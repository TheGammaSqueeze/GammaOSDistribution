...
public class HeadsUpContainerViewTest {
    ...
    @Test
    public void addView_notTouchMode_noPrevFocus_addNewChild_nothingScheduled() {
    ...
    @Test
    public void addView_notTouchMode_hasPrevFocus_addNewChild_scheduleRunnable() {
        // Setup.
        getInstrumentation().runOnMainSync(() -> {
            View notif1 = getTestNotificationView();
            mHeadsUpContainerView.addView(notif1);
