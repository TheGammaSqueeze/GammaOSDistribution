...
/**
 * A provider for {@link UserProvisioningStateHelper}.
 */
public interface UserProvisioningStateHelperProvider {
    UserProvisioningStateHelperProvider DEFAULT = UserProvisioningStateHelper::new;

    /**
     * Returns an instance of {@link UserProvisioningStateHelper} for the provided {@link Context}.
     */
