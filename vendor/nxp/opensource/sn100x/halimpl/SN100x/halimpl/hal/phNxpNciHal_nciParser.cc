...
phNxpNciHal_initParser() {
    ...
    psContext->sEntryFuncs.destroyParser = (tHAL_API_NATIVE_DESTROY_PARSER)dlsym(psContext->pvHandle, "native_destroyParser");
    ...
    psContext->sEntryFuncs.deinitParser = (tHAL_API_NATIVE_DEINIT_PARSER)dlsym(psContext->pvHandle, "native_deinitParser");
