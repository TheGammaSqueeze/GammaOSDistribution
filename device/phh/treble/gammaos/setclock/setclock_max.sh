...
echo 1866 > /sys/class/devfreq/scene-frequency/sprd-governor/scaling_force_ddr_freq
echo "performance" > /sys/class/devfreq/scene-frequency/governor
echo "50" > /sys/class/devfreq/scene-frequency/polling_interval
echo "1866" > /sys/class/devfreq/scene-frequency/min_freq
