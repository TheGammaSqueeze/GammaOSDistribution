...
/** Opens any application generically, idles, and exits after, based on the provided options. */
@Scenario
@RunWith(Microbenchmark.class)
public class IdleInAppMicrobenchmark {
    // Class-level rules
    ...
    public static LongOption sIdleMsOption =
            new LongOption("idleMs").setRequired(false).setDefault(2500L);
