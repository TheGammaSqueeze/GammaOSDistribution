...
binder_status_t EnergyMeasurement::readFromParcel(const AParcel* parcel) {
  ...
  _aidl_ret_status = AParcel_readInt64(parcel, &durationMs);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t EnergyMeasurement::writeToParcel(AParcel* parcel) const {
  ...
  _aidl_ret_status = AParcel_writeInt64(parcel, durationMs);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
