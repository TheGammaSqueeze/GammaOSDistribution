#ifndef HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_BUFFERPOOL_V2_0_ICONNECTION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_BUFFERPOOL_V2_0_ICONNECTION_H
...
struct IConnection : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.media.bufferpool@2.0::IConnection"
     */
    ...
    /**
     * Return callback for fetch
     */
    using fetch_cb = std::function<void(::android::hardware::media::bufferpool::V2_0::ResultStatus status, const ::android::hardware::media::bufferpool::V2_0::Buffer& buffer)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::bufferpool::V2_0::IConnection>> castFrom(const ::android::sp<::android::hardware::media::bufferpool::V2_0::IConnection>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::bufferpool::V2_0::IConnection>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::media::bufferpool::V2_0::IConnection>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::media::bufferpool::V2_0::IConnection>& o) {
    ...
    os += ::android::hardware::media::bufferpool::V2_0::IConnection::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_BUFFERPOOL_V2_0_ICONNECTION_H
