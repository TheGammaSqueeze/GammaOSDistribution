...
binder_status_t KeyCreationResult::readFromParcel(const AParcel* parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readVector(parcel, &keyCharacteristics);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t KeyCreationResult::writeToParcel(AParcel* parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeVector(parcel, keyCharacteristics);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
