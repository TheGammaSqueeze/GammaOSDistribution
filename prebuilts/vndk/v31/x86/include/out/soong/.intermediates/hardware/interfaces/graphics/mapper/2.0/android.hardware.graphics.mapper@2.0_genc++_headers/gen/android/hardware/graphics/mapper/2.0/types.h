...
static inline void PrintTo(::android::hardware::graphics::mapper::V2_0::Error o, ::std::ostream* os);
...
static inline void PrintTo(const ::android::hardware::graphics::mapper::V2_0::YCbCrLayout& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::graphics::mapper::V2_0::YCbCrLayout& o, ::std::ostream* os) {
    *os << toString(o);
}
...
template<> inline constexpr std::array<::android::hardware::graphics::mapper::V2_0::Error, 6> hidl_enum_values<::android::hardware::graphics::mapper::V2_0::Error> = {
