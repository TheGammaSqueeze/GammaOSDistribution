...
struct BsMapper : IMapper, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<::android::sp<::android::hidl::memory::V1_0::IMemory>> mapMemory(const ::android::hardware::hidl_memory& mem) override {
        ...
        ::android::sp<::android::hidl::memory::V1_0::IMemory> _hidl_out_mappedMemory = _hidl_return;
        (void) _hidl_out_mappedMemory;
        ::android::sp<::android::hidl::memory::V1_0::IMemory> _hidl_wrapped__hidl_out_mappedMemory;
        if (_hidl_out_mappedMemory != nullptr && !_hidl_out_mappedMemory->isRemote()) {
            _hidl_wrapped__hidl_out_mappedMemory = ::android::hardware::details::wrapPassthrough(_hidl_out_mappedMemory);
            if (_hidl_wrapped__hidl_out_mappedMemory == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
                        ::android::hardware::Status::EX_TRANSACTION_FAILED,
                        "Cannot wrap passthrough interface.");
            }
        } else {
            _hidl_wrapped__hidl_out_mappedMemory = _hidl_out_mappedMemory;
        }

        _hidl_out_mappedMemory = _hidl_wrapped__hidl_out_mappedMemory;

        _hidl_return = _hidl_out_mappedMemory
