#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RENDERSCRIPT_V1_0_BSDEVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RENDERSCRIPT_V1_0_BSDEVICE_H
...
struct BsDevice : IDevice, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::renderscript::V1_0::IContext>> contextCreate(uint32_t sdkVersion, ::android::hardware::renderscript::V1_0::ContextType ct, ::android::hardware::hidl_bitfield<::android::hardware::renderscript::V1_0::ContextFlags> flags) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IDevice::contextCreate::passthrough");
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.renderscript", "1.0", "IDevice", "contextCreate", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->contextCreate(sdkVersion, ct, flags);

        ::android::sp<::android::hardware::renderscript::V1_0::IContext> _hidl_out_context = _hidl_return;
        (void) _hidl_out_context;
        ::android::sp<::android::hardware::renderscript::V1_0::IContext> _hidl_wrapped__hidl_out_context;
        ...
        _hidl_out_context = _hidl_wrapped__hidl_out_context;

        _hidl_return = _hidl_out_context
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.renderscript", "1.0", "IDevice", "contextCreate", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RENDERSCRIPT_V1_0_BSDEVICE_H
