#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_MAPPER_V3_0_TYPES_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_MAPPER_V3_0_TYPES_H
...
template<> inline constexpr std::array<::android::hardware::graphics::mapper::V3_0::Error, 6> hidl_enum_values<::android::hardware::graphics::mapper::V3_0::Error> = {
    ::android::hardware::graphics::mapper::V3_0::Error::NONE,
    ::android::hardware::graphics::mapper::V3_0::Error::BAD_DESCRIPTOR,
    ::android::hardware::graphics::mapper::V3_0::Error::BAD_BUFFER,
    ::android::hardware::graphics::mapper::V3_0::Error::BAD_VALUE,
    ::android::hardware::graphics::mapper::V3_0::Error::NO_RESOURCES,
    ::android::hardware::graphics::mapper::V3_0::Error::UNSUPPORTED,
};
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_MAPPER_V3_0_TYPES_H
