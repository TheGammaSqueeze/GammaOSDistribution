#ifndef HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_BUFFERPOOL_V2_0_ICLIENTMANAGER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_BUFFERPOOL_V2_0_ICLIENTMANAGER_H
...
struct IClientManager : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.media.bufferpool@2.0::IClientManager"
     */
    ...
    /**
     * Return callback for registerSender
     */
    using registerSender_cb = std::function<void(::android::hardware::media::bufferpool::V2_0::ResultStatus status, int64_t connectionId)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> registerSender(const ::android::sp<::android::hardware::media::bufferpool::V2_0::IAccessor>& bufferPool, registerSender_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::bufferpool::V2_0::IClientManager>> castFrom(const ::android::sp<::android::hardware::media::bufferpool::V2_0::IClientManager>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::bufferpool::V2_0::IClientManager>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::media::bufferpool::V2_0::IClientManager>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::media::bufferpool::V2_0::IClientManager>& o) {
    ...
    os += ::android::hardware::media::bufferpool::V2_0::IClientManager::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_BUFFERPOOL_V2_0_ICLIENTMANAGER_H
