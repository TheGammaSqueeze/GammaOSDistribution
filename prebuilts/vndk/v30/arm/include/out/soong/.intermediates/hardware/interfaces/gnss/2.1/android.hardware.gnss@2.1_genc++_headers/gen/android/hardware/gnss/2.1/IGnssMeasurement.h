#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_1_IGNSSMEASUREMENT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_1_IGNSSMEASUREMENT_H
 ...
 */
struct IGnssMeasurement : public ::android::hardware::gnss::V2_0::IGnssMeasurement {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.gnss@2.1::IGnssMeasurement"
     */
     ...
     *     error code.
     */
    virtual ::android::hardware::Return<::android::hardware::gnss::V1_0::IGnssMeasurement::GnssMeasurementStatus> setCallback_2_0(const ::android::sp<::android::hardware::gnss::V2_0::IGnssMeasurementCallback>& callback, bool enableFullTracking) = 0;
     ...
     *     error code.
     */
    virtual ::android::hardware::Return<::android::hardware::gnss::V1_0::IGnssMeasurement::GnssMeasurementStatus> setCallback_2_1(const ::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurementCallback>& callback, bool enableFullTracking) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>> castFrom(const ::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>> castFrom(const ::android::sp<::android::hardware::gnss::V2_0::IGnssMeasurement>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>> castFrom(const ::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurement>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>> castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnssMeasurement>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>& o) {
    ...
    os += ::android::hardware::gnss::V2_1::IGnssMeasurement::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_1_IGNSSMEASUREMENT_H
