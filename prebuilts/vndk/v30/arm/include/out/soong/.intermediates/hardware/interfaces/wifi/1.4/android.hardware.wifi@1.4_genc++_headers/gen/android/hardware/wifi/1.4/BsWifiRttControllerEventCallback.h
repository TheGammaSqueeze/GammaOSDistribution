#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_BSWIFIRTTCONTROLLEREVENTCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_BSWIFIRTTCONTROLLEREVENTCALLBACK_H
...
struct BsWifiRttControllerEventCallback : IWifiRttControllerEventCallback, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> onResults_1_4(uint32_t cmdId, const ::android::hardware::hidl_vec<::android::hardware::wifi::V1_4::RttResult>& results) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IWifiRttControllerEventCallback::onResults_1_4::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&cmdId);
            _hidl_args.push_back((void *)&results);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.wifi", "1.4", "IWifiRttControllerEventCallback", "onResults_1_4", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        #endif // __ANDROID_DEBUGGABLE__
        , cmdId, results] {
            mImpl->onResults_1_4(cmdId, results);
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.wifi", "1.4", "IWifiRttControllerEventCallback", "onResults_1_4", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_BSWIFIRTTCONTROLLEREVENTCALLBACK_H
