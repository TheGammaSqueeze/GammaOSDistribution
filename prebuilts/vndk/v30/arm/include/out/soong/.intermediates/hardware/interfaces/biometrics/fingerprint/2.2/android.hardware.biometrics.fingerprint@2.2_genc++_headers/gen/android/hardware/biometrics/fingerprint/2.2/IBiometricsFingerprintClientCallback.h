#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BIOMETRICS_FINGERPRINT_V2_2_IBIOMETRICSFINGERPRINTCLIENTCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BIOMETRICS_FINGERPRINT_V2_2_IBIOMETRICSFINGERPRINTCLIENTCALLBACK_H
 ...
 */
struct IBiometricsFingerprintClientCallback : public ::android::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprintClientCallback {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.biometrics.fingerprint@2.2::IBiometricsFingerprintClientCallback"
     */
     ...
     *        valid when acquiredInfo == ACQUIRED_VENDOR
     */
    virtual ::android::hardware::Return<void> onAcquired_2_2(uint64_t deviceId, ::android::hardware::biometrics::fingerprint::V2_2::FingerprintAcquiredInfo acquiredInfo, int32_t vendorCode) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::biometrics::fingerprint::V2_2::IBiometricsFingerprintClientCallback>> castFrom(const ::android::sp<::android::hardware::biometrics::fingerprint::V2_2::IBiometricsFingerprintClientCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::biometrics::fingerprint::V2_2::IBiometricsFingerprintClientCallback>> castFrom(const ::android::sp<::android::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprintClientCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::biometrics::fingerprint::V2_2::IBiometricsFingerprintClientCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::biometrics::fingerprint::V2_2::IBiometricsFingerprintClientCallback>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::biometrics::fingerprint::V2_2::IBiometricsFingerprintClientCallback>& o) {
    ...
    os += ::android::hardware::biometrics::fingerprint::V2_2::IBiometricsFingerprintClientCallback::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BIOMETRICS_FINGERPRINT_V2_2_IBIOMETRICSFINGERPRINTCLIENTCALLBACK_H
