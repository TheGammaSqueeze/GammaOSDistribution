#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWVIRTUALIZEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWVIRTUALIZEREFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/2.0/IHwVirtualizerEffect.h>
...
struct BpHwVirtualizerEffect : public ::android::hardware::BpInterface<IVirtualizerEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result>  _hidl_setStrength(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint16_t strength);
    ...
    static ::android::hardware::Return<void>  _hidl_getVirtualSpeakerAngles(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::common::V2_0::AudioChannelMask mask, ::android::hardware::audio::common::V2_0::AudioDevice device, getVirtualSpeakerAngles_cb _hidl_cb);
    static ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result>  _hidl_forceVirtualizationMode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::common::V2_0::AudioDevice device);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWVIRTUALIZEREFFECT_H
