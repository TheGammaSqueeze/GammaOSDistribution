#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_3_BNHWRADIO_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_3_BNHWRADIO_H
...
struct BnHwRadio : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_setSystemSelectionChannels(
    ...
    static ::android::status_t _hidl_enableModem(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_getModemStackStatus(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_3_BNHWRADIO_H
