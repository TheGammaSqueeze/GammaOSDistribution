...
struct IRadio : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio@1.0::IRadio"
     */
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_0::IRadio>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_0::IRadio>& o) {
    ...
    os += ::android::hardware::radio::V1_0::IRadio::descriptor;
    os += "]";
