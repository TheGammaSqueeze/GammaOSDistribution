#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IEFFECTBUFFERPROVIDERCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IEFFECTBUFFERPROVIDERCALLBACK_H
...
struct IEffectBufferProviderCallback : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@6.0::IEffectBufferProviderCallback"
     */
    ...
    /**
     * Return callback for getBuffer
     */
    using getBuffer_cb = std::function<void(const ::android::hardware::audio::effect::V6_0::AudioBuffer& buffer)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> putBuffer(const ::android::hardware::audio::effect::V6_0::AudioBuffer& buffer) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>> castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& o) {
    ...
    os += ::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IEFFECTBUFFERPROVIDERCALLBACK_H
