#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V5_0_BPHWAUTOMATICGAINCONTROLEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V5_0_BPHWAUTOMATICGAINCONTROLEFFECT_H
...
struct BpHwAutomaticGainControlEffect : public ::android::hardware::BpInterface<IAutomaticGainControlEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V5_0::Result>  _hidl_setTargetLevel(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int16_t targetLevelMb);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V5_0::Result>  _hidl_setCompGain(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int16_t compGainMb);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V5_0::Result>  _hidl_setLimiterEnabled(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool enabled);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V5_0::Result>  _hidl_setAllProperties(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::effect::V5_0::IAutomaticGainControlEffect::AllProperties& properties);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V5_0_BPHWAUTOMATICGAINCONTROLEFFECT_H
