#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_0_IWIFIAPIFACE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_0_IWIFIAPIFACE_H
 ...
 */
struct IWifiApIface : public ::android::hardware::wifi::V1_0::IWifiIface {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi@1.0::IWifiApIface"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_0::IWifiApIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiApIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_0::IWifiApIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_0::IWifiApIface>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_0::IWifiApIface>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_0::IWifiApIface>& o) {
    ...
    os += ::android::hardware::wifi::V1_0::IWifiApIface::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_0_IWIFIAPIFACE_H
