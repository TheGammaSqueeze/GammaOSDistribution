#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWAUTOMATICGAINCONTROLEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWAUTOMATICGAINCONTROLEFFECT_H
...
struct BpHwAutomaticGainControlEffect : public ::android::hardware::BpInterface<IAutomaticGainControlEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_setTargetLevel(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int16_t targetLevelMb);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_setCompGain(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int16_t compGainMb);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_setLimiterEnabled(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool enabled);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_setAllProperties(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::effect::V4_0::IAutomaticGainControlEffect::AllProperties& properties);
    ...
    // Methods from ::android::hardware::audio::effect::V4_0::IAutomaticGainControlEffect follow.
    ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setTargetLevel(int16_t targetLevelMb) override;
    ::android::hardware::Return<void> getTargetLevel(getTargetLevel_cb _hidl_cb) override;
    ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setCompGain(int16_t compGainMb) override;
    ::android::hardware::Return<void> getCompGain(getCompGain_cb _hidl_cb) override;
    ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setLimiterEnabled(bool enabled) override;
    ::android::hardware::Return<void> isLimiterEnabled(isLimiterEnabled_cb _hidl_cb) override;
    ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setAllProperties(const ::android::hardware::audio::effect::V4_0::IAutomaticGainControlEffect::AllProperties& properties) override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWAUTOMATICGAINCONTROLEFFECT_H
