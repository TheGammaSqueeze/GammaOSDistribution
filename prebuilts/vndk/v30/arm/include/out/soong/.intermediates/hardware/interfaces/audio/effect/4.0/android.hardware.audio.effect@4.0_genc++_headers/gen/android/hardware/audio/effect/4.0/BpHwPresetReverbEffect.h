#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWPRESETREVERBEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWPRESETREVERBEFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/4.0/IHwPresetReverbEffect.h>
...
struct BpHwPresetReverbEffect : public ::android::hardware::BpInterface<IPresetReverbEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_setPreset(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::effect::V4_0::IPresetReverbEffect::Preset preset);
    ...
    // Methods from ::android::hardware::audio::effect::V4_0::IPresetReverbEffect follow.
    ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setPreset(::android::hardware::audio::effect::V4_0::IPresetReverbEffect::Preset preset) override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWPRESETREVERBEFFECT_H
