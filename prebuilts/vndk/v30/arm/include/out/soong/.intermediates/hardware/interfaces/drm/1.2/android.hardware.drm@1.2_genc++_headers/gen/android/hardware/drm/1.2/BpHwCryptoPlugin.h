#ifndef HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_2_BPHWCRYPTOPLUGIN_H
#define HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_2_BPHWCRYPTOPLUGIN_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/drm/1.2/IHwCryptoPlugin.h>
...
struct BpHwCryptoPlugin : public ::android::hardware::BpInterface<ICryptoPlugin>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_decrypt_1_2(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool secure, const ::android::hardware::hidl_array<uint8_t, 16>& keyId, const ::android::hardware::hidl_array<uint8_t, 16>& iv, ::android::hardware::drm::V1_0::Mode mode, const ::android::hardware::drm::V1_0::Pattern& pattern, const ::android::hardware::hidl_vec<::android::hardware::drm::V1_0::SubSample>& subSamples, const ::android::hardware::drm::V1_0::SharedBuffer& source, uint64_t offset, const ::android::hardware::drm::V1_0::DestinationBuffer& destination, decrypt_1_2_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_2_BPHWCRYPTOPLUGIN_H
