#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_IWIFICHIPEVENTCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_IWIFICHIPEVENTCALLBACK_H
 ...
 */
struct IWifiChipEventCallback : public ::android::hardware::wifi::V1_2::IWifiChipEventCallback {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi@1.4::IWifiChipEventCallback"
     */
    ...
    struct RadioModeInfo final {
         ...
         */
        ::android::hardware::wifi::V1_4::WifiBand bandInfo __attribute__ ((aligned(4)));
        /**
    ...
    static_assert(offsetof(::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo, radioId) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo, bandInfo) == 4, "wrong offset");
    static_assert(offsetof(::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo, ifaceInfos) == 8, "wrong offset");
    static_assert(sizeof(::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo) == 24, "wrong size");
    static_assert(__alignof(::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo) == 8, "wrong alignment");
     ...
     * radio chain (hardware MAC) on the device.
     */
    virtual ::android::hardware::Return<void> onRadioModeChange_1_4(const ::android::hardware::hidl_vec<::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo>& radioModeInfos) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiChipEventCallback>> castFrom(const ::android::sp<::android::hardware::wifi::V1_4::IWifiChipEventCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiChipEventCallback>> castFrom(const ::android::sp<::android::hardware::wifi::V1_2::IWifiChipEventCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiChipEventCallback>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiChipEventCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiChipEventCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo& o);
static inline void PrintTo(const ::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo& lhs, const ::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo& rhs);
static inline bool operator!=(const ::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo& lhs, const ::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo& rhs);

static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_4::IWifiChipEventCallback>& o);
...
static inline std::string toString(const ::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo& o) {
    ...
    os += ", .bandInfo = ";
    os += ::android::hardware::wifi::V1_4::toString(o.bandInfo);
    os += ", .ifaceInfos = ";
    os += ::android::hardware::toString(o.ifaceInfos);
    os += "}"; return os;
}

static inline void PrintTo(const ::android::hardware::wifi::V1_4::IWifiChipEventCallback::RadioModeInfo& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_4::IWifiChipEventCallback>& o) {
    ...
    os += ::android::hardware::wifi::V1_4::IWifiChipEventCallback::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_IWIFICHIPEVENTCALLBACK_H
