#ifndef HIDL_GENERATED_ANDROID_HARDWARE_TV_CEC_V2_0_BSHDMICECCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_TV_CEC_V2_0_BSHDMICECCALLBACK_H
...
struct BsHdmiCecCallback : IHdmiCecCallback, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> onCecMessage(const ::android::hardware::tv::cec::V2_0::CecMessage& message) override {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.tv.cec", "2.0", "IHdmiCecCallback", "onCecMessage", &_hidl_args);
            }
        }
        ...
        , message] {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.tv.cec", "2.0", "IHdmiCecCallback", "onCecMessage", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> onHotplugEvent(const ::android::hardware::tv::cec::V2_0::HotplugEvent& event) override {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.tv.cec", "2.0", "IHdmiCecCallback", "onHotplugEvent", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        , event] {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.tv.cec", "2.0", "IHdmiCecCallback", "onHotplugEvent", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> onTopologyEvent(const ::android::hardware::tv::cec::V2_0::CecTopologyEvent& event) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IHdmiCecCallback::onTopologyEvent::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&event);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.tv.cec", "2.0", "IHdmiCecCallback", "onTopologyEvent", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        , event] {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.tv.cec", "2.0", "IHdmiCecCallback", "onTopologyEvent", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_TV_CEC_V2_0_BSHDMICECCALLBACK_H
