#ifndef HIDL_GENERATED_ANDROID_SYSTEM_NET_NETD_V1_1_BSNETD_H
#define HIDL_GENERATED_ANDROID_SYSTEM_NET_NETD_V1_1_BSNETD_H
...
struct BsNetd : INetd, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<::android::system::net::netd::V1_0::INetd::StatusCode> addRouteToOemNetwork(uint64_t networkHandle, const ::android::hardware::hidl_string& ifname, const ::android::hardware::hidl_string& destination, const ::android::hardware::hidl_string& nexthop) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::INetd::addRouteToOemNetwork::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&networkHandle);
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.system.net.netd", "1.1", "INetd", "addRouteToOemNetwork", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->addRouteToOemNetwork(networkHandle, ifname, destination, nexthop);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_status);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.system.net.netd", "1.1", "INetd", "addRouteToOemNetwork", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::system::net::netd::V1_0::INetd::StatusCode> removeRouteFromOemNetwork(uint64_t networkHandle, const ::android::hardware::hidl_string& ifname, const ::android::hardware::hidl_string& destination, const ::android::hardware::hidl_string& nexthop) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::INetd::removeRouteFromOemNetwork::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&networkHandle);
            ...
            _hidl_args.push_back((void *)&nexthop);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.system.net.netd", "1.1", "INetd", "removeRouteFromOemNetwork", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->removeRouteFromOemNetwork(networkHandle, ifname, destination, nexthop);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_status);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.system.net.netd", "1.1", "INetd", "removeRouteFromOemNetwork", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::system::net::netd::V1_0::INetd::StatusCode> addInterfaceToOemNetwork(uint64_t networkHandle, const ::android::hardware::hidl_string& ifname) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::INetd::addInterfaceToOemNetwork::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&networkHandle);
            _hidl_args.push_back((void *)&ifname);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.system.net.netd", "1.1", "INetd", "addInterfaceToOemNetwork", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->addInterfaceToOemNetwork(networkHandle, ifname);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_status);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.system.net.netd", "1.1", "INetd", "addInterfaceToOemNetwork", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::system::net::netd::V1_0::INetd::StatusCode> removeInterfaceFromOemNetwork(uint64_t networkHandle, const ::android::hardware::hidl_string& ifname) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::INetd::removeInterfaceFromOemNetwork::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&networkHandle);
            _hidl_args.push_back((void *)&ifname);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.system.net.netd", "1.1", "INetd", "removeInterfaceFromOemNetwork", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->removeInterfaceFromOemNetwork(networkHandle, ifname);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_status);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.system.net.netd", "1.1", "INetd", "removeInterfaceFromOemNetwork", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::system::net::netd::V1_0::INetd::StatusCode> setIpForwardEnable(bool enable) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::INetd::setIpForwardEnable::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&enable);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.system.net.netd", "1.1", "INetd", "setIpForwardEnable", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->setIpForwardEnable(enable);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_status);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.system.net.netd", "1.1", "INetd", "setIpForwardEnable", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::system::net::netd::V1_0::INetd::StatusCode> setForwardingBetweenInterfaces(const ::android::hardware::hidl_string& inputIfName, const ::android::hardware::hidl_string& outputIfName, bool enable) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::INetd::setForwardingBetweenInterfaces::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            ...
            _hidl_args.push_back((void *)&enable);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.system.net.netd", "1.1", "INetd", "setForwardingBetweenInterfaces", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->setForwardingBetweenInterfaces(inputIfName, outputIfName, enable);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_status);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.system.net.netd", "1.1", "INetd", "setForwardingBetweenInterfaces", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_ANDROID_SYSTEM_NET_NETD_V1_1_BSNETD_H
