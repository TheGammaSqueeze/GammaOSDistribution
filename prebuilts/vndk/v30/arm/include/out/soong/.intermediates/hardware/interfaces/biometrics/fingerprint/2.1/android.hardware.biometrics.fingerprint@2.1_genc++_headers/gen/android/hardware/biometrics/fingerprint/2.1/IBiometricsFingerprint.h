#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BIOMETRICS_FINGERPRINT_V2_1_IBIOMETRICSFINGERPRINT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BIOMETRICS_FINGERPRINT_V2_1_IBIOMETRICSFINGERPRINT_H
...
struct IBiometricsFingerprint : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprint"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprint>> castFrom(const ::android::sp<::android::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprint>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprint>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprint>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprint>& o) {
    ...
    os += ::android::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprint::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BIOMETRICS_FINGERPRINT_V2_1_IBIOMETRICSFINGERPRINT_H
