#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_1_BPHWRADIO_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_1_BPHWRADIO_H
...
struct BpHwRadio : public ::android::hardware::BpInterface<IRadio>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_setCarrierInfoForImsiEncryption(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, const ::android::hardware::radio::V1_1::ImsiEncryptionInfo& imsiEncryptionInfo);
    static ::android::hardware::Return<void>  _hidl_setSimCardPower_1_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, ::android::hardware::radio::V1_1::CardPowerState powerUp);
    static ::android::hardware::Return<void>  _hidl_startNetworkScan(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, const ::android::hardware::radio::V1_1::NetworkScanRequest& request);
    static ::android::hardware::Return<void>  _hidl_stopNetworkScan(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial);
    static ::android::hardware::Return<void>  _hidl_startKeepalive(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, const ::android::hardware::radio::V1_1::KeepaliveRequest& keepalive);
    static ::android::hardware::Return<void>  _hidl_stopKeepalive(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, int32_t sessionHandle);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_1_BPHWRADIO_H
