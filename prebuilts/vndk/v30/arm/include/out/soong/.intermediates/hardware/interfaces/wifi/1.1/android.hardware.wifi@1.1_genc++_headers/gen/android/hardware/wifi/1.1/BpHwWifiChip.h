#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_1_BPHWWIFICHIP_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_1_BPHWWIFICHIP_H
...
struct BpHwWifiChip : public ::android::hardware::BpInterface<IWifiChip>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_selectTxPowerScenario(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::wifi::V1_1::IWifiChip::TxPowerScenario scenario, selectTxPowerScenario_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_resetTxPowerScenario(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, resetTxPowerScenario_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_1_BPHWWIFICHIP_H
