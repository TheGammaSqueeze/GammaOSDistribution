#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_1_ISAP_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_1_ISAP_H
 ...
 */
struct ISap : public ::android::hardware::radio::V1_0::ISap {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio@1.1::ISap"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_1::ISap>> castFrom(const ::android::sp<::android::hardware::radio::V1_1::ISap>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_1::ISap>> castFrom(const ::android::sp<::android::hardware::radio::V1_0::ISap>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_1::ISap>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_1::ISap>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_1::ISap>& o) {
    ...
    os += ::android::hardware::radio::V1_1::ISap::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_1_ISAP_H
