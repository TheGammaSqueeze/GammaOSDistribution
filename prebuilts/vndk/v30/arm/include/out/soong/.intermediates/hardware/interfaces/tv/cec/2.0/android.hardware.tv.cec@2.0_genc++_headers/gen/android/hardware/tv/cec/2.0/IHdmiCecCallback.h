#ifndef HIDL_GENERATED_ANDROID_HARDWARE_TV_CEC_V2_0_IHDMICECCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_TV_CEC_V2_0_IHDMICECCALLBACK_H
...
struct IHdmiCecCallback : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.tv.cec@2.0::IHdmiCecCallback"
     */
     ...
     */
    virtual ::android::hardware::Return<void> onCecMessage(const ::android::hardware::tv::cec::V2_0::CecMessage& message) = 0;

    /**
     * The callback function that must be called by HAL implementation to notify
     * the system of new hotplug event.
     */
    virtual ::android::hardware::Return<void> onHotplugEvent(const ::android::hardware::tv::cec::V2_0::HotplugEvent& event) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> onTopologyEvent(const ::android::hardware::tv::cec::V2_0::CecTopologyEvent& event) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::tv::cec::V2_0::IHdmiCecCallback>> castFrom(const ::android::sp<::android::hardware::tv::cec::V2_0::IHdmiCecCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::tv::cec::V2_0::IHdmiCecCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::tv::cec::V2_0::IHdmiCecCallback>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::tv::cec::V2_0::IHdmiCecCallback>& o) {
    ...
    os += ::android::hardware::tv::cec::V2_0::IHdmiCecCallback::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_TV_CEC_V2_0_IHDMICECCALLBACK_H
