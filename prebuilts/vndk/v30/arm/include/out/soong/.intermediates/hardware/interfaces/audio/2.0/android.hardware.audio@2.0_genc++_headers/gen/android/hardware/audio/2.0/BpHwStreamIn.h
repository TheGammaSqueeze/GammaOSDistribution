#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V2_0_BPHWSTREAMIN_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V2_0_BPHWSTREAMIN_H
...
struct BpHwStreamIn : public ::android::hardware::BpInterface<IStreamIn>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_setGain(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float gain);
    ...
    ::android::hardware::Return<::android::hardware::audio::V2_0::Result> setGain(float gain) override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V2_0_BPHWSTREAMIN_H
