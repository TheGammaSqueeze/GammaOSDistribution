#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V1_0_ITUNERCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V1_0_ITUNERCALLBACK_H
...
struct ITunerCallback : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.broadcastradio@1.0::ITunerCallback"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::broadcastradio::V1_0::ITunerCallback>> castFrom(const ::android::sp<::android::hardware::broadcastradio::V1_0::ITunerCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::broadcastradio::V1_0::ITunerCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::broadcastradio::V1_0::ITunerCallback>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::broadcastradio::V1_0::ITunerCallback>& o) {
    ...
    os += ::android::hardware::broadcastradio::V1_0::ITunerCallback::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V1_0_ITUNERCALLBACK_H
