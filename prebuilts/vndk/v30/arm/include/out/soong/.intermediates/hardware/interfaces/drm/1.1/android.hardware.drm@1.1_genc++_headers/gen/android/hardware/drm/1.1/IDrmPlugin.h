#ifndef HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_1_IDRMPLUGIN_H
#define HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_1_IDRMPLUGIN_H
 ...
 */
struct IDrmPlugin : public ::android::hardware::drm::V1_0::IDrmPlugin {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.drm@1.1::IDrmPlugin"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::drm::V1_1::IDrmPlugin>> castFrom(const ::android::sp<::android::hardware::drm::V1_1::IDrmPlugin>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::drm::V1_1::IDrmPlugin>> castFrom(const ::android::sp<::android::hardware::drm::V1_0::IDrmPlugin>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::drm::V1_1::IDrmPlugin>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::drm::V1_1::IDrmPlugin>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::drm::V1_1::IDrmPlugin>& o) {
    ...
    os += ::android::hardware::drm::V1_1::IDrmPlugin::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_1_IDRMPLUGIN_H
