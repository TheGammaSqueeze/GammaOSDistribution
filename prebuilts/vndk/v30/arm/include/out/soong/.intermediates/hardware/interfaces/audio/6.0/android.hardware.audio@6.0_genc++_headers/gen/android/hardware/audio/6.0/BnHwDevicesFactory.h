#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V6_0_BNHWDEVICESFACTORY_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V6_0_BNHWDEVICESFACTORY_H

#include <android/hardware/audio/6.0/IHwDevicesFactory.h>
...
struct BnHwDevicesFactory : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_openPrimaryDevice(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V6_0_BNHWDEVICESFACTORY_H
