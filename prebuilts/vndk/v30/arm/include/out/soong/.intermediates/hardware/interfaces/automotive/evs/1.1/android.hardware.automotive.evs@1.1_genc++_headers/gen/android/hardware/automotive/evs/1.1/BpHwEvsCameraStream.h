#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUTOMOTIVE_EVS_V1_1_BPHWEVSCAMERASTREAM_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUTOMOTIVE_EVS_V1_1_BPHWEVSCAMERASTREAM_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/automotive/evs/1.1/IHwEvsCameraStream.h>
...
struct BpHwEvsCameraStream : public ::android::hardware::BpInterface<IEvsCameraStream>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_deliverFrame_1_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::automotive::evs::V1_1::BufferDesc>& buffer);
    ...
    // Methods from ::android::hardware::automotive::evs::V1_1::IEvsCameraStream follow.
    ::android::hardware::Return<void> deliverFrame_1_1(const ::android::hardware::hidl_vec<::android::hardware::automotive::evs::V1_1::BufferDesc>& buffer) override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUTOMOTIVE_EVS_V1_1_BPHWEVSCAMERASTREAM_H
