#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BNHWGNSSCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BNHWGNSSCALLBACK_H
...
struct BnHwGnssCallback : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_gnssNameCb(
    ...
    static ::android::status_t _hidl_gnssRequestLocationCb(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BNHWGNSSCALLBACK_H
