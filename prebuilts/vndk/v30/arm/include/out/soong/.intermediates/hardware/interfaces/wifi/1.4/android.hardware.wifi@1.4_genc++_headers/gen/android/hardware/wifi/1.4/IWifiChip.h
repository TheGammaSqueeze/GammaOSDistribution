#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_IWIFICHIP_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_IWIFICHIP_H
 ...
 */
struct IWifiChip : public ::android::hardware::wifi::V1_3::IWifiChip {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi@1.4::IWifiChip"
     */
     ...
     *         |WifiStatusCode.ERROR_WIFI_CHIP_INVALID|
     */
    virtual ::android::hardware::Return<void> registerEventCallback_1_4(const ::android::sp<::android::hardware::wifi::V1_4::IWifiChipEventCallback>& callback, registerEventCallback_1_4_cb _hidl_cb) = 0;

    /**
     * Return callback for createRttController_1_4
     */
    using createRttController_1_4_cb = std::function<void(const ::android::hardware::wifi::V1_0::WifiStatus& status, const ::android::sp<::android::hardware::wifi::V1_4::IWifiRttController>& rtt)>;
    /**
     * Create a RTTController instance.
     *
     * RTT controller can be either:
     ...
     *         |WifiStatusCode.ERROR_WIFI_CHIP_INVALID|
     */
    virtual ::android::hardware::Return<void> createRttController_1_4(const ::android::sp<::android::hardware::wifi::V1_0::IWifiIface>& boundIface, createRttController_1_4_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiChip>> castFrom(const ::android::sp<::android::hardware::wifi::V1_4::IWifiChip>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiChip>> castFrom(const ::android::sp<::android::hardware::wifi::V1_3::IWifiChip>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiChip>> castFrom(const ::android::sp<::android::hardware::wifi::V1_2::IWifiChip>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiChip>> castFrom(const ::android::sp<::android::hardware::wifi::V1_1::IWifiChip>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiChip>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiChip>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiChip>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_4::IWifiChip>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_4::IWifiChip>& o) {
    ...
    os += ::android::hardware::wifi::V1_4::IWifiChip::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_IWIFICHIP_H
