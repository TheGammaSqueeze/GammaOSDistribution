...
struct IRadio : public ::android::hardware::radio::V1_0::IRadio {
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio@1.1::IRadio"
     */
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_1::IRadio>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_1::IRadio>& o) {
    ...
    os += ::android::hardware::radio::V1_1::IRadio::descriptor;
    os += "]";
