#ifndef HIDL_GENERATED_ANDROID_HARDWARE_POWER_V1_0_IPOWER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_POWER_V1_0_IPOWER_H
...
struct IPower : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.power@1.0::IPower"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::power::V1_0::IPower>> castFrom(const ::android::sp<::android::hardware::power::V1_0::IPower>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::power::V1_0::IPower>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::power::V1_0::IPower>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::power::V1_0::IPower>& o) {
    ...
    os += ::android::hardware::power::V1_0::IPower::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_POWER_V1_0_IPOWER_H
