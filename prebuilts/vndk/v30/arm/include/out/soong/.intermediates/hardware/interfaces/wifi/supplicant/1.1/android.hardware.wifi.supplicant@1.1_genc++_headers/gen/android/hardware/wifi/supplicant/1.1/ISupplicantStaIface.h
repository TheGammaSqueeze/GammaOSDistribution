#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_1_ISUPPLICANTSTAIFACE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_1_ISUPPLICANTSTAIFACE_H
 ...
 */
struct ISupplicantStaIface : public ::android::hardware::wifi::supplicant::V1_0::ISupplicantStaIface {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi.supplicant@1.1::ISupplicantStaIface"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicantStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicantStaIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicantStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_0::ISupplicantStaIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicantStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_0::ISupplicantIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicantStaIface>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicantStaIface>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicantStaIface>& o) {
    ...
    os += ::android::hardware::wifi::supplicant::V1_1::ISupplicantStaIface::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_1_ISUPPLICANTSTAIFACE_H
