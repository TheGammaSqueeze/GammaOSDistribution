#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_IEQUALIZEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_IEQUALIZEREFFECT_H
...
struct IEqualizerEffect : public ::android::hardware::audio::effect::V4_0::IEffect {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@4.0::IEqualizerEffect"
     */
    ...
    static_assert(offsetof(::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties, curPreset) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties, bandLevels) == 8, "wrong offset");
    static_assert(sizeof(::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties) == 24, "wrong size");
    static_assert(__alignof(::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties) == 8, "wrong alignment");
     ...
     */
    using getNumBands_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, uint16_t numBands)>;
    /**
     ...
     */
    using getLevelRange_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, int16_t minLevel, int16_t maxLevel)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setBandLevel(uint16_t band, int16_t level) = 0;

    /**
     * Return callback for getBandLevel
     */
    using getBandLevel_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, int16_t level)>;
    /**
     ...
     */
    using getBandCenterFrequency_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, uint32_t centerFreqmHz)>;
    /**
     ...
     */
    using getBandFrequencyRange_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, uint32_t minFreqmHz, uint32_t maxFreqmHz)>;
    /**
     ...
     */
    using getBandForFrequency_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, uint16_t band)>;
    /**
     ...
     */
    using getPresetNames_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& names)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setCurrentPreset(uint16_t preset) = 0;

    /**
     * Return callback for getCurrentPreset
     */
    using getCurrentPreset_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, uint16_t preset)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setAllProperties(const ::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties& properties) = 0;

    /**
     * Return callback for getAllProperties
     */
    using getAllProperties_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, const ::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties& properties)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::IEqualizerEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::IEqualizerEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::IEqualizerEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::IEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::IEqualizerEffect>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties& o);
static inline void PrintTo(const ::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties& lhs, const ::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties& rhs);
static inline bool operator!=(const ::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties& lhs, const ::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties& rhs);

static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V4_0::IEqualizerEffect>& o);
...
static inline void PrintTo(const ::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V4_0::IEqualizerEffect>& o) {
    ...
    os += ::android::hardware::audio::effect::V4_0::IEqualizerEffect::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_IEQUALIZEREFFECT_H
