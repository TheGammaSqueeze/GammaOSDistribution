#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_COMPOSER_V2_3_ICOMPOSER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_COMPOSER_V2_3_ICOMPOSER_H
...
struct IComposer : public ::android::hardware::graphics::composer::V2_2::IComposer {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.graphics.composer@2.3::IComposer"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>> castFrom(const ::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>> castFrom(const ::android::sp<::android::hardware::graphics::composer::V2_2::IComposer>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>> castFrom(const ::android::sp<::android::hardware::graphics::composer::V2_1::IComposer>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>& o) {
    ...
    os += ::android::hardware::graphics::composer::V2_3::IComposer::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_COMPOSER_V2_3_ICOMPOSER_H
