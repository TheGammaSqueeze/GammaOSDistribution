#ifndef HIDL_GENERATED_ANDROID_HARDWARE_POWER_V1_0_BNHWPOWER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_POWER_V1_0_BNHWPOWER_H
...
struct BnHwPower : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_setInteractive(
    ...
    static ::android::status_t _hidl_powerHint(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_setFeature(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_getPlatformLowPowerStats(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_POWER_V1_0_BNHWPOWER_H
