#ifndef HIDL_GENERATED_ANDROID_HARDWARE_SENSORS_V1_0_ISENSORS_H
#define HIDL_GENERATED_ANDROID_HARDWARE_SENSORS_V1_0_ISENSORS_H
...
struct ISensors : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.sensors@1.0::ISensors"
     */
    ...
    /**
     * Return callback for poll
     */
    using poll_cb = std::function<void(::android::hardware::sensors::V1_0::Result result, const ::android::hardware::hidl_vec<::android::hardware::sensors::V1_0::Event>& data, const ::android::hardware::hidl_vec<::android::hardware::sensors::V1_0::SensorInfo>& dynamicSensorsAdded)>;
    /**
     ...
     *         in data.
     */
    virtual ::android::hardware::Return<void> poll(int32_t maxCount, poll_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::sensors::V1_0::ISensors>> castFrom(const ::android::sp<::android::hardware::sensors::V1_0::ISensors>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::sensors::V1_0::ISensors>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::sensors::V1_0::ISensors>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::sensors::V1_0::ISensors>& o) {
    ...
    os += ::android::hardware::sensors::V1_0::ISensors::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_SENSORS_V1_0_ISENSORS_H
