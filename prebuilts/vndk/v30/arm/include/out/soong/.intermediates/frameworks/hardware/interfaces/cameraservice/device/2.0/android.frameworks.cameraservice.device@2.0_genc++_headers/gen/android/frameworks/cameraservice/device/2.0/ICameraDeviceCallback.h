#ifndef HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_DEVICE_V2_0_ICAMERADEVICECALLBACK_H
#define HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_DEVICE_V2_0_ICAMERADEVICECALLBACK_H
...
struct ICameraDeviceCallback : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.frameworks.cameraservice.device@2.0::ICameraDeviceCallback"
     */
     ...
     */
    virtual ::android::hardware::Return<void> onDeviceError(::android::frameworks::cameraservice::device::V2_0::ErrorCode errorCode, const ::android::frameworks::cameraservice::device::V2_0::CaptureResultExtras& resultExtras) = 0;

    /**
     *  Callback called when the device is idle.
     */
    virtual ::android::hardware::Return<void> onDeviceIdle() = 0;
     ...
     */
    virtual ::android::hardware::Return<void> onCaptureStarted(const ::android::frameworks::cameraservice::device::V2_0::CaptureResultExtras& resultExtras, uint64_t timestamp) = 0;
     ...
     *        being stopped
     */
    virtual ::android::hardware::Return<void> onRepeatingRequestError(uint64_t lastFrameNumber, int32_t repeatingRequestId) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::device::V2_0::ICameraDeviceCallback>> castFrom(const ::android::sp<::android::frameworks::cameraservice::device::V2_0::ICameraDeviceCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::device::V2_0::ICameraDeviceCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::frameworks::cameraservice::device::V2_0::ICameraDeviceCallback>& o);
...
static inline std::string toString(const ::android::sp<::android::frameworks::cameraservice::device::V2_0::ICameraDeviceCallback>& o) {
    ...
    os += ::android::frameworks::cameraservice::device::V2_0::ICameraDeviceCallback::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_DEVICE_V2_0_ICAMERADEVICECALLBACK_H
