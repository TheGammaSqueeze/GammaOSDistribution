...
struct IStreamOut : public ::android::hardware::audio::V2_0::IStream {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio@2.0::IStreamOut"
     */
...
static inline void PrintTo(::android::hardware::audio::V2_0::IStreamOut::WriteCommand o, ::std::ostream* os);
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamOut::WriteStatus::Reply::PresentationPosition& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamOut::WriteStatus::Reply& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamOut::WriteStatus& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamOut::WriteStatus::Reply::PresentationPosition& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamOut::WriteStatus::Reply& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamOut::WriteStatus& o, ::std::ostream* os) {
    *os << toString(o);
}
...
template<> inline constexpr std::array<::android::hardware::audio::V2_0::IStreamOut::WriteCommand, 3> hidl_enum_values<::android::hardware::audio::V2_0::IStreamOut::WriteCommand> = {
