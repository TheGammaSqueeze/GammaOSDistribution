#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_MAPPER_V2_1_IMAPPER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_MAPPER_V2_1_IMAPPER_H
...
struct IMapper : public ::android::hardware::graphics::mapper::V2_0::IMapper {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.graphics.mapper@2.1::IMapper"
     */
    ...
    struct BufferDescriptorInfo final {
         ...
         * Buffer pixel format.
         */
        ::android::hardware::graphics::common::V1_1::PixelFormat format __attribute__ ((aligned(4)));
        /**
         * Buffer usage mask; valid flags can be found in the definition of
         * BufferUsage.
         */
        ::android::hardware::hidl_bitfield<::android::hardware::graphics::common::V1_1::BufferUsage> usage __attribute__ ((aligned(8)));
    };

    static_assert(offsetof(::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo, width) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo, height) == 4, "wrong offset");
    static_assert(offsetof(::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo, layerCount) == 8, "wrong offset");
    static_assert(offsetof(::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo, format) == 12, "wrong offset");
    static_assert(offsetof(::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo, usage) == 16, "wrong offset");
    static_assert(sizeof(::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo) == 24, "wrong size");
    static_assert(__alignof(::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo) == 8, "wrong alignment");
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::graphics::mapper::V2_0::Error> validateBufferSize(void* buffer, const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& descriptorInfo, uint32_t stride) = 0;

    /**
     * Return callback for getTransportSize
     */
    using getTransportSize_cb = std::function<void(::android::hardware::graphics::mapper::V2_0::Error error, uint32_t numFds, uint32_t numInts)>;
    /**
    ...
    /**
     * Return callback for createDescriptor_2_1
     */
    using createDescriptor_2_1_cb = std::function<void(::android::hardware::graphics::mapper::V2_0::Error error, const ::android::hardware::hidl_vec<uint32_t>& descriptor)>;
    /**
     ...
     * @return descriptor is the newly created buffer descriptor.
     */
    virtual ::android::hardware::Return<void> createDescriptor_2_1(const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& descriptorInfo, createDescriptor_2_1_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::mapper::V2_1::IMapper>> castFrom(const ::android::sp<::android::hardware::graphics::mapper::V2_1::IMapper>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::mapper::V2_1::IMapper>> castFrom(const ::android::sp<::android::hardware::graphics::mapper::V2_0::IMapper>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::mapper::V2_1::IMapper>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& o);
static inline void PrintTo(const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& lhs, const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& rhs);
static inline bool operator!=(const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& lhs, const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& rhs);

static inline std::string toString(const ::android::sp<::android::hardware::graphics::mapper::V2_1::IMapper>& o);
...
static inline std::string toString(const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& o) {
    ...
    os += ", .format = ";
    os += ::android::hardware::graphics::common::V1_1::toString(o.format);
    os += ", .usage = ";
    os += ::android::hardware::graphics::common::V1_1::toString<::android::hardware::graphics::common::V1_1::BufferUsage>(o.usage);
    os += "}"; return os;
}

static inline void PrintTo(const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::graphics::mapper::V2_1::IMapper>& o) {
    ...
    os += ::android::hardware::graphics::mapper::V2_1::IMapper::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_MAPPER_V2_1_IMAPPER_H
