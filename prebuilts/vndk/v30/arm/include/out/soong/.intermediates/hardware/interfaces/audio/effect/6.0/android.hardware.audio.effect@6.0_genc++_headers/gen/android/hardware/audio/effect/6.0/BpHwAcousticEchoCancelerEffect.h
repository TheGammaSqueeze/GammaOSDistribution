#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_BPHWACOUSTICECHOCANCELEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_BPHWACOUSTICECHOCANCELEREFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/6.0/IHwAcousticEchoCancelerEffect.h>
...
struct BpHwAcousticEchoCancelerEffect : public ::android::hardware::BpInterface<IAcousticEchoCancelerEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result>  _hidl_setEchoDelay(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t echoDelayMs);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_BPHWACOUSTICECHOCANCELEREFFECT_H
