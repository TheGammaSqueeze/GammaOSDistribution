#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_V1_0_BPHWBLUETOOTHHCICALLBACKS_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_V1_0_BPHWBLUETOOTHHCICALLBACKS_H
...
struct BpHwBluetoothHciCallbacks : public ::android::hardware::BpInterface<IBluetoothHciCallbacks>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_initializationComplete(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::bluetooth::V1_0::Status status);
    ...
    static ::android::hardware::Return<void>  _hidl_aclDataReceived(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& data);
    static ::android::hardware::Return<void>  _hidl_scoDataReceived(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& data);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_V1_0_BPHWBLUETOOTHHCICALLBACKS_H
