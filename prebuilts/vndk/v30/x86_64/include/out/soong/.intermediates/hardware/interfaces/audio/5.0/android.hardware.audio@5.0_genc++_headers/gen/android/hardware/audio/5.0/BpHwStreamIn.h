#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWSTREAMIN_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWSTREAMIN_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/5.0/IHwStreamIn.h>
...
struct BpHwStreamIn : public ::android::hardware::BpInterface<IStreamIn>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setGain(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float gain);
    static ::android::hardware::Return<void>  _hidl_updateSinkMetadata(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V5_0::SinkMetadata& sinkMetadata);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setMicrophoneDirection(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::V5_0::MicrophoneDirection direction);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setMicrophoneFieldDimension(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float zoom);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWSTREAMIN_H
