#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_IDOWNMIXEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_IDOWNMIXEFFECT_H
...
struct IDownmixEffect : public ::android::hardware::audio::effect::V4_0::IEffect {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@4.0::IDownmixEffect"
     */
    ...
    enum class Type : int32_t {
        STRIP = 0,
        FOLD = 1 /* ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type.STRIP implicitly + 1 */,
    };
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setType(::android::hardware::audio::effect::V4_0::IDownmixEffect::Type preset) = 0;

    /**
     * Return callback for getType
     */
    using getType_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type preset)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::IDownmixEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::IDownmixEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::IDownmixEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::IEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::IDownmixEffect>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(::android::hardware::audio::effect::V4_0::IDownmixEffect::Type o);
static inline void PrintTo(::android::hardware::audio::effect::V4_0::IDownmixEffect::Type o, ::std::ostream* os);
constexpr int32_t operator|(const ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type lhs, const ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const int32_t lhs, const ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type rhs) {
    return static_cast<int32_t>(lhs | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type lhs, const int32_t rhs) {
...
constexpr int32_t &operator|=(int32_t& v, const ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type e) {
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V4_0::IDownmixEffect>& o);
...
template<>
inline std::string toString<::android::hardware::audio::effect::V4_0::IDownmixEffect::Type>(int32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::effect::V4_0::IDownmixEffect::Type> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type::STRIP) == static_cast<int32_t>(::android::hardware::audio::effect::V4_0::IDownmixEffect::Type::STRIP)) {
        os += (first ? "" : " | ");
        os += "STRIP";
        first = false;
        flipped |= ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type::STRIP;
    }
    if ((o & ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type::FOLD) == static_cast<int32_t>(::android::hardware::audio::effect::V4_0::IDownmixEffect::Type::FOLD)) {
        os += (first ? "" : " | ");
        os += "FOLD";
        first = false;
        flipped |= ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type::FOLD;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
...
static inline std::string toString(::android::hardware::audio::effect::V4_0::IDownmixEffect::Type o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type::STRIP) {
        return "STRIP";
    }
    if (o == ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type::FOLD) {
        return "FOLD";
    }
    std::string os;
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V4_0::IDownmixEffect>& o) {
    ...
    os += ::android::hardware::audio::effect::V4_0::IDownmixEffect::descriptor;
    os += "]";
...
template<> inline constexpr std::array<::android::hardware::audio::effect::V4_0::IDownmixEffect::Type, 2> hidl_enum_values<::android::hardware::audio::effect::V4_0::IDownmixEffect::Type> = {
    ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type::STRIP,
    ::android::hardware::audio::effect::V4_0::IDownmixEffect::Type::FOLD,
};
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_IDOWNMIXEFFECT_H
