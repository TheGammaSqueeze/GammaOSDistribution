#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V2_0_BPHWSTREAM_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V2_0_BPHWSTREAM_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/2.0/IHwStream.h>
...
struct BpHwStream : public ::android::hardware::BpInterface<IStream>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_getSupportedSampleRates(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getSupportedSampleRates_cb _hidl_cb);
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_setSampleRate(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t sampleRateHz);
    static ::android::hardware::Return<::android::hardware::audio::common::V2_0::AudioChannelMask>  _hidl_getChannelMask(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<void>  _hidl_getSupportedChannelMasks(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getSupportedChannelMasks_cb _hidl_cb);
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_setChannelMask(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::common::V2_0::AudioChannelMask mask);
    static ::android::hardware::Return<::android::hardware::audio::common::V2_0::AudioFormat>  _hidl_getFormat(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_setFormat(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::common::V2_0::AudioFormat format);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_addEffect(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t effectId);
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_removeEffect(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t effectId);
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_standby(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::hardware::audio::common::V2_0::AudioDevice>  _hidl_getDevice(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_setDevice(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::V2_0::DeviceAddress& address);
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_setConnectedState(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::V2_0::DeviceAddress& address, bool connected);
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_setHwAvSync(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t hwAvSync);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_setParameters(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::audio::V2_0::ParameterValue>& parameters);
    static ::android::hardware::Return<void>  _hidl_debugDump(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_handle& fd);
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_start(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_stop(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V2_0::Result>  _hidl_close(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V2_0_BPHWSTREAM_H
