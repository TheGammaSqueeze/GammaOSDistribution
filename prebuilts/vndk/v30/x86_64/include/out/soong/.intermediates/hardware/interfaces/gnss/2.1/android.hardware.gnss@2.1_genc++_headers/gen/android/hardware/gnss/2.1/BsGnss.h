#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_1_BSGNSS_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_1_BSGNSS_H
...
struct BsGnss : IGnss, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<bool> setCallback_1_1(const ::android::sp<::android::hardware::gnss::V1_1::IGnssCallback>& callback) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::setCallback_1_1::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&callback);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "1.1", "IGnss", "setCallback_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::sp<::android::hardware::gnss::V1_1::IGnssCallback> _hidl_wrapped_callback;
        if (callback != nullptr && !callback->isRemote()) {
            _hidl_wrapped_callback = ::android::hardware::details::wrapPassthrough(callback);
            if (_hidl_wrapped_callback == nullptr) {
                return ::android::hardware::Status::fromExceptionCode(
        ...
        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->setCallback_1_1(_hidl_wrapped_callback);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "1.1", "IGnss", "setCallback_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> setPositionMode_1_1(::android::hardware::gnss::V1_0::IGnss::GnssPositionMode mode, ::android::hardware::gnss::V1_0::IGnss::GnssPositionRecurrence recurrence, uint32_t minIntervalMs, uint32_t preferredAccuracyMeters, uint32_t preferredTimeMs, bool lowPowerMode) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::setPositionMode_1_1::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&mode);
            ...
            _hidl_args.push_back((void *)&preferredAccuracyMeters);
            _hidl_args.push_back((void *)&preferredTimeMs);
            _hidl_args.push_back((void *)&lowPowerMode);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "1.1", "IGnss", "setPositionMode_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->setPositionMode_1_1(mode, recurrence, minIntervalMs, preferredAccuracyMeters, preferredTimeMs, lowPowerMode);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "1.1", "IGnss", "setPositionMode_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration>> getExtensionGnssConfiguration_1_1() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssConfiguration_1_1::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "1.1", "IGnss", "getExtensionGnssConfiguration_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionGnssConfiguration_1_1();

        ::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration> _hidl_out_gnssConfigurationIface = _hidl_return;
        (void) _hidl_out_gnssConfigurationIface;
        ::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration> _hidl_wrapped__hidl_out_gnssConfigurationIface;
        if (_hidl_out_gnssConfigurationIface != nullptr && !_hidl_out_gnssConfigurationIface->isRemote()) {
            _hidl_wrapped__hidl_out_gnssConfigurationIface = ::android::hardware::details::wrapPassthrough(_hidl_out_gnssConfigurationIface);
            if (_hidl_wrapped__hidl_out_gnssConfigurationIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
                        ::android::hardware::Status::EX_TRANSACTION_FAILED,
                        "Cannot wrap passthrough interface.");
            }
        } else {
            _hidl_wrapped__hidl_out_gnssConfigurationIface = _hidl_out_gnssConfigurationIface;
        }

        _hidl_out_gnssConfigurationIface = _hidl_wrapped__hidl_out_gnssConfigurationIface;

        _hidl_return = _hidl_out_gnssConfigurationIface
        ;atrace_end(ATRACE_TAG_HAL);
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "1.1", "IGnss", "getExtensionGnssConfiguration_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurement>> getExtensionGnssMeasurement_1_1() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssMeasurement_1_1::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "1.1", "IGnss", "getExtensionGnssMeasurement_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionGnssMeasurement_1_1();

        ::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurement> _hidl_out_gnssMeasurementIface = _hidl_return;
        (void) _hidl_out_gnssMeasurementIface;
        ::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurement> _hidl_wrapped__hidl_out_gnssMeasurementIface;
        if (_hidl_out_gnssMeasurementIface != nullptr && !_hidl_out_gnssMeasurementIface->isRemote()) {
            _hidl_wrapped__hidl_out_gnssMeasurementIface = ::android::hardware::details::wrapPassthrough(_hidl_out_gnssMeasurementIface);
            if (_hidl_wrapped__hidl_out_gnssMeasurementIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_gnssMeasurementIface);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "1.1", "IGnss", "getExtensionGnssMeasurement_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> injectBestLocation(const ::android::hardware::gnss::V1_0::GnssLocation& location) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::injectBestLocation::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&location);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "1.1", "IGnss", "injectBestLocation", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->injectBestLocation(location);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "1.1", "IGnss", "injectBestLocation", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> setCallback_2_0(const ::android::sp<::android::hardware::gnss::V2_0::IGnssCallback>& callback) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::setCallback_2_0::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&callback);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.0", "IGnss", "setCallback_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::sp<::android::hardware::gnss::V2_0::IGnssCallback> _hidl_wrapped_callback;
        if (callback != nullptr && !callback->isRemote()) {
            _hidl_wrapped_callback = ::android::hardware::details::wrapPassthrough(callback);
            if (_hidl_wrapped_callback == nullptr) {
                return ::android::hardware::Status::fromExceptionCode(
        ...
        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->setCallback_2_0(_hidl_wrapped_callback);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.0", "IGnss", "setCallback_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssConfiguration>> getExtensionGnssConfiguration_2_0() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssConfiguration_2_0::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.0", "IGnss", "getExtensionGnssConfiguration_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionGnssConfiguration_2_0();

        ::android::sp<::android::hardware::gnss::V2_0::IGnssConfiguration> _hidl_out_gnssConfigurationIface = _hidl_return;
        (void) _hidl_out_gnssConfigurationIface;
        ::android::sp<::android::hardware::gnss::V2_0::IGnssConfiguration> _hidl_wrapped__hidl_out_gnssConfigurationIface;
        if (_hidl_out_gnssConfigurationIface != nullptr && !_hidl_out_gnssConfigurationIface->isRemote()) {
            _hidl_wrapped__hidl_out_gnssConfigurationIface = ::android::hardware::details::wrapPassthrough(_hidl_out_gnssConfigurationIface);
            if (_hidl_wrapped__hidl_out_gnssConfigurationIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_gnssConfigurationIface);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.0", "IGnss", "getExtensionGnssConfiguration_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssDebug>> getExtensionGnssDebug_2_0() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssDebug_2_0::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.0", "IGnss", "getExtensionGnssDebug_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionGnssDebug_2_0();

        ::android::sp<::android::hardware::gnss::V2_0::IGnssDebug> _hidl_out_gnssDebugIface = _hidl_return;
        (void) _hidl_out_gnssDebugIface;
        ::android::sp<::android::hardware::gnss::V2_0::IGnssDebug> _hidl_wrapped__hidl_out_gnssDebugIface;
        if (_hidl_out_gnssDebugIface != nullptr && !_hidl_out_gnssDebugIface->isRemote()) {
            _hidl_wrapped__hidl_out_gnssDebugIface = ::android::hardware::details::wrapPassthrough(_hidl_out_gnssDebugIface);
            if (_hidl_wrapped__hidl_out_gnssDebugIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
                        ::android::hardware::Status::EX_TRANSACTION_FAILED,
                        "Cannot wrap passthrough interface.");
            }
        } else {
            _hidl_wrapped__hidl_out_gnssDebugIface = _hidl_out_gnssDebugIface;
        }

        _hidl_out_gnssDebugIface = _hidl_wrapped__hidl_out_gnssDebugIface;

        _hidl_return = _hidl_out_gnssDebugIface
        ;atrace_end(ATRACE_TAG_HAL);
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.0", "IGnss", "getExtensionGnssDebug_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IAGnss>> getExtensionAGnss_2_0() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionAGnss_2_0::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.0", "IGnss", "getExtensionAGnss_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionAGnss_2_0();

        ::android::sp<::android::hardware::gnss::V2_0::IAGnss> _hidl_out_aGnssIface = _hidl_return;
        (void) _hidl_out_aGnssIface;
        ::android::sp<::android::hardware::gnss::V2_0::IAGnss> _hidl_wrapped__hidl_out_aGnssIface;
        if (_hidl_out_aGnssIface != nullptr && !_hidl_out_aGnssIface->isRemote()) {
            _hidl_wrapped__hidl_out_aGnssIface = ::android::hardware::details::wrapPassthrough(_hidl_out_aGnssIface);
            if (_hidl_wrapped__hidl_out_aGnssIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_aGnssIface);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.0", "IGnss", "getExtensionAGnss_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IAGnssRil>> getExtensionAGnssRil_2_0() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionAGnssRil_2_0::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.0", "IGnss", "getExtensionAGnssRil_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionAGnssRil_2_0();

        ::android::sp<::android::hardware::gnss::V2_0::IAGnssRil> _hidl_out_aGnssRilIface = _hidl_return;
        (void) _hidl_out_aGnssRilIface;
        ::android::sp<::android::hardware::gnss::V2_0::IAGnssRil> _hidl_wrapped__hidl_out_aGnssRilIface;
        if (_hidl_out_aGnssRilIface != nullptr && !_hidl_out_aGnssRilIface->isRemote()) {
            _hidl_wrapped__hidl_out_aGnssRilIface = ::android::hardware::details::wrapPassthrough(_hidl_out_aGnssRilIface);
            if (_hidl_wrapped__hidl_out_aGnssRilIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_aGnssRilIface);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.0", "IGnss", "getExtensionAGnssRil_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssMeasurement>> getExtensionGnssMeasurement_2_0() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssMeasurement_2_0::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.0", "IGnss", "getExtensionGnssMeasurement_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionGnssMeasurement_2_0();

        ::android::sp<::android::hardware::gnss::V2_0::IGnssMeasurement> _hidl_out_gnssMeasurementIface = _hidl_return;
        (void) _hidl_out_gnssMeasurementIface;
        ::android::sp<::android::hardware::gnss::V2_0::IGnssMeasurement> _hidl_wrapped__hidl_out_gnssMeasurementIface;
        if (_hidl_out_gnssMeasurementIface != nullptr && !_hidl_out_gnssMeasurementIface->isRemote()) {
            _hidl_wrapped__hidl_out_gnssMeasurementIface = ::android::hardware::details::wrapPassthrough(_hidl_out_gnssMeasurementIface);
            if (_hidl_wrapped__hidl_out_gnssMeasurementIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_gnssMeasurementIface);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.0", "IGnss", "getExtensionGnssMeasurement_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::measurement_corrections::V1_0::IMeasurementCorrections>> getExtensionMeasurementCorrections() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionMeasurementCorrections::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.0", "IGnss", "getExtensionMeasurementCorrections", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionMeasurementCorrections();

        ::android::sp<::android::hardware::gnss::measurement_corrections::V1_0::IMeasurementCorrections> _hidl_out_measurementCorrectionsIface = _hidl_return;
        (void) _hidl_out_measurementCorrectionsIface;
        ::android::sp<::android::hardware::gnss::measurement_corrections::V1_0::IMeasurementCorrections> _hidl_wrapped__hidl_out_measurementCorrectionsIface;
        if (_hidl_out_measurementCorrectionsIface != nullptr && !_hidl_out_measurementCorrectionsIface->isRemote()) {
            _hidl_wrapped__hidl_out_measurementCorrectionsIface = ::android::hardware::details::wrapPassthrough(_hidl_out_measurementCorrectionsIface);
            if (_hidl_wrapped__hidl_out_measurementCorrectionsIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
                        ::android::hardware::Status::EX_TRANSACTION_FAILED,
                        "Cannot wrap passthrough interface.");
            }
        } else {
            _hidl_wrapped__hidl_out_measurementCorrectionsIface = _hidl_out_measurementCorrectionsIface;
        }

        _hidl_out_measurementCorrectionsIface = _hidl_wrapped__hidl_out_measurementCorrectionsIface;

        _hidl_return = _hidl_out_measurementCorrectionsIface
        ;atrace_end(ATRACE_TAG_HAL);
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.0", "IGnss", "getExtensionMeasurementCorrections", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::visibility_control::V1_0::IGnssVisibilityControl>> getExtensionVisibilityControl() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionVisibilityControl::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.0", "IGnss", "getExtensionVisibilityControl", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionVisibilityControl();

        ::android::sp<::android::hardware::gnss::visibility_control::V1_0::IGnssVisibilityControl> _hidl_out_visibilityControlIface = _hidl_return;
        (void) _hidl_out_visibilityControlIface;
        ::android::sp<::android::hardware::gnss::visibility_control::V1_0::IGnssVisibilityControl> _hidl_wrapped__hidl_out_visibilityControlIface;
        if (_hidl_out_visibilityControlIface != nullptr && !_hidl_out_visibilityControlIface->isRemote()) {
            _hidl_wrapped__hidl_out_visibilityControlIface = ::android::hardware::details::wrapPassthrough(_hidl_out_visibilityControlIface);
            if (_hidl_wrapped__hidl_out_visibilityControlIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
                        ::android::hardware::Status::EX_TRANSACTION_FAILED,
                        "Cannot wrap passthrough interface.");
            }
        } else {
            _hidl_wrapped__hidl_out_visibilityControlIface = _hidl_out_visibilityControlIface;
        }

        _hidl_out_visibilityControlIface = _hidl_wrapped__hidl_out_visibilityControlIface;

        _hidl_return = _hidl_out_visibilityControlIface
        ;atrace_end(ATRACE_TAG_HAL);
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.0", "IGnss", "getExtensionVisibilityControl", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssBatching>> getExtensionGnssBatching_2_0() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssBatching_2_0::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.0", "IGnss", "getExtensionGnssBatching_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionGnssBatching_2_0();

        ::android::sp<::android::hardware::gnss::V2_0::IGnssBatching> _hidl_out_batchingIface = _hidl_return;
        (void) _hidl_out_batchingIface;
        ::android::sp<::android::hardware::gnss::V2_0::IGnssBatching> _hidl_wrapped__hidl_out_batchingIface;
        if (_hidl_out_batchingIface != nullptr && !_hidl_out_batchingIface->isRemote()) {
            _hidl_wrapped__hidl_out_batchingIface = ::android::hardware::details::wrapPassthrough(_hidl_out_batchingIface);
            if (_hidl_wrapped__hidl_out_batchingIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_batchingIface);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.0", "IGnss", "getExtensionGnssBatching_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> injectBestLocation_2_0(const ::android::hardware::gnss::V2_0::GnssLocation& location) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::injectBestLocation_2_0::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&location);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.0", "IGnss", "injectBestLocation_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->injectBestLocation_2_0(location);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.0", "IGnss", "injectBestLocation_2_0", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<bool> setCallback_2_1(const ::android::sp<::android::hardware::gnss::V2_1::IGnssCallback>& callback) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::setCallback_2_1::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&callback);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "setCallback_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::sp<::android::hardware::gnss::V2_1::IGnssCallback> _hidl_wrapped_callback;
        if (callback != nullptr && !callback->isRemote()) {
            _hidl_wrapped_callback = ::android::hardware::details::wrapPassthrough(callback);
            if (_hidl_wrapped_callback == nullptr) {
                return ::android::hardware::Status::fromExceptionCode(
        ...
        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->setCallback_2_1(_hidl_wrapped_callback);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_success);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.1", "IGnss", "setCallback_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>> getExtensionGnssMeasurement_2_1() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssMeasurement_2_1::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssMeasurement_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionGnssMeasurement_2_1();

        ::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement> _hidl_out_gnssMeasurementIface = _hidl_return;
        (void) _hidl_out_gnssMeasurementIface;
        ::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement> _hidl_wrapped__hidl_out_gnssMeasurementIface;
        if (_hidl_out_gnssMeasurementIface != nullptr && !_hidl_out_gnssMeasurementIface->isRemote()) {
            _hidl_wrapped__hidl_out_gnssMeasurementIface = ::android::hardware::details::wrapPassthrough(_hidl_out_gnssMeasurementIface);
            if (_hidl_wrapped__hidl_out_gnssMeasurementIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_gnssMeasurementIface);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssMeasurement_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration>> getExtensionGnssConfiguration_2_1() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssConfiguration_2_1::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssConfiguration_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionGnssConfiguration_2_1();

        ::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration> _hidl_out_gnssConfigurationIface = _hidl_return;
        (void) _hidl_out_gnssConfigurationIface;
        ::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration> _hidl_wrapped__hidl_out_gnssConfigurationIface;
        if (_hidl_out_gnssConfigurationIface != nullptr && !_hidl_out_gnssConfigurationIface->isRemote()) {
            _hidl_wrapped__hidl_out_gnssConfigurationIface = ::android::hardware::details::wrapPassthrough(_hidl_out_gnssConfigurationIface);
            if (_hidl_wrapped__hidl_out_gnssConfigurationIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_gnssConfigurationIface);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssConfiguration_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections>> getExtensionMeasurementCorrections_1_1() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionMeasurementCorrections_1_1::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionMeasurementCorrections_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionMeasurementCorrections_1_1();

        ::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections> _hidl_out_measurementCorrectionsIface = _hidl_return;
        (void) _hidl_out_measurementCorrectionsIface;
        ::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections> _hidl_wrapped__hidl_out_measurementCorrectionsIface;
        if (_hidl_out_measurementCorrectionsIface != nullptr && !_hidl_out_measurementCorrectionsIface->isRemote()) {
            _hidl_wrapped__hidl_out_measurementCorrectionsIface = ::android::hardware::details::wrapPassthrough(_hidl_out_measurementCorrectionsIface);
            if (_hidl_wrapped__hidl_out_measurementCorrectionsIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_measurementCorrectionsIface);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionMeasurementCorrections_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo>> getExtensionGnssAntennaInfo() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssAntennaInfo::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssAntennaInfo", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->getExtensionGnssAntennaInfo();

        ::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo> _hidl_out_gnssAntennaInfoIface = _hidl_return;
        (void) _hidl_out_gnssAntennaInfoIface;
        ::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo> _hidl_wrapped__hidl_out_gnssAntennaInfoIface;
        if (_hidl_out_gnssAntennaInfoIface != nullptr && !_hidl_out_gnssAntennaInfoIface->isRemote()) {
            _hidl_wrapped__hidl_out_gnssAntennaInfoIface = ::android::hardware::details::wrapPassthrough(_hidl_out_gnssAntennaInfoIface);
            if (_hidl_wrapped__hidl_out_gnssAntennaInfoIface == nullptr) {
                _hidl_error = ::android::hardware::Status::fromExceptionCode(
                        ::android::hardware::Status::EX_TRANSACTION_FAILED,
                        "Cannot wrap passthrough interface.");
            }
        } else {
            _hidl_wrapped__hidl_out_gnssAntennaInfoIface = _hidl_out_gnssAntennaInfoIface;
        }

        _hidl_out_gnssAntennaInfoIface = _hidl_wrapped__hidl_out_gnssAntennaInfoIface;

        _hidl_return = _hidl_out_gnssAntennaInfoIface
        ;atrace_end(ATRACE_TAG_HAL);
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssAntennaInfo", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_1_BSGNSS_H
