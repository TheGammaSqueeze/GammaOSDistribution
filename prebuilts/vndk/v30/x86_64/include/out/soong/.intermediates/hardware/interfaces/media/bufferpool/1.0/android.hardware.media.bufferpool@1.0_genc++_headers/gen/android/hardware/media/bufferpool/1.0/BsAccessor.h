#ifndef HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_BUFFERPOOL_V1_0_BSACCESSOR_H
#define HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_BUFFERPOOL_V1_0_BSACCESSOR_H
    ...
    ::android::hardware::Return<void> connect(connect_cb _hidl_cb) override {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.media.bufferpool", "1.0", "IAccessor", "connect", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->connect([&](const auto &_hidl_out_status, const auto &_hidl_out_connection, const auto &_hidl_out_connectionId, const auto &_hidl_out_mqDesc) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.media.bufferpool", "1.0", "IAccessor", "connect", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__

            ::android::sp<::android::hardware::media::bufferpool::V1_0::IConnection> _hidl_wrapped__hidl_out_connection;
            ...
            _hidl_cb(_hidl_out_status, _hidl_wrapped__hidl_out_connection, _hidl_out_connectionId, _hidl_out_mqDesc);
        });
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_BUFFERPOOL_V1_0_BSACCESSOR_H
