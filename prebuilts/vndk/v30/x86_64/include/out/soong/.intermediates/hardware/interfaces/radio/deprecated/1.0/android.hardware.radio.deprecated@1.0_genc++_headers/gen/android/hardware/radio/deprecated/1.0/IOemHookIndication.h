...
struct IOemHookIndication : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio.deprecated@1.0::IOemHookIndication"
     */
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::deprecated::V1_0::IOemHookIndication>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::deprecated::V1_0::IOemHookIndication>& o) {
    ...
    os += ::android::hardware::radio::deprecated::V1_0::IOemHookIndication::descriptor;
    os += "]";
