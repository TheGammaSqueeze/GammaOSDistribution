#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_1_ISUPPLICANT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_1_ISUPPLICANT_H
 ...
 */
struct ISupplicant : public ::android::hardware::wifi::supplicant::V1_0::ISupplicant {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi.supplicant@1.1::ISupplicant"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicant>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicant>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicant>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_0::ISupplicant>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicant>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicant>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicant>& o) {
    ...
    os += ::android::hardware::wifi::supplicant::V1_1::ISupplicant::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_1_ISUPPLICANT_H
