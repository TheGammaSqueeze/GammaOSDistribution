#ifndef HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_SERVICE_V2_1_ICAMERASERVICE_H
#define HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_SERVICE_V2_1_ICAMERASERVICE_H
...
struct ICameraService : public ::android::frameworks::cameraservice::service::V2_0::ICameraService {
    /**
    ...
    /**
     * Fully qualified interface name: "android.frameworks.cameraservice.service@2.1::ICameraService"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>> castFrom(const ::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>> castFrom(const ::android::sp<::android::frameworks::cameraservice::service::V2_0::ICameraService>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>& o);
...
static inline std::string toString(const ::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>& o) {
    ...
    os += ::android::frameworks::cameraservice::service::V2_1::ICameraService::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_SERVICE_V2_1_ICAMERASERVICE_H
