#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V5_0_BSDOWNMIXEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V5_0_BSDOWNMIXEFFECT_H

#include <android-base/macros.h>
#include <cutils/trace.h>
#include <future>
#include <android/hardware/audio/effect/5.0/IDownmixEffect.h>
...
struct BsDownmixEffect : IDownmixEffect, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<::android::hardware::audio::effect::V5_0::Result> setType(::android::hardware::audio::effect::V5_0::IDownmixEffect::Type preset) override {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.audio.effect", "5.0", "IDownmixEffect", "setType", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_retval);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.audio.effect", "5.0", "IDownmixEffect", "setType", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> getType(getType_cb _hidl_cb) override {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.audio.effect", "5.0", "IDownmixEffect", "getType", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->getType([&](const auto &_hidl_out_retval, const auto &_hidl_out_preset) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.audio.effect", "5.0", "IDownmixEffect", "getType", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V5_0_BSDOWNMIXEFFECT_H
