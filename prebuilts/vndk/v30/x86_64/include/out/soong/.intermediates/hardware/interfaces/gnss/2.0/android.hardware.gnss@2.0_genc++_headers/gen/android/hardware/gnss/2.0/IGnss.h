#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_0_IGNSS_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_0_IGNSS_H
 ...
 */
struct IGnss : public ::android::hardware::gnss::V1_1::IGnss {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.gnss@2.0::IGnss"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnss>> castFrom(const ::android::sp<::android::hardware::gnss::V2_0::IGnss>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnss>> castFrom(const ::android::sp<::android::hardware::gnss::V1_1::IGnss>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnss>> castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnss>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnss>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::gnss::V2_0::IGnss>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::gnss::V2_0::IGnss>& o) {
    ...
    os += ::android::hardware::gnss::V2_0::IGnss::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_0_IGNSS_H
