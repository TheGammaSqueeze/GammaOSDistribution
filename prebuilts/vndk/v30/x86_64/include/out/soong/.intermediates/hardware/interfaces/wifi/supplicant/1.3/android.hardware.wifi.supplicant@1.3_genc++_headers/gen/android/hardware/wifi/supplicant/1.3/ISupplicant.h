#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_3_ISUPPLICANT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_3_ISUPPLICANT_H
 ...
 */
struct ISupplicant : public ::android::hardware::wifi::supplicant::V1_2::ISupplicant {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi.supplicant@1.3::ISupplicant"
     */
    ...
    /**
     * Return callback for addInterface
     */
    using addInterface_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status, const ::android::sp<::android::hardware::wifi::supplicant::V1_0::ISupplicantIface>& iface)>;
    /**
     ...
     *         successful, null otherwise.
     */
    virtual ::android::hardware::Return<void> addInterface(const ::android::hardware::wifi::supplicant::V1_0::ISupplicant::IfaceInfo& ifaceInfo, addInterface_cb _hidl_cb) = 0;

    /**
     * Return callback for removeInterface
     */
    using removeInterface_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status)>;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_IFACE_UNKOWN|
     */
    virtual ::android::hardware::Return<void> removeInterface(const ::android::hardware::wifi::supplicant::V1_0::ISupplicant::IfaceInfo& ifaceInfo, removeInterface_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicant>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicant>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicant>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_2::ISupplicant>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicant>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicant>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicant>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_0::ISupplicant>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicant>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicant>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicant>& o) {
    ...
    os += ::android::hardware::wifi::supplicant::V1_3::ISupplicant::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_3_ISUPPLICANT_H
