#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUTOMOTIVE_EVS_V1_0_IEVSENUMERATOR_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUTOMOTIVE_EVS_V1_0_IEVSENUMERATOR_H
 ...
 */
struct IEvsEnumerator : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.automotive.evs@1.0::IEvsEnumerator"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::automotive::evs::V1_0::IEvsEnumerator>> castFrom(const ::android::sp<::android::hardware::automotive::evs::V1_0::IEvsEnumerator>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::automotive::evs::V1_0::IEvsEnumerator>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::automotive::evs::V1_0::IEvsEnumerator>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::automotive::evs::V1_0::IEvsEnumerator>& o) {
    ...
    os += ::android::hardware::automotive::evs::V1_0::IEvsEnumerator::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUTOMOTIVE_EVS_V1_0_IEVSENUMERATOR_H
