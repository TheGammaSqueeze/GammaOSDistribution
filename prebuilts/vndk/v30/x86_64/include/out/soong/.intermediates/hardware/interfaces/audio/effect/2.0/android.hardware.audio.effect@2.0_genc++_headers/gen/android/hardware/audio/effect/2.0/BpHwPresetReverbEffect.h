#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWPRESETREVERBEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWPRESETREVERBEFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/2.0/IHwPresetReverbEffect.h>
...
struct BpHwPresetReverbEffect : public ::android::hardware::BpInterface<IPresetReverbEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result>  _hidl_setPreset(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::effect::V2_0::IPresetReverbEffect::Preset preset);
    ...
    // Methods from ::android::hardware::audio::effect::V2_0::IPresetReverbEffect follow.
    ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result> setPreset(::android::hardware::audio::effect::V2_0::IPresetReverbEffect::Preset preset) override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWPRESETREVERBEFFECT_H
