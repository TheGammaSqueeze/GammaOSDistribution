#ifndef HIDL_GENERATED_ANDROID_HARDWARE_NEURALNETWORKS_V1_3_BPHWEXECUTIONCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_NEURALNETWORKS_V1_3_BPHWEXECUTIONCALLBACK_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/neuralnetworks/1.3/IHwExecutionCallback.h>
...
struct BpHwExecutionCallback : public ::android::hardware::BpInterface<IExecutionCallback>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_notify_1_3(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::neuralnetworks::V1_3::ErrorStatus status, const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_2::OutputShape>& outputShapes, const ::android::hardware::neuralnetworks::V1_2::Timing& timing);
    ...
    // Methods from ::android::hardware::neuralnetworks::V1_3::IExecutionCallback follow.
    ::android::hardware::Return<void> notify_1_3(::android::hardware::neuralnetworks::V1_3::ErrorStatus status, const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_2::OutputShape>& outputShapes, const ::android::hardware::neuralnetworks::V1_2::Timing& timing) override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_NEURALNETWORKS_V1_3_BPHWEXECUTIONCALLBACK_H
