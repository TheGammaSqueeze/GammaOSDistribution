#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V2_0_BSSTREAM_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V2_0_BSSTREAM_H
...
struct BsStream : IStream, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<::android::hardware::audio::common::V2_0::AudioDevice> getDevice() override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IStream::getDevice::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
    ...
    ::android::hardware::Return<::android::hardware::audio::V2_0::Result> setDevice(const ::android::hardware::audio::V2_0::DeviceAddress& address) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IStream::setDevice::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
    ...
    ::android::hardware::Return<::android::hardware::audio::V2_0::Result> setConnectedState(const ::android::hardware::audio::V2_0::DeviceAddress& address, bool connected) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IStream::setConnectedState::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&address);
    ...
    ::android::hardware::Return<void> debugDump(const ::android::hardware::hidl_handle& fd) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IStream::debugDump::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V2_0_BSSTREAM_H
