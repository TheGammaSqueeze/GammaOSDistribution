#ifndef HIDL_GENERATED_ANDROID_HARDWARE_SECURE_ELEMENT_V1_2_BPHWSECUREELEMENT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_SECURE_ELEMENT_V1_2_BPHWSECUREELEMENT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/secure_element/1.2/IHwSecureElement.h>
...
struct BpHwSecureElement : public ::android::hardware::BpInterface<ISecureElement>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::secure_element::V1_0::SecureElementStatus>  _hidl_reset(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    // Methods from ::android::hardware::secure_element::V1_2::ISecureElement follow.
    ::android::hardware::Return<::android::hardware::secure_element::V1_0::SecureElementStatus> reset() override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_SECURE_ELEMENT_V1_2_BPHWSECUREELEMENT_H
