#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_IWIFI_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_IWIFI_H
 ...
 * or @1.2:IWifiChip
 */
struct IWifi : public ::android::hardware::wifi::V1_1::IWifi {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi@1.2::IWifi"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifi>> castFrom(const ::android::sp<::android::hardware::wifi::V1_2::IWifi>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifi>> castFrom(const ::android::sp<::android::hardware::wifi::V1_1::IWifi>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifi>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifi>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifi>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_2::IWifi>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_2::IWifi>& o) {
    ...
    os += ::android::hardware::wifi::V1_2::IWifi::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_IWIFI_H
