#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_2_BPHWSUPPLICANTSTANETWORK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_2_BPHWSUPPLICANTSTANETWORK_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/wifi/supplicant/1.2/IHwSupplicantStaNetwork.h>
...
struct BpHwSupplicantStaNetwork : public ::android::hardware::BpInterface<ISupplicantStaNetwork>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_setKeyMgmt_1_2(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::hidl_bitfield<::android::hardware::wifi::supplicant::V1_2::ISupplicantStaNetwork::KeyMgmtMask> keyMgmtMask, setKeyMgmt_1_2_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getKeyMgmt_1_2(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getKeyMgmt_1_2_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_setPairwiseCipher_1_2(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::hidl_bitfield<::android::hardware::wifi::supplicant::V1_2::ISupplicantStaNetwork::PairwiseCipherMask> pairwiseCipherMask, setPairwiseCipher_1_2_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getPairwiseCipher_1_2(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getPairwiseCipher_1_2_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_setGroupCipher_1_2(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::hidl_bitfield<::android::hardware::wifi::supplicant::V1_2::ISupplicantStaNetwork::GroupCipherMask> groupCipherMask, setGroupCipher_1_2_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getGroupCipher_1_2(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getGroupCipher_1_2_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_setGroupMgmtCipher(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::hidl_bitfield<::android::hardware::wifi::supplicant::V1_2::ISupplicantStaNetwork::GroupMgmtCipherMask> groupMgmtCipherMask, setGroupMgmtCipher_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getGroupMgmtCipher(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getGroupMgmtCipher_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_enableTlsSuiteBEapPhase1Param(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool enable, enableTlsSuiteBEapPhase1Param_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_enableSuiteBEapOpenSslCiphers(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, enableSuiteBEapOpenSslCiphers_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getSaePassword(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getSaePassword_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getSaePasswordId(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getSaePasswordId_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_setSaePassword(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& saePassword, setSaePassword_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_setSaePasswordId(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& saePasswordId, setSaePasswordId_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_2_BPHWSUPPLICANTSTANETWORK_H
