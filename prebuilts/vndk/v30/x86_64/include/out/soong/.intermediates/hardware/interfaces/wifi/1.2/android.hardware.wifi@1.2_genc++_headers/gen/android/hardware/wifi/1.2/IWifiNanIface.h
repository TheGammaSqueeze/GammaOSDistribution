#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_IWIFINANIFACE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_IWIFINANIFACE_H
 ...
 */
struct IWifiNanIface : public ::android::hardware::wifi::V1_0::IWifiNanIface {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi@1.2::IWifiNanIface"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifiNanIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_2::IWifiNanIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifiNanIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiNanIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifiNanIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifiNanIface>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_2::IWifiNanIface>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_2::IWifiNanIface>& o) {
    ...
    os += ::android::hardware::wifi::V1_2::IWifiNanIface::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_IWIFINANIFACE_H
