#ifndef HIDL_GENERATED_ANDROID_HARDWARE_NFC_V1_0_INFC_H
#define HIDL_GENERATED_ANDROID_HARDWARE_NFC_V1_0_INFC_H
...
struct INfc : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.nfc@1.0::INfc"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::nfc::V1_0::INfc>> castFrom(const ::android::sp<::android::hardware::nfc::V1_0::INfc>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::nfc::V1_0::INfc>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::nfc::V1_0::INfc>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::nfc::V1_0::INfc>& o) {
    ...
    os += ::android::hardware::nfc::V1_0::INfc::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_NFC_V1_0_INFC_H
