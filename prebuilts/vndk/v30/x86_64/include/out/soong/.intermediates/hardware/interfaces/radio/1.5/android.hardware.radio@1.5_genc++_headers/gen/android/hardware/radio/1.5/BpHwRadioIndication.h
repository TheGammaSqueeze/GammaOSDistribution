#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_5_BPHWRADIOINDICATION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_5_BPHWRADIOINDICATION_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/radio/1.5/IHwRadioIndication.h>
...
struct BpHwRadioIndication : public ::android::hardware::BpInterface<IRadioIndication>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_uiccApplicationsEnablementChanged(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, bool enabled);
    static ::android::hardware::Return<void>  _hidl_registrationFailed(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_5::CellIdentity& cellIdentity, const ::android::hardware::hidl_string& chosenPlmn, ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_5::Domain> domain, int32_t causeCode, int32_t additionalCauseCode);
    static ::android::hardware::Return<void>  _hidl_barringInfoChanged(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_5::CellIdentity& cellIdentity, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_5::BarringInfo>& barringInfos);
    static ::android::hardware::Return<void>  _hidl_cellInfoList_1_5(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_5::CellInfo>& records);
    static ::android::hardware::Return<void>  _hidl_networkScanResult_1_5(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_5::NetworkScanResult& result);
    static ::android::hardware::Return<void>  _hidl_dataCallListChanged_1_5(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_5::SetupDataCallResult>& dcList);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_5_BPHWRADIOINDICATION_H
