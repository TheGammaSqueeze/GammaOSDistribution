#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_IWIFINANIFACE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_IWIFINANIFACE_H
 ...
 */
struct IWifiNanIface : public ::android::hardware::wifi::V1_2::IWifiNanIface {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi@1.4::IWifiNanIface"
     */
     ...
     *         |WifiStatusCode.ERROR_WIFI_IFACE_INVALID|
     */
    virtual ::android::hardware::Return<void> registerEventCallback_1_2(const ::android::sp<::android::hardware::wifi::V1_2::IWifiNanIfaceEventCallback>& callback, registerEventCallback_1_2_cb _hidl_cb) = 0;

    /**
     * Return callback for enableRequest_1_2
     */
    using enableRequest_1_2_cb = std::function<void(const ::android::hardware::wifi::V1_0::WifiStatus& status)>;
    /**
     * Enable NAN: configures and activates NAN clustering (does not start
     * a discovery session or set up data-interfaces or data-paths). Use the
     * |IWifiNanIface.configureRequest| method to change the configuration of an already enabled
     ...
     *         |WifiStatusCode.ERROR_UNKNOWN|
     */
    virtual ::android::hardware::Return<void> enableRequest_1_2(uint16_t cmdId, const ::android::hardware::wifi::V1_0::NanEnableRequest& msg1, const ::android::hardware::wifi::V1_2::NanConfigRequestSupplemental& msg2, enableRequest_1_2_cb _hidl_cb) = 0;

    /**
     * Return callback for configRequest_1_2
     */
    using configRequest_1_2_cb = std::function<void(const ::android::hardware::wifi::V1_0::WifiStatus& status)>;
    /**
     * Configure NAN: configures an existing NAN functionality (i.e. assumes
     * |IWifiNanIface.enableRequest| already submitted and succeeded).
     * Asynchronous response is with |IWifiNanIfaceEventCallback.notifyConfigResponse|.
     ...
     *         |WifiStatusCode.ERROR_UNKNOWN|
     */
    virtual ::android::hardware::Return<void> configRequest_1_2(uint16_t cmdId, const ::android::hardware::wifi::V1_0::NanConfigRequest& msg1, const ::android::hardware::wifi::V1_2::NanConfigRequestSupplemental& msg2, configRequest_1_2_cb _hidl_cb) = 0;

    /**
     * Return callback for enableRequest_1_4
     */
    using enableRequest_1_4_cb = std::function<void(const ::android::hardware::wifi::V1_0::WifiStatus& status)>;
    /**
     * Enable NAN: configures and activates NAN clustering (does not start
     * a discovery session or set up data-interfaces or data-paths). Use the
     * |IWifiNanIface.configureRequest| method to change the configuration of an already enabled
     ...
     *         |WifiStatusCode.ERROR_UNKNOWN|
     */
    virtual ::android::hardware::Return<void> enableRequest_1_4(uint16_t cmdId, const ::android::hardware::wifi::V1_4::NanEnableRequest& msg1, const ::android::hardware::wifi::V1_2::NanConfigRequestSupplemental& msg2, enableRequest_1_4_cb _hidl_cb) = 0;

    /**
     * Return callback for configRequest_1_4
     */
    using configRequest_1_4_cb = std::function<void(const ::android::hardware::wifi::V1_0::WifiStatus& status)>;
    /**
     * Configure NAN: configures an existing NAN functionality (i.e. assumes
     * |IWifiNanIface.enableRequest| already submitted and succeeded).
     * Asynchronous response is with |IWifiNanIfaceEventCallback.notifyConfigResponse|.
     ...
     *         |WifiStatusCode.ERROR_UNKNOWN|
     */
    virtual ::android::hardware::Return<void> configRequest_1_4(uint16_t cmdId, const ::android::hardware::wifi::V1_4::NanConfigRequest& msg1, const ::android::hardware::wifi::V1_2::NanConfigRequestSupplemental& msg2, configRequest_1_4_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiNanIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_4::IWifiNanIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiNanIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_2::IWifiNanIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiNanIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiNanIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiNanIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_4::IWifiNanIface>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_4::IWifiNanIface>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_4::IWifiNanIface>& o) {
    ...
    os += ::android::hardware::wifi::V1_4::IWifiNanIface::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_IWIFINANIFACE_H
