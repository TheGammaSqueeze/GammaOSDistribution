#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_3_BPHWWIFICHIP_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_3_BPHWWIFICHIP_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/wifi/1.3/IHwWifiChip.h>
...
struct BpHwWifiChip : public ::android::hardware::BpInterface<IWifiChip>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_setLatencyMode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode mode, setLatencyMode_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_flushRingBufferToFile(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, flushRingBufferToFile_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_3_BPHWWIFICHIP_H
