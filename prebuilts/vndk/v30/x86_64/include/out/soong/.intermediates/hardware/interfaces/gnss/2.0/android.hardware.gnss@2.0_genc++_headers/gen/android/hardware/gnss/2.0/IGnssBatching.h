#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_0_IGNSSBATCHING_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_0_IGNSSBATCHING_H
 ...
 */
struct IGnssBatching : public ::android::hardware::gnss::V1_0::IGnssBatching {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.gnss@2.0::IGnssBatching"
     */
     ...
     * @return success Returns true on success.
     */
    virtual ::android::hardware::Return<bool> init_2_0(const ::android::sp<::android::hardware::gnss::V2_0::IGnssBatchingCallback>& callback) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssBatching>> castFrom(const ::android::sp<::android::hardware::gnss::V2_0::IGnssBatching>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssBatching>> castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnssBatching>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssBatching>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::gnss::V2_0::IGnssBatching>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::gnss::V2_0::IGnssBatching>& o) {
    ...
    os += ::android::hardware::gnss::V2_0::IGnssBatching::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_0_IGNSSBATCHING_H
