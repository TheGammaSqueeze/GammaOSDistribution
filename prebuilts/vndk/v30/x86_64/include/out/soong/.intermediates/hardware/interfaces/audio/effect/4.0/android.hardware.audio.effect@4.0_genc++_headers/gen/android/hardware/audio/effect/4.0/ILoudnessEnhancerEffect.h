#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_ILOUDNESSENHANCEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_ILOUDNESSENHANCEREFFECT_H
...
struct ILoudnessEnhancerEffect : public ::android::hardware::audio::effect::V4_0::IEffect {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@4.0::ILoudnessEnhancerEffect"
     */
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setTargetGain(int32_t targetGainMb) = 0;

    /**
     * Return callback for getTargetGain
     */
    using getTargetGain_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, int32_t targetGainMb)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::IEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect>& o) {
    ...
    os += ::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_ILOUDNESSENHANCEREFFECT_H
