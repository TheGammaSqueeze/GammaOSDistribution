#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BPHWGNSS_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BPHWGNSS_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/gnss/1.1/IHwGnss.h>
...
struct BpHwGnss : public ::android::hardware::BpInterface<IGnss>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<bool>  _hidl_setCallback_1_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::gnss::V1_1::IGnssCallback>& callback);
    static ::android::hardware::Return<bool>  _hidl_setPositionMode_1_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::gnss::V1_0::IGnss::GnssPositionMode mode, ::android::hardware::gnss::V1_0::IGnss::GnssPositionRecurrence recurrence, uint32_t minIntervalMs, uint32_t preferredAccuracyMeters, uint32_t preferredTimeMs, bool lowPowerMode);
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration>>  _hidl_getExtensionGnssConfiguration_1_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurement>>  _hidl_getExtensionGnssMeasurement_1_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<bool>  _hidl_injectBestLocation(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::gnss::V1_0::GnssLocation& location);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BPHWGNSS_H
