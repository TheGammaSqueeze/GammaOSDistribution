#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_0_IGNSSCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_0_IGNSSCALLBACK_H
 ...
 */
struct IGnssCallback : public ::android::hardware::gnss::V1_1::IGnssCallback {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.gnss@2.0::IGnssCallback"
     */
    ...
    struct GnssSvInfo final {
         ...
         */
        ::android::hardware::gnss::V1_0::IGnssCallback::GnssSvInfo v1_0 __attribute__ ((aligned(4)));
        /**
    ...
    static_assert(offsetof(::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo, v1_0) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo, constellation) == 24, "wrong offset");
    static_assert(sizeof(::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo) == 28, "wrong size");
    static_assert(__alignof(::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo) == 4, "wrong alignment");
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssCallback>> castFrom(const ::android::sp<::android::hardware::gnss::V2_0::IGnssCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssCallback>> castFrom(const ::android::sp<::android::hardware::gnss::V1_1::IGnssCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssCallback>> castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnssCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities o);
static inline void PrintTo(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities o, ::std::ostream* os);
constexpr uint32_t operator|(const ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities lhs, const ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities rhs) {
    return static_cast<uint32_t>(static_cast<uint32_t>(lhs) | static_cast<uint32_t>(rhs));
}
constexpr uint32_t operator|(const uint32_t lhs, const ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities rhs) {
    return static_cast<uint32_t>(lhs | static_cast<uint32_t>(rhs));
}
constexpr uint32_t operator|(const ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities lhs, const uint32_t rhs) {
...
constexpr uint32_t &operator|=(uint32_t& v, const ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities e) {
...
static inline std::string toString(const ::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo& o);
static inline void PrintTo(const ::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo& lhs, const ::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo& rhs);
static inline bool operator!=(const ::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo& lhs, const ::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo& rhs);

static inline std::string toString(const ::android::sp<::android::hardware::gnss::V2_0::IGnssCallback>& o);
...
template<>
inline std::string toString<::android::hardware::gnss::V2_0::IGnssCallback::Capabilities>(uint32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::gnss::V2_0::IGnssCallback::Capabilities> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SCHEDULING) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SCHEDULING)) {
        os += (first ? "" : " | ");
        os += "SCHEDULING";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SCHEDULING;
    }
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MSB) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MSB)) {
        os += (first ? "" : " | ");
        os += "MSB";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MSB;
    }
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MSA) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MSA)) {
        os += (first ? "" : " | ");
        os += "MSA";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MSA;
    }
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SINGLE_SHOT) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SINGLE_SHOT)) {
        os += (first ? "" : " | ");
        os += "SINGLE_SHOT";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SINGLE_SHOT;
    }
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::ON_DEMAND_TIME) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::ON_DEMAND_TIME)) {
        os += (first ? "" : " | ");
        os += "ON_DEMAND_TIME";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::ON_DEMAND_TIME;
    }
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::GEOFENCING) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::GEOFENCING)) {
        os += (first ? "" : " | ");
        os += "GEOFENCING";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::GEOFENCING;
    }
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MEASUREMENTS) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MEASUREMENTS)) {
        os += (first ? "" : " | ");
        os += "MEASUREMENTS";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MEASUREMENTS;
    }
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::NAV_MESSAGES) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::NAV_MESSAGES)) {
        os += (first ? "" : " | ");
        os += "NAV_MESSAGES";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::NAV_MESSAGES;
    }
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::LOW_POWER_MODE) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::LOW_POWER_MODE)) {
        os += (first ? "" : " | ");
        os += "LOW_POWER_MODE";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::LOW_POWER_MODE;
    }
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SATELLITE_BLACKLIST) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SATELLITE_BLACKLIST)) {
        os += (first ? "" : " | ");
        os += "SATELLITE_BLACKLIST";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SATELLITE_BLACKLIST;
    }
    if ((o & ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MEASUREMENT_CORRECTIONS) == static_cast<uint32_t>(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MEASUREMENT_CORRECTIONS)) {
        os += (first ? "" : " | ");
        os += "MEASUREMENT_CORRECTIONS";
        first = false;
        flipped |= ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MEASUREMENT_CORRECTIONS;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
...
static inline std::string toString(::android::hardware::gnss::V2_0::IGnssCallback::Capabilities o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SCHEDULING) {
        return "SCHEDULING";
    }
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MSB) {
        return "MSB";
    }
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MSA) {
        return "MSA";
    }
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SINGLE_SHOT) {
        return "SINGLE_SHOT";
    }
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::ON_DEMAND_TIME) {
        return "ON_DEMAND_TIME";
    }
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::GEOFENCING) {
        return "GEOFENCING";
    }
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MEASUREMENTS) {
        return "MEASUREMENTS";
    }
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::NAV_MESSAGES) {
        return "NAV_MESSAGES";
    }
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::LOW_POWER_MODE) {
        return "LOW_POWER_MODE";
    }
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SATELLITE_BLACKLIST) {
        return "SATELLITE_BLACKLIST";
    }
    if (o == ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MEASUREMENT_CORRECTIONS) {
...
static inline void PrintTo(const ::android::hardware::gnss::V2_0::IGnssCallback::GnssSvInfo& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::gnss::V2_0::IGnssCallback>& o) {
    ...
    os += ::android::hardware::gnss::V2_0::IGnssCallback::descriptor;
    os += "]";
...
template<> inline constexpr std::array<::android::hardware::gnss::V2_0::IGnssCallback::Capabilities, 11> hidl_enum_values<::android::hardware::gnss::V2_0::IGnssCallback::Capabilities> = {
    ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SCHEDULING,
    ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MSB,
    ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MSA,
    ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SINGLE_SHOT,
    ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::ON_DEMAND_TIME,
    ...
    ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::LOW_POWER_MODE,
    ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::SATELLITE_BLACKLIST,
    ::android::hardware::gnss::V2_0::IGnssCallback::Capabilities::MEASUREMENT_CORRECTIONS,
};
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_0_IGNSSCALLBACK_H
