...
struct IRadioIndication : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio@1.0::IRadioIndication"
     */
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_0::IRadioIndication>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_0::IRadioIndication>& o) {
    ...
    os += ::android::hardware::radio::V1_0::IRadioIndication::descriptor;
    os += "]";
