#ifndef HIDL_GENERATED_ANDROID_HARDWARE_VIBRATOR_V1_3_IVIBRATOR_H
#define HIDL_GENERATED_ANDROID_HARDWARE_VIBRATOR_V1_3_IVIBRATOR_H
...
struct IVibrator : public ::android::hardware::vibrator::V1_2::IVibrator {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.vibrator@1.3::IVibrator"
     */
     ...
     */
    virtual ::android::hardware::Return<bool> supportsExternalControl() = 0;
     ...
     *                not supported by the device.
     */
    virtual ::android::hardware::Return<::android::hardware::vibrator::V1_0::Status> setExternalControl(bool enabled) = 0;

    /**
     * Return callback for perform_1_3
     */
    using perform_1_3_cb = std::function<void(::android::hardware::vibrator::V1_0::Status status, uint32_t lengthMs)>;
    /**
     * Fire off a predefined haptic event.
     *
     * @param event The type of haptic event to trigger.
     ...
     *     and set to 0 otherwise.
     */
    virtual ::android::hardware::Return<void> perform_1_3(::android::hardware::vibrator::V1_3::Effect effect, ::android::hardware::vibrator::V1_0::EffectStrength strength, perform_1_3_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_3::IVibrator>> castFrom(const ::android::sp<::android::hardware::vibrator::V1_3::IVibrator>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_3::IVibrator>> castFrom(const ::android::sp<::android::hardware::vibrator::V1_2::IVibrator>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_3::IVibrator>> castFrom(const ::android::sp<::android::hardware::vibrator::V1_1::IVibrator>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_3::IVibrator>> castFrom(const ::android::sp<::android::hardware::vibrator::V1_0::IVibrator>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_3::IVibrator>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::vibrator::V1_3::IVibrator>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::vibrator::V1_3::IVibrator>& o) {
    ...
    os += ::android::hardware::vibrator::V1_3::IVibrator::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_VIBRATOR_V1_3_IVIBRATOR_H
