...
struct IVirtualizerEffect : public ::android::hardware::audio::effect::V4_0::IEffect {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@4.0::IVirtualizerEffect"
     */
...
static inline void PrintTo(::android::hardware::audio::effect::V4_0::IVirtualizerEffect::StrengthRange o, ::std::ostream* os);
...
static inline void PrintTo(const ::android::hardware::audio::effect::V4_0::IVirtualizerEffect::SpeakerAngle& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::audio::effect::V4_0::IVirtualizerEffect::SpeakerAngle& o, ::std::ostream* os) {
    *os << toString(o);
}
...
template<> inline constexpr std::array<::android::hardware::audio::effect::V4_0::IVirtualizerEffect::StrengthRange, 2> hidl_enum_values<::android::hardware::audio::effect::V4_0::IVirtualizerEffect::StrengthRange> = {
