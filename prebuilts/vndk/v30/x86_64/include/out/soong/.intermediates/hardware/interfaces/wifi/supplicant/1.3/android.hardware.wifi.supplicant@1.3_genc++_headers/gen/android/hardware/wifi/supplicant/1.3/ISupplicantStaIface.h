#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_3_ISUPPLICANTSTAIFACE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_3_ISUPPLICANTSTAIFACE_H
 ...
 */
struct ISupplicantStaIface : public ::android::hardware::wifi::supplicant::V1_2::ISupplicantStaIface {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi.supplicant@1.3::ISupplicantStaIface"
     */
    ...
    /**
     * Return callback for registerCallback_1_3
     */
    using registerCallback_1_3_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status)>;
    /**
     * Register for callbacks from this interface.
     *
     * These callbacks are invoked for events that are specific to this interface.
     ...
     *         |SupplicantStatusCode.FAILURE_IFACE_INVALID|
     */
    virtual ::android::hardware::Return<void> registerCallback_1_3(const ::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIfaceCallback>& callback, registerCallback_1_3_cb _hidl_cb) = 0;

    /**
     * Return callback for getConnectionCapabilities
     */
    using getConnectionCapabilities_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status, const ::android::hardware::wifi::supplicant::V1_3::ConnectionCapabilities& capabilities)>;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|,
     */
    virtual ::android::hardware::Return<void> getConnectionCapabilities(getConnectionCapabilities_cb _hidl_cb) = 0;

    /**
     * Return callback for getWpaDriverCapabilities
     */
    using getWpaDriverCapabilities_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status, ::android::hardware::hidl_bitfield<::android::hardware::wifi::supplicant::V1_3::WpaDriverCapabilitiesMask> driverCapabilitiesMask)>;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|,
     */
    virtual ::android::hardware::Return<void> getWpaDriverCapabilities(getWpaDriverCapabilities_cb _hidl_cb) = 0;

    /**
     * Return callback for setMboCellularDataStatus
     */
    using setMboCellularDataStatus_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status)>;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|
     */
    virtual ::android::hardware::Return<void> setMboCellularDataStatus(bool available, setMboCellularDataStatus_cb _hidl_cb) = 0;

    /**
     * Return callback for getKeyMgmtCapabilities_1_3
     */
    using getKeyMgmtCapabilities_1_3_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status, ::android::hardware::hidl_bitfield<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaNetwork::KeyMgmtMask> keyMgmtMask)>;
    /**
     * Get Key management capabilities of the device
     *
     * @return status Status of the operation, and a bitmap of key management mask.
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|
     */
    virtual ::android::hardware::Return<void> getKeyMgmtCapabilities_1_3(getKeyMgmtCapabilities_1_3_cb _hidl_cb) = 0;

    /**
     * Return callback for filsHlpFlushRequest
     */
    using filsHlpFlushRequest_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status)>;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_IFACE_DISABLED|
     */
    virtual ::android::hardware::Return<void> filsHlpFlushRequest(filsHlpFlushRequest_cb _hidl_cb) = 0;

    /**
     * Return callback for filsHlpAddRequest
     */
    using filsHlpAddRequest_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status)>;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_IFACE_DISABLED|
     */
    virtual ::android::hardware::Return<void> filsHlpAddRequest(const ::android::hardware::hidl_array<uint8_t, 6>& dst_mac, const ::android::hardware::hidl_vec<uint8_t>& pkt, filsHlpAddRequest_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_2::ISupplicantStaIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_1::ISupplicantStaIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_0::ISupplicantStaIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_0::ISupplicantIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIface>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIface>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIface>& o) {
    ...
    os += ::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIface::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_3_ISUPPLICANTSTAIFACE_H
