#ifndef HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_2_BPHWUSBCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_2_BPHWUSBCALLBACK_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/usb/1.2/IHwUsbCallback.h>
...
struct BpHwUsbCallback : public ::android::hardware::BpInterface<IUsbCallback>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_notifyPortStatusChange_1_2(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::usb::V1_2::PortStatus>& currentPortStatus, ::android::hardware::usb::V1_0::Status retval);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_2_BPHWUSBCALLBACK_H
