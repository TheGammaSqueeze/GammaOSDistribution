#ifndef HIDL_GENERATED_ANDROID_HARDWARE_POWER_V1_1_BPHWPOWER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_POWER_V1_1_BPHWPOWER_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/power/1.1/IHwPower.h>
...
struct BpHwPower : public ::android::hardware::BpInterface<IPower>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_getSubsystemLowPowerStats(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getSubsystemLowPowerStats_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_powerHintAsync(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::power::V1_0::PowerHint hint, int32_t data);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_POWER_V1_1_BPHWPOWER_H
