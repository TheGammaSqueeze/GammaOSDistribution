#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_1_BPHWRADIOINDICATION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_1_BPHWRADIOINDICATION_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/radio/1.1/IHwRadioIndication.h>
...
struct BpHwRadioIndication : public ::android::hardware::BpInterface<IRadioIndication>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_carrierInfoForImsiEncryption(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType info);
    static ::android::hardware::Return<void>  _hidl_networkScanResult(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_1::NetworkScanResult& result);
    static ::android::hardware::Return<void>  _hidl_keepaliveStatus(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_1::KeepaliveStatus& status);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_1_BPHWRADIOINDICATION_H
