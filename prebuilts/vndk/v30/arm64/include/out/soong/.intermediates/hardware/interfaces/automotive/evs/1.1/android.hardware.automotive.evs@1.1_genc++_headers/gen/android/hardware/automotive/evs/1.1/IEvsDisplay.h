#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUTOMOTIVE_EVS_V1_1_IEVSDISPLAY_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUTOMOTIVE_EVS_V1_1_IEVSDISPLAY_H
 ...
 */
struct IEvsDisplay : public ::android::hardware::automotive::evs::V1_0::IEvsDisplay {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.automotive.evs@1.1::IEvsDisplay"
     */
    ...
    /**
     * Return callback for getDisplayInfo_1_1
     */
    using getDisplayInfo_1_1_cb = std::function<void(const ::android::hardware::hidl_vec<uint8_t>& cfg, const ::android::hardware::hidl_vec<uint8_t>& state)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> getDisplayInfo_1_1(getDisplayInfo_1_1_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::automotive::evs::V1_1::IEvsDisplay>> castFrom(const ::android::sp<::android::hardware::automotive::evs::V1_1::IEvsDisplay>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::automotive::evs::V1_1::IEvsDisplay>> castFrom(const ::android::sp<::android::hardware::automotive::evs::V1_0::IEvsDisplay>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::automotive::evs::V1_1::IEvsDisplay>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::automotive::evs::V1_1::IEvsDisplay>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::automotive::evs::V1_1::IEvsDisplay>& o) {
    ...
    os += ::android::hardware::automotive::evs::V1_1::IEvsDisplay::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUTOMOTIVE_EVS_V1_1_IEVSDISPLAY_H
