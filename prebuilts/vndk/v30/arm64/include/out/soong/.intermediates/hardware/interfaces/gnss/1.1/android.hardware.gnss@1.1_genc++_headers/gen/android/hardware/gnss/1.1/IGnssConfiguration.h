#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_IGNSSCONFIGURATION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_IGNSSCONFIGURATION_H
 ...
 */
struct IGnssConfiguration : public ::android::hardware::gnss::V1_0::IGnssConfiguration {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.gnss@1.1::IGnssConfiguration"
     */
    ...
    static_assert(offsetof(::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource, constellation) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource, svid) == 2, "wrong offset");
    static_assert(sizeof(::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource) == 4, "wrong size");
    static_assert(__alignof(::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource) == 2, "wrong alignment");
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration>> castFrom(const ::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration>> castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnssConfiguration>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource& o);
static inline void PrintTo(const ::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource& lhs, const ::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource& rhs);
static inline bool operator!=(const ::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource& lhs, const ::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource& rhs);

static inline std::string toString(const ::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration>& o);
...
static inline void PrintTo(const ::android::hardware::gnss::V1_1::IGnssConfiguration::BlacklistedSource& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration>& o) {
    ...
    os += ::android::hardware::gnss::V1_1::IGnssConfiguration::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_IGNSSCONFIGURATION_H
