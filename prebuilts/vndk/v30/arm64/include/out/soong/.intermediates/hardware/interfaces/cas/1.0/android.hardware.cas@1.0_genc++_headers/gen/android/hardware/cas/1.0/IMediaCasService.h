...
struct IMediaCasService : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.cas@1.0::IMediaCasService"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_0::IMediaCasService>> castFrom(const ::android::sp<::android::hardware::cas::V1_0::IMediaCasService>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_0::IMediaCasService>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::cas::V1_0::IMediaCasService>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::cas::V1_0::IMediaCasService>& o) {
    ...
    os += ::android::hardware::cas::V1_0::IMediaCasService::descriptor;
    os += "]";
