#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_MAPPER_V2_1_BPHWMAPPER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_MAPPER_V2_1_BPHWMAPPER_H
...
struct BpHwMapper : public ::android::hardware::BpInterface<IMapper>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::graphics::mapper::V2_0::Error>  _hidl_validateBufferSize(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, void* buffer, const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& descriptorInfo, uint32_t stride);
    ...
    static ::android::hardware::Return<void>  _hidl_createDescriptor_2_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::graphics::mapper::V2_1::IMapper::BufferDescriptorInfo& descriptorInfo, createDescriptor_2_1_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_MAPPER_V2_1_BPHWMAPPER_H
