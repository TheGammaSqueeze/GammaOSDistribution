#ifndef HIDL_GENERATED_ANDROID_HARDWARE_KEYMASTER_V4_0_BNHWKEYMASTERDEVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_KEYMASTER_V4_0_BNHWKEYMASTERDEVICE_H
...
struct BnHwKeymasterDevice : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_getHardwareInfo(
    ...
    static ::android::status_t _hidl_getHmacSharingParameters(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_computeSharedHmac(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_verifyAuthorization(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_importWrappedKey(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_KEYMASTER_V4_0_BNHWKEYMASTERDEVICE_H
