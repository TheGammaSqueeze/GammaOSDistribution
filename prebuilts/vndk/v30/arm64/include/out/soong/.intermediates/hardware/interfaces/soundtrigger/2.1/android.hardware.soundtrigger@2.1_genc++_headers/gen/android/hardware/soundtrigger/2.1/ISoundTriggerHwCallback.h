...
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHwCallback::RecognitionEvent& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHwCallback::PhraseRecognitionEvent& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHwCallback::ModelEvent& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHwCallback::RecognitionEvent& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHwCallback::PhraseRecognitionEvent& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHwCallback::ModelEvent& o, ::std::ostream* os) {
    *os << toString(o);
}
