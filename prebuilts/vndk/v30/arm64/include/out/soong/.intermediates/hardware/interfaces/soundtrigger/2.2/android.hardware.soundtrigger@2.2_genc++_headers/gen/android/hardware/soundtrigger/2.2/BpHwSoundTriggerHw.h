#ifndef HIDL_GENERATED_ANDROID_HARDWARE_SOUNDTRIGGER_V2_2_BPHWSOUNDTRIGGERHW_H
#define HIDL_GENERATED_ANDROID_HARDWARE_SOUNDTRIGGER_V2_2_BPHWSOUNDTRIGGERHW_H
...
struct BpHwSoundTriggerHw : public ::android::hardware::BpInterface<ISoundTriggerHw>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<int32_t>  _hidl_getModelState(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t modelHandle);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_SOUNDTRIGGER_V2_2_BPHWSOUNDTRIGGERHW_H
