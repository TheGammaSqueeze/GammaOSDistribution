#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWPRIMARYDEVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWPRIMARYDEVICE_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/5.0/IHwPrimaryDevice.h>
...
struct BpHwPrimaryDevice : public ::android::hardware::BpInterface<IPrimaryDevice>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setVoiceVolume(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float volume);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setMode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::common::V5_0::AudioMode mode);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setBtScoHeadsetDebugName(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& name);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setBtScoNrecEnabled(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool enabled);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setBtScoWidebandEnabled(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool enabled);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setBtHfpEnabled(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool enabled);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setBtHfpSampleRate(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t sampleRateHz);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setBtHfpVolume(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float volume);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setTtyMode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::V5_0::IPrimaryDevice::TtyMode mode);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setHacEnabled(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool enabled);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_updateRotation(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::V5_0::IPrimaryDevice::Rotation rotation);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWPRIMARYDEVICE_H
