#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_2_ICAS_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_2_ICAS_H
 ...
 */
struct ICas : public ::android::hardware::cas::V1_1::ICas {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.cas@1.2::ICas"
     */
    ...
    /**
     * Return callback for openSession_1_2
     */
    using openSession_1_2_cb = std::function<void(::android::hardware::cas::V1_2::Status status, const ::android::hardware::hidl_vec<uint8_t>& sessionId)>;
    /**
     ...
     * @return sessionId the id of the newly opened session.
     */
    virtual ::android::hardware::Return<void> openSession_1_2(::android::hardware::cas::V1_2::SessionIntent intent, ::android::hardware::cas::V1_2::ScramblingMode mode, openSession_1_2_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_2::ICas>> castFrom(const ::android::sp<::android::hardware::cas::V1_2::ICas>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_2::ICas>> castFrom(const ::android::sp<::android::hardware::cas::V1_1::ICas>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_2::ICas>> castFrom(const ::android::sp<::android::hardware::cas::V1_0::ICas>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_2::ICas>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::cas::V1_2::ICas>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::cas::V1_2::ICas>& o) {
    ...
    os += ::android::hardware::cas::V1_2::ICas::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_2_ICAS_H
