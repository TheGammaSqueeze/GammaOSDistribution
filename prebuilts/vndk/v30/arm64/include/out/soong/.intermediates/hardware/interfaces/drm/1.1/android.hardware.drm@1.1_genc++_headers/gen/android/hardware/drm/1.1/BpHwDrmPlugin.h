#ifndef HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_1_BPHWDRMPLUGIN_H
#define HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_1_BPHWDRMPLUGIN_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/drm/1.1/IHwDrmPlugin.h>
...
struct BpHwDrmPlugin : public ::android::hardware::BpInterface<IDrmPlugin>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_openSession_1_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::drm::V1_1::SecurityLevel securityLevel, openSession_1_1_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getKeyRequest_1_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& scope, const ::android::hardware::hidl_vec<uint8_t>& initData, const ::android::hardware::hidl_string& mimeType, ::android::hardware::drm::V1_0::KeyType keyType, const ::android::hardware::hidl_vec<::android::hardware::drm::V1_0::KeyValue>& optionalParameters, getKeyRequest_1_1_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getHdcpLevels(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getHdcpLevels_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getNumberOfSessions(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getNumberOfSessions_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getSecurityLevel(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& sessionId, getSecurityLevel_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getMetrics(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getMetrics_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getSecureStopIds(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getSecureStopIds_cb _hidl_cb);
    static ::android::hardware::Return<::android::hardware::drm::V1_0::Status>  _hidl_releaseSecureStops(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::drm::V1_1::SecureStopRelease& ssRelease);
    static ::android::hardware::Return<::android::hardware::drm::V1_0::Status>  _hidl_removeSecureStop(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& secureStopId);
    static ::android::hardware::Return<::android::hardware::drm::V1_0::Status>  _hidl_removeAllSecureStops(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_1_BPHWDRMPLUGIN_H
