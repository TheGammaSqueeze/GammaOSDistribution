#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_5_IRADIO_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_5_IRADIO_H
 ...
 */
struct IRadio : public ::android::hardware::radio::V1_4::IRadio {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio@1.5::IRadio"
     */
     ...
     * @param accessNetwork The type of network for which to apply these thresholds.
     */
    virtual ::android::hardware::Return<void> setSignalStrengthReportingCriteria_1_5(int32_t serial, const ::android::hardware::radio::V1_5::SignalThresholdInfo& signalThresholdInfo, ::android::hardware::radio::V1_5::AccessNetwork accessNetwork) = 0;
     ...
     * @param accessNetwork The type of network for which to apply these thresholds.
     */
    virtual ::android::hardware::Return<void> setLinkCapacityReportingCriteria_1_5(int32_t serial, int32_t hysteresisMs, int32_t hysteresisDlKbps, int32_t hysteresisUlKbps, const ::android::hardware::hidl_vec<int32_t>& thresholdsDownlinkKbps, const ::android::hardware::hidl_vec<int32_t>& thresholdsUplinkKbps, ::android::hardware::radio::V1_5::AccessNetwork accessNetwork) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> enableUiccApplications(int32_t serial, bool enable) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> areUiccApplicationsEnabled(int32_t serial) = 0;
     ...
     * Response callback is IRadioResponse.setSystemSelectionChannelsResponse()
     */
    virtual ::android::hardware::Return<void> setSystemSelectionChannels_1_5(int32_t serial, bool specifyChannels, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_5::RadioAccessSpecifier>& specifiers) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> startNetworkScan_1_5(int32_t serial, const ::android::hardware::radio::V1_5::NetworkScanRequest& request) = 0;
     ...
     * as the input param.
     */
    virtual ::android::hardware::Return<void> setInitialAttachApn_1_5(int32_t serial, const ::android::hardware::radio::V1_5::DataProfileInfo& dataProfileInfo) = 0;
     ...
     * as the input param.
     */
    virtual ::android::hardware::Return<void> setDataProfile_1_5(int32_t serial, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_5::DataProfileInfo>& profiles) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> setRadioPower_1_5(int32_t serial, bool powerOn, bool forEmergencyCall, bool preferredForEmergencyCall) = 0;
     ...
     * Response callback is IRadioResponse.setIndicationFilterResponse()
     */
    virtual ::android::hardware::Return<void> setIndicationFilter_1_5(int32_t serial, ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_5::IndicationFilter> indicationFilter) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getBarringInfo(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getVoiceRegistrationState_1_5(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getDataRegistrationState_1_5(int32_t serial) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> setNetworkSelectionModeManual_1_5(int32_t serial, const ::android::hardware::hidl_string& operatorNumeric, ::android::hardware::radio::V1_5::RadioAccessNetworks ran) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> sendCdmaSmsExpectMore(int32_t serial, const ::android::hardware::radio::V1_0::CdmaSmsMessage& sms) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> supplySimDepersonalization(int32_t serial, ::android::hardware::radio::V1_5::PersoSubstate persoType, const ::android::hardware::hidl_string& controlKey) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_5::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_5::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_5::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_4::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_5::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_3::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_5::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_2::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_5::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_5::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::radio::V1_5::IRadio>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_5::IRadio>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_5::IRadio>& o) {
    ...
    os += ::android::hardware::radio::V1_5::IRadio::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_5_IRADIO_H
