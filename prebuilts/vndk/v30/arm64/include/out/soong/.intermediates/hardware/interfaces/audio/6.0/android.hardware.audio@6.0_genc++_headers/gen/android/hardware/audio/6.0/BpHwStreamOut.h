#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V6_0_BPHWSTREAMOUT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V6_0_BPHWSTREAMOUT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/6.0/IHwStreamOut.h>
...
struct BpHwStreamOut : public ::android::hardware::BpInterface<IStreamOut>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_setVolume(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float left, float right);
    static ::android::hardware::Return<void>  _hidl_updateSourceMetadata(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V6_0::SourceMetadata& sourceMetadata);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_setCallback(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::audio::V6_0::IStreamOutCallback>& callback);
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_clearCallback(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_setEventCallback(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::audio::V6_0::IStreamOutEventCallback>& callback);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_pause(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_resume(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_drain(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::V6_0::AudioDrain type);
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_flush(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_selectPresentation(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t presentationId, int32_t programId);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_setDualMonoMode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::V6_0::DualMonoMode mode);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_setAudioDescriptionMixLevel(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float leveldB);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V6_0::Result>  _hidl_setPlaybackRateParameters(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::V6_0::PlaybackRate& playbackRate);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V6_0_BPHWSTREAMOUT_H
