#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_COMPOSER_V2_4_BSCOMPOSER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_COMPOSER_V2_4_BSCOMPOSER_H
...
struct BsComposer : IComposer, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> createClient(createClient_cb _hidl_cb) override {
        ...
        auto _hidl_return = mImpl->createClient([&](const auto &_hidl_out_error, const auto &_hidl_out_client) {
            ...
            ::android::sp<::android::hardware::graphics::composer::V2_1::IComposerClient> _hidl_wrapped__hidl_out_client;
            if (_hidl_out_client != nullptr && !_hidl_out_client->isRemote()) {
                _hidl_wrapped__hidl_out_client = ::android::hardware::details::wrapPassthrough(_hidl_out_client);
                if (_hidl_wrapped__hidl_out_client == nullptr) {
                    _hidl_error = ::android::hardware::Status::fromExceptionCode(
                            ::android::hardware::Status::EX_TRANSACTION_FAILED,
                            "Cannot wrap passthrough interface.");
                }
            } else {
                _hidl_wrapped__hidl_out_client = _hidl_out_client;
            }

            _hidl_cb(_hidl_out_error, _hidl_wrapped__hidl_out_client);
        });
    ...
    ::android::hardware::Return<void> createClient_2_3(createClient_2_3_cb _hidl_cb) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IComposer::createClient_2_3::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.composer", "2.3", "IComposer", "createClient_2_3", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->createClient_2_3([&](const auto &_hidl_out_error, const auto &_hidl_out_client) {
            atrace_end(ATRACE_TAG_HAL);
            #ifdef __ANDROID_DEBUGGABLE__
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                ...
                _hidl_args.push_back((void *)&_hidl_out_client);
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.composer", "2.3", "IComposer", "createClient_2_3", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__

            ::android::sp<::android::hardware::graphics::composer::V2_3::IComposerClient> _hidl_wrapped__hidl_out_client;
            if (_hidl_out_client != nullptr && !_hidl_out_client->isRemote()) {
                _hidl_wrapped__hidl_out_client = ::android::hardware::details::wrapPassthrough(_hidl_out_client);
                if (_hidl_wrapped__hidl_out_client == nullptr) {
                    _hidl_error = ::android::hardware::Status::fromExceptionCode(
    ...
    ::android::hardware::Return<void> createClient_2_4(createClient_2_4_cb _hidl_cb) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IComposer::createClient_2_4::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.graphics.composer", "2.4", "IComposer", "createClient_2_4", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->createClient_2_4([&](const auto &_hidl_out_error, const auto &_hidl_out_client) {
            atrace_end(ATRACE_TAG_HAL);
            #ifdef __ANDROID_DEBUGGABLE__
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                ...
                _hidl_args.push_back((void *)&_hidl_out_client);
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.graphics.composer", "2.4", "IComposer", "createClient_2_4", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__

            ::android::sp<::android::hardware::graphics::composer::V2_4::IComposerClient> _hidl_wrapped__hidl_out_client;
            if (_hidl_out_client != nullptr && !_hidl_out_client->isRemote()) {
                _hidl_wrapped__hidl_out_client = ::android::hardware::details::wrapPassthrough(_hidl_out_client);
                if (_hidl_wrapped__hidl_out_client == nullptr) {
                    _hidl_error = ::android::hardware::Status::fromExceptionCode(
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_COMPOSER_V2_4_BSCOMPOSER_H
