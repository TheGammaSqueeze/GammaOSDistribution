#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V4_0_ISTREAMIN_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V4_0_ISTREAMIN_H
...
struct IStreamIn : public ::android::hardware::audio::V4_0::IStream {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio@4.0::IStreamIn"
     */
    ...
    enum class ReadCommand : int32_t {
        READ = 0,
        GET_CAPTURE_POSITION = 1 /* ::android::hardware::audio::V4_0::IStreamIn::ReadCommand.READ implicitly + 1 */,
    };
    ...
    struct ReadParameters final {
        ...
        static_assert(offsetof(::android::hardware::audio::V4_0::IStreamIn::ReadParameters::Params, read) == 0, "wrong offset");
        static_assert(sizeof(::android::hardware::audio::V4_0::IStreamIn::ReadParameters::Params) == 8, "wrong size");
        static_assert(__alignof(::android::hardware::audio::V4_0::IStreamIn::ReadParameters::Params) == 8, "wrong alignment");

        ::android::hardware::audio::V4_0::IStreamIn::ReadCommand command __attribute__ ((aligned(4)));
        ::android::hardware::audio::V4_0::IStreamIn::ReadParameters::Params params __attribute__ ((aligned(8)));
    };

    static_assert(offsetof(::android::hardware::audio::V4_0::IStreamIn::ReadParameters, command) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::V4_0::IStreamIn::ReadParameters, params) == 8, "wrong offset");
    static_assert(sizeof(::android::hardware::audio::V4_0::IStreamIn::ReadParameters) == 16, "wrong size");
    static_assert(__alignof(::android::hardware::audio::V4_0::IStreamIn::ReadParameters) == 8, "wrong alignment");
    ...
    struct ReadStatus final {
        ...
        union Reply final {
            ...
            static_assert(offsetof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition, frames) == 0, "wrong offset");
            static_assert(offsetof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition, time) == 8, "wrong offset");
            static_assert(sizeof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition) == 16, "wrong size");
            static_assert(__alignof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition) == 8, "wrong alignment");

            uint64_t read __attribute__ ((aligned(8)));
            ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition capturePosition __attribute__ ((aligned(8)));
        };

        static_assert(offsetof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply, read) == 0, "wrong offset");
        static_assert(offsetof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply, capturePosition) == 0, "wrong offset");
        static_assert(sizeof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply) == 16, "wrong size");
        static_assert(__alignof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply) == 8, "wrong alignment");

        ::android::hardware::audio::V4_0::Result retval __attribute__ ((aligned(4)));
        ::android::hardware::audio::V4_0::IStreamIn::ReadCommand replyTo __attribute__ ((aligned(4)));
        ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply reply __attribute__ ((aligned(8)));
    };

    static_assert(offsetof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus, retval) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus, replyTo) == 4, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus, reply) == 8, "wrong offset");
    static_assert(sizeof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus) == 24, "wrong size");
    static_assert(__alignof(::android::hardware::audio::V4_0::IStreamIn::ReadStatus) == 8, "wrong alignment");
     ...
     */
    using getAudioSource_cb = std::function<void(::android::hardware::audio::V4_0::Result retval, ::android::hardware::audio::common::V4_0::AudioSource source)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V4_0::Result> setGain(float gain) = 0;

    /**
     * Called when the metadata of the stream's sink has been changed.
     * @param sinkMetadata Description of the audio that is suggested by the clients.
     */
    virtual ::android::hardware::Return<void> updateSinkMetadata(const ::android::hardware::audio::V4_0::SinkMetadata& sinkMetadata) = 0;

    /**
     * Return callback for prepareForReading
     */
    using prepareForReading_cb = std::function<void(::android::hardware::audio::V4_0::Result retval, const ::android::hardware::MQDescriptorSync<::android::hardware::audio::V4_0::IStreamIn::ReadParameters>& commandMQ, const ::android::hardware::MQDescriptorSync<uint8_t>& dataMQ, const ::android::hardware::MQDescriptorSync<::android::hardware::audio::V4_0::IStreamIn::ReadStatus>& statusMQ, const ::android::hardware::audio::common::V4_0::ThreadInfo& threadInfo)>;
    /**
     ...
     */
    using getCapturePosition_cb = std::function<void(::android::hardware::audio::V4_0::Result retval, uint64_t frames, uint64_t time)>;
    /**
     ...
     */
    using getActiveMicrophones_cb = std::function<void(::android::hardware::audio::V4_0::Result retval, const ::android::hardware::hidl_vec<::android::hardware::audio::V4_0::MicrophoneInfo>& microphones)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V4_0::IStreamIn>> castFrom(const ::android::sp<::android::hardware::audio::V4_0::IStreamIn>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V4_0::IStreamIn>> castFrom(const ::android::sp<::android::hardware::audio::V4_0::IStream>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V4_0::IStreamIn>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(::android::hardware::audio::V4_0::IStreamIn::ReadCommand o);
static inline void PrintTo(::android::hardware::audio::V4_0::IStreamIn::ReadCommand o, ::std::ostream* os);
constexpr int32_t operator|(const ::android::hardware::audio::V4_0::IStreamIn::ReadCommand lhs, const ::android::hardware::audio::V4_0::IStreamIn::ReadCommand rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const int32_t lhs, const ::android::hardware::audio::V4_0::IStreamIn::ReadCommand rhs) {
    return static_cast<int32_t>(lhs | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const ::android::hardware::audio::V4_0::IStreamIn::ReadCommand lhs, const int32_t rhs) {
...
constexpr int32_t &operator|=(int32_t& v, const ::android::hardware::audio::V4_0::IStreamIn::ReadCommand e) {
...
static inline std::string toString(const ::android::hardware::audio::V4_0::IStreamIn::ReadParameters::Params& o);
static inline void PrintTo(const ::android::hardware::audio::V4_0::IStreamIn::ReadParameters::Params& o, ::std::ostream*);
// operator== and operator!= are not generated for Params

static inline std::string toString(const ::android::hardware::audio::V4_0::IStreamIn::ReadParameters& o);
static inline void PrintTo(const ::android::hardware::audio::V4_0::IStreamIn::ReadParameters& o, ::std::ostream*);
// operator== and operator!= are not generated for ReadParameters

static inline std::string toString(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition& o);
static inline void PrintTo(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition& lhs, const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition& rhs);
static inline bool operator!=(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition& lhs, const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition& rhs);

static inline std::string toString(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply& o);
static inline void PrintTo(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply& o, ::std::ostream*);
// operator== and operator!= are not generated for Reply

static inline std::string toString(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus& o);
static inline void PrintTo(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus& o, ::std::ostream*);
// operator== and operator!= are not generated for ReadStatus

static inline std::string toString(const ::android::sp<::android::hardware::audio::V4_0::IStreamIn>& o);
...
template<>
inline std::string toString<::android::hardware::audio::V4_0::IStreamIn::ReadCommand>(int32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::V4_0::IStreamIn::ReadCommand> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::V4_0::IStreamIn::ReadCommand::READ) == static_cast<int32_t>(::android::hardware::audio::V4_0::IStreamIn::ReadCommand::READ)) {
        os += (first ? "" : " | ");
        os += "READ";
        first = false;
        flipped |= ::android::hardware::audio::V4_0::IStreamIn::ReadCommand::READ;
    }
    if ((o & ::android::hardware::audio::V4_0::IStreamIn::ReadCommand::GET_CAPTURE_POSITION) == static_cast<int32_t>(::android::hardware::audio::V4_0::IStreamIn::ReadCommand::GET_CAPTURE_POSITION)) {
        os += (first ? "" : " | ");
        os += "GET_CAPTURE_POSITION";
        first = false;
        flipped |= ::android::hardware::audio::V4_0::IStreamIn::ReadCommand::GET_CAPTURE_POSITION;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
...
static inline std::string toString(::android::hardware::audio::V4_0::IStreamIn::ReadCommand o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::V4_0::IStreamIn::ReadCommand::READ) {
        return "READ";
    }
    if (o == ::android::hardware::audio::V4_0::IStreamIn::ReadCommand::GET_CAPTURE_POSITION) {
...
static inline void PrintTo(const ::android::hardware::audio::V4_0::IStreamIn::ReadParameters::Params& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::hardware::audio::V4_0::IStreamIn::ReadParameters& o) {
    ...
    os += "{";
    os += ".command = ";
    os += ::android::hardware::audio::V4_0::toString(o.command);
    os += ", .params = ";
    os += ::android::hardware::audio::V4_0::toString(o.params);
    os += "}"; return os;
}

static inline void PrintTo(const ::android::hardware::audio::V4_0::IStreamIn::ReadParameters& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply::CapturePosition& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply& o) {
    ...
    os += ::android::hardware::toString(o.read);
    os += ", .capturePosition = ";
    os += ::android::hardware::audio::V4_0::toString(o.capturePosition);
    os += "}"; return os;
}

static inline void PrintTo(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus::Reply& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::audio::V4_0::IStreamIn::ReadStatus& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::V4_0::IStreamIn>& o) {
    ...
    os += ::android::hardware::audio::V4_0::IStreamIn::descriptor;
    os += "]";
...
template<> inline constexpr std::array<::android::hardware::audio::V4_0::IStreamIn::ReadCommand, 2> hidl_enum_values<::android::hardware::audio::V4_0::IStreamIn::ReadCommand> = {
    ::android::hardware::audio::V4_0::IStreamIn::ReadCommand::READ,
    ::android::hardware::audio::V4_0::IStreamIn::ReadCommand::GET_CAPTURE_POSITION,
};
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V4_0_ISTREAMIN_H
