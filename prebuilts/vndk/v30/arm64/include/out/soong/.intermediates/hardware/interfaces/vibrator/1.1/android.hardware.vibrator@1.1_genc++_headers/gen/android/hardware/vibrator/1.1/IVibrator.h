#ifndef HIDL_GENERATED_ANDROID_HARDWARE_VIBRATOR_V1_1_IVIBRATOR_H
#define HIDL_GENERATED_ANDROID_HARDWARE_VIBRATOR_V1_1_IVIBRATOR_H
...
struct IVibrator : public ::android::hardware::vibrator::V1_0::IVibrator {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.vibrator@1.1::IVibrator"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_1::IVibrator>> castFrom(const ::android::sp<::android::hardware::vibrator::V1_1::IVibrator>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_1::IVibrator>> castFrom(const ::android::sp<::android::hardware::vibrator::V1_0::IVibrator>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_1::IVibrator>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::vibrator::V1_1::IVibrator>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::vibrator::V1_1::IVibrator>& o) {
    ...
    os += ::android::hardware::vibrator::V1_1::IVibrator::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_VIBRATOR_V1_1_IVIBRATOR_H
