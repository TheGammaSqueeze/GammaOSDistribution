#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_2_ISUPPLICANTP2PIFACE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_2_ISUPPLICANTP2PIFACE_H
 ...
 */
struct ISupplicantP2pIface : public ::android::hardware::wifi::supplicant::V1_0::ISupplicantP2pIface {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi.supplicant@1.2::ISupplicantP2pIface"
     */
    ...
    /**
     * Return callback for addGroup_1_2
     */
    using addGroup_1_2_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status)>;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_IFACE_INVALID|
     */
    virtual ::android::hardware::Return<void> addGroup_1_2(const ::android::hardware::hidl_vec<uint8_t>& ssid, const ::android::hardware::hidl_string& pskPassphrase, bool persistent, uint32_t freq, const ::android::hardware::hidl_array<uint8_t, 6>& peerAddress, bool joinExistingGroup, addGroup_1_2_cb _hidl_cb) = 0;

    /**
     * Return callback for setMacRandomization
     */
    using setMacRandomization_cb = std::function<void(const ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus& status)>;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_IFACE_INVALID|
     */
    virtual ::android::hardware::Return<void> setMacRandomization(bool enable, setMacRandomization_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_2::ISupplicantP2pIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_2::ISupplicantP2pIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_2::ISupplicantP2pIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_0::ISupplicantP2pIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_2::ISupplicantP2pIface>> castFrom(const ::android::sp<::android::hardware::wifi::supplicant::V1_0::ISupplicantIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::supplicant::V1_2::ISupplicantP2pIface>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::supplicant::V1_2::ISupplicantP2pIface>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::supplicant::V1_2::ISupplicantP2pIface>& o) {
    ...
    os += ::android::hardware::wifi::supplicant::V1_2::ISupplicantP2pIface::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_2_ISUPPLICANTP2PIFACE_H
