#ifndef HIDL_GENERATED_ANDROID_HARDWARE_SENSORS_V2_1_ISENSORS_H
#define HIDL_GENERATED_ANDROID_HARDWARE_SENSORS_V2_1_ISENSORS_H
...
struct ISensors : public ::android::hardware::sensors::V2_0::ISensors {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.sensors@2.1::ISensors"
     */
    ...
    /**
     * Return callback for getSensorsList_2_1
     */
    using getSensorsList_2_1_cb = std::function<void(const ::android::hardware::hidl_vec<::android::hardware::sensors::V2_1::SensorInfo>& list)>;
    /**
     * Enumerate all available (static) sensors.
     *
     * The SensorInfo for each sensor returned by getSensorsList must be stable
     ...
     * sensor must not change across HAL restarts).
     */
    virtual ::android::hardware::Return<void> getSensorsList_2_1(getSensorsList_2_1_cb _hidl_cb) = 0;
     ...
     *     as null)
     */
    virtual ::android::hardware::Return<::android::hardware::sensors::V1_0::Result> initialize_2_1(const ::android::hardware::MQDescriptorSync<::android::hardware::sensors::V2_1::Event>& eventQueueDescriptor, const ::android::hardware::MQDescriptorSync<uint32_t>& wakeLockDescriptor, const ::android::sp<::android::hardware::sensors::V2_1::ISensorsCallback>& sensorsCallback) = 0;
     ...
     *     BAD_VALUE if sensor event cannot be injected.
     */
    virtual ::android::hardware::Return<::android::hardware::sensors::V1_0::Result> injectSensorData_2_1(const ::android::hardware::sensors::V2_1::Event& event) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::sensors::V2_1::ISensors>> castFrom(const ::android::sp<::android::hardware::sensors::V2_1::ISensors>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::sensors::V2_1::ISensors>> castFrom(const ::android::sp<::android::hardware::sensors::V2_0::ISensors>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::sensors::V2_1::ISensors>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::sensors::V2_1::ISensors>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::sensors::V2_1::ISensors>& o) {
    ...
    os += ::android::hardware::sensors::V2_1::ISensors::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_SENSORS_V2_1_ISENSORS_H
