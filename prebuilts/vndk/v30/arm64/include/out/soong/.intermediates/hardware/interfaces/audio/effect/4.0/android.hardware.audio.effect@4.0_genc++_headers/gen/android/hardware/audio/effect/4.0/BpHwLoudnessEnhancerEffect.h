#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWLOUDNESSENHANCEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWLOUDNESSENHANCEREFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/4.0/IHwLoudnessEnhancerEffect.h>
...
struct BpHwLoudnessEnhancerEffect : public ::android::hardware::BpInterface<ILoudnessEnhancerEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_setTargetGain(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t targetGainMb);
    ...
    // Methods from ::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect follow.
    ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setTargetGain(int32_t targetGainMb) override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWLOUDNESSENHANCEREFFECT_H
