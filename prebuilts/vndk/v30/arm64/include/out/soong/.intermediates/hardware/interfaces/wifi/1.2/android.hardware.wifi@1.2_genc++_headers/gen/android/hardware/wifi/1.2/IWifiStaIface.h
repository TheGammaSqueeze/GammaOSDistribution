#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_IWIFISTAIFACE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_IWIFISTAIFACE_H
 ...
 */
struct IWifiStaIface : public ::android::hardware::wifi::V1_0::IWifiStaIface {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi@1.2::IWifiStaIface"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifiStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_2::IWifiStaIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifiStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiStaIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifiStaIface>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiIface>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_2::IWifiStaIface>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_2::IWifiStaIface>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_2::IWifiStaIface>& o) {
    ...
    os += ::android::hardware::wifi::V1_2::IWifiStaIface::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_IWIFISTAIFACE_H
