#ifndef HIDL_GENERATED_ANDROID_HARDWARE_SENSORS_V2_0_BNHWSENSORSCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_SENSORS_V2_0_BNHWSENSORSCALLBACK_H
...
struct BnHwSensorsCallback : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_onDynamicSensorsConnected(
    ...
    static ::android::status_t _hidl_onDynamicSensorsDisconnected(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_SENSORS_V2_0_BNHWSENSORSCALLBACK_H
