#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_1_IMEDIACASSERVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_1_IMEDIACASSERVICE_H
 ...
 */
struct IMediaCasService : public ::android::hardware::cas::V1_0::IMediaCasService {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.cas@1.1::IMediaCasService"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_1::IMediaCasService>> castFrom(const ::android::sp<::android::hardware::cas::V1_1::IMediaCasService>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_1::IMediaCasService>> castFrom(const ::android::sp<::android::hardware::cas::V1_0::IMediaCasService>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_1::IMediaCasService>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::cas::V1_1::IMediaCasService>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::cas::V1_1::IMediaCasService>& o) {
    ...
    os += ::android::hardware::cas::V1_1::IMediaCasService::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_1_IMEDIACASSERVICE_H
