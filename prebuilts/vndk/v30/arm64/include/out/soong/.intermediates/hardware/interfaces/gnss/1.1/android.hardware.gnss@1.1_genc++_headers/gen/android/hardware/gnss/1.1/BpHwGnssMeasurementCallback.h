#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BPHWGNSSMEASUREMENTCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BPHWGNSSMEASUREMENTCALLBACK_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/gnss/1.1/IHwGnssMeasurementCallback.h>
...
struct BpHwGnssMeasurementCallback : public ::android::hardware::BpInterface<IGnssMeasurementCallback>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_gnssMeasurementCb(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::gnss::V1_1::IGnssMeasurementCallback::GnssData& data);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BPHWGNSSMEASUREMENTCALLBACK_H
