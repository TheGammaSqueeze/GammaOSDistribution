#ifndef HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_1_IUSBCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_1_IUSBCALLBACK_H
 ...
 */
struct IUsbCallback : public ::android::hardware::usb::V1_0::IUsbCallback {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.usb@1.1::IUsbCallback"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::usb::V1_1::IUsbCallback>> castFrom(const ::android::sp<::android::hardware::usb::V1_1::IUsbCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::usb::V1_1::IUsbCallback>> castFrom(const ::android::sp<::android::hardware::usb::V1_0::IUsbCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::usb::V1_1::IUsbCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::usb::V1_1::IUsbCallback>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::usb::V1_1::IUsbCallback>& o) {
    ...
    os += ::android::hardware::usb::V1_1::IUsbCallback::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_1_IUSBCALLBACK_H
