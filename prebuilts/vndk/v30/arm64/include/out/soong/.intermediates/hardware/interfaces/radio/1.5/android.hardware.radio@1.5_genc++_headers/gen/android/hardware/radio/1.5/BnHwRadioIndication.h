#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_5_BNHWRADIOINDICATION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_5_BNHWRADIOINDICATION_H
...
struct BnHwRadioIndication : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_uiccApplicationsEnablementChanged(
    ...
    static ::android::status_t _hidl_registrationFailed(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_barringInfoChanged(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_cellInfoList_1_5(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_networkScanResult_1_5(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_dataCallListChanged_1_5(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_5_BNHWRADIOINDICATION_H
