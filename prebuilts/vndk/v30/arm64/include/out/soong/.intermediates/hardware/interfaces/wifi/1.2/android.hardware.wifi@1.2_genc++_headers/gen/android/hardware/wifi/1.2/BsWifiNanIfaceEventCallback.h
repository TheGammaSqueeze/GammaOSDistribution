#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_BSWIFINANIFACEEVENTCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_BSWIFINANIFACEEVENTCALLBACK_H
...
struct BsWifiNanIfaceEventCallback : IWifiNanIfaceEventCallback, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> eventDataPathConfirm_1_2(const ::android::hardware::wifi::V1_2::NanDataPathConfirmInd& event) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IWifiNanIfaceEventCallback::eventDataPathConfirm_1_2::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&event);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.wifi", "1.2", "IWifiNanIfaceEventCallback", "eventDataPathConfirm_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        #endif // __ANDROID_DEBUGGABLE__
        , event] {
            mImpl->eventDataPathConfirm_1_2(event);
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.wifi", "1.2", "IWifiNanIfaceEventCallback", "eventDataPathConfirm_1_2", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> eventDataPathScheduleUpdate(const ::android::hardware::wifi::V1_2::NanDataPathScheduleUpdateInd& event) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IWifiNanIfaceEventCallback::eventDataPathScheduleUpdate::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&event);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.wifi", "1.2", "IWifiNanIfaceEventCallback", "eventDataPathScheduleUpdate", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        #endif // __ANDROID_DEBUGGABLE__
        , event] {
            mImpl->eventDataPathScheduleUpdate(event);
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.wifi", "1.2", "IWifiNanIfaceEventCallback", "eventDataPathScheduleUpdate", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_2_BSWIFINANIFACEEVENTCALLBACK_H
