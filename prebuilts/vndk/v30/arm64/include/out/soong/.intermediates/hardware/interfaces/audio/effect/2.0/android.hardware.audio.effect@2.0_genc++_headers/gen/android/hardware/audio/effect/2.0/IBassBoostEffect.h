#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_IBASSBOOSTEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_IBASSBOOSTEFFECT_H
...
struct IBassBoostEffect : public ::android::hardware::audio::effect::V2_0::IEffect {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@2.0::IBassBoostEffect"
     */
     ...
     */
    using isStrengthSupported_cb = std::function<void(::android::hardware::audio::effect::V2_0::Result retval, bool strengthSupported)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V2_0::IBassBoostEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V2_0::IBassBoostEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V2_0::IBassBoostEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V2_0::IEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V2_0::IBassBoostEffect>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange o);
static inline void PrintTo(::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange o, ::std::ostream* os);
constexpr uint16_t operator|(const ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange lhs, const ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange rhs) {
    return static_cast<uint16_t>(static_cast<uint16_t>(lhs) | static_cast<uint16_t>(rhs));
}
constexpr uint16_t operator|(const uint16_t lhs, const ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange rhs) {
    return static_cast<uint16_t>(lhs | static_cast<uint16_t>(rhs));
}
constexpr uint16_t operator|(const ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange lhs, const uint16_t rhs) {
...
constexpr uint16_t &operator|=(uint16_t& v, const ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange e) {
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V2_0::IBassBoostEffect>& o);
...
template<>
inline std::string toString<::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange>(uint16_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange::MIN) == static_cast<uint16_t>(::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange::MIN)) {
        os += (first ? "" : " | ");
        os += "MIN";
        first = false;
        flipped |= ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange::MIN;
    }
    if ((o & ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange::MAX) == static_cast<uint16_t>(::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange::MAX)) {
        os += (first ? "" : " | ");
        os += "MAX";
        first = false;
        flipped |= ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange::MAX;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
...
static inline std::string toString(::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange::MIN) {
        return "MIN";
    }
    if (o == ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange::MAX) {
        return "MAX";
    }
    std::string os;
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V2_0::IBassBoostEffect>& o) {
    ...
    os += ::android::hardware::audio::effect::V2_0::IBassBoostEffect::descriptor;
    os += "]";
...
template<> inline constexpr std::array<::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange, 2> hidl_enum_values<::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange> = {
    ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange::MIN,
    ::android::hardware::audio::effect::V2_0::IBassBoostEffect::StrengthRange::MAX,
};
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_IBASSBOOSTEFFECT_H
