...
struct IPresetReverbEffect : public ::android::hardware::audio::effect::V4_0::IEffect {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@4.0::IPresetReverbEffect"
     */
...
static inline void PrintTo(::android::hardware::audio::effect::V4_0::IPresetReverbEffect::Preset o, ::std::ostream* os);
...
template<> inline constexpr std::array<::android::hardware::audio::effect::V4_0::IPresetReverbEffect::Preset, 8> hidl_enum_values<::android::hardware::audio::effect::V4_0::IPresetReverbEffect::Preset> = {
