#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_V1_1_IBLUETOOTHHCI_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_V1_1_IBLUETOOTHHCI_H
 ...
 */
struct IBluetoothHci : public ::android::hardware::bluetooth::V1_0::IBluetoothHci {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.bluetooth@1.1::IBluetoothHci"
     */
     ...
     */
    virtual ::android::hardware::Return<void> initialize_1_1(const ::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks>& callback) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHci>> castFrom(const ::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHci>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHci>> castFrom(const ::android::sp<::android::hardware::bluetooth::V1_0::IBluetoothHci>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHci>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHci>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHci>& o) {
    ...
    os += ::android::hardware::bluetooth::V1_1::IBluetoothHci::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_V1_1_IBLUETOOTHHCI_H
