#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_1_BPHWSUPPLICANTSTAIFACECALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_1_BPHWSUPPLICANTSTAIFACECALLBACK_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/wifi/supplicant/1.1/IHwSupplicantStaIfaceCallback.h>
...
struct BpHwSupplicantStaIfaceCallback : public ::android::hardware::BpInterface<ISupplicantStaIfaceCallback>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_onEapFailure_1_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::wifi::supplicant::V1_1::ISupplicantStaIfaceCallback::EapErrorCode errorCode);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_1_BPHWSUPPLICANTSTAIFACECALLBACK_H
