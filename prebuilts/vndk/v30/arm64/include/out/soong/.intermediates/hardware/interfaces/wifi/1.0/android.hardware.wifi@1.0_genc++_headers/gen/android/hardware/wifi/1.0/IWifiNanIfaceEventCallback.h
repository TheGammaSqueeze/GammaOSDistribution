#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_0_IWIFINANIFACEEVENTCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_0_IWIFINANIFACEEVENTCALLBACK_H
 ...
 */
struct IWifiNanIfaceEventCallback : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi@1.0::IWifiNanIfaceEventCallback"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_0::IWifiNanIfaceEventCallback>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiNanIfaceEventCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_0::IWifiNanIfaceEventCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_0::IWifiNanIfaceEventCallback>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_0::IWifiNanIfaceEventCallback>& o) {
    ...
    os += ::android::hardware::wifi::V1_0::IWifiNanIfaceEventCallback::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_0_IWIFINANIFACEEVENTCALLBACK_H
