...
struct IRadioResponse : public ::android::hardware::radio::V1_0::IRadioResponse {
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio@1.1::IRadioResponse"
     */
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_1::IRadioResponse>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_1::IRadioResponse>& o) {
    ...
    os += ::android::hardware::radio::V1_1::IRadioResponse::descriptor;
    os += "]";
