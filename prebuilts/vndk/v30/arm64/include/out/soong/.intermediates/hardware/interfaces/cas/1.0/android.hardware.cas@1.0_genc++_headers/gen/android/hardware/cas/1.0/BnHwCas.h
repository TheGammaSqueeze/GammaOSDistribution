#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_0_BNHWCAS_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_0_BNHWCAS_H
...
struct BnHwCas : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_setPrivateData(
    ...
    static ::android::status_t _hidl_closeSession(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_setSessionPrivateData(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_processEcm(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_processEmm(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_provision(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
    ...
    static ::android::status_t _hidl_refreshEntitlements(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_0_BNHWCAS_H
