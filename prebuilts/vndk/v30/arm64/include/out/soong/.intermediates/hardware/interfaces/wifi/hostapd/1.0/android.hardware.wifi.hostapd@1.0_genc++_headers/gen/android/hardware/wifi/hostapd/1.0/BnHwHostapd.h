#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_HOSTAPD_V1_0_BNHWHOSTAPD_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_HOSTAPD_V1_0_BNHWHOSTAPD_H
...
struct BnHwHostapd : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_addAccessPoint(
    ...
    static ::android::status_t _hidl_removeAccessPoint(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_HOSTAPD_V1_0_BNHWHOSTAPD_H
