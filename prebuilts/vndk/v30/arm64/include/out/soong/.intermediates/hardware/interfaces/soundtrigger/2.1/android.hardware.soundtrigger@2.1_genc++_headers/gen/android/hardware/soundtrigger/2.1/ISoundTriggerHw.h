#ifndef HIDL_GENERATED_ANDROID_HARDWARE_SOUNDTRIGGER_V2_1_ISOUNDTRIGGERHW_H
#define HIDL_GENERATED_ANDROID_HARDWARE_SOUNDTRIGGER_V2_1_ISOUNDTRIGGERHW_H
 ...
 */
struct ISoundTriggerHw : public ::android::hardware::soundtrigger::V2_0::ISoundTriggerHw {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.soundtrigger@2.1::ISoundTriggerHw"
     */
    ...
    struct SoundModel final {
         ...
         * is ignored
         */
        ::android::hardware::soundtrigger::V2_0::ISoundTriggerHw::SoundModel header __attribute__ ((aligned(8)));
        /**
    ...
    static_assert(offsetof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::SoundModel, header) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::SoundModel, data) == 56, "wrong offset");
    static_assert(sizeof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::SoundModel) == 96, "wrong size");
    static_assert(__alignof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::SoundModel) == 8, "wrong alignment");
    ...
    struct PhraseSoundModel final {
         ...
         */
        ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::SoundModel common __attribute__ ((aligned(8)));
        /**
    ...
    static_assert(offsetof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::PhraseSoundModel, common) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::PhraseSoundModel, phrases) == 96, "wrong offset");
    static_assert(sizeof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::PhraseSoundModel) == 112, "wrong size");
    static_assert(__alignof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::PhraseSoundModel) == 8, "wrong alignment");
    ...
    struct RecognitionConfig final {
         ...
         * is ignored
         */
        ::android::hardware::soundtrigger::V2_0::ISoundTriggerHw::RecognitionConfig header __attribute__ ((aligned(8)));
        /**
    ...
    static_assert(offsetof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::RecognitionConfig, header) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::RecognitionConfig, data) == 48, "wrong offset");
    static_assert(sizeof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::RecognitionConfig) == 88, "wrong size");
    static_assert(__alignof(::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::RecognitionConfig) == 8, "wrong alignment");
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::soundtrigger::V2_1::ISoundTriggerHw>> castFrom(const ::android::sp<::android::hardware::soundtrigger::V2_1::ISoundTriggerHw>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::soundtrigger::V2_1::ISoundTriggerHw>> castFrom(const ::android::sp<::android::hardware::soundtrigger::V2_0::ISoundTriggerHw>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::soundtrigger::V2_1::ISoundTriggerHw>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::SoundModel& o);
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::SoundModel& o, ::std::ostream*);
// operator== and operator!= are not generated for SoundModel

static inline std::string toString(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::PhraseSoundModel& o);
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::PhraseSoundModel& o, ::std::ostream*);
// operator== and operator!= are not generated for PhraseSoundModel

static inline std::string toString(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::RecognitionConfig& o);
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::RecognitionConfig& o, ::std::ostream*);
// operator== and operator!= are not generated for RecognitionConfig

static inline std::string toString(const ::android::sp<::android::hardware::soundtrigger::V2_1::ISoundTriggerHw>& o);
...
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::SoundModel& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::PhraseSoundModel& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::RecognitionConfig& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::soundtrigger::V2_1::ISoundTriggerHw>& o) {
    ...
    os += ::android::hardware::soundtrigger::V2_1::ISoundTriggerHw::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_SOUNDTRIGGER_V2_1_ISOUNDTRIGGERHW_H
