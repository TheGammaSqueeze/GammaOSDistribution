...
struct IVehicleCallback : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.automotive.vehicle@2.0::IVehicleCallback"
     */
     ...
     */
    virtual ::android::hardware::Return<void> onPropertyEvent(const ::android::hardware::hidl_vec<::android::hardware::automotive::vehicle::V2_0::VehiclePropValue>& propValues) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> onPropertySet(const ::android::hardware::automotive::vehicle::V2_0::VehiclePropValue& propValue) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> onPropertySetError(::android::hardware::automotive::vehicle::V2_0::StatusCode errorCode, int32_t propId, int32_t areaId) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::automotive::vehicle::V2_0::IVehicleCallback>> castFrom(const ::android::sp<::android::hardware::automotive::vehicle::V2_0::IVehicleCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::automotive::vehicle::V2_0::IVehicleCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::automotive::vehicle::V2_0::IVehicleCallback>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::automotive::vehicle::V2_0::IVehicleCallback>& o) {
    ...
    os += ::android::hardware::automotive::vehicle::V2_0::IVehicleCallback::descriptor;
    os += "]";
