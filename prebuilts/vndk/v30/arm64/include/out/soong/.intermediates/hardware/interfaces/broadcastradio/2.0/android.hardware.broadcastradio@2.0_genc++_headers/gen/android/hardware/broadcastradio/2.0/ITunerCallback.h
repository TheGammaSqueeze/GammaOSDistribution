#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V2_0_ITUNERCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V2_0_ITUNERCALLBACK_H
...
struct ITunerCallback : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.broadcastradio@2.0::ITunerCallback"
     */
     ...
     */
    virtual ::android::hardware::Return<void> onTuneFailed(::android::hardware::broadcastradio::V2_0::Result result, const ::android::hardware::broadcastradio::V2_0::ProgramSelector& selector) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> onCurrentProgramInfoChanged(const ::android::hardware::broadcastradio::V2_0::ProgramInfo& info) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> onProgramListUpdated(const ::android::hardware::broadcastradio::V2_0::ProgramListChunk& chunk) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> onAntennaStateChange(bool connected) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> onParametersUpdated(const ::android::hardware::hidl_vec<::android::hardware::broadcastradio::V2_0::VendorKeyValue>& parameters) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::broadcastradio::V2_0::ITunerCallback>> castFrom(const ::android::sp<::android::hardware::broadcastradio::V2_0::ITunerCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::broadcastradio::V2_0::ITunerCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::broadcastradio::V2_0::ITunerCallback>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::broadcastradio::V2_0::ITunerCallback>& o) {
    ...
    os += ::android::hardware::broadcastradio::V2_0::ITunerCallback::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V2_0_ITUNERCALLBACK_H
