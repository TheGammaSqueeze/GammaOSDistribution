#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IPRESETREVERBEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IPRESETREVERBEFFECT_H
...
struct IPresetReverbEffect : public ::android::hardware::audio::effect::V6_0::IEffect {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@6.0::IPresetReverbEffect"
     */
    ...
    enum class Preset : int32_t {
        NONE = 0,
        SMALLROOM = 1 /* ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset.NONE implicitly + 1 */,
        MEDIUMROOM = 2 /* ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset.SMALLROOM implicitly + 1 */,
        LARGEROOM = 3 /* ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset.MEDIUMROOM implicitly + 1 */,
        MEDIUMHALL = 4 /* ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset.LARGEROOM implicitly + 1 */,
        LARGEHALL = 5 /* ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset.MEDIUMHALL implicitly + 1 */,
        PLATE = 6 /* ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset.LARGEHALL implicitly + 1 */,
        LAST = 6 /* PLATE */,
    };
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> setPreset(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset preset) = 0;

    /**
     * Return callback for getPreset
     */
    using getPreset_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset preset)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset o);
static inline void PrintTo(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset o, ::std::ostream* os);
constexpr int32_t operator|(const ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset lhs, const ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const int32_t lhs, const ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset rhs) {
    return static_cast<int32_t>(lhs | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset lhs, const int32_t rhs) {
...
constexpr int32_t &operator|=(int32_t& v, const ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset e) {
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect>& o);
...
template<>
inline std::string toString<::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset>(int32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::NONE) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::NONE)) {
        os += (first ? "" : " | ");
        os += "NONE";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::NONE;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::SMALLROOM) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::SMALLROOM)) {
        os += (first ? "" : " | ");
        os += "SMALLROOM";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::SMALLROOM;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::MEDIUMROOM) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::MEDIUMROOM)) {
        os += (first ? "" : " | ");
        os += "MEDIUMROOM";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::MEDIUMROOM;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LARGEROOM) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LARGEROOM)) {
        os += (first ? "" : " | ");
        os += "LARGEROOM";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LARGEROOM;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::MEDIUMHALL) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::MEDIUMHALL)) {
        os += (first ? "" : " | ");
        os += "MEDIUMHALL";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::MEDIUMHALL;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LARGEHALL) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LARGEHALL)) {
        os += (first ? "" : " | ");
        os += "LARGEHALL";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LARGEHALL;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::PLATE) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::PLATE)) {
        os += (first ? "" : " | ");
        os += "PLATE";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::PLATE;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LAST) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LAST)) {
        os += (first ? "" : " | ");
        os += "LAST";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LAST;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
...
static inline std::string toString(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::NONE) {
        return "NONE";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::SMALLROOM) {
        return "SMALLROOM";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::MEDIUMROOM) {
        return "MEDIUMROOM";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LARGEROOM) {
        return "LARGEROOM";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::MEDIUMHALL) {
        return "MEDIUMHALL";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LARGEHALL) {
        return "LARGEHALL";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::PLATE) {
        return "PLATE";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LAST) {
        return "LAST";
    }
    std::string os;
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect>& o) {
    ...
    os += ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::descriptor;
    os += "]";
...
template<> inline constexpr std::array<::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset, 8> hidl_enum_values<::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset> = {
    ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::NONE,
    ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::SMALLROOM,
    ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::MEDIUMROOM,
    ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LARGEROOM,
    ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::MEDIUMHALL,
    ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LARGEHALL,
    ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::PLATE,
    ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset::LAST,
};
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IPRESETREVERBEFFECT_H
