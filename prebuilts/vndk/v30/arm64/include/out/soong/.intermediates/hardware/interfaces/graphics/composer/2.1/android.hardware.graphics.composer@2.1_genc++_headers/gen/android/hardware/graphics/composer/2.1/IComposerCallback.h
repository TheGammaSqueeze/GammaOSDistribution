...
struct IComposerCallback : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.graphics.composer@2.1::IComposerCallback"
     */
...
static inline void PrintTo(::android::hardware::graphics::composer::V2_1::IComposerCallback::Connection o, ::std::ostream* os);
...
template<> inline constexpr std::array<::android::hardware::graphics::composer::V2_1::IComposerCallback::Connection, 3> hidl_enum_values<::android::hardware::graphics::composer::V2_1::IComposerCallback::Connection> = {
