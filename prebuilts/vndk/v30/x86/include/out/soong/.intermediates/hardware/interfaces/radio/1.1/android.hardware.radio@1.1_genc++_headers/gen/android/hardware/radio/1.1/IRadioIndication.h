...
struct IRadioIndication : public ::android::hardware::radio::V1_0::IRadioIndication {
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio@1.1::IRadioIndication"
     */
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_1::IRadioIndication>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_1::IRadioIndication>& o) {
    ...
    os += ::android::hardware::radio::V1_1::IRadioIndication::descriptor;
    os += "]";
