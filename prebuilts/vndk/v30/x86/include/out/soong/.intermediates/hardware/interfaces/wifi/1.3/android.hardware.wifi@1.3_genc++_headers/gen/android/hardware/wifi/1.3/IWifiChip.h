#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_3_IWIFICHIP_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_3_IWIFICHIP_H
 ...
 */
struct IWifiChip : public ::android::hardware::wifi::V1_2::IWifiChip {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.wifi@1.3::IWifiChip"
     */
    ...
    enum class ChipCapabilityMask : uint32_t {
         ...
         * Set Latency Mode.
         */
        SET_LATENCY_MODE = 4096u /* 1 << 12 */,
        /**
         * Support P2P MAC randomization
         */
        P2P_RAND_MAC = 8192u /* 1 << 13 */,
    };
     ...
     */
    using getCapabilities_1_3_cb = std::function<void(const ::android::hardware::wifi::V1_0::WifiStatus& status, ::android::hardware::hidl_bitfield<::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask> capabilities)>;
    /**
     * Get the capabilities supported by this chip.
     *
     * @return status WifiStatus of the operation.
    ...
    /**
     * Return callback for setLatencyMode
     */
    using setLatencyMode_cb = std::function<void(const ::android::hardware::wifi::V1_0::WifiStatus& status)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> setLatencyMode(::android::hardware::wifi::V1_3::IWifiChip::LatencyMode mode, setLatencyMode_cb _hidl_cb) = 0;

    /**
     * Return callback for flushRingBufferToFile
     */
    using flushRingBufferToFile_cb = std::function<void(const ::android::hardware::wifi::V1_0::WifiStatus& status)>;
    /**
     ...
     *         |WifiStatusCode.UNKNOWN|
     */
    virtual ::android::hardware::Return<void> flushRingBufferToFile(flushRingBufferToFile_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_3::IWifiChip>> castFrom(const ::android::sp<::android::hardware::wifi::V1_3::IWifiChip>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_3::IWifiChip>> castFrom(const ::android::sp<::android::hardware::wifi::V1_2::IWifiChip>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_3::IWifiChip>> castFrom(const ::android::sp<::android::hardware::wifi::V1_1::IWifiChip>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_3::IWifiChip>> castFrom(const ::android::sp<::android::hardware::wifi::V1_0::IWifiChip>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::wifi::V1_3::IWifiChip>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask o);
static inline void PrintTo(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask o, ::std::ostream* os);
constexpr uint32_t operator|(const ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask lhs, const ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask rhs) {
    return static_cast<uint32_t>(static_cast<uint32_t>(lhs) | static_cast<uint32_t>(rhs));
}
constexpr uint32_t operator|(const uint32_t lhs, const ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask rhs) {
    return static_cast<uint32_t>(lhs | static_cast<uint32_t>(rhs));
}
constexpr uint32_t operator|(const ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask lhs, const uint32_t rhs) {
...
constexpr uint32_t &operator|=(uint32_t& v, const ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask e) {
...
template<typename>
static inline std::string toString(uint32_t o);
static inline std::string toString(::android::hardware::wifi::V1_3::IWifiChip::LatencyMode o);
static inline void PrintTo(::android::hardware::wifi::V1_3::IWifiChip::LatencyMode o, ::std::ostream* os);
constexpr uint32_t operator|(const ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode lhs, const ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode rhs) {
    return static_cast<uint32_t>(static_cast<uint32_t>(lhs) | static_cast<uint32_t>(rhs));
}
constexpr uint32_t operator|(const uint32_t lhs, const ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode rhs) {
    return static_cast<uint32_t>(lhs | static_cast<uint32_t>(rhs));
}
constexpr uint32_t operator|(const ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode lhs, const uint32_t rhs) {
    return static_cast<uint32_t>(static_cast<uint32_t>(lhs) | rhs);
}
constexpr uint32_t operator&(const ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode lhs, const ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode rhs) {
    return static_cast<uint32_t>(static_cast<uint32_t>(lhs) & static_cast<uint32_t>(rhs));
...
constexpr uint32_t &operator|=(uint32_t& v, const ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode e) {
    v |= static_cast<uint32_t>(e);
    return v;
}
constexpr uint32_t &operator&=(uint32_t& v, const ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode e) {
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_3::IWifiChip>& o);
...
template<>
inline std::string toString<::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask>(uint32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_MEMORY_FIRMWARE_DUMP) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_MEMORY_FIRMWARE_DUMP)) {
        os += (first ? "" : " | ");
        os += "DEBUG_MEMORY_FIRMWARE_DUMP";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_MEMORY_FIRMWARE_DUMP;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_MEMORY_DRIVER_DUMP) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_MEMORY_DRIVER_DUMP)) {
        os += (first ? "" : " | ");
        os += "DEBUG_MEMORY_DRIVER_DUMP";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_MEMORY_DRIVER_DUMP;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_CONNECT_EVENT) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_CONNECT_EVENT)) {
        os += (first ? "" : " | ");
        os += "DEBUG_RING_BUFFER_CONNECT_EVENT";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_CONNECT_EVENT;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_POWER_EVENT) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_POWER_EVENT)) {
        os += (first ? "" : " | ");
        os += "DEBUG_RING_BUFFER_POWER_EVENT";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_POWER_EVENT;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_WAKELOCK_EVENT) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_WAKELOCK_EVENT)) {
        os += (first ? "" : " | ");
        os += "DEBUG_RING_BUFFER_WAKELOCK_EVENT";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_WAKELOCK_EVENT;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_VENDOR_DATA) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_VENDOR_DATA)) {
        os += (first ? "" : " | ");
        os += "DEBUG_RING_BUFFER_VENDOR_DATA";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_VENDOR_DATA;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_HOST_WAKE_REASON_STATS) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_HOST_WAKE_REASON_STATS)) {
        os += (first ? "" : " | ");
        os += "DEBUG_HOST_WAKE_REASON_STATS";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_HOST_WAKE_REASON_STATS;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_ERROR_ALERTS) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_ERROR_ALERTS)) {
        os += (first ? "" : " | ");
        os += "DEBUG_ERROR_ALERTS";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_ERROR_ALERTS;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::SET_TX_POWER_LIMIT) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::SET_TX_POWER_LIMIT)) {
        os += (first ? "" : " | ");
        os += "SET_TX_POWER_LIMIT";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::SET_TX_POWER_LIMIT;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::D2D_RTT) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::D2D_RTT)) {
        os += (first ? "" : " | ");
        os += "D2D_RTT";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::D2D_RTT;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::D2AP_RTT) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::D2AP_RTT)) {
        os += (first ? "" : " | ");
        os += "D2AP_RTT";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::D2AP_RTT;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::USE_BODY_HEAD_SAR) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::USE_BODY_HEAD_SAR)) {
        os += (first ? "" : " | ");
        os += "USE_BODY_HEAD_SAR";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::USE_BODY_HEAD_SAR;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::SET_LATENCY_MODE) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::SET_LATENCY_MODE)) {
        os += (first ? "" : " | ");
        os += "SET_LATENCY_MODE";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::SET_LATENCY_MODE;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::P2P_RAND_MAC) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::P2P_RAND_MAC)) {
        os += (first ? "" : " | ");
        os += "P2P_RAND_MAC";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::P2P_RAND_MAC;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
...
static inline std::string toString(::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_MEMORY_FIRMWARE_DUMP) {
        return "DEBUG_MEMORY_FIRMWARE_DUMP";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_MEMORY_DRIVER_DUMP) {
        return "DEBUG_MEMORY_DRIVER_DUMP";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_CONNECT_EVENT) {
        return "DEBUG_RING_BUFFER_CONNECT_EVENT";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_POWER_EVENT) {
        return "DEBUG_RING_BUFFER_POWER_EVENT";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_WAKELOCK_EVENT) {
        return "DEBUG_RING_BUFFER_WAKELOCK_EVENT";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_VENDOR_DATA) {
        return "DEBUG_RING_BUFFER_VENDOR_DATA";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_HOST_WAKE_REASON_STATS) {
        return "DEBUG_HOST_WAKE_REASON_STATS";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_ERROR_ALERTS) {
        return "DEBUG_ERROR_ALERTS";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::SET_TX_POWER_LIMIT) {
        return "SET_TX_POWER_LIMIT";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::D2D_RTT) {
        return "D2D_RTT";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::D2AP_RTT) {
        return "D2AP_RTT";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::USE_BODY_HEAD_SAR) {
        return "USE_BODY_HEAD_SAR";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::SET_LATENCY_MODE) {
        return "SET_LATENCY_MODE";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::P2P_RAND_MAC) {
        return "P2P_RAND_MAC";
    }
    std::string os;
...
template<>
inline std::string toString<::android::hardware::wifi::V1_3::IWifiChip::LatencyMode>(uint32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::wifi::V1_3::IWifiChip::LatencyMode> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode::NORMAL) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::LatencyMode::NORMAL)) {
        os += (first ? "" : " | ");
        os += "NORMAL";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode::NORMAL;
    }
    if ((o & ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode::LOW) == static_cast<uint32_t>(::android::hardware::wifi::V1_3::IWifiChip::LatencyMode::LOW)) {
        os += (first ? "" : " | ");
        os += "LOW";
        first = false;
        flipped |= ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode::LOW;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
        os += toHexString(o & (~flipped));
...
static inline std::string toString(::android::hardware::wifi::V1_3::IWifiChip::LatencyMode o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode::NORMAL) {
        return "NORMAL";
    }
    if (o == ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode::LOW) {
        return "LOW";
    }
    std::string os;
    os += toHexString(static_cast<uint32_t>(o));
...
static inline std::string toString(const ::android::sp<::android::hardware::wifi::V1_3::IWifiChip>& o) {
    ...
    os += ::android::hardware::wifi::V1_3::IWifiChip::descriptor;
    os += "]";
...
template<> inline constexpr std::array<::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask, 14> hidl_enum_values<::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask> = {
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_MEMORY_FIRMWARE_DUMP,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_MEMORY_DRIVER_DUMP,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_CONNECT_EVENT,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_POWER_EVENT,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_WAKELOCK_EVENT,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_RING_BUFFER_VENDOR_DATA,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_HOST_WAKE_REASON_STATS,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::DEBUG_ERROR_ALERTS,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::SET_TX_POWER_LIMIT,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::D2D_RTT,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::D2AP_RTT,
    ::android::hardware::wifi::V1_3::IWifiChip::ChipCapabilityMask::USE_BODY_HEAD_SAR,
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<> inline constexpr std::array<::android::hardware::wifi::V1_3::IWifiChip::LatencyMode, 2> hidl_enum_values<::android::hardware::wifi::V1_3::IWifiChip::LatencyMode> = {
    ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode::NORMAL,
    ::android::hardware::wifi::V1_3::IWifiChip::LatencyMode::LOW,
};
#pragma clang diagnostic pop
}  // namespace details
}  // namespace hardware
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_3_IWIFICHIP_H
