#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_3_BPHWSUPPLICANTSTAIFACECALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_3_BPHWSUPPLICANTSTAIFACECALLBACK_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/wifi/supplicant/1.3/IHwSupplicantStaIfaceCallback.h>
...
struct BpHwSupplicantStaIfaceCallback : public ::android::hardware::BpInterface<ISupplicantStaIfaceCallback>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_onPmkCacheAdded(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int64_t expirationTimeInSec, const ::android::hardware::hidl_vec<uint8_t>& serializedEntry);
    static ::android::hardware::Return<void>  _hidl_onDppSuccess(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::wifi::supplicant::V1_3::DppSuccessCode code);
    static ::android::hardware::Return<void>  _hidl_onDppProgress_1_3(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::wifi::supplicant::V1_3::DppProgressCode code);
    static ::android::hardware::Return<void>  _hidl_onDppFailure_1_3(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::wifi::supplicant::V1_3::DppFailureCode code, const ::android::hardware::hidl_string& ssid, const ::android::hardware::hidl_string& channelList, const ::android::hardware::hidl_vec<uint16_t>& bandList);
    static ::android::hardware::Return<void>  _hidl_onBssTmHandlingDone(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::wifi::supplicant::V1_3::ISupplicantStaIfaceCallback::BssTmData& tmData);
    static ::android::hardware::Return<void>  _hidl_onEapFailure_1_3(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t errorCode);
    static ::android::hardware::Return<void>  _hidl_onStateChanged_1_3(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::wifi::supplicant::V1_0::ISupplicantStaIfaceCallback::State newState, const ::android::hardware::hidl_array<uint8_t, 6>& bssid, uint32_t id, const ::android::hardware::hidl_vec<uint8_t>& ssid, bool filsHlpSent);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_3_BPHWSUPPLICANTSTAIFACECALLBACK_H
