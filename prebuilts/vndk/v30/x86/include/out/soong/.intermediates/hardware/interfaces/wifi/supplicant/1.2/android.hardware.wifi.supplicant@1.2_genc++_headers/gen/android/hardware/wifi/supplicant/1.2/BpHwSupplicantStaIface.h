#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_2_BPHWSUPPLICANTSTAIFACE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_2_BPHWSUPPLICANTSTAIFACE_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/wifi/supplicant/1.2/IHwSupplicantStaIface.h>
...
struct BpHwSupplicantStaIface : public ::android::hardware::BpInterface<ISupplicantStaIface>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_registerCallback_1_2(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::wifi::supplicant::V1_2::ISupplicantStaIfaceCallback>& callback, registerCallback_1_2_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_getKeyMgmtCapabilities(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getKeyMgmtCapabilities_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_addDppPeerUri(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& uri, addDppPeerUri_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_removeDppUri(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t id, removeDppUri_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_startDppConfiguratorInitiator(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t peerBootstrapId, uint32_t ownBootstrapId, const ::android::hardware::hidl_string& ssid, const ::android::hardware::hidl_string& password, const ::android::hardware::hidl_string& psk, ::android::hardware::wifi::supplicant::V1_2::DppNetRole netRole, ::android::hardware::wifi::supplicant::V1_2::DppAkm securityAkm, startDppConfiguratorInitiator_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_startDppEnrolleeInitiator(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t peerBootstrapId, uint32_t ownBootstrapId, startDppEnrolleeInitiator_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_stopDppInitiator(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, stopDppInitiator_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_SUPPLICANT_V1_2_BPHWSUPPLICANTSTAIFACE_H
