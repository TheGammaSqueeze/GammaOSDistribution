#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_3_BPHWRADIO_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_3_BPHWRADIO_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/radio/1.3/IHwRadio.h>
...
struct BpHwRadio : public ::android::hardware::BpInterface<IRadio>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_setSystemSelectionChannels(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, bool specifyChannels, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_1::RadioAccessSpecifier>& specifiers);
    static ::android::hardware::Return<void>  _hidl_enableModem(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, bool on);
    static ::android::hardware::Return<void>  _hidl_getModemStackStatus(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RADIO_V1_3_BPHWRADIO_H
