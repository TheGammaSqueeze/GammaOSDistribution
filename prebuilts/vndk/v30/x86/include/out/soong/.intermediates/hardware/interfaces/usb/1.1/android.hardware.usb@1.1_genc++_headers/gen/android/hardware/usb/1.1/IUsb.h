#ifndef HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_1_IUSB_H
#define HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_1_IUSB_H
 ...
 */
struct IUsb : public ::android::hardware::usb::V1_0::IUsb {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.usb@1.1::IUsb"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::usb::V1_1::IUsb>> castFrom(const ::android::sp<::android::hardware::usb::V1_1::IUsb>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::usb::V1_1::IUsb>> castFrom(const ::android::sp<::android::hardware::usb::V1_0::IUsb>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::usb::V1_1::IUsb>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::usb::V1_1::IUsb>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::usb::V1_1::IUsb>& o) {
    ...
    os += ::android::hardware::usb::V1_1::IUsb::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_1_IUSB_H
