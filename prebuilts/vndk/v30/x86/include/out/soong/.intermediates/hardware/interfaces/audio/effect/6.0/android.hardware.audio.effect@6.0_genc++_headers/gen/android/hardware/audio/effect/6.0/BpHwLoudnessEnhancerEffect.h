#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_BPHWLOUDNESSENHANCEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_BPHWLOUDNESSENHANCEREFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/6.0/IHwLoudnessEnhancerEffect.h>
...
struct BpHwLoudnessEnhancerEffect : public ::android::hardware::BpInterface<ILoudnessEnhancerEffect>, public ::android::hardware::details::HidlInstrumentor {
    explicit BpHwLoudnessEnhancerEffect(const ::android::sp<::android::hardware::IBinder> &_hidl_impl);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result>  _hidl_setTargetGain(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t targetGainMb);
    static ::android::hardware::Return<void>  _hidl_getTargetGain(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getTargetGain_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_BPHWLOUDNESSENHANCEREFFECT_H
