#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_BPHWBASSBOOSTEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_BPHWBASSBOOSTEFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/6.0/IHwBassBoostEffect.h>
...
struct BpHwBassBoostEffect : public ::android::hardware::BpInterface<IBassBoostEffect>, public ::android::hardware::details::HidlInstrumentor {
    explicit BpHwBassBoostEffect(const ::android::sp<::android::hardware::IBinder> &_hidl_impl);
    ...
    static ::android::hardware::Return<void>  _hidl_isStrengthSupported(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, isStrengthSupported_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_BPHWBASSBOOSTEFFECT_H
