...
struct IOemHookResponse : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio.deprecated@1.0::IOemHookResponse"
     */
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::deprecated::V1_0::IOemHookResponse>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::deprecated::V1_0::IOemHookResponse>& o) {
    ...
    os += ::android::hardware::radio::deprecated::V1_0::IOemHookResponse::descriptor;
    os += "]";
