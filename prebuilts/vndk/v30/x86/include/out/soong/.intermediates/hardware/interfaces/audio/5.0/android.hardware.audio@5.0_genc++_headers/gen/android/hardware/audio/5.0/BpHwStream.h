#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWSTREAM_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWSTREAM_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/5.0/IHwStream.h>
...
struct BpHwStream : public ::android::hardware::BpInterface<IStream>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_getSupportedSampleRates(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::common::V5_0::AudioFormat format, getSupportedSampleRates_cb _hidl_cb);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setSampleRate(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t sampleRateHz);
    static ::android::hardware::Return<::android::hardware::hidl_bitfield<::android::hardware::audio::common::V5_0::AudioChannelMask>>  _hidl_getChannelMask(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<void>  _hidl_getSupportedChannelMasks(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::common::V5_0::AudioFormat format, getSupportedChannelMasks_cb _hidl_cb);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setChannelMask(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::hidl_bitfield<::android::hardware::audio::common::V5_0::AudioChannelMask> mask);
    static ::android::hardware::Return<::android::hardware::audio::common::V5_0::AudioFormat>  _hidl_getFormat(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setFormat(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::common::V5_0::AudioFormat format);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_addEffect(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t effectId);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_removeEffect(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t effectId);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_standby(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setDevices(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::audio::common::V5_0::DeviceAddress>& devices);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setHwAvSync(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t hwAvSync);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_start(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_stop(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_close(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWSTREAM_H
