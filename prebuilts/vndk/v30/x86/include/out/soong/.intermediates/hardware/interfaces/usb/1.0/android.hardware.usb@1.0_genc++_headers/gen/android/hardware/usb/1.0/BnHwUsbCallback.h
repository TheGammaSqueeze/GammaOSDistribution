#ifndef HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_0_BNHWUSBCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_0_BNHWUSBCALLBACK_H
...
struct BnHwUsbCallback : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_notifyPortStatusChange(
    ...
    static ::android::status_t _hidl_notifyRoleSwitchStatus(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_USB_V1_0_BNHWUSBCALLBACK_H
