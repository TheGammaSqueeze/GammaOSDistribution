#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_IACOUSTICECHOCANCELEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_IACOUSTICECHOCANCELEREFFECT_H
...
struct IAcousticEchoCancelerEffect : public ::android::hardware::audio::effect::V2_0::IEffect {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@2.0::IAcousticEchoCancelerEffect"
     */
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result> setEchoDelay(uint32_t echoDelayMs) = 0;

    /**
     * Return callback for getEchoDelay
     */
    using getEchoDelay_cb = std::function<void(::android::hardware::audio::effect::V2_0::Result retval, uint32_t echoDelayMs)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V2_0::IAcousticEchoCancelerEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V2_0::IAcousticEchoCancelerEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V2_0::IAcousticEchoCancelerEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V2_0::IEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V2_0::IAcousticEchoCancelerEffect>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V2_0::IAcousticEchoCancelerEffect>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V2_0::IAcousticEchoCancelerEffect>& o) {
    ...
    os += ::android::hardware::audio::effect::V2_0::IAcousticEchoCancelerEffect::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_IACOUSTICECHOCANCELEREFFECT_H
