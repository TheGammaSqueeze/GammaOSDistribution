...
struct IRadioResponse : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.radio@1.0::IRadioResponse"
     */
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_0::IRadioResponse>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::radio::V1_0::IRadioResponse>& o) {
    ...
    os += ::android::hardware::radio::V1_0::IRadioResponse::descriptor;
    os += "]";
