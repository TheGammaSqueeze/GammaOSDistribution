#ifndef HIDL_GENERATED_ANDROID_HARDWARE_HEALTH_V1_0_IHEALTH_H
#define HIDL_GENERATED_ANDROID_HARDWARE_HEALTH_V1_0_IHEALTH_H
...
struct IHealth : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.health@1.0::IHealth"
     */
    ...
    /**
     * Return callback for init
     */
    using init_cb = std::function<void(const ::android::hardware::health::V1_0::HealthConfig& configOut)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> init(const ::android::hardware::health::V1_0::HealthConfig& config, init_cb _hidl_cb) = 0;

    /**
     * Return callback for update
     */
    using update_cb = std::function<void(bool skipLogging, const ::android::hardware::health::V1_0::HealthInfo& infoOut)>;
    /**
     ...
     *          not be modified).
     */
    virtual ::android::hardware::Return<void> update(const ::android::hardware::health::V1_0::HealthInfo& info, update_cb _hidl_cb) = 0;

    /**
     * Return callback for energyCounter
     */
    using energyCounter_cb = std::function<void(::android::hardware::health::V1_0::Result result, int64_t energy)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> energyCounter(energyCounter_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::health::V1_0::IHealth>> castFrom(const ::android::sp<::android::hardware::health::V1_0::IHealth>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::health::V1_0::IHealth>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::health::V1_0::IHealth>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::health::V1_0::IHealth>& o) {
    ...
    os += ::android::hardware::health::V1_0::IHealth::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_HEALTH_V1_0_IHEALTH_H
