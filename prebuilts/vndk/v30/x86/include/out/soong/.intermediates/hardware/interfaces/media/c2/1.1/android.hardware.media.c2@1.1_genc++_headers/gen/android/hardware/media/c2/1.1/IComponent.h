#ifndef HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_1_ICOMPONENT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_1_ICOMPONENT_H
...
struct IComponent : public ::android::hardware::media::c2::V1_0::IComponent {
    ...
    /**
     * Fully qualified interface name: "android.hardware.media.c2@1.1::IComponent"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_1::IComponent>> castFrom(const ::android::sp<::android::hardware::media::c2::V1_1::IComponent>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_1::IComponent>> castFrom(const ::android::sp<::android::hardware::media::c2::V1_0::IComponent>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_1::IComponent>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::media::c2::V1_1::IComponent>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::media::c2::V1_1::IComponent>& o) {
    ...
    os += ::android::hardware::media::c2::V1_1::IComponent::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_1_ICOMPONENT_H
