#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V1_1_IBROADCASTRADIO_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V1_1_IBROADCASTRADIO_H
...
struct IBroadcastRadio : public ::android::hardware::broadcastradio::V1_0::IBroadcastRadio {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.broadcastradio@1.1::IBroadcastRadio"
     */
     ...
     */
    using getProperties_cb = std::function<void(::android::hardware::broadcastradio::V1_0::Result result, const ::android::hardware::broadcastradio::V1_0::Properties& properties)>;
    /**
    ...
    /**
     * Return callback for openTuner
     */
    using openTuner_cb = std::function<void(::android::hardware::broadcastradio::V1_0::Result result, const ::android::sp<::android::hardware::broadcastradio::V1_0::ITuner>& tuner)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> openTuner(const ::android::hardware::broadcastradio::V1_0::BandConfig& config, bool audio, const ::android::sp<::android::hardware::broadcastradio::V1_0::ITunerCallback>& callback, openTuner_cb _hidl_cb) = 0;

    /**
     * Return callback for getProperties_1_1
     */
    using getProperties_1_1_cb = std::function<void(const ::android::hardware::broadcastradio::V1_1::Properties& properties)>;
    /**
     * Retrieve implementation properties.
     * @return properties A Properties structure containing implementation
     *                    description and capabilities.
     */
    virtual ::android::hardware::Return<void> getProperties_1_1(getProperties_1_1_cb _hidl_cb) = 0;
     ...
     */
    virtual ::android::hardware::Return<void> getImage(int32_t id, getImage_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::broadcastradio::V1_1::IBroadcastRadio>> castFrom(const ::android::sp<::android::hardware::broadcastradio::V1_1::IBroadcastRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::broadcastradio::V1_1::IBroadcastRadio>> castFrom(const ::android::sp<::android::hardware::broadcastradio::V1_0::IBroadcastRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::broadcastradio::V1_1::IBroadcastRadio>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::broadcastradio::V1_1::IBroadcastRadio>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::broadcastradio::V1_1::IBroadcastRadio>& o) {
    ...
    os += ::android::hardware::broadcastradio::V1_1::IBroadcastRadio::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V1_1_IBROADCASTRADIO_H
