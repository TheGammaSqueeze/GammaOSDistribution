#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWDEVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWDEVICE_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/5.0/IHwDevice.h>
...
struct BpHwDevice : public ::android::hardware::BpInterface<IDevice>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_initCheck(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setMasterVolume(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float volume);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setMicMute(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool mute);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setMasterMute(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool mute);
    ...
    static ::android::hardware::Return<void>  _hidl_getInputBufferSize(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V5_0::AudioConfig& config, getInputBufferSize_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_openOutputStream(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t ioHandle, const ::android::hardware::audio::common::V5_0::DeviceAddress& device, const ::android::hardware::audio::common::V5_0::AudioConfig& config, ::android::hardware::hidl_bitfield<::android::hardware::audio::common::V5_0::AudioOutputFlag> flags, const ::android::hardware::audio::common::V5_0::SourceMetadata& sourceMetadata, openOutputStream_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_openInputStream(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t ioHandle, const ::android::hardware::audio::common::V5_0::DeviceAddress& device, const ::android::hardware::audio::common::V5_0::AudioConfig& config, ::android::hardware::hidl_bitfield<::android::hardware::audio::common::V5_0::AudioInputFlag> flags, const ::android::hardware::audio::common::V5_0::SinkMetadata& sinkMetadata, openInputStream_cb _hidl_cb);
    ...
    static ::android::hardware::Return<void>  _hidl_createAudioPatch(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::audio::common::V5_0::AudioPortConfig>& sources, const ::android::hardware::hidl_vec<::android::hardware::audio::common::V5_0::AudioPortConfig>& sinks, createAudioPatch_cb _hidl_cb);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_releaseAudioPatch(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t patch);
    static ::android::hardware::Return<void>  _hidl_getAudioPort(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V5_0::AudioPort& port, getAudioPort_cb _hidl_cb);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setAudioPortConfig(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V5_0::AudioPortConfig& config);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setScreenState(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool turnedOn);
    static ::android::hardware::Return<void>  _hidl_getParameters(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::audio::V5_0::ParameterValue>& context, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& keys, getParameters_cb _hidl_cb);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setParameters(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::audio::V5_0::ParameterValue>& context, const ::android::hardware::hidl_vec<::android::hardware::audio::V5_0::ParameterValue>& parameters);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setConnectedState(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V5_0::DeviceAddress& address, bool connected);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWDEVICE_H
