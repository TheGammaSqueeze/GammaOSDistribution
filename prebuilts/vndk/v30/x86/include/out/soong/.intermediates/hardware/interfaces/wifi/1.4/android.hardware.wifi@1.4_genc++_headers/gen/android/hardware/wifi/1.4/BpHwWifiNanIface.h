#ifndef HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_BPHWWIFINANIFACE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_BPHWWIFINANIFACE_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/wifi/1.4/IHwWifiNanIface.h>
...
struct BpHwWifiNanIface : public ::android::hardware::BpInterface<IWifiNanIface>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_enableRequest_1_4(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint16_t cmdId, const ::android::hardware::wifi::V1_4::NanEnableRequest& msg1, const ::android::hardware::wifi::V1_2::NanConfigRequestSupplemental& msg2, enableRequest_1_4_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_configRequest_1_4(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint16_t cmdId, const ::android::hardware::wifi::V1_4::NanConfigRequest& msg1, const ::android::hardware::wifi::V1_2::NanConfigRequestSupplemental& msg2, configRequest_1_4_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_WIFI_V1_4_BPHWWIFINANIFACE_H
