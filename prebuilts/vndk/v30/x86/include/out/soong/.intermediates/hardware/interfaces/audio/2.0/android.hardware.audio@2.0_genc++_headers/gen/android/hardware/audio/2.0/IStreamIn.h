...
struct IStreamIn : public ::android::hardware::audio::V2_0::IStream {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio@2.0::IStreamIn"
     */
...
static inline void PrintTo(::android::hardware::audio::V2_0::IStreamIn::ReadCommand o, ::std::ostream* os);
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamIn::ReadParameters::Params& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamIn::ReadParameters& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamIn::ReadStatus::Reply::CapturePosition& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamIn::ReadStatus::Reply& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamIn::ReadStatus& o, ::std::ostream*);
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamIn::ReadParameters::Params& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamIn::ReadParameters& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamIn::ReadStatus::Reply::CapturePosition& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamIn::ReadStatus::Reply& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::audio::V2_0::IStreamIn::ReadStatus& o, ::std::ostream* os) {
    *os << toString(o);
}
...
template<> inline constexpr std::array<::android::hardware::audio::V2_0::IStreamIn::ReadCommand, 2> hidl_enum_values<::android::hardware::audio::V2_0::IStreamIn::ReadCommand> = {
