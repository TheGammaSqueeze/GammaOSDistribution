#ifndef HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_0_BNHWDRMFACTORY_H
#define HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_0_BNHWDRMFACTORY_H
...
struct BnHwDrmFactory : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_isCryptoSchemeSupported(
    ...
    static ::android::status_t _hidl_isContentTypeSupported(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_0_BNHWDRMFACTORY_H
