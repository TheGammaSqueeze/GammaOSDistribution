#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_1_ICASLISTENER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_1_ICASLISTENER_H
...
struct ICasListener : public ::android::hardware::cas::V1_0::ICasListener {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.cas@1.1::ICasListener"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_1::ICasListener>> castFrom(const ::android::sp<::android::hardware::cas::V1_1::ICasListener>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_1::ICasListener>> castFrom(const ::android::sp<::android::hardware::cas::V1_0::ICasListener>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::cas::V1_1::ICasListener>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::cas::V1_1::ICasListener>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::cas::V1_1::ICasListener>& o) {
    ...
    os += ::android::hardware::cas::V1_1::ICasListener::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAS_V1_1_ICASLISTENER_H
