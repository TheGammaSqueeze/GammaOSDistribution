#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWEQUALIZEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWEQUALIZEREFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/4.0/IHwEqualizerEffect.h>
...
struct BpHwEqualizerEffect : public ::android::hardware::BpInterface<IEqualizerEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_setBandLevel(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint16_t band, int16_t level);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_setCurrentPreset(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint16_t preset);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_setAllProperties(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::effect::V4_0::IEqualizerEffect::AllProperties& properties);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWEQUALIZEREFFECT_H
