...
struct IDevicesFactory : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio@2.0::IDevicesFactory"
     */
...
static inline void PrintTo(::android::hardware::audio::V2_0::IDevicesFactory::Device o, ::std::ostream* os);
...
template<> inline constexpr std::array<::android::hardware::audio::V2_0::IDevicesFactory::Device, 5> hidl_enum_values<::android::hardware::audio::V2_0::IDevicesFactory::Device> = {
