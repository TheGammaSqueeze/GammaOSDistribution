#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_INOISESUPPRESSIONEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_INOISESUPPRESSIONEFFECT_H
...
struct INoiseSuppressionEffect : public ::android::hardware::audio::effect::V4_0::IEffect {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@4.0::INoiseSuppressionEffect"
     */
    ...
    enum class Level : int32_t {
        LOW = 0,
        MEDIUM = 1 /* ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level.LOW implicitly + 1 */,
        HIGH = 2 /* ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level.MEDIUM implicitly + 1 */,
    };

    enum class Type : int32_t {
        SINGLE_CHANNEL = 0,
        MULTI_CHANNEL = 1 /* ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type.SINGLE_CHANNEL implicitly + 1 */,
    };

    struct AllProperties final {
        ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level level __attribute__ ((aligned(4)));
        ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type type __attribute__ ((aligned(4)));
    };

    static_assert(offsetof(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties, level) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties, type) == 4, "wrong offset");
    static_assert(sizeof(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties) == 8, "wrong size");
    static_assert(__alignof(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties) == 4, "wrong alignment");
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setSuppressionLevel(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level level) = 0;

    /**
     * Return callback for getSuppressionLevel
     */
    using getSuppressionLevel_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level level)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setSuppressionType(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type type) = 0;

    /**
     * Return callback for getSuppressionType
     */
    using getSuppressionType_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type type)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> setAllProperties(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& properties) = 0;

    /**
     * Return callback for getAllProperties
     */
    using getAllProperties_cb = std::function<void(::android::hardware::audio::effect::V4_0::Result retval, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& properties)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::IEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level o);
static inline void PrintTo(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level o, ::std::ostream* os);
constexpr int32_t operator|(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level lhs, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const int32_t lhs, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level rhs) {
    return static_cast<int32_t>(lhs | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level lhs, const int32_t rhs) {
...
constexpr int32_t &operator|=(int32_t& v, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level e) {
...
template<typename>
static inline std::string toString(int32_t o);
static inline std::string toString(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type o);
static inline void PrintTo(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type o, ::std::ostream* os);
constexpr int32_t operator|(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type lhs, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const int32_t lhs, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type rhs) {
    return static_cast<int32_t>(lhs | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type lhs, const int32_t rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | rhs);
}
constexpr int32_t operator&(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type lhs, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) & static_cast<int32_t>(rhs));
...
constexpr int32_t &operator|=(int32_t& v, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type e) {
    v |= static_cast<int32_t>(e);
    return v;
}
constexpr int32_t &operator&=(int32_t& v, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type e) {
...
static inline std::string toString(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& o);
static inline void PrintTo(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& lhs, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& rhs);
static inline bool operator!=(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& lhs, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& rhs);

static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect>& o);
...
template<>
inline std::string toString<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level>(int32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::LOW) == static_cast<int32_t>(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::LOW)) {
        os += (first ? "" : " | ");
        os += "LOW";
        first = false;
        flipped |= ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::LOW;
    }
    if ((o & ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::MEDIUM) == static_cast<int32_t>(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::MEDIUM)) {
        os += (first ? "" : " | ");
        os += "MEDIUM";
        first = false;
        flipped |= ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::MEDIUM;
    }
    if ((o & ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::HIGH) == static_cast<int32_t>(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::HIGH)) {
        os += (first ? "" : " | ");
        os += "HIGH";
        first = false;
        flipped |= ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::HIGH;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
...
static inline std::string toString(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::LOW) {
        return "LOW";
    }
    if (o == ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::MEDIUM) {
        return "MEDIUM";
    }
    if (o == ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::HIGH) {
        return "HIGH";
    }
    std::string os;
...
template<>
inline std::string toString<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type>(int32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type::SINGLE_CHANNEL) == static_cast<int32_t>(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type::SINGLE_CHANNEL)) {
        os += (first ? "" : " | ");
        os += "SINGLE_CHANNEL";
        first = false;
        flipped |= ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type::SINGLE_CHANNEL;
    }
    if ((o & ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type::MULTI_CHANNEL) == static_cast<int32_t>(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type::MULTI_CHANNEL)) {
        os += (first ? "" : " | ");
        os += "MULTI_CHANNEL";
        first = false;
        flipped |= ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type::MULTI_CHANNEL;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
        os += toHexString(o & (~flipped));
...
static inline std::string toString(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type::SINGLE_CHANNEL) {
        return "SINGLE_CHANNEL";
    }
    if (o == ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type::MULTI_CHANNEL) {
...
static inline std::string toString(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& o) {
    ...
    os += "{";
    os += ".level = ";
    os += ::android::hardware::audio::effect::V4_0::toString(o.level);
    os += ", .type = ";
    os += ::android::hardware::audio::effect::V4_0::toString(o.type);
    os += "}"; return os;
}

static inline void PrintTo(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect>& o) {
    ...
    os += ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::descriptor;
    os += "]";
...
template<> inline constexpr std::array<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level, 3> hidl_enum_values<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level> = {
    ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::LOW,
    ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::MEDIUM,
    ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level::HIGH,
};
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<> inline constexpr std::array<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type, 2> hidl_enum_values<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type> = {
    ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type::SINGLE_CHANNEL,
    ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type::MULTI_CHANNEL,
};
#pragma clang diagnostic pop
}  // namespace details
}  // namespace hardware
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_INOISESUPPRESSIONEFFECT_H
