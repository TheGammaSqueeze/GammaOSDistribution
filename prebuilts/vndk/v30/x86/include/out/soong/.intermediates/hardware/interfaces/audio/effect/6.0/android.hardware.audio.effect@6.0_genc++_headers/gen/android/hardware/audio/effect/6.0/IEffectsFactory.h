#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IEFFECTSFACTORY_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IEFFECTSFACTORY_H
...
struct IEffectsFactory : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@6.0::IEffectsFactory"
     */
    ...
    /**
     * Return callback for getAllDescriptors
     */
    using getAllDescriptors_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, const ::android::hardware::hidl_vec<::android::hardware::audio::effect::V6_0::EffectDescriptor>& result)>;
    /**
     ...
     */
    using getDescriptor_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, const ::android::hardware::audio::effect::V6_0::EffectDescriptor& result)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> getDescriptor(const ::android::hardware::audio::common::V6_0::Uuid& uid, getDescriptor_cb _hidl_cb) = 0;

    /**
     * Return callback for createEffect
     */
    using createEffect_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffect>& result, uint64_t effectId)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> createEffect(const ::android::hardware::audio::common::V6_0::Uuid& uid, int32_t session, int32_t ioHandle, int32_t device, createEffect_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IEffectsFactory>> castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectsFactory>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IEffectsFactory>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectsFactory>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectsFactory>& o) {
    ...
    os += ::android::hardware::audio::effect::V6_0::IEffectsFactory::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IEFFECTSFACTORY_H
