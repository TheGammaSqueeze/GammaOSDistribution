#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_ICAMERADEVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_ICAMERADEVICE_H
 ...
 *
 */
struct ICameraDevice : public ::android::hardware::camera::device::V3_2::ICameraDevice {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.camera.device@3.5::ICameraDevice"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_5::ICameraDevice>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_5::ICameraDevice>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_5::ICameraDevice>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDevice>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDevice>& o) {
    ...
    os += ::android::hardware::camera::device::V3_5::ICameraDevice::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_ICAMERADEVICE_H
