#ifndef HIDL_GENERATED_ANDROID_SYSTEM_NET_NETD_V1_0_BNHWNETD_H
#define HIDL_GENERATED_ANDROID_SYSTEM_NET_NETD_V1_0_BNHWNETD_H
...
struct BnHwNetd : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_createOemNetwork(
    ...
    static ::android::status_t _hidl_destroyOemNetwork(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_SYSTEM_NET_NETD_V1_0_BNHWNETD_H
