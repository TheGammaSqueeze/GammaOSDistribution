#ifndef HIDL_GENERATED_ANDROID_HARDWARE_THERMAL_V1_1_ITHERMAL_H
#define HIDL_GENERATED_ANDROID_HARDWARE_THERMAL_V1_1_ITHERMAL_H
...
struct IThermal : public ::android::hardware::thermal::V1_0::IThermal {
    ...
    /**
     * Fully qualified interface name: "android.hardware.thermal@1.1::IThermal"
     */
     ...
     */
    virtual ::android::hardware::Return<void> registerThermalCallback(const ::android::sp<::android::hardware::thermal::V1_1::IThermalCallback>& callback) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::thermal::V1_1::IThermal>> castFrom(const ::android::sp<::android::hardware::thermal::V1_1::IThermal>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::thermal::V1_1::IThermal>> castFrom(const ::android::sp<::android::hardware::thermal::V1_0::IThermal>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::thermal::V1_1::IThermal>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::thermal::V1_1::IThermal>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::thermal::V1_1::IThermal>& o) {
    ...
    os += ::android::hardware::thermal::V1_1::IThermal::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_THERMAL_V1_1_ITHERMAL_H
