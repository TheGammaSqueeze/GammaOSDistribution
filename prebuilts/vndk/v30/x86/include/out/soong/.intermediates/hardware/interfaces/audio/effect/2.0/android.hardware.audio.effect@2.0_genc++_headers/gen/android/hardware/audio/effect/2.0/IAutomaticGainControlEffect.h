#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_IAUTOMATICGAINCONTROLEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_IAUTOMATICGAINCONTROLEFFECT_H
...
struct IAutomaticGainControlEffect : public ::android::hardware::audio::effect::V2_0::IEffect {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@2.0::IAutomaticGainControlEffect"
     */
    ...
    static_assert(offsetof(::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties, targetLevelMb) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties, compGainMb) == 2, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties, limiterEnabled) == 4, "wrong offset");
    static_assert(sizeof(::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties) == 6, "wrong size");
    static_assert(__alignof(::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties) == 2, "wrong alignment");
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result> setTargetLevel(int16_t targetLevelMb) = 0;

    /**
     * Return callback for getTargetLevel
     */
    using getTargetLevel_cb = std::function<void(::android::hardware::audio::effect::V2_0::Result retval, int16_t targetLevelMb)>;
    /**
     * Gets target level.
     */
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result> setCompGain(int16_t compGainMb) = 0;

    /**
     * Return callback for getCompGain
     */
    using getCompGain_cb = std::function<void(::android::hardware::audio::effect::V2_0::Result retval, int16_t compGainMb)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result> setLimiterEnabled(bool enabled) = 0;

    /**
     * Return callback for isLimiterEnabled
     */
    using isLimiterEnabled_cb = std::function<void(::android::hardware::audio::effect::V2_0::Result retval, bool enabled)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result> setAllProperties(const ::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties& properties) = 0;

    /**
     * Return callback for getAllProperties
     */
    using getAllProperties_cb = std::function<void(::android::hardware::audio::effect::V2_0::Result retval, const ::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties& properties)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V2_0::IEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties& o);
static inline void PrintTo(const ::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties& lhs, const ::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties& rhs);
static inline bool operator!=(const ::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties& lhs, const ::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties& rhs);

static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect>& o);
...
static inline void PrintTo(const ::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::AllProperties& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect>& o) {
    ...
    os += ::android::hardware::audio::effect::V2_0::IAutomaticGainControlEffect::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_IAUTOMATICGAINCONTROLEFFECT_H
