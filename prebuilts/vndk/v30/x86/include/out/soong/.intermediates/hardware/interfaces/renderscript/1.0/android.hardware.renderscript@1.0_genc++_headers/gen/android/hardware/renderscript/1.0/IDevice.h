#ifndef HIDL_GENERATED_ANDROID_HARDWARE_RENDERSCRIPT_V1_0_IDEVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_RENDERSCRIPT_V1_0_IDEVICE_H
...
struct IDevice : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.renderscript@1.0::IDevice"
     */
     ...
     */
    virtual ::android::hardware::Return<::android::sp<::android::hardware::renderscript::V1_0::IContext>> contextCreate(uint32_t sdkVersion, ::android::hardware::renderscript::V1_0::ContextType ct, ::android::hardware::hidl_bitfield<::android::hardware::renderscript::V1_0::ContextFlags> flags) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::renderscript::V1_0::IDevice>> castFrom(const ::android::sp<::android::hardware::renderscript::V1_0::IDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::renderscript::V1_0::IDevice>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::renderscript::V1_0::IDevice>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::renderscript::V1_0::IDevice>& o) {
    ...
    os += ::android::hardware::renderscript::V1_0::IDevice::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_RENDERSCRIPT_V1_0_IDEVICE_H
