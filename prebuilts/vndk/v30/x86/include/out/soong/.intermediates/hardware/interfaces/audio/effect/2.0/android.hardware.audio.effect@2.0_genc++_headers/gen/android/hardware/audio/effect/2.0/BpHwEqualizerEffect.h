#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWEQUALIZEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWEQUALIZEREFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/2.0/IHwEqualizerEffect.h>
...
struct BpHwEqualizerEffect : public ::android::hardware::BpInterface<IEqualizerEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result>  _hidl_setBandLevel(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint16_t band, int16_t level);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result>  _hidl_setCurrentPreset(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint16_t preset);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result>  _hidl_setAllProperties(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::effect::V2_0::IEqualizerEffect::AllProperties& properties);
    ...
    ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result> setBandLevel(uint16_t band, int16_t level) override;
    ...
    ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result> setCurrentPreset(uint16_t preset) override;
    ::android::hardware::Return<void> getCurrentPreset(getCurrentPreset_cb _hidl_cb) override;
    ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result> setAllProperties(const ::android::hardware::audio::effect::V2_0::IEqualizerEffect::AllProperties& properties) override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWEQUALIZEREFFECT_H
