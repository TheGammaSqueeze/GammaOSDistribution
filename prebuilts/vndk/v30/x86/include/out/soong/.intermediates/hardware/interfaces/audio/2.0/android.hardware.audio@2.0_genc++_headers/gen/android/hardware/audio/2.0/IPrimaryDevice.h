...
struct IPrimaryDevice : public ::android::hardware::audio::V2_0::IDevice {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio@2.0::IPrimaryDevice"
     */
...
static inline void PrintTo(::android::hardware::audio::V2_0::IPrimaryDevice::TtyMode o, ::std::ostream* os);
...
template<> inline constexpr std::array<::android::hardware::audio::V2_0::IPrimaryDevice::TtyMode, 4> hidl_enum_values<::android::hardware::audio::V2_0::IPrimaryDevice::TtyMode> = {
