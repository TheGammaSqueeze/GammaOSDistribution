...
/**
 * Authenticator for multiuser accounts test.
 * Copied from cts/hostsidetests/accounts/test-apps/AccountManagerCrossUserApp/
 *                 src/com/android/cts/accountmanager/MockAuthenticator.java
 */
public class MockAuthenticator extends Service {
    ...
    static final String ACCOUNT_TYPE = "com.android.cts.multiuser";
