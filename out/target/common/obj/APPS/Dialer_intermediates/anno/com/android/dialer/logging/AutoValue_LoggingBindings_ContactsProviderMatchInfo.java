...
final class AutoValue_LoggingBindings_ContactsProviderMatchInfo extends LoggingBindings.ContactsProviderMatchInfo {
  ...
  public int hashCode() {
    int h$ = 1;
    h$ *= 1000003;
    h$ ^= matchedContact ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= inputNumberValid ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= inputNumberLength;
    h$ *= 1000003;
    h$ ^= matchedNumberLength;
    h$ *= 1000003;
    h$ ^= inputNumberHasPostdialDigits ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= matchedNumberHasPostdialDigits ? 1231 : 1237;
    return h$;
  }
