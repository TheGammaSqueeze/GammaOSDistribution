...
final class AutoValue_OutgoingCallComposerData extends OutgoingCallComposerData {
  ...
  public int hashCode() {
    ...
    h$ *= 1000003;
    h$ ^= (imageContentType == null) ? 0 : imageContentType.hashCode();
    return h$;
  }
  ...
  static final class Builder extends OutgoingCallComposerData.Builder {
    ...
    @Override
    public OutgoingCallComposerData.Builder setSubject(String subject) {
      this.subject = subject;
      return this;
    }
    @Override
    OutgoingCallComposerData.Builder setImageUri(Uri imageUri) {
      this.imageUri = imageUri;
      return this;
    }
    @Override
    OutgoingCallComposerData.Builder setImageContentType(String imageContentType) {
      this.imageContentType = imageContentType;
      return this;
    }
    @Override
