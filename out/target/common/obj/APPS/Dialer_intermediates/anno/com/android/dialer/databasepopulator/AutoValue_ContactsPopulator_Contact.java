...
final class AutoValue_ContactsPopulator_Contact extends ContactsPopulator.Contact {
  ...
  public int hashCode() {
    int h$ = 1;
    h$ *= 1000003;
    h$ ^= accountType.hashCode();
    h$ *= 1000003;
    h$ ^= accountName.hashCode();
    h$ *= 1000003;
    h$ ^= (name == null) ? 0 : name.hashCode();
    h$ *= 1000003;
    h$ ^= isStarred ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= pinned;
    h$ *= 1000003;
    h$ ^= (photoStream == null) ? 0 : photoStream.hashCode();
    h$ *= 1000003;
    h$ ^= phoneNumbers.hashCode();
    h$ *= 1000003;
    h$ ^= emails.hashCode();
    return h$;
  }
  ...
  static final class Builder extends ContactsPopulator.Contact.Builder {
    ...
    @Override
    ContactsPopulator.Contact.Builder setName(String name) {
      this.name = name;
      return this;
    }
    @Override
    ...
    @Override
    ContactsPopulator.Contact.Builder setPhotoStream(ByteArrayOutputStream photoStream) {
      this.photoStream = photoStream;
      return this;
    }
    @Override
