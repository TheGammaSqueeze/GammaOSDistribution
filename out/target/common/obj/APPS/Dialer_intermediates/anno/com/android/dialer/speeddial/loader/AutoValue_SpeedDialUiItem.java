...
final class AutoValue_SpeedDialUiItem extends SpeedDialUiItem {
  ...
  public int hashCode() {
    int h$ = 1;
    h$ *= 1000003;
    h$ ^= (speedDialEntryId == null) ? 0 : speedDialEntryId.hashCode();
    h$ *= 1000003;
    h$ ^= pinnedPosition.hashCode();
    h$ *= 1000003;
    h$ ^= name.hashCode();
    h$ *= 1000003;
    h$ ^= (int) ((contactId >>> 32) ^ contactId);
    h$ *= 1000003;
    h$ ^= lookupKey.hashCode();
    h$ *= 1000003;
    h$ ^= isStarred ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= (int) ((photoId >>> 32) ^ photoId);
    h$ *= 1000003;
    h$ ^= photoUri.hashCode();
    h$ *= 1000003;
    h$ ^= channels.hashCode();
    h$ *= 1000003;
    h$ ^= (defaultChannel == null) ? 0 : defaultChannel.hashCode();
    return h$;
  }
