...
final class AutoValue_PrimaryCallState extends PrimaryCallState {
  ...
  public int hashCode() {
    ...
    h$ ^= state;
    h$ *= 1000003;
    h$ ^= isVideoCall ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= sessionModificationState;
    h$ *= 1000003;
    h$ ^= disconnectCause.hashCode();
    h$ *= 1000003;
    h$ ^= (connectionLabel == null) ? 0 : connectionLabel.hashCode();
    h$ *= 1000003;
    h$ ^= primaryColor;
    h$ *= 1000003;
    h$ ^= (simSuggestionReason == null) ? 0 : simSuggestionReason.hashCode();
    h$ *= 1000003;
    h$ ^= (connectionIcon == null) ? 0 : connectionIcon.hashCode();
    h$ *= 1000003;
    h$ ^= (gatewayNumber == null) ? 0 : gatewayNumber.hashCode();
    h$ *= 1000003;
    h$ ^= (callSubject == null) ? 0 : callSubject.hashCode();
    h$ *= 1000003;
    h$ ^= (callbackNumber == null) ? 0 : callbackNumber.hashCode();
    h$ *= 1000003;
    h$ ^= isWifi ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isConference ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isWorkCall ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isHdAttempting ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isHdAudioCall ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isForwardedNumber ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= shouldShowContactPhoto ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= (int) ((connectTimeMillis >>> 32) ^ connectTimeMillis);
    h$ *= 1000003;
    h$ ^= isVoiceMailNumber ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isRemotelyHeld ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isBusinessNumber ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= supportsCallOnHold ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= swapToSecondaryButtonState;
    h$ *= 1000003;
    h$ ^= isAssistedDialed ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= (customLabel == null) ? 0 : customLabel.hashCode();
    h$ *= 1000003;
    h$ ^= (assistedDialingExtras == null) ? 0 : assistedDialingExtras.hashCode();
    return h$;
  }
  ...
  static final class Builder extends PrimaryCallState.Builder {
    ...
    @Override
    public PrimaryCallState.Builder setConnectionLabel(String connectionLabel) {
      this.connectionLabel = connectionLabel;
      return this;
    }
    @Override
    ...
    @Override
    public PrimaryCallState.Builder setSimSuggestionReason(SuggestionProvider.Reason simSuggestionReason) {
      this.simSuggestionReason = simSuggestionReason;
      return this;
    }
    @Override
    public PrimaryCallState.Builder setConnectionIcon(Drawable connectionIcon) {
      this.connectionIcon = connectionIcon;
      return this;
    }
    @Override
    public PrimaryCallState.Builder setGatewayNumber(String gatewayNumber) {
      this.gatewayNumber = gatewayNumber;
      return this;
    }
    @Override
    public PrimaryCallState.Builder setCallSubject(String callSubject) {
      this.callSubject = callSubject;
      return this;
    }
    @Override
    public PrimaryCallState.Builder setCallbackNumber(String callbackNumber) {
      this.callbackNumber = callbackNumber;
      return this;
    }
    @Override
    ...
    @Override
    public PrimaryCallState.Builder setCustomLabel(String customLabel) {
      this.customLabel = customLabel;
      return this;
    }
    @Override
    public PrimaryCallState.Builder setAssistedDialingExtras(TransformationInfo assistedDialingExtras) {
      this.assistedDialingExtras = assistedDialingExtras;
      return this;
    }
    @Override
