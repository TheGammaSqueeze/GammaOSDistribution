...
final class AutoValue_SecondaryInfo extends SecondaryInfo {
  ...
  public int hashCode() {
    ...
    h$ *= 1000003;
    h$ ^= (providerLabel == null) ? 0 : providerLabel.hashCode();
    h$ *= 1000003;
    h$ ^= isConference ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isVideoCall ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isFullscreen ? 1231 : 1237;
    return h$;
  }
  ...
  static final class Builder extends SecondaryInfo.Builder {
    ...
    @Override
    public SecondaryInfo.Builder setName(String name) {
      this.name = name;
      return this;
    }
    @Override
    ...
    @Override
    public SecondaryInfo.Builder setLabel(String label) {
      this.label = label;
      return this;
    }
    @Override
    public SecondaryInfo.Builder setProviderLabel(String providerLabel) {
      this.providerLabel = providerLabel;
      return this;
    }
    @Override
