...
final class AutoValue_CallIntent extends CallIntent {
  ...
  public int hashCode() {
    ...
    h$ ^= number.hashCode();
    h$ *= 1000003;
    h$ ^= callSpecificAppData.hashCode();
    h$ *= 1000003;
    h$ ^= (phoneAccountHandle == null) ? 0 : phoneAccountHandle.hashCode();
    h$ *= 1000003;
    h$ ^= isVideoCall ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= (callSubject == null) ? 0 : callSubject.hashCode();
    h$ *= 1000003;
    h$ ^= allowAssistedDial ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= stringInCallUiIntentExtras.hashCode();
    h$ *= 1000003;
    h$ ^= longInCallUiIntentExtras.hashCode();
    h$ *= 1000003;
    h$ ^= stringPlaceCallExtras.hashCode();
    h$ *= 1000003;
    h$ ^= longPlaceCallExtras.hashCode();
    return h$;
  }
  ...
  static final class Builder extends CallIntent.Builder {
    ...
    @Override
    public CallIntent.Builder setCallSubject(String callSubject) {
      this.callSubject = callSubject;
      return this;
    }
    @Override
