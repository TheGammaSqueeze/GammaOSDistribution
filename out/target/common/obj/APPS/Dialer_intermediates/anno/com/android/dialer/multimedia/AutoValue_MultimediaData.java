...
final class AutoValue_MultimediaData extends MultimediaData {
  ...
  static final class Builder extends MultimediaData.Builder {
    ...
    @Override
    public MultimediaData.Builder setText(String text) {
      this.text = text;
      return this;
    }
    @Override
    ...
    @Override
    MultimediaData.Builder setImageUri(Uri imageUri) {
      this.imageUri = imageUri;
      return this;
    }
    @Override
    MultimediaData.Builder setImageContentType(String imageContentType) {
      this.imageContentType = imageContentType;
      return this;
    }
    @Override
