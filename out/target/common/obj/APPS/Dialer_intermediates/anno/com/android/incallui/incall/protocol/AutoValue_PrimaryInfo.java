...
final class AutoValue_PrimaryInfo extends PrimaryInfo {
  ...
  public int hashCode() {
    ...
    h$ *= 1000003;
    h$ ^= (photoUri == null) ? 0 : photoUri.hashCode();
    h$ *= 1000003;
    h$ ^= photoType;
    h$ *= 1000003;
    h$ ^= isSipCall ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isContactPhotoShown ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isWorkCall ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isSpam ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= isLocalContact ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= answeringDisconnectsOngoingCall ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= shouldShowLocation ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= (contactInfoLookupKey == null) ? 0 : contactInfoLookupKey.hashCode();
    h$ *= 1000003;
    h$ ^= (multimediaData == null) ? 0 : multimediaData.hashCode();
    h$ *= 1000003;
    h$ ^= showInCallButtonGrid ? 1231 : 1237;
    h$ *= 1000003;
    h$ ^= numberPresentation;
    return h$;
  }
  ...
  static final class Builder extends PrimaryInfo.Builder {
    ...
    @Override
    public PrimaryInfo.Builder setNumber(String number) {
      this.number = number;
      return this;
    }
    @Override
    public PrimaryInfo.Builder setName(String name) {
      this.name = name;
      return this;
    }
    @Override
    ...
    @Override
    public PrimaryInfo.Builder setLabel(String label) {
      this.label = label;
      return this;
    }
    @Override
    public PrimaryInfo.Builder setLocation(String location) {
      this.location = location;
      return this;
    }
    @Override
    public PrimaryInfo.Builder setPhoto(Drawable photo) {
      this.photo = photo;
      return this;
    }
    @Override
    public PrimaryInfo.Builder setPhotoUri(Uri photoUri) {
      this.photoUri = photoUri;
      return this;
    }
    @Override
    ...
    @Override
    public PrimaryInfo.Builder setContactInfoLookupKey(String contactInfoLookupKey) {
      this.contactInfoLookupKey = contactInfoLookupKey;
      return this;
    }
    @Override
