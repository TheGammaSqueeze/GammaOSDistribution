...
final class AutoValue_TransformationInfo extends TransformationInfo {
  ...
  public int hashCode() {
    int h$ = 1;
    h$ *= 1000003;
    h$ ^= originalNumber.hashCode();
    h$ *= 1000003;
    h$ ^= transformedNumber.hashCode();
    h$ *= 1000003;
    h$ ^= userHomeCountryCode.hashCode();
    h$ *= 1000003;
    h$ ^= userRoamingCountryCode.hashCode();
    h$ *= 1000003;
    h$ ^= transformedNumberCountryCallingCode;
    return h$;
  }
