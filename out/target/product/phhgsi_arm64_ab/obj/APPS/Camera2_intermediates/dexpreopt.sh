...
mkdir -p out/target/product/phhgsi_arm64_ab/obj/APPS/Camera2_intermediates/oat/arm64

rm -f out/target/product/phhgsi_arm64_ab/obj/APPS/Camera2_intermediates/oat/arm64/package.odex

target_sdk_version="$( out/soong/host/linux-x86/bin/manifest_check --extract-target-sdk-version out/target/common/obj/APPS/Camera2_intermediates/manifest/AndroidManifest.xml --aapt out/soong/host/linux-x86/bin/aapt )"
...
: \
    ...
    out/target/common/obj/APPS/Camera2_intermediates/enforce_uses_libraries.status \
    out/target/common/obj/APPS/Camera2_intermediates/manifest/AndroidManifest.xml \
