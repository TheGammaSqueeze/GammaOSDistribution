...
mkdir -p out/target/product/phhgsi_arm64_ab/obj/APPS/GmsCore_intermediates/oat/arm64

rm -f out/target/product/phhgsi_arm64_ab/obj/APPS/GmsCore_intermediates/oat/arm64/package.odex
...
: \
    ...
    out/target/common/obj/APPS/GmsCore_intermediates/enforce_uses_libraries.status \
    ...
    out/target/common/obj/JAVA_LIBRARIES/androidx.window.extensions_intermediates/javalib.jar \
    out/target/common/obj/JAVA_LIBRARIES/androidx.window.sidecar_intermediates/javalib.jar \
    out/target/common/obj/JAVA_LIBRARIES/com.android.location.provider_intermediates/javalib.jar \
    out/target/common/obj/JAVA_LIBRARIES/com.android.media.remotedisplay_intermediates/javalib.jar \
