...
mkdir -p out/target/product/phhgsi_arm64_ab/obj/APPS/GoogleRestore_intermediates/oat/arm64

rm -f out/target/product/phhgsi_arm64_ab/obj/APPS/GoogleRestore_intermediates/oat/arm64/package.odex
...
: \
    ...
    out/target/common/obj/APPS/GoogleRestore_intermediates/enforce_uses_libraries.status \
