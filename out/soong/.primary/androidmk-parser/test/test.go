...
var t = []testing.InternalTest{
	...
	{"TestMakeStringSplitN", pkg.TestMakeStringSplitN},

	{"TestMakeStringValue", pkg.TestMakeStringValue},

	{"TestMakeStringWords", pkg.TestMakeStringWords},

	{"TestParse", pkg.TestParse},
...
func (matchString) ImportPath() string {
	return "android/soong/androidmk/parser"
}
