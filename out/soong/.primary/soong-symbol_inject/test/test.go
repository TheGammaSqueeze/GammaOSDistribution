...
import (
	...
	pkg "android/soong/symbol_inject"
)

var t = []testing.InternalTest{

	{"TestCopyAndInject", pkg.TestCopyAndInject},

	{"TestElfSymbolTable", pkg.TestElfSymbolTable},

	{"TestMachoSymbolTable", pkg.TestMachoSymbolTable},

	{"TestPESymbolTable", pkg.TestPESymbolTable},
...
func (matchString) ImportPath() string {
	return "android/soong/symbol_inject"
}
