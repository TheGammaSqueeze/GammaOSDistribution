...
import (
	...
	pkg "android/soong/remoteexec"
)

var t = []testing.InternalTest{

	{"TestNoVarTemplate", pkg.TestNoVarTemplate},

	{"TestTemplate", pkg.TestTemplate},

	{"TestTemplateDeterminism", pkg.TestTemplateDeterminism},
...
func (matchString) ImportPath() string {
	return "android/soong/remoteexec"
}
