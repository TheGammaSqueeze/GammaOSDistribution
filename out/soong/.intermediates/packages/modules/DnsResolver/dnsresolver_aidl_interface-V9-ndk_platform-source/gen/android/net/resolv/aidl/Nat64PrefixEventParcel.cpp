...
namespace resolv {
namespace aidl {
const char* Nat64PrefixEventParcel::descriptor = "android.net.resolv.aidl.Nat64PrefixEventParcel";

binder_status_t Nat64PrefixEventParcel::readFromParcel(const AParcel* parcel) {
  ...
  _aidl_ret_status = AParcel_readInt32(parcel, &prefixOperation);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = ::ndk::AParcel_readString(parcel, &prefixAddress);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = AParcel_readInt32(parcel, &prefixLength);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t Nat64PrefixEventParcel::writeToParcel(AParcel* parcel) const {
  ...
  _aidl_ret_status = AParcel_writeInt32(parcel, prefixOperation);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeString(parcel, prefixAddress);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = AParcel_writeInt32(parcel, prefixLength);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
