...
namespace resolv {
namespace aidl {
class BnDnsResolverUnsolicitedEventListener : public ::ndk::BnCInterface<IDnsResolverUnsolicitedEventListener> {
public:
  BnDnsResolverUnsolicitedEventListener();
  virtual ~BnDnsResolverUnsolicitedEventListener();
