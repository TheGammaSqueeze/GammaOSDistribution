...
using namespace android::sysprop::GkiProperties;
...
std::optional<bool> prevent_downgrade_version() {
    return GetProp<std::optional<bool>>("ro.build.ab_update.gki.prevent_downgrade_version");
}

std::optional<bool> prevent_downgrade_spl() {
    return GetProp<std::optional<bool>>("ro.build.ab_update.gki.prevent_downgrade_spl");
}
