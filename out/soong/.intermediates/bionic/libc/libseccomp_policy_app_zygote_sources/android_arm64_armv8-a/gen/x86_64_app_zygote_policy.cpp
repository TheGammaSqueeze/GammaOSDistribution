...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 57, 87, 86), //sendto|recvfrom|sendmsg|recvmsg|shutdown|bind|listen|getsockname|getpeername|socketpair|setsockopt|getsockopt|clone
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 72, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 64, 85, 84), //vfork|execve|exit|wait4|kill|uname
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 82, 84, 83), //fcntl|flock|fsync|fdatasync|truncate|ftruncate|getdents|getcwd|chdir|fchdir
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 103, 74, 73), //umask|gettimeofday|getrlimit|getrusage|sysinfo|times|ptrace|getuid
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 122, 66, 65), //setresuid|getresuid|setresgid|getresgid|getpgid
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 132, 65, 64), //getsid|capget|capset|rt_sigpending|rt_sigtimedwait|rt_sigqueueinfo|rt_sigsuspend|sigaltstack
...
const size_t x86_64_app_zygote_filter_size = sizeof(x86_64_app_zygote_filter) / sizeof(struct sock_filter);
