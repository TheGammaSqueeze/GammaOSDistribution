...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 186, 49, 0),
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 273, 25, 24), //newfstatat|unlinkat|renameat|linkat|symlinkat|readlinkat|fchmodat|faccessat|pselect6|ppoll|unshare
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 279, 24, 23), //splice|tee|sync_file_range|vmsplice
