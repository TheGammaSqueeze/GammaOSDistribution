...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 0, 0, 138),
BPF_JUMP(BPF_JMP|BPF_JEQ|BPF_K, 240, 136, 0), //futex
BPF_JUMP(BPF_JMP|BPF_JEQ|BPF_K, 54, 135, 0), //ioctl
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 106, 87, 86), //setitimer|getitimer
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 374, 17, 0),
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 311, 28, 27), //fstatat64|unlinkat|renameat|linkat|symlinkat|readlinkat|fchmodat|faccessat|pselect6|ppoll|unshare
