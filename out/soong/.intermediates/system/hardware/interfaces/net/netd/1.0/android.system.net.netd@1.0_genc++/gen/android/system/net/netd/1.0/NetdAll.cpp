#define LOG_TAG "android.system.net.netd@1.0::Netd"
...
#include <android/system/net/netd/1.0/BnHwNetd.h>
#include <android/system/net/netd/1.0/BsNetd.h>
...
const char* INetd::descriptor("android.system.net.netd@1.0::INetd");
...
::android::hardware::Return<void> INetd::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::system::net::netd::V1_0::INetd::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::system::net::netd::V1_0::INetd>> INetd::castFrom(const ::android::sp<::android::system::net::netd::V1_0::INetd>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::system::net::netd::V1_0::INetd>> INetd::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<INetd, ::android::hidl::base::V1_0::IBase, BpHwNetd>(
            parent, "android.system.net.netd@1.0::INetd", emitError);
}

BpHwNetd::BpHwNetd(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<INetd>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.system.net.netd@1.0", "INetd") {
}
...
// Methods from ::android::system::net::netd::V1_0::INetd follow.
::android::hardware::Return<void> BpHwNetd::_hidl_createOemNetwork(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, createOemNetwork_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::INetd::createOemNetwork::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.system.net.netd", "1.0", "INetd", "createOemNetwork", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* createOemNetwork */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        uint64_t _hidl_out_networkHandle;
        uint32_t _hidl_out_packetMark;
        ...
        _hidl_err = _hidl_reply.readUint64(&_hidl_out_networkHandle);
        if (_hidl_err != ::android::OK) { return; }

        _hidl_err = _hidl_reply.readUint32(&_hidl_out_packetMark);
        if (_hidl_err != ::android::OK) { return; }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.system.net.netd", "1.0", "INetd", "createOemNetwork", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::system::net::netd::V1_0::INetd::StatusCode> BpHwNetd::_hidl_destroyOemNetwork(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t networkHandle) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::INetd::destroyOemNetwork::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&networkHandle);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.system.net.netd", "1.0", "INetd", "destroyOemNetwork", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* destroyOemNetwork */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.system.net.netd", "1.0", "INetd", "destroyOemNetwork", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwNetd::BnHwNetd(const ::android::sp<INetd> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.system.net.netd@1.0", "INetd") { 
...
// Methods from ::android::system::net::netd::V1_0::INetd follow.
::android::status_t BnHwNetd::_hidl_createOemNetwork(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::INetd::createOemNetwork::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.system.net.netd", "1.0", "INetd", "createOemNetwork", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<INetd*>(_hidl_this->getImpl().get())->createOemNetwork([&](const auto &_hidl_out_networkHandle, const auto &_hidl_out_packetMark, const auto &_hidl_out_status) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("createOemNetwork: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;

        ::android::hardware::writeToParcel(::android::hardware::Status::ok(), _hidl_reply);

        _hidl_err = _hidl_reply->writeUint64(_hidl_out_networkHandle);
        if (_hidl_err != ::android::OK) { goto _hidl_error; }

        _hidl_err = _hidl_reply->writeUint32(_hidl_out_packetMark);
        if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_status);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.system.net.netd", "1.0", "INetd", "createOemNetwork", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("createOemNetwork: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwNetd::_hidl_destroyOemNetwork(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::INetd::destroyOemNetwork::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&networkHandle);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.system.net.netd", "1.0", "INetd", "destroyOemNetwork", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::system::net::netd::V1_0::INetd::StatusCode _hidl_out_status = static_cast<INetd*>(_hidl_this->getImpl().get())->destroyOemNetwork(networkHandle);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.system.net.netd", "1.0", "INetd", "destroyOemNetwork", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsNetd::BsNetd(const ::android::sp<::android::system::net::netd::V1_0::INetd> impl) : ::android::hardware::details::HidlInstrumentor("android.system.net.netd@1.0", "INetd"), mImpl(impl) {
...
bool INetd::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.system.net.netd@1.0::INetd",
