...
using namespace android::sysprop::SuspendProperties;
...
std::optional<std::uint32_t> max_sleep_time_millis() {
    return GetProp<std::optional<std::uint32_t>>("suspend.max_sleep_time_millis");
}

std::optional<std::uint32_t> base_sleep_time_millis() {
    return GetProp<std::optional<std::uint32_t>>("suspend.base_sleep_time_millis");
}

std::optional<std::uint32_t> backoff_threshold_count() {
    return GetProp<std::optional<std::uint32_t>>("suspend.backoff_threshold_count");
}

std::optional<std::uint32_t> short_suspend_threshold_millis() {
    return GetProp<std::optional<std::uint32_t>>("suspend.short_suspend_threshold_millis");
}

std::optional<double> sleep_time_scale_factor() {
    return GetProp<std::optional<double>>("suspend.sleep_time_scale_factor");
}

std::optional<bool> failed_suspend_backoff_enabled() {
    return GetProp<std::optional<bool>>("suspend.failed_suspend_backoff_enabled");
}

std::optional<bool> short_suspend_backoff_enabled() {
    return GetProp<std::optional<bool>>("suspend.short_suspend_backoff_enabled");
}
