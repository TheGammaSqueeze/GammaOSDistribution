...
public class KeyEntryResponse implements android.os.Parcelable
{
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    _aidl_parcel.writeStrongBinder((((iSecurityLevel!=null))?(iSecurityLevel.asBinder()):(null)));
    if ((metadata!=null)) {
      _aidl_parcel.writeInt(1);
      metadata.writeToParcel(_aidl_parcel, 0);
    }
    else {
      _aidl_parcel.writeInt(0);
    }
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if ((0!=_aidl_parcel.readInt())) {
        metadata = android.system.keystore2.KeyMetadata.CREATOR.createFromParcel(_aidl_parcel);
      }
      else {
        metadata = null;
      }
