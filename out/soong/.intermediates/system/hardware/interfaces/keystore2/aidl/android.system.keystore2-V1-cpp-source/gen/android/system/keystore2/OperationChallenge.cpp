...
::android::status_t OperationChallenge::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t OperationChallenge::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
