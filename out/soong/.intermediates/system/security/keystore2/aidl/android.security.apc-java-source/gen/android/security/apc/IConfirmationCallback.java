...
public interface IConfirmationCallback extends android.os.IInterface
{
  ...
  public static abstract class Stub extends android.os.Binder implements android.security.apc.IConfirmationCallback
  {
        ...
        try {
          ...
          if (!_status) {
            if (getDefaultImpl() != null) {
              getDefaultImpl().onCompleted(result, dataConfirmed);
              return;
            }
          }
        }
    ...
    public static boolean setDefaultImpl(android.security.apc.IConfirmationCallback impl) {
    ...
    public static android.security.apc.IConfirmationCallback getDefaultImpl() {
