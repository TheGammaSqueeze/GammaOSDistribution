...
using namespace android::sysprop::ApexProperties;
...
std::optional<bool> updatable() {
    return GetProp<std::optional<bool>>("ro.apex.updatable");
}

std::optional<std::uint32_t> dm_delete_timeout() {
    return GetProp<std::optional<std::uint32_t>>("apexd.config.dm_delete.timeout");
}

std::optional<std::uint32_t> dm_create_timeout() {
    return GetProp<std::optional<std::uint32_t>>("apexd.config.dm_create.timeout");
}
