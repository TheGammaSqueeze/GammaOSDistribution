...
#include <android/sysprop/DisplayProperties.sysprop.h>
...
using namespace android::sysprop::DisplayProperties;
...
std::optional<bool> debug_force_msaa() {
    return GetProp<std::optional<bool>>("debug.egl.force_msaa");
}

bool debug_force_msaa(const std::optional<bool>& value) {
    return SetProp("debug.egl.force_msaa", FormatValue(value).c_str());
}

std::optional<std::string> debug_opengl_trace() {
    return GetProp<std::optional<std::string>>("debug.egl.trace");
}

bool debug_opengl_trace(const std::optional<std::string>& value) {
    return SetProp("debug.egl.trace", value ? value->c_str() : "");
}

std::optional<bool> debug_force_rtl() {
    return GetProp<std::optional<bool>>("debug.force_rtl");
}

bool debug_force_rtl(const std::optional<bool>& value) {
    return SetProp("debug.force_rtl", FormatValue(value).c_str());
}

std::optional<bool> debug_layout() {
    return GetProp<std::optional<bool>>("debug.layout");
}

bool debug_layout(const std::optional<bool>& value) {
    return SetProp("debug.layout", FormatValue(value).c_str());
}

std::optional<bool> debug_allow_non_native_refresh_rate_override() {
    return GetProp<std::optional<bool>>("debug.display.allow_non_native_refresh_rate_override");
}
