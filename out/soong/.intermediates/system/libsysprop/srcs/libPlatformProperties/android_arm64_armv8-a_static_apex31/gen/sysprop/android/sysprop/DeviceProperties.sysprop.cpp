...
#include <android/sysprop/DeviceProperties.sysprop.h>
...
using namespace android::sysprop::DeviceProperties;
...
std::optional<std::int32_t> media_performance_class() {
    return GetProp<std::optional<std::int32_t>>("ro.odm.build.media_performance_class");
}
