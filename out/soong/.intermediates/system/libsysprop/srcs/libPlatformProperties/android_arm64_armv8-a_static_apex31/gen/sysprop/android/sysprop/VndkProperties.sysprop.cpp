...
using namespace android::sysprop::VndkProperties;
...
std::optional<std::string> vendor_vndk_version() {
    return GetProp<std::optional<std::string>>("ro.vndk.version");
}

std::optional<std::string> product_vndk_version() {
    return GetProp<std::optional<std::string>>("ro.product.vndk.version");
}
