...
#include <android/sysprop/SocProperties.sysprop.h>
...
using namespace android::sysprop::SocProperties;
...
std::optional<std::string> soc_manufacturer() {
    return GetProp<std::optional<std::string>>("ro.soc.manufacturer");
}

std::optional<std::string> soc_model() {
    return GetProp<std::optional<std::string>>("ro.soc.model");
}
