...
#include <android/sysprop/WifiProperties.sysprop.h>
...
using namespace android::sysprop::WifiProperties;
...
std::optional<bool> start_supplicant() {
    return GetProp<std::optional<bool>>("ctl.start$supplicant");
}

bool start_supplicant(const std::optional<bool>& value) {
    return SetProp("ctl.start$supplicant", FormatValue(value).c_str());
}

std::optional<bool> stop_supplicant() {
    return GetProp<std::optional<bool>>("ctl.stop$supplicant");
}

bool stop_supplicant(const std::optional<bool>& value) {
    return SetProp("ctl.stop$supplicant", FormatValue(value).c_str());
}
