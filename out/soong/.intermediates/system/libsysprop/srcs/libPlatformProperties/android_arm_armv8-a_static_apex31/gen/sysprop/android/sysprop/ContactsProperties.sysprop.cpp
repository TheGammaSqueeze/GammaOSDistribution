...
#include <android/sysprop/ContactsProperties.sysprop.h>
...
using namespace android::sysprop::ContactsProperties;
...
std::optional<bool> aggregate_contacts() {
    return GetProp<std::optional<bool>>("sync.contacts.aggregate");
}

std::optional<bool> debug_scan_all_packages() {
    return GetProp<std::optional<bool>>("debug.cp2.scan_all_packages");
}

std::optional<std::int32_t> display_photo_size() {
    return GetProp<std::optional<std::int32_t>>("contacts.display_photo_size");
}

std::optional<bool> keep_stale_account_data() {
    return GetProp<std::optional<bool>>("debug.contacts.ksad");
}

std::optional<std::int32_t> thumbnail_size() {
    return GetProp<std::optional<std::int32_t>>("contacts.thumbnail_size");
}
