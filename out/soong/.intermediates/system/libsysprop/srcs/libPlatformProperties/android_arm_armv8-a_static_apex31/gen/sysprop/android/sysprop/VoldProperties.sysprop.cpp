...
#include <android/sysprop/VoldProperties.sysprop.h>
...
using namespace android::sysprop::VoldProperties;
...
std::optional<std::string> decrypt() {
    return GetProp<std::optional<std::string>>("vold.decrypt");
}

bool decrypt(const std::optional<std::string>& value) {
    return SetProp("vold.decrypt", value ? value->c_str() : "");
}

std::optional<std::string> encrypt_progress() {
    return GetProp<std::optional<std::string>>("vold.encrypt_progress");
}

bool encrypt_progress(const std::optional<std::string>& value) {
    return SetProp("vold.encrypt_progress", value ? value->c_str() : "");
}

std::optional<std::int32_t> encrypt_time_remaining() {
    return GetProp<std::optional<std::int32_t>>("vold.encrypt_time_remaining");
}

bool encrypt_time_remaining(const std::optional<std::int32_t>& value) {
    return SetProp("vold.encrypt_time_remaining", FormatValue(value).c_str());
}
