...
using namespace android::sysprop::MediaProperties;
...
std::optional<std::int32_t> swcodec_ion_heapmask() {
    return GetProp<std::optional<std::int32_t>>("ro.com.android.media.swcodec.ion.heapmask");
}

std::optional<std::int32_t> swcodec_ion_align() {
    return GetProp<std::optional<std::int32_t>>("ro.com.android.media.swcodec.ion.align");
}

std::optional<std::int32_t> swcodec_ion_flags() {
    return GetProp<std::optional<std::int32_t>>("ro.com.android.media.swcodec.ion.flags");
}

std::optional<std::int32_t> codec2_dmabuf_padding() {
    return GetProp<std::optional<std::int32_t>>("media.c2.dmabuf.padding");
}
