...
#include <android/sysprop/AdbProperties.sysprop.h>
...
using namespace android::sysprop::AdbProperties;
...
std::optional<bool> secure() {
    return GetProp<std::optional<bool>>("ro.adb.secure");
}

bool secure(const std::optional<bool>& value) {
    return SetProp("ro.adb.secure", FormatValue(value).c_str());
}
