...
using namespace android::sysprop::OtaProperties;
...
std::optional<bool> warm_reset() {
    return GetProp<std::optional<bool>>("ota.warm_reset");
}

bool warm_reset(const std::optional<bool>& value) {
    return SetProp("ota.warm_reset", FormatValue(std::optional<int>(value)).c_str());
}

std::optional<std::string> ab_ota_partitions() {
    return GetProp<std::optional<std::string>>("ro.product.ab_ota_partitions");
}

std::optional<bool> virtual_ab_enabled() {
    return GetProp<std::optional<bool>>("ro.virtual_ab.enabled");
}

std::optional<bool> virtual_ab_retrofit() {
    return GetProp<std::optional<bool>>("ro.virtual_ab.retrofit");
}

std::optional<std::string> other_vbmeta_digest() {
    return GetProp<std::optional<std::string>>("ota.other.vbmeta_digest");
}

bool other_vbmeta_digest(const std::optional<std::string>& value) {
    return SetProp("ota.other.vbmeta_digest", value ? value->c_str() : "");
}
