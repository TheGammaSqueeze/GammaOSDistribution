...
#include <android/sysprop/TraceProperties.sysprop.h>
...
using namespace android::sysprop::TraceProperties;
...
std::optional<bool> user_initiated() {
    return GetProp<std::optional<bool>>("debug.atrace.user_initiated");
}

bool user_initiated(const std::optional<bool>& value) {
    return SetProp("debug.atrace.user_initiated", FormatValue(std::optional<int>(value)).c_str());
}
