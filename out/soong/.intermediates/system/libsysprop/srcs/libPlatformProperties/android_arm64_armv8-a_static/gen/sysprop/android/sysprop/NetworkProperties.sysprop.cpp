...
#include <android/sysprop/NetworkProperties.sysprop.h>
...
using namespace android::sysprop::NetworkProperties;
...
std::optional<std::int32_t> tcp_init_rwnd() {
    return GetProp<std::optional<std::int32_t>>("net.tcp_def_init_rwnd");
}

bool tcp_init_rwnd(const std::optional<std::int32_t>& value) {
    return SetProp("net.tcp_def_init_rwnd", FormatValue(value).c_str());
}

std::optional<bool> isCellular464XlatEnabled() {
    return GetProp<std::optional<bool>>("net.464xlat.cellular.enabled");
}
