...
#include <android/sysprop/SetupWizardProperties.sysprop.h>
...
using namespace android::sysprop::SetupWizardProperties;
...
std::optional<std::string> theme() {
    return GetProp<std::optional<std::string>>("setupwizard.theme");
}

bool theme(const std::optional<std::string>& value) {
    return SetProp("setupwizard.theme", value ? value->c_str() : "");
}

std::vector<std::optional<std::string>> esim_cid_ignore() {
    return GetProp<std::vector<std::optional<std::string>>>("ro.setupwizard.esim_cid_ignore");
}
