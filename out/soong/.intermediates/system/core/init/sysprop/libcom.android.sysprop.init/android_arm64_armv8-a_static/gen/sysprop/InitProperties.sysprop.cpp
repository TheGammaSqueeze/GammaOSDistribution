...
using namespace android::sysprop::InitProperties;
...
std::optional<bool> userspace_reboot_in_progress() {
    return GetProp<std::optional<bool>>("sys.init.userspace_reboot.in_progress");
}

bool userspace_reboot_in_progress(const std::optional<bool>& value) {
    return SetProp("sys.init.userspace_reboot.in_progress", FormatValue(std::optional<int>(value)).c_str());
}

std::optional<bool> is_userspace_reboot_supported() {
    return GetProp<std::optional<bool>>("init.userspace_reboot.is_supported");
}
