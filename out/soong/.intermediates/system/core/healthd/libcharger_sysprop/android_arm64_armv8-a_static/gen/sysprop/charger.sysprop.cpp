...
using namespace android::sysprop::ChargerProperties;
...
std::optional<bool> draw_split_screen() {
    return GetProp<std::optional<bool>>("ro.charger.draw_split_screen");
}

std::optional<std::int64_t> draw_split_offset() {
    return GetProp<std::optional<std::int64_t>>("ro.charger.draw_split_offset");
}

std::optional<bool> disable_init_blank() {
    return GetProp<std::optional<bool>>("ro.charger.disable_init_blank");
}

std::optional<bool> enable_suspend() {
    return GetProp<std::optional<bool>>("ro.charger.enable_suspend");
}

std::optional<bool> no_ui() {
    return GetProp<std::optional<bool>>("ro.charger.no_ui");
}
