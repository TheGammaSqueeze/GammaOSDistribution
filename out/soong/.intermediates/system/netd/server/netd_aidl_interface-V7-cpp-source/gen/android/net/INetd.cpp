...
::android::binder::Status BpNetd::networkAddUidRangesParcel(const ::android::net::netd::aidl::NativeUidRangeConfig& uidRangesConfig) {
  ::android::Parcel _aidl_data;
  _aidl_data.markForBinder(remoteStrong());
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  BpNetd::TransactionLog _transaction_log;
  if (BpNetd::logFunc != nullptr) {
    _transaction_log.input_args.emplace_back("uidRangesConfig", ::android::internal::ToString(uidRangesConfig));
  }
  auto _log_start = std::chrono::steady_clock::now();
  _aidl_ret_status = _aidl_data.writeInterfaceToken(getInterfaceDescriptor());
  if (((_aidl_ret_status) != (::android::OK))) {
  ...
  _aidl_ret_status = _aidl_data.writeParcelable(uidRangesConfig);
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  _aidl_ret_status = remote()->transact(BnNetd::TRANSACTION_networkAddUidRangesParcel, _aidl_data, &_aidl_reply, 0);
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && INetd::getDefaultImpl())) {
     return INetd::getDefaultImpl()->networkAddUidRangesParcel(uidRangesConfig);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  ...
  if (BpNetd::logFunc != nullptr) {
    ...
    _transaction_log.duration_ms = std::chrono::duration<double, std::milli>(_log_end - _log_start).count();
    _transaction_log.interface_name = "android.net.INetd";
    _transaction_log.method_name = "networkAddUidRangesParcel";
    _transaction_log.stub_address = nullptr;
    _transaction_log.proxy_address = static_cast<const void*>(this);
    _transaction_log.exception_code = _aidl_status.exceptionCode();
    _transaction_log.exception_message = _aidl_status.exceptionMessage();
...
::android::binder::Status BpNetd::networkRemoveUidRangesParcel(const ::android::net::netd::aidl::NativeUidRangeConfig& uidRangesConfig) {
  ::android::Parcel _aidl_data;
  _aidl_data.markForBinder(remoteStrong());
  ::android::Parcel _aidl_reply;
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = remote()->transact(BnNetd::TRANSACTION_networkRemoveUidRangesParcel, _aidl_data, &_aidl_reply, 0);
  if (UNLIKELY(_aidl_ret_status == ::android::UNKNOWN_TRANSACTION && INetd::getDefaultImpl())) {
     return INetd::getDefaultImpl()->networkRemoveUidRangesParcel(uidRangesConfig);
  }
  if (((_aidl_ret_status) != (::android::OK))) {
    goto _aidl_error;
  }
  ...
  if (BpNetd::logFunc != nullptr) {
    ...
    _transaction_log.duration_ms = std::chrono::duration<double, std::milli>(_log_end - _log_start).count();
    _transaction_log.interface_name = "android.net.INetd";
    _transaction_log.method_name = "networkRemoveUidRangesParcel";
    _transaction_log.stub_address = nullptr;
    _transaction_log.proxy_address = static_cast<const void*>(this);
    _transaction_log.exception_code = _aidl_status.exceptionCode();
    _transaction_log.exception_message = _aidl_status.exceptionMessage();
...
::android::status_t BnNetd::onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) {
  ...
  break;
  case BnNetd::TRANSACTION_networkAddUidRangesParcel:
  {
    ::android::net::netd::aidl::NativeUidRangeConfig in_uidRangesConfig;
    if (!(_aidl_data.checkInterface(this))) {
      _aidl_ret_status = ::android::BAD_TYPE;
      break;
    }
    _aidl_ret_status = _aidl_data.readParcelable(&in_uidRangesConfig);
    if (((_aidl_ret_status) != (::android::OK))) {
      break;
    }
    BnNetd::TransactionLog _transaction_log;
    if (BnNetd::logFunc != nullptr) {
      _transaction_log.input_args.emplace_back("in_uidRangesConfig", ::android::internal::ToString(in_uidRangesConfig));
    }
    auto _log_start = std::chrono::steady_clock::now();
    ::android::binder::Status _aidl_status(networkAddUidRangesParcel(in_uidRangesConfig));
    if (BnNetd::logFunc != nullptr) {
      auto _log_end = std::chrono::steady_clock::now();
      _transaction_log.duration_ms = std::chrono::duration<double, std::milli>(_log_end - _log_start).count();
      _transaction_log.interface_name = "android.net.INetd";
  ...
  break;
  case BnNetd::TRANSACTION_networkRemoveUidRangesParcel:
  {
    ::android::net::netd::aidl::NativeUidRangeConfig in_uidRangesConfig;
    if (!(_aidl_data.checkInterface(this))) {
      _aidl_ret_status = ::android::BAD_TYPE;
    ...
    auto _log_start = std::chrono::steady_clock::now();
    ::android::binder::Status _aidl_status(networkRemoveUidRangesParcel(in_uidRangesConfig));
    if (BnNetd::logFunc != nullptr) {
      auto _log_end = std::chrono::steady_clock::now();
      _transaction_log.duration_ms = std::chrono::duration<double, std::milli>(_log_end - _log_start).count();
      _transaction_log.interface_name = "android.net.INetd";
