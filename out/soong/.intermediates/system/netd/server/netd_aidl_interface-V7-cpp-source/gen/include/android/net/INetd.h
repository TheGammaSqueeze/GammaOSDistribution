...
#include <android/net/netd/aidl/NativeUidRangeConfig.h>
...
public:
  ...
  const std::string HASH = "850353de5d19a0dd718f8fd20791f0532e6a34c7";
  enum  : int32_t {
    IPV4 = 4,
    IPV6 = 6,
    CONF = 1,
  ...
  virtual ::android::binder::Status networkAddUidRangesParcel(const ::android::net::netd::aidl::NativeUidRangeConfig& uidRangesConfig) = 0;
  virtual ::android::binder::Status networkRemoveUidRangesParcel(const ::android::net::netd::aidl::NativeUidRangeConfig& uidRangesConfig) = 0;
...
public:
  ...
  ::android::binder::Status networkAddUidRangesParcel(const ::android::net::netd::aidl::NativeUidRangeConfig&) override {
    return ::android::binder::Status::fromStatusT(::android::UNKNOWN_TRANSACTION);
  }
  ::android::binder::Status networkRemoveUidRangesParcel(const ::android::net::netd::aidl::NativeUidRangeConfig&) override {
    return ::android::binder::Status::fromStatusT(::android::UNKNOWN_TRANSACTION);
  }
