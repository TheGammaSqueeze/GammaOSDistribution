...
public:
  ...
  static constexpr uint32_t TRANSACTION_networkAddUidRangesParcel = ::android::IBinder::FIRST_CALL_TRANSACTION + 105;
  static constexpr uint32_t TRANSACTION_networkRemoveUidRangesParcel = ::android::IBinder::FIRST_CALL_TRANSACTION + 106;
