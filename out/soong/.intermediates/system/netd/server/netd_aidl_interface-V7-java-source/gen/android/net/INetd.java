...
public interface INetd extends android.os.IInterface
{
  ...
  public static final String HASH = "850353de5d19a0dd718f8fd20791f0532e6a34c7";
  ...
  public static class Default implements android.net.INetd
  {
    ...
    @Override public boolean firewallReplaceUidChain(java.lang.String chainName, boolean isAllowlist, int[] uids) throws android.os.RemoteException
    {
      return false;
    }
    ...
    @Override public android.net.TetherStatsParcel[] tetherOffloadGetStats() throws android.os.RemoteException
    {
      return null;
    }
    @Override public void tetherOffloadSetInterfaceQuota(int ifIndex, long quotaBytes) throws android.os.RemoteException
    {
    }
    @Override public android.net.TetherStatsParcel tetherOffloadGetAndClearStats(int ifIndex) throws android.os.RemoteException
    {
      return null;
    }
    @Override public void networkCreate(android.net.NativeNetworkConfig config) throws android.os.RemoteException
    {
    }
    @Override public void networkAddUidRangesParcel(android.net.netd.aidl.NativeUidRangeConfig uidRangesConfig) throws android.os.RemoteException
    {
    }
    @Override public void networkRemoveUidRangesParcel(android.net.netd.aidl.NativeUidRangeConfig uidRangesConfig) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.net.INetd
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_tetherOffloadGetStats:
        {
          data.enforceInterface(descriptor);
          android.net.TetherStatsParcel[] _result = this.tetherOffloadGetStats();
          reply.writeNoException();
          reply.writeTypedArray(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          return true;
        }
        case TRANSACTION_tetherOffloadSetInterfaceQuota:
        {
          data.enforceInterface(descriptor);
          int _arg0;
          _arg0 = data.readInt();
          long _arg1;
          _arg1 = data.readLong();
          this.tetherOffloadSetInterfaceQuota(_arg0, _arg1);
          reply.writeNoException();
          return true;
        }
        case TRANSACTION_tetherOffloadGetAndClearStats:
        {
          data.enforceInterface(descriptor);
          int _arg0;
          _arg0 = data.readInt();
          android.net.TetherStatsParcel _result = this.tetherOffloadGetAndClearStats(_arg0);
          reply.writeNoException();
          if ((_result!=null)) {
            reply.writeInt(1);
            _result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
        ...
        case TRANSACTION_networkCreate:
        {
          data.enforceInterface(descriptor);
          android.net.NativeNetworkConfig _arg0;
          if ((0!=data.readInt())) {
            _arg0 = android.net.NativeNetworkConfig.CREATOR.createFromParcel(data);
          }
          else {
            _arg0 = null;
          }
          this.networkCreate(_arg0);
          reply.writeNoException();
          return true;
        }
        case TRANSACTION_networkAddUidRangesParcel:
        {
          data.enforceInterface(descriptor);
          android.net.netd.aidl.NativeUidRangeConfig _arg0;
          if ((0!=data.readInt())) {
            _arg0 = android.net.netd.aidl.NativeUidRangeConfig.CREATOR.createFromParcel(data);
          }
          else {
            _arg0 = null;
          }
          this.networkAddUidRangesParcel(_arg0);
          reply.writeNoException();
          return true;
        }
        case TRANSACTION_networkRemoveUidRangesParcel:
        {
          data.enforceInterface(descriptor);
          android.net.netd.aidl.NativeUidRangeConfig _arg0;
          if ((0!=data.readInt())) {
          ...
          this.networkRemoveUidRangesParcel(_arg0);
          reply.writeNoException();
          return true;
        }
        default:
    ...
    private static class Proxy implements android.net.INetd
    {
      ...
      @Override public boolean firewallReplaceUidChain(java.lang.String chainName, boolean isAllowlist, int[] uids) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeInt(((isAllowlist)?(1):(0)));
          _data.writeIntArray(uids);
          boolean _status = mRemote.transact(Stub.TRANSACTION_firewallReplaceUidChain, _data, _reply, 0);
          if (!_status) {
            if (getDefaultImpl() != null) {
              return getDefaultImpl().firewallReplaceUidChain(chainName, isAllowlist, uids);
            }
            else {
      ...
      @Override public android.net.TetherStatsParcel[] tetherOffloadGetStats() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_tetherOffloadGetStats, _data, _reply, 0);
          if (!_status) {
            if (getDefaultImpl() != null) {
              return getDefaultImpl().tetherOffloadGetStats();
            }
            else {
      ...
      @Override public void tetherOffloadSetInterfaceQuota(int ifIndex, long quotaBytes) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_tetherOffloadSetInterfaceQuota, _data, _reply, 0);
          if (!_status) {
            if (getDefaultImpl() != null) {
              getDefaultImpl().tetherOffloadSetInterfaceQuota(ifIndex, quotaBytes);
              return;
            }
            else {
      ...
      @Override public android.net.TetherStatsParcel tetherOffloadGetAndClearStats(int ifIndex) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(ifIndex);
          boolean _status = mRemote.transact(Stub.TRANSACTION_tetherOffloadGetAndClearStats, _data, _reply, 0);
          if (!_status) {
            if (getDefaultImpl() != null) {
              return getDefaultImpl().tetherOffloadGetAndClearStats(ifIndex);
            }
            else {
          ...
          _reply.readException();
          if ((0!=_reply.readInt())) {
            _result = android.net.TetherStatsParcel.CREATOR.createFromParcel(_reply);
          }
          else {
            _result = null;
          }
      ...
      @Override public void networkCreate(android.net.NativeNetworkConfig config) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_networkCreate, _data, _reply, 0);
          if (!_status) {
            if (getDefaultImpl() != null) {
              getDefaultImpl().networkCreate(config);
              return;
            }
            else {
      ...
      @Override public void networkAddUidRangesParcel(android.net.netd.aidl.NativeUidRangeConfig uidRangesConfig) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          if ((uidRangesConfig!=null)) {
            _data.writeInt(1);
            uidRangesConfig.writeToParcel(_data, 0);
          }
          else {
            _data.writeInt(0);
          }
          boolean _status = mRemote.transact(Stub.TRANSACTION_networkAddUidRangesParcel, _data, _reply, 0);
          if (!_status) {
            if (getDefaultImpl() != null) {
              getDefaultImpl().networkAddUidRangesParcel(uidRangesConfig);
              return;
            }
            else {
      ...
      @Override public void networkRemoveUidRangesParcel(android.net.netd.aidl.NativeUidRangeConfig uidRangesConfig) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_networkRemoveUidRangesParcel, _data, _reply, 0);
          if (!_status) {
            if (getDefaultImpl() != null) {
              getDefaultImpl().networkRemoveUidRangesParcel(uidRangesConfig);
              return;
            }
            else {
    ...
    static final int TRANSACTION_tetherOffloadGetStats = (android.os.IBinder.FIRST_CALL_TRANSACTION + 101);
    static final int TRANSACTION_tetherOffloadSetInterfaceQuota = (android.os.IBinder.FIRST_CALL_TRANSACTION + 102);
    static final int TRANSACTION_tetherOffloadGetAndClearStats = (android.os.IBinder.FIRST_CALL_TRANSACTION + 103);
    static final int TRANSACTION_networkCreate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 104);
    static final int TRANSACTION_networkAddUidRangesParcel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 105);
    static final int TRANSACTION_networkRemoveUidRangesParcel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 106);
