 ...
 * {@hide}
 */
public class TunerFrontendDvbsCapabilities implements android.os.Parcelable
{
  /**
  ...
  public static final android.os.Parcelable.Creator<TunerFrontendDvbsCapabilities> CREATOR = new android.os.Parcelable.Creator<TunerFrontendDvbsCapabilities>() {
    @Override
    public TunerFrontendDvbsCapabilities createFromParcel(android.os.Parcel _aidl_source) {
