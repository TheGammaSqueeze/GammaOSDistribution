...
namespace android {
namespace media {
const char* MediaObservableParcel::descriptor = "android.media.MediaObservableParcel";

binder_status_t MediaObservableParcel::readFromParcel(const AParcel* parcel) {
...
binder_status_t MediaObservableParcel::writeToParcel(AParcel* parcel) const {
