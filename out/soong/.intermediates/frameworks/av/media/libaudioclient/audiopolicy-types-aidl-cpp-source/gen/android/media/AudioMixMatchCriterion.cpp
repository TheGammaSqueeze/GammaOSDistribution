...
::android::status_t AudioMixMatchCriterion::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readBool(&invert);
...
::android::status_t AudioMixMatchCriterion::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  auto _aidl_start_pos = _aidl_parcel->dataPosition();
  _aidl_parcel->writeInt32(0);
  _aidl_ret_status = _aidl_parcel->writeBool(invert);
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
