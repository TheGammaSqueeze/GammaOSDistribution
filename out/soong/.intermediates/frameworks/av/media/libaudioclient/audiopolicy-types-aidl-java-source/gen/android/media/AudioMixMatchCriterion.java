...
public class AudioMixMatchCriterion implements android.os.Parcelable
{
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    _aidl_parcel.writeInt(((invert)?(1):(0)));
    if ((value!=null)) {
      _aidl_parcel.writeInt(1);
      value.writeToParcel(_aidl_parcel, 0);
    }
    else {
      _aidl_parcel.writeInt(0);
    }
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      invert = (0!=_aidl_parcel.readInt());
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      if ((0!=_aidl_parcel.readInt())) {
        value = android.media.AudioMixMatchCriterionValue.CREATOR.createFromParcel(_aidl_parcel);
      }
      else {
        value = null;
      }
