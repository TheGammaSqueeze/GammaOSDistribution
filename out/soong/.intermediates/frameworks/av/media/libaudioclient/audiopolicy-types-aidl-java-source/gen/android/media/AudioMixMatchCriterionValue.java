...
public final class AudioMixMatchCriterionValue implements android.os.Parcelable {
  ...
  public final static int usage = 0;  // android.media.AudioUsage usage;
  public final static int source = 1;  // android.media.AudioSourceType source;
  ...
  public AudioMixMatchCriterionValue() {
    int _value = android.media.AudioUsage.UNKNOWN;
    this._tag = usage;
    this._value = _value;
  }
  ...
  // android.media.AudioUsage usage;
