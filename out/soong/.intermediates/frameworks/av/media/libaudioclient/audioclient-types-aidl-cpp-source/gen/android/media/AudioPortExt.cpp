...
::android::status_t AudioPortExt::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  case device: {
    ...
    if constexpr (std::is_trivially_copyable_v<::android::media::AudioPortDeviceExt>) {
  ...
  case mix: {
    ...
    if ((_aidl_ret_status = _aidl_parcel->readParcelable(&_aidl_value)) != ::android::OK) return _aidl_ret_status;
    if constexpr (std::is_trivially_copyable_v<::android::media::AudioPortMixExt>) {
      set<mix>(_aidl_value);
    } else {
      // NOLINTNEXTLINE(performance-move-const-arg)
  ...
  case session: {
    ...
    if ((_aidl_ret_status = _aidl_parcel->readParcelable(&_aidl_value)) != ::android::OK) return _aidl_ret_status;
    if constexpr (std::is_trivially_copyable_v<::android::media::AudioPortSessionExt>) {
...
::android::status_t AudioPortExt::writeToParcel(::android::Parcel* _aidl_parcel) const {
