...
::android::status_t AudioDevice::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t AudioDevice::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
