...
::android::status_t AudioPortMixExt::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readInt32(reinterpret_cast<int32_t *>(&latencyClass));
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
  _aidl_parcel->setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
...
::android::status_t AudioPortMixExt::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  ...
  _aidl_ret_status = _aidl_parcel->writeInt32(static_cast<int32_t>(latencyClass));
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
