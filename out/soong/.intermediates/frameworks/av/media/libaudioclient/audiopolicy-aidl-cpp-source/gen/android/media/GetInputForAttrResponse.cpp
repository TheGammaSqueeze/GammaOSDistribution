...
::android::status_t GetInputForAttrResponse::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t GetInputForAttrResponse::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
