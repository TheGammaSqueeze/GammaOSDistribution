...
public class TranscodingSessionParcel implements android.os.Parcelable
{
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    if ((request!=null)) {
      ...
      request.writeToParcel(_aidl_parcel, 0);
    }
    else {
      _aidl_parcel.writeInt(0);
    }
    if ((videoTrackFormat!=null)) {
      _aidl_parcel.writeInt(1);
      videoTrackFormat.writeToParcel(_aidl_parcel, 0);
    }
    else {
      _aidl_parcel.writeInt(0);
    }
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if ((0!=_aidl_parcel.readInt())) {
        request = android.media.TranscodingRequestParcel.CREATOR.createFromParcel(_aidl_parcel);
      }
      else {
        request = null;
      }
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      if ((0!=_aidl_parcel.readInt())) {
        videoTrackFormat = android.media.TranscodingVideoTrackFormat.CREATOR.createFromParcel(_aidl_parcel);
      }
      else {
