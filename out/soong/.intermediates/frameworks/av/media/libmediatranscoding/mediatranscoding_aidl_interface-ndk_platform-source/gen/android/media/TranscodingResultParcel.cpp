...
namespace android {
namespace media {
const char* TranscodingResultParcel::descriptor = "android.media.TranscodingResultParcel";

binder_status_t TranscodingResultParcel::readFromParcel(const AParcel* parcel) {
  ...
  _aidl_ret_status = AParcel_readInt32(parcel, &actualBitrateBps);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = ::ndk::AParcel_readNullableParcelable(parcel, &sessionStats);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t TranscodingResultParcel::writeToParcel(AParcel* parcel) const {
  ...
  _aidl_ret_status = AParcel_writeInt32(parcel, actualBitrateBps);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeNullableParcelable(parcel, sessionStats);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
