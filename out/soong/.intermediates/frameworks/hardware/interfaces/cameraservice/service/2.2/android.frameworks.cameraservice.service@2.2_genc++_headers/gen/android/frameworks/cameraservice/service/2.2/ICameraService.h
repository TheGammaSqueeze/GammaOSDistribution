#ifndef HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_SERVICE_V2_2_ICAMERASERVICE_H
#define HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_SERVICE_V2_2_ICAMERASERVICE_H
...
struct ICameraService : public ::android::frameworks::cameraservice::service::V2_1::ICameraService {
    /**
    ...
    /**
     * Fully qualified interface name: "android.frameworks.cameraservice.service@2.2::ICameraService"
     */
    ...
    /**
     * Return callback for addListener_2_1
     */
    using addListener_2_1_cb = std::function<void(::android::frameworks::cameraservice::common::V2_0::Status status, const ::android::hardware::hidl_vec<::android::frameworks::cameraservice::service::V2_1::CameraStatusAndId>& statuses)>;
    /**
     * Add listener for changes to camera device status.
     *
     ...
     */
    virtual ::android::hardware::Return<void> addListener_2_1(const ::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraServiceListener>& listener, addListener_2_1_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_2::ICameraService>> castFrom(const ::android::sp<::android::frameworks::cameraservice::service::V2_2::ICameraService>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_2::ICameraService>> castFrom(const ::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_2::ICameraService>> castFrom(const ::android::sp<::android::frameworks::cameraservice::service::V2_0::ICameraService>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_2::ICameraService>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::frameworks::cameraservice::service::V2_2::ICameraService>& o);
...
static inline std::string toString(const ::android::sp<::android::frameworks::cameraservice::service::V2_2::ICameraService>& o) {
    ...
    os += ::android::frameworks::cameraservice::service::V2_2::ICameraService::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_SERVICE_V2_2_ICAMERASERVICE_H
