#define LOG_TAG "android.frameworks.cameraservice.service@2.0::CameraServiceListener"
...
#include <android/frameworks/cameraservice/service/2.0/BnHwCameraServiceListener.h>
#include <android/frameworks/cameraservice/service/2.0/BsCameraServiceListener.h>
...
const char* ICameraServiceListener::descriptor("android.frameworks.cameraservice.service@2.0::ICameraServiceListener");
...
::android::hardware::Return<void> ICameraServiceListener::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::frameworks::cameraservice::service::V2_0::ICameraServiceListener::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_0::ICameraServiceListener>> ICameraServiceListener::castFrom(const ::android::sp<::android::frameworks::cameraservice::service::V2_0::ICameraServiceListener>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_0::ICameraServiceListener>> ICameraServiceListener::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraServiceListener, ::android::hidl::base::V1_0::IBase, BpHwCameraServiceListener>(
            parent, "android.frameworks.cameraservice.service@2.0::ICameraServiceListener", emitError);
}
...
BpHwCameraServiceListener::BpHwCameraServiceListener(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICameraServiceListener>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.frameworks.cameraservice.service@2.0", "ICameraServiceListener") {
}
...
// Methods from ::android::frameworks::cameraservice::service::V2_0::ICameraServiceListener follow.
::android::hardware::Return<void> BpHwCameraServiceListener::_hidl_onStatusChanged(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::frameworks::cameraservice::service::V2_0::CameraStatusAndId& statusAndId) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraServiceListener::onStatusChanged::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&statusAndId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.frameworks.cameraservice.service", "2.0", "ICameraServiceListener", "onStatusChanged", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* onStatusChanged */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.frameworks.cameraservice.service", "2.0", "ICameraServiceListener", "onStatusChanged", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwCameraServiceListener::BnHwCameraServiceListener(const ::android::sp<ICameraServiceListener> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.frameworks.cameraservice.service@2.0", "ICameraServiceListener") { 
...
// Methods from ::android::frameworks::cameraservice::service::V2_0::ICameraServiceListener follow.
::android::status_t BnHwCameraServiceListener::_hidl_onStatusChanged(
    ...
    ::android::frameworks::cameraservice::service::V2_0::CameraStatusAndId* statusAndId;
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::frameworks::cameraservice::service::V2_0::CameraStatusAndId &>(*statusAndId),
            _hidl_data,
            _hidl_statusAndId_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraServiceListener::onStatusChanged::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)statusAndId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.frameworks.cameraservice.service", "2.0", "ICameraServiceListener", "onStatusChanged", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraServiceListener*>(_hidl_this->getImpl().get())->onStatusChanged(*statusAndId);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.frameworks.cameraservice.service", "2.0", "ICameraServiceListener", "onStatusChanged", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsCameraServiceListener::BsCameraServiceListener(const ::android::sp<::android::frameworks::cameraservice::service::V2_0::ICameraServiceListener> impl) : ::android::hardware::details::HidlInstrumentor("android.frameworks.cameraservice.service@2.0", "ICameraServiceListener"), mImpl(impl) {
...
bool ICameraServiceListener::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.frameworks.cameraservice.service@2.0::ICameraServiceListener",
