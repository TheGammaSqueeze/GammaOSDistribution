#define LOG_TAG "android.frameworks.cameraservice.service@2.1::CameraService"
...
#include <android/frameworks/cameraservice/service/2.1/BnHwCameraService.h>
#include <android/frameworks/cameraservice/service/2.1/BsCameraService.h>
...
const char* ICameraService::descriptor("android.frameworks.cameraservice.service@2.1::ICameraService");
...
::android::hardware::Return<void> ICameraService::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::frameworks::cameraservice::service::V2_1::ICameraService::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>> ICameraService::castFrom(const ::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>> ICameraService::castFrom(const ::android::sp<::android::frameworks::cameraservice::service::V2_0::ICameraService>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraService, ::android::frameworks::cameraservice::service::V2_0::ICameraService, BpHwCameraService>(
            parent, "android.frameworks.cameraservice.service@2.1::ICameraService", emitError);
}

::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService>> ICameraService::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCameraService::BpHwCameraService(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICameraService>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.frameworks.cameraservice.service@2.1", "ICameraService") {
}
...
// Methods from ::android::frameworks::cameraservice::service::V2_1::ICameraService follow.
::android::hardware::Return<void> BpHwCameraService::_hidl_addListener_2_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraServiceListener>& listener, addListener_2_1_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraService::addListener_2_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&listener);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.frameworks.cameraservice.service", "2.1", "ICameraService", "addListener_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(6 /* addListener_2_1 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::frameworks::cameraservice::common::V2_0::Status _hidl_out_status;
        const ::android::hardware::hidl_vec<::android::frameworks::cameraservice::service::V2_1::CameraStatusAndId>* _hidl_out_statuses;
        ...
        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::hidl_vec<::android::frameworks::cameraservice::service::V2_1::CameraStatusAndId> &>(*_hidl_out_statuses),
                _hidl_reply,
        ...
        for (size_t _hidl_index_0 = 0; _hidl_index_0 < _hidl_out_statuses->size(); ++_hidl_index_0) {
            _hidl_err = readEmbeddedFromParcel(
                    const_cast<::android::frameworks::cameraservice::service::V2_1::CameraStatusAndId &>((*_hidl_out_statuses)[_hidl_index_0]),
                    _hidl_reply,
                    _hidl__hidl_out_statuses_child,
                    _hidl_index_0 * sizeof(::android::frameworks::cameraservice::service::V2_1::CameraStatusAndId));
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.frameworks.cameraservice.service", "2.1", "ICameraService", "addListener_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwCameraService::BnHwCameraService(const ::android::sp<ICameraService> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.frameworks.cameraservice.service@2.1", "ICameraService") { 
...
// Methods from ::android::frameworks::cameraservice::service::V2_1::ICameraService follow.
::android::status_t BnHwCameraService::_hidl_addListener_2_1(
    ...
    ::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraServiceListener> listener;

    {
        ...
        listener = ::android::hardware::fromBinder<::android::frameworks::cameraservice::service::V2_1::ICameraServiceListener,::android::frameworks::cameraservice::service::V2_1::BpHwCameraServiceListener,::android::frameworks::cameraservice::service::V2_1::BnHwCameraServiceListener>(_hidl_binder);
    }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraService::addListener_2_1::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&listener);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.frameworks.cameraservice.service", "2.1", "ICameraService", "addListener_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraService*>(_hidl_this->getImpl().get())->addListener_2_1(listener, [&](const auto &_hidl_out_status, const auto &_hidl_out_statuses) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("addListener_2_1: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_statuses);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.frameworks.cameraservice.service", "2.1", "ICameraService", "addListener_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("addListener_2_1: _hidl_cb not called, but must be called once.");
    }
...
BsCameraService::BsCameraService(const ::android::sp<::android::frameworks::cameraservice::service::V2_1::ICameraService> impl) : ::android::hardware::details::HidlInstrumentor("android.frameworks.cameraservice.service@2.1", "ICameraService"), mImpl(impl) {
...
bool ICameraService::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.frameworks.cameraservice.service@2.1::ICameraService",
