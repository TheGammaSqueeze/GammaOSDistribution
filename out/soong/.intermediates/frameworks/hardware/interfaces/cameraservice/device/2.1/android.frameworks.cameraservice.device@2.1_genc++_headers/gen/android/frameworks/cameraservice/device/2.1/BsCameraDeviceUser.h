#ifndef HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_DEVICE_V2_1_BSCAMERADEVICEUSER_H
#define HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_DEVICE_V2_1_BSCAMERADEVICEUSER_H
...
struct BsCameraDeviceUser : ICameraDeviceUser, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<::android::frameworks::cameraservice::common::V2_0::Status> endConfigure_2_1(::android::frameworks::cameraservice::device::V2_0::StreamConfigurationMode operatingMode, const ::android::hardware::hidl_vec<uint8_t>& sessionParams, int64_t startTimeNs) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraDeviceUser::endConfigure_2_1::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&operatingMode);
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.frameworks.cameraservice.device", "2.1", "ICameraDeviceUser", "endConfigure_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__

        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->endConfigure_2_1(operatingMode, sessionParams, startTimeNs);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_status);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.frameworks.cameraservice.device", "2.1", "ICameraDeviceUser", "endConfigure_2_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_DEVICE_V2_1_BSCAMERADEVICEUSER_H
