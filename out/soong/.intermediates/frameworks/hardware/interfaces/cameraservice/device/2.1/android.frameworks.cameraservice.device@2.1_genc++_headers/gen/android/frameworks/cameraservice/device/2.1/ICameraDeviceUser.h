#ifndef HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_DEVICE_V2_1_ICAMERADEVICEUSER_H
#define HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_DEVICE_V2_1_ICAMERADEVICEUSER_H
...
struct ICameraDeviceUser : public ::android::frameworks::cameraservice::device::V2_0::ICameraDeviceUser {
    /**
    ...
    /**
     * Fully qualified interface name: "android.frameworks.cameraservice.device@2.1::ICameraDeviceUser"
     */
     ...
     *
     */
    virtual ::android::hardware::Return<::android::frameworks::cameraservice::common::V2_0::Status> endConfigure_2_1(::android::frameworks::cameraservice::device::V2_0::StreamConfigurationMode operatingMode, const ::android::hardware::hidl_vec<uint8_t>& sessionParams, int64_t startTimeNs) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::device::V2_1::ICameraDeviceUser>> castFrom(const ::android::sp<::android::frameworks::cameraservice::device::V2_1::ICameraDeviceUser>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::device::V2_1::ICameraDeviceUser>> castFrom(const ::android::sp<::android::frameworks::cameraservice::device::V2_0::ICameraDeviceUser>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::frameworks::cameraservice::device::V2_1::ICameraDeviceUser>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::frameworks::cameraservice::device::V2_1::ICameraDeviceUser>& o);
...
static inline std::string toString(const ::android::sp<::android::frameworks::cameraservice::device::V2_1::ICameraDeviceUser>& o) {
    ...
    os += ::android::frameworks::cameraservice::device::V2_1::ICameraDeviceUser::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_FRAMEWORKS_CAMERASERVICE_DEVICE_V2_1_ICAMERADEVICEUSER_H
