...
public final class ReadingModeTile_Factory implements Factory<ReadingModeTile> {
  ...
  public ReadingModeTile_Factory(Provider<QSHost> hostProvider,
  ...
  public static ReadingModeTile_Factory create(Provider<QSHost> hostProvider,
      Provider<Looper> backgroundLooperProvider, Provider<Handler> mainHandlerProvider,
      Provider<FalsingManager> falsingManagerProvider,
      Provider<MetricsLogger> metricsLoggerProvider,
      Provider<StatusBarStateController> statusBarStateControllerProvider,
      Provider<ActivityStarter> activityStarterProvider, Provider<QSLogger> qsLoggerProvider) {
    return new ReadingModeTile_Factory(hostProvider, backgroundLooperProvider, mainHandlerProvider, falsingManagerProvider, metricsLoggerProvider, statusBarStateControllerProvider, activityStarterProvider, qsLoggerProvider);
  }

  public static ReadingModeTile newInstance(QSHost host, Looper backgroundLooper,
      ...
      QSLogger qsLogger) {
    return new ReadingModeTile(host, backgroundLooper, mainHandler, falsingManager, metricsLogger, statusBarStateController, activityStarter, qsLogger);
  }
}
