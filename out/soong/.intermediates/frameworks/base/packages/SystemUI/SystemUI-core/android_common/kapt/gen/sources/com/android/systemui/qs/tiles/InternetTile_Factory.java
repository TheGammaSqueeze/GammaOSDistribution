...
public final class InternetTile_Factory implements Factory<InternetTile> {
  ...
  public InternetTile_Factory(Provider<QSHost> hostProvider,
  ...
  public static InternetTile_Factory create(Provider<QSHost> hostProvider,
      ...
      Provider<AccessPointController> accessPointControllerProvider,
      Provider<InternetDialogFactory> internetDialogFactoryProvider) {
    return new InternetTile_Factory(hostProvider, backgroundLooperProvider, mainHandlerProvider, falsingManagerProvider, metricsLoggerProvider, statusBarStateControllerProvider, activityStarterProvider, qsLoggerProvider, networkControllerProvider, accessPointControllerProvider, internetDialogFactoryProvider);
  }

  public static InternetTile newInstance(QSHost host, Looper backgroundLooper, Handler mainHandler,
      ...
      AccessPointController accessPointController, InternetDialogFactory internetDialogFactory) {
    return new InternetTile(host, backgroundLooper, mainHandler, falsingManager, metricsLogger, statusBarStateController, activityStarter, qsLogger, networkController, accessPointController, internetDialogFactory);
  }
}
