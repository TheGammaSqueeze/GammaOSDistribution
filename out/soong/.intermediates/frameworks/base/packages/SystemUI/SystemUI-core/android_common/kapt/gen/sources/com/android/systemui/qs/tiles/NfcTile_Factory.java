...
public final class NfcTile_Factory implements Factory<NfcTile> {
  ...
  public NfcTile_Factory(Provider<QSHost> hostProvider, Provider<Looper> backgroundLooperProvider,
  ...
  @Override
  public NfcTile get() {
    return newInstance(hostProvider.get(), backgroundLooperProvider.get(), mainHandlerProvider.get(), falsingManagerProvider.get(), metricsLoggerProvider.get(), statusBarStateControllerProvider.get(), activityStarterProvider.get(), qsLoggerProvider.get(), broadcastDispatcherProvider.get());
  }
  ...
  public static NfcTile_Factory create(Provider<QSHost> hostProvider,
      ...
      Provider<ActivityStarter> activityStarterProvider, Provider<QSLogger> qsLoggerProvider,
      Provider<BroadcastDispatcher> broadcastDispatcherProvider) {
    return new NfcTile_Factory(hostProvider, backgroundLooperProvider, mainHandlerProvider, falsingManagerProvider, metricsLoggerProvider, statusBarStateControllerProvider, activityStarterProvider, qsLoggerProvider, broadcastDispatcherProvider);
  }

  public static NfcTile newInstance(QSHost host, Looper backgroundLooper, Handler mainHandler,
    ...
    return new NfcTile(host, backgroundLooper, mainHandler, falsingManager, metricsLogger, statusBarStateController, activityStarter, qsLogger, broadcastDispatcher);
  }
}
