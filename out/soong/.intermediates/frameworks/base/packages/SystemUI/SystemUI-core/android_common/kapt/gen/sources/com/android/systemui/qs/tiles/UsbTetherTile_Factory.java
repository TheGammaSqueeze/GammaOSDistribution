...
public final class UsbTetherTile_Factory implements Factory<UsbTetherTile> {
  ...
  public UsbTetherTile_Factory(Provider<QSHost> hostProvider,
  ...
  public static UsbTetherTile_Factory create(Provider<QSHost> hostProvider,
      Provider<Looper> backgroundLooperProvider, Provider<Handler> mainHandlerProvider,
      Provider<FalsingManager> falsingManagerProvider,
      Provider<MetricsLogger> metricsLoggerProvider,
      Provider<StatusBarStateController> statusBarStateControllerProvider,
      Provider<ActivityStarter> activityStarterProvider, Provider<QSLogger> qsLoggerProvider) {
    return new UsbTetherTile_Factory(hostProvider, backgroundLooperProvider, mainHandlerProvider, falsingManagerProvider, metricsLoggerProvider, statusBarStateControllerProvider, activityStarterProvider, qsLoggerProvider);
  }

  public static UsbTetherTile newInstance(QSHost host, Looper backgroundLooper, Handler mainHandler,
      ...
      QSLogger qsLogger) {
    return new UsbTetherTile(host, backgroundLooper, mainHandler, falsingManager, metricsLogger, statusBarStateController, activityStarter, qsLogger);
  }
}
