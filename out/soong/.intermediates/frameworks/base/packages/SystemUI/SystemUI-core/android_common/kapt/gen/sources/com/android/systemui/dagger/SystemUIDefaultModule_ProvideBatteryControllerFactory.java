...
public final class SystemUIDefaultModule_ProvideBatteryControllerFactory implements Factory<BatteryController> {
  ...
  public SystemUIDefaultModule_ProvideBatteryControllerFactory(Provider<Context> contextProvider,
  ...
  public static SystemUIDefaultModule_ProvideBatteryControllerFactory create(
      Provider<Context> contextProvider, Provider<EnhancedEstimates> enhancedEstimatesProvider,
      Provider<PowerManager> powerManagerProvider,
      Provider<BroadcastDispatcher> broadcastDispatcherProvider,
      Provider<DemoModeController> demoModeControllerProvider,
      Provider<Handler> mainHandlerProvider, Provider<Handler> bgHandlerProvider) {
    return new SystemUIDefaultModule_ProvideBatteryControllerFactory(contextProvider, enhancedEstimatesProvider, powerManagerProvider, broadcastDispatcherProvider, demoModeControllerProvider, mainHandlerProvider, bgHandlerProvider);
  }
  ...
  public static BatteryController provideBatteryController(Context context,
    ...
    return Preconditions.checkNotNullFromProvides(SystemUIDefaultModule.provideBatteryController(context, enhancedEstimates, powerManager, broadcastDispatcher, demoModeController, mainHandler, bgHandler));
  }
}
