...
public final class MediaModule_ProvidesQSMediaHostFactory implements Factory<MediaHost> {
  ...
  public MediaModule_ProvidesQSMediaHostFactory(
  ...
  public MediaHost get() {
    return providesQSMediaHost(stateHolderProvider.get(), hierarchyManagerProvider.get(), dataManagerProvider.get(), statesManagerProvider.get());
  }

  public static MediaModule_ProvidesQSMediaHostFactory create(
      Provider<MediaHost.MediaHostStateHolder> stateHolderProvider,
      Provider<MediaHierarchyManager> hierarchyManagerProvider,
      Provider<MediaDataManager> dataManagerProvider,
      Provider<MediaHostStatesManager> statesManagerProvider) {
    return new MediaModule_ProvidesQSMediaHostFactory(stateHolderProvider, hierarchyManagerProvider, dataManagerProvider, statesManagerProvider);
  }

  public static MediaHost providesQSMediaHost(MediaHost.MediaHostStateHolder stateHolder,
      MediaHierarchyManager hierarchyManager, MediaDataManager dataManager,
      MediaHostStatesManager statesManager) {
    return Preconditions.checkNotNullFromProvides(MediaModule.providesQSMediaHost(stateHolder, hierarchyManager, dataManager, statesManager));
  }
}
