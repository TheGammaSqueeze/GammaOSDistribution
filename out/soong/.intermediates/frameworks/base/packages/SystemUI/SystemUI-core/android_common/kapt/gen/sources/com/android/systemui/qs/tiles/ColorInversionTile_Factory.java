...
public final class ColorInversionTile_Factory implements Factory<ColorInversionTile> {
  ...
  public static ColorInversionTile_Factory create(Provider<QSHost> hostProvider,
      ...
      Provider<ActivityStarter> activityStarterProvider, Provider<QSLogger> qsLoggerProvider,
      Provider<UserTracker> userTrackerProvider, Provider<SecureSettings> secureSettingsProvider) {
    return new ColorInversionTile_Factory(hostProvider, backgroundLooperProvider, mainHandlerProvider, falsingManagerProvider, metricsLoggerProvider, statusBarStateControllerProvider, activityStarterProvider, qsLoggerProvider, userTrackerProvider, secureSettingsProvider);
  }

  public static ColorInversionTile newInstance(QSHost host, Looper backgroundLooper,
    ...
    return new ColorInversionTile(host, backgroundLooper, mainHandler, falsingManager, metricsLogger, statusBarStateController, activityStarter, qsLogger, userTracker, secureSettings);
  }
}
