...
public final class WifiTile_Factory implements Factory<WifiTile> {
  ...
  public WifiTile_Factory(Provider<QSHost> hostProvider, Provider<Looper> backgroundLooperProvider,
  ...
  @Override
  public WifiTile get() {
    return newInstance(hostProvider.get(), backgroundLooperProvider.get(), mainHandlerProvider.get(), falsingManagerProvider.get(), metricsLoggerProvider.get(), statusBarStateControllerProvider.get(), activityStarterProvider.get(), qsLoggerProvider.get(), networkControllerProvider.get(), accessPointControllerProvider.get());
  }

  public static WifiTile_Factory create(Provider<QSHost> hostProvider,
      ...
      Provider<NetworkController> networkControllerProvider,
      Provider<AccessPointController> accessPointControllerProvider) {
    return new WifiTile_Factory(hostProvider, backgroundLooperProvider, mainHandlerProvider, falsingManagerProvider, metricsLoggerProvider, statusBarStateControllerProvider, activityStarterProvider, qsLoggerProvider, networkControllerProvider, accessPointControllerProvider);
  }

  public static WifiTile newInstance(QSHost host, Looper backgroundLooper, Handler mainHandler,
      ...
      QSLogger qsLogger, NetworkController networkController,
      AccessPointController accessPointController) {
    return new WifiTile(host, backgroundLooper, mainHandler, falsingManager, metricsLogger, statusBarStateController, activityStarter, qsLogger, networkController, accessPointController);
  }
}
