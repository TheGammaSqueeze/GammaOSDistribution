...
public final class SystemUIDefaultModule_ProvideRecentsFactory implements Factory<Recents> {
  ...
  public SystemUIDefaultModule_ProvideRecentsFactory(Provider<Context> contextProvider,
  ...
  public static SystemUIDefaultModule_ProvideRecentsFactory create(
      Provider<Context> contextProvider,
      Provider<RecentsImplementation> recentsImplementationProvider,
      Provider<CommandQueue> commandQueueProvider) {
    return new SystemUIDefaultModule_ProvideRecentsFactory(contextProvider, recentsImplementationProvider, commandQueueProvider);
  }

  public static Recents provideRecents(Context context, RecentsImplementation recentsImplementation,
      CommandQueue commandQueue) {
    return Preconditions.checkNotNullFromProvides(SystemUIDefaultModule.provideRecents(context, recentsImplementation, commandQueue));
  }
}
