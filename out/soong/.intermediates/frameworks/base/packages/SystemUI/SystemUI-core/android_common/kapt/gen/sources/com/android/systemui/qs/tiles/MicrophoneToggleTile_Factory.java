...
public final class MicrophoneToggleTile_Factory implements Factory<MicrophoneToggleTile> {
  ...
  public MicrophoneToggleTile_Factory(Provider<QSHost> hostProvider,
  ...
  public static MicrophoneToggleTile_Factory create(Provider<QSHost> hostProvider,
      Provider<Looper> backgroundLooperProvider, Provider<Handler> mainHandlerProvider,
      Provider<MetricsLogger> metricsLoggerProvider,
      Provider<FalsingManager> falsingManagerProvider,
      Provider<StatusBarStateController> statusBarStateControllerProvider,
      ...
      Provider<IndividualSensorPrivacyController> sensorPrivacyControllerProvider,
      Provider<KeyguardStateController> keyguardStateControllerProvider) {
    return new MicrophoneToggleTile_Factory(hostProvider, backgroundLooperProvider, mainHandlerProvider, metricsLoggerProvider, falsingManagerProvider, statusBarStateControllerProvider, activityStarterProvider, qsLoggerProvider, sensorPrivacyControllerProvider, keyguardStateControllerProvider);
  }

  public static MicrophoneToggleTile newInstance(QSHost host, Looper backgroundLooper,
    ...
    return new MicrophoneToggleTile(host, backgroundLooper, mainHandler, metricsLogger, falsingManager, statusBarStateController, activityStarter, qsLogger, sensorPrivacyController, keyguardStateController);
  }
}
