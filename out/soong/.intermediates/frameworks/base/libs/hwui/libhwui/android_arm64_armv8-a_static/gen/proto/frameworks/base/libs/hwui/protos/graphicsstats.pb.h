...
#ifndef GOOGLE_PROTOBUF_INCLUDED_frameworks_2fbase_2flibs_2fhwui_2fprotos_2fgraphicsstats_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_frameworks_2fbase_2flibs_2fhwui_2fprotos_2fgraphicsstats_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_frameworks_2fbase_2flibs_2fhwui_2fprotos_2fgraphicsstats_2eproto
...
struct TableStruct_frameworks_2fbase_2flibs_2fhwui_2fprotos_2fgraphicsstats_2eproto {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto* Arena::CreateMaybeMessage<::android::uirenderer::protos::GraphicsStatsHistogramBucketProto>(Arena*);
template<> ::android::uirenderer::protos::GraphicsStatsJankSummaryProto* Arena::CreateMaybeMessage<::android::uirenderer::protos::GraphicsStatsJankSummaryProto>(Arena*);
template<> ::android::uirenderer::protos::GraphicsStatsProto* Arena::CreateMaybeMessage<::android::uirenderer::protos::GraphicsStatsProto>(Arena*);
template<> ::android::uirenderer::protos::GraphicsStatsServiceDumpProto* Arena::CreateMaybeMessage<::android::uirenderer::protos::GraphicsStatsServiceDumpProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace android {
namespace uirenderer {
namespace protos {
...
class GraphicsStatsServiceDumpProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.uirenderer.protos.GraphicsStatsServiceDumpProto) */ {
 public:
  ...
  void clear_stats();
  ::android::uirenderer::protos::GraphicsStatsProto* mutable_stats(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsProto >*
      mutable_stats();
  const ::android::uirenderer::protos::GraphicsStatsProto& stats(int index) const;
  ::android::uirenderer::protos::GraphicsStatsProto* add_stats();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsProto >&
      stats() const;

  // @@protoc_insertion_point(class_scope:android.uirenderer.protos.GraphicsStatsServiceDumpProto)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsProto > stats_;
  friend struct ::TableStruct_frameworks_2fbase_2flibs_2fhwui_2fprotos_2fgraphicsstats_2eproto;
};
// -------------------------------------------------------------------

class GraphicsStatsProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.uirenderer.protos.GraphicsStatsProto) */ {
 public:
  GraphicsStatsProto();
  ...
  ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto* mutable_histogram(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto >*
      mutable_histogram();
  const ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto& histogram(int index) const;
  ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto* add_histogram();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto >&
      histogram() const;
  ...
  ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto* mutable_gpu_histogram(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto >*
      mutable_gpu_histogram();
  const ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto& gpu_histogram(int index) const;
  ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto* add_gpu_histogram();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto >&
      gpu_histogram() const;
  ...
  void clear_summary();
  const ::android::uirenderer::protos::GraphicsStatsJankSummaryProto& summary() const;
  ::android::uirenderer::protos::GraphicsStatsJankSummaryProto* release_summary();
  ::android::uirenderer::protos::GraphicsStatsJankSummaryProto* mutable_summary();
  void set_allocated_summary(::android::uirenderer::protos::GraphicsStatsJankSummaryProto* summary);
  ...
  void clear_pipeline();
  ::android::uirenderer::protos::GraphicsStatsProto_PipelineType pipeline() const;
  void set_pipeline(::android::uirenderer::protos::GraphicsStatsProto_PipelineType value);

  // @@protoc_insertion_point(class_scope:android.uirenderer.protos.GraphicsStatsProto)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto > histogram_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto > gpu_histogram_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr package_name_;
  ::android::uirenderer::protos::GraphicsStatsJankSummaryProto* summary_;
...
class GraphicsStatsJankSummaryProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.uirenderer.protos.GraphicsStatsJankSummaryProto) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:android.uirenderer.protos.GraphicsStatsJankSummaryProto)
 private:
  class _Internal;
...
class GraphicsStatsHistogramBucketProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.uirenderer.protos.GraphicsStatsHistogramBucketProto) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:android.uirenderer.protos.GraphicsStatsHistogramBucketProto)
 private:
  class _Internal;
...
inline ::android::uirenderer::protos::GraphicsStatsProto* GraphicsStatsServiceDumpProto::mutable_stats(int index) {
  // @@protoc_insertion_point(field_mutable:android.uirenderer.protos.GraphicsStatsServiceDumpProto.stats)
  return stats_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsProto >*
GraphicsStatsServiceDumpProto::mutable_stats() {
  // @@protoc_insertion_point(field_mutable_list:android.uirenderer.protos.GraphicsStatsServiceDumpProto.stats)
  return &stats_;
}
inline const ::android::uirenderer::protos::GraphicsStatsProto& GraphicsStatsServiceDumpProto::stats(int index) const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsServiceDumpProto.stats)
  return stats_.Get(index);
}
inline ::android::uirenderer::protos::GraphicsStatsProto* GraphicsStatsServiceDumpProto::add_stats() {
  // @@protoc_insertion_point(field_add:android.uirenderer.protos.GraphicsStatsServiceDumpProto.stats)
  return stats_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsProto >&
GraphicsStatsServiceDumpProto::stats() const {
  // @@protoc_insertion_point(field_list:android.uirenderer.protos.GraphicsStatsServiceDumpProto.stats)
  return stats_;
}
...
inline const std::string& GraphicsStatsProto::package_name() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsProto.package_name)
...
inline void GraphicsStatsProto::set_package_name(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsProto.package_name)
}
inline void GraphicsStatsProto::set_package_name(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  package_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:android.uirenderer.protos.GraphicsStatsProto.package_name)
}
inline void GraphicsStatsProto::set_package_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:android.uirenderer.protos.GraphicsStatsProto.package_name)
}
inline void GraphicsStatsProto::set_package_name(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:android.uirenderer.protos.GraphicsStatsProto.package_name)
}
inline std::string* GraphicsStatsProto::mutable_package_name() {
  _has_bits_[0] |= 0x00000001u;
  // @@protoc_insertion_point(field_mutable:android.uirenderer.protos.GraphicsStatsProto.package_name)
...
inline std::string* GraphicsStatsProto::release_package_name() {
  // @@protoc_insertion_point(field_release:android.uirenderer.protos.GraphicsStatsProto.package_name)
  if (!has_package_name()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000001u;
...
inline void GraphicsStatsProto::set_allocated_package_name(std::string* package_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:android.uirenderer.protos.GraphicsStatsProto.package_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 GraphicsStatsProto::version_code() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsProto.version_code)
  return version_code_;
}
inline void GraphicsStatsProto::set_version_code(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000004u;
  version_code_ = value;
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsProto.version_code)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 GraphicsStatsProto::stats_start() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsProto.stats_start)
  return stats_start_;
}
inline void GraphicsStatsProto::set_stats_start(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000008u;
  stats_start_ = value;
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsProto.stats_start)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 GraphicsStatsProto::stats_end() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsProto.stats_end)
  return stats_end_;
}
inline void GraphicsStatsProto::set_stats_end(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000010u;
  stats_end_ = value;
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsProto.stats_end)
}
...
inline const ::android::uirenderer::protos::GraphicsStatsJankSummaryProto& GraphicsStatsProto::summary() const {
  const ::android::uirenderer::protos::GraphicsStatsJankSummaryProto* p = summary_;
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsProto.summary)
  return p != nullptr ? *p : *reinterpret_cast<const ::android::uirenderer::protos::GraphicsStatsJankSummaryProto*>(
      &::android::uirenderer::protos::_GraphicsStatsJankSummaryProto_default_instance_);
}
inline ::android::uirenderer::protos::GraphicsStatsJankSummaryProto* GraphicsStatsProto::release_summary() {
  // @@protoc_insertion_point(field_release:android.uirenderer.protos.GraphicsStatsProto.summary)
  _has_bits_[0] &= ~0x00000002u;
  ::android::uirenderer::protos::GraphicsStatsJankSummaryProto* temp = summary_;
  summary_ = nullptr;
  return temp;
}
inline ::android::uirenderer::protos::GraphicsStatsJankSummaryProto* GraphicsStatsProto::mutable_summary() {
  _has_bits_[0] |= 0x00000002u;
  if (summary_ == nullptr) {
    auto* p = CreateMaybeMessage<::android::uirenderer::protos::GraphicsStatsJankSummaryProto>(GetArenaNoVirtual());
    summary_ = p;
  }
  // @@protoc_insertion_point(field_mutable:android.uirenderer.protos.GraphicsStatsProto.summary)
  return summary_;
}
inline void GraphicsStatsProto::set_allocated_summary(::android::uirenderer::protos::GraphicsStatsJankSummaryProto* summary) {
  ...
  summary_ = summary;
  // @@protoc_insertion_point(field_set_allocated:android.uirenderer.protos.GraphicsStatsProto.summary)
}
...
inline ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto* GraphicsStatsProto::mutable_histogram(int index) {
  // @@protoc_insertion_point(field_mutable:android.uirenderer.protos.GraphicsStatsProto.histogram)
  return histogram_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto >*
GraphicsStatsProto::mutable_histogram() {
  // @@protoc_insertion_point(field_mutable_list:android.uirenderer.protos.GraphicsStatsProto.histogram)
  return &histogram_;
}
inline const ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto& GraphicsStatsProto::histogram(int index) const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsProto.histogram)
  return histogram_.Get(index);
}
inline ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto* GraphicsStatsProto::add_histogram() {
  // @@protoc_insertion_point(field_add:android.uirenderer.protos.GraphicsStatsProto.histogram)
  return histogram_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto >&
GraphicsStatsProto::histogram() const {
  // @@protoc_insertion_point(field_list:android.uirenderer.protos.GraphicsStatsProto.histogram)
  return histogram_;
}
...
inline ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto* GraphicsStatsProto::mutable_gpu_histogram(int index) {
  // @@protoc_insertion_point(field_mutable:android.uirenderer.protos.GraphicsStatsProto.gpu_histogram)
  return gpu_histogram_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto >*
GraphicsStatsProto::mutable_gpu_histogram() {
  // @@protoc_insertion_point(field_mutable_list:android.uirenderer.protos.GraphicsStatsProto.gpu_histogram)
  return &gpu_histogram_;
}
inline const ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto& GraphicsStatsProto::gpu_histogram(int index) const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsProto.gpu_histogram)
  return gpu_histogram_.Get(index);
}
inline ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto* GraphicsStatsProto::add_gpu_histogram() {
  // @@protoc_insertion_point(field_add:android.uirenderer.protos.GraphicsStatsProto.gpu_histogram)
  return gpu_histogram_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::android::uirenderer::protos::GraphicsStatsHistogramBucketProto >&
GraphicsStatsProto::gpu_histogram() const {
  // @@protoc_insertion_point(field_list:android.uirenderer.protos.GraphicsStatsProto.gpu_histogram)
  return gpu_histogram_;
}
...
inline ::android::uirenderer::protos::GraphicsStatsProto_PipelineType GraphicsStatsProto::pipeline() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsProto.pipeline)
  return static_cast< ::android::uirenderer::protos::GraphicsStatsProto_PipelineType >(pipeline_);
}
inline void GraphicsStatsProto::set_pipeline(::android::uirenderer::protos::GraphicsStatsProto_PipelineType value) {
  assert(::android::uirenderer::protos::GraphicsStatsProto_PipelineType_IsValid(value));
  _has_bits_[0] |= 0x00000020u;
  pipeline_ = value;
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsProto.pipeline)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphicsStatsJankSummaryProto::total_frames() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsJankSummaryProto.total_frames)
  return total_frames_;
}
inline void GraphicsStatsJankSummaryProto::set_total_frames(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  total_frames_ = value;
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsJankSummaryProto.total_frames)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphicsStatsJankSummaryProto::janky_frames() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsJankSummaryProto.janky_frames)
  return janky_frames_;
}
inline void GraphicsStatsJankSummaryProto::set_janky_frames(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  janky_frames_ = value;
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsJankSummaryProto.janky_frames)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphicsStatsJankSummaryProto::missed_vsync_count() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsJankSummaryProto.missed_vsync_count)
...
inline void GraphicsStatsJankSummaryProto::set_missed_vsync_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsJankSummaryProto.missed_vsync_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphicsStatsJankSummaryProto::high_input_latency_count() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsJankSummaryProto.high_input_latency_count)
...
inline void GraphicsStatsJankSummaryProto::set_high_input_latency_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsJankSummaryProto.high_input_latency_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphicsStatsJankSummaryProto::slow_ui_thread_count() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsJankSummaryProto.slow_ui_thread_count)
...
inline void GraphicsStatsJankSummaryProto::set_slow_ui_thread_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsJankSummaryProto.slow_ui_thread_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphicsStatsJankSummaryProto::slow_bitmap_upload_count() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsJankSummaryProto.slow_bitmap_upload_count)
...
inline void GraphicsStatsJankSummaryProto::set_slow_bitmap_upload_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsJankSummaryProto.slow_bitmap_upload_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphicsStatsJankSummaryProto::slow_draw_count() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsJankSummaryProto.slow_draw_count)
...
inline void GraphicsStatsJankSummaryProto::set_slow_draw_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsJankSummaryProto.slow_draw_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphicsStatsJankSummaryProto::missed_deadline_count() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsJankSummaryProto.missed_deadline_count)
...
inline void GraphicsStatsJankSummaryProto::set_missed_deadline_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsJankSummaryProto.missed_deadline_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphicsStatsHistogramBucketProto::render_millis() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsHistogramBucketProto.render_millis)
...
inline void GraphicsStatsHistogramBucketProto::set_render_millis(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsHistogramBucketProto.render_millis)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphicsStatsHistogramBucketProto::frame_count() const {
  // @@protoc_insertion_point(field_get:android.uirenderer.protos.GraphicsStatsHistogramBucketProto.frame_count)
  return frame_count_;
}
inline void GraphicsStatsHistogramBucketProto::set_frame_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  frame_count_ = value;
  // @@protoc_insertion_point(field_set:android.uirenderer.protos.GraphicsStatsHistogramBucketProto.frame_count)
}
...
template <> struct is_proto_enum< ::android::uirenderer::protos::GraphicsStatsProto_PipelineType> : ::std::true_type {};
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_frameworks_2fbase_2flibs_2fhwui_2fprotos_2fgraphicsstats_2eproto
