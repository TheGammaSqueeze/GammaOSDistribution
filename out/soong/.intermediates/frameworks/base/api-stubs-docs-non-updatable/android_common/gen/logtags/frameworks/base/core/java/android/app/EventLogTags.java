...
public class EventLogTags {
  ...
  public static void writeWmOnPausedCalled(int token, String componentName, String reason) {
    android.util.EventLog.writeEvent(WM_ON_PAUSED_CALLED, token, componentName, reason);
  }

  public static void writeWmOnResumeCalled(int token, String componentName, String reason) {
    android.util.EventLog.writeEvent(WM_ON_RESUME_CALLED, token, componentName, reason);
  }

  public static void writeWmOnStopCalled(int token, String componentName, String reason) {
    android.util.EventLog.writeEvent(WM_ON_STOP_CALLED, token, componentName, reason);
  }

  public static void writeWmOnCreateCalled(int token, String componentName, String reason) {
    android.util.EventLog.writeEvent(WM_ON_CREATE_CALLED, token, componentName, reason);
  }

  public static void writeWmOnRestartCalled(int token, String componentName, String reason) {
    android.util.EventLog.writeEvent(WM_ON_RESTART_CALLED, token, componentName, reason);
  }

  public static void writeWmOnStartCalled(int token, String componentName, String reason) {
    android.util.EventLog.writeEvent(WM_ON_START_CALLED, token, componentName, reason);
  }

  public static void writeWmOnDestroyCalled(int token, String componentName, String reason) {
    android.util.EventLog.writeEvent(WM_ON_DESTROY_CALLED, token, componentName, reason);
  }
