...
void RestrictedImagesDumpProto::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const RestrictedImagesDumpProto*>(
      &from));
}
...
std::string RestrictedImagesDumpProto::GetTypeName() const {
...
void RestrictedImageSetProto::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const RestrictedImageSetProto*>(
      &from));
}
...
std::string RestrictedImageSetProto::GetTypeName() const {
...
void RestrictedImageProto::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const RestrictedImageProto*>(
      &from));
}
...
std::string RestrictedImageProto::GetTypeName() const {
