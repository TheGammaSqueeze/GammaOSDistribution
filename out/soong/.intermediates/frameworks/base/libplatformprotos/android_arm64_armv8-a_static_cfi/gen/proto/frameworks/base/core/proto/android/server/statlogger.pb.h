...
class StatLoggerProto_Event :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:com.android.server.StatLoggerProto.Event) */ {
 public:
...
class StatLoggerProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:com.android.server.StatLoggerProto) */ {
 public:
  StatLoggerProto();
