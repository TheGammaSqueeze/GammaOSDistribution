...
const std::string& ProtoLogFileProto_MagicNumber_Name(ProtoLogFileProto_MagicNumber value);
template<typename T>
inline const std::string& ProtoLogFileProto_MagicNumber_Name(T enum_t_value) {
  ...
  return ProtoLogFileProto_MagicNumber_Name(static_cast<ProtoLogFileProto_MagicNumber>(enum_t_value));
}
...
class ProtoLogMessage :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:com.android.internal.protolog.ProtoLogMessage) */ {
 public:
  ProtoLogMessage();
...
class ProtoLogFileProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:com.android.internal.protolog.ProtoLogFileProto) */ {
 public:
  ProtoLogFileProto();
