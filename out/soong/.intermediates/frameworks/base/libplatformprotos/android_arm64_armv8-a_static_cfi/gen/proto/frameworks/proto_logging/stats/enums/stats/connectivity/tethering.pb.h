...
const std::string& DownstreamType_Name(DownstreamType value);
template<typename T>
inline const std::string& DownstreamType_Name(T enum_t_value) {
  ...
  return DownstreamType_Name(static_cast<DownstreamType>(enum_t_value));
}
...
const std::string& UpstreamType_Name(UpstreamType value);
template<typename T>
inline const std::string& UpstreamType_Name(T enum_t_value) {
  ...
  return UpstreamType_Name(static_cast<UpstreamType>(enum_t_value));
}
...
const std::string& UserType_Name(UserType value);
template<typename T>
inline const std::string& UserType_Name(T enum_t_value) {
  ...
  return UserType_Name(static_cast<UserType>(enum_t_value));
}
bool UserType_Parse(
