...
const std::string& WindowManagerTraceFileProto_MagicNumber_Name(WindowManagerTraceFileProto_MagicNumber value);
template<typename T>
inline const std::string& WindowManagerTraceFileProto_MagicNumber_Name(T enum_t_value) {
  ...
  return WindowManagerTraceFileProto_MagicNumber_Name(static_cast<WindowManagerTraceFileProto_MagicNumber>(enum_t_value));
}
...
class WindowManagerTraceFileProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:com.android.server.wm.WindowManagerTraceFileProto) */ {
 public:
...
class WindowManagerTraceProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:com.android.server.wm.WindowManagerTraceProto) */ {
 public:
