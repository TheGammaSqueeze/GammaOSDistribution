...
const std::string& LaunchAction_Name(LaunchAction value);
template<typename T>
inline const std::string& LaunchAction_Name(T enum_t_value) {
  ...
  return LaunchAction_Name(static_cast<LaunchAction>(enum_t_value));
}
...
const std::string& MimeType_Name(MimeType value);
template<typename T>
inline const std::string& MimeType_Name(T enum_t_value) {
  ...
  return MimeType_Name(static_cast<MimeType>(enum_t_value));
}
bool MimeType_Parse(
...
const std::string& Root_Name(Root value);
template<typename T>
inline const std::string& Root_Name(T enum_t_value) {
  ...
  return Root_Name(static_cast<Root>(enum_t_value));
}
bool Root_Parse(
...
const std::string& ContextScope_Name(ContextScope value);
template<typename T>
inline const std::string& ContextScope_Name(T enum_t_value) {
  ...
  return ContextScope_Name(static_cast<ContextScope>(enum_t_value));
}
...
const std::string& Provider_Name(Provider value);
template<typename T>
inline const std::string& Provider_Name(T enum_t_value) {
  ...
  return Provider_Name(static_cast<Provider>(enum_t_value));
}
bool Provider_Parse(
...
const std::string& FileOperation_Name(FileOperation value);
template<typename T>
inline const std::string& FileOperation_Name(T enum_t_value) {
  ...
  return FileOperation_Name(static_cast<FileOperation>(enum_t_value));
}
...
const std::string& SubFileOperation_Name(SubFileOperation value);
template<typename T>
inline const std::string& SubFileOperation_Name(T enum_t_value) {
  ...
  return SubFileOperation_Name(static_cast<SubFileOperation>(enum_t_value));
}
...
const std::string& CopyMoveOpMode_Name(CopyMoveOpMode value);
template<typename T>
inline const std::string& CopyMoveOpMode_Name(T enum_t_value) {
  ...
  return CopyMoveOpMode_Name(static_cast<CopyMoveOpMode>(enum_t_value));
}
...
const std::string& Authority_Name(Authority value);
template<typename T>
inline const std::string& Authority_Name(T enum_t_value) {
  ...
  return Authority_Name(static_cast<Authority>(enum_t_value));
}
...
const std::string& UserAction_Name(UserAction value);
template<typename T>
inline const std::string& UserAction_Name(T enum_t_value) {
  ...
  return UserAction_Name(static_cast<UserAction>(enum_t_value));
}
...
const std::string& InvalidScopedAccess_Name(InvalidScopedAccess value);
template<typename T>
inline const std::string& InvalidScopedAccess_Name(T enum_t_value) {
  ...
  return InvalidScopedAccess_Name(static_cast<InvalidScopedAccess>(enum_t_value));
}
...
const std::string& SearchType_Name(SearchType value);
template<typename T>
inline const std::string& SearchType_Name(T enum_t_value) {
  ...
  return SearchType_Name(static_cast<SearchType>(enum_t_value));
}
...
const std::string& SearchMode_Name(SearchMode value);
template<typename T>
inline const std::string& SearchMode_Name(T enum_t_value) {
  ...
  return SearchMode_Name(static_cast<SearchMode>(enum_t_value));
}
