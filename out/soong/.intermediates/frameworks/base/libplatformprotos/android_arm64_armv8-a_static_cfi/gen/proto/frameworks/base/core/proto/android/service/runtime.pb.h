...
class RuntimeServiceInfoProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.service.runtime.RuntimeServiceInfoProto) */ {
 public:
...
class DebugEntryProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.service.runtime.DebugEntryProto) */ {
 public:
  DebugEntryProto();
