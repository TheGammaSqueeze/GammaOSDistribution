...
const std::string& NetworkRequestProto_Type_Name(NetworkRequestProto_Type value);
template<typename T>
inline const std::string& NetworkRequestProto_Type_Name(T enum_t_value) {
  ...
  return NetworkRequestProto_Type_Name(static_cast<NetworkRequestProto_Type>(enum_t_value));
}
...
class NetworkRequestProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.net.NetworkRequestProto) */ {
 public:
  NetworkRequestProto();
