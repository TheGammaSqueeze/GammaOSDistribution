...
const std::string& PageId_Name(PageId value);
template<typename T>
inline const std::string& PageId_Name(T enum_t_value) {
  ...
  return PageId_Name(static_cast<PageId>(enum_t_value));
}
bool PageId_Parse(
...
const std::string& BatterySaverScheduleType_Name(BatterySaverScheduleType value);
template<typename T>
inline const std::string& BatterySaverScheduleType_Name(T enum_t_value) {
  ...
  return BatterySaverScheduleType_Name(static_cast<BatterySaverScheduleType>(enum_t_value));
}
