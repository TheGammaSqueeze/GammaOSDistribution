...
const std::string& ApBand_Name(ApBand value);
template<typename T>
inline const std::string& ApBand_Name(T enum_t_value) {
  ...
  return ApBand_Name(static_cast<ApBand>(enum_t_value));
}
bool ApBand_Parse(
...
const std::string& RadioTech_Name(RadioTech value);
template<typename T>
inline const std::string& RadioTech_Name(T enum_t_value) {
  ...
  return RadioTech_Name(static_cast<RadioTech>(enum_t_value));
}
...
class CellularData :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:com.android.server.connectivity.CellularData) */ {
 public:
  CellularData();
...
class WifiData :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:com.android.server.connectivity.WifiData) */ {
 public:
  WifiData();
  virtual ~WifiData();
...
class DnsEvent :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:com.android.server.connectivity.DnsEvent) */ {
 public:
  DnsEvent();
  virtual ~DnsEvent();
