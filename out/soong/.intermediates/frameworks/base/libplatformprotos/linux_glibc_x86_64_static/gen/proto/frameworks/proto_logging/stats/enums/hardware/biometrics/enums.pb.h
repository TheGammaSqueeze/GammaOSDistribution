...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fproto_5flogging_2fstats_2fenums_2fhardware_2fbiometrics_2fenums_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace android {
namespace hardware {
...
inline const std::string& ModalityEnum_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ModalityEnum_descriptor(), enum_t_value);
}
inline bool ModalityEnum_Parse(
    const std::string& name, ModalityEnum* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ModalityEnum>(
    ModalityEnum_descriptor(), name, value);
}
enum ClientEnum : int {
  CLIENT_UNKNOWN = 0,
  CLIENT_KEYGUARD = 1,
...
inline const std::string& ClientEnum_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ClientEnum_descriptor(), enum_t_value);
}
inline bool ClientEnum_Parse(
    const std::string& name, ClientEnum* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ClientEnum>(
    ClientEnum_descriptor(), name, value);
}
enum ActionEnum : int {
  ACTION_UNKNOWN = 0,
  ACTION_ENROLL = 1,
...
inline const std::string& ActionEnum_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ActionEnum_descriptor(), enum_t_value);
}
inline bool ActionEnum_Parse(
    const std::string& name, ActionEnum* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ActionEnum>(
    ActionEnum_descriptor(), name, value);
}
enum IssueEnum : int {
  ISSUE_UNKNOWN = 0,
  ISSUE_HAL_DEATH = 1,
...
inline const std::string& IssueEnum_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    IssueEnum_descriptor(), enum_t_value);
}
inline bool IssueEnum_Parse(
    const std::string& name, IssueEnum* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<IssueEnum>(
    IssueEnum_descriptor(), name, value);
}
// ===================================================================
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::hardware::biometrics::ModalityEnum>() {
  return ::android::hardware::biometrics::ModalityEnum_descriptor();
}
template <> struct is_proto_enum< ::android::hardware::biometrics::ClientEnum> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::hardware::biometrics::ClientEnum>() {
  return ::android::hardware::biometrics::ClientEnum_descriptor();
}
template <> struct is_proto_enum< ::android::hardware::biometrics::ActionEnum> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::hardware::biometrics::ActionEnum>() {
  return ::android::hardware::biometrics::ActionEnum_descriptor();
}
template <> struct is_proto_enum< ::android::hardware::biometrics::IssueEnum> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::hardware::biometrics::IssueEnum>() {
  return ::android::hardware::biometrics::IssueEnum_descriptor();
}
