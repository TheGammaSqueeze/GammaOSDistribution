...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fmedia_2faudioattributes_2eproto;
namespace android {
namespace media {
...
inline const std::string& Usage_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    Usage_descriptor(), enum_t_value);
}
inline bool Usage_Parse(
    const std::string& name, Usage* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<Usage>(
    Usage_descriptor(), name, value);
}
// ===================================================================

class AudioAttributesProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.media.AudioAttributesProto) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fmedia_2faudioattributes_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::media::ContentType>() {
  return ::android::media::ContentType_descriptor();
}
template <> struct is_proto_enum< ::android::media::Usage> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::media::Usage>() {
  return ::android::media::Usage_descriptor();
}
