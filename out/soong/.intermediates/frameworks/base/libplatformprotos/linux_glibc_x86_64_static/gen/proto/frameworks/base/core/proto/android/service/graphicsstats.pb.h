...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fservice_2fgraphicsstats_2eproto;
namespace android {
namespace service {
...
inline const std::string& GraphicsStatsProto_PipelineType_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    GraphicsStatsProto_PipelineType_descriptor(), enum_t_value);
}
inline bool GraphicsStatsProto_PipelineType_Parse(
    const std::string& name, GraphicsStatsProto_PipelineType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<GraphicsStatsProto_PipelineType>(
    GraphicsStatsProto_PipelineType_descriptor(), name, value);
}
// ===================================================================

class GraphicsStatsServiceDumpProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.GraphicsStatsServiceDumpProto) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fservice_2fgraphicsstats_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class GraphicsStatsProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.GraphicsStatsProto) */ {
 public:
  GraphicsStatsProto();
  ...
  PipelineType_descriptor() {
    return GraphicsStatsProto_PipelineType_descriptor();
  }
  template<typename T>
...
class GraphicsStatsJankSummaryProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.GraphicsStatsJankSummaryProto) */ {
 public:
...
class GraphicsStatsHistogramBucketProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.GraphicsStatsHistogramBucketProto) */ {
 public:
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::service::GraphicsStatsProto_PipelineType>() {
  return ::android::service::GraphicsStatsProto_PipelineType_descriptor();
}
