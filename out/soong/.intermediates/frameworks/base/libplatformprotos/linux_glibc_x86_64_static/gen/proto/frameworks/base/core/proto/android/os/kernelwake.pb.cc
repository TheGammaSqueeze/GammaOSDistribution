...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, name_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, active_count_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, event_count_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, wakeup_count_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, expire_count_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, active_since_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, total_time_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, max_time_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, last_change_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto_WakeupSource, prevent_suspend_time_),
  0,
  1,
  2,
  3,
  ...
  8,
  9,
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::android::os::KernelWakeSourcesProto, wakeup_sources_),
  ~0u,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 15, sizeof(::android::os::KernelWakeSourcesProto_WakeupSource)},
  { 25, 31, sizeof(::android::os::KernelWakeSourcesProto)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::android::os::_KernelWakeSourcesProto_WakeupSource_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::android::os::_KernelWakeSourcesProto_default_instance_),
};

const char descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n6frameworks/base/core/proto/android/os/"
  "kernelwake.proto\022\nandroid.os\0320frameworks"
  "/base/core/proto/android/privacy.proto\"\334"
  "\002\n\026KernelWakeSourcesProto\022G\n\016wakeup_sour"
  "ces\030\001 \003(\0132/.android.os.KernelWakeSources"
  "Proto.WakeupSource\032\355\001\n\014WakeupSource\022\014\n\004n"
  "ame\030\001 \001(\t\022\024\n\014active_count\030\002 \001(\005\022\023\n\013event"
  "_count\030\003 \001(\005\022\024\n\014wakeup_count\030\004 \001(\005\022\024\n\014ex"
  "pire_count\030\005 \001(\005\022\024\n\014active_since\030\006 \001(\003\022\022"
  "\n\ntotal_time\030\007 \001(\003\022\020\n\010max_time\030\010 \001(\003\022\023\n\013"
  "last_change\030\t \001(\003\022\034\n\024prevent_suspend_tim"
  "e\030\n \001(\003:\t\232\237\325\207\003\003\010\310\001:\t\232\237\325\207\003\003\010\310\001B\002P\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto_deps[1] = {
  &::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fprivacy_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto_sccs[2] = {
  &scc_info_KernelWakeSourcesProto_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto.base,
  &scc_info_KernelWakeSourcesProto_WakeupSource_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto_once;
static bool descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto = {
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto_initialized, descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto, "frameworks/base/core/proto/android/os/kernelwake.proto", 473,
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto_once, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto_sccs, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto_deps, 2, 1,
  schemas, file_default_instances, TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto::offsets,
  file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto, 2, file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto, file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fkernelwake_2eproto), true);
namespace android {
namespace os {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_name(), ptr, ctx, "android.os.KernelWakeSourcesProto.WakeupSource.name");
          CHK_(ptr);
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (10 & 0xFF)) {
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            "android.os.KernelWakeSourcesProto.WakeupSource.name");
        } else {
          goto handle_unusual;
        }
        break;
...
::PROTOBUF_NAMESPACE_ID::uint8* KernelWakeSourcesProto_WakeupSource::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:android.os.KernelWakeSourcesProto.WakeupSource)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional int32 event_count = 3;
  if (cached_has_bits & 0x00000004u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->event_count(), target);
  }

  // optional int32 wakeup_count = 4;
  if (cached_has_bits & 0x00000008u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->wakeup_count(), target);
  }

  // optional int32 expire_count = 5;
  if (cached_has_bits & 0x00000010u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(5, this->expire_count(), target);
  }

  // optional int64 active_since = 6;
  if (cached_has_bits & 0x00000020u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(6, this->active_since(), target);
  }

  // optional int64 total_time = 7;
  if (cached_has_bits & 0x00000040u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(7, this->total_time(), target);
  }

  // optional int64 max_time = 8;
  if (cached_has_bits & 0x00000080u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(8, this->max_time(), target);
  }

  // optional int64 last_change = 9;
  if (cached_has_bits & 0x00000100u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(9, this->last_change(), target);
  }

  // optional int64 prevent_suspend_time = 10;
  if (cached_has_bits & 0x00000200u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(10, this->prevent_suspend_time(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:android.os.KernelWakeSourcesProto.WakeupSource)
  return target;
}
...
void KernelWakeSourcesProto_WakeupSource::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:android.os.KernelWakeSourcesProto.WakeupSource)
  GOOGLE_DCHECK_NE(&from, this);
  const KernelWakeSourcesProto_WakeupSource* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<KernelWakeSourcesProto_WakeupSource>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:android.os.KernelWakeSourcesProto.WakeupSource)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:android.os.KernelWakeSourcesProto.WakeupSource)
    MergeFrom(*source);
  }
}
...
void KernelWakeSourcesProto_WakeupSource::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:android.os.KernelWakeSourcesProto.WakeupSource)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata KernelWakeSourcesProto_WakeupSource::GetMetadata() const {
...
::PROTOBUF_NAMESPACE_ID::uint8* KernelWakeSourcesProto::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:android.os.KernelWakeSourcesProto)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, this->wakeup_sources(static_cast<int>(i)), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:android.os.KernelWakeSourcesProto)
  return target;
}
...
void KernelWakeSourcesProto::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:android.os.KernelWakeSourcesProto)
  GOOGLE_DCHECK_NE(&from, this);
  const KernelWakeSourcesProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<KernelWakeSourcesProto>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:android.os.KernelWakeSourcesProto)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:android.os.KernelWakeSourcesProto)
    MergeFrom(*source);
  }
}
...
void KernelWakeSourcesProto::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:android.os.KernelWakeSourcesProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata KernelWakeSourcesProto::GetMetadata() const {
  return GetMetadataStatic();
}
