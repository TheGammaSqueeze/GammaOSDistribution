...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fhardware_2fsensorprivacy_2eproto;
namespace android {
namespace service {
...
inline const std::string& SensorPrivacyIndividualEnabledSensorProto_Sensor_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    SensorPrivacyIndividualEnabledSensorProto_Sensor_descriptor(), enum_t_value);
}
inline bool SensorPrivacyIndividualEnabledSensorProto_Sensor_Parse(
    const std::string& name, SensorPrivacyIndividualEnabledSensorProto_Sensor* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<SensorPrivacyIndividualEnabledSensorProto_Sensor>(
    SensorPrivacyIndividualEnabledSensorProto_Sensor_descriptor(), name, value);
}
...
inline const std::string& SensorPrivacyToggleSourceProto_Source_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    SensorPrivacyToggleSourceProto_Source_descriptor(), enum_t_value);
}
inline bool SensorPrivacyToggleSourceProto_Source_Parse(
    const std::string& name, SensorPrivacyToggleSourceProto_Source* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<SensorPrivacyToggleSourceProto_Source>(
    SensorPrivacyToggleSourceProto_Source_descriptor(), name, value);
}
// ===================================================================

class SensorPrivacyServiceDumpProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.SensorPrivacyServiceDumpProto) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fhardware_2fsensorprivacy_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class SensorPrivacyUserProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.SensorPrivacyUserProto) */ {
 public:
...
class SensorPrivacyIndividualEnabledSensorProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.SensorPrivacyIndividualEnabledSensorProto) */ {
 public:
  ...
  Sensor_descriptor() {
    return SensorPrivacyIndividualEnabledSensorProto_Sensor_descriptor();
  }
  template<typename T>
...
class SensorPrivacyToggleSourceProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.SensorPrivacyToggleSourceProto) */ {
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  Source_descriptor() {
    return SensorPrivacyToggleSourceProto_Source_descriptor();
  }
  template<typename T>
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::service::SensorPrivacyIndividualEnabledSensorProto_Sensor>() {
  return ::android::service::SensorPrivacyIndividualEnabledSensorProto_Sensor_descriptor();
}
template <> struct is_proto_enum< ::android::service::SensorPrivacyToggleSourceProto_Source> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::service::SensorPrivacyToggleSourceProto_Source>() {
  return ::android::service::SensorPrivacyToggleSourceProto_Source_descriptor();
}
