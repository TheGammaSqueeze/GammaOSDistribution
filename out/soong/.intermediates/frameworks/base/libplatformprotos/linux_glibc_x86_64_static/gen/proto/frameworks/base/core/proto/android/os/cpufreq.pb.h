...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto;
namespace android {
namespace os {
class CpuFreqProto;
...
class CpuFreqProto_Stats_TimeInState :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.os.CpuFreqProto.Stats.TimeInState) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto);
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class CpuFreqProto_Stats :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.os.CpuFreqProto.Stats) */ {
 public:
  CpuFreqProto_Stats();
...
class CpuFreqProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.os.CpuFreqProto) */ {
 public:
  CpuFreqProto();
