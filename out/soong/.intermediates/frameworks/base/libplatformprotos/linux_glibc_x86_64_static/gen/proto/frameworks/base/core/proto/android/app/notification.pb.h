...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto;
namespace android {
namespace app {
...
inline const std::string& NotificationProto_Visibility_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    NotificationProto_Visibility_descriptor(), enum_t_value);
}
inline bool NotificationProto_Visibility_Parse(
    const std::string& name, NotificationProto_Visibility* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<NotificationProto_Visibility>(
    NotificationProto_Visibility_descriptor(), name, value);
}
// ===================================================================

class NotificationProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.app.NotificationProto) */ {
 public:
  NotificationProto();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  Visibility_descriptor() {
    return NotificationProto_Visibility_descriptor();
  }
  template<typename T>
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::app::NotificationProto_Visibility>() {
  return ::android::app::NotificationProto_Visibility_descriptor();
}
