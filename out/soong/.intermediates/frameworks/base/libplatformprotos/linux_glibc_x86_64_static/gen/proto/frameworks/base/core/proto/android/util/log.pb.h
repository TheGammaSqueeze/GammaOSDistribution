...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2futil_2flog_2eproto;
namespace android {
namespace util {
...
inline const std::string& TextLogEntry_LogPriority_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    TextLogEntry_LogPriority_descriptor(), enum_t_value);
}
inline bool TextLogEntry_LogPriority_Parse(
    const std::string& name, TextLogEntry_LogPriority* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<TextLogEntry_LogPriority>(
    TextLogEntry_LogPriority_descriptor(), name, value);
}
...
inline const std::string& BinaryLogEntry_Elem_Type_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    BinaryLogEntry_Elem_Type_descriptor(), enum_t_value);
}
inline bool BinaryLogEntry_Elem_Type_Parse(
    const std::string& name, BinaryLogEntry_Elem_Type* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<BinaryLogEntry_Elem_Type>(
    BinaryLogEntry_Elem_Type_descriptor(), name, value);
}
// ===================================================================

class TextLogEntry :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.util.TextLogEntry) */ {
 public:
  TextLogEntry();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2futil_2flog_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  LogPriority_descriptor() {
    return TextLogEntry_LogPriority_descriptor();
  }
  template<typename T>
...
class BinaryLogEntry_Elem :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.util.BinaryLogEntry.Elem) */ {
 public:
  BinaryLogEntry_Elem();
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  Type_descriptor() {
    return BinaryLogEntry_Elem_Type_descriptor();
  }
  template<typename T>
...
class BinaryLogEntry :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.util.BinaryLogEntry) */ {
 public:
  BinaryLogEntry();
...
class LogProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.util.LogProto) */ {
 public:
  LogProto();
  virtual ~LogProto();
...
class PersistedLogProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.util.PersistedLogProto) */ {
 public:
  PersistedLogProto();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::util::TextLogEntry_LogPriority>() {
  return ::android::util::TextLogEntry_LogPriority_descriptor();
}
template <> struct is_proto_enum< ::android::util::BinaryLogEntry_Elem_Type> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::util::BinaryLogEntry_Elem_Type>() {
  return ::android::util::BinaryLogEntry_Elem_Type_descriptor();
}
