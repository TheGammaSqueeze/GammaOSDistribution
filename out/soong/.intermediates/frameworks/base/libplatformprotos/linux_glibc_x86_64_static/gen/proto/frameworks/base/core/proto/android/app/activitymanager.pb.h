...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2factivitymanager_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace android {
namespace app {
...
inline const std::string& UidObserverFlag_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    UidObserverFlag_descriptor(), enum_t_value);
}
inline bool UidObserverFlag_Parse(
    const std::string& name, UidObserverFlag* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<UidObserverFlag>(
    UidObserverFlag_descriptor(), name, value);
}
// ===================================================================
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::app::UidObserverFlag>() {
  return ::android::app::UidObserverFlag_descriptor();
}
