...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2falarmmanager_2eproto;
namespace android {
namespace app {
...
inline const std::string& AlarmManagerProto_AlarmType_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    AlarmManagerProto_AlarmType_descriptor(), enum_t_value);
}
inline bool AlarmManagerProto_AlarmType_Parse(
    const std::string& name, AlarmManagerProto_AlarmType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<AlarmManagerProto_AlarmType>(
    AlarmManagerProto_AlarmType_descriptor(), name, value);
}
// ===================================================================

class AlarmManagerProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.app.AlarmManagerProto) */ {
 public:
  AlarmManagerProto();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2falarmmanager_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  AlarmType_descriptor() {
    return AlarmManagerProto_AlarmType_descriptor();
  }
  template<typename T>
...
class AlarmClockInfoProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.app.AlarmClockInfoProto) */ {
 public:
  AlarmClockInfoProto();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::app::AlarmManagerProto_AlarmType>() {
  return ::android::app::AlarmManagerProto_AlarmType_descriptor();
}
