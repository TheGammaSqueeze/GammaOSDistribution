...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::android::view::InsetsSourceControlProto, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::android::view::InsetsSourceControlProto, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::android::view::InsetsSourceControlProto, type_),
  PROTOBUF_FIELD_OFFSET(::android::view::InsetsSourceControlProto, position_),
  PROTOBUF_FIELD_OFFSET(::android::view::InsetsSourceControlProto, leash_),
  0,
  1,
  2,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, sizeof(::android::view::InsetsSourceControlProto)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::android::view::_InsetsSourceControlProto_default_instance_),
};

const char descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\nAframeworks/base/core/proto/android/vie"
  "w/insetssourcecontrol.proto\022\014android.vie"
  "w\0327frameworks/base/core/proto/android/gr"
  "aphics/point.proto\032<frameworks/base/core"
  "/proto/android/view/surfacecontrol.proto"
  "\"\212\001\n\030InsetsSourceControlProto\022\014\n\004type\030\001 "
  "\001(\t\022.\n\010position\030\002 \001(\0132\034.android.graphics"
  ".PointProto\0220\n\005leash\030\003 \001(\0132!.android.vie"
  "w.SurfaceControlProtoB\002P\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto_deps[2] = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto_sccs[1] = {
  &scc_info_InsetsSourceControlProto_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto_once;
static bool descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto = {
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto_initialized, descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto, "frameworks/base/core/proto/android/view/insetssourcecontrol.proto", 345,
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto_once, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto_sccs, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto_deps, 1, 2,
  schemas, file_default_instances, TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto::offsets,
  file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto, 1, file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto, file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2finsetssourcecontrol_2eproto), true);
namespace android {
namespace view {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_type(), ptr, ctx, "android.view.InsetsSourceControlProto.type");
          CHK_(ptr);
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (10 & 0xFF)) {
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            "android.view.InsetsSourceControlProto.type");
        } else {
          goto handle_unusual;
        }
        break;
...
::PROTOBUF_NAMESPACE_ID::uint8* InsetsSourceControlProto::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:android.view.InsetsSourceControlProto)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:android.view.InsetsSourceControlProto)
  return target;
}
...
void InsetsSourceControlProto::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:android.view.InsetsSourceControlProto)
  GOOGLE_DCHECK_NE(&from, this);
  const InsetsSourceControlProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<InsetsSourceControlProto>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:android.view.InsetsSourceControlProto)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:android.view.InsetsSourceControlProto)
    MergeFrom(*source);
  }
}
...
void InsetsSourceControlProto::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:android.view.InsetsSourceControlProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata InsetsSourceControlProto::GetMetadata() const {
