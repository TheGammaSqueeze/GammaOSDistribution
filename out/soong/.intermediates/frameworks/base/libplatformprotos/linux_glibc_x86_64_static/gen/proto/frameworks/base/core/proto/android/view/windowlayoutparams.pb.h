...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2fwindowlayoutparams_2eproto;
namespace android {
namespace view {
...
inline const std::string& WindowLayoutParamsProto_RotationAnimation_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    WindowLayoutParamsProto_RotationAnimation_descriptor(), enum_t_value);
}
inline bool WindowLayoutParamsProto_RotationAnimation_Parse(
    const std::string& name, WindowLayoutParamsProto_RotationAnimation* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<WindowLayoutParamsProto_RotationAnimation>(
    WindowLayoutParamsProto_RotationAnimation_descriptor(), name, value);
}
// ===================================================================

class WindowLayoutParamsProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.view.WindowLayoutParamsProto) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2fwindowlayoutparams_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::view::WindowLayoutParamsProto_RotationAnimation>() {
  return ::android::view::WindowLayoutParamsProto_RotationAnimation_descriptor();
}
