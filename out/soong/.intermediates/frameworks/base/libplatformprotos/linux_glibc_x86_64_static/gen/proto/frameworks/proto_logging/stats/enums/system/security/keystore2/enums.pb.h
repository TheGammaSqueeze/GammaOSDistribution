...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fproto_5flogging_2fstats_2fenums_2fsystem_2fsecurity_2fkeystore2_2fenums_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace android {
namespace system {
...
inline const std::string& SecurityLevelEnum_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    SecurityLevelEnum_descriptor(), enum_t_value);
}
inline bool SecurityLevelEnum_Parse(
    const std::string& name, SecurityLevelEnum* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<SecurityLevelEnum>(
    SecurityLevelEnum_descriptor(), name, value);
}
enum Algorithm : int {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::system::security::keystore2::SecurityLevelEnum>() {
  return ::android::system::security::keystore2::SecurityLevelEnum_descriptor();
}
template <> struct is_proto_enum< ::android::system::security::keystore2::Algorithm> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::system::security::keystore2::Algorithm>() {
  return ::android::system::security::keystore2::Algorithm_descriptor();
}
