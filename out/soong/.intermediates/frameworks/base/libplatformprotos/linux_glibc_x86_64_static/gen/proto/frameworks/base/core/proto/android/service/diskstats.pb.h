...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fservice_2fdiskstats_2eproto;
namespace android {
namespace service {
namespace diskstats {
...
inline const std::string& DiskStatsServiceDumpProto_EncryptionType_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    DiskStatsServiceDumpProto_EncryptionType_descriptor(), enum_t_value);
}
inline bool DiskStatsServiceDumpProto_EncryptionType_Parse(
    const std::string& name, DiskStatsServiceDumpProto_EncryptionType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<DiskStatsServiceDumpProto_EncryptionType>(
    DiskStatsServiceDumpProto_EncryptionType_descriptor(), name, value);
}
...
inline const std::string& DiskStatsFreeSpaceProto_Folder_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    DiskStatsFreeSpaceProto_Folder_descriptor(), enum_t_value);
}
inline bool DiskStatsFreeSpaceProto_Folder_Parse(
    const std::string& name, DiskStatsFreeSpaceProto_Folder* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<DiskStatsFreeSpaceProto_Folder>(
    DiskStatsFreeSpaceProto_Folder_descriptor(), name, value);
}
// ===================================================================

class DiskStatsServiceDumpProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.diskstats.DiskStatsServiceDumpProto) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fservice_2fdiskstats_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  EncryptionType_descriptor() {
    return DiskStatsServiceDumpProto_EncryptionType_descriptor();
  }
  template<typename T>
...
class DiskStatsCachedValuesProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.diskstats.DiskStatsCachedValuesProto) */ {
 public:
...
class DiskStatsAppSizesProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.diskstats.DiskStatsAppSizesProto) */ {
 public:
...
class DiskStatsFreeSpaceProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.service.diskstats.DiskStatsFreeSpaceProto) */ {
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  Folder_descriptor() {
    return DiskStatsFreeSpaceProto_Folder_descriptor();
  }
  template<typename T>
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::service::diskstats::DiskStatsServiceDumpProto_EncryptionType>() {
  return ::android::service::diskstats::DiskStatsServiceDumpProto_EncryptionType_descriptor();
}
template <> struct is_proto_enum< ::android::service::diskstats::DiskStatsFreeSpaceProto_Folder> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::service::diskstats::DiskStatsFreeSpaceProto_Folder>() {
  return ::android::service::diskstats::DiskStatsFreeSpaceProto_Folder_descriptor();
}
