...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto[3];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages, uid_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages, package_name_),
  1,
  0,
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto_ExemptedPackage, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto_ExemptedPackage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto_ExemptedPackage, user_id_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto_ExemptedPackage, package_name_),
  1,
  0,
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, forced_app_standby_feature_enabled_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, force_all_apps_standby_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, active_uids_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, foreground_uids_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, power_save_exempt_app_ids_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, power_save_user_exempt_app_ids_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, temp_power_save_exempt_app_ids_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, run_any_in_background_restricted_packages_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, is_small_battery_device_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, force_all_apps_standby_for_small_battery_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, is_plugged_in_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, stats_),
  PROTOBUF_FIELD_OFFSET(::com::android::server::AppStateTrackerProto, exempted_bucket_packages_),
  1,
  2,
  ~0u,
  ~0u,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, sizeof(::com::android::server::AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages)},
  { 9, 16, sizeof(::com::android::server::AppStateTrackerProto_ExemptedPackage)},
  { 18, 36, sizeof(::com::android::server::AppStateTrackerProto)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::com::android::server::_AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::com::android::server::_AppStateTrackerProto_ExemptedPackage_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::com::android::server::_AppStateTrackerProto_default_instance_),
};

const char descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\?frameworks/base/core/proto/android/ser"
  "ver/appstatetracker.proto\022\022com.android.s"
  "erver\032:frameworks/base/core/proto/androi"
  "d/server/statlogger.proto\0320frameworks/ba"
  "se/core/proto/android/privacy.proto\"\246\006\n\024"
  "AppStateTrackerProto\022*\n\"forced_app_stand"
  "by_feature_enabled\030\r \001(\010\022\036\n\026force_all_ap"
  "ps_standby\030\001 \001(\010\022\023\n\013active_uids\030\002 \003(\005\022\027\n"
  "\017foreground_uids\030\013 \003(\005\022!\n\031power_save_exe"
  "mpt_app_ids\030\003 \003(\005\022&\n\036power_save_user_exe"
  "mpt_app_ids\030\014 \003(\005\022&\n\036temp_power_save_exe"
  "mpt_app_ids\030\004 \003(\005\022\200\001\n)run_any_in_backgro"
  "und_restricted_packages\030\005 \003(\0132M.com.andr"
  "oid.server.AppStateTrackerProto.RunAnyIn"
  "BackgroundRestrictedPackages\022\037\n\027is_small"
  "_battery_device\030\006 \001(\010\0220\n(force_all_apps_"
  "standby_for_small_battery\030\007 \001(\010\022\025\n\ris_pl"
  "ugged_in\030\010 \001(\010\0222\n\005stats\030\t \001(\0132#.com.andr"
  "oid.server.StatLoggerProto\022Z\n\030exempted_b"
  "ucket_packages\030\n \003(\01328.com.android.serve"
  "r.AppStateTrackerProto.ExemptedPackage\032T"
  "\n$RunAnyInBackgroundRestrictedPackages\022\013"
  "\n\003uid\030\001 \001(\005\022\024\n\014package_name\030\002 \001(\t:\t\232\237\325\207\003"
  "\003\010\310\001\032C\n\017ExemptedPackage\022\017\n\007user_id\030\001 \001(\005"
  "\022\024\n\014package_name\030\002 \001(\t:\t\232\237\325\207\003\003\010\310\001:\t\232\237\325\207\003"
  "\003\010\310\001B\002P\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto_deps[2] = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto_sccs[3] = {
  &scc_info_AppStateTrackerProto_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto.base,
  &scc_info_AppStateTrackerProto_ExemptedPackage_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto.base,
  &scc_info_AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto_once;
static bool descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto = {
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto_initialized, descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto, "frameworks/base/core/proto/android/server/appstatetracker.proto", 1008,
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto_once, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto_sccs, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto_deps, 3, 2,
  schemas, file_default_instances, TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto::offsets,
  file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto, 3, file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto, file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fappstatetracker_2eproto), true);
namespace com {
namespace android {
namespace server {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_package_name(), ptr, ctx, "com.android.server.AppStateTrackerProto.RunAnyInBackgroundRestrictedPackages.package_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
      ...
      case 2: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (18 & 0xFF)) {
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            "com.android.server.AppStateTrackerProto.RunAnyInBackgroundRestrictedPackages.package_name");
        } else {
          goto handle_unusual;
        }
        break;
...
::PROTOBUF_NAMESPACE_ID::uint8* AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:com.android.server.AppStateTrackerProto.RunAnyInBackgroundRestrictedPackages)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:com.android.server.AppStateTrackerProto.RunAnyInBackgroundRestrictedPackages)
  return target;
}
...
void AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:com.android.server.AppStateTrackerProto.RunAnyInBackgroundRestrictedPackages)
  GOOGLE_DCHECK_NE(&from, this);
  const AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:com.android.server.AppStateTrackerProto.RunAnyInBackgroundRestrictedPackages)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:com.android.server.AppStateTrackerProto.RunAnyInBackgroundRestrictedPackages)
    MergeFrom(*source);
  }
}
...
void AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:com.android.server.AppStateTrackerProto.RunAnyInBackgroundRestrictedPackages)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata AppStateTrackerProto_RunAnyInBackgroundRestrictedPackages::GetMetadata() const {
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_package_name(), ptr, ctx, "com.android.server.AppStateTrackerProto.ExemptedPackage.package_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
      ...
      case 2: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (18 & 0xFF)) {
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            this->package_name().data(), static_cast<int>(this->package_name().length()),
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::PARSE,
            "com.android.server.AppStateTrackerProto.ExemptedPackage.package_name");
        } else {
          goto handle_unusual;
        }
        break;
...
::PROTOBUF_NAMESPACE_ID::uint8* AppStateTrackerProto_ExemptedPackage::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:com.android.server.AppStateTrackerProto.ExemptedPackage)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:com.android.server.AppStateTrackerProto.ExemptedPackage)
  return target;
}
...
void AppStateTrackerProto_ExemptedPackage::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:com.android.server.AppStateTrackerProto.ExemptedPackage)
  GOOGLE_DCHECK_NE(&from, this);
  const AppStateTrackerProto_ExemptedPackage* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<AppStateTrackerProto_ExemptedPackage>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:com.android.server.AppStateTrackerProto.ExemptedPackage)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:com.android.server.AppStateTrackerProto.ExemptedPackage)
    MergeFrom(*source);
  }
}
...
void AppStateTrackerProto_ExemptedPackage::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:com.android.server.AppStateTrackerProto.ExemptedPackage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata AppStateTrackerProto_ExemptedPackage::GetMetadata() const {
  return GetMetadataStatic();
}
...
::PROTOBUF_NAMESPACE_ID::uint8* AppStateTrackerProto::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:com.android.server.AppStateTrackerProto)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional bool force_all_apps_standby = 1;
  if (cached_has_bits & 0x00000004u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(1, this->force_all_apps_standby(), target);
  }

  // repeated int32 active_uids = 2;
  target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
    WriteInt32ToArray(2, this->active_uids_, target);

  // repeated int32 power_save_exempt_app_ids = 3;
  target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
    WriteInt32ToArray(3, this->power_save_exempt_app_ids_, target);

  // repeated int32 temp_power_save_exempt_app_ids = 4;
  target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
    WriteInt32ToArray(4, this->temp_power_save_exempt_app_ids_, target);
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        5, this->run_any_in_background_restricted_packages(static_cast<int>(i)), target);
  }

  // optional bool is_small_battery_device = 6;
  if (cached_has_bits & 0x00000008u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(6, this->is_small_battery_device(), target);
  }

  // optional bool force_all_apps_standby_for_small_battery = 7;
  if (cached_has_bits & 0x00000010u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(7, this->force_all_apps_standby_for_small_battery(), target);
  }

  // optional bool is_plugged_in = 8;
  if (cached_has_bits & 0x00000020u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(8, this->is_plugged_in(), target);
  }
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        10, this->exempted_bucket_packages(static_cast<int>(i)), target);
  }

  // repeated int32 foreground_uids = 11;
  target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
    WriteInt32ToArray(11, this->foreground_uids_, target);

  // repeated int32 power_save_user_exempt_app_ids = 12;
  target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
    WriteInt32ToArray(12, this->power_save_user_exempt_app_ids_, target);

  // optional bool forced_app_standby_feature_enabled = 13;
  if (cached_has_bits & 0x00000002u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(13, this->forced_app_standby_feature_enabled(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:com.android.server.AppStateTrackerProto)
  return target;
}
...
void AppStateTrackerProto::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:com.android.server.AppStateTrackerProto)
  GOOGLE_DCHECK_NE(&from, this);
  const AppStateTrackerProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<AppStateTrackerProto>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:com.android.server.AppStateTrackerProto)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:com.android.server.AppStateTrackerProto)
    MergeFrom(*source);
  }
}
...
void AppStateTrackerProto::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:com.android.server.AppStateTrackerProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata AppStateTrackerProto::GetMetadata() const {
  return GetMetadataStatic();
}
