...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fnfc_2fnfc_5fservice_2eproto;
namespace com {
namespace android {
namespace nfc {
...
inline const std::string& NfcServiceDumpProto_State_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    NfcServiceDumpProto_State_descriptor(), enum_t_value);
}
inline bool NfcServiceDumpProto_State_Parse(
    const std::string& name, NfcServiceDumpProto_State* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<NfcServiceDumpProto_State>(
    NfcServiceDumpProto_State_descriptor(), name, value);
}
...
inline const std::string& NfcServiceDumpProto_ScreenState_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    NfcServiceDumpProto_ScreenState_descriptor(), enum_t_value);
}
inline bool NfcServiceDumpProto_ScreenState_Parse(
    const std::string& name, NfcServiceDumpProto_ScreenState* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<NfcServiceDumpProto_ScreenState>(
    NfcServiceDumpProto_ScreenState_descriptor(), name, value);
}
...
inline const std::string& P2pLinkManagerProto_LinkState_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    P2pLinkManagerProto_LinkState_descriptor(), enum_t_value);
}
inline bool P2pLinkManagerProto_LinkState_Parse(
    const std::string& name, P2pLinkManagerProto_LinkState* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<P2pLinkManagerProto_LinkState>(
    P2pLinkManagerProto_LinkState_descriptor(), name, value);
}
...
inline const std::string& P2pLinkManagerProto_SendState_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    P2pLinkManagerProto_SendState_descriptor(), enum_t_value);
}
inline bool P2pLinkManagerProto_SendState_Parse(
    const std::string& name, P2pLinkManagerProto_SendState* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<P2pLinkManagerProto_SendState>(
    P2pLinkManagerProto_SendState_descriptor(), name, value);
}
// ===================================================================

class NfcServiceDumpProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.nfc.NfcServiceDumpProto) */ {
 public:
  NfcServiceDumpProto();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fnfc_2fnfc_5fservice_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  State_descriptor() {
    return NfcServiceDumpProto_State_descriptor();
  }
  template<typename T>
  ...
  ScreenState_descriptor() {
    return NfcServiceDumpProto_ScreenState_descriptor();
  }
  template<typename T>
...
class DiscoveryParamsProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.nfc.DiscoveryParamsProto) */ {
 public:
...
class P2pLinkManagerProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.nfc.P2pLinkManagerProto) */ {
 public:
  P2pLinkManagerProto();
  ...
  LinkState_descriptor() {
    return P2pLinkManagerProto_LinkState_descriptor();
  }
  template<typename T>
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  SendState_descriptor() {
    return P2pLinkManagerProto_SendState_descriptor();
  }
  template<typename T>
...
class NfcDispatcherProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.nfc.NfcDispatcherProto) */ {
 public:
  NfcDispatcherProto();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::android::nfc::NfcServiceDumpProto_State>() {
  return ::com::android::nfc::NfcServiceDumpProto_State_descriptor();
}
template <> struct is_proto_enum< ::com::android::nfc::NfcServiceDumpProto_ScreenState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::android::nfc::NfcServiceDumpProto_ScreenState>() {
  return ::com::android::nfc::NfcServiceDumpProto_ScreenState_descriptor();
}
template <> struct is_proto_enum< ::com::android::nfc::P2pLinkManagerProto_LinkState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::android::nfc::P2pLinkManagerProto_LinkState>() {
  return ::com::android::nfc::P2pLinkManagerProto_LinkState_descriptor();
}
template <> struct is_proto_enum< ::com::android::nfc::P2pLinkManagerProto_SendState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::android::nfc::P2pLinkManagerProto_SendState>() {
  return ::com::android::nfc::P2pLinkManagerProto_SendState_descriptor();
}
