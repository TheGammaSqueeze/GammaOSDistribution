...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2faccessibilitytrace_2eproto;
namespace com {
namespace android {
namespace server {
...
inline const std::string& AccessibilityTraceFileProto_MagicNumber_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    AccessibilityTraceFileProto_MagicNumber_descriptor(), enum_t_value);
}
inline bool AccessibilityTraceFileProto_MagicNumber_Parse(
    const std::string& name, AccessibilityTraceFileProto_MagicNumber* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<AccessibilityTraceFileProto_MagicNumber>(
    AccessibilityTraceFileProto_MagicNumber_descriptor(), name, value);
}
// ===================================================================

class AccessibilityTraceFileProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.server.accessibility.AccessibilityTraceFileProto) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2faccessibilitytrace_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  MagicNumber_descriptor() {
    return AccessibilityTraceFileProto_MagicNumber_descriptor();
  }
  template<typename T>
...
class AccessibilityTraceProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.server.accessibility.AccessibilityTraceProto) */ {
 public:
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::android::server::accessibility::AccessibilityTraceFileProto_MagicNumber>() {
  return ::com::android::server::accessibility::AccessibilityTraceFileProto_MagicNumber_descriptor();
}
