...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fcontent_2fintent_2eproto;
namespace android {
namespace content {
...
inline const std::string& IntentProto_DockState_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    IntentProto_DockState_descriptor(), enum_t_value);
}
inline bool IntentProto_DockState_Parse(
    const std::string& name, IntentProto_DockState* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<IntentProto_DockState>(
    IntentProto_DockState_descriptor(), name, value);
}
// ===================================================================

class IntentProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.content.IntentProto) */ {
 public:
  IntentProto();
  virtual ~IntentProto();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fcontent_2fintent_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  DockState_descriptor() {
    return IntentProto_DockState_descriptor();
  }
  template<typename T>
...
class IntentFilterProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.content.IntentFilterProto) */ {
 public:
  IntentFilterProto();
...
class AuthorityEntryProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.content.AuthorityEntryProto) */ {
 public:
  AuthorityEntryProto();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::content::IntentProto_DockState>() {
  return ::android::content::IntentProto_DockState_descriptor();
}
