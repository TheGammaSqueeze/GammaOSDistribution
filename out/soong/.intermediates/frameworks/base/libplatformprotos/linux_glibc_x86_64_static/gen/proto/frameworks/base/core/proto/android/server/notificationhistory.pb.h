...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fnotificationhistory_2eproto;
namespace com {
namespace android {
namespace server {
...
inline const std::string& NotificationHistoryProto_Notification_ImageTypeEnum_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    NotificationHistoryProto_Notification_ImageTypeEnum_descriptor(), enum_t_value);
}
inline bool NotificationHistoryProto_Notification_ImageTypeEnum_Parse(
    const std::string& name, NotificationHistoryProto_Notification_ImageTypeEnum* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<NotificationHistoryProto_Notification_ImageTypeEnum>(
    NotificationHistoryProto_Notification_ImageTypeEnum_descriptor(), name, value);
}
// ===================================================================

class NotificationHistoryProto_StringPool :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.server.notification.NotificationHistoryProto.StringPool) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fserver_2fnotificationhistory_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class NotificationHistoryProto_Notification_Icon :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.server.notification.NotificationHistoryProto.Notification.Icon) */ {
 public:
...
class NotificationHistoryProto_Notification :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.server.notification.NotificationHistoryProto.Notification) */ {
 public:
  ...
  ImageTypeEnum_descriptor() {
    return NotificationHistoryProto_Notification_ImageTypeEnum_descriptor();
  }
  template<typename T>
...
class NotificationHistoryProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.server.notification.NotificationHistoryProto) */ {
 public:
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::android::server::notification::NotificationHistoryProto_Notification_ImageTypeEnum>() {
  return ::com::android::server::notification::NotificationHistoryProto_Notification_ImageTypeEnum_descriptor();
}
