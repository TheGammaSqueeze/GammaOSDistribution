...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2ftime_5fzone_5fdetector_2eproto;
namespace android {
namespace app {
namespace time {
...
inline const std::string& MetricsTimeZoneSuggestion_Type_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    MetricsTimeZoneSuggestion_Type_descriptor(), enum_t_value);
}
inline bool MetricsTimeZoneSuggestion_Type_Parse(
    const std::string& name, MetricsTimeZoneSuggestion_Type* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<MetricsTimeZoneSuggestion_Type>(
    MetricsTimeZoneSuggestion_Type_descriptor(), name, value);
}
// ===================================================================

class GeolocationTimeZoneSuggestionProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.app.time.GeolocationTimeZoneSuggestionProto) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2ftime_5fzone_5fdetector_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class MetricsTimeZoneSuggestion :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.app.time.MetricsTimeZoneSuggestion) */ {
 public:
  ...
  Type_descriptor() {
    return MetricsTimeZoneSuggestion_Type_descriptor();
  }
  template<typename T>
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::app::time::MetricsTimeZoneSuggestion_Type>() {
  return ::android::app::time::MetricsTimeZoneSuggestion_Type_descriptor();
}
