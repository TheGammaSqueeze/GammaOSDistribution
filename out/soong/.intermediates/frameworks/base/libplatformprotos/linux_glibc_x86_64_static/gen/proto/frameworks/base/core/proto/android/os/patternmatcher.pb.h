...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fpatternmatcher_2eproto;
namespace android {
namespace os {
...
inline const std::string& PatternMatcherProto_Type_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    PatternMatcherProto_Type_descriptor(), enum_t_value);
}
inline bool PatternMatcherProto_Type_Parse(
    const std::string& name, PatternMatcherProto_Type* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<PatternMatcherProto_Type>(
    PatternMatcherProto_Type_descriptor(), name, value);
}
// ===================================================================

class PatternMatcherProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.os.PatternMatcherProto) */ {
 public:
  PatternMatcherProto();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fpatternmatcher_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  Type_descriptor() {
    return PatternMatcherProto_Type_descriptor();
  }
  template<typename T>
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::os::PatternMatcherProto_Type>() {
  return ::android::os::PatternMatcherProto_Type_descriptor();
}
