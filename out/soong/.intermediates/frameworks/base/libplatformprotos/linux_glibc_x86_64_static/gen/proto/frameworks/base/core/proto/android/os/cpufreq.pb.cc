...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto[3];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto_Stats_TimeInState, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto_Stats_TimeInState, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto_Stats_TimeInState, state_khz_),
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto_Stats_TimeInState, time_jiffy_),
  1,
  0,
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto_Stats, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto_Stats, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto_Stats, cpu_name_),
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto_Stats, times_),
  0,
  ~0u,
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto, jiffy_hz_),
  PROTOBUF_FIELD_OFFSET(::android::os::CpuFreqProto, cpu_freqs_),
  0,
  ~0u,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, sizeof(::android::os::CpuFreqProto_Stats_TimeInState)},
  { 9, 16, sizeof(::android::os::CpuFreqProto_Stats)},
  { 18, 25, sizeof(::android::os::CpuFreqProto)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::android::os::_CpuFreqProto_Stats_TimeInState_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::android::os::_CpuFreqProto_Stats_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::android::os::_CpuFreqProto_default_instance_),
};

const char descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n3frameworks/base/core/proto/android/os/"
  "cpufreq.proto\022\nandroid.os\0320frameworks/ba"
  "se/core/proto/android/privacy.proto\"\201\002\n\014"
  "CpuFreqProto\022\020\n\010jiffy_hz\030\001 \001(\005\0221\n\tcpu_fr"
  "eqs\030\002 \003(\0132\036.android.os.CpuFreqProto.Stat"
  "s\032\240\001\n\005Stats\022\020\n\010cpu_name\030\001 \001(\t\0229\n\005times\030\002"
  " \003(\0132*.android.os.CpuFreqProto.Stats.Tim"
  "eInState\032\?\n\013TimeInState\022\021\n\tstate_khz\030\001 \001"
  "(\005\022\022\n\ntime_jiffy\030\002 \001(\003:\t\232\237\325\207\003\003\010\310\001:\t\232\237\325\207\003"
  "\003\010\310\001:\t\232\237\325\207\003\003\010\310\001B\002P\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto_deps[1] = {
  &::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fprivacy_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto_sccs[3] = {
  &scc_info_CpuFreqProto_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto.base,
  &scc_info_CpuFreqProto_Stats_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto.base,
  &scc_info_CpuFreqProto_Stats_TimeInState_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto_once;
static bool descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto = {
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto_initialized, descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto, "frameworks/base/core/proto/android/os/cpufreq.proto", 379,
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto_once, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto_sccs, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto_deps, 3, 1,
  schemas, file_default_instances, TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto::offsets,
  file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto, 3, file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto, file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fcpufreq_2eproto), true);
namespace android {
namespace os {
...
::PROTOBUF_NAMESPACE_ID::uint8* CpuFreqProto_Stats_TimeInState::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:android.os.CpuFreqProto.Stats.TimeInState)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional int32 state_khz = 1;
  if (cached_has_bits & 0x00000002u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->state_khz(), target);
  }

  // optional int64 time_jiffy = 2;
  if (cached_has_bits & 0x00000001u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(2, this->time_jiffy(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:android.os.CpuFreqProto.Stats.TimeInState)
  return target;
}
...
void CpuFreqProto_Stats_TimeInState::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:android.os.CpuFreqProto.Stats.TimeInState)
  GOOGLE_DCHECK_NE(&from, this);
  const CpuFreqProto_Stats_TimeInState* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<CpuFreqProto_Stats_TimeInState>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:android.os.CpuFreqProto.Stats.TimeInState)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:android.os.CpuFreqProto.Stats.TimeInState)
    MergeFrom(*source);
  }
}
...
void CpuFreqProto_Stats_TimeInState::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:android.os.CpuFreqProto.Stats.TimeInState)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata CpuFreqProto_Stats_TimeInState::GetMetadata() const {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_cpu_name(), ptr, ctx, "android.os.CpuFreqProto.Stats.cpu_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (10 & 0xFF)) {
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            this->cpu_name().data(), static_cast<int>(this->cpu_name().length()),
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::PARSE,
            "android.os.CpuFreqProto.Stats.cpu_name");
        } else {
          goto handle_unusual;
        }
        break;
...
::PROTOBUF_NAMESPACE_ID::uint8* CpuFreqProto_Stats::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:android.os.CpuFreqProto.Stats)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, this->times(static_cast<int>(i)), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:android.os.CpuFreqProto.Stats)
  return target;
}
...
void CpuFreqProto_Stats::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:android.os.CpuFreqProto.Stats)
  GOOGLE_DCHECK_NE(&from, this);
  const CpuFreqProto_Stats* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<CpuFreqProto_Stats>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:android.os.CpuFreqProto.Stats)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:android.os.CpuFreqProto.Stats)
    MergeFrom(*source);
  }
}
...
void CpuFreqProto_Stats::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:android.os.CpuFreqProto.Stats)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata CpuFreqProto_Stats::GetMetadata() const {
  return GetMetadataStatic();
}
...
::PROTOBUF_NAMESPACE_ID::uint8* CpuFreqProto::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:android.os.CpuFreqProto)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional int32 jiffy_hz = 1;
  if (cached_has_bits & 0x00000001u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->jiffy_hz(), target);
  }
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, this->cpu_freqs(static_cast<int>(i)), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:android.os.CpuFreqProto)
  return target;
}
...
void CpuFreqProto::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:android.os.CpuFreqProto)
  GOOGLE_DCHECK_NE(&from, this);
  const CpuFreqProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<CpuFreqProto>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:android.os.CpuFreqProto)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:android.os.CpuFreqProto)
    MergeFrom(*source);
  }
}
...
void CpuFreqProto::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:android.os.CpuFreqProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata CpuFreqProto::GetMetadata() const {
  return GetMetadataStatic();
}
