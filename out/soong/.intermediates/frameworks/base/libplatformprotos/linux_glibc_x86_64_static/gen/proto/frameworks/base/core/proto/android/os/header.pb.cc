...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::android::os::IncidentHeaderProto_StatsdConfigKey, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::android::os::IncidentHeaderProto_StatsdConfigKey, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::android::os::IncidentHeaderProto_StatsdConfigKey, uid_),
  PROTOBUF_FIELD_OFFSET(::android::os::IncidentHeaderProto_StatsdConfigKey, id_),
  1,
  0,
  PROTOBUF_FIELD_OFFSET(::android::os::IncidentHeaderProto, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::android::os::IncidentHeaderProto, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::android::os::IncidentHeaderProto, alert_id_),
  PROTOBUF_FIELD_OFFSET(::android::os::IncidentHeaderProto, reason_),
  PROTOBUF_FIELD_OFFSET(::android::os::IncidentHeaderProto, config_key_),
  PROTOBUF_FIELD_OFFSET(::android::os::IncidentHeaderProto, trigger_details_),
  3,
  0,
  2,
  1,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, sizeof(::android::os::IncidentHeaderProto_StatsdConfigKey)},
  { 9, 18, sizeof(::android::os::IncidentHeaderProto)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::android::os::_IncidentHeaderProto_StatsdConfigKey_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::android::os::_IncidentHeaderProto_default_instance_),
};

const char descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n2frameworks/base/core/proto/android/os/"
  "header.proto\022\nandroid.os\"\301\001\n\023IncidentHea"
  "derProto\022\020\n\010alert_id\030\001 \001(\003\022\016\n\006reason\030\002 \001"
  "(\t\022C\n\nconfig_key\030\003 \001(\0132/.android.os.Inci"
  "dentHeaderProto.StatsdConfigKey\022\027\n\017trigg"
  "er_details\030\004 \001(\014\032*\n\017StatsdConfigKey\022\013\n\003u"
  "id\030\001 \001(\005\022\n\n\002id\030\002 \001(\003B\002P\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto_sccs[2] = {
  &scc_info_IncidentHeaderProto_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto.base,
  &scc_info_IncidentHeaderProto_StatsdConfigKey_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto_once;
static bool descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto = {
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto_initialized, descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto, "frameworks/base/core/proto/android/os/header.proto", 264,
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto_once, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto_sccs, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto::offsets,
  file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto, 2, file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto, file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fheader_2eproto), true);
namespace android {
namespace os {
...
::PROTOBUF_NAMESPACE_ID::uint8* IncidentHeaderProto_StatsdConfigKey::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:android.os.IncidentHeaderProto.StatsdConfigKey)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:android.os.IncidentHeaderProto.StatsdConfigKey)
  return target;
}
...
void IncidentHeaderProto_StatsdConfigKey::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:android.os.IncidentHeaderProto.StatsdConfigKey)
  GOOGLE_DCHECK_NE(&from, this);
  const IncidentHeaderProto_StatsdConfigKey* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<IncidentHeaderProto_StatsdConfigKey>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:android.os.IncidentHeaderProto.StatsdConfigKey)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:android.os.IncidentHeaderProto.StatsdConfigKey)
    MergeFrom(*source);
  }
}
...
void IncidentHeaderProto_StatsdConfigKey::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:android.os.IncidentHeaderProto.StatsdConfigKey)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata IncidentHeaderProto_StatsdConfigKey::GetMetadata() const {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_reason(), ptr, ctx, "android.os.IncidentHeaderProto.reason");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 2: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (18 & 0xFF)) {
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            "android.os.IncidentHeaderProto.reason");
        } else {
          goto handle_unusual;
        }
        break;
...
::PROTOBUF_NAMESPACE_ID::uint8* IncidentHeaderProto::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:android.os.IncidentHeaderProto)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional int64 alert_id = 1;
  if (cached_has_bits & 0x00000008u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(1, this->alert_id(), target);
  }
  ...
  if (cached_has_bits & 0x00000004u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, _Internal::config_key(this), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:android.os.IncidentHeaderProto)
  return target;
}
...
void IncidentHeaderProto::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:android.os.IncidentHeaderProto)
  GOOGLE_DCHECK_NE(&from, this);
  const IncidentHeaderProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<IncidentHeaderProto>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:android.os.IncidentHeaderProto)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:android.os.IncidentHeaderProto)
    MergeFrom(*source);
  }
}
...
void IncidentHeaderProto::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:android.os.IncidentHeaderProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata IncidentHeaderProto::GetMetadata() const {
  return GetMetadataStatic();
}
