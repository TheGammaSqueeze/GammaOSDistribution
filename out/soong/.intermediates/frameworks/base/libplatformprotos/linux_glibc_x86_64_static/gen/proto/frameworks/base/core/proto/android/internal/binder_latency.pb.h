...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2finternal_2fbinder_5flatency_2eproto;
namespace com {
namespace android {
namespace internal {
namespace os {
...
inline const std::string& Dims_ProcessSource_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    Dims_ProcessSource_descriptor(), enum_t_value);
}
inline bool Dims_ProcessSource_Parse(
    const std::string& name, Dims_ProcessSource* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<Dims_ProcessSource>(
    Dims_ProcessSource_descriptor(), name, value);
}
...
inline const std::string& Dims_ServiceClassName_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    Dims_ServiceClassName_descriptor(), enum_t_value);
}
inline bool Dims_ServiceClassName_Parse(
    const std::string& name, Dims_ServiceClassName* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<Dims_ServiceClassName>(
    Dims_ServiceClassName_descriptor(), name, value);
}
...
inline const std::string& Dims_ServiceMethodName_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    Dims_ServiceMethodName_descriptor(), enum_t_value);
}
inline bool Dims_ServiceMethodName_Parse(
    const std::string& name, Dims_ServiceMethodName* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<Dims_ServiceMethodName>(
    Dims_ServiceMethodName_descriptor(), name, value);
}
// ===================================================================

class RepeatedApiStats :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.internal.os.RepeatedApiStats) */ {
 public:
  RepeatedApiStats();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2finternal_2fbinder_5flatency_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class Dims :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.internal.os.Dims) */ {
 public:
  Dims();
  virtual ~Dims();
  ...
  ProcessSource_descriptor() {
    return Dims_ProcessSource_descriptor();
  }
  template<typename T>
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  ServiceClassName_descriptor() {
    return Dims_ServiceClassName_descriptor();
  }
  template<typename T>
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  ServiceMethodName_descriptor() {
    return Dims_ServiceMethodName_descriptor();
  }
  template<typename T>
...
class ApiStats :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.android.internal.os.ApiStats) */ {
 public:
  ApiStats();
  virtual ~ApiStats();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::android::internal::os::Dims_ProcessSource>() {
  return ::com::android::internal::os::Dims_ProcessSource_descriptor();
}
template <> struct is_proto_enum< ::com::android::internal::os::Dims_ServiceClassName> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::android::internal::os::Dims_ServiceClassName>() {
  return ::com::android::internal::os::Dims_ServiceClassName_descriptor();
}
template <> struct is_proto_enum< ::com::android::internal::os::Dims_ServiceMethodName> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::android::internal::os::Dims_ServiceMethodName>() {
  return ::com::android::internal::os::Dims_ServiceMethodName_descriptor();
}
