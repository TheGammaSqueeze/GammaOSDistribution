...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2fdisplay_2eproto;
namespace android {
namespace view {
class DisplayProto;
...
inline const std::string& DisplayProto_ColorMode_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    DisplayProto_ColorMode_descriptor(), enum_t_value);
}
inline bool DisplayProto_ColorMode_Parse(
    const std::string& name, DisplayProto_ColorMode* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<DisplayProto_ColorMode>(
    DisplayProto_ColorMode_descriptor(), name, value);
}
// ===================================================================

class DisplayProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.view.DisplayProto) */ {
 public:
  DisplayProto();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fview_2fdisplay_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ColorMode_descriptor() {
    return DisplayProto_ColorMode_descriptor();
  }
  template<typename T>
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::view::DisplayProto_ColorMode>() {
  return ::android::view::DisplayProto_ColorMode_descriptor();
}
