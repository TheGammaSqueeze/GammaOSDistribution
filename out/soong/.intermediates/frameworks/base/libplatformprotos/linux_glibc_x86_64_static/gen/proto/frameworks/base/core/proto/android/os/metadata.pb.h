...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fmetadata_2eproto;
namespace android {
namespace os {
...
inline const std::string& IncidentMetadata_Destination_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    IncidentMetadata_Destination_descriptor(), enum_t_value);
}
inline bool IncidentMetadata_Destination_Parse(
    const std::string& name, IncidentMetadata_Destination* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<IncidentMetadata_Destination>(
    IncidentMetadata_Destination_descriptor(), name, value);
}
// ===================================================================

class IncidentMetadata_SectionStats :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.os.IncidentMetadata.SectionStats) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fos_2fmetadata_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class IncidentMetadata :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.os.IncidentMetadata) */ {
 public:
  IncidentMetadata();
  ...
  Destination_descriptor() {
    return IncidentMetadata_Destination_descriptor();
  }
  template<typename T>
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::os::IncidentMetadata_Destination>() {
  return ::android::os::IncidentMetadata_Destination_descriptor();
}
