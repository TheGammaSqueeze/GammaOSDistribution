...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fprivacy_2eproto;
namespace android {
class PrivacyFlags;
...
inline const std::string& Destination_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    Destination_descriptor(), enum_t_value);
}
inline bool Destination_Parse(
    const std::string& name, Destination* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<Destination>(
    Destination_descriptor(), name, value);
}
// ===================================================================

class PrivacyFlags :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.PrivacyFlags) */ {
 public:
  PrivacyFlags();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fprivacy_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::Destination>() {
  return ::android::Destination_descriptor();
}
