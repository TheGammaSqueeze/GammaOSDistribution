...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto[1];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, channel_id_),
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, has_ticker_text_),
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, flags_),
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, color_),
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, category_),
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, group_key_),
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, sort_key_),
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, action_length_),
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, visibility_),
  PROTOBUF_FIELD_OFFSET(::android::app::NotificationProto, public_version_),
  0,
  5,
  6,
  7,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 15, sizeof(::android::app::NotificationProto)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::android::app::_NotificationProto_default_instance_),
};

const char descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n9frameworks/base/core/proto/android/app"
  "/notification.proto\022\013android.app\0320framew"
  "orks/base/core/proto/android/privacy.pro"
  "to\"\263\003\n\021NotificationProto\022\034\n\nchannel_id\030\001"
  " \001(\tB\010\232\237\325\207\003\002\010d\022\027\n\017has_ticker_text\030\002 \001(\010\022"
  "\r\n\005flags\030\003 \001(\005\022\r\n\005color\030\004 \001(\005\022\032\n\010categor"
  "y\030\005 \001(\tB\010\232\237\325\207\003\002\010d\022\033\n\tgroup_key\030\006 \001(\tB\010\232\237"
  "\325\207\003\002\010d\022\032\n\010sort_key\030\007 \001(\tB\010\232\237\325\207\003\002\010d\022\025\n\rac"
  "tion_length\030\010 \001(\005\022=\n\nvisibility\030\t \001(\0162)."
  "android.app.NotificationProto.Visibility"
  "\0226\n\016public_version\030\n \001(\0132\036.android.app.N"
  "otificationProto\"[\n\nVisibility\022\036\n\021VISIBI"
  "LITY_SECRET\020\377\377\377\377\377\377\377\377\377\001\022\026\n\022VISIBILITY_PRI"
  "VATE\020\000\022\025\n\021VISIBILITY_PUBLIC\020\001:\t\232\237\325\207\003\003\010\310\001"
  "B\002P\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto_deps[1] = {
  &::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fprivacy_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto_sccs[1] = {
  &scc_info_NotificationProto_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto_once;
static bool descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto = {
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto_initialized, descriptor_table_protodef_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto, "frameworks/base/core/proto/android/app/notification.proto", 564,
  &descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto_once, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto_sccs, descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto::offsets,
  file_level_metadata_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto, 1, file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto, file_level_service_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto), true);
namespace android {
namespace app {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* NotificationProto_Visibility_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto);
  return file_level_enum_descriptors_frameworks_2fbase_2fcore_2fproto_2fandroid_2fapp_2fnotification_2eproto[0];
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_channel_id(), ptr, ctx, "android.app.NotificationProto.channel_id");
          CHK_(ptr);
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_category(), ptr, ctx, "android.app.NotificationProto.category");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 50)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_group_key(), ptr, ctx, "android.app.NotificationProto.group_key");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 58)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_sort_key(), ptr, ctx, "android.app.NotificationProto.sort_key");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (10 & 0xFF)) {
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            "android.app.NotificationProto.channel_id");
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 5: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (42 & 0xFF)) {
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::PARSE,
            "android.app.NotificationProto.category");
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 6: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (50 & 0xFF)) {
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            ...
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::PARSE,
            "android.app.NotificationProto.group_key");
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 7: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (58 & 0xFF)) {
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            this->sort_key().data(), static_cast<int>(this->sort_key().length()),
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::PARSE,
            "android.app.NotificationProto.sort_key");
        } else {
          goto handle_unusual;
        }
        break;
...
::PROTOBUF_NAMESPACE_ID::uint8* NotificationProto::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:android.app.NotificationProto)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional bool has_ticker_text = 2;
  if (cached_has_bits & 0x00000020u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(2, this->has_ticker_text(), target);
  }
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target =
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteStringToArray(
        7, this->sort_key(), target);
  }

  // optional int32 action_length = 8;
  if (cached_has_bits & 0x00000100u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(8, this->action_length(), target);
  }

  // optional .android.app.NotificationProto.Visibility visibility = 9;
  if (cached_has_bits & 0x00000200u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnumToArray(
      9, this->visibility(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        10, _Internal::public_version(this), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:android.app.NotificationProto)
  return target;
}
...
void NotificationProto::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:android.app.NotificationProto)
  GOOGLE_DCHECK_NE(&from, this);
  const NotificationProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<NotificationProto>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:android.app.NotificationProto)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:android.app.NotificationProto)
    MergeFrom(*source);
  }
}
...
void NotificationProto::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:android.app.NotificationProto)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata NotificationProto::GetMetadata() const {
