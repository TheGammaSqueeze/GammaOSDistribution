...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2futil_2fevent_5flog_5ftags_2eproto;
namespace android {
namespace util {
class EventLogTag;
...
inline const std::string& EventLogTag_ValueDescriptor_DataType_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EventLogTag_ValueDescriptor_DataType_descriptor(), enum_t_value);
}
inline bool EventLogTag_ValueDescriptor_DataType_Parse(
    const std::string& name, EventLogTag_ValueDescriptor_DataType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EventLogTag_ValueDescriptor_DataType>(
    EventLogTag_ValueDescriptor_DataType_descriptor(), name, value);
}
...
inline const std::string& EventLogTag_ValueDescriptor_DataUnit_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EventLogTag_ValueDescriptor_DataUnit_descriptor(), enum_t_value);
}
inline bool EventLogTag_ValueDescriptor_DataUnit_Parse(
    const std::string& name, EventLogTag_ValueDescriptor_DataUnit* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EventLogTag_ValueDescriptor_DataUnit>(
    EventLogTag_ValueDescriptor_DataUnit_descriptor(), name, value);
}
// ===================================================================

class EventLogTagMapProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.util.EventLogTagMapProto) */ {
 public:
  EventLogTagMapProto();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_frameworks_2fbase_2fcore_2fproto_2fandroid_2futil_2fevent_5flog_5ftags_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class EventLogTag_ValueDescriptor :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.util.EventLogTag.ValueDescriptor) */ {
 public:
  ...
  DataType_descriptor() {
    return EventLogTag_ValueDescriptor_DataType_descriptor();
  }
  template<typename T>
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  DataUnit_descriptor() {
    return EventLogTag_ValueDescriptor_DataUnit_descriptor();
  }
  template<typename T>
...
class EventLogTag :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:android.util.EventLogTag) */ {
 public:
  EventLogTag();
  virtual ~EventLogTag();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::util::EventLogTag_ValueDescriptor_DataType>() {
  return ::android::util::EventLogTag_ValueDescriptor_DataType_descriptor();
}
template <> struct is_proto_enum< ::android::util::EventLogTag_ValueDescriptor_DataUnit> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::util::EventLogTag_ValueDescriptor_DataUnit>() {
  return ::android::util::EventLogTag_ValueDescriptor_DataUnit_descriptor();
}
