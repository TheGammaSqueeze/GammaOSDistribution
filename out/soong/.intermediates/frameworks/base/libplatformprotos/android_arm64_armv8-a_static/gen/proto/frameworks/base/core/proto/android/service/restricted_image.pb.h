...
class RestrictedImagesDumpProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.service.restricted_image.RestrictedImagesDumpProto) */ {
 public:
...
class RestrictedImageSetProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.service.restricted_image.RestrictedImageSetProto) */ {
 public:
...
class RestrictedImageProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.service.restricted_image.RestrictedImageProto) */ {
 public:
