...
const std::string& SectionType_Name(SectionType value);
template<typename T>
inline const std::string& SectionType_Name(T enum_t_value) {
  ...
  return SectionType_Name(static_cast<SectionType>(enum_t_value));
}
...
class SectionFlags :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.SectionFlags) */ {
 public:
  SectionFlags();
