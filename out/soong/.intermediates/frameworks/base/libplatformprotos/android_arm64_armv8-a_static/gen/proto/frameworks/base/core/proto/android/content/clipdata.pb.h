...
class ClipDataProto_Icon :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.content.ClipDataProto.Icon) */ {
 public:
  ClipDataProto_Icon();
...
class ClipDataProto_Item :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.content.ClipDataProto.Item) */ {
 public:
  ClipDataProto_Item();
...
class ClipDataProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.content.ClipDataProto) */ {
 public:
  ClipDataProto();
