...
void DisplayCutoutProto::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const DisplayCutoutProto*>(
      &from));
}
...
std::string DisplayCutoutProto::GetTypeName() const {
