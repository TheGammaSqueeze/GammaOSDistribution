...
const std::string& AppTransitionReasonEnum_Name(AppTransitionReasonEnum value);
template<typename T>
inline const std::string& AppTransitionReasonEnum_Name(T enum_t_value) {
  ...
  return AppTransitionReasonEnum_Name(static_cast<AppTransitionReasonEnum>(enum_t_value));
}
...
const std::string& ProcessStateEnum_Name(ProcessStateEnum value);
template<typename T>
inline const std::string& ProcessStateEnum_Name(T enum_t_value) {
  ...
  return ProcessStateEnum_Name(static_cast<ProcessStateEnum>(enum_t_value));
}
...
const std::string& AppOpEnum_Name(AppOpEnum value);
template<typename T>
inline const std::string& AppOpEnum_Name(T enum_t_value) {
  ...
  return AppOpEnum_Name(static_cast<AppOpEnum>(enum_t_value));
}
...
const std::string& AppExitReasonCode_Name(AppExitReasonCode value);
template<typename T>
inline const std::string& AppExitReasonCode_Name(T enum_t_value) {
  ...
  return AppExitReasonCode_Name(static_cast<AppExitReasonCode>(enum_t_value));
}
...
const std::string& AppExitSubReasonCode_Name(AppExitSubReasonCode value);
template<typename T>
inline const std::string& AppExitSubReasonCode_Name(T enum_t_value) {
  ...
  return AppExitSubReasonCode_Name(static_cast<AppExitSubReasonCode>(enum_t_value));
}
...
const std::string& Importance_Name(Importance value);
template<typename T>
inline const std::string& Importance_Name(T enum_t_value) {
  ...
  return Importance_Name(static_cast<Importance>(enum_t_value));
}
