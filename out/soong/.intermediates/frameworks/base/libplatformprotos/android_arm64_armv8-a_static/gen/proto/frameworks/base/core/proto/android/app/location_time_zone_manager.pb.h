...
const std::string& TimeZoneProviderStateEnum_Name(TimeZoneProviderStateEnum value);
template<typename T>
inline const std::string& TimeZoneProviderStateEnum_Name(T enum_t_value) {
  ...
  return TimeZoneProviderStateEnum_Name(static_cast<TimeZoneProviderStateEnum>(enum_t_value));
}
...
class LocationTimeZoneManagerServiceStateProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.app.time.LocationTimeZoneManagerServiceStateProto) */ {
 public:
...
class TimeZoneProviderStateProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.app.time.TimeZoneProviderStateProto) */ {
 public:
