...
void ProcrankProto_Process::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ProcrankProto_Process*>(
      &from));
}
...
std::string ProcrankProto_Process::GetTypeName() const {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(mutable_raw_text(), ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
void ProcrankProto_Summary_Zram::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ProcrankProto_Summary_Zram*>(
      &from));
}
...
std::string ProcrankProto_Summary_Zram::GetTypeName() const {
...
void ProcrankProto_Summary_Ram::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ProcrankProto_Summary_Ram*>(
      &from));
}
...
std::string ProcrankProto_Summary_Ram::GetTypeName() const {
...
void ProcrankProto_Summary::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ProcrankProto_Summary*>(
      &from));
}
...
std::string ProcrankProto_Summary::GetTypeName() const {
...
void ProcrankProto::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ProcrankProto*>(
      &from));
}
...
std::string ProcrankProto::GetTypeName() const {
