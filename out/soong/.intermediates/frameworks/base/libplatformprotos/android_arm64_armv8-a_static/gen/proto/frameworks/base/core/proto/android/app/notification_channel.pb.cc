    ...
    switch (tag >> 3) {
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 122)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(mutable_group(), ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
void NotificationChannelProto::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const NotificationChannelProto*>(
      &from));
}
...
std::string NotificationChannelProto::GetTypeName() const {
