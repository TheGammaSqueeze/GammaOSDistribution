...
const std::string& PsProto_Process_ProcessStateCode_Name(PsProto_Process_ProcessStateCode value);
template<typename T>
inline const std::string& PsProto_Process_ProcessStateCode_Name(T enum_t_value) {
  ...
  return PsProto_Process_ProcessStateCode_Name(static_cast<PsProto_Process_ProcessStateCode>(enum_t_value));
}
...
const std::string& PsProto_Process_SchedulingPolicy_Name(PsProto_Process_SchedulingPolicy value);
template<typename T>
inline const std::string& PsProto_Process_SchedulingPolicy_Name(T enum_t_value) {
  ...
  return PsProto_Process_SchedulingPolicy_Name(static_cast<PsProto_Process_SchedulingPolicy>(enum_t_value));
}
...
const std::string& PsProto_Process_Policy_Name(PsProto_Process_Policy value);
template<typename T>
inline const std::string& PsProto_Process_Policy_Name(T enum_t_value) {
  ...
  return PsProto_Process_Policy_Name(static_cast<PsProto_Process_Policy>(enum_t_value));
}
...
class PsProto_Process :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.PsProto.Process) */ {
 public:
  PsProto_Process();
...
class PsProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.PsProto) */ {
 public:
  PsProto();
  virtual ~PsProto();
