...
class CpuUsageProto_Load :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.CpuUsageProto.Load) */ {
 public:
  CpuUsageProto_Load();
...
class CpuUsageProto_Stat :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.CpuUsageProto.Stat) */ {
 public:
  CpuUsageProto_Stat();
...
class CpuUsageProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.CpuUsageProto) */ {
 public:
  CpuUsageProto();
