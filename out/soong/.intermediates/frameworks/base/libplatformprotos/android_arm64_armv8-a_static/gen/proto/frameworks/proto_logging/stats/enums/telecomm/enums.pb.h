...
const std::string& CallStateEnum_Name(CallStateEnum value);
template<typename T>
inline const std::string& CallStateEnum_Name(T enum_t_value) {
  ...
  return CallStateEnum_Name(static_cast<CallStateEnum>(enum_t_value));
}
...
const std::string& DisconnectCauseEnum_Name(DisconnectCauseEnum value);
template<typename T>
inline const std::string& DisconnectCauseEnum_Name(T enum_t_value) {
  ...
  return DisconnectCauseEnum_Name(static_cast<DisconnectCauseEnum>(enum_t_value));
}
