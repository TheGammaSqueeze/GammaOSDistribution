...
const std::string& MediumType_Name(MediumType value);
template<typename T>
inline const std::string& MediumType_Name(T enum_t_value) {
  ...
  return MediumType_Name(static_cast<MediumType>(enum_t_value));
}
...
const std::string& SwitchResult_Name(SwitchResult value);
template<typename T>
inline const std::string& SwitchResult_Name(T enum_t_value) {
  ...
  return SwitchResult_Name(static_cast<SwitchResult>(enum_t_value));
}
...
const std::string& SubResult_Name(SubResult value);
template<typename T>
inline const std::string& SubResult_Name(T enum_t_value) {
  ...
  return SubResult_Name(static_cast<SubResult>(enum_t_value));
}
