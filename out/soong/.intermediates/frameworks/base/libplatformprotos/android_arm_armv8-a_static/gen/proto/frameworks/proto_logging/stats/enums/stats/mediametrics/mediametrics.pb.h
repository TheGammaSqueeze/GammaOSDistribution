...
const std::string& StreamType_Name(StreamType value);
template<typename T>
inline const std::string& StreamType_Name(T enum_t_value) {
  ...
  return StreamType_Name(static_cast<StreamType>(enum_t_value));
}
...
const std::string& DrmType_Name(DrmType value);
template<typename T>
inline const std::string& DrmType_Name(T enum_t_value) {
  ...
  return DrmType_Name(static_cast<DrmType>(enum_t_value));
}
bool DrmType_Parse(
...
const std::string& PlaybackType_Name(PlaybackType value);
template<typename T>
inline const std::string& PlaybackType_Name(T enum_t_value) {
  ...
  return PlaybackType_Name(static_cast<PlaybackType>(enum_t_value));
}
...
const std::string& StreamSourceType_Name(StreamSourceType value);
template<typename T>
inline const std::string& StreamSourceType_Name(T enum_t_value) {
  ...
  return StreamSourceType_Name(static_cast<StreamSourceType>(enum_t_value));
}
...
const std::string& PlaybackState_Name(PlaybackState value);
template<typename T>
inline const std::string& PlaybackState_Name(T enum_t_value) {
  ...
  return PlaybackState_Name(static_cast<PlaybackState>(enum_t_value));
}
...
const std::string& PlaybackErrorCode_Name(PlaybackErrorCode value);
template<typename T>
inline const std::string& PlaybackErrorCode_Name(T enum_t_value) {
  ...
  return PlaybackErrorCode_Name(static_cast<PlaybackErrorCode>(enum_t_value));
}
...
const std::string& TrackType_Name(TrackType value);
template<typename T>
inline const std::string& TrackType_Name(T enum_t_value) {
  ...
  return TrackType_Name(static_cast<TrackType>(enum_t_value));
}
...
const std::string& TrackState_Name(TrackState value);
template<typename T>
inline const std::string& TrackState_Name(T enum_t_value) {
  ...
  return TrackState_Name(static_cast<TrackState>(enum_t_value));
}
...
const std::string& TrackChangeReason_Name(TrackChangeReason value);
template<typename T>
inline const std::string& TrackChangeReason_Name(T enum_t_value) {
  ...
  return TrackChangeReason_Name(static_cast<TrackChangeReason>(enum_t_value));
}
