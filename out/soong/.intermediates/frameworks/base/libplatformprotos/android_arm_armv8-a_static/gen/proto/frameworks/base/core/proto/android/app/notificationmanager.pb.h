...
const std::string& PolicyProto_Category_Name(PolicyProto_Category value);
template<typename T>
inline const std::string& PolicyProto_Category_Name(T enum_t_value) {
  ...
  return PolicyProto_Category_Name(static_cast<PolicyProto_Category>(enum_t_value));
}
...
const std::string& PolicyProto_Sender_Name(PolicyProto_Sender value);
template<typename T>
inline const std::string& PolicyProto_Sender_Name(T enum_t_value) {
  ...
  return PolicyProto_Sender_Name(static_cast<PolicyProto_Sender>(enum_t_value));
}
...
const std::string& PolicyProto_SuppressedVisualEffect_Name(PolicyProto_SuppressedVisualEffect value);
template<typename T>
inline const std::string& PolicyProto_SuppressedVisualEffect_Name(T enum_t_value) {
  ...
  return PolicyProto_SuppressedVisualEffect_Name(static_cast<PolicyProto_SuppressedVisualEffect>(enum_t_value));
}
...
class PolicyProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.app.PolicyProto) */ {
 public:
  PolicyProto();
  virtual ~PolicyProto();
