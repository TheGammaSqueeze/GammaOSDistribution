...
class PageTypeInfoProto_MigrateType :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.PageTypeInfoProto.MigrateType) */ {
 public:
...
class PageTypeInfoProto_Block :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.PageTypeInfoProto.Block) */ {
 public:
...
class PageTypeInfoProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.PageTypeInfoProto) */ {
 public:
  PageTypeInfoProto();
