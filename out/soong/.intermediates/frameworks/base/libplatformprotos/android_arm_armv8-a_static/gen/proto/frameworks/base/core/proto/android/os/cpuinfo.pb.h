...
const std::string& CpuInfoProto_Task_Status_Name(CpuInfoProto_Task_Status value);
template<typename T>
inline const std::string& CpuInfoProto_Task_Status_Name(T enum_t_value) {
  ...
  return CpuInfoProto_Task_Status_Name(static_cast<CpuInfoProto_Task_Status>(enum_t_value));
}
...
const std::string& CpuInfoProto_Task_Policy_Name(CpuInfoProto_Task_Policy value);
template<typename T>
inline const std::string& CpuInfoProto_Task_Policy_Name(T enum_t_value) {
  ...
  return CpuInfoProto_Task_Policy_Name(static_cast<CpuInfoProto_Task_Policy>(enum_t_value));
}
...
class CpuInfoProto_TaskStats :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.CpuInfoProto.TaskStats) */ {
 public:
...
class CpuInfoProto_MemStats :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.CpuInfoProto.MemStats) */ {
 public:
...
class CpuInfoProto_CpuUsage :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.CpuInfoProto.CpuUsage) */ {
 public:
...
class CpuInfoProto_Task :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.CpuInfoProto.Task) */ {
 public:
  CpuInfoProto_Task();
...
class CpuInfoProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:android.os.CpuInfoProto) */ {
 public:
  CpuInfoProto();
