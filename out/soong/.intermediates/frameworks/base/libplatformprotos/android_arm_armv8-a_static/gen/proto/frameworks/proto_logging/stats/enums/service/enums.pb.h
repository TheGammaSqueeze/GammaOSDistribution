...
const std::string& UsbEndPointType_Name(UsbEndPointType value);
template<typename T>
inline const std::string& UsbEndPointType_Name(T enum_t_value) {
  ...
  return UsbEndPointType_Name(static_cast<UsbEndPointType>(enum_t_value));
}
...
const std::string& UsbEndPointDirection_Name(UsbEndPointDirection value);
template<typename T>
inline const std::string& UsbEndPointDirection_Name(T enum_t_value) {
  ...
  return UsbEndPointDirection_Name(static_cast<UsbEndPointDirection>(enum_t_value));
}
...
const std::string& UsbConnectionRecordMode_Name(UsbConnectionRecordMode value);
template<typename T>
inline const std::string& UsbConnectionRecordMode_Name(T enum_t_value) {
  ...
  return UsbConnectionRecordMode_Name(static_cast<UsbConnectionRecordMode>(enum_t_value));
}
...
const std::string& ContaminantPresenceStatus_Name(ContaminantPresenceStatus value);
template<typename T>
inline const std::string& ContaminantPresenceStatus_Name(T enum_t_value) {
  ...
  return ContaminantPresenceStatus_Name(static_cast<ContaminantPresenceStatus>(enum_t_value));
}
