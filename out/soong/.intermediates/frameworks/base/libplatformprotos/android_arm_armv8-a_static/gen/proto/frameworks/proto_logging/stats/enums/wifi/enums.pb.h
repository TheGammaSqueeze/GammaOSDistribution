...
const std::string& WifiModeEnum_Name(WifiModeEnum value);
template<typename T>
inline const std::string& WifiModeEnum_Name(T enum_t_value) {
  ...
  return WifiModeEnum_Name(static_cast<WifiModeEnum>(enum_t_value));
}
...
const std::string& WifiAuthType_Name(WifiAuthType value);
template<typename T>
inline const std::string& WifiAuthType_Name(T enum_t_value) {
  ...
  return WifiAuthType_Name(static_cast<WifiAuthType>(enum_t_value));
}
...
const std::string& WifiBandBucket_Name(WifiBandBucket value);
template<typename T>
inline const std::string& WifiBandBucket_Name(T enum_t_value) {
  ...
  return WifiBandBucket_Name(static_cast<WifiBandBucket>(enum_t_value));
}
