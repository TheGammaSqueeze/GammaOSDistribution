...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fproto_5flogging_2fstats_2fenums_2fview_2fenums_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace android {
namespace view {
...
inline const std::string& DisplayStateEnum_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    DisplayStateEnum_descriptor(), enum_t_value);
}
inline bool DisplayStateEnum_Parse(
    const std::string& name, DisplayStateEnum* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<DisplayStateEnum>(
    DisplayStateEnum_descriptor(), name, value);
}
...
inline const std::string& TransitionTypeEnum_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    TransitionTypeEnum_descriptor(), enum_t_value);
}
inline bool TransitionTypeEnum_Parse(
    const std::string& name, TransitionTypeEnum* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<TransitionTypeEnum>(
    TransitionTypeEnum_descriptor(), name, value);
}
// ===================================================================
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::view::DisplayStateEnum>() {
  return ::android::view::DisplayStateEnum_descriptor();
}
template <> struct is_proto_enum< ::android::view::TransitionTypeEnum> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::view::TransitionTypeEnum>() {
  return ::android::view::TransitionTypeEnum_descriptor();
}
