...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fproto_5flogging_2fstats_2fenums_2fstats_2fdevicepolicy_2fdevice_5fpolicy_5fenums_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace android {
namespace stats {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::stats::devicepolicy::EventId>() {
  return ::android::stats::devicepolicy::EventId_descriptor();
}
