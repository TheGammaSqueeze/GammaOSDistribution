...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_frameworks_2fproto_5flogging_2fstats_2fenums_2fstats_2fotaupdate_2fupdateengine_5fenums_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace android {
namespace stats {
...
inline const std::string& AttemptResult_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    AttemptResult_descriptor(), enum_t_value);
}
inline bool AttemptResult_Parse(
    const std::string& name, AttemptResult* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<AttemptResult>(
    AttemptResult_descriptor(), name, value);
}
enum ErrorCode : int {
  SUCCESS = 10000,
  ERROR = 10001,
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::stats::otaupdate::PayloadType>() {
  return ::android::stats::otaupdate::PayloadType_descriptor();
}
template <> struct is_proto_enum< ::android::stats::otaupdate::AttemptResult> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::stats::otaupdate::AttemptResult>() {
  return ::android::stats::otaupdate::AttemptResult_descriptor();
}
template <> struct is_proto_enum< ::android::stats::otaupdate::ErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::android::stats::otaupdate::ErrorCode>() {
  return ::android::stats::otaupdate::ErrorCode_descriptor();
}
