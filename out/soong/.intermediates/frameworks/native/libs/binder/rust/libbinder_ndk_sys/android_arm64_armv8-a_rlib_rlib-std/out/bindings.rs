...
extern "C" {
    #[doc = " WARNING: this is not expected to be used manually. When the build system has"]
    #[doc = " versioned checks in place for an interface that prevent it being changed year"]
    #[doc = " over year (specifically like those for @VintfStability stable AIDL"]
    #[doc = " interfaces), this could be called. Calling this without this or equivalent"]
    #[doc = " infrastructure will lead to de facto frozen APIs or GSI test failures."]
    #[doc = ""]
    #[doc = " This interface has system<->vendor stability"]
