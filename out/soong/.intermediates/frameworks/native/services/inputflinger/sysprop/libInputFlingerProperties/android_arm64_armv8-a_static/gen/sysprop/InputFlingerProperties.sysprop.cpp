...
using namespace android::sysprop::InputFlingerProperties;
...
std::optional<bool> per_window_input_rotation() {
    return GetProp<std::optional<bool>>("persist.debug.per_window_input_rotation");
}

bool per_window_input_rotation(const std::optional<bool>& value) {
    return SetProp("persist.debug.per_window_input_rotation", FormatValue(value).c_str());
}
