...
public final class ComponentDescriptorFactory_Factory implements Factory<ComponentDescriptorFactory> {
  ...
  public ComponentDescriptorFactory get() {
    return new ComponentDescriptorFactory(elementsProvider.get(), typesProvider.get(), dependencyRequestFactoryProvider.get(), moduleDescriptorFactoryProvider.get(), injectionAnnotationsProvider.get());
  }
