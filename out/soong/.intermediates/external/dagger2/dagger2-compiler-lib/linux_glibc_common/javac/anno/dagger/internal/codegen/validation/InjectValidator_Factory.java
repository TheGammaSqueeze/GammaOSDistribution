...
public final class InjectValidator_Factory implements Factory<InjectValidator> {
  ...
  public InjectValidator get() {
    return new InjectValidator(typesProvider.get(), elementsProvider.get(), dependencyRequestValidatorProvider.get(), compilerOptionsProvider.get(), injectionAnnotationsProvider.get(), metadataUtilProvider.get());
  }
