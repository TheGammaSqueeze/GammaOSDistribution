...
public final class BindingGraphFactory_Factory implements Factory<BindingGraphFactory> {
  ...
  public BindingGraphFactory get() {
    return new BindingGraphFactory(elementsProvider.get(), injectBindingRegistryProvider.get(), keyFactoryProvider.get(), bindingFactoryProvider.get(), moduleDescriptorFactoryProvider.get(), bindingGraphConverterProvider.get(), compilerOptionsProvider.get());
  }
