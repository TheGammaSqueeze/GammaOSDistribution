...
public final class BindsMethodValidator_Factory implements Factory<BindsMethodValidator> {
  ...
  public BindsMethodValidator get() {
    return new BindsMethodValidator(elementsProvider.get(), typesProvider.get(), kotlinMetadataUtilProvider.get(), bindsTypeCheckerProvider.get(), dependencyRequestValidatorProvider.get(), injectionAnnotationsProvider.get());
  }
