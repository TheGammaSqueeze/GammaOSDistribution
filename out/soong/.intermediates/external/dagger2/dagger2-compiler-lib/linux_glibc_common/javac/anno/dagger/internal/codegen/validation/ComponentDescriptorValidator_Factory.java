...
public final class ComponentDescriptorValidator_Factory implements Factory<ComponentDescriptorValidator> {
  ...
  public ComponentDescriptorValidator get() {
    return new ComponentDescriptorValidator(elementsProvider.get(), typesProvider.get(), compilerOptionsProvider.get(), methodSignatureFormatterProvider.get(), componentHierarchyValidatorProvider.get(), metadataUtilProvider.get());
  }
