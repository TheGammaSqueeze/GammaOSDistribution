...
public final class ModuleDescriptor_Factory_Factory implements Factory<ModuleDescriptor.Factory> {
  ...
  public ModuleDescriptor.Factory get() {
    return new ModuleDescriptor.Factory(elementsProvider.get(), metadataUtilProvider.get(), bindingFactoryProvider.get(), multibindingDeclarationFactoryProvider.get(), bindingDelegateDeclarationFactoryProvider.get(), subcomponentDeclarationFactoryProvider.get(), optionalBindingDeclarationFactoryProvider.get());
  }
