...
public final class ModuleValidator_Factory implements Factory<ModuleValidator> {
  ...
  public ModuleValidator get() {
    return new ModuleValidator(typesProvider.get(), elementsProvider.get(), anyBindingMethodValidatorProvider.get(), methodSignatureFormatterProvider.get(), componentDescriptorFactoryProvider.get(), bindingGraphFactoryProvider.get(), bindingGraphValidatorProvider.get(), metadataUtilProvider.get());
  }
