...
public final class ProvidesMethodValidator_Factory implements Factory<ProvidesMethodValidator> {
  ...
  public ProvidesMethodValidator get() {
    return new ProvidesMethodValidator(elementsProvider.get(), typesProvider.get(), kotlinMetadataUtilProvider.get(), dependencyRequestValidatorProvider.get(), injectionAnnotationsProvider.get());
  }
