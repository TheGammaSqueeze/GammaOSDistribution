...
public final class DependencyRequestValidator_Factory implements Factory<DependencyRequestValidator> {
  ...
  public DependencyRequestValidator get() {
    return new DependencyRequestValidator(membersInjectionValidatorProvider.get(), injectionAnnotationsProvider.get(), metadataUtilProvider.get(), elementsProvider.get());
  }
