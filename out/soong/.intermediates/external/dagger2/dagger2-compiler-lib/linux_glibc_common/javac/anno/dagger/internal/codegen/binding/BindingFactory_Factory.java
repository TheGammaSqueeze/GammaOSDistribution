...
public final class BindingFactory_Factory implements Factory<BindingFactory> {
  ...
  public BindingFactory get() {
    return new BindingFactory(typesProvider.get(), elementsProvider.get(), keyFactoryProvider.get(), dependencyRequestFactoryProvider.get(), injectionSiteFactoryProvider.get(), injectionAnnotationsProvider.get(), metadataUtilProvider.get());
  }
