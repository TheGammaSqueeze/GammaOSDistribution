...
public final class ComponentProcessor_ProcessingStepsModule_ProcessingStepsFactory implements Factory<ImmutableList<BasicAnnotationProcessor.ProcessingStep>> {
  ...
  public static ImmutableList<BasicAnnotationProcessor.ProcessingStep> processingSteps(
      Object mapKeyProcessingStep, Object injectProcessingStep, Object assistedInjectProcessingStep,
    ...
    return Preconditions.checkNotNull(ComponentProcessor.ProcessingStepsModule.processingSteps((MapKeyProcessingStep) mapKeyProcessingStep, (InjectProcessingStep) injectProcessingStep, (AssistedInjectProcessingStep) assistedInjectProcessingStep, (AssistedFactoryProcessingStep) assistedFactoryProcessingStep, (AssistedProcessingStep) assistedProcessingStep, monitoringModuleProcessingStep, multibindingAnnotationsProcessingStep, bindsInstanceProcessingStep, (ModuleProcessingStep) moduleProcessingStep, (ComponentProcessingStep) componentProcessingStep, (ComponentHjarProcessingStep) componentHjarProcessingStep, bindingMethodProcessingStep, compilerOptions), "Cannot return null from a non-@Nullable @Provides method");
  }
}
