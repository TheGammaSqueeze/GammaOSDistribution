...
public final class ComponentCreatorImplementationFactory_Factory implements Factory<ComponentCreatorImplementationFactory> {
  ...
  public ComponentCreatorImplementationFactory get() {
    return new ComponentCreatorImplementationFactory(componentImplementationProvider.get(), elementsProvider.get(), typesProvider.get(), metadataUtilProvider.get(), moduleProxiesProvider.get());
  }
