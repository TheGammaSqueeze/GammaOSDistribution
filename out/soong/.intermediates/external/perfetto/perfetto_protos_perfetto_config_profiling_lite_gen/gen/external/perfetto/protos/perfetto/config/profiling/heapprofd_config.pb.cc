    ...
    switch (tag >> 3) {
      ...
      case 27:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 218)) {
          ...
          do {
            ptr += 2;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(add_exclude_heaps(), ptr, ctx);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
void HeapprofdConfig::SerializeWithCachedSizes(
  ...
  for (int i = 0, n = this->target_installed_by_size(); i < n; i++) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteString(
      26, this->target_installed_by(i), output);
  }

  // repeated string exclude_heaps = 27;
  for (int i = 0, n = this->exclude_heaps_size(); i < n; i++) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteString(
      27, this->exclude_heaps(i), output);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.HeapprofdConfig)
  ...
  // repeated string exclude_heaps = 27;
  total_size += 2 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(this->exclude_heaps_size());
  for (int i = 0, n = this->exclude_heaps_size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      this->exclude_heaps(i));
  }
...
void HeapprofdConfig::InternalSwap(HeapprofdConfig* other) {
  ...
  exclude_heaps_.InternalSwap(CastToBase(&other->exclude_heaps_));
