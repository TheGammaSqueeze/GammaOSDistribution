...
ChromeMetadataPacket::ChromeMetadataPacket(const ChromeMetadataPacket& from)
  ...
  if (from.has_enabled_categories()) {
    enabled_categories_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.enabled_categories_);
  }
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.ChromeMetadataPacket)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      enabled_categories_.ClearNonDefaultToEmptyNoArena();
    }
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(mutable_enabled_categories(), ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
      ...
      case 3: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (26 & 0xFF)) {
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadString(
                input, this->mutable_enabled_categories()));
        } else {
          goto handle_unusual;
        }
        break;
...
void ChromeMetadataPacket::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteStringMaybeAliased(
      3, this->enabled_categories(), output);
  }
...
void ChromeMetadataPacket::InternalSwap(ChromeMetadataPacket* other) {
  ...
  enabled_categories_.Swap(&other->enabled_categories_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (17 & 0xFF)) {
          _Internal::set_has_content_trigger_name_hash(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   ::PROTOBUF_NAMESPACE_ID::uint64, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_FIXED64>(
                 input, &content_trigger_name_hash_)));
        } else {
          goto handle_unusual;
        }
        break;
...
void BackgroundTracingMetadata_TriggerRule_NamedRule::SerializeWithCachedSizes(
  ...
  // optional fixed64 content_trigger_name_hash = 2;
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFixed64(2, this->content_trigger_name_hash(), output);
  }
...
void BackgroundTracingMetadata_TriggerRule_NamedRule::InternalSwap(BackgroundTracingMetadata_TriggerRule_NamedRule* other) {
  ...
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  swap(content_trigger_name_hash_, other->content_trigger_name_hash_);
