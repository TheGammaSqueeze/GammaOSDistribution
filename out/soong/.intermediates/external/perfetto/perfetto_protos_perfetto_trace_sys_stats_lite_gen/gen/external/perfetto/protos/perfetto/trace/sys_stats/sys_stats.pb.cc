...
extern PROTOBUF_INTERNAL_EXPORT_protos_2fperfetto_2ftrace_2fsys_5fstats_2fsys_5fstats_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SysStats_DevfreqValue_protos_2fperfetto_2ftrace_2fsys_5fstats_2fsys_5fstats_2eproto;
...
class SysStats_DevfreqValueDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<SysStats_DevfreqValue> _instance;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<5> scc_info_SysStats_protos_2fperfetto_2ftrace_2fsys_5fstats_2fsys_5fstats_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 5, InitDefaultsscc_info_SysStats_protos_2fperfetto_2ftrace_2fsys_5fstats_2fsys_5fstats_2eproto}, {
      ...
      &scc_info_SysStats_DevfreqValue_protos_2fperfetto_2ftrace_2fsys_5fstats_2fsys_5fstats_2eproto.base,}};
...
static void InitDefaultsscc_info_SysStats_DevfreqValue_protos_2fperfetto_2ftrace_2fsys_5fstats_2fsys_5fstats_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::perfetto::protos::_SysStats_DevfreqValue_default_instance_;
    new (ptr) ::perfetto::protos::SysStats_DevfreqValue();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::perfetto::protos::SysStats_DevfreqValue::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SysStats_DevfreqValue_protos_2fperfetto_2ftrace_2fsys_5fstats_2fsys_5fstats_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_SysStats_DevfreqValue_protos_2fperfetto_2ftrace_2fsys_5fstats_2fsys_5fstats_2eproto}, {}};
...
void SysStats_DevfreqValue::InitAsDefaultInstance() {
}
...
SysStats_DevfreqValue::SysStats_DevfreqValue()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:perfetto.protos.SysStats.DevfreqValue)
}
...
void SysStats_DevfreqValue::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_SysStats_DevfreqValue_protos_2fperfetto_2ftrace_2fsys_5fstats_2fsys_5fstats_2eproto.base);
  key_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void SysStats_DevfreqValue::SharedDtor() {
...
const SysStats_DevfreqValue& SysStats_DevfreqValue::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SysStats_DevfreqValue_protos_2fperfetto_2ftrace_2fsys_5fstats_2fsys_5fstats_2eproto.base);
  return *internal_default_instance();
}
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* SysStats_DevfreqValue::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool SysStats_DevfreqValue::MergePartialFromCodedStream(
    ::PROTOBUF_NAMESPACE_ID::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  ::PROTOBUF_NAMESPACE_ID::internal::LiteUnknownFieldSetter unknown_fields_setter(
  ...
  ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:perfetto.protos.SysStats.DevfreqValue)
  for (;;) {
    ::std::pair<::PROTOBUF_NAMESPACE_ID::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:perfetto.protos.SysStats.DevfreqValue)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:perfetto.protos.SysStats.DevfreqValue)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void SysStats_DevfreqValue::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:perfetto.protos.SysStats.DevfreqValue)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  output->WriteRaw(_internal_metadata_.unknown_fields().data(),
                   static_cast<int>(_internal_metadata_.unknown_fields().size()));
  // @@protoc_insertion_point(serialize_end:perfetto.protos.SysStats.DevfreqValue)
}
...
void SysStats_DevfreqValue::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const SysStats_DevfreqValue*>(
      &from));
}
    ...
    switch (tag >> 3) {
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 82)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(add_devfreq(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
void SysStats::SerializeWithCachedSizes(
  ...
  // repeated .perfetto.protos.SysStats.DevfreqValue devfreq = 10;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->devfreq_size()); i < n; i++) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessage(
      10,
      this->devfreq(static_cast<int>(i)),
      output);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.SysStats)
  ...
  // repeated .perfetto.protos.SysStats.DevfreqValue devfreq = 10;
  {
    unsigned int count = static_cast<unsigned int>(this->devfreq_size());
    total_size += 1UL * count;
    for (unsigned int i = 0; i < count; i++) {
      total_size +=
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(
...
void SysStats::InternalSwap(SysStats* other) {
  ...
  CastToBase(&devfreq_)->InternalSwap(CastToBase(&other->devfreq_));
...
template<> PROTOBUF_NOINLINE ::perfetto::protos::SysStats_DevfreqValue* Arena::CreateMaybeMessage< ::perfetto::protos::SysStats_DevfreqValue >(Arena* arena) {
  return Arena::CreateInternal< ::perfetto::protos::SysStats_DevfreqValue >(arena);
}
