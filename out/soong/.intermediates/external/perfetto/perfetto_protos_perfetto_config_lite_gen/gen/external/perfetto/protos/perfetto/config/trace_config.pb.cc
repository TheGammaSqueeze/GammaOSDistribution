...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<10> scc_info_TraceConfig_protos_2fperfetto_2fconfig_2ftrace_5fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 10, InitDefaultsscc_info_TraceConfig_protos_2fperfetto_2fconfig_2ftrace_5fconfig_2eproto}, {
...
static void InitDefaultsscc_info_TraceConfig_TraceFilter_protos_2fperfetto_2fconfig_2ftrace_5fconfig_2eproto() {
  ...
  ::perfetto::protos::TraceConfig_TraceFilter::InitAsDefaultInstance();
}
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TraceConfig_TraceFilter_protos_2fperfetto_2fconfig_2ftrace_5fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_TraceConfig_TraceFilter_protos_2fperfetto_2fconfig_2ftrace_5fconfig_2eproto}, {}};
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 56)) {
          ...
          prefer_suspend_clock_for_snapshot_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (56 & 0xFF)) {
          _Internal::set_has_prefer_suspend_clock_for_snapshot(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   bool, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_BOOL>(
                 input, &prefer_suspend_clock_for_snapshot_)));
        } else {
          goto handle_unusual;
        }
        break;
...
void TraceConfig_BuiltinDataSource::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000040u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBool(7, this->prefer_suspend_clock_for_snapshot(), output);
  }
...
void TraceConfig_BuiltinDataSource::InternalSwap(TraceConfig_BuiltinDataSource* other) {
  ...
  swap(prefer_suspend_clock_for_snapshot_, other->prefer_suspend_clock_for_snapshot_);
}
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          ...
          skip_incidentd_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (40 & 0xFF)) {
          _Internal::set_has_skip_incidentd(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   bool, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_BOOL>(
                 input, &skip_incidentd_)));
        } else {
          goto handle_unusual;
        }
        break;
...
void TraceConfig_IncidentReportConfig::SerializeWithCachedSizes(
  ...
  // optional bool skip_incidentd = 5;
  if (cached_has_bits & 0x00000008u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBool(5, this->skip_incidentd(), output);
  }
...
void TraceConfig_IncidentReportConfig::InternalSwap(TraceConfig_IncidentReportConfig* other) {
  ...
  swap(skip_incidentd_, other->skip_incidentd_);
...
void TraceConfig_TraceFilter::InitAsDefaultInstance() {
}
...
TraceConfig_TraceFilter::TraceConfig_TraceFilter()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:perfetto.protos.TraceConfig.TraceFilter)
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TraceConfig.TraceFilter)
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000001u) {
    bytecode_.ClearNonDefaultToEmptyNoArena();
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool TraceConfig_TraceFilter::MergePartialFromCodedStream(
    ::PROTOBUF_NAMESPACE_ID::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  ::PROTOBUF_NAMESPACE_ID::internal::LiteUnknownFieldSetter unknown_fields_setter(
  ...
  ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:perfetto.protos.TraceConfig.TraceFilter)
  for (;;) {
    ::std::pair<::PROTOBUF_NAMESPACE_ID::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:perfetto.protos.TraceConfig.TraceFilter)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:perfetto.protos.TraceConfig.TraceFilter)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void TraceConfig_TraceFilter::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:perfetto.protos.TraceConfig.TraceFilter)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBytesMaybeAliased(
      1, this->bytecode(), output);
  }

  output->WriteRaw(_internal_metadata_.unknown_fields().data(),
                   static_cast<int>(_internal_metadata_.unknown_fields().size()));
  // @@protoc_insertion_point(serialize_end:perfetto.protos.TraceConfig.TraceFilter)
}
...
void TraceConfig::InitAsDefaultInstance() {
  ...
  ::perfetto::protos::_TraceConfig_default_instance_._instance.get_mutable()->trace_filter_ = const_cast< ::perfetto::protos::TraceConfig_TraceFilter*>(
      ::perfetto::protos::TraceConfig_TraceFilter::internal_default_instance());
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TraceConfig)
  ...
  if (cached_has_bits & 0x0000fe00u) {
    ::memset(&duration_ms_, 0, static_cast<size_t>(
        ...
        reinterpret_cast<char*>(&duration_ms_)) + sizeof(notify_traceur_));
  }
  if (cached_has_bits & 0x00ff0000u) {
    ::memset(&max_file_size_bytes_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&bugreport_score_) -
        reinterpret_cast<char*>(&max_file_size_bytes_)) + sizeof(bugreport_score_));
  }
  if (cached_has_bits & 0x03000000u) {
    ::memset(&trace_uuid_lsb_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&statsd_logging_) -
        reinterpret_cast<char*>(&trace_uuid_lsb_)) + sizeof(statsd_logging_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
    ...
    switch (tag >> 3) {
      ...
      case 31:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 248)) {
          ...
          if (PROTOBUF_PREDICT_TRUE(::perfetto::protos::TraceConfig_StatsdLogging_IsValid(val))) {
            set_statsd_logging(static_cast<::perfetto::protos::TraceConfig_StatsdLogging>(val));
          } else {
      ...
      case 32:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 2)) {
          ptr = ctx->ParseMessage(mutable_trace_filter(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
      ...
      case 31: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (248 & 0xFF)) {
          ...
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   int, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::perfetto::protos::TraceConfig_StatsdLogging_IsValid(value)) {
            set_statsd_logging(static_cast< ::perfetto::protos::TraceConfig_StatsdLogging >(value));
          } else {
...
void TraceConfig::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x02000000u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnum(
      31, this->statsd_logging(), output);
  }

  // optional .perfetto.protos.TraceConfig.TraceFilter trace_filter = 32;
  if (cached_has_bits & 0x00000100u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessage(
      32, _Internal::trace_filter(this), output);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.TraceConfig)
  ...
  if (cached_has_bits & 0x03000000u) {
    ...
    if (cached_has_bits & 0x02000000u) {
      total_size += 2 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->statsd_logging());
    }
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.TraceConfig)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    if (cached_has_bits & 0x00000100u) {
      mutable_trace_filter()->::perfetto::protos::TraceConfig_TraceFilter::MergeFrom(from.trace_filter());
    }
    if (cached_has_bits & 0x00000200u) {
...
void TraceConfig::InternalSwap(TraceConfig* other) {
  ...
  swap(trace_filter_, other->trace_filter_);
  ...
  swap(statsd_logging_, other->statsd_logging_);
}
...
template<> PROTOBUF_NOINLINE ::perfetto::protos::TraceConfig_TraceFilter* Arena::CreateMaybeMessage< ::perfetto::protos::TraceConfig_TraceFilter >(Arena* arena) {
  return Arena::CreateInternal< ::perfetto::protos::TraceConfig_TraceFilter >(arena);
}
