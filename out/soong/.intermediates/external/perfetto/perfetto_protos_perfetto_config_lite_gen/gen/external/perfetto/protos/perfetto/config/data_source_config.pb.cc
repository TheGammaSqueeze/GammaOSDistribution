      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 64)) {
          ...
          if (PROTOBUF_PREDICT_TRUE(::perfetto::protos::DataSourceConfig_SessionInitiator_IsValid(val))) {
            set_session_initiator(static_cast<::perfetto::protos::DataSourceConfig_SessionInitiator>(val));
          } else {
      ...
      case 8: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (64 & 0xFF)) {
          ...
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::perfetto::protos::DataSourceConfig_SessionInitiator_IsValid(value)) {
            set_session_initiator(static_cast< ::perfetto::protos::DataSourceConfig_SessionInitiator >(value));
          } else {
...
void DataSourceConfig::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x01000000u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnum(
      8, this->session_initiator(), output);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.DataSourceConfig)
  ...
  if (cached_has_bits & 0x01000000u) {
    total_size += 1 +
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->session_initiator());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.DataSourceConfig)
  ...
  if (cached_has_bits & 0x01000000u) {
    set_session_initiator(from.session_initiator());
  }
}
...
void DataSourceConfig::InternalSwap(DataSourceConfig* other) {
  ...
  swap(session_initiator_, other->session_initiator_);
}
