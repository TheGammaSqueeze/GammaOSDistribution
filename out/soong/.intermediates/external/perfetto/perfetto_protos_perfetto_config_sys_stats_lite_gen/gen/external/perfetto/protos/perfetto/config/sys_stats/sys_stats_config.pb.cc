...
SysStatsConfig::SysStatsConfig(const SysStatsConfig& from)
  ...
  ::memcpy(&meminfo_period_ms_, &from.meminfo_period_ms_,
    static_cast<size_t>(reinterpret_cast<char*>(&devfreq_period_ms_) -
    reinterpret_cast<char*>(&meminfo_period_ms_)) + sizeof(devfreq_period_ms_));
...
void SysStatsConfig::SharedCtor() {
  ::memset(&meminfo_period_ms_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&devfreq_period_ms_) -
      reinterpret_cast<char*>(&meminfo_period_ms_)) + sizeof(devfreq_period_ms_));
}
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 56)) {
          ...
          devfreq_period_ms_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (56 & 0xFF)) {
          _Internal::set_has_devfreq_period_ms(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   ::PROTOBUF_NAMESPACE_ID::uint32, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_UINT32>(
                 input, &devfreq_period_ms_)));
        } else {
          goto handle_unusual;
        }
        break;
...
void SysStatsConfig::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000008u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32(7, this->devfreq_period_ms(), output);
  }
...
void SysStatsConfig::InternalSwap(SysStatsConfig* other) {
  ...
  swap(devfreq_period_ms_, other->devfreq_period_ms_);
}
