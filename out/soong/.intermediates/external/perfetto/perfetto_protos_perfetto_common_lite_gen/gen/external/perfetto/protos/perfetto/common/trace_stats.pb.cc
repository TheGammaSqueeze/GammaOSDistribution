...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_TraceStats_protos_2fperfetto_2fcommon_2ftrace_5fstats_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsscc_info_TraceStats_protos_2fperfetto_2fcommon_2ftrace_5fstats_2eproto}, {
...
static void InitDefaultsscc_info_TraceStats_FilterStats_protos_2fperfetto_2fcommon_2ftrace_5fstats_2eproto() {
  ...
  ::perfetto::protos::TraceStats_FilterStats::InitAsDefaultInstance();
}
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TraceStats_FilterStats_protos_2fperfetto_2fcommon_2ftrace_5fstats_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_TraceStats_FilterStats_protos_2fperfetto_2fcommon_2ftrace_5fstats_2eproto}, {}};
...
void TraceStats_FilterStats::InitAsDefaultInstance() {
}
...
TraceStats_FilterStats::TraceStats_FilterStats()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:perfetto.protos.TraceStats.FilterStats)
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          input_packets_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          input_bytes_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool TraceStats_FilterStats::MergePartialFromCodedStream(
    ::PROTOBUF_NAMESPACE_ID::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  ::PROTOBUF_NAMESPACE_ID::internal::LiteUnknownFieldSetter unknown_fields_setter(
  ...
  ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:perfetto.protos.TraceStats.FilterStats)
  for (;;) {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (8 & 0xFF)) {
          _Internal::set_has_input_packets(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   ::PROTOBUF_NAMESPACE_ID::uint64, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_UINT64>(
                 input, &input_packets_)));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 2: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (16 & 0xFF)) {
          _Internal::set_has_input_bytes(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   ::PROTOBUF_NAMESPACE_ID::uint64, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_UINT64>(
                 input, &input_bytes_)));
        } else {
      ...
      case 3: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (24 & 0xFF)) {
          _Internal::set_has_output_bytes(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   ::PROTOBUF_NAMESPACE_ID::uint64, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_UINT64>(
                 input, &output_bytes_)));
        } else {
...
success:
  // @@protoc_insertion_point(parse_success:perfetto.protos.TraceStats.FilterStats)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:perfetto.protos.TraceStats.FilterStats)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void TraceStats_FilterStats::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:perfetto.protos.TraceStats.FilterStats)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional uint64 input_packets = 1;
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(1, this->input_packets(), output);
  }

  // optional uint64 input_bytes = 2;
  if (cached_has_bits & 0x00000002u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(2, this->input_bytes(), output);
  }

  // optional uint64 output_bytes = 3;
  if (cached_has_bits & 0x00000004u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(3, this->output_bytes(), output);
  }

  // optional uint64 errors = 4;
  if (cached_has_bits & 0x00000008u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64(4, this->errors(), output);
  }

  output->WriteRaw(_internal_metadata_.unknown_fields().data(),
                   static_cast<int>(_internal_metadata_.unknown_fields().size()));
  // @@protoc_insertion_point(serialize_end:perfetto.protos.TraceStats.FilterStats)
}
...
void TraceStats_FilterStats::InternalSwap(TraceStats_FilterStats* other) {
  ...
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  swap(input_packets_, other->input_packets_);
...
void TraceStats::InitAsDefaultInstance() {
  ::perfetto::protos::_TraceStats_default_instance_._instance.get_mutable()->filter_stats_ = const_cast< ::perfetto::protos::TraceStats_FilterStats*>(
      ::perfetto::protos::TraceStats_FilterStats::internal_default_instance());
}
...
void TraceStats::SharedCtor() {
  ...
  ::memset(&filter_stats_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&invalid_packets_) -
      reinterpret_cast<char*>(&filter_stats_)) + sizeof(invalid_packets_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TraceStats)
  ...
  if (cached_has_bits & 0x00000300u) {
    ::memset(&patches_discarded_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&invalid_packets_) -
        reinterpret_cast<char*>(&patches_discarded_)) + sizeof(invalid_packets_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
...
void TraceStats::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessage(
      11, _Internal::filter_stats(this), output);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.TraceStats)
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      mutable_filter_stats()->::perfetto::protos::TraceStats_FilterStats::MergeFrom(from.filter_stats());
    }
    if (cached_has_bits & 0x00000002u) {
...
template<> PROTOBUF_NOINLINE ::perfetto::protos::TraceStats_FilterStats* Arena::CreateMaybeMessage< ::perfetto::protos::TraceStats_FilterStats >(Arena* arena) {
  return Arena::CreateInternal< ::perfetto::protos::TraceStats_FilterStats >(arena);
}
