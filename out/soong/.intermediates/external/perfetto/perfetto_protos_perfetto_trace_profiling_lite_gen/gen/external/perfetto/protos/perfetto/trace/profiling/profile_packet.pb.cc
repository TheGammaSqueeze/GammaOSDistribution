...
static void InitDefaultsscc_info_PerfSampleDefaults_protos_2fperfetto_2ftrace_2fprofiling_2fprofile_5fpacket_2eproto() {
  ...
  ::perfetto::protos::PerfSampleDefaults::InitAsDefaultInstance();
}
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_PerfSampleDefaults_protos_2fperfetto_2ftrace_2fprofiling_2fprofile_5fpacket_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsscc_info_PerfSampleDefaults_protos_2fperfetto_2ftrace_2fprofiling_2fprofile_5fpacket_2eproto}, {
...
void PerfSampleDefaults::InitAsDefaultInstance() {
  ::perfetto::protos::_PerfSampleDefaults_default_instance_._instance.get_mutable()->timebase_ = const_cast< ::perfetto::protos::PerfEvents_Timebase*>(
...
PerfSampleDefaults::PerfSampleDefaults()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:perfetto.protos.PerfSampleDefaults)
}
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool PerfSampleDefaults::MergePartialFromCodedStream(
    ::PROTOBUF_NAMESPACE_ID::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  ::PROTOBUF_NAMESPACE_ID::internal::LiteUnknownFieldSetter unknown_fields_setter(
  ...
  ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:perfetto.protos.PerfSampleDefaults)
  for (;;) {
    ::std::pair<::PROTOBUF_NAMESPACE_ID::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:perfetto.protos.PerfSampleDefaults)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:perfetto.protos.PerfSampleDefaults)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void PerfSampleDefaults::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:perfetto.protos.PerfSampleDefaults)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessage(
      1, _Internal::timebase(this), output);
  }

  output->WriteRaw(_internal_metadata_.unknown_fields().data(),
                   static_cast<int>(_internal_metadata_.unknown_fields().size()));
  // @@protoc_insertion_point(serialize_end:perfetto.protos.PerfSampleDefaults)
}
...
template<> PROTOBUF_NOINLINE ::perfetto::protos::PerfSampleDefaults* Arena::CreateMaybeMessage< ::perfetto::protos::PerfSampleDefaults >(Arena* arena) {
  return Arena::CreateInternal< ::perfetto::protos::PerfSampleDefaults >(arena);
}
