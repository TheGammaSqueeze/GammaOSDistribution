...
pub const GRPC_ARES: u32 = 0;
pub const GRPC_ALLOW_EXCEPTIONS: u32 = 0;
...
pub const GRPC_ARG_MAX_CHANNEL_TRACE_EVENTS_PER_NODE: &'static [u8; 39usize] =
    b"grpc.max_channel_trace_events_per_node\0";
...
extern "C" {
    #[doc = " GRPC Core POSIX library may internally use signals to optimize some work."]
    #[doc = "The library uses (SIGRTMIN + 6) signal by default. Use this API to instruct"]
    #[doc = "the library to use a different signal i.e 'signum' instead."]
    #[doc = "Note:"]
    #[doc = "- To prevent GRPC library from using any signals, pass a 'signum' of -1"]
    #[doc = "- This API is optional but if called, it MUST be called before grpc_init()"]
    pub fn grpc_use_signal(signum: ::std::os::raw::c_int);
}
extern "C" {
