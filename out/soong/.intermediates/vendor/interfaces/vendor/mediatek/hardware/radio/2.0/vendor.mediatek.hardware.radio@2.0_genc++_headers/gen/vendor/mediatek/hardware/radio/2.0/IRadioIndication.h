#ifndef HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_RADIO_V2_0_IRADIOINDICATION_H
#define HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_RADIO_V2_0_IRADIOINDICATION_H
...
struct IRadioIndication : public ::android::hardware::radio::V1_1::IRadioIndication {
    ...
    /**
     * Fully qualified interface name: "vendor.mediatek.hardware.radio@2.0::IRadioIndication"
     */
    ...
    virtual ::android::hardware::Return<void> incomingCallIndication(::android::hardware::radio::V1_0::RadioIndicationType type, const ::vendor::mediatek::hardware::radio::V2_0::IncomingCallNotification& notification) = 0;

    virtual ::android::hardware::Return<void> cipherIndication() = 0;

    virtual ::android::hardware::Return<void> crssIndication() = 0;

    virtual ::android::hardware::Return<void> vtStatusInfoIndication() = 0;

    virtual ::android::hardware::Return<void> speechCodecInfoIndication() = 0;

    virtual ::android::hardware::Return<void> cdmaCallAccepted() = 0;

    virtual ::android::hardware::Return<void> onVirtualSimOn() = 0;

    virtual ::android::hardware::Return<void> onVirtualSimOff() = 0;

    virtual ::android::hardware::Return<void> onImeiLock() = 0;

    virtual ::android::hardware::Return<void> onImsiRefreshDone() = 0;

    virtual ::android::hardware::Return<void> newEtwsInd() = 0;

    virtual ::android::hardware::Return<void> meSmsStorageFullInd() = 0;

    virtual ::android::hardware::Return<void> smsReadyInd() = 0;

    virtual ::android::hardware::Return<void> dataCallListChangedEx(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::vendor::mediatek::hardware::radio::V2_0::MtkSetupDataCallResult>& dcResponse) = 0;

    virtual ::android::hardware::Return<void> responseCsNetworkStateChangeInd() = 0;

    virtual ::android::hardware::Return<void> eMBMSAtInfoIndication() = 0;

    virtual ::android::hardware::Return<void> eMBMSSessionStatusIndication() = 0;

    virtual ::android::hardware::Return<void> responsePsNetworkStateChangeInd() = 0;

    virtual ::android::hardware::Return<void> responseInvalidSimInd() = 0;

    virtual ::android::hardware::Return<void> responseNetworkEventInd() = 0;

    virtual ::android::hardware::Return<void> responseModulationInfoInd() = 0;

    virtual ::android::hardware::Return<void> dataAllowedNotification() = 0;

    virtual ::android::hardware::Return<void> onPseudoCellInfoInd() = 0;

    virtual ::android::hardware::Return<void> plmnChangedIndication() = 0;

    virtual ::android::hardware::Return<void> registrationSuspendedIndication() = 0;

    virtual ::android::hardware::Return<void> gmssRatChangedIndication() = 0;

    virtual ::android::hardware::Return<void> worldModeChangedIndication() = 0;

    virtual ::android::hardware::Return<void> resetAttachApnInd() = 0;

    virtual ::android::hardware::Return<void> mdChangedApnInd() = 0;

    virtual ::android::hardware::Return<void> esnMeidChangeInd() = 0;

    virtual ::android::hardware::Return<void> responseFemtocellInfo() = 0;

    virtual ::android::hardware::Return<void> phbReadyNotification() = 0;

    virtual ::android::hardware::Return<void> bipProactiveCommand() = 0;

    virtual ::android::hardware::Return<void> triggerOtaSP() = 0;

    virtual ::android::hardware::Return<void> onStkMenuReset() = 0;

    virtual ::android::hardware::Return<void> onMdDataRetryCountReset() = 0;

    virtual ::android::hardware::Return<void> onRemoveRestrictEutran() = 0;

    virtual ::android::hardware::Return<void> onPcoStatus() = 0;

    virtual ::android::hardware::Return<void> onLteAccessStratumStateChanged() = 0;

    virtual ::android::hardware::Return<void> onSimPlugIn() = 0;

    virtual ::android::hardware::Return<void> onSimPlugOut() = 0;

    virtual ::android::hardware::Return<void> onSimMissing() = 0;

    virtual ::android::hardware::Return<void> onSimRecovery() = 0;

    virtual ::android::hardware::Return<void> onSimTrayPlugIn() = 0;

    virtual ::android::hardware::Return<void> onSimCommonSlotNoChanged() = 0;

    virtual ::android::hardware::Return<void> onSimMeLockEvent() = 0;

    virtual ::android::hardware::Return<void> networkInfoInd() = 0;

    virtual ::android::hardware::Return<void> cfuStatusNotify() = 0;

    virtual ::android::hardware::Return<void> pcoDataAfterAttached() = 0;

    virtual ::android::hardware::Return<void> confSRVCC() = 0;

    virtual ::android::hardware::Return<void> onVsimEventIndication() = 0;

    virtual ::android::hardware::Return<void> volteLteConnectionStatus() = 0;

    virtual ::android::hardware::Return<void> dedicatedBearerActivationInd() = 0;

    virtual ::android::hardware::Return<void> dedicatedBearerModificationInd() = 0;

    virtual ::android::hardware::Return<void> dedicatedBearerDeactivationInd() = 0;

    virtual ::android::hardware::Return<void> onWifiMonitoringThreshouldChanged() = 0;

    virtual ::android::hardware::Return<void> onWifiPdnActivate() = 0;

    virtual ::android::hardware::Return<void> onWfcPdnError() = 0;

    virtual ::android::hardware::Return<void> onPdnHandover() = 0;

    virtual ::android::hardware::Return<void> onWifiRoveout() = 0;

    virtual ::android::hardware::Return<void> onLocationRequest() = 0;

    virtual ::android::hardware::Return<void> onWfcPdnStateChanged() = 0;

    virtual ::android::hardware::Return<void> onNattKeepAliveChanged() = 0;

    virtual ::android::hardware::Return<void> oemHookRaw() = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadioIndication>> castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadioIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadioIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadioIndication>> castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadioIndication>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadioIndication>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadioIndication>& o);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadioIndication>& o) {
    ...
    os += ::vendor::mediatek::hardware::radio::V2_0::IRadioIndication::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_RADIO_V2_0_IRADIOINDICATION_H
