#ifndef HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_RADIO_V2_6_IRADIO_H
#define HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_RADIO_V2_6_IRADIO_H
...
struct IRadio : public ::vendor::mediatek::hardware::radio::V2_5::IRadio {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.mediatek.hardware.radio@2.6::IRadio"
     */
    ...
    virtual ::android::hardware::Return<void> setResponseFunctionsMtk(const ::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadioResponse>& responseCb, const ::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadioIndication>& indicationCb) = 0;

    virtual ::android::hardware::Return<void> setResponseFunctionsIms() = 0;

    virtual ::android::hardware::Return<void> setTrm() = 0;

    virtual ::android::hardware::Return<void> getATR() = 0;

    virtual ::android::hardware::Return<void> setSimPower() = 0;

    virtual ::android::hardware::Return<void> hangupAll() = 0;

    virtual ::android::hardware::Return<void> setCallIndication(int32_t serial, int32_t mode, int32_t callId, int32_t seqNo) = 0;

    virtual ::android::hardware::Return<void> emergencyDial() = 0;

    virtual ::android::hardware::Return<void> setEccServiceCategory() = 0;

    virtual ::android::hardware::Return<void> setEccList() = 0;

    virtual ::android::hardware::Return<void> vtDial() = 0;

    virtual ::android::hardware::Return<void> voiceAccept() = 0;

    virtual ::android::hardware::Return<void> replaceVtCall() = 0;

    virtual ::android::hardware::Return<void> currentStatus() = 0;

    virtual ::android::hardware::Return<void> eccPreferredRat() = 0;

    virtual ::android::hardware::Return<void> videoCallAccept() = 0;

    virtual ::android::hardware::Return<void> imsEctCommand() = 0;

    virtual ::android::hardware::Return<void> holdCall() = 0;

    virtual ::android::hardware::Return<void> resumeCall() = 0;

    virtual ::android::hardware::Return<void> imsDeregNotification() = 0;

    virtual ::android::hardware::Return<void> setImsEnable() = 0;

    virtual ::android::hardware::Return<void> setVolteEnable() = 0;

    virtual ::android::hardware::Return<void> setWfcEnable() = 0;

    virtual ::android::hardware::Return<void> setVilteEnable() = 0;

    virtual ::android::hardware::Return<void> setViWifiEnable() = 0;

    virtual ::android::hardware::Return<void> setImsVoiceEnable() = 0;

    virtual ::android::hardware::Return<void> setImsVideoEnable() = 0;

    virtual ::android::hardware::Return<void> setImsCfg() = 0;

    virtual ::android::hardware::Return<void> getProvisionValue() = 0;

    virtual ::android::hardware::Return<void> setProvisionValue() = 0;

    virtual ::android::hardware::Return<void> addImsConferenceCallNumber() = 0;

    virtual ::android::hardware::Return<void> removeImsConferenceCallNumber() = 0;

    virtual ::android::hardware::Return<void> setWfcProfile() = 0;

    virtual ::android::hardware::Return<void> conferenceDial() = 0;

    virtual ::android::hardware::Return<void> vtDialWithSipUri() = 0;

    virtual ::android::hardware::Return<void> dialWithSipUri() = 0;

    virtual ::android::hardware::Return<void> sendUssi() = 0;

    virtual ::android::hardware::Return<void> cancelUssi() = 0;

    virtual ::android::hardware::Return<void> forceReleaseCall() = 0;

    virtual ::android::hardware::Return<void> imsBearerActivationDone() = 0;

    virtual ::android::hardware::Return<void> imsBearerDeactivationDone() = 0;

    virtual ::android::hardware::Return<void> setImsRtpReport() = 0;

    virtual ::android::hardware::Return<void> pullCall() = 0;

    virtual ::android::hardware::Return<void> setImsRegistrationReport() = 0;

    virtual ::android::hardware::Return<void> setResponseFunctionsForAtci() = 0;

    virtual ::android::hardware::Return<void> sendAtciRequest() = 0;

    virtual ::android::hardware::Return<void> setModemPower() = 0;

    virtual ::android::hardware::Return<void> setNetworkSelectionModeManualWithAct() = 0;

    virtual ::android::hardware::Return<void> getAvailableNetworksWithAct() = 0;

    virtual ::android::hardware::Return<void> cancelAvailableNetworks() = 0;

    virtual ::android::hardware::Return<void> getSmsParameters() = 0;

    virtual ::android::hardware::Return<void> setSmsParameters() = 0;

    virtual ::android::hardware::Return<void> getSmsMemStatus() = 0;

    virtual ::android::hardware::Return<void> setEtws() = 0;

    virtual ::android::hardware::Return<void> removeCbMsg() = 0;

    virtual ::android::hardware::Return<void> setGsmBroadcastLangs() = 0;

    virtual ::android::hardware::Return<void> getGsmBroadcastLangs() = 0;

    virtual ::android::hardware::Return<void> getGsmBroadcastActivation() = 0;

    virtual ::android::hardware::Return<void> sendEmbmsAtCommand() = 0;

    virtual ::android::hardware::Return<void> setApcMode() = 0;

    virtual ::android::hardware::Return<void> getApcInfo() = 0;

    virtual ::android::hardware::Return<void> triggerModeSwitchByEcc() = 0;

    virtual ::android::hardware::Return<void> getSmsRuimMemoryStatus() = 0;

    virtual ::android::hardware::Return<void> setFdMode() = 0;

    virtual ::android::hardware::Return<void> setResumeRegistration() = 0;

    virtual ::android::hardware::Return<void> storeModemType() = 0;

    virtual ::android::hardware::Return<void> reloadModemType() = 0;

    virtual ::android::hardware::Return<void> setInitialAttachApnEx() = 0;

    virtual ::android::hardware::Return<void> handleStkCallSetupRequestFromSimWithResCode() = 0;

    virtual ::android::hardware::Return<void> getFemtocellList() = 0;

    virtual ::android::hardware::Return<void> abortFemtocellList() = 0;

    virtual ::android::hardware::Return<void> selectFemtocell() = 0;

    virtual ::android::hardware::Return<void> queryFemtoCellSystemSelectionMode() = 0;

    virtual ::android::hardware::Return<void> setFemtoCellSystemSelectionMode() = 0;

    virtual ::android::hardware::Return<void> setBarringPasswordCheckedByNW() = 0;

    virtual ::android::hardware::Return<void> setClip() = 0;

    virtual ::android::hardware::Return<void> getColp() = 0;

    virtual ::android::hardware::Return<void> getColr() = 0;

    virtual ::android::hardware::Return<void> sendCnap() = 0;

    virtual ::android::hardware::Return<void> setColp() = 0;

    virtual ::android::hardware::Return<void> setColr() = 0;

    virtual ::android::hardware::Return<void> queryCallForwardInTimeSlotStatus() = 0;

    virtual ::android::hardware::Return<void> setCallForwardInTimeSlot() = 0;

    virtual ::android::hardware::Return<void> runGbaAuthentication() = 0;

    virtual ::android::hardware::Return<void> queryPhbStorageInfo() = 0;

    virtual ::android::hardware::Return<void> writePhbEntry() = 0;

    virtual ::android::hardware::Return<void> readPhbEntry() = 0;

    virtual ::android::hardware::Return<void> queryUPBCapability() = 0;

    virtual ::android::hardware::Return<void> editUPBEntry() = 0;

    virtual ::android::hardware::Return<void> deleteUPBEntry() = 0;

    virtual ::android::hardware::Return<void> readUPBGasList() = 0;

    virtual ::android::hardware::Return<void> readUPBGrpEntry() = 0;

    virtual ::android::hardware::Return<void> writeUPBGrpEntry() = 0;

    virtual ::android::hardware::Return<void> getPhoneBookStringsLength() = 0;

    virtual ::android::hardware::Return<void> getPhoneBookMemStorage() = 0;

    virtual ::android::hardware::Return<void> setPhoneBookMemStorage() = 0;

    virtual ::android::hardware::Return<void> readPhoneBookEntryExt() = 0;

    virtual ::android::hardware::Return<void> writePhoneBookEntryExt() = 0;

    virtual ::android::hardware::Return<void> queryUPBAvailable() = 0;

    virtual ::android::hardware::Return<void> readUPBEmailEntry() = 0;

    virtual ::android::hardware::Return<void> readUPBSneEntry() = 0;

    virtual ::android::hardware::Return<void> readUPBAnrEntry() = 0;

    virtual ::android::hardware::Return<void> readUPBAasList() = 0;

    virtual ::android::hardware::Return<void> doGeneralSimAuthentication() = 0;

    virtual ::android::hardware::Return<void> queryNetworkLock() = 0;

    virtual ::android::hardware::Return<void> setNetworkLock() = 0;

    virtual ::android::hardware::Return<void> resetRadio() = 0;

    virtual ::android::hardware::Return<void> syncDataSettingsToMd(int32_t serial, const ::android::hardware::hidl_vec<int32_t>& dataSettings) = 0;

    virtual ::android::hardware::Return<void> resetMdDataRetryCount(int32_t serial, const ::android::hardware::hidl_string& apn) = 0;

    virtual ::android::hardware::Return<void> setRemoveRestrictEutranMode() = 0;

    virtual ::android::hardware::Return<void> setLteAccessStratumReport() = 0;

    virtual ::android::hardware::Return<void> setLteUplinkDataTransfer() = 0;

    virtual ::android::hardware::Return<void> setRxTestConfig() = 0;

    virtual ::android::hardware::Return<void> getRxTestResult() = 0;

    virtual ::android::hardware::Return<void> getPOLCapability() = 0;

    virtual ::android::hardware::Return<void> getCurrentPOLList() = 0;

    virtual ::android::hardware::Return<void> setPOLEntry() = 0;

    virtual ::android::hardware::Return<void> setRoamingEnable() = 0;

    virtual ::android::hardware::Return<void> getRoamingEnable() = 0;

    virtual ::android::hardware::Return<void> setDataProfileEx() = 0;

    virtual ::android::hardware::Return<void> sendVsimNotification() = 0;

    virtual ::android::hardware::Return<void> sendVsimOperation() = 0;

    virtual ::android::hardware::Return<void> setVoiceDomainPreference() = 0;

    virtual ::android::hardware::Return<void> setModemImsCfg() = 0;

    virtual ::android::hardware::Return<void> setWifiEnable() = 0;

    virtual ::android::hardware::Return<void> setWifiAssociated() = 0;

    virtual ::android::hardware::Return<void> setWifiSignalLevel() = 0;

    virtual ::android::hardware::Return<void> setWifiIpAddress() = 0;

    virtual ::android::hardware::Return<void> setLocationInfo() = 0;

    virtual ::android::hardware::Return<void> setEmergencyAddressId() = 0;

    virtual ::android::hardware::Return<void> setE911State() = 0;

    virtual ::android::hardware::Return<void> setServiceStateToModem(int32_t serial, int32_t voiceRegState, int32_t dataRegState, int32_t voiceRoamingType, int32_t dataRoamingType, int32_t rilVoiceRegState, int32_t rilDataRegState) = 0;

    virtual ::android::hardware::Return<void> sendRequestRaw() = 0;

    virtual ::android::hardware::Return<void> sendRequestStrings() = 0;

    virtual ::android::hardware::Return<void> setNattKeepAliveStatus() = 0;

    virtual ::android::hardware::Return<void> setWifiFlightModeEnabled() = 0;

    virtual ::android::hardware::Return<void> setLocationInfoWlanMac() = 0;

    virtual ::android::hardware::Return<void> setWifiPingResult() = 0;

    virtual ::android::hardware::Return<void> setResponseFunctionsSubsidyLock() = 0;

    virtual ::android::hardware::Return<void> sendSubsidyLockRequest() = 0;

    virtual ::android::hardware::Return<void> setSmsFwkReady(int32_t ready) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_5::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_3::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_2::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_1::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadio>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>& o);
...
static inline std::string toString(const ::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>& o) {
    ...
    os += ::vendor::mediatek::hardware::radio::V2_6::IRadio::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_MEDIATEK_HARDWARE_RADIO_V2_6_IRADIO_H
