#define LOG_TAG "vendor.mediatek.hardware.radio@2.4::Radio"
...
#include <vendor/mediatek/hardware/radio/2.4/BnHwRadio.h>
#include <vendor/mediatek/hardware/radio/2.4/BsRadio.h>
...
const char* IRadio::descriptor("vendor.mediatek.hardware.radio@2.4::IRadio");
...
::android::hardware::Return<void> IRadio::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::vendor::mediatek::hardware::radio::V2_4::IRadio::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_3::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::vendor::mediatek::hardware::radio::V2_3::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.4::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_2::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::vendor::mediatek::hardware::radio::V2_2::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.4::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_1::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::vendor::mediatek::hardware::radio::V2_1::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.4::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::vendor::mediatek::hardware::radio::V2_0::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.4::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>> IRadio::castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::android::hardware::radio::V1_1::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.4::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>> IRadio::castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::android::hardware::radio::V1_0::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.4::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>> IRadio::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwRadio::BpHwRadio(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IRadio>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("vendor.mediatek.hardware.radio@2.4", "IRadio") {
}
...
// Methods from ::vendor::mediatek::hardware::radio::V2_4::IRadio follow.
::android::hardware::Return<void> BpHwRadio::_hidl_setWifiPingResult(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::setWifiPingResult::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.mediatek.hardware.radio", "2.4", "IRadio", "setWifiPingResult", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(274 /* setWifiPingResult */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.mediatek.hardware.radio", "2.4", "IRadio", "setWifiPingResult", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwRadio::BnHwRadio(const ::android::sp<IRadio> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "vendor.mediatek.hardware.radio@2.4", "IRadio") { 
...
// Methods from ::vendor::mediatek::hardware::radio::V2_4::IRadio follow.
::android::status_t BnHwRadio::_hidl_setWifiPingResult(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::setWifiPingResult::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.mediatek.hardware.radio", "2.4", "IRadio", "setWifiPingResult", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->setWifiPingResult();
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.mediatek.hardware.radio", "2.4", "IRadio", "setWifiPingResult", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsRadio::BsRadio(const ::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio> impl) : ::android::hardware::details::HidlInstrumentor("vendor.mediatek.hardware.radio@2.4", "IRadio"), mImpl(impl) {
...
bool IRadio::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("vendor.mediatek.hardware.radio@2.4::IRadio",
