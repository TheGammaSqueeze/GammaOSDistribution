#define LOG_TAG "vendor.mediatek.hardware.radio@2.6::Radio"
...
#include <vendor/mediatek/hardware/radio/2.6/BpHwRadio.h>
#include <vendor/mediatek/hardware/radio/2.6/BnHwRadio.h>
#include <vendor/mediatek/hardware/radio/2.6/BsRadio.h>
...
const char* IRadio::descriptor("vendor.mediatek.hardware.radio@2.6::IRadio");
...
// no default implementation for: ::android::hardware::Return<void> IRadio::setSmsFwkReady(int32_t ready)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IRadio::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::vendor::mediatek::hardware::radio::V2_6::IRadio::descriptor,
...
::android::hardware::Return<void> IRadio::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::vendor::mediatek::hardware::radio::V2_6::IRadio::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<void> IRadio::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        ...
        (uint8_t[32]){171,198,137,149,166,215,232,111,233,1,243,248,112,188,108,210,185,112,39,48,55,70,47,157,7,202,153,192,26,111,139,172} /* abc68995a6d7e86fe901f3f870bc6cd2b970273037462f9d07ca99c01a6f8bac */,
...
::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_5::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::vendor::mediatek::hardware::radio::V2_5::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.6::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_4::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::vendor::mediatek::hardware::radio::V2_4::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.6::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_3::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::vendor::mediatek::hardware::radio::V2_3::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.6::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_2::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::vendor::mediatek::hardware::radio::V2_2::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.6::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_1::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::vendor::mediatek::hardware::radio::V2_1::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.6::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> IRadio::castFrom(const ::android::sp<::vendor::mediatek::hardware::radio::V2_0::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::vendor::mediatek::hardware::radio::V2_0::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.6::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> IRadio::castFrom(const ::android::sp<::android::hardware::radio::V1_1::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::android::hardware::radio::V1_1::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.6::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> IRadio::castFrom(const ::android::sp<::android::hardware::radio::V1_0::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::android::hardware::radio::V1_0::IRadio, BpHwRadio>(
            parent, "vendor.mediatek.hardware.radio@2.6::IRadio", emitError);
}

::android::hardware::Return<::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio>> IRadio::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwRadio::BpHwRadio(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IRadio>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("vendor.mediatek.hardware.radio@2.6", "IRadio") {
}
...
// Methods from ::vendor::mediatek::hardware::radio::V2_6::IRadio follow.
::android::hardware::Return<void> BpHwRadio::_hidl_setSmsFwkReady(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t ready) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::setSmsFwkReady::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&ready);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.mediatek.hardware.radio", "2.6", "IRadio", "setSmsFwkReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_err = _hidl_data.writeInt32(ready);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(277 /* setSmsFwkReady */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.mediatek.hardware.radio", "2.6", "IRadio", "setSmsFwkReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::vendor::mediatek::hardware::radio::V2_6::IRadio follow.
::android::hardware::Return<void> BpHwRadio::setSmsFwkReady(int32_t ready){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::mediatek::hardware::radio::V2_6::BpHwRadio::_hidl_setSmsFwkReady(this, this, ready);
...
BnHwRadio::BnHwRadio(const ::android::sp<IRadio> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "vendor.mediatek.hardware.radio@2.6", "IRadio") { 
...
// Methods from ::vendor::mediatek::hardware::radio::V2_6::IRadio follow.
::android::status_t BnHwRadio::_hidl_setSmsFwkReady(
    ...
    _hidl_err = _hidl_data.readInt32(&ready);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::setSmsFwkReady::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&ready);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.mediatek.hardware.radio", "2.6", "IRadio", "setSmsFwkReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->setSmsFwkReady(ready);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.mediatek.hardware.radio", "2.6", "IRadio", "setSmsFwkReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 277 /* setSmsFwkReady */:
        {
            _hidl_err = ::vendor::mediatek::hardware::radio::V2_6::BnHwRadio::_hidl_setSmsFwkReady(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsRadio::BsRadio(const ::android::sp<::vendor::mediatek::hardware::radio::V2_6::IRadio> impl) : ::android::hardware::details::HidlInstrumentor("vendor.mediatek.hardware.radio@2.6", "IRadio"), mImpl(impl) {
...
bool IRadio::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("vendor.mediatek.hardware.radio@2.6::IRadio",
