#ifndef HIDL_GENERATED_VENDOR_OPLUS_HARDWARE_BIOMETRICS_FINGERPRINT_V2_1_BPHWBIOMETRICSFINGERPRINTCLIENTCALLBACK_H
#define HIDL_GENERATED_VENDOR_OPLUS_HARDWARE_BIOMETRICS_FINGERPRINT_V2_1_BPHWBIOMETRICSFINGERPRINTCLIENTCALLBACK_H

#include <hidl/HidlTransportSupport.h>

#include <vendor/oplus/hardware/biometrics/fingerprint/2.1/IHwBiometricsFingerprintClientCallback.h>
...
struct BpHwBiometricsFingerprintClientCallback : public ::android::hardware::BpInterface<IBiometricsFingerprintClientCallback>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_onAcquired(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId, ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintAcquiredInfo acquiredInfo, int32_t vendorCode);
    ...
    static ::android::hardware::Return<void>  _hidl_onError(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId, ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintError error, int32_t vendorCode);
...
#endif  // HIDL_GENERATED_VENDOR_OPLUS_HARDWARE_BIOMETRICS_FINGERPRINT_V2_1_BPHWBIOMETRICSFINGERPRINTCLIENTCALLBACK_H
