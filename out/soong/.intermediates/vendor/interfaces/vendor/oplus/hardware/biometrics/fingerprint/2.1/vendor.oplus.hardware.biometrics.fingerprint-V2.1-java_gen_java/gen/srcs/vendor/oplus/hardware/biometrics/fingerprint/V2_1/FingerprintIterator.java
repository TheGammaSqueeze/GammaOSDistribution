...
public final class FingerprintIterator {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintIterator.class) {
            return false;
        }
        vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintIterator other = (vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintIterator)otherObject;
    ...
    public static final java.util.ArrayList<FingerprintIterator> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintIterator _hidl_vec_element = new vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintIterator();
                ((vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintIterator) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 12);
