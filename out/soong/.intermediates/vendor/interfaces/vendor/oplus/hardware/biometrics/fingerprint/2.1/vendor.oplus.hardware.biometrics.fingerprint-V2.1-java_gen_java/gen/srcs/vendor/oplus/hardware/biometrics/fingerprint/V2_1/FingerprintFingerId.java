...
public final class FingerprintFingerId {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId.class) {
            return false;
        }
        vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId other = (vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId)otherObject;
    ...
    public static final java.util.ArrayList<FingerprintFingerId> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId _hidl_vec_element = new vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId();
                ((vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 8);
