...
public final class FingerprintAuthenticated {
    public vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId finger = new vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId();
    public byte[/* 69 */] hat = new byte[69];
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated.class) {
            return false;
        }
        vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated other = (vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated)otherObject;
    ...
    public static final java.util.ArrayList<FingerprintAuthenticated> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated _hidl_vec_element = new vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated();
                ((vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 80);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((vendor.oplus.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId) finger).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        {
