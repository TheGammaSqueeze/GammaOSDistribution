...
public interface IBiometricsFingerprintClientCallback extends android.hidl.base.V1_0.IBase {
     ...
     */
    public static final String kInterfaceName = "vendor.oplus.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback";
     ...
     */
    public static IBiometricsFingerprintClientCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IBiometricsFingerprintClientCallback.asInterface(android.os.HwBinder.getService("vendor.oplus.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback", serviceName, retry));
    }

    /**
     * Calls getService("default",retry).
     */
    public static IBiometricsFingerprintClientCallback getService(boolean retry) throws android.os.RemoteException {
    ...
    public static IBiometricsFingerprintClientCallback getService(String serviceName) throws android.os.RemoteException {
        return IBiometricsFingerprintClientCallback.asInterface(android.os.HwBinder.getService("vendor.oplus.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback", serviceName));
    }
    ...
    void onImageInfoAcquired(int type, int quality, int match_score)
        throws android.os.RemoteException;
    void onSyncTemplates(long deviceId, java.util.ArrayList<Integer> fingerId, int remaining)
        throws android.os.RemoteException;
    void onEngineeringInfoUpdated(int length, java.util.ArrayList<Integer> keys, java.util.ArrayList<String> values)
        throws android.os.RemoteException;
    void onFingerprintCmd(int deviceId, java.util.ArrayList<Integer> groupId, int remaining)
        throws android.os.RemoteException;
    void onUIReady(long deviceId)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements IBiometricsFingerprintClientCallback {
        ...
        public void onEnrollResult(long deviceId, int fingerId, int groupId, int remaining)
            ...
            _hidl_request.writeInterfaceToken(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.kInterfaceName);
        ...
        public void onAcquired(long deviceId, int acquiredInfo, int vendorCode)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(2 /* onAcquired */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void onAuthenticated(long deviceId, int fingerId, int groupId, java.util.ArrayList<Byte> token)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(3 /* onAuthenticated */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void onTouchDown(long deviceId)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(7 /* onTouchDown */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void onTouchUp(long deviceId)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(8 /* onTouchUp */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void onMonitorEventTriggered(int type, String data)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(9 /* onMonitorEventTriggered */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void onImageInfoAcquired(int type, int quality, int match_score)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(10 /* onImageInfoAcquired */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override
        public void onSyncTemplates(long deviceId, java.util.ArrayList<Integer> fingerId, int remaining)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.kInterfaceName);
            _hidl_request.writeInt64(deviceId);
            _hidl_request.writeInt32Vector(fingerId);
            _hidl_request.writeInt32(remaining);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(11 /* onSyncTemplates */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override
        public void onEngineeringInfoUpdated(int length, java.util.ArrayList<Integer> keys, java.util.ArrayList<String> values)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(12 /* onEngineeringInfoUpdated */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override
        public void onFingerprintCmd(int deviceId, java.util.ArrayList<Integer> groupId, int remaining)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.kInterfaceName);
            _hidl_request.writeInt32(deviceId);
            _hidl_request.writeInt32Vector(groupId);
            _hidl_request.writeInt32(remaining);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(13 /* onFingerprintCmd */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override
        public void onUIReady(long deviceId)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.kInterfaceName);
            _hidl_request.writeInt64(deviceId);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(14 /* onUIReady */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
    ...
    public static abstract class Stub extends android.os.HwBinder implements IBiometricsFingerprintClientCallback {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.kInterfaceName;
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                {
                    _hidl_request.enforceInterface(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.kInterfaceName);
                ...
                case 11 /* onSyncTemplates */:
                {
                    ...
                    long deviceId = _hidl_request.readInt64();
                    java.util.ArrayList<Integer> fingerId = _hidl_request.readInt32Vector();
                    int remaining = _hidl_request.readInt32();
                    onSyncTemplates(deviceId, fingerId, remaining);
                    break;
                }
                ...
                case 12 /* onEngineeringInfoUpdated */:
                {
                    ...
                    onEngineeringInfoUpdated(length, keys, values);
                    break;
                }
                ...
                case 13 /* onFingerprintCmd */:
                {
                    ...
                    int deviceId = _hidl_request.readInt32();
                    java.util.ArrayList<Integer> groupId = _hidl_request.readInt32Vector();
                    int remaining = _hidl_request.readInt32();
                    onFingerprintCmd(deviceId, groupId, remaining);
                    break;
                }
