#define LOG_TAG "vendor.oplus.hardware.biometrics.fingerprint@2.1::BiometricsFingerprintClientCallback"
...
#include <vendor/oplus/hardware/biometrics/fingerprint/2.1/BpHwBiometricsFingerprintClientCallback.h>
#include <vendor/oplus/hardware/biometrics/fingerprint/2.1/BnHwBiometricsFingerprintClientCallback.h>
#include <vendor/oplus/hardware/biometrics/fingerprint/2.1/BsBiometricsFingerprintClientCallback.h>
...
const char* IBiometricsFingerprintClientCallback::descriptor("vendor.oplus.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback");
...
// Methods from ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprintClientCallback follow.
...
// no default implementation for: ::android::hardware::Return<void> IBiometricsFingerprintClientCallback::onAcquired(uint64_t deviceId, ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintAcquiredInfo acquiredInfo, int32_t vendorCode)
...
// no default implementation for: ::android::hardware::Return<void> IBiometricsFingerprintClientCallback::onError(uint64_t deviceId, ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintError error, int32_t vendorCode)
...
::android::hardware::Return<void> IBiometricsFingerprintClientCallback::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprintClientCallback::descriptor,
...
::android::hardware::Return<void> IBiometricsFingerprintClientCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::vendor::oplus::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprintClientCallback::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::vendor::oplus::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprintClientCallback>> IBiometricsFingerprintClientCallback::castFrom(const ::android::sp<::vendor::oplus::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprintClientCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::vendor::oplus::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprintClientCallback>> IBiometricsFingerprintClientCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IBiometricsFingerprintClientCallback, ::android::hidl::base::V1_0::IBase, BpHwBiometricsFingerprintClientCallback>(
            parent, "vendor.oplus.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback", emitError);
}
...
BpHwBiometricsFingerprintClientCallback::BpHwBiometricsFingerprintClientCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IBiometricsFingerprintClientCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("vendor.oplus.hardware.biometrics.fingerprint@2.1", "IBiometricsFingerprintClientCallback") {
}
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onEnrollResult(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId, uint32_t fingerId, uint32_t groupId, uint32_t remaining) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEnrollResult", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEnrollResult", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onAcquired(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId, ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintAcquiredInfo acquiredInfo, int32_t vendorCode) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onAcquired", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onAcquired", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onAuthenticated(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId, uint32_t fingerId, uint32_t groupId, const ::android::hardware::hidl_vec<uint8_t>& token) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onAuthenticated", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onAuthenticated", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onError(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId, ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintError error, int32_t vendorCode) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&vendorCode);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onError", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onError", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onRemoved(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId, uint32_t fingerId, uint32_t groupId, uint32_t remaining) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&remaining);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onRemoved", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onRemoved", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onEnumerate(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId, uint32_t fingerId, uint32_t groupId, uint32_t remaining) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&remaining);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEnumerate", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEnumerate", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onTouchDown(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&deviceId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onTouchDown", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onTouchDown", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onTouchUp(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&deviceId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onTouchUp", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onTouchUp", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onMonitorEventTriggered(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t type, const ::android::hardware::hidl_string& data) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onMonitorEventTriggered", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onMonitorEventTriggered", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onImageInfoAcquired(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t type, uint32_t quality, uint32_t match_score) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onImageInfoAcquired", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onImageInfoAcquired", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onSyncTemplates(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t deviceId, const ::android::hardware::hidl_vec<uint32_t>& fingerId, uint32_t remaining) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&remaining);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onSyncTemplates", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onSyncTemplates", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onEngineeringInfoUpdated(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t length, const ::android::hardware::hidl_vec<uint32_t>& keys, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& values) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEngineeringInfoUpdated", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEngineeringInfoUpdated", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onFingerprintCmd(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t deviceId, const ::android::hardware::hidl_vec<uint32_t>& groupId, uint32_t remaining) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&remaining);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onFingerprintCmd", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onFingerprintCmd", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::_hidl_onUIReady(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int64_t deviceId) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&deviceId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onUIReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onUIReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onEnrollResult(uint64_t deviceId, uint32_t fingerId, uint32_t groupId, uint32_t remaining){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onEnrollResult(this, this, deviceId, fingerId, groupId, remaining);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onAcquired(uint64_t deviceId, ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintAcquiredInfo acquiredInfo, int32_t vendorCode){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onAcquired(this, this, deviceId, acquiredInfo, vendorCode);
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onAuthenticated(uint64_t deviceId, uint32_t fingerId, uint32_t groupId, const ::android::hardware::hidl_vec<uint8_t>& token){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onAuthenticated(this, this, deviceId, fingerId, groupId, token);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onError(uint64_t deviceId, ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintError error, int32_t vendorCode){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onError(this, this, deviceId, error, vendorCode);
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onRemoved(uint64_t deviceId, uint32_t fingerId, uint32_t groupId, uint32_t remaining){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onRemoved(this, this, deviceId, fingerId, groupId, remaining);
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onEnumerate(uint64_t deviceId, uint32_t fingerId, uint32_t groupId, uint32_t remaining){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onEnumerate(this, this, deviceId, fingerId, groupId, remaining);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onTouchDown(uint64_t deviceId){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onTouchDown(this, this, deviceId);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onTouchUp(uint64_t deviceId){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onTouchUp(this, this, deviceId);
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onMonitorEventTriggered(uint32_t type, const ::android::hardware::hidl_string& data){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onMonitorEventTriggered(this, this, type, data);
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onImageInfoAcquired(uint32_t type, uint32_t quality, uint32_t match_score){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onImageInfoAcquired(this, this, type, quality, match_score);
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onSyncTemplates(uint64_t deviceId, const ::android::hardware::hidl_vec<uint32_t>& fingerId, uint32_t remaining){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onSyncTemplates(this, this, deviceId, fingerId, remaining);
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onEngineeringInfoUpdated(uint32_t length, const ::android::hardware::hidl_vec<uint32_t>& keys, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& values){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onEngineeringInfoUpdated(this, this, length, keys, values);
...
::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onFingerprintCmd(int32_t deviceId, const ::android::hardware::hidl_vec<uint32_t>& groupId, uint32_t remaining){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onFingerprintCmd(this, this, deviceId, groupId, remaining);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwBiometricsFingerprintClientCallback::onUIReady(int64_t deviceId){
    ::android::hardware::Return<void>  _hidl_out = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BpHwBiometricsFingerprintClientCallback::_hidl_onUIReady(this, this, deviceId);
...
BnHwBiometricsFingerprintClientCallback::BnHwBiometricsFingerprintClientCallback(const ::android::sp<IBiometricsFingerprintClientCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "vendor.oplus.hardware.biometrics.fingerprint@2.1", "IBiometricsFingerprintClientCallback") { 
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onEnrollResult(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&remaining);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEnrollResult", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEnrollResult", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onAcquired(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&vendorCode);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onAcquired", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onAcquired", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onAuthenticated(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)token);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onAuthenticated", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onAuthenticated", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onError(
    ...
    uint64_t deviceId;
    ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::FingerprintError error;
    int32_t vendorCode;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&vendorCode);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onError", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onError", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onRemoved(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&remaining);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onRemoved", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onRemoved", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onEnumerate(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&remaining);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEnumerate", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEnumerate", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onTouchDown(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&deviceId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onTouchDown", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onTouchDown", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onTouchUp(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&deviceId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onTouchUp", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onTouchUp", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onMonitorEventTriggered(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)data);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onMonitorEventTriggered", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onMonitorEventTriggered", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onImageInfoAcquired(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&match_score);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onImageInfoAcquired", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onImageInfoAcquired", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onSyncTemplates(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&remaining);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onSyncTemplates", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onSyncTemplates", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onEngineeringInfoUpdated(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)values);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEngineeringInfoUpdated", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onEngineeringInfoUpdated", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onFingerprintCmd(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&remaining);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onFingerprintCmd", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onFingerprintCmd", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::_hidl_onUIReady(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&deviceId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onUIReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "vendor.oplus.hardware.biometrics.fingerprint", "2.1", "IBiometricsFingerprintClientCallback", "onUIReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBiometricsFingerprintClientCallback::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onEnrollResult(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 2 /* onAcquired */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onAcquired(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 3 /* onAuthenticated */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onAuthenticated(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 4 /* onError */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onError(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 5 /* onRemoved */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onRemoved(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 6 /* onEnumerate */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onEnumerate(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 7 /* onTouchDown */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onTouchDown(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 8 /* onTouchUp */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onTouchUp(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 9 /* onMonitorEventTriggered */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onMonitorEventTriggered(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 10 /* onImageInfoAcquired */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onImageInfoAcquired(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 11 /* onSyncTemplates */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onSyncTemplates(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 12 /* onEngineeringInfoUpdated */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onEngineeringInfoUpdated(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 13 /* onFingerprintCmd */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onFingerprintCmd(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 14 /* onUIReady */:
        {
            _hidl_err = ::vendor::oplus::hardware::biometrics::fingerprint::V2_1::BnHwBiometricsFingerprintClientCallback::_hidl_onUIReady(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsBiometricsFingerprintClientCallback::BsBiometricsFingerprintClientCallback(const ::android::sp<::vendor::oplus::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprintClientCallback> impl) : ::android::hardware::details::HidlInstrumentor("vendor.oplus.hardware.biometrics.fingerprint@2.1", "IBiometricsFingerprintClientCallback"), mImpl(impl) {
...
bool IBiometricsFingerprintClientCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("vendor.oplus.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback",
