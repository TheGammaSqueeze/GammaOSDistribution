...
public interface IQcRilAudio extends android.hidl.base.V1_0.IBase {
     ...
     */
    public static IQcRilAudio getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IQcRilAudio.asInterface(android.os.HwBinder.getService("vendor.qti.hardware.radio.am@1.0::IQcRilAudio", serviceName, retry));
    }

    /**
     * Calls getService("default",retry).
     */
    public static IQcRilAudio getService(boolean retry) throws android.os.RemoteException {
    ...
    void setCallback(vendor.qti.hardware.radio.am.V1_0.IQcRilAudioCallback iQcRilAudioCallback)
    ...
    public static final class Proxy implements IQcRilAudio {
        ...
        @Override
        public void setCallback(vendor.qti.hardware.radio.am.V1_0.IQcRilAudioCallback iQcRilAudioCallback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.qti.hardware.radio.am.V1_0.IQcRilAudio.kInterfaceName);
            _hidl_request.writeStrongBinder(iQcRilAudioCallback == null ? null : iQcRilAudioCallback.asBinder());

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(1 /* setCallback */, _hidl_request, _hidl_reply, 1 /* oneway */);
        ...
        public void setError(int error)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(2 /* setError */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
    ...
    public static abstract class Stub extends android.os.HwBinder implements IQcRilAudio {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    vendor.qti.hardware.radio.am.V1_0.IQcRilAudio.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return vendor.qti.hardware.radio.am.V1_0.IQcRilAudio.kInterfaceName;
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                case 1 /* setCallback */:
                {
                    _hidl_request.enforceInterface(vendor.qti.hardware.radio.am.V1_0.IQcRilAudio.kInterfaceName);

                    vendor.qti.hardware.radio.am.V1_0.IQcRilAudioCallback iQcRilAudioCallback = vendor.qti.hardware.radio.am.V1_0.IQcRilAudioCallback.asInterface(_hidl_request.readStrongBinder());
