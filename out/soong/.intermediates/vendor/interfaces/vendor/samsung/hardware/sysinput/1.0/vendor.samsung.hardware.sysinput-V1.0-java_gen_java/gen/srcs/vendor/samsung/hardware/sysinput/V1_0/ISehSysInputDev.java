...
public interface ISehSysInputDev extends android.hidl.base.V1_0.IBase {
    /**
    ...
    public static ISehSysInputDev getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISehSysInputDev.asInterface(android.os.HwBinder.getService("vendor.samsung.hardware.sysinput@1.0::ISehSysInputDev", serviceName, retry));
    }
    ...
    public static ISehSysInputDev getService(String serviceName) throws android.os.RemoteException {
        return ISehSysInputDev.asInterface(android.os.HwBinder.getService("vendor.samsung.hardware.sysinput@1.0::ISehSysInputDev", serviceName));
    }
    ...
    void getKeyCodePressed(int keycode, getKeyCodePressedCallback _hidl_cb)
    ...
    void runTspCmd(int devId, String cmdname, runTspCmdCallback _hidl_cb)
        throws android.os.RemoteException;
    ...
    void getTspScrubPosition(int devid, getTspScrubPositionCallback _hidl_cb)
        throws android.os.RemoteException;
    ...
    void getTspSupportFeature(int devid, getTspSupportFeatureCallback _hidl_cb)
        throws android.os.RemoteException;
    ...
    void getTspCommandList(int devid, getTspCommandListCallback _hidl_cb)
        throws android.os.RemoteException;
    ...
    void getTspAodActiveArea(int devid, getTspAodActiveAreaCallback _hidl_cb)
        throws android.os.RemoteException;
    ...
    void getTspFodInformation(int devid, getTspFodInformationCallback _hidl_cb)
        throws android.os.RemoteException;
    ...
    void getTspFodPosition(int devid, getTspFodPositionCallback _hidl_cb)
        throws android.os.RemoteException;
    ...
    void runSpenCmd(String cmdname, runSpenCmdCallback _hidl_cb)
        throws android.os.RemoteException;
    ...
    void getSpenPosition(getSpenPositionCallback _hidl_cb)
        throws android.os.RemoteException;
    ...
    void getSpenCommandList(getSpenCommandListCallback _hidl_cb)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISehSysInputDev {
        ...
        public final String interfaceDescriptor() {
            return vendor.samsung.hardware.sysinput.V1_0.ISehSysInputDev.kInterfaceName;
