#ifndef HIDL_GENERATED_VENDOR_SAMSUNG_HARDWARE_CAMERA_DEVICE_V4_0_ISEHCAMERADEVICE_H
#define HIDL_GENERATED_VENDOR_SAMSUNG_HARDWARE_CAMERA_DEVICE_V4_0_ISEHCAMERADEVICE_H
...
struct ISehCameraDevice : public ::android::hardware::camera::device::V3_5::ICameraDevice {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.samsung.hardware.camera.device@4.0::ISehCameraDevice"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::device::V4_0::ISehCameraDevice>> castFrom(const ::android::sp<::vendor::samsung::hardware::camera::device::V4_0::ISehCameraDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::device::V4_0::ISehCameraDevice>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::device::V4_0::ISehCameraDevice>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::device::V4_0::ISehCameraDevice>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::samsung::hardware::camera::device::V4_0::ISehCameraDevice>& o);
...
static inline std::string toString(const ::android::sp<::vendor::samsung::hardware::camera::device::V4_0::ISehCameraDevice>& o) {
    ...
    os += ::vendor::samsung::hardware::camera::device::V4_0::ISehCameraDevice::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_SAMSUNG_HARDWARE_CAMERA_DEVICE_V4_0_ISEHCAMERADEVICE_H
