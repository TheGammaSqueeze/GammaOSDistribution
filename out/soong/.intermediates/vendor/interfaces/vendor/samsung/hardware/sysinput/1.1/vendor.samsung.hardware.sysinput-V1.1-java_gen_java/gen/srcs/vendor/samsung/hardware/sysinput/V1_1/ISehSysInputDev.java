...
public interface ISehSysInputDev extends vendor.samsung.hardware.sysinput.V1_0.ISehSysInputDev {
    ...
    public static ISehSysInputDev getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISehSysInputDev.asInterface(android.os.HwBinder.getService("vendor.samsung.hardware.sysinput@1.1::ISehSysInputDev", serviceName, retry));
    }
    ...
    public static ISehSysInputDev getService(String serviceName) throws android.os.RemoteException {
        return ISehSysInputDev.asInterface(android.os.HwBinder.getService("vendor.samsung.hardware.sysinput@1.1::ISehSysInputDev", serviceName));
    }
    ...
    int runTspCmdNoRead(int devid, String cmdname)
        throws android.os.RemoteException;
    int runSpenCmdNoRead(String cmdname)
        throws android.os.RemoteException;
    int setTspEnable(int devid, int enable, boolean isBefore)
        throws android.os.RemoteException;
    int setSpenEnable(int enable, boolean isBefore)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISehSysInputDev {
        ...
        public final String interfaceDescriptor() {
            return vendor.samsung.hardware.sysinput.V1_1.ISehSysInputDev.kInterfaceName;
