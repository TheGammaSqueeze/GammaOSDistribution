#ifndef HIDL_GENERATED_VENDOR_SAMSUNG_HARDWARE_CAMERA_PROVIDER_V3_0_ISEHCAMERAPROVIDER_H
#define HIDL_GENERATED_VENDOR_SAMSUNG_HARDWARE_CAMERA_PROVIDER_V3_0_ISEHCAMERAPROVIDER_H
...
struct ISehCameraProvider : public ::android::hardware::camera::provider::V2_5::ICameraProvider {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.samsung.hardware.camera.provider@3.0::ISehCameraProvider"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::provider::V3_0::ISehCameraProvider>> castFrom(const ::android::sp<::vendor::samsung::hardware::camera::provider::V3_0::ISehCameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::provider::V3_0::ISehCameraProvider>> castFrom(const ::android::sp<::android::hardware::camera::provider::V2_5::ICameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::provider::V3_0::ISehCameraProvider>> castFrom(const ::android::sp<::android::hardware::camera::provider::V2_4::ICameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::provider::V3_0::ISehCameraProvider>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::vendor::samsung::hardware::camera::provider::V3_0::ISehCameraProvider>& o);
...
static inline std::string toString(const ::android::sp<::vendor::samsung::hardware::camera::provider::V3_0::ISehCameraProvider>& o) {
    ...
    os += ::vendor::samsung::hardware::camera::provider::V3_0::ISehCameraProvider::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_SAMSUNG_HARDWARE_CAMERA_PROVIDER_V3_0_ISEHCAMERAPROVIDER_H
