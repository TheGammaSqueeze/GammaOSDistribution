#ifndef HIDL_GENERATED_VENDOR_SAMSUNG_HARDWARE_CAMERA_PROVIDER_V4_0_ISEHCAMERAPROVIDER_H
#define HIDL_GENERATED_VENDOR_SAMSUNG_HARDWARE_CAMERA_PROVIDER_V4_0_ISEHCAMERAPROVIDER_H
...
struct ISehCameraProvider : public ::android::hardware::camera::provider::V2_6::ICameraProvider {
    /**
    ...
    /**
     * Fully qualified interface name: "vendor.samsung.hardware.camera.provider@4.0::ISehCameraProvider"
     */
    ...
    /**
     * Return callback for sehGetCameraIdList
     */
    using sehGetCameraIdList_cb = std::function<void(::android::hardware::camera::common::V1_0::Status status, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& cameraIds)>;
    virtual ::android::hardware::Return<void> sehGetCameraIdList(sehGetCameraIdList_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::provider::V4_0::ISehCameraProvider>> castFrom(const ::android::sp<::vendor::samsung::hardware::camera::provider::V4_0::ISehCameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::provider::V4_0::ISehCameraProvider>> castFrom(const ::android::sp<::android::hardware::camera::provider::V2_6::ICameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::provider::V4_0::ISehCameraProvider>> castFrom(const ::android::sp<::android::hardware::camera::provider::V2_5::ICameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::provider::V4_0::ISehCameraProvider>> castFrom(const ::android::sp<::android::hardware::camera::provider::V2_4::ICameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::vendor::samsung::hardware::camera::provider::V4_0::ISehCameraProvider>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
     ...
     */
    static ::android::sp<ISehCameraProvider> tryGetService(const std::string &serviceName="default", bool getStub=false);
    /**
     * Deprecated. See tryGetService(std::string, bool)
     */
    static ::android::sp<ISehCameraProvider> tryGetService(const char serviceName[], bool getStub=false)  { std::string str(serviceName ? serviceName : "");      return tryGetService(str, getStub); }
    /**
     * Deprecated. See tryGetService(std::string, bool)
     */
    static ::android::sp<ISehCameraProvider> tryGetService(const ::android::hardware::hidl_string& serviceName, bool getStub=false)  { std::string str(serviceName.c_str());      return tryGetService(str, getStub); }
    /**
     * Calls tryGetService("default", bool). This is the recommended instance name for singleton services.
     */
    static ::android::sp<ISehCameraProvider> tryGetService(bool getStub) { return tryGetService("default", getStub); }
    /**
     * This gets the service of this type with the specified instance name. If the
     ...
     */
    static ::android::sp<ISehCameraProvider> getService(const std::string &serviceName="default", bool getStub=false);
    /**
     * Deprecated. See getService(std::string, bool)
     */
    static ::android::sp<ISehCameraProvider> getService(const char serviceName[], bool getStub=false)  { std::string str(serviceName ? serviceName : "");      return getService(str, getStub); }
    /**
     * Deprecated. See getService(std::string, bool)
     */
    static ::android::sp<ISehCameraProvider> getService(const ::android::hardware::hidl_string& serviceName, bool getStub=false)  { std::string str(serviceName.c_str());      return getService(str, getStub); }
    /**
     * Calls getService("default", bool). This is the recommended instance name for singleton services.
     */
    static ::android::sp<ISehCameraProvider> getService(bool getStub) { return getService("default", getStub); }
    /**
...
static inline std::string toString(const ::android::sp<::vendor::samsung::hardware::camera::provider::V4_0::ISehCameraProvider>& o);
...
static inline std::string toString(const ::android::sp<::vendor::samsung::hardware::camera::provider::V4_0::ISehCameraProvider>& o) {
    ...
    os += ::vendor::samsung::hardware::camera::provider::V4_0::ISehCameraProvider::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_VENDOR_SAMSUNG_HARDWARE_CAMERA_PROVIDER_V4_0_ISEHCAMERAPROVIDER_H
