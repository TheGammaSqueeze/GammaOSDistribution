...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #Autofill_InlineSuggestion_autofillInlineSuggestionChip androidx.autofill:autofillInlineSuggestionChip}</code></td><td>Defines the overall style for the entire chip, such as the background.</td></tr>
     * <tr><td><code>{@link #Autofill_InlineSuggestion_autofillInlineSuggestionEndIconStyle androidx.autofill:autofillInlineSuggestionEndIconStyle}</code></td><td>Defines the style for the end icon, such as the scaleType.</td></tr>
     * <tr><td><code>{@link #Autofill_InlineSuggestion_autofillInlineSuggestionStartIconStyle androidx.autofill:autofillInlineSuggestionStartIconStyle}</code></td><td>Defines the style for the start icon, such as the scaleType.</td></tr>
     * <tr><td><code>{@link #Autofill_InlineSuggestion_autofillInlineSuggestionSubtitle androidx.autofill:autofillInlineSuggestionSubtitle}</code></td><td>Defines the style of the subtitle TextView, such as the color, size, etc.</td></tr>
     * <tr><td><code>{@link #Autofill_InlineSuggestion_autofillInlineSuggestionTitle androidx.autofill:autofillInlineSuggestionTitle}</code></td><td>Defines the style of the title TextView, such as the color, size, etc.</td></tr>
     * <tr><td><code>{@link #Autofill_InlineSuggestion_isAutofillInlineSuggestionTheme androidx.autofill:isAutofillInlineSuggestionTheme}</code></td><td>Private boolean attribute to identify the theme and the child of the theme.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name androidx.autofill:autofillInlineSuggestionChip
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name androidx.autofill:autofillInlineSuggestionEndIconStyle
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name androidx.autofill:autofillInlineSuggestionStartIconStyle
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name androidx.autofill:autofillInlineSuggestionSubtitle
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name androidx.autofill:autofillInlineSuggestionTitle
     */
     ...
     * "<code>false</code>".
     *
     * @attr name androidx.autofill:isAutofillInlineSuggestionTheme
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #Capability_queryPatterns androidx.autofill:queryPatterns}</code></td><td>Resource reference to the string array of query patterns for a custom capability.</td></tr>
     * <tr><td><code>{@link #Capability_shortcutMatchRequired androidx.autofill:shortcutMatchRequired}</code></td><td>Indicates whether a parameter in a capability template can only contain a matched
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name androidx.autofill:queryPatterns
     */
     ...
     * "<code>false</code>".
     *
     * @attr name androidx.autofill:shortcutMatchRequired
     */
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha androidx.autofill:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name androidx.autofill:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority androidx.autofill:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts androidx.autofill:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy androidx.autofill:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout androidx.autofill:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage androidx.autofill:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery androidx.autofill:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderSystemFontFamily androidx.autofill:fontProviderSystemFontFamily}</code></td><td>Provides the system font family name to check before downloading the font.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name androidx.autofill:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name androidx.autofill:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name androidx.autofill:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name androidx.autofill:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name androidx.autofill:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name androidx.autofill:fontProviderQuery
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name androidx.autofill:fontProviderSystemFontFamily
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font androidx.autofill:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle androidx.autofill:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings androidx.autofill:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight androidx.autofill:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex androidx.autofill:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name androidx.autofill:font
     */
     ...
     * </table>
     *
     * @attr name androidx.autofill:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name androidx.autofill:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name androidx.autofill:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name androidx.autofill:ttcIndex
     */
