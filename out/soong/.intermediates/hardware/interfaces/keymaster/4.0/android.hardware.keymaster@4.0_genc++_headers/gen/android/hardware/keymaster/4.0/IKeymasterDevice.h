#ifndef HIDL_GENERATED_ANDROID_HARDWARE_KEYMASTER_V4_0_IKEYMASTERDEVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_KEYMASTER_V4_0_IKEYMASTERDEVICE_H
...
struct IKeymasterDevice : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.keymaster@4.0::IKeymasterDevice"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::keymaster::V4_0::IKeymasterDevice>> castFrom(const ::android::sp<::android::hardware::keymaster::V4_0::IKeymasterDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::keymaster::V4_0::IKeymasterDevice>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::keymaster::V4_0::IKeymasterDevice>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::keymaster::V4_0::IKeymasterDevice>& o) {
    ...
    os += ::android::hardware::keymaster::V4_0::IKeymasterDevice::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_KEYMASTER_V4_0_IKEYMASTERDEVICE_H
