...
public final class ProgramIdentifier {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.broadcastradio.V2_0.ProgramIdentifier.class) {
            return false;
        }
        android.hardware.broadcastradio.V2_0.ProgramIdentifier other = (android.hardware.broadcastradio.V2_0.ProgramIdentifier)otherObject;
    ...
    public static final java.util.ArrayList<ProgramIdentifier> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<ProgramIdentifier> _hidl_vec = new java.util.ArrayList();
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<ProgramIdentifier> _hidl_vec) {
