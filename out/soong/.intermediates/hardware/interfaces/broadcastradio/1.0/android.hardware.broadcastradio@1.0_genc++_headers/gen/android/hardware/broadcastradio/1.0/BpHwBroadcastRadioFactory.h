#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V1_0_BPHWBROADCASTRADIOFACTORY_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V1_0_BPHWBROADCASTRADIOFACTORY_H
...
struct BpHwBroadcastRadioFactory : public ::android::hardware::BpInterface<IBroadcastRadioFactory>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_connectModule(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::broadcastradio::V1_0::Class classId, connectModule_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BROADCASTRADIO_V1_0_BPHWBROADCASTRADIOFACTORY_H
