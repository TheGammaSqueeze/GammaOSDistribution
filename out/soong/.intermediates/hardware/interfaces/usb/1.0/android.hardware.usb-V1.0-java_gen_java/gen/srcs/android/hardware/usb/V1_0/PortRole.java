...
public final class PortRole {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.usb.V1_0.PortRole.class) {
            return false;
        }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.role));
    }
    ...
    public final String toString() {
        ...
        builder.append("{");
        builder.append(".type = ");
        builder.append(android.hardware.usb.V1_0.PortRoleType.toString(this.type));
        builder.append(", .role = ");
    ...
    public static final java.util.ArrayList<PortRole> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<PortRole> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((android.hardware.usb.V1_0.PortRole) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 8);
    ...
    public final void readEmbeddedFromParcel(
        ...
        role = _hidl_blob.getInt32(_hidl_offset + 4);
    }
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<PortRole> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 4, role);
    }
};
