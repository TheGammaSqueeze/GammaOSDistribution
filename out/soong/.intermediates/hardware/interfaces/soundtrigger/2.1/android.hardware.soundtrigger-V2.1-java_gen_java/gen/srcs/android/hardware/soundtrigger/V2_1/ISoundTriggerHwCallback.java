...
public interface ISoundTriggerHwCallback extends android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback {
    ...
    public static ISoundTriggerHwCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISoundTriggerHwCallback.asInterface(android.os.HwBinder.getService("android.hardware.soundtrigger@2.1::ISoundTriggerHwCallback", serviceName, retry));
    }
    ...
    public static ISoundTriggerHwCallback getService(String serviceName) throws android.os.RemoteException {
        return ISoundTriggerHwCallback.asInterface(android.os.HwBinder.getService("android.hardware.soundtrigger@2.1::ISoundTriggerHwCallback", serviceName));
    }
    ...
    public final static class RecognitionEvent {
        ...
        // equals() is not generated for RecognitionEvent
        @Override
        ...
        public final void readFromParcel(android.os.HwParcel parcel) {
            android.os.HwBlob blob = parcel.readBuffer(160 /* size */);
        ...
        public static final java.util.ArrayList<RecognitionEvent> readVectorFromParcel(android.os.HwParcel parcel) {
...

            {
                ...
                android.os.HwBlob childBlob = parcel.readEmbeddedBuffer(
                        _hidl_vec_size * 160,_hidl_blob.handle(),
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    ...
                    ((android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.RecognitionEvent) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 160);
        ...
        public final void readEmbeddedFromParcel(
            ...
            ((android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback.RecognitionEvent) header).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
            try {
                data = parcel.readEmbeddedHidlMemory(
                _hidl_blob.getFieldHandle(_hidl_offset + 120),
                _hidl_blob.handle(),
                _hidl_offset + 120).dup();
        ...
        public final void writeToParcel(android.os.HwParcel parcel) {
            android.os.HwBlob _hidl_blob = new android.os.HwBlob(160 /* size */);
        ...
        public static final void writeVectorToParcel(
            ...
            android.os.HwBlob _hidl_blob = new android.os.HwBlob(16 /* sizeof(hidl_vec<T>) */);
            {
                ...
                android.os.HwBlob childBlob = new android.os.HwBlob((int)(_hidl_vec_size * 160));
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
        ...
        public final void writeEmbeddedToBlob(
            ...
            _hidl_blob.putHidlMemory(_hidl_offset + 120, data);
        }
    };
    ...
    public final static class PhraseRecognitionEvent {
        ...
        // equals() is not generated for PhraseRecognitionEvent
        @Override
        public final String toString() {
            java.lang.StringBuilder builder = new java.lang.StringBuilder();
            builder.append("{");
        ...
        public static final java.util.ArrayList<PhraseRecognitionEvent> readVectorFromParcel(android.os.HwParcel parcel) {
...

            {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    ...
                    ((android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.PhraseRecognitionEvent) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 176);
                    _hidl_vec.add(_hidl_vec_element);
                }
            }
        ...
        public final void readEmbeddedFromParcel(
                android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
            ((android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.RecognitionEvent) common).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
            {
                int _hidl_vec_size = _hidl_blob.getInt32(_hidl_offset + 160 + 8 /* offsetof(hidl_vec<T>, mSize) */);
                android.os.HwBlob childBlob = parcel.readEmbeddedBuffer(
                        _hidl_vec_size * 32,_hidl_blob.handle(),
                        _hidl_offset + 160 + 0 /* offsetof(hidl_vec<T>, mBuffer) */,true /* nullable */);
        ...
        public final void writeEmbeddedToBlob(
            ...
            common.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 0);
            {
                ...
                _hidl_blob.putInt32(_hidl_offset + 160 + 8 /* offsetof(hidl_vec<T>, mSize) */, _hidl_vec_size);
                _hidl_blob.putBool(_hidl_offset + 160 + 12 /* offsetof(hidl_vec<T>, mOwnsBuffer) */, false);
                android.os.HwBlob childBlob = new android.os.HwBlob((int)(_hidl_vec_size * 32));
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    phraseExtras.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 32);
                }
                _hidl_blob.putBlob(_hidl_offset + 160 + 0 /* offsetof(hidl_vec<T>, mBuffer) */, childBlob);
            }
        }
    };
    ...
    public final static class ModelEvent {
        ...
        // equals() is not generated for ModelEvent
        @Override
        public final String toString() {
            java.lang.StringBuilder builder = new java.lang.StringBuilder();
            builder.append("{");
        ...
        public static final java.util.ArrayList<ModelEvent> readVectorFromParcel(android.os.HwParcel parcel) {
...

            {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    ...
                    ((android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.ModelEvent) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 64);
                    _hidl_vec.add(_hidl_vec_element);
                }
            }
        ...
        public final void readEmbeddedFromParcel(
                android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
            ((android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback.ModelEvent) header).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
            try {
                data = parcel.readEmbeddedHidlMemory(
                _hidl_blob.getFieldHandle(_hidl_offset + 24),
                _hidl_blob.handle(),
                _hidl_offset + 24).dup();
            } catch (java.io.IOException e) {
                throw new RuntimeException(e);
        ...
        public final void writeEmbeddedToBlob(
                android.os.HwBlob _hidl_blob, long _hidl_offset) {
            header.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 0);
            _hidl_blob.putHidlMemory(_hidl_offset + 24, data);
        }
    };
     ...
     */
    void recognitionCallback_2_1(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.RecognitionEvent event, int cookie)
     ...
     *     started (see ISoundtriggerHw.startRecognition*())
     */
    void phraseRecognitionCallback_2_1(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.PhraseRecognitionEvent event, int cookie)
        throws android.os.RemoteException;
    /**
     ...
     */
    void soundModelCallback_2_1(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.ModelEvent event, int cookie)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements ISoundTriggerHwCallback {
        ...
        public void recognitionCallback_2_1(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.RecognitionEvent event, int cookie)
            ...
            ((android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.RecognitionEvent) event).writeToParcel(_hidl_request);
            _hidl_request.writeInt32(cookie);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(4 /* recognitionCallback_2_1 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
        ...
        public void phraseRecognitionCallback_2_1(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.PhraseRecognitionEvent event, int cookie)
            ...
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.kInterfaceName);
            ((android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.PhraseRecognitionEvent) event).writeToParcel(_hidl_request);
            _hidl_request.writeInt32(cookie);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(5 /* phraseRecognitionCallback_2_1 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
        ...
        public void soundModelCallback_2_1(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.ModelEvent event, int cookie)
            ...
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.kInterfaceName);
            ((android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.ModelEvent) event).writeToParcel(_hidl_request);
            _hidl_request.writeInt32(cookie);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(6 /* soundModelCallback_2_1 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISoundTriggerHwCallback {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.kInterfaceName,
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-24,-56,108,105,-60,56,-38,-115,21,73,-123,108,27,-77,-30,-47,-72,-38,82,114,47,-126,53,-1,73,-93,15,44,-50,-111,116,44} /* e8c86c69c438da8d1549856c1bb3e2d1b8da52722f8235ff49a30f2cce91742c */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 4 /* recognitionCallback_2_1 */:
                {
                    _hidl_request.enforceInterface(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.kInterfaceName);

                    android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.RecognitionEvent event = new android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.RecognitionEvent();
                    ((android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.RecognitionEvent) event).readFromParcel(_hidl_request);
                    int cookie = _hidl_request.readInt32();
                    recognitionCallback_2_1(event, cookie);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.send();
                    break;
                }

                case 5 /* phraseRecognitionCallback_2_1 */:
                {
                    _hidl_request.enforceInterface(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.kInterfaceName);

                    android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.PhraseRecognitionEvent event = new android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.PhraseRecognitionEvent();
                    ((android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.PhraseRecognitionEvent) event).readFromParcel(_hidl_request);
                    int cookie = _hidl_request.readInt32();
                    phraseRecognitionCallback_2_1(event, cookie);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.send();
                    break;
                }

                case 6 /* soundModelCallback_2_1 */:
                {
                    _hidl_request.enforceInterface(android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.kInterfaceName);

                    android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.ModelEvent event = new android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.ModelEvent();
                    ((android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.ModelEvent) event).readFromParcel(_hidl_request);
                    int cookie = _hidl_request.readInt32();
                    soundModelCallback_2_1(event, cookie);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.send();
                    break;
                }
