...
public final class ConfidenceLevel {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.soundtrigger.V2_0.ConfidenceLevel.class) {
            return false;
        }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.levelPercent));
    }
    ...
    public final String toString() {
        ...
        builder.append(", .levelPercent = ");
        builder.append(this.levelPercent);
        builder.append("}");
    ...
    public static final java.util.ArrayList<ConfidenceLevel> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<ConfidenceLevel> _hidl_vec = new java.util.ArrayList();
    ...
    public final void readEmbeddedFromParcel(
        ...
        levelPercent = _hidl_blob.getInt32(_hidl_offset + 4);
    }
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<ConfidenceLevel> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 4, levelPercent);
    }
};
