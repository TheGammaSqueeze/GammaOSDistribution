...
public interface ISoundTriggerHw extends android.hardware.soundtrigger.V2_2.ISoundTriggerHw {
    ...
    public static ISoundTriggerHw getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISoundTriggerHw.asInterface(android.os.HwBinder.getService("android.hardware.soundtrigger@2.3::ISoundTriggerHw", serviceName, retry));
    }
    ...
    public static ISoundTriggerHw getService(String serviceName) throws android.os.RemoteException {
        return ISoundTriggerHw.asInterface(android.os.HwBinder.getService("android.hardware.soundtrigger@2.3::ISoundTriggerHw", serviceName));
    }
    ...
    public interface getProperties_2_3Callback {
        public void onValues(int retval, android.hardware.soundtrigger.V2_3.Properties properties);
    }
     ...
     */
    void getProperties_2_3(getProperties_2_3Callback _hidl_cb)
     ...
     *     -ENODEV in case of initialization error.
     */
    int startRecognition_2_3(int modelHandle, android.hardware.soundtrigger.V2_3.RecognitionConfig config)
        throws android.os.RemoteException;
    /**
     ...
     */
    int setParameter(int modelHandle, int modelParam, int value)
        throws android.os.RemoteException;

    @java.lang.FunctionalInterface
    public interface getParameterCallback {
        public void onValues(int status, int value);
    }
    ...
    public interface queryParameterCallback {
        public void onValues(int status, android.hardware.soundtrigger.V2_3.OptionalModelParameterRange retval);
    }
     ...
     */
    void queryParameter(int modelHandle, int modelParam, queryParameterCallback _hidl_cb)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements ISoundTriggerHw {
        ...
        public void getProperties_2_3(getProperties_2_3Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(12 /* getProperties_2_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                int _hidl_out_retval = _hidl_reply.readInt32();
                android.hardware.soundtrigger.V2_3.Properties _hidl_out_properties = new android.hardware.soundtrigger.V2_3.Properties();
                ((android.hardware.soundtrigger.V2_3.Properties) _hidl_out_properties).readFromParcel(_hidl_reply);
                _hidl_cb.onValues(_hidl_out_retval, _hidl_out_properties);
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override
        public int startRecognition_2_3(int modelHandle, android.hardware.soundtrigger.V2_3.RecognitionConfig config)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
            ((android.hardware.soundtrigger.V2_3.RecognitionConfig) config).writeToParcel(_hidl_request);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(13 /* startRecognition_2_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public int setParameter(int modelHandle, int modelParam, int value)
            ...
            _hidl_request.writeInterfaceToken(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
            _hidl_request.writeInt32(modelParam);
            _hidl_request.writeInt32(value);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(14 /* setParameter */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public void getParameter(int modelHandle, int modelParam, getParameterCallback _hidl_cb)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(15 /* getParameter */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                int _hidl_out_status = _hidl_reply.readInt32();
                int _hidl_out_value = _hidl_reply.readInt32();
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_value);
            } finally {
                _hidl_reply.release();
            }
        }
        ...
        @Override
        public void queryParameter(int modelHandle, int modelParam, queryParameterCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(16 /* queryParameter */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                int _hidl_out_status = _hidl_reply.readInt32();
                android.hardware.soundtrigger.V2_3.OptionalModelParameterRange _hidl_out_retval = new android.hardware.soundtrigger.V2_3.OptionalModelParameterRange();
                ((android.hardware.soundtrigger.V2_3.OptionalModelParameterRange) _hidl_out_retval).readFromParcel(_hidl_reply);
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_retval);
            } finally {
                _hidl_reply.release();
            }
        }
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISoundTriggerHw {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName,
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-77,127,120,-29,-3,-57,-102,-8,-77,42,84,91,43,66,111,31,-47,53,91,53,-99,-98,120,53,-13,-65,30,-48,-86,69,24,-40} /* b37f78e3fdc79af8b32a545b2b426f1fd1355b359d9e7835f3bf1ed0aa4518d8 */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 12 /* getProperties_2_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);

                    getProperties_2_3(new getProperties_2_3Callback() {
                        @Override
                        public void onValues(int retval, android.hardware.soundtrigger.V2_3.Properties properties) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            _hidl_reply.writeInt32(retval);
                            ((android.hardware.soundtrigger.V2_3.Properties) properties).writeToParcel(_hidl_reply);
                            _hidl_reply.send();
                            }});
                    break;
                }

                case 13 /* startRecognition_2_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);

                    int modelHandle = _hidl_request.readInt32();
                    android.hardware.soundtrigger.V2_3.RecognitionConfig config = new android.hardware.soundtrigger.V2_3.RecognitionConfig();
                    ((android.hardware.soundtrigger.V2_3.RecognitionConfig) config).readFromParcel(_hidl_request);
                    int _hidl_out_retval = startRecognition_2_3(modelHandle, config);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_retval);
                    _hidl_reply.send();
                    break;
                ...
                case 14 /* setParameter */:
                {
                    _hidl_request.enforceInterface(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);

                    int modelHandle = _hidl_request.readInt32();
                    int modelParam = _hidl_request.readInt32();
                    int value = _hidl_request.readInt32();
                    int _hidl_out_status = setParameter(modelHandle, modelParam, value);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                ...
                case 15 /* getParameter */:
                {
                    _hidl_request.enforceInterface(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);

                    int modelHandle = _hidl_request.readInt32();
                    int modelParam = _hidl_request.readInt32();
                    getParameter(modelHandle, modelParam, new getParameterCallback() {
                        @Override
                        public void onValues(int status, int value) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                ...
                case 16 /* queryParameter */:
                {
                    _hidl_request.enforceInterface(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);

                    int modelHandle = _hidl_request.readInt32();
                    int modelParam = _hidl_request.readInt32();
                    queryParameter(modelHandle, modelParam, new queryParameterCallback() {
                        @Override
                        public void onValues(int status, android.hardware.soundtrigger.V2_3.OptionalModelParameterRange retval) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            _hidl_reply.writeInt32(status);
                            ((android.hardware.soundtrigger.V2_3.OptionalModelParameterRange) retval).writeToParcel(_hidl_reply);
                            _hidl_reply.send();
                            }});
                    break;
                }
