...
public final class OptionalModelParameterRange {
    ...
    public static final class hidl_discriminator {
        ...
        public static final byte range = 1;  // android.hardware.soundtrigger.V2_3.ModelParameterRange
    ...
    public android.hardware.soundtrigger.V2_3.ModelParameterRange range() {
        ...
        if (hidl_o != null && !android.hardware.soundtrigger.V2_3.ModelParameterRange.class.isInstance(hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
        return ((android.hardware.soundtrigger.V2_3.ModelParameterRange) hidl_o);
    }
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.soundtrigger.V2_3.OptionalModelParameterRange.class) {
            return false;
        }
    ...
    public static final java.util.ArrayList<OptionalModelParameterRange> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<OptionalModelParameterRange> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((android.hardware.soundtrigger.V2_3.OptionalModelParameterRange) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 12);
    ...
    public final void readEmbeddedFromParcel(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.range: {
                hidl_o = new android.hardware.soundtrigger.V2_3.ModelParameterRange();
                ((android.hardware.soundtrigger.V2_3.ModelParameterRange) hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 4);
                break;
            }
            default: {
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<OptionalModelParameterRange> _hidl_vec) {
