...
public interface IVibrator extends android.hidl.base.V1_0.IBase {
    /**
    ...
    public static IVibrator getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IVibrator.asInterface(android.os.HwBinder.getService("android.hardware.vibrator@1.0::IVibrator", serviceName, retry));
    }
    ...
    public static IVibrator getService(String serviceName) throws android.os.RemoteException {
        return IVibrator.asInterface(android.os.HwBinder.getService("android.hardware.vibrator@1.0::IVibrator", serviceName));
    }
     ...
     */
    int setAmplitude(byte amplitude)
        throws android.os.RemoteException;
     ...
     */
    void perform(int effect, byte strength, performCallback _hidl_cb)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements IVibrator {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.vibrator.V1_0.IVibrator.kInterfaceName;
