...
public interface IVibrator extends android.hardware.vibrator.V1_0.IVibrator {
    ...
    public static IVibrator getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IVibrator.asInterface(android.os.HwBinder.getService("android.hardware.vibrator@1.1::IVibrator", serviceName, retry));
    }
    ...
    public static IVibrator getService(String serviceName) throws android.os.RemoteException {
        return IVibrator.asInterface(android.os.HwBinder.getService("android.hardware.vibrator@1.1::IVibrator", serviceName));
    }
     ...
     */
    void perform_1_1(int effect, byte strength, perform_1_1Callback _hidl_cb)
    ...
    public static abstract class Stub extends android.os.HwBinder implements IVibrator {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.vibrator.V1_1.IVibrator.kInterfaceName;
