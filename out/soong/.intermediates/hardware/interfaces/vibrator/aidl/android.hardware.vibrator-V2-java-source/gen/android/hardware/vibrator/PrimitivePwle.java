  ...
  public void readFromParcel(android.os.Parcel _aidl_parcel) {
    ...
    case active: {
      ...
      if ((0!=_aidl_parcel.readInt())) {
        _aidl_value = android.hardware.vibrator.ActivePwle.CREATOR.createFromParcel(_aidl_parcel);
      }
      else {
        _aidl_value = null;
      }
    ...
    case braking: {
      ...
      if ((0!=_aidl_parcel.readInt())) {
        _aidl_value = android.hardware.vibrator.BrakingPwle.CREATOR.createFromParcel(_aidl_parcel);
      }
      else {
        _aidl_value = null;
      }
