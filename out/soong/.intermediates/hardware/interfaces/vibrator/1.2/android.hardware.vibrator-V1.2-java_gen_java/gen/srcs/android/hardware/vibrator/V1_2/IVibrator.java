...
public interface IVibrator extends android.hardware.vibrator.V1_1.IVibrator {
    ...
    public static IVibrator getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IVibrator.asInterface(android.os.HwBinder.getService("android.hardware.vibrator@1.2::IVibrator", serviceName, retry));
    }
    ...
    public static IVibrator getService(String serviceName) throws android.os.RemoteException {
        return IVibrator.asInterface(android.os.HwBinder.getService("android.hardware.vibrator@1.2::IVibrator", serviceName));
    }
     ...
     */
    void perform_1_2(int effect, byte strength, perform_1_2Callback _hidl_cb)
