#define LOG_TAG "android.hardware.vibrator@1.2::Vibrator"
...
#include <android/hardware/vibrator/1.2/BnHwVibrator.h>
#include <android/hardware/vibrator/1.2/BsVibrator.h>
...
const char* IVibrator::descriptor("android.hardware.vibrator@1.2::IVibrator");
...
::android::hardware::Return<void> IVibrator::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::vibrator::V1_2::IVibrator::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_2::IVibrator>> IVibrator::castFrom(const ::android::sp<::android::hardware::vibrator::V1_2::IVibrator>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_2::IVibrator>> IVibrator::castFrom(const ::android::sp<::android::hardware::vibrator::V1_1::IVibrator>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IVibrator, ::android::hardware::vibrator::V1_1::IVibrator, BpHwVibrator>(
            parent, "android.hardware.vibrator@1.2::IVibrator", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_2::IVibrator>> IVibrator::castFrom(const ::android::sp<::android::hardware::vibrator::V1_0::IVibrator>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IVibrator, ::android::hardware::vibrator::V1_0::IVibrator, BpHwVibrator>(
            parent, "android.hardware.vibrator@1.2::IVibrator", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::vibrator::V1_2::IVibrator>> IVibrator::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwVibrator::BpHwVibrator(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IVibrator>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.vibrator@1.2", "IVibrator") {
}
...
// Methods from ::android::hardware::vibrator::V1_2::IVibrator follow.
::android::hardware::Return<void> BpHwVibrator::_hidl_perform_1_2(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::vibrator::V1_2::Effect effect, ::android::hardware::vibrator::V1_0::EffectStrength strength, perform_1_2_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IVibrator::perform_1_2::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.vibrator", "1.2", "IVibrator", "perform_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(7 /* perform_1_2 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.vibrator", "1.2", "IVibrator", "perform_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwVibrator::BnHwVibrator(const ::android::sp<IVibrator> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.vibrator@1.2", "IVibrator") { 
...
// Methods from ::android::hardware::vibrator::V1_2::IVibrator follow.
::android::status_t BnHwVibrator::_hidl_perform_1_2(
    ...
    ::android::hardware::vibrator::V1_2::Effect effect;
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IVibrator::perform_1_2::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&effect);
        _hidl_args.push_back((void *)&strength);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.vibrator", "1.2", "IVibrator", "perform_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IVibrator*>(_hidl_this->getImpl().get())->perform_1_2(effect, strength, [&](const auto &_hidl_out_status, const auto &_hidl_out_lengthMs) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("perform_1_2: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_lengthMs);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.vibrator", "1.2", "IVibrator", "perform_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("perform_1_2: _hidl_cb not called, but must be called once.");
    }
...
BsVibrator::BsVibrator(const ::android::sp<::android::hardware::vibrator::V1_2::IVibrator> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.vibrator@1.2", "IVibrator"), mImpl(impl) {
...
bool IVibrator::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.vibrator@1.2::IVibrator",
