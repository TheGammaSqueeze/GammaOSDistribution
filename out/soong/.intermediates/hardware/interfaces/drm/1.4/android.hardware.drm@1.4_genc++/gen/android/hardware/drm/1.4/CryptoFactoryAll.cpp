#define LOG_TAG "android.hardware.drm@1.4::CryptoFactory"
...
#include <android/hardware/drm/1.4/BpHwCryptoFactory.h>
#include <android/hardware/drm/1.4/BnHwCryptoFactory.h>
#include <android/hardware/drm/1.4/BsCryptoFactory.h>
#include <android/hardware/drm/1.3/BpHwCryptoFactory.h>
#include <android/hardware/drm/1.2/BpHwCryptoFactory.h>
...
const char* ICryptoFactory::descriptor("android.hardware.drm@1.4::ICryptoFactory");
...
::android::hardware::Return<void> ICryptoFactory::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::drm::V1_4::ICryptoFactory::descriptor,
        ::android::hardware::drm::V1_3::ICryptoFactory::descriptor,
        ::android::hardware::drm::V1_2::ICryptoFactory::descriptor,
...
::android::hardware::Return<void> ICryptoFactory::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::drm::V1_4::ICryptoFactory::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> ICryptoFactory::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){195,138,66,102,26,144,160,206,245,56,177,117,126,41,38,141,58,145,134,127,202,223,60,68,24,92,153,37,102,218,11,129} /* c38a42661a90a0cef538b1757e29268d3a91867fcadf3c44185c992566da0b81 */,
        (uint8_t[32]){102,147,28,37,6,251,181,175,97,242,1,56,203,5,224,160,158,123,246,125,105,100,194,49,210,124,100,137,51,187,51,236} /* 66931c2506fbb5af61f20138cb05e0a09e7bf67d6964c231d27c648933bb33ec */,
        (uint8_t[32]){91,31,74,79,184,140,35,158,7,215,96,38,70,122,31,46,224,208,143,77,82,193,128,91,217,59,215,192,94,63,230,156} /* 5b1f4a4fb88c239e07d76026467a1f2ee0d08f4d52c1805bd93bd7c05e3fe69c */,
...
::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::ICryptoFactory>> ICryptoFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_4::ICryptoFactory>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::ICryptoFactory>> ICryptoFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_3::ICryptoFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICryptoFactory, ::android::hardware::drm::V1_3::ICryptoFactory, BpHwCryptoFactory>(
            parent, "android.hardware.drm@1.4::ICryptoFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::ICryptoFactory>> ICryptoFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_2::ICryptoFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICryptoFactory, ::android::hardware::drm::V1_2::ICryptoFactory, BpHwCryptoFactory>(
            parent, "android.hardware.drm@1.4::ICryptoFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::ICryptoFactory>> ICryptoFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_1::ICryptoFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICryptoFactory, ::android::hardware::drm::V1_1::ICryptoFactory, BpHwCryptoFactory>(
            parent, "android.hardware.drm@1.4::ICryptoFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::ICryptoFactory>> ICryptoFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_0::ICryptoFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICryptoFactory, ::android::hardware::drm::V1_0::ICryptoFactory, BpHwCryptoFactory>(
            parent, "android.hardware.drm@1.4::ICryptoFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::ICryptoFactory>> ICryptoFactory::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCryptoFactory::BpHwCryptoFactory(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICryptoFactory>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.4", "ICryptoFactory") {
}
...
BnHwCryptoFactory::BnHwCryptoFactory(const ::android::sp<ICryptoFactory> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.drm@1.4", "ICryptoFactory") { 
...
BsCryptoFactory::BsCryptoFactory(const ::android::sp<::android::hardware::drm::V1_4::ICryptoFactory> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.4", "ICryptoFactory"), mImpl(impl) {
...
bool ICryptoFactory::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.drm@1.4::ICryptoFactory",
