#define LOG_TAG "android.hardware.drm@1.4::DrmFactory"
...
#include <android/hardware/drm/1.4/BpHwDrmFactory.h>
#include <android/hardware/drm/1.4/BnHwDrmFactory.h>
#include <android/hardware/drm/1.4/BsDrmFactory.h>
...
const char* IDrmFactory::descriptor("android.hardware.drm@1.4::IDrmFactory");
...
::android::hardware::Return<void> IDrmFactory::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::drm::V1_4::IDrmFactory::descriptor,
...
::android::hardware::Return<void> IDrmFactory::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::drm::V1_4::IDrmFactory::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IDrmFactory::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){78,187,226,184,255,58,108,135,41,97,159,233,206,98,66,159,75,86,29,46,38,227,46,181,70,117,186,189,223,236,158,89} /* 4ebbe2b8ff3a6c8729619fe9ce62429f4b561d2e26e32eb54675babddfec9e59 */,
...
::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_4::IDrmFactory>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_3::IDrmFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDrmFactory, ::android::hardware::drm::V1_3::IDrmFactory, BpHwDrmFactory>(
            parent, "android.hardware.drm@1.4::IDrmFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_2::IDrmFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDrmFactory, ::android::hardware::drm::V1_2::IDrmFactory, BpHwDrmFactory>(
            parent, "android.hardware.drm@1.4::IDrmFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_1::IDrmFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDrmFactory, ::android::hardware::drm::V1_1::IDrmFactory, BpHwDrmFactory>(
            parent, "android.hardware.drm@1.4::IDrmFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_0::IDrmFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDrmFactory, ::android::hardware::drm::V1_0::IDrmFactory, BpHwDrmFactory>(
            parent, "android.hardware.drm@1.4::IDrmFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_4::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwDrmFactory::BpHwDrmFactory(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IDrmFactory>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.4", "IDrmFactory") {
}
...
BnHwDrmFactory::BnHwDrmFactory(const ::android::sp<IDrmFactory> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.drm@1.4", "IDrmFactory") { 
...
BsDrmFactory::BsDrmFactory(const ::android::sp<::android::hardware::drm::V1_4::IDrmFactory> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.4", "IDrmFactory"), mImpl(impl) {
...
bool IDrmFactory::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.drm@1.4::IDrmFactory",
