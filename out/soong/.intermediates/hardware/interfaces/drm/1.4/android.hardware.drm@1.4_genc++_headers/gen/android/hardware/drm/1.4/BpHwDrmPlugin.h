#ifndef HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_4_BPHWDRMPLUGIN_H
#define HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_4_BPHWDRMPLUGIN_H
...
struct BpHwDrmPlugin : public ::android::hardware::BpInterface<IDrmPlugin>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<bool>  _hidl_requiresSecureDecoder(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& mime, ::android::hardware::drm::V1_1::SecurityLevel level);
    static ::android::hardware::Return<bool>  _hidl_requiresSecureDecoderDefault(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& mime);
    static ::android::hardware::Return<::android::hardware::drm::V1_0::Status>  _hidl_setPlaybackId(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& sessionId, const ::android::hardware::hidl_string& playbackId);
    static ::android::hardware::Return<void>  _hidl_getLogMessages(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getLogMessages_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_DRM_V1_4_BPHWDRMPLUGIN_H
