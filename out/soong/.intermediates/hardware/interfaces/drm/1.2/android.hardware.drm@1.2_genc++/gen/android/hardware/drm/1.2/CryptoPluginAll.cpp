#define LOG_TAG "android.hardware.drm@1.2::CryptoPlugin"
...
#include <android/hardware/drm/1.2/BnHwCryptoPlugin.h>
#include <android/hardware/drm/1.2/BsCryptoPlugin.h>
...
const char* ICryptoPlugin::descriptor("android.hardware.drm@1.2::ICryptoPlugin");
...
::android::hardware::Return<void> ICryptoPlugin::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::drm::V1_2::ICryptoPlugin::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::ICryptoPlugin>> ICryptoPlugin::castFrom(const ::android::sp<::android::hardware::drm::V1_2::ICryptoPlugin>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::ICryptoPlugin>> ICryptoPlugin::castFrom(const ::android::sp<::android::hardware::drm::V1_0::ICryptoPlugin>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICryptoPlugin, ::android::hardware::drm::V1_0::ICryptoPlugin, BpHwCryptoPlugin>(
            parent, "android.hardware.drm@1.2::ICryptoPlugin", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::ICryptoPlugin>> ICryptoPlugin::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCryptoPlugin::BpHwCryptoPlugin(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICryptoPlugin>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.2", "ICryptoPlugin") {
}
...
// Methods from ::android::hardware::drm::V1_2::ICryptoPlugin follow.
::android::hardware::Return<void> BpHwCryptoPlugin::_hidl_decrypt_1_2(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool secure, const ::android::hardware::hidl_array<uint8_t, 16>& keyId, const ::android::hardware::hidl_array<uint8_t, 16>& iv, ::android::hardware::drm::V1_0::Mode mode, const ::android::hardware::drm::V1_0::Pattern& pattern, const ::android::hardware::hidl_vec<::android::hardware::drm::V1_0::SubSample>& subSamples, const ::android::hardware::drm::V1_0::SharedBuffer& source, uint64_t offset, const ::android::hardware::drm::V1_0::DestinationBuffer& destination, decrypt_1_2_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::decrypt_1_2::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.2", "ICryptoPlugin", "decrypt_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(6 /* decrypt_1_2 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.2", "ICryptoPlugin", "decrypt_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwCryptoPlugin::BnHwCryptoPlugin(const ::android::sp<ICryptoPlugin> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.drm@1.2", "ICryptoPlugin") { 
...
// Methods from ::android::hardware::drm::V1_2::ICryptoPlugin follow.
::android::status_t BnHwCryptoPlugin::_hidl_decrypt_1_2(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::decrypt_1_2::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&secure);
        ...
        _hidl_args.push_back((void *)destination);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.2", "ICryptoPlugin", "decrypt_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICryptoPlugin*>(_hidl_this->getImpl().get())->decrypt_1_2(secure, *keyId, *iv, mode, *pattern, *subSamples, *source, offset, *destination, [&](const auto &_hidl_out_status, const auto &_hidl_out_bytesWritten, const auto &_hidl_out_detailedError) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("decrypt_1_2: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_detailedError);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.2", "ICryptoPlugin", "decrypt_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("decrypt_1_2: _hidl_cb not called, but must be called once.");
    }
...
BsCryptoPlugin::BsCryptoPlugin(const ::android::sp<::android::hardware::drm::V1_2::ICryptoPlugin> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.2", "ICryptoPlugin"), mImpl(impl) {
...
bool ICryptoPlugin::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.drm@1.2::ICryptoPlugin",
