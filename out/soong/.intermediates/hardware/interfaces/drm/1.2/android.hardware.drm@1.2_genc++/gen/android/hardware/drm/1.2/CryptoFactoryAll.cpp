#define LOG_TAG "android.hardware.drm@1.2::CryptoFactory"
...
#include <android/hardware/drm/1.2/BnHwCryptoFactory.h>
#include <android/hardware/drm/1.2/BsCryptoFactory.h>
...
const char* ICryptoFactory::descriptor("android.hardware.drm@1.2::ICryptoFactory");
...
::android::hardware::Return<void> ICryptoFactory::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::drm::V1_2::ICryptoFactory::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::ICryptoFactory>> ICryptoFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_2::ICryptoFactory>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::ICryptoFactory>> ICryptoFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_1::ICryptoFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICryptoFactory, ::android::hardware::drm::V1_1::ICryptoFactory, BpHwCryptoFactory>(
            parent, "android.hardware.drm@1.2::ICryptoFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::ICryptoFactory>> ICryptoFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_0::ICryptoFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICryptoFactory, ::android::hardware::drm::V1_0::ICryptoFactory, BpHwCryptoFactory>(
            parent, "android.hardware.drm@1.2::ICryptoFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::ICryptoFactory>> ICryptoFactory::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCryptoFactory::BpHwCryptoFactory(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICryptoFactory>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.2", "ICryptoFactory") {
}
...
BnHwCryptoFactory::BnHwCryptoFactory(const ::android::sp<ICryptoFactory> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.drm@1.2", "ICryptoFactory") { 
...
BsCryptoFactory::BsCryptoFactory(const ::android::sp<::android::hardware::drm::V1_2::ICryptoFactory> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.2", "ICryptoFactory"), mImpl(impl) {
...
bool ICryptoFactory::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.drm@1.2::ICryptoFactory",
