#define LOG_TAG "android.hardware.drm@1.2::DrmPlugin"
...
#include <android/hardware/drm/1.2/BnHwDrmPlugin.h>
#include <android/hardware/drm/1.2/BsDrmPlugin.h>
...
const char* IDrmPlugin::descriptor("android.hardware.drm@1.2::IDrmPlugin");
...
::android::hardware::Return<void> IDrmPlugin::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::drm::V1_2::IDrmPlugin::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::IDrmPlugin>> IDrmPlugin::castFrom(const ::android::sp<::android::hardware::drm::V1_2::IDrmPlugin>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::IDrmPlugin>> IDrmPlugin::castFrom(const ::android::sp<::android::hardware::drm::V1_1::IDrmPlugin>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDrmPlugin, ::android::hardware::drm::V1_1::IDrmPlugin, BpHwDrmPlugin>(
            parent, "android.hardware.drm@1.2::IDrmPlugin", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::IDrmPlugin>> IDrmPlugin::castFrom(const ::android::sp<::android::hardware::drm::V1_0::IDrmPlugin>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDrmPlugin, ::android::hardware::drm::V1_0::IDrmPlugin, BpHwDrmPlugin>(
            parent, "android.hardware.drm@1.2::IDrmPlugin", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_2::IDrmPlugin>> IDrmPlugin::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwDrmPlugin::BpHwDrmPlugin(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IDrmPlugin>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.2", "IDrmPlugin") {
}
...
// Methods from ::android::hardware::drm::V1_2::IDrmPlugin follow.
::android::hardware::Return<void> BpHwDrmPlugin::_hidl_getOfflineLicenseKeySetIds(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getOfflineLicenseKeySetIds_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDrmPlugin::getOfflineLicenseKeySetIds::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "getOfflineLicenseKeySetIds", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(39 /* getOfflineLicenseKeySetIds */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::drm::V1_0::Status _hidl_out_status;
        const ::android::hardware::hidl_vec<::android::hardware::hidl_vec<uint8_t>>* _hidl_out_keySetIds;
        ...
        size_t _hidl__hidl_out_keySetIds_parent;

        _hidl_err = _hidl_reply.readBuffer(sizeof(*_hidl_out_keySetIds), &_hidl__hidl_out_keySetIds_parent,  reinterpret_cast<const void **>(&_hidl_out_keySetIds));

        if (_hidl_err != ::android::OK) { return; }

        size_t _hidl__hidl_out_keySetIds_child;

        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::hidl_vec<::android::hardware::hidl_vec<uint8_t>> &>(*_hidl_out_keySetIds),
                _hidl_reply,
                _hidl__hidl_out_keySetIds_parent,
                0 /* parentOffset */, &_hidl__hidl_out_keySetIds_child);

        if (_hidl_err != ::android::OK) { return; }

        for (size_t _hidl_index_0 = 0; _hidl_index_0 < _hidl_out_keySetIds->size(); ++_hidl_index_0) {
            size_t _hidl__hidl_out_keySetIds_deref_indexed_child;

            _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                    const_cast<::android::hardware::hidl_vec<uint8_t> &>((*_hidl_out_keySetIds)[_hidl_index_0]),
                    _hidl_reply,
                    _hidl__hidl_out_keySetIds_child,
                    _hidl_index_0 * sizeof(::android::hardware::hidl_vec<uint8_t>), &_hidl__hidl_out_keySetIds_deref_indexed_child);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "getOfflineLicenseKeySetIds", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::drm::V1_0::Status> BpHwDrmPlugin::_hidl_removeOfflineLicense(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& keySetId) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDrmPlugin::removeOfflineLicense::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&keySetId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "removeOfflineLicense", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(40 /* removeOfflineLicense */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "removeOfflineLicense", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDrmPlugin::_hidl_getOfflineLicenseState(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& keySetId, getOfflineLicenseState_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDrmPlugin::getOfflineLicenseState::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&keySetId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "getOfflineLicenseState", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(41 /* getOfflineLicenseState */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::drm::V1_0::Status _hidl_out_status;
        ::android::hardware::drm::V1_2::OfflineLicenseState _hidl_out_state;
        ...
        _hidl_err = _hidl_reply.readUint32((uint32_t *)&_hidl_out_state);
        if (_hidl_err != ::android::OK) { return; }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "getOfflineLicenseState", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDrmPlugin::_hidl_getKeyRequest_1_2(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& scope, const ::android::hardware::hidl_vec<uint8_t>& initData, const ::android::hardware::hidl_string& mimeType, ::android::hardware::drm::V1_0::KeyType keyType, const ::android::hardware::hidl_vec<::android::hardware::drm::V1_0::KeyValue>& optionalParameters, getKeyRequest_1_2_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDrmPlugin::getKeyRequest_1_2::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "getKeyRequest_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(42 /* getKeyRequest_1_2 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::drm::V1_2::Status _hidl_out_status;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "getKeyRequest_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDrmPlugin::_hidl_getProvisionRequest_1_2(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& certificateType, const ::android::hardware::hidl_string& certificateAuthority, getProvisionRequest_1_2_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDrmPlugin::getProvisionRequest_1_2::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "getProvisionRequest_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(43 /* getProvisionRequest_1_2 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::drm::V1_2::Status _hidl_out_status;
        const ::android::hardware::hidl_vec<uint8_t>* _hidl_out_request;
        const ::android::hardware::hidl_string* _hidl_out_defaultUrl;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)_hidl_out_defaultUrl);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "getProvisionRequest_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDrmPlugin::_hidl_getHdcpLevels_1_2(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getHdcpLevels_1_2_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDrmPlugin::getHdcpLevels_1_2::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "getHdcpLevels_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(44 /* getHdcpLevels_1_2 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::drm::V1_2::Status _hidl_out_status;
        ::android::hardware::drm::V1_2::HdcpLevel _hidl_out_connectedLevel;
        ::android::hardware::drm::V1_2::HdcpLevel _hidl_out_maxLevel;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "getHdcpLevels_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDrmPlugin::_hidl_sendSessionLostState(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& sessionId) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDrmPlugin::sendSessionLostState::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&sessionId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "sendSessionLostState", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(45 /* sendSessionLostState */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "sendSessionLostState", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDrmPlugin::_hidl_sendKeysChange_1_2(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& sessionId, const ::android::hardware::hidl_vec<::android::hardware::drm::V1_2::KeyStatus>& keyStatusList, bool hasNewUsableKey) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDrmPlugin::sendKeysChange_1_2::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&sessionId);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "sendKeysChange_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(46 /* sendKeysChange_1_2 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "sendKeysChange_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwDrmPlugin::BnHwDrmPlugin(const ::android::sp<IDrmPlugin> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.drm@1.2", "IDrmPlugin") { 
...
// Methods from ::android::hardware::drm::V1_2::IDrmPlugin follow.
::android::status_t BnHwDrmPlugin::_hidl_getOfflineLicenseKeySetIds(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDrmPlugin::getOfflineLicenseKeySetIds::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "getOfflineLicenseKeySetIds", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDrmPlugin*>(_hidl_this->getImpl().get())->getOfflineLicenseKeySetIds([&](const auto &_hidl_out_status, const auto &_hidl_out_keySetIds) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("getOfflineLicenseKeySetIds: _hidl_cb called a second time, but must be called once.");
        }
        ...
        _hidl_err = _hidl_reply->writeBuffer(&_hidl_out_keySetIds, sizeof(_hidl_out_keySetIds), &_hidl__hidl_out_keySetIds_parent);
        if (_hidl_err != ::android::OK) { goto _hidl_error; }
        ...
        for (size_t _hidl_index_0 = 0; _hidl_index_0 < _hidl_out_keySetIds.size(); ++_hidl_index_0) {
            size_t _hidl__hidl_out_keySetIds_indexed_child;

            _hidl_err = ::android::hardware::writeEmbeddedToParcel(
                    _hidl_out_keySetIds[_hidl_index_0],
                    _hidl_reply,
                    _hidl__hidl_out_keySetIds_child,
                    _hidl_index_0 * sizeof(::android::hardware::hidl_vec<uint8_t>), &_hidl__hidl_out_keySetIds_indexed_child);
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_keySetIds);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "getOfflineLicenseKeySetIds", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("getOfflineLicenseKeySetIds: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwDrmPlugin::_hidl_removeOfflineLicense(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDrmPlugin::removeOfflineLicense::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)keySetId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "removeOfflineLicense", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::drm::V1_0::Status _hidl_out_status = static_cast<IDrmPlugin*>(_hidl_this->getImpl().get())->removeOfflineLicense(*keySetId);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "removeOfflineLicense", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwDrmPlugin::_hidl_getOfflineLicenseState(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDrmPlugin::getOfflineLicenseState::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)keySetId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "getOfflineLicenseState", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDrmPlugin*>(_hidl_this->getImpl().get())->getOfflineLicenseState(*keySetId, [&](const auto &_hidl_out_status, const auto &_hidl_out_state) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("getOfflineLicenseState: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;
        ...
        _hidl_err = _hidl_reply->writeUint32((uint32_t)_hidl_out_state);
        if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_state);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "getOfflineLicenseState", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("getOfflineLicenseState: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwDrmPlugin::_hidl_getKeyRequest_1_2(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDrmPlugin::getKeyRequest_1_2::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)scope);
        ...
        _hidl_args.push_back((void *)optionalParameters);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "getKeyRequest_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDrmPlugin*>(_hidl_this->getImpl().get())->getKeyRequest_1_2(*scope, *initData, *mimeType, keyType, *optionalParameters, [&](const auto &_hidl_out_status, const auto &_hidl_out_request, const auto &_hidl_out_requestType, const auto &_hidl_out_defaultUrl) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("getKeyRequest_1_2: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_defaultUrl);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "getKeyRequest_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("getKeyRequest_1_2: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwDrmPlugin::_hidl_getProvisionRequest_1_2(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDrmPlugin::getProvisionRequest_1_2::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)certificateType);
        _hidl_args.push_back((void *)certificateAuthority);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "getProvisionRequest_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDrmPlugin*>(_hidl_this->getImpl().get())->getProvisionRequest_1_2(*certificateType, *certificateAuthority, [&](const auto &_hidl_out_status, const auto &_hidl_out_request, const auto &_hidl_out_defaultUrl) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("getProvisionRequest_1_2: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_defaultUrl);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "getProvisionRequest_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("getProvisionRequest_1_2: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwDrmPlugin::_hidl_getHdcpLevels_1_2(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDrmPlugin::getHdcpLevels_1_2::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "getHdcpLevels_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDrmPlugin*>(_hidl_this->getImpl().get())->getHdcpLevels_1_2([&](const auto &_hidl_out_status, const auto &_hidl_out_connectedLevel, const auto &_hidl_out_maxLevel) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("getHdcpLevels_1_2: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_maxLevel);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "getHdcpLevels_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("getHdcpLevels_1_2: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwDrmPlugin::_hidl_sendSessionLostState(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDrmPlugin::sendSessionLostState::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)sessionId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "sendSessionLostState", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IDrmPlugin*>(_hidl_this->getImpl().get())->sendSessionLostState(*sessionId);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "sendSessionLostState", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwDrmPlugin::_hidl_sendKeysChange_1_2(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDrmPlugin::sendKeysChange_1_2::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)sessionId);
        ...
        _hidl_args.push_back((void *)&hasNewUsableKey);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.2", "IDrmPlugin", "sendKeysChange_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IDrmPlugin*>(_hidl_this->getImpl().get())->sendKeysChange_1_2(*sessionId, *keyStatusList, hasNewUsableKey);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.2", "IDrmPlugin", "sendKeysChange_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsDrmPlugin::BsDrmPlugin(const ::android::sp<::android::hardware::drm::V1_2::IDrmPlugin> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.2", "IDrmPlugin"), mImpl(impl) {
...
bool IDrmPlugin::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.drm@1.2::IDrmPlugin",
