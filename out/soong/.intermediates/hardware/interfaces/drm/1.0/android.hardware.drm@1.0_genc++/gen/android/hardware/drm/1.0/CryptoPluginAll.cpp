#define LOG_TAG "android.hardware.drm@1.0::CryptoPlugin"
...
#include <android/hardware/drm/1.0/BnHwCryptoPlugin.h>
#include <android/hardware/drm/1.0/BsCryptoPlugin.h>
...
const char* ICryptoPlugin::descriptor("android.hardware.drm@1.0::ICryptoPlugin");
...
::android::hardware::Return<void> ICryptoPlugin::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::drm::V1_0::ICryptoPlugin::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::drm::V1_0::ICryptoPlugin>> ICryptoPlugin::castFrom(const ::android::sp<::android::hardware::drm::V1_0::ICryptoPlugin>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_0::ICryptoPlugin>> ICryptoPlugin::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICryptoPlugin, ::android::hidl::base::V1_0::IBase, BpHwCryptoPlugin>(
            parent, "android.hardware.drm@1.0::ICryptoPlugin", emitError);
}
...
BpHwCryptoPlugin::BpHwCryptoPlugin(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICryptoPlugin>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.0", "ICryptoPlugin") {
}
...
// Methods from ::android::hardware::drm::V1_0::ICryptoPlugin follow.
::android::hardware::Return<bool> BpHwCryptoPlugin::_hidl_requiresSecureDecoderComponent(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& mime) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::requiresSecureDecoderComponent::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&mime);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.0", "ICryptoPlugin", "requiresSecureDecoderComponent", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* requiresSecureDecoderComponent */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.0", "ICryptoPlugin", "requiresSecureDecoderComponent", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwCryptoPlugin::_hidl_notifyResolution(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t width, uint32_t height) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::notifyResolution::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.0", "ICryptoPlugin", "notifyResolution", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* notifyResolution */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.0", "ICryptoPlugin", "notifyResolution", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::drm::V1_0::Status> BpHwCryptoPlugin::_hidl_setMediaDrmSession(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& sessionId) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::setMediaDrmSession::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&sessionId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.0", "ICryptoPlugin", "setMediaDrmSession", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(3 /* setMediaDrmSession */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.0", "ICryptoPlugin", "setMediaDrmSession", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwCryptoPlugin::_hidl_setSharedBufferBase(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_memory& base, uint32_t bufferId) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::setSharedBufferBase::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&base);
        _hidl_args.push_back((void *)&bufferId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.0", "ICryptoPlugin", "setSharedBufferBase", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    size_t _hidl_base_parent;

    _hidl_err = _hidl_data.writeBuffer(&base, sizeof(base), &_hidl_base_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(4 /* setSharedBufferBase */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.0", "ICryptoPlugin", "setSharedBufferBase", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwCryptoPlugin::_hidl_decrypt(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool secure, const ::android::hardware::hidl_array<uint8_t, 16>& keyId, const ::android::hardware::hidl_array<uint8_t, 16>& iv, ::android::hardware::drm::V1_0::Mode mode, const ::android::hardware::drm::V1_0::Pattern& pattern, const ::android::hardware::hidl_vec<::android::hardware::drm::V1_0::SubSample>& subSamples, const ::android::hardware::drm::V1_0::SharedBuffer& source, uint64_t offset, const ::android::hardware::drm::V1_0::DestinationBuffer& destination, decrypt_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::decrypt::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&secure);
        _hidl_args.push_back((void *)&keyId);
        _hidl_args.push_back((void *)&iv);
        _hidl_args.push_back((void *)&mode);
        _hidl_args.push_back((void *)&pattern);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.0", "ICryptoPlugin", "decrypt", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_err = _hidl_data.writeBool(secure);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_keyId_parent;

    _hidl_err = _hidl_data.writeBuffer(keyId.data(), 16 * sizeof(uint8_t), &_hidl_keyId_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_iv_parent;

    _hidl_err = _hidl_data.writeBuffer(iv.data(), 16 * sizeof(uint8_t), &_hidl_iv_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_err = _hidl_data.writeUint32((uint32_t)mode);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_pattern_parent;

    _hidl_err = _hidl_data.writeBuffer(&pattern, sizeof(pattern), &_hidl_pattern_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_err = _hidl_data.writeUint64(offset);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(5 /* decrypt */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::drm::V1_0::Status _hidl_out_status;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.0", "ICryptoPlugin", "decrypt", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwCryptoPlugin::BnHwCryptoPlugin(const ::android::sp<ICryptoPlugin> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.drm@1.0", "ICryptoPlugin") { 
...
// Methods from ::android::hardware::drm::V1_0::ICryptoPlugin follow.
::android::status_t BnHwCryptoPlugin::_hidl_requiresSecureDecoderComponent(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::requiresSecureDecoderComponent::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)mime);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.0", "ICryptoPlugin", "requiresSecureDecoderComponent", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    bool _hidl_out_secureRequired = static_cast<ICryptoPlugin*>(_hidl_this->getImpl().get())->requiresSecureDecoderComponent(*mime);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_secureRequired);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.0", "ICryptoPlugin", "requiresSecureDecoderComponent", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwCryptoPlugin::_hidl_notifyResolution(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::notifyResolution::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&width);
        _hidl_args.push_back((void *)&height);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.0", "ICryptoPlugin", "notifyResolution", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<ICryptoPlugin*>(_hidl_this->getImpl().get())->notifyResolution(width, height);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.0", "ICryptoPlugin", "notifyResolution", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwCryptoPlugin::_hidl_setMediaDrmSession(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::setMediaDrmSession::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)sessionId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.0", "ICryptoPlugin", "setMediaDrmSession", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::drm::V1_0::Status _hidl_out_status = static_cast<ICryptoPlugin*>(_hidl_this->getImpl().get())->setMediaDrmSession(*sessionId);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.0", "ICryptoPlugin", "setMediaDrmSession", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwCryptoPlugin::_hidl_setSharedBufferBase(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    const ::android::hardware::hidl_memory* base;
    uint32_t bufferId;

    size_t _hidl_base_parent;

    _hidl_err = _hidl_data.readBuffer(sizeof(*base), &_hidl_base_parent,  reinterpret_cast<const void **>(&base));

    if (_hidl_err != ::android::OK) { return _hidl_err; }

    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_memory &>(*base),
            _hidl_data,
            _hidl_base_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::setSharedBufferBase::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)base);
        _hidl_args.push_back((void *)&bufferId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.0", "ICryptoPlugin", "setSharedBufferBase", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<ICryptoPlugin*>(_hidl_this->getImpl().get())->setSharedBufferBase(*base, bufferId);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.0", "ICryptoPlugin", "setSharedBufferBase", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwCryptoPlugin::_hidl_decrypt(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    bool secure;
    const ::android::hardware::hidl_array<uint8_t, 16>* keyId;
    const ::android::hardware::hidl_array<uint8_t, 16>* iv;
    ::android::hardware::drm::V1_0::Mode mode;
    ::android::hardware::drm::V1_0::Pattern* pattern;
    const ::android::hardware::hidl_vec<::android::hardware::drm::V1_0::SubSample>* subSamples;
    ::android::hardware::drm::V1_0::SharedBuffer* source;
    uint64_t offset;
    ::android::hardware::drm::V1_0::DestinationBuffer* destination;

    _hidl_err = _hidl_data.readBool(&secure);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    size_t _hidl_keyId_parent;

    _hidl_err = _hidl_data.readBuffer(16 * sizeof(uint8_t), &_hidl_keyId_parent,  reinterpret_cast<const void **>(&keyId));

    if (_hidl_err != ::android::OK) { return _hidl_err; }

    size_t _hidl_iv_parent;

    _hidl_err = _hidl_data.readBuffer(16 * sizeof(uint8_t), &_hidl_iv_parent,  reinterpret_cast<const void **>(&iv));
    ...
    _hidl_err = _hidl_data.readBuffer(sizeof(*pattern), &_hidl_pattern_parent,  const_cast<const void**>(reinterpret_cast<void **>(&pattern)));
    if (_hidl_err != ::android::OK) { return _hidl_err; }
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::drm::V1_0::SubSample> &>(*subSamples),
            _hidl_data,
            _hidl_subSamples_parent,
            0 /* parentOffset */, &_hidl_subSamples_child);
    ...
    _hidl_err = _hidl_data.readBuffer(sizeof(*source), &_hidl_source_parent,  const_cast<const void**>(reinterpret_cast<void **>(&source)));
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    _hidl_err = _hidl_data.readUint64(&offset);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    size_t _hidl_destination_parent;

    _hidl_err = _hidl_data.readBuffer(sizeof(*destination), &_hidl_destination_parent,  const_cast<const void**>(reinterpret_cast<void **>(&destination)));
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::drm::V1_0::DestinationBuffer &>(*destination),
            _hidl_data,
            _hidl_destination_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICryptoPlugin::decrypt::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&secure);
        ...
        _hidl_args.push_back((void *)destination);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.0", "ICryptoPlugin", "decrypt", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICryptoPlugin*>(_hidl_this->getImpl().get())->decrypt(secure, *keyId, *iv, mode, *pattern, *subSamples, *source, offset, *destination, [&](const auto &_hidl_out_status, const auto &_hidl_out_bytesWritten, const auto &_hidl_out_detailedError) {
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_detailedError);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.0", "ICryptoPlugin", "decrypt", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BsCryptoPlugin::BsCryptoPlugin(const ::android::sp<::android::hardware::drm::V1_0::ICryptoPlugin> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.0", "ICryptoPlugin"), mImpl(impl) {
...
bool ICryptoPlugin::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.drm@1.0::ICryptoPlugin",
