#define LOG_TAG "android.hardware.drm@1.3::DrmFactory"
...
#include <android/hardware/drm/1.3/BpHwDrmFactory.h>
#include <android/hardware/drm/1.3/BnHwDrmFactory.h>
#include <android/hardware/drm/1.3/BsDrmFactory.h>
...
const char* IDrmFactory::descriptor("android.hardware.drm@1.3::IDrmFactory");
...
// no default implementation for: ::android::hardware::Return<void> IDrmFactory::getSupportedCryptoSchemes(getSupportedCryptoSchemes_cb _hidl_cb)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IDrmFactory::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::drm::V1_3::IDrmFactory::descriptor,
...
::android::hardware::Return<void> IDrmFactory::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::drm::V1_3::IDrmFactory::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IDrmFactory::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){153,77,8,171,39,214,19,2,44,37,138,158,196,140,236,231,173,242,163,5,233,45,245,215,110,249,35,226,198,102,95,100} /* 994d08ab27d613022c258a9ec48cece7adf2a305e92df5d76ef923e2c6665f64 */,
...
::android::hardware::Return<::android::sp<::android::hardware::drm::V1_3::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_3::IDrmFactory>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_3::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_2::IDrmFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDrmFactory, ::android::hardware::drm::V1_2::IDrmFactory, BpHwDrmFactory>(
            parent, "android.hardware.drm@1.3::IDrmFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_3::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_1::IDrmFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDrmFactory, ::android::hardware::drm::V1_1::IDrmFactory, BpHwDrmFactory>(
            parent, "android.hardware.drm@1.3::IDrmFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_3::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hardware::drm::V1_0::IDrmFactory>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDrmFactory, ::android::hardware::drm::V1_0::IDrmFactory, BpHwDrmFactory>(
            parent, "android.hardware.drm@1.3::IDrmFactory", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::drm::V1_3::IDrmFactory>> IDrmFactory::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwDrmFactory::BpHwDrmFactory(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IDrmFactory>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.3", "IDrmFactory") {
}
...
// Methods from ::android::hardware::drm::V1_3::IDrmFactory follow.
::android::hardware::Return<void> BpHwDrmFactory::_hidl_getSupportedCryptoSchemes(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getSupportedCryptoSchemes_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDrmFactory::getSupportedCryptoSchemes::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.drm", "1.3", "IDrmFactory", "getSupportedCryptoSchemes", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(5 /* getSupportedCryptoSchemes */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        const ::android::hardware::hidl_vec<::android::hardware::hidl_array<uint8_t, 16>>* _hidl_out_schemes;
        ...
        size_t _hidl__hidl_out_schemes_parent;

        _hidl_err = _hidl_reply.readBuffer(sizeof(*_hidl_out_schemes), &_hidl__hidl_out_schemes_parent,  reinterpret_cast<const void **>(&_hidl_out_schemes));

        if (_hidl_err != ::android::OK) { return; }

        size_t _hidl__hidl_out_schemes_child;

        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::hidl_vec<::android::hardware::hidl_array<uint8_t, 16>> &>(*_hidl_out_schemes),
                _hidl_reply,
                _hidl__hidl_out_schemes_parent,
                0 /* parentOffset */, &_hidl__hidl_out_schemes_child);

        if (_hidl_err != ::android::OK) { return; }

        _hidl_cb(*_hidl_out_schemes);

        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)_hidl_out_schemes);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.drm", "1.3", "IDrmFactory", "getSupportedCryptoSchemes", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::drm::V1_3::IDrmFactory follow.
::android::hardware::Return<void> BpHwDrmFactory::getSupportedCryptoSchemes(getSupportedCryptoSchemes_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::drm::V1_3::BpHwDrmFactory::_hidl_getSupportedCryptoSchemes(this, this, _hidl_cb);
...
BnHwDrmFactory::BnHwDrmFactory(const ::android::sp<IDrmFactory> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.drm@1.3", "IDrmFactory") { 
...
// Methods from ::android::hardware::drm::V1_3::IDrmFactory follow.
::android::status_t BnHwDrmFactory::_hidl_getSupportedCryptoSchemes(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDrmFactory::getSupportedCryptoSchemes::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.drm", "1.3", "IDrmFactory", "getSupportedCryptoSchemes", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDrmFactory*>(_hidl_this->getImpl().get())->getSupportedCryptoSchemes([&](const auto &_hidl_out_schemes) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("getSupportedCryptoSchemes: _hidl_cb called a second time, but must be called once.");
        }
        ...
        _hidl_err = _hidl_reply->writeBuffer(&_hidl_out_schemes, sizeof(_hidl_out_schemes), &_hidl__hidl_out_schemes_parent);
        if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_schemes);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.drm", "1.3", "IDrmFactory", "getSupportedCryptoSchemes", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("getSupportedCryptoSchemes: _hidl_cb not called, but must be called once.");
    }
...
::android::status_t BnHwDrmFactory::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 5 /* getSupportedCryptoSchemes */:
        {
            _hidl_err = ::android::hardware::drm::V1_3::BnHwDrmFactory::_hidl_getSupportedCryptoSchemes(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsDrmFactory::BsDrmFactory(const ::android::sp<::android::hardware::drm::V1_3::IDrmFactory> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.drm@1.3", "IDrmFactory"), mImpl(impl) {
...
bool IDrmFactory::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.drm@1.3::IDrmFactory",
