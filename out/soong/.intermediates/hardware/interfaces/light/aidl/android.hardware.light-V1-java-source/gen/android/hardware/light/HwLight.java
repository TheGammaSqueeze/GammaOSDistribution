...
public class HwLight implements android.os.Parcelable
{
  ...
  public static final android.os.Parcelable.Creator<HwLight> CREATOR = new android.os.Parcelable.Creator<HwLight>() {
    @Override
    public HwLight createFromParcel(android.os.Parcel _aidl_source) {
