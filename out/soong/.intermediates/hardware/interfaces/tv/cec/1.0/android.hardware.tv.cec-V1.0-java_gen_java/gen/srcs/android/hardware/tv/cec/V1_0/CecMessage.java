...
public final class CecMessage {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.tv.cec.V1_0.CecMessage.class) {
            return false;
        }
    ...
    public final String toString() {
        ...
        builder.append(android.hardware.tv.cec.V1_0.CecLogicalAddress.toString(this.initiator));
        builder.append(", .destination = ");
        builder.append(android.hardware.tv.cec.V1_0.CecLogicalAddress.toString(this.destination));
        builder.append(", .body = ");
    ...
    public static final java.util.ArrayList<CecMessage> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((android.hardware.tv.cec.V1_0.CecMessage) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
