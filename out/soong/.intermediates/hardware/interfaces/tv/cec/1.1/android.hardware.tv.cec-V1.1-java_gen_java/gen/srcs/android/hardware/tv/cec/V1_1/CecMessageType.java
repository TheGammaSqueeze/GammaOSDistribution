...
public final class CecMessageType {
    ...
    public static final int GIVE_FEATURES = 165 /* 0xA5 */;
    public static final int REPORT_FEATURES = 166 /* 0xA6 */;
    public static final int REQUEST_CURRENT_LATENCY = 167 /* 0xA7 */;
    public static final int REPORT_CURRENT_LATENCY = 168 /* 0xA8 */;
    public static final String toString(int o) {
        ...
        if (o == REPORT_FEATURES) {
            return "REPORT_FEATURES";
        }
        if (o == REQUEST_CURRENT_LATENCY) {
            return "REQUEST_CURRENT_LATENCY";
        }
        if (o == REPORT_CURRENT_LATENCY) {
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & GIVE_FEATURES) == GIVE_FEATURES) {
            list.add("GIVE_FEATURES");
            flipped |= GIVE_FEATURES;
        }
        if ((o & REPORT_FEATURES) == REPORT_FEATURES) {
            list.add("REPORT_FEATURES");
            flipped |= REPORT_FEATURES;
        }
        if ((o & REQUEST_CURRENT_LATENCY) == REQUEST_CURRENT_LATENCY) {
            list.add("REQUEST_CURRENT_LATENCY");
            flipped |= REQUEST_CURRENT_LATENCY;
        }
        if ((o & REPORT_CURRENT_LATENCY) == REPORT_CURRENT_LATENCY) {
            list.add("REPORT_CURRENT_LATENCY");
            flipped |= REPORT_CURRENT_LATENCY;
        }
        if (o != flipped) {
