...
public interface IHdmiCec extends android.hardware.tv.cec.V1_0.IHdmiCec {
    ...
    public static IHdmiCec getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IHdmiCec.asInterface(android.os.HwBinder.getService("android.hardware.tv.cec@1.1::IHdmiCec", serviceName, retry));
    }
    ...
    public static IHdmiCec getService(String serviceName) throws android.os.RemoteException {
        return IHdmiCec.asInterface(android.os.HwBinder.getService("android.hardware.tv.cec@1.1::IHdmiCec", serviceName));
    }
     ...
     */
    int addLogicalAddress_1_1(int addr)
     ...
     */
    int sendMessage_1_1(android.hardware.tv.cec.V1_1.CecMessage message)
        throws android.os.RemoteException;
    /**
     ...
     */
    void setCallback_1_1(android.hardware.tv.cec.V1_1.IHdmiCecCallback callback)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements IHdmiCec {
        ...
        @Override
        public int addLogicalAddress_1_1(int addr)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
            _hidl_request.writeInt32(addr);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(13 /* addLogicalAddress_1_1 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public int sendMessage_1_1(android.hardware.tv.cec.V1_1.CecMessage message)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(14 /* sendMessage_1_1 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void setCallback_1_1(android.hardware.tv.cec.V1_1.IHdmiCecCallback callback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
            _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(15 /* setCallback_1_1 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IHdmiCec {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{99,-33,-37,67,58,-57,63,-78,-65,74,68,-46,-83,-25,-73,-30,-119,-31,85,-125,82,6,-47,-109,-106,64,-42,-56,-115,32,-119,-108} /* 63dfdb433ac73fb2bf4a44d2ade7b7e289e155835206d1939640d6c88d208994 */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 13 /* addLogicalAddress_1_1 */:
                {
                    _hidl_request.enforceInterface(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);

                    int addr = _hidl_request.readInt32();
                    int _hidl_out_result = addLogicalAddress_1_1(addr);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_result);
                    _hidl_reply.send();
                    break;
                ...
                case 14 /* sendMessage_1_1 */:
                {
                    ...
                    int _hidl_out_result = sendMessage_1_1(message);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_result);
                    _hidl_reply.send();
                    break;
                ...
                case 15 /* setCallback_1_1 */:
                {
                    _hidl_request.enforceInterface(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);

                    android.hardware.tv.cec.V1_1.IHdmiCecCallback callback = android.hardware.tv.cec.V1_1.IHdmiCecCallback.asInterface(_hidl_request.readStrongBinder());
                    setCallback_1_1(callback);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.send();
                    break;
                }
