#define LOG_TAG "android.hardware.sensors@2.1::SensorsCallback"
...
#include <android/hardware/sensors/2.1/BpHwSensorsCallback.h>
#include <android/hardware/sensors/2.1/BnHwSensorsCallback.h>
#include <android/hardware/sensors/2.1/BsSensorsCallback.h>
...
const char* ISensorsCallback::descriptor("android.hardware.sensors@2.1::ISensorsCallback");
...
// no default implementation for: ::android::hardware::Return<void> ISensorsCallback::onDynamicSensorsConnected_2_1(const ::android::hardware::hidl_vec<::android::hardware::sensors::V2_1::SensorInfo>& sensorInfos)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> ISensorsCallback::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::sensors::V2_1::ISensorsCallback::descriptor,
...
::android::hardware::Return<void> ISensorsCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::sensors::V2_1::ISensorsCallback::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> ISensorsCallback::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){61,65,65,198,55,60,217,202,2,254,34,26,125,18,52,56,64,222,34,85,208,50,195,130,72,254,142,53,129,107,88,178} /* 3d4141c6373cd9ca02fe221a7d12343840de2255d032c38248fe8e35816b58b2 */,
...
::android::hardware::Return<::android::sp<::android::hardware::sensors::V2_1::ISensorsCallback>> ISensorsCallback::castFrom(const ::android::sp<::android::hardware::sensors::V2_1::ISensorsCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::sensors::V2_1::ISensorsCallback>> ISensorsCallback::castFrom(const ::android::sp<::android::hardware::sensors::V2_0::ISensorsCallback>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ISensorsCallback, ::android::hardware::sensors::V2_0::ISensorsCallback, BpHwSensorsCallback>(
            parent, "android.hardware.sensors@2.1::ISensorsCallback", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::sensors::V2_1::ISensorsCallback>> ISensorsCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwSensorsCallback::BpHwSensorsCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ISensorsCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.sensors@2.1", "ISensorsCallback") {
}
...
// Methods from ::android::hardware::sensors::V2_1::ISensorsCallback follow.
::android::hardware::Return<void> BpHwSensorsCallback::_hidl_onDynamicSensorsConnected_2_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::sensors::V2_1::SensorInfo>& sensorInfos) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ISensorsCallback::onDynamicSensorsConnected_2_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&sensorInfos);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.sensors", "2.1", "ISensorsCallback", "onDynamicSensorsConnected_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(3 /* onDynamicSensorsConnected_2_1 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.sensors", "2.1", "ISensorsCallback", "onDynamicSensorsConnected_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::sensors::V2_1::ISensorsCallback follow.
::android::hardware::Return<void> BpHwSensorsCallback::onDynamicSensorsConnected_2_1(const ::android::hardware::hidl_vec<::android::hardware::sensors::V2_1::SensorInfo>& sensorInfos){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::sensors::V2_1::BpHwSensorsCallback::_hidl_onDynamicSensorsConnected_2_1(this, this, sensorInfos);
...
BnHwSensorsCallback::BnHwSensorsCallback(const ::android::sp<ISensorsCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.sensors@2.1", "ISensorsCallback") { 
...
// Methods from ::android::hardware::sensors::V2_1::ISensorsCallback follow.
::android::status_t BnHwSensorsCallback::_hidl_onDynamicSensorsConnected_2_1(
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::sensors::V2_1::SensorInfo> &>(*sensorInfos),
            _hidl_data,
            _hidl_sensorInfos_parent,
            0 /* parentOffset */, &_hidl_sensorInfos_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < sensorInfos->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::sensors::V2_1::SensorInfo &>((*sensorInfos)[_hidl_index_0]),
                _hidl_data,
                _hidl_sensorInfos_child,
                _hidl_index_0 * sizeof(::android::hardware::sensors::V2_1::SensorInfo));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ISensorsCallback::onDynamicSensorsConnected_2_1::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)sensorInfos);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.sensors", "2.1", "ISensorsCallback", "onDynamicSensorsConnected_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<ISensorsCallback*>(_hidl_this->getImpl().get())->onDynamicSensorsConnected_2_1(*sensorInfos);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.sensors", "2.1", "ISensorsCallback", "onDynamicSensorsConnected_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwSensorsCallback::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 3 /* onDynamicSensorsConnected_2_1 */:
        {
            _hidl_err = ::android::hardware::sensors::V2_1::BnHwSensorsCallback::_hidl_onDynamicSensorsConnected_2_1(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsSensorsCallback::BsSensorsCallback(const ::android::sp<::android::hardware::sensors::V2_1::ISensorsCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.sensors@2.1", "ISensorsCallback"), mImpl(impl) {
...
bool ISensorsCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.sensors@2.1::ISensorsCallback",
