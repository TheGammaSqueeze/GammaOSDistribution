 ...
 */
public interface IWifiStaIface extends android.hardware.wifi.V1_3.IWifiStaIface {
    /**
     * Fully-qualified interface name for this interface.
     */
    public static final String kInterfaceName = "android.hardware.wifi@1.5::IWifiStaIface";
    ...
    public static IWifiStaIface getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IWifiStaIface.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.5::IWifiStaIface", serviceName, retry));
    }
    ...
    public static IWifiStaIface getService(String serviceName) throws android.os.RemoteException {
        return IWifiStaIface.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.5::IWifiStaIface", serviceName));
    }
    ...
    public interface getLinkLayerStats_1_5Callback {
        public void onValues(android.hardware.wifi.V1_0.WifiStatus status, android.hardware.wifi.V1_5.StaLinkLayerStats stats);
    }
     ...
     */
    void getLinkLayerStats_1_5(getLinkLayerStats_1_5Callback _hidl_cb)
     ...
     */
    android.hardware.wifi.V1_0.WifiStatus setScanMode(boolean enable)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements IWifiStaIface {
        ...
        @Override
        public void getLinkLayerStats_1_3(getLinkLayerStats_1_3Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_3.IWifiStaIface.kInterfaceName);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(28 /* getLinkLayerStats_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = new android.hardware.wifi.V1_0.WifiStatus();
                ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).readFromParcel(_hidl_reply);
                android.hardware.wifi.V1_3.StaLinkLayerStats _hidl_out_stats = new android.hardware.wifi.V1_3.StaLinkLayerStats();
                ((android.hardware.wifi.V1_3.StaLinkLayerStats) _hidl_out_stats).readFromParcel(_hidl_reply);
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_stats);
            } finally {
                _hidl_reply.release();
            }
        ...
        public void getFactoryMacAddress(getFactoryMacAddressCallback _hidl_cb)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(29 /* getFactoryMacAddress */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        // Methods from ::android::hardware::wifi::V1_5::IWifiStaIface follow.
        @Override
        public void getLinkLayerStats_1_5(getLinkLayerStats_1_5Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_5.IWifiStaIface.kInterfaceName);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(30 /* getLinkLayerStats_1_5 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = new android.hardware.wifi.V1_0.WifiStatus();
                ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).readFromParcel(_hidl_reply);
                android.hardware.wifi.V1_5.StaLinkLayerStats _hidl_out_stats = new android.hardware.wifi.V1_5.StaLinkLayerStats();
                ((android.hardware.wifi.V1_5.StaLinkLayerStats) _hidl_out_stats).readFromParcel(_hidl_reply);
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_stats);
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus setScanMode(boolean enable)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_5.IWifiStaIface.kInterfaceName);
            _hidl_request.writeBool(enable);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(31 /* setScanMode */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IWifiStaIface {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.wifi.V1_5.IWifiStaIface.kInterfaceName,
                    android.hardware.wifi.V1_3.IWifiStaIface.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.V1_5.IWifiStaIface.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-79,84,-71,-2,-117,-108,-49,100,57,39,102,-65,-39,50,-64,35,-19,-10,88,-70,-114,-52,75,-107,47,-124,36,5,-127,32,-27,-67} /* b154b9fe8b94cf64392766bfd932c023edf658ba8ecc4b952f8424058120e5bd */,
                    new byte[/* 32 */]{87,81,-14,48,-24,106,54,17,30,124,91,-103,85,119,-53,-8,-99,-115,-9,108,-114,108,118,65,25,-111,-104,-13,-37,58,-109,-9} /* 5751f230e86a36111e7c5b995577cbf89d8df76c8e6c7641199198f3db3a93f7 */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_3.IWifiStaIface.kInterfaceName);

                    getLinkLayerStats_1_3(new getLinkLayerStats_1_3Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.V1_0.WifiStatus status, android.hardware.wifi.V1_3.StaLinkLayerStats stats) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.V1_0.WifiStatus) status).writeToParcel(_hidl_reply);
                            ((android.hardware.wifi.V1_3.StaLinkLayerStats) stats).writeToParcel(_hidl_reply);
                            _hidl_reply.send();
                            }});
                    break;
                }
                ...
                case 30 /* getLinkLayerStats_1_5 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_5.IWifiStaIface.kInterfaceName);

                    getLinkLayerStats_1_5(new getLinkLayerStats_1_5Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.V1_0.WifiStatus status, android.hardware.wifi.V1_5.StaLinkLayerStats stats) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.V1_0.WifiStatus) status).writeToParcel(_hidl_reply);
                            ((android.hardware.wifi.V1_5.StaLinkLayerStats) stats).writeToParcel(_hidl_reply);
                            _hidl_reply.send();
                            }});
                    break;
                }
                ...
                case 31 /* setScanMode */:
                {
                    ...
                    boolean enable = _hidl_request.readBool();
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = setScanMode(enable);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
