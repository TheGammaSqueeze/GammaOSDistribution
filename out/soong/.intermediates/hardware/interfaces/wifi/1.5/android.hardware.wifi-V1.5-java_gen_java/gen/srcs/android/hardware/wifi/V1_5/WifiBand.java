...
public final class WifiBand {
    ...
    public static final String toString(int o) {
        ...
        if (o == BAND_24GHZ_5GHZ_6GHZ_60GHZ) {
            return "BAND_24GHZ_5GHZ_6GHZ_60GHZ";
        }
        if (o == BAND_24GHZ_5GHZ_WITH_DFS_6GHZ_60GHZ) {
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & BAND_60GHZ) == BAND_60GHZ) {
            list.add("BAND_60GHZ");
            flipped |= BAND_60GHZ;
        }
        if ((o & BAND_24GHZ_5GHZ_6GHZ_60GHZ) == BAND_24GHZ_5GHZ_6GHZ_60GHZ) {
            list.add("BAND_24GHZ_5GHZ_6GHZ_60GHZ");
            flipped |= BAND_24GHZ_5GHZ_6GHZ_60GHZ;
        }
        if ((o & BAND_24GHZ_5GHZ_WITH_DFS_6GHZ_60GHZ) == BAND_24GHZ_5GHZ_WITH_DFS_6GHZ_60GHZ) {
            list.add("BAND_24GHZ_5GHZ_WITH_DFS_6GHZ_60GHZ");
            flipped |= BAND_24GHZ_5GHZ_WITH_DFS_6GHZ_60GHZ;
        }
        if (o != flipped) {
