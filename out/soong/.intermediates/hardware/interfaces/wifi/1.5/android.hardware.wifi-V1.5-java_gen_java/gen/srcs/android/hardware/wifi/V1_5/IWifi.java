 ...
 */
public interface IWifi extends android.hardware.wifi.V1_4.IWifi {
    /**
     * Fully-qualified interface name for this interface.
     */
    public static final String kInterfaceName = "android.hardware.wifi@1.5::IWifi";
    ...
    public static IWifi getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IWifi.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.5::IWifi", serviceName, retry));
    }
    ...
    public static IWifi getService(String serviceName) throws android.os.RemoteException {
        return IWifi.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.5::IWifi", serviceName));
    }
     ...
     */
    android.hardware.wifi.V1_0.WifiStatus registerEventCallback_1_5(android.hardware.wifi.V1_5.IWifiEventCallback callback)
    ...
    public static final class Proxy implements IWifi {
        ...
        // Methods from ::android::hardware::wifi::V1_5::IWifi follow.
        @Override
        public android.hardware.wifi.V1_0.WifiStatus registerEventCallback_1_5(android.hardware.wifi.V1_5.IWifiEventCallback callback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_5.IWifi.kInterfaceName);
            _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(7 /* registerEventCallback_1_5 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IWifi {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.V1_5.IWifi.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-69,123,-113,101,52,82,-14,4,78,29,-75,-121,-50,-76,21,-19,-9,34,1,-85,-100,29,84,117,100,-61,-9,91,-6,-74,90,-125} /* bb7b8f653452f2044e1db587ceb415edf72201ab9c1d547564c3f75bfab65a83 */,
                    new byte[/* 32 */]{62,1,-44,68,108,-42,-97,-47,-60,-113,-123,114,-17,-39,116,-121,-68,23,-107,100,-77,43,-41,-107,-128,11,-105,-69,-31,11,-29,123} /* 3e01d4446cd69fd1c48f8572efd97487bc179564b32bd795800b97bbe10be37b */,
                    new byte[/* 32 */]{-15,-104,50,-123,106,63,83,-50,-43,-17,-111,-45,-52,99,10,87,-5,127,77,76,-31,95,54,77,-66,-48,-112,-103,-72,-97,104,48} /* f19832856a3f53ced5ef91d3cc630a57fb7f4d4ce15f364dbed09099b89f6830 */,
                    new byte[/* 32 */]{-117,-57,90,13,-6,-63,92,111,-121,-1,-20,-107,11,118,-57,-41,-34,48,-43,22,-75,78,-114,11,31,60,15,-7,-57,-58,-121,59} /* 8bc75a0dfac15c6f87ffec950b76c7d7de30d516b54e8e0b1f3c0ff9c7c6873b */,
                    new byte[/* 32 */]{-62,100,115,-30,-28,-96,10,-12,62,40,-96,-35,-7,0,46,80,98,-89,-48,-108,4,41,-27,-17,-74,-27,81,58,-118,-68,-73,92} /* c26473e2e4a00af43e28a0ddf9002e5062a7d0940429e5efb6e5513a8abcb75c */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 7 /* registerEventCallback_1_5 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_5.IWifi.kInterfaceName);

                    android.hardware.wifi.V1_5.IWifiEventCallback callback = android.hardware.wifi.V1_5.IWifiEventCallback.asInterface(_hidl_request.readStrongBinder());
