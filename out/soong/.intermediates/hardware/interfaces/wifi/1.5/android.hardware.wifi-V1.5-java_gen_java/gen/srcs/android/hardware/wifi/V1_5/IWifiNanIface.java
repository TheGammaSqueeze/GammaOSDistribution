 ...
 */
public interface IWifiNanIface extends android.hardware.wifi.V1_4.IWifiNanIface {
    /**
     * Fully-qualified interface name for this interface.
     */
    public static final String kInterfaceName = "android.hardware.wifi@1.5::IWifiNanIface";
    ...
    public static IWifiNanIface getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IWifiNanIface.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.5::IWifiNanIface", serviceName, retry));
    }
    ...
    public static IWifiNanIface getService(String serviceName) throws android.os.RemoteException {
        return IWifiNanIface.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.5::IWifiNanIface", serviceName));
    }
     ...
     */
    android.hardware.wifi.V1_0.WifiStatus enableRequest_1_5(short cmdId, android.hardware.wifi.V1_4.NanEnableRequest msg1, android.hardware.wifi.V1_5.NanConfigRequestSupplemental msg2)
     ...
     *         |WifiStatusCode.ERROR_UNKNOWN|
     */
    android.hardware.wifi.V1_0.WifiStatus configRequest_1_5(short cmdId, android.hardware.wifi.V1_4.NanConfigRequest msg1, android.hardware.wifi.V1_5.NanConfigRequestSupplemental msg2)
        throws android.os.RemoteException;
    /**
     ...
     *         |WifiStatusCode.ERROR_WIFI_IFACE_INVALID|
     */
    android.hardware.wifi.V1_0.WifiStatus registerEventCallback_1_5(android.hardware.wifi.V1_5.IWifiNanIfaceEventCallback callback)
        throws android.os.RemoteException;
    /**
     ...
     *         |WifiStatusCode.ERROR_UNKNOWN|
     */
    android.hardware.wifi.V1_0.WifiStatus getCapabilitiesRequest_1_5(short cmdId)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements IWifiNanIface {
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus registerEventCallback_1_2(android.hardware.wifi.V1_2.IWifiNanIfaceEventCallback callback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_2.IWifiNanIface.kInterfaceName);
            _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(18 /* registerEventCallback_1_2 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus enableRequest_1_2(short cmdId, android.hardware.wifi.V1_0.NanEnableRequest msg1, android.hardware.wifi.V1_2.NanConfigRequestSupplemental msg2)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_2.IWifiNanIface.kInterfaceName);
            _hidl_request.writeInt16(cmdId);
            ((android.hardware.wifi.V1_0.NanEnableRequest) msg1).writeToParcel(_hidl_request);
            ((android.hardware.wifi.V1_2.NanConfigRequestSupplemental) msg2).writeToParcel(_hidl_request);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(19 /* enableRequest_1_2 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus configRequest_1_2(short cmdId, android.hardware.wifi.V1_0.NanConfigRequest msg1, android.hardware.wifi.V1_2.NanConfigRequestSupplemental msg2)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_2.IWifiNanIface.kInterfaceName);
            _hidl_request.writeInt16(cmdId);
            ((android.hardware.wifi.V1_0.NanConfigRequest) msg1).writeToParcel(_hidl_request);
            ((android.hardware.wifi.V1_2.NanConfigRequestSupplemental) msg2).writeToParcel(_hidl_request);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(20 /* configRequest_1_2 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus enableRequest_1_4(short cmdId, android.hardware.wifi.V1_4.NanEnableRequest msg1, android.hardware.wifi.V1_2.NanConfigRequestSupplemental msg2)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_4.IWifiNanIface.kInterfaceName);
            _hidl_request.writeInt16(cmdId);
            ((android.hardware.wifi.V1_4.NanEnableRequest) msg1).writeToParcel(_hidl_request);
            ((android.hardware.wifi.V1_2.NanConfigRequestSupplemental) msg2).writeToParcel(_hidl_request);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(21 /* enableRequest_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus configRequest_1_4(short cmdId, android.hardware.wifi.V1_4.NanConfigRequest msg1, android.hardware.wifi.V1_2.NanConfigRequestSupplemental msg2)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_4.IWifiNanIface.kInterfaceName);
            _hidl_request.writeInt16(cmdId);
            ((android.hardware.wifi.V1_4.NanConfigRequest) msg1).writeToParcel(_hidl_request);
            ((android.hardware.wifi.V1_2.NanConfigRequestSupplemental) msg2).writeToParcel(_hidl_request);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(22 /* configRequest_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        // Methods from ::android::hardware::wifi::V1_5::IWifiNanIface follow.
        @Override
        public android.hardware.wifi.V1_0.WifiStatus enableRequest_1_5(short cmdId, android.hardware.wifi.V1_4.NanEnableRequest msg1, android.hardware.wifi.V1_5.NanConfigRequestSupplemental msg2)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_5.IWifiNanIface.kInterfaceName);
            _hidl_request.writeInt16(cmdId);
            ((android.hardware.wifi.V1_4.NanEnableRequest) msg1).writeToParcel(_hidl_request);
            ((android.hardware.wifi.V1_5.NanConfigRequestSupplemental) msg2).writeToParcel(_hidl_request);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(23 /* enableRequest_1_5 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus configRequest_1_5(short cmdId, android.hardware.wifi.V1_4.NanConfigRequest msg1, android.hardware.wifi.V1_5.NanConfigRequestSupplemental msg2)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_5.IWifiNanIface.kInterfaceName);
            _hidl_request.writeInt16(cmdId);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(24 /* configRequest_1_5 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus registerEventCallback_1_5(android.hardware.wifi.V1_5.IWifiNanIfaceEventCallback callback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_5.IWifiNanIface.kInterfaceName);
            _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(25 /* registerEventCallback_1_5 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus getCapabilitiesRequest_1_5(short cmdId)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_5.IWifiNanIface.kInterfaceName);
            _hidl_request.writeInt16(cmdId);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(26 /* getCapabilitiesRequest_1_5 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IWifiNanIface {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.wifi.V1_5.IWifiNanIface.kInterfaceName,
                    android.hardware.wifi.V1_4.IWifiNanIface.kInterfaceName,
                    android.hardware.wifi.V1_2.IWifiNanIface.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.V1_5.IWifiNanIface.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{69,-85,-109,55,-113,2,-88,-68,58,101,-120,83,-50,77,63,-36,30,-97,-94,-63,-47,-59,69,-126,29,73,11,-16,-12,-39,108,-20} /* 45ab93378f02a8bc3a658853ce4d3fdc1e9fa2c1d1c545821d490bf0f4d96cec */,
                    new byte[/* 32 */]{-1,102,55,26,70,125,31,60,-86,-50,-95,93,-109,-13,-101,123,118,123,13,107,-116,-44,29,4,3,55,-51,-85,-14,81,75,-121} /* ff66371a467d1f3caacea15d93f39b7b767b0d6b8cd41d040337cdabf2514b87 */,
                    new byte[/* 32 */]{-116,126,-13,47,-57,-115,94,-58,-26,-107,109,-29,120,76,-62,-58,-12,38,20,-75,39,45,46,70,31,109,96,83,75,-93,-114,-62} /* 8c7ef32fc78d5ec6e6956de3784cc2c6f42614b5272d2e461f6d60534ba38ec2 */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_2.IWifiNanIface.kInterfaceName);

                    android.hardware.wifi.V1_2.IWifiNanIfaceEventCallback callback = android.hardware.wifi.V1_2.IWifiNanIfaceEventCallback.asInterface(_hidl_request.readStrongBinder());
                ...
                case 19 /* enableRequest_1_2 */:
                {
                    ...
                    short cmdId = _hidl_request.readInt16();
                    android.hardware.wifi.V1_0.NanEnableRequest msg1 = new android.hardware.wifi.V1_0.NanEnableRequest();
                    ((android.hardware.wifi.V1_0.NanEnableRequest) msg1).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_2.NanConfigRequestSupplemental msg2 = new android.hardware.wifi.V1_2.NanConfigRequestSupplemental();
                    ((android.hardware.wifi.V1_2.NanConfigRequestSupplemental) msg2).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = enableRequest_1_2(cmdId, msg1, msg2);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 20 /* configRequest_1_2 */:
                {
                    ...
                    short cmdId = _hidl_request.readInt16();
                    android.hardware.wifi.V1_0.NanConfigRequest msg1 = new android.hardware.wifi.V1_0.NanConfigRequest();
                    ((android.hardware.wifi.V1_0.NanConfigRequest) msg1).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_2.NanConfigRequestSupplemental msg2 = new android.hardware.wifi.V1_2.NanConfigRequestSupplemental();
                    ((android.hardware.wifi.V1_2.NanConfigRequestSupplemental) msg2).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = configRequest_1_2(cmdId, msg1, msg2);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 21 /* enableRequest_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_4.IWifiNanIface.kInterfaceName);

                    short cmdId = _hidl_request.readInt16();
                    android.hardware.wifi.V1_4.NanEnableRequest msg1 = new android.hardware.wifi.V1_4.NanEnableRequest();
                    ((android.hardware.wifi.V1_4.NanEnableRequest) msg1).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_2.NanConfigRequestSupplemental msg2 = new android.hardware.wifi.V1_2.NanConfigRequestSupplemental();
                    ((android.hardware.wifi.V1_2.NanConfigRequestSupplemental) msg2).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = enableRequest_1_4(cmdId, msg1, msg2);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 22 /* configRequest_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_4.IWifiNanIface.kInterfaceName);

                    short cmdId = _hidl_request.readInt16();
                    android.hardware.wifi.V1_4.NanConfigRequest msg1 = new android.hardware.wifi.V1_4.NanConfigRequest();
                    ((android.hardware.wifi.V1_4.NanConfigRequest) msg1).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_2.NanConfigRequestSupplemental msg2 = new android.hardware.wifi.V1_2.NanConfigRequestSupplemental();
                    ((android.hardware.wifi.V1_2.NanConfigRequestSupplemental) msg2).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = configRequest_1_4(cmdId, msg1, msg2);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 23 /* enableRequest_1_5 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_5.IWifiNanIface.kInterfaceName);

                    short cmdId = _hidl_request.readInt16();
                    android.hardware.wifi.V1_4.NanEnableRequest msg1 = new android.hardware.wifi.V1_4.NanEnableRequest();
                    ((android.hardware.wifi.V1_4.NanEnableRequest) msg1).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_5.NanConfigRequestSupplemental msg2 = new android.hardware.wifi.V1_5.NanConfigRequestSupplemental();
                    ((android.hardware.wifi.V1_5.NanConfigRequestSupplemental) msg2).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = enableRequest_1_5(cmdId, msg1, msg2);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 24 /* configRequest_1_5 */:
                {
                    ...
                    android.hardware.wifi.V1_5.NanConfigRequestSupplemental msg2 = new android.hardware.wifi.V1_5.NanConfigRequestSupplemental();
                    ((android.hardware.wifi.V1_5.NanConfigRequestSupplemental) msg2).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = configRequest_1_5(cmdId, msg1, msg2);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 25 /* registerEventCallback_1_5 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_5.IWifiNanIface.kInterfaceName);

                    android.hardware.wifi.V1_5.IWifiNanIfaceEventCallback callback = android.hardware.wifi.V1_5.IWifiNanIfaceEventCallback.asInterface(_hidl_request.readStrongBinder());
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = registerEventCallback_1_5(callback);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 26 /* getCapabilitiesRequest_1_5 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_5.IWifiNanIface.kInterfaceName);

                    short cmdId = _hidl_request.readInt16();
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = getCapabilitiesRequest_1_5(cmdId);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
