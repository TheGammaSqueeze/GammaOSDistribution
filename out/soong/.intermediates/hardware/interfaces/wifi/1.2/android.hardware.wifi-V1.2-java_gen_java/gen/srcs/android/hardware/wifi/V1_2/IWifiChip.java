...
public interface IWifiChip extends android.hardware.wifi.V1_1.IWifiChip {
    ...
    public static IWifiChip getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IWifiChip.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.2::IWifiChip", serviceName, retry));
    }
    ...
    public static IWifiChip getService(String serviceName) throws android.os.RemoteException {
        return IWifiChip.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.2::IWifiChip", serviceName));
    }
    ...
    public static final class TxPowerScenario {
        ...
        public static final String toString(int o) {
            ...
            if (o == ON_HEAD_CELL_OFF) {
                return "ON_HEAD_CELL_OFF";
            }
            if (o == ON_HEAD_CELL_ON) {
                return "ON_HEAD_CELL_ON";
            }
            if (o == ON_BODY_CELL_OFF) {
                return "ON_BODY_CELL_OFF";
            }
            if (o == ON_BODY_CELL_ON) {
        ...
        public static final String dumpBitfield(int o) {
            ...
            if ((o & ON_HEAD_CELL_OFF) == ON_HEAD_CELL_OFF) {
                list.add("ON_HEAD_CELL_OFF");
                flipped |= ON_HEAD_CELL_OFF;
            }
            if ((o & ON_HEAD_CELL_ON) == ON_HEAD_CELL_ON) {
                list.add("ON_HEAD_CELL_ON");
                flipped |= ON_HEAD_CELL_ON;
            }
            if ((o & ON_BODY_CELL_OFF) == ON_BODY_CELL_OFF) {
                list.add("ON_BODY_CELL_OFF");
                flipped |= ON_BODY_CELL_OFF;
            }
            if ((o & ON_BODY_CELL_ON) == ON_BODY_CELL_ON) {
                list.add("ON_BODY_CELL_ON");
                flipped |= ON_BODY_CELL_ON;
            }
            if (o != flipped) {
                list.add("0x" + Integer.toHexString(o & (~flipped)));
            }
     ...
     */
    android.hardware.wifi.V1_0.WifiStatus selectTxPowerScenario_1_2(int scenario)
     ...
     *         |WifiStatusCode.ERROR_WIFI_CHIP_INVALID|
     */
    android.hardware.wifi.V1_0.WifiStatus registerEventCallback_1_2(android.hardware.wifi.V1_2.IWifiChipEventCallback callback)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements IWifiChip {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.V1_2.IWifiChip.kInterfaceName;
