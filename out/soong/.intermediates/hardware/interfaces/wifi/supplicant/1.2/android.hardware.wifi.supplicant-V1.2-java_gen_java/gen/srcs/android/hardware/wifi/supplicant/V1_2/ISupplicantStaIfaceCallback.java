...
public interface ISupplicantStaIfaceCallback extends android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback {
    ...
    public static ISupplicantStaIfaceCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISupplicantStaIfaceCallback.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.2::ISupplicantStaIfaceCallback", serviceName, retry));
    }
    ...
    public static ISupplicantStaIfaceCallback getService(String serviceName) throws android.os.RemoteException {
        return ISupplicantStaIfaceCallback.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.2::ISupplicantStaIfaceCallback", serviceName));
    }
     ...
     */
    void onDppSuccessConfigReceived(java.util.ArrayList<Byte> ssid, String password, byte[/* 32 */] psk, int securityAkm)
     ...
     */
    void onDppProgress(int code)
        throws android.os.RemoteException;
    /**
     * Indicates a DPP failure event.
     */
    void onDppFailure(int code)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISupplicantStaIfaceCallback {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.supplicant.V1_2.ISupplicantStaIfaceCallback.kInterfaceName;
