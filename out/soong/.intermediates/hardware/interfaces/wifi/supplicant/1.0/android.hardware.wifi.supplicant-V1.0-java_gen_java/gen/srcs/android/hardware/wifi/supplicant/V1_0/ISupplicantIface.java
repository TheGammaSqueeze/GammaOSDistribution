 ...
 * it controls.
 */
public interface ISupplicantIface extends android.hidl.base.V1_0.IBase {
    /**
     ...
     */
    /* package private */ static ISupplicantIface asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        ISupplicantIface proxy = new ISupplicantIface.Proxy(binder);
     ...
     */
    public static ISupplicantIface castFrom(android.os.IHwInterface iface) {
        return (iface == null) ? null : ISupplicantIface.asInterface(iface.asBinder());
    }
     ...
     */
    public static ISupplicantIface getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISupplicantIface.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.0::ISupplicantIface", serviceName, retry));
    }

    /**
     * Calls getService("default",retry).
     */
    public static ISupplicantIface getService(boolean retry) throws android.os.RemoteException {
     ...
     */
    @Deprecated
    public static ISupplicantIface getService(String serviceName) throws android.os.RemoteException {
        return ISupplicantIface.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.0::ISupplicantIface", serviceName));
    }
     ...
     */
    @Deprecated
    public static ISupplicantIface getService() throws android.os.RemoteException {
    ...
    public static final class ParamSizeLimits {
        ...
        public static final String toString(int o) {
            if (o == WPS_DEVICE_NAME_MAX_LEN) {
                return "WPS_DEVICE_NAME_MAX_LEN";
            }
            if (o == WPS_MANUFACTURER_MAX_LEN) {
                return "WPS_MANUFACTURER_MAX_LEN";
            }
            if (o == WPS_MODEL_NAME_MAX_LEN) {
                return "WPS_MODEL_NAME_MAX_LEN";
            }
            if (o == WPS_MODEL_NUMBER_MAX_LEN) {
                return "WPS_MODEL_NUMBER_MAX_LEN";
            }
            if (o == WPS_SERIAL_NUMBER_MAX_LEN) {
        ...
        public static final String dumpBitfield(int o) {
            ...
            int flipped = 0;
            if ((o & WPS_DEVICE_NAME_MAX_LEN) == WPS_DEVICE_NAME_MAX_LEN) {
                list.add("WPS_DEVICE_NAME_MAX_LEN");
                flipped |= WPS_DEVICE_NAME_MAX_LEN;
            }
            if ((o & WPS_MANUFACTURER_MAX_LEN) == WPS_MANUFACTURER_MAX_LEN) {
                list.add("WPS_MANUFACTURER_MAX_LEN");
                flipped |= WPS_MANUFACTURER_MAX_LEN;
            }
            if ((o & WPS_MODEL_NAME_MAX_LEN) == WPS_MODEL_NAME_MAX_LEN) {
                list.add("WPS_MODEL_NAME_MAX_LEN");
                flipped |= WPS_MODEL_NAME_MAX_LEN;
            }
            if ((o & WPS_MODEL_NUMBER_MAX_LEN) == WPS_MODEL_NUMBER_MAX_LEN) {
                list.add("WPS_MODEL_NUMBER_MAX_LEN");
                flipped |= WPS_MODEL_NUMBER_MAX_LEN;
            }
            if ((o & WPS_SERIAL_NUMBER_MAX_LEN) == WPS_SERIAL_NUMBER_MAX_LEN) {
                list.add("WPS_SERIAL_NUMBER_MAX_LEN");
                flipped |= WPS_SERIAL_NUMBER_MAX_LEN;
            }
            if (o != flipped) {
     ...
     */
    void addNetwork(addNetworkCallback _hidl_cb)
        throws android.os.RemoteException;
    /**
     ...
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus removeNetwork(int id)
        throws android.os.RemoteException;
     ...
     *         successful, null otherwise.
     */
    void getNetwork(int id, getNetworkCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void listNetworks(listNetworksCallback _hidl_cb)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setWpsDeviceName(String name)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setWpsDeviceType(byte[/* 8 */] type)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setWpsManufacturer(String manufacturer)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setWpsModelName(String modelName)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setWpsModelNumber(String modelNumber)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setWpsSerialNumber(String serialNumber)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setWpsConfigMethods(short configMethods)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements ISupplicantIface {
        ...
        public String toString() {
            ...
            return "[class or subclass of " + ISupplicantIface.kInterfaceName + "]@Proxy";
        }
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISupplicantIface {
        @Override
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.supplicant.V1_0.ISupplicantIface.kInterfaceName;
