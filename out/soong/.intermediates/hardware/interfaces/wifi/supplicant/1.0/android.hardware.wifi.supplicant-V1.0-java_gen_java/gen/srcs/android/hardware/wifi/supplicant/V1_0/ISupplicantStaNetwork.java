 ...
 */
public interface ISupplicantStaNetwork extends android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork {
    /**
    ...
    public static ISupplicantStaNetwork getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISupplicantStaNetwork.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.0::ISupplicantStaNetwork", serviceName, retry));
    }
    ...
    public static ISupplicantStaNetwork getService(String serviceName) throws android.os.RemoteException {
        return ISupplicantStaNetwork.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.0::ISupplicantStaNetwork", serviceName));
    }
    ...
    public static final class ParamSizeLimits {
        ...
        public static final String toString(int o) {
            ...
            if (o == PSK_PASSPHRASE_MIN_LEN_IN_BYTES) {
                return "PSK_PASSPHRASE_MIN_LEN_IN_BYTES";
            }
            if (o == PSK_PASSPHRASE_MAX_LEN_IN_BYTES) {
                return "PSK_PASSPHRASE_MAX_LEN_IN_BYTES";
            }
            if (o == WEP_KEYS_MAX_NUM) {
                return "WEP_KEYS_MAX_NUM";
            }
            if (o == WEP40_KEY_LEN_IN_BYTES) {
                return "WEP40_KEY_LEN_IN_BYTES";
            }
            if (o == WEP104_KEY_LEN_IN_BYTES) {
        ...
        public static final String dumpBitfield(int o) {
            ...
            if ((o & PSK_PASSPHRASE_MIN_LEN_IN_BYTES) == PSK_PASSPHRASE_MIN_LEN_IN_BYTES) {
                list.add("PSK_PASSPHRASE_MIN_LEN_IN_BYTES");
                flipped |= PSK_PASSPHRASE_MIN_LEN_IN_BYTES;
            }
            if ((o & PSK_PASSPHRASE_MAX_LEN_IN_BYTES) == PSK_PASSPHRASE_MAX_LEN_IN_BYTES) {
                list.add("PSK_PASSPHRASE_MAX_LEN_IN_BYTES");
                flipped |= PSK_PASSPHRASE_MAX_LEN_IN_BYTES;
            }
            if ((o & WEP_KEYS_MAX_NUM) == WEP_KEYS_MAX_NUM) {
                list.add("WEP_KEYS_MAX_NUM");
                flipped |= WEP_KEYS_MAX_NUM;
            }
            if ((o & WEP40_KEY_LEN_IN_BYTES) == WEP40_KEY_LEN_IN_BYTES) {
                list.add("WEP40_KEY_LEN_IN_BYTES");
                flipped |= WEP40_KEY_LEN_IN_BYTES;
            }
            if ((o & WEP104_KEY_LEN_IN_BYTES) == WEP104_KEY_LEN_IN_BYTES) {
                list.add("WEP104_KEY_LEN_IN_BYTES");
                flipped |= WEP104_KEY_LEN_IN_BYTES;
            }
            if (o != flipped) {
    ...
    public static final class ProtoMask {
        public static final int WPA = 1 /* 1 << 0 */;
        public static final int RSN = 2 /* 1 << 1 */;
        /**
         * Unused 1 << 2
         */
        public static final int OSEN = 8 /* 1 << 3 */;
        public static final String toString(int o) {
            if (o == WPA) {
                return "WPA";
            }
    ...
    public static final class AuthAlgMask {
        public static final int OPEN = 1 /* 1 << 0 */;
        public static final int SHARED = 2 /* 1 << 1 */;
        public static final int LEAP = 4 /* 1 << 2 */;
        public static final String toString(int o) {
            if (o == OPEN) {
                return "OPEN";
            }
    ...
    public static final class EapMethod {
        ...
        public static final String dumpBitfield(int o) {
            ...
            if ((o & AKA_PRIME) == AKA_PRIME) {
                list.add("AKA_PRIME");
                flipped |= AKA_PRIME;
            }
            if ((o & WFA_UNAUTH_TLS) == WFA_UNAUTH_TLS) {
                list.add("WFA_UNAUTH_TLS");
                flipped |= WFA_UNAUTH_TLS;
            }
            if (o != flipped) {
                list.add("0x" + Integer.toHexString(o & (~flipped)));
            }
     ...
     */
    public final static class NetworkResponseEapSimGsmAuthParams {
        public byte[/* 8 */] kc = new byte[8];
        public byte[/* 4 */] sres = new byte[4];
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (otherObject.getClass() != android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimGsmAuthParams.class) {
                return false;
            }
            android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimGsmAuthParams other = (android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimGsmAuthParams)otherObject;
            if (!android.os.HidlSupport.deepEquals(this.kc, other.kc)) {
                return false;
            }
            if (!android.os.HidlSupport.deepEquals(this.sres, other.sres)) {
                return false;
            }
            return true;
        }
        ...
        public final int hashCode() {
            return java.util.Objects.hash(
                    android.os.HidlSupport.deepHashCode(this.kc), 
                    android.os.HidlSupport.deepHashCode(this.sres));
        }
        ...
        public final String toString() {
            ...
            builder.append("{");
            builder.append(".kc = ");
            builder.append(java.util.Arrays.toString(this.kc));
            builder.append(", .sres = ");
            builder.append(java.util.Arrays.toString(this.sres));
            builder.append("}");
        ...
        public static final java.util.ArrayList<NetworkResponseEapSimGsmAuthParams> readVectorFromParcel(android.os.HwParcel parcel) {
            java.util.ArrayList<NetworkResponseEapSimGsmAuthParams> _hidl_vec = new java.util.ArrayList();
...

            {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimGsmAuthParams _hidl_vec_element = new android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimGsmAuthParams();
                    ((android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimGsmAuthParams) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 12);
        ...
        public final void readEmbeddedFromParcel(
                android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
            {
                ...
                _hidl_blob.copyToInt8Array(_hidl_array_offset_0, (byte[/* 8 */]) kc, 8 /* size */);
                _hidl_array_offset_0 += 8 * 1;
            }
            {
                long _hidl_array_offset_0 = _hidl_offset + 8;
                _hidl_blob.copyToInt8Array(_hidl_array_offset_0, (byte[/* 4 */]) sres, 4 /* size */);
                _hidl_array_offset_0 += 4 * 1;
            }
        }
        ...
        public static final void writeVectorToParcel(
                android.os.HwParcel parcel, java.util.ArrayList<NetworkResponseEapSimGsmAuthParams> _hidl_vec) {
        ...
        public final void writeEmbeddedToBlob(
            ...
            {
                long _hidl_array_offset_0 = _hidl_offset + 0;
                byte[] _hidl_array_item_0 = (byte[/* 8 */]) kc;
            ...
            {
                long _hidl_array_offset_0 = _hidl_offset + 8;
                byte[] _hidl_array_item_0 = (byte[/* 4 */]) sres;
     ...
     */
    public final static class NetworkResponseEapSimUmtsAuthParams {
        public java.util.ArrayList<Byte> res = new java.util.ArrayList<Byte>();
        public byte[/* 16 */] ik = new byte[16];
        public byte[/* 16 */] ck = new byte[16];
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (otherObject.getClass() != android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimUmtsAuthParams.class) {
                return false;
            }
            android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimUmtsAuthParams other = (android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimUmtsAuthParams)otherObject;
            if (!android.os.HidlSupport.deepEquals(this.res, other.res)) {
                return false;
            }
            if (!android.os.HidlSupport.deepEquals(this.ik, other.ik)) {
                return false;
            }
            if (!android.os.HidlSupport.deepEquals(this.ck, other.ck)) {
                return false;
            }
            return true;
        }
        ...
        public final int hashCode() {
            return java.util.Objects.hash(
                    android.os.HidlSupport.deepHashCode(this.res), 
                    android.os.HidlSupport.deepHashCode(this.ik), 
                    android.os.HidlSupport.deepHashCode(this.ck));
        }
        ...
        public final String toString() {
            ...
            builder.append(", .ik = ");
            builder.append(java.util.Arrays.toString(this.ik));
            builder.append(", .ck = ");
            builder.append(java.util.Arrays.toString(this.ck));
            builder.append("}");
            return builder.toString();
        }
        ...
        public static final java.util.ArrayList<NetworkResponseEapSimUmtsAuthParams> readVectorFromParcel(android.os.HwParcel parcel) {
            java.util.ArrayList<NetworkResponseEapSimUmtsAuthParams> _hidl_vec = new java.util.ArrayList();
            android.os.HwBlob _hidl_blob = parcel.readBuffer(16 /* sizeof hidl_vec<T> */);

            {
                ...
                _hidl_vec.clear();
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimUmtsAuthParams _hidl_vec_element = new android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimUmtsAuthParams();
                    ((android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimUmtsAuthParams) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 48);
                    _hidl_vec.add(_hidl_vec_element);
                }
            }
        ...
        public final void readEmbeddedFromParcel(
                android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
            {
                ...
                ((java.util.ArrayList<Byte>) res).clear();
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    byte _hidl_vec_element = 0;
                    _hidl_vec_element = childBlob.getInt8(_hidl_index_0 * 1);
                    ((java.util.ArrayList<Byte>) res).add(_hidl_vec_element);
                }
            }
            {
                long _hidl_array_offset_0 = _hidl_offset + 16;
                _hidl_blob.copyToInt8Array(_hidl_array_offset_0, (byte[/* 16 */]) ik, 16 /* size */);
                _hidl_array_offset_0 += 16 * 1;
            }
            {
                long _hidl_array_offset_0 = _hidl_offset + 32;
                _hidl_blob.copyToInt8Array(_hidl_array_offset_0, (byte[/* 16 */]) ck, 16 /* size */);
                _hidl_array_offset_0 += 16 * 1;
            }
        }
        ...
        public static final void writeVectorToParcel(
                android.os.HwParcel parcel, java.util.ArrayList<NetworkResponseEapSimUmtsAuthParams> _hidl_vec) {
            android.os.HwBlob _hidl_blob = new android.os.HwBlob(16 /* sizeof(hidl_vec<T>) */);
            {
                int _hidl_vec_size = _hidl_vec.size();
                _hidl_blob.putInt32(0 + 8 /* offsetof(hidl_vec<T>, mSize) */, _hidl_vec_size);
        ...
        public final void writeEmbeddedToBlob(
                android.os.HwBlob _hidl_blob, long _hidl_offset) {
            {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    childBlob.putInt8(_hidl_index_0 * 1, res.get(_hidl_index_0));
                }
                _hidl_blob.putBlob(_hidl_offset + 0 + 0 /* offsetof(hidl_vec<T>, mBuffer) */, childBlob);
            }
            {
                long _hidl_array_offset_0 = _hidl_offset + 16;
                byte[] _hidl_array_item_0 = (byte[/* 16 */]) ik;
            ...
            {
                long _hidl_array_offset_0 = _hidl_offset + 32;
                byte[] _hidl_array_item_0 = (byte[/* 16 */]) ck;
     ...
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus registerCallback(android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetworkCallback callback)
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setSsid(java.util.ArrayList<Byte> ssid)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setBssid(byte[/* 6 */] bssid)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setScanSsid(boolean enable)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setKeyMgmt(int keyMgmtMask)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setProto(int protoMask)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setAuthAlg(int authAlgMask)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setGroupCipher(int groupCipherMask)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setPairwiseCipher(int pairwiseCipherMask)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setPskPassphrase(String psk)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setPsk(byte[/* 32 */] psk)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setWepKey(int keyIdx, java.util.ArrayList<Byte> wepKey)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setWepTxKeyIdx(int keyIdx)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setRequirePmf(boolean enable)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapMethod(int method)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapPhase2Method(int method)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapIdentity(java.util.ArrayList<Byte> identity)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapAnonymousIdentity(java.util.ArrayList<Byte> identity)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapPassword(java.util.ArrayList<Byte> password)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapCACert(String path)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapCAPath(String path)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapClientCert(String path)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapPrivateKeyId(String id)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapSubjectMatch(String match)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapAltSubjectMatch(String match)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapEngine(boolean enable)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapEngineID(String id)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapDomainSuffixMatch(String match)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setProactiveKeyCaching(boolean enable)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setIdStr(String idStr)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setUpdateIdentifier(int id)
        throws android.os.RemoteException;
     ...
     */
    void getSsid(getSsidCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getBssid(getBssidCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getScanSsid(getScanSsidCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getKeyMgmt(getKeyMgmtCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getProto(getProtoCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getAuthAlg(getAuthAlgCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getGroupCipher(getGroupCipherCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getPairwiseCipher(getPairwiseCipherCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getPskPassphrase(getPskPassphraseCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     * @param psk value set.
     */
    void getPsk(getPskCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getWepKey(int keyIdx, getWepKeyCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getWepTxKeyIdx(getWepTxKeyIdxCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     * @return enabled true if set, false otherwise.
     */
    void getRequirePmf(getRequirePmfCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     *        Must be one of |EapMethod| values.
     */
    void getEapMethod(getEapMethodCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     *        Must be one of |EapPhase2Method| values.
     */
    void getEapPhase2Method(getEapPhase2MethodCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getEapIdentity(getEapIdentityCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     * @return identity value set.
     */
    void getEapAnonymousIdentity(getEapAnonymousIdentityCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getEapPassword(getEapPasswordCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getEapCACert(getEapCACertCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     * @return path value set.
     */
    void getEapCAPath(getEapCAPathCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     * @return path value set.
     */
    void getEapClientCert(getEapClientCertCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     * @return id value set.
     */
    void getEapPrivateKeyId(getEapPrivateKeyIdCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getEapSubjectMatch(getEapSubjectMatchCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     * @return match value set.
     */
    void getEapAltSubjectMatch(getEapAltSubjectMatchCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     * @return enabled true if set, false otherwise.
     */
    void getEapEngine(getEapEngineCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     * @return id value set.
     */
    void getEapEngineID(getEapEngineIDCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     * @return match value set.
     */
    void getEapDomainSuffixMatch(getEapDomainSuffixMatchCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getIdStr(getIdStrCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getWpsNfcConfigurationToken(getWpsNfcConfigurationTokenCallback _hidl_cb)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus enable(boolean noConnect)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus disable()
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus select()
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus sendNetworkEapSimGsmAuthResponse(java.util.ArrayList<android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimGsmAuthParams> params)
        throws android.os.RemoteException;
    /**
     * Used to send a response to the
     * |ISupplicantNetworkCallback.onNetworkEapSimGsmAuthRequest| request.
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus sendNetworkEapSimGsmAuthFailure()
        throws android.os.RemoteException;
    /**
     * Used to send a response to the
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus sendNetworkEapSimUmtsAuthResponse(android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.NetworkResponseEapSimUmtsAuthParams params)
        throws android.os.RemoteException;
    /**
     * Used to send a response to the
     * |ISupplicantNetworkCallback.onNetworkEapSimUmtsAuthRequest| request.
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus sendNetworkEapSimUmtsAutsResponse(byte[/* 14 */] auts)
        throws android.os.RemoteException;
    /**
     * Used to send a response to the
     * |ISupplicantNetworkCallback.onNetworkEapSimUmtsAuthRequest| request.
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus sendNetworkEapSimUmtsAuthFailure()
        throws android.os.RemoteException;
    /**
     * Used to send a response to the
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus sendNetworkEapIdentityResponse(java.util.ArrayList<Byte> identity)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISupplicantStaNetwork {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.kInterfaceName;
