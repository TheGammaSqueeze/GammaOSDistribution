 ...
 */
public interface ISupplicantNetwork extends android.hidl.base.V1_0.IBase {
    /**
     ...
     */
    /* package private */ static ISupplicantNetwork asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        ISupplicantNetwork proxy = new ISupplicantNetwork.Proxy(binder);
     ...
     */
    public static ISupplicantNetwork castFrom(android.os.IHwInterface iface) {
        return (iface == null) ? null : ISupplicantNetwork.asInterface(iface.asBinder());
    }
     ...
     */
    public static ISupplicantNetwork getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISupplicantNetwork.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.0::ISupplicantNetwork", serviceName, retry));
    }

    /**
     * Calls getService("default",retry).
     */
    public static ISupplicantNetwork getService(boolean retry) throws android.os.RemoteException {
     ...
     */
    @Deprecated
    public static ISupplicantNetwork getService(String serviceName) throws android.os.RemoteException {
        return ISupplicantNetwork.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.0::ISupplicantNetwork", serviceName));
    }
     ...
     */
    @Deprecated
    public static ISupplicantNetwork getService() throws android.os.RemoteException {
     ...
     */
    void getInterfaceName(getInterfaceNameCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getType(getTypeCallback _hidl_cb)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements ISupplicantNetwork {
        ...
        public String toString() {
            ...
            return "[class or subclass of " + ISupplicantNetwork.kInterfaceName + "]@Proxy";
        }
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISupplicantNetwork {
        @Override
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork.kInterfaceName;
