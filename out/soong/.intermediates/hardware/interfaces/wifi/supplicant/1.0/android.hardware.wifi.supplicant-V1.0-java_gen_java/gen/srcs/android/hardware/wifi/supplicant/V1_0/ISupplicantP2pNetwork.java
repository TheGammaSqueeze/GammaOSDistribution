 ...
 */
public interface ISupplicantP2pNetwork extends android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork {
    /**
     ...
     */
    /* package private */ static ISupplicantP2pNetwork asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        ISupplicantP2pNetwork proxy = new ISupplicantP2pNetwork.Proxy(binder);
     ...
     */
    public static ISupplicantP2pNetwork castFrom(android.os.IHwInterface iface) {
        return (iface == null) ? null : ISupplicantP2pNetwork.asInterface(iface.asBinder());
    }
     ...
     */
    public static ISupplicantP2pNetwork getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISupplicantP2pNetwork.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.0::ISupplicantP2pNetwork", serviceName, retry));
    }

    /**
     * Calls getService("default",retry).
     */
    public static ISupplicantP2pNetwork getService(boolean retry) throws android.os.RemoteException {
     ...
     */
    @Deprecated
    public static ISupplicantP2pNetwork getService(String serviceName) throws android.os.RemoteException {
        return ISupplicantP2pNetwork.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.0::ISupplicantP2pNetwork", serviceName));
    }
     ...
     */
    @Deprecated
    public static ISupplicantP2pNetwork getService() throws android.os.RemoteException {
     ...
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus registerCallback(android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetworkCallback callback)
    ...
    public interface isCurrentCallback {
        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, boolean isCurrent);
    }
     ...
     */
    void isCurrent(isCurrentCallback _hidl_cb)
        throws android.os.RemoteException;

    @java.lang.FunctionalInterface
    public interface isPersistentCallback {
        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, boolean isPersistent);
    }
     ...
     */
    void isPersistent(isPersistentCallback _hidl_cb)
        throws android.os.RemoteException;

    @java.lang.FunctionalInterface
    public interface isGoCallback {
        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, boolean isGo);
    }
     ...
     */
    void isGo(isGoCallback _hidl_cb)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus setClientList(java.util.ArrayList<byte[/* 6 */]> clients)
        throws android.os.RemoteException;

    @java.lang.FunctionalInterface
    public interface getClientListCallback {
        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, java.util.ArrayList<byte[/* 6 */]> clients);
    }
     ...
     */
    void getClientList(getClientListCallback _hidl_cb)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements ISupplicantP2pNetwork {
        ...
        public String toString() {
            ...
            return "[class or subclass of " + ISupplicantP2pNetwork.kInterfaceName + "]@Proxy";
        }
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus registerCallback(android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetworkCallback callback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork.kInterfaceName);
        ...
        public void getSsid(getSsidCallback _hidl_cb)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(5 /* getSsid */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public void getBssid(getBssidCallback _hidl_cb)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(6 /* getBssid */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void isCurrent(isCurrentCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(7 /* isCurrent */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = new android.hardware.wifi.supplicant.V1_0.SupplicantStatus();
                ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).readFromParcel(_hidl_reply);
                boolean _hidl_out_isCurrent = _hidl_reply.readBool();
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_isCurrent);
            } finally {
                _hidl_reply.release();
            }
        }
        ...
        @Override
        public void isPersistent(isPersistentCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(8 /* isPersistent */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = new android.hardware.wifi.supplicant.V1_0.SupplicantStatus();
                ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).readFromParcel(_hidl_reply);
                boolean _hidl_out_isPersistent = _hidl_reply.readBool();
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_isPersistent);
            } finally {
                _hidl_reply.release();
            }
        }
        ...
        @Override
        public void isGo(isGoCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(9 /* isGo */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = new android.hardware.wifi.supplicant.V1_0.SupplicantStatus();
                ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).readFromParcel(_hidl_reply);
                boolean _hidl_out_isGo = _hidl_reply.readBool();
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_isGo);
            } finally {
                _hidl_reply.release();
            }
        }
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus setClientList(java.util.ArrayList<byte[/* 6 */]> clients)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork.kInterfaceName);
            {
                    ...
                    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                        {
                            ...
                            byte[] _hidl_array_item_1 = (byte[/* 6 */]) clients.get(_hidl_index_0);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(10 /* setClientList */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getClientList(getClientListCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(11 /* getClientList */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = new android.hardware.wifi.supplicant.V1_0.SupplicantStatus();
                ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).readFromParcel(_hidl_reply);
                java.util.ArrayList<byte[/* 6 */]> _hidl_out_clients =  new java.util.ArrayList<byte[/* 6 */]>();
                {
                    android.os.HwBlob _hidl_blob = _hidl_reply.readBuffer(16 /* size */);
                    {
                        ...
                        ((java.util.ArrayList<byte[/* 6 */]>) _hidl_out_clients).clear();
                        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                            ...
                            ((java.util.ArrayList<byte[/* 6 */]>) _hidl_out_clients).add(_hidl_vec_element);
                        }
                    }
                }
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISupplicantP2pNetwork {
        @Override
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{86,18,-113,116,86,5,113,-74,119,125,89,69,63,53,-58,-77,86,-109,-18,55,126,42,35,-56,7,112,-119,6,-110,-113,9,-34} /* 56128f74560571b6777d59453f35c6b35693ee377e2a23c807708906928f09de */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork.kInterfaceName);

                    android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetworkCallback callback = android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetworkCallback.asInterface(_hidl_request.readStrongBinder());
                ...
                case 10 /* setClientList */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork.kInterfaceName);

                    java.util.ArrayList<byte[/* 6 */]> clients =  new java.util.ArrayList<byte[/* 6 */]>();
                    {
                        android.os.HwBlob _hidl_blob = _hidl_request.readBuffer(16 /* size */);
                        {
                            ...
                            ((java.util.ArrayList<byte[/* 6 */]>) clients).clear();
                            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                                byte[/* 6 */] _hidl_vec_element = new byte[6];
                                {
                                    long _hidl_array_offset_1 = _hidl_index_0 * 6;
                                ...
                                ((java.util.ArrayList<byte[/* 6 */]>) clients).add(_hidl_vec_element);
                            }
                        }
                    }
                    android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = setClientList(clients);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
