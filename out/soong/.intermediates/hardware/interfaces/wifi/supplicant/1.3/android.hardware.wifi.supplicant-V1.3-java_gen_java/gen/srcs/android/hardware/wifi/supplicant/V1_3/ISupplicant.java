...
public interface ISupplicant extends android.hardware.wifi.supplicant.V1_2.ISupplicant {
     ...
     */
    public static final String kInterfaceName = "android.hardware.wifi.supplicant@1.3::ISupplicant";
    ...
    public static ISupplicant getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISupplicant.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.3::ISupplicant", serviceName, retry));
    }
    ...
    public static ISupplicant getService(String serviceName) throws android.os.RemoteException {
        return ISupplicant.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.3::ISupplicant", serviceName));
    }
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISupplicant {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.supplicant.V1_3.ISupplicant.kInterfaceName;
