...
public interface ISupplicant extends android.hardware.wifi.supplicant.V1_0.ISupplicant {
    ...
    public static ISupplicant getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISupplicant.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.1::ISupplicant", serviceName, retry));
    }
    ...
    public static ISupplicant getService(String serviceName) throws android.os.RemoteException {
        return ISupplicant.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.1::ISupplicant", serviceName));
    }
     ...
     */
    void addInterface(android.hardware.wifi.supplicant.V1_0.ISupplicant.IfaceInfo ifaceInfo, addInterfaceCallback _hidl_cb)
     ...
     */
    android.hardware.wifi.supplicant.V1_0.SupplicantStatus removeInterface(android.hardware.wifi.supplicant.V1_0.ISupplicant.IfaceInfo ifaceInfo)
        throws android.os.RemoteException;
    /**
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISupplicant {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.supplicant.V1_1.ISupplicant.kInterfaceName;
