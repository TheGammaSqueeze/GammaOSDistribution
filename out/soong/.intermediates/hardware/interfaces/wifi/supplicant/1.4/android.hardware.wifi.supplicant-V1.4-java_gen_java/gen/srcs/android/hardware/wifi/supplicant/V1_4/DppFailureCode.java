...
public final class DppFailureCode {
     ...
     */
    public static final int URI_GENERATION = 11 /* ::android::hardware::wifi::supplicant::V1_3::DppFailureCode.ENROLLEE_AUTHENTICATION implicitly + 1 */;
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & URI_GENERATION) == URI_GENERATION) {
            list.add("URI_GENERATION");
            flipped |= URI_GENERATION;
        }
        if (o != flipped) {
