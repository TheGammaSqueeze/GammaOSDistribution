 ...
 */
public interface ISupplicantStaNetwork extends android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork {
    /**
     * Fully-qualified interface name for this interface.
     */
    public static final String kInterfaceName = "android.hardware.wifi.supplicant@1.4::ISupplicantStaNetwork";
    ...
    public static ISupplicantStaNetwork getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISupplicantStaNetwork.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.4::ISupplicantStaNetwork", serviceName, retry));
    }
    ...
    public static ISupplicantStaNetwork getService(String serviceName) throws android.os.RemoteException {
        return ISupplicantStaNetwork.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.4::ISupplicantStaNetwork", serviceName));
    }
    ...
    public static final class KeyMgmtMask {
         ...
         * WAPI Psk
         */
        public static final int WAPI_PSK = 4096 /* 1 << 12 */;
        /**
         * WAPI Cert
         */
        public static final int WAPI_CERT = 8192 /* 1 << 13 */;
        /**
         * FILS shared key authentication with sha-256
         */
        public static final int FILS_SHA256 = 262144 /* 1 << 18 */;
        /**
         * FILS shared key authentication with sha-384
         */
        public static final int FILS_SHA384 = 524288 /* 1 << 19 */;
        /**
         * SAE PK mode
         */
        public static final int SAE_PK = 524289 /* ::android::hardware::wifi::supplicant::V1_3::ISupplicantStaNetwork::KeyMgmtMask.FILS_SHA384 implicitly + 1 */;
        ...
        public static final String dumpBitfield(int o) {
            ...
            if ((o & WAPI_PSK) == WAPI_PSK) {
                list.add("WAPI_PSK");
                flipped |= WAPI_PSK;
            }
            if ((o & WAPI_CERT) == WAPI_CERT) {
                list.add("WAPI_CERT");
                flipped |= WAPI_CERT;
            }
    ...
    public static final class PairwiseCipherMask {
         ...
         */
        public static final int SMS4 = 128 /* 1 << 7 */;
        /**
         * GCMP-128 Pairwise Cipher
         */
        public static final int GCMP_128 = 64 /* 1 << 6 */;
        public static final String toString(int o) {
            if (o == NONE) {
                return "NONE";
            }
     ...
     */
    public static final class SaeH2eMode {
        /**
         ...
         */
        public static final byte H2E_OPTIONAL = 1 /* ::android::hardware::wifi::supplicant::V1_4::ISupplicantStaNetwork::SaeH2eMode.DISABLED implicitly + 1 */;
        /**
         * Only Hash-to-Element is allowed.
         */
        public static final byte H2E_MANDATORY = 2 /* ::android::hardware::wifi::supplicant::V1_4::ISupplicantStaNetwork::SaeH2eMode.H2E_OPTIONAL implicitly + 1 */;
        ...
        public static final String dumpBitfield(byte o) {
            ...
            if ((o & H2E_OPTIONAL) == H2E_OPTIONAL) {
                list.add("H2E_OPTIONAL");
                flipped |= H2E_OPTIONAL;
            }
            if ((o & H2E_MANDATORY) == H2E_MANDATORY) {
                list.add("H2E_MANDATORY");
                flipped |= H2E_MANDATORY;
            }
            if (o != flipped) {
     ...
     */
    android.hardware.wifi.supplicant.V1_4.SupplicantStatus setGroupCipher_1_4(int groupCipherMask)
        throws android.os.RemoteException;

    @java.lang.FunctionalInterface
    public interface getGroupCipher_1_4Callback {
        public void onValues(android.hardware.wifi.supplicant.V1_4.SupplicantStatus status, int groupCipherMask);
    }
     ...
     */
    void getGroupCipher_1_4(getGroupCipher_1_4Callback _hidl_cb)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_UNKNOWN|
     */
    android.hardware.wifi.supplicant.V1_4.SupplicantStatus setPairwiseCipher_1_4(int pairwiseCipherMask)
        throws android.os.RemoteException;

    @java.lang.FunctionalInterface
    public interface getPairwiseCipher_1_4Callback {
        public void onValues(android.hardware.wifi.supplicant.V1_4.SupplicantStatus status, int pairwiseCipherMask);
    }
     ...
     */
    void getPairwiseCipher_1_4(getPairwiseCipher_1_4Callback _hidl_cb)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_4.SupplicantStatus setEdmg(boolean enable)
        throws android.os.RemoteException;

    @java.lang.FunctionalInterface
    public interface getEdmgCallback {
        public void onValues(android.hardware.wifi.supplicant.V1_4.SupplicantStatus status, boolean enabled);
    }
     ...
     */
    void getEdmg(getEdmgCallback _hidl_cb)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_4.SupplicantStatus registerCallback_1_4(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetworkCallback callback)
        throws android.os.RemoteException;
    /**
     ...
     *         |SupplicantStatusCode.FAILURE_NETWORK_INVALID|
     */
    android.hardware.wifi.supplicant.V1_4.SupplicantStatus setSaeH2eMode(byte mode)
        throws android.os.RemoteException;
    /**
     ...
     */
    android.hardware.wifi.supplicant.V1_4.SupplicantStatus enableSaePkOnlyMode(boolean enable)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements ISupplicantStaNetwork {
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus setOcsp(int ocspType)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeInt32(ocspType);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(89 /* setOcsp */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getOcsp(getOcspCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(90 /* getOcsp */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = new android.hardware.wifi.supplicant.V1_0.SupplicantStatus();
                ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).readFromParcel(_hidl_reply);
                int _hidl_out_ocspType = _hidl_reply.readInt32();
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_ocspType);
            } finally {
                _hidl_reply.release();
            }
        }
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus setKeyMgmt_1_3(int keyMgmtMask)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeInt32(keyMgmtMask);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(91 /* setKeyMgmt_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getKeyMgmt_1_3(getKeyMgmt_1_3Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(92 /* getKeyMgmt_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus setProto_1_3(int protoMask)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeInt32(protoMask);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(93 /* setProto_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getProto_1_3(getProto_1_3Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(94 /* getProto_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus setGroupCipher_1_3(int groupCipherMask)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeInt32(groupCipherMask);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(95 /* setGroupCipher_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getPairwiseCipher_1_3(getPairwiseCipher_1_3Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(96 /* getPairwiseCipher_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus setPairwiseCipher_1_3(int pairwiseCipherMask)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeInt32(pairwiseCipherMask);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(97 /* setPairwiseCipher_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getGroupCipher_1_3(getGroupCipher_1_3Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(98 /* getGroupCipher_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus setWapiCertSuite(String suite)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeString(suite);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(99 /* setWapiCertSuite */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getWapiCertSuite(getWapiCertSuiteCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(100 /* getWapiCertSuite */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = new android.hardware.wifi.supplicant.V1_0.SupplicantStatus();
                ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).readFromParcel(_hidl_reply);
                String _hidl_out_suite = _hidl_reply.readString();
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_suite);
            } finally {
                _hidl_reply.release();
            }
        }
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus setPmkCache(java.util.ArrayList<Byte> serializedEntry)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(101 /* setPmkCache */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus setAuthAlg_1_3(int authAlgMask)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeInt32(authAlgMask);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(102 /* setAuthAlg_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getAuthAlg_1_3(getAuthAlg_1_3Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(103 /* getAuthAlg_1_3 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_0.SupplicantStatus setEapErp(boolean enable)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeBool(enable);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(104 /* setEapErp */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        // Methods from ::android::hardware::wifi::supplicant::V1_4::ISupplicantStaNetwork follow.
        @Override
        public android.hardware.wifi.supplicant.V1_4.SupplicantStatus setGroupCipher_1_4(int groupCipherMask)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeInt32(groupCipherMask);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(105 /* setGroupCipher_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getGroupCipher_1_4(getGroupCipher_1_4Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(106 /* getGroupCipher_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_4.SupplicantStatus setPairwiseCipher_1_4(int pairwiseCipherMask)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeInt32(pairwiseCipherMask);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(107 /* setPairwiseCipher_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getPairwiseCipher_1_4(getPairwiseCipher_1_4Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(108 /* getPairwiseCipher_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_4.SupplicantStatus setEdmg(boolean enable)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeBool(enable);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(109 /* setEdmg */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getEdmg(getEdmgCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(110 /* getEdmg */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_4.SupplicantStatus registerCallback_1_4(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetworkCallback callback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(111 /* registerCallback_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_4.SupplicantStatus setSaeH2eMode(byte mode)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(112 /* setSaeH2eMode */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_4.SupplicantStatus enableSaePkOnlyMode(boolean enable)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeBool(enable);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(113 /* enableSaePkOnlyMode */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISupplicantStaNetwork {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName,
                    android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-56,-91,115,100,-10,-83,32,-124,43,-31,79,77,-78,-124,-33,83,4,-9,82,28,-88,-22,-58,-68,-63,-6,108,91,70,111,-72,-90} /* c8a57364f6ad20842be14f4db284df5304f7521ca8eac6bcc1fa6c5b466fb8a6 */,
                    new byte[/* 32 */]{119,83,28,-115,4,-113,-113,-118,-27,50,-70,-67,12,-88,99,50,-88,101,-20,-102,-84,-31,-80,81,34,110,-14,-78,17,35,-26,69} /* 77531c8d048f8f8ae532babd0ca86332a865ec9aace1b051226ef2b21123e645 */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 89 /* setOcsp */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    int ocspType = _hidl_request.readInt32();
                    android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = setOcsp(ocspType);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 90 /* getOcsp */:
                {
                    ...
                    getOcsp(new getOcspCallback() {
                        @Override
                        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, int ocspType) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) status).writeToParcel(_hidl_reply);
                            _hidl_reply.writeInt32(ocspType);
                            _hidl_reply.send();
                            }});
                    break;
                }

                case 91 /* setKeyMgmt_1_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    int keyMgmtMask = _hidl_request.readInt32();
                    android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = setKeyMgmt_1_3(keyMgmtMask);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 92 /* getKeyMgmt_1_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    getKeyMgmt_1_3(new getKeyMgmt_1_3Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, int keyMgmtMask) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) status).writeToParcel(_hidl_reply);
                ...
                case 93 /* setProto_1_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    int protoMask = _hidl_request.readInt32();
                    android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = setProto_1_3(protoMask);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 94 /* getProto_1_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    getProto_1_3(new getProto_1_3Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, int protoMask) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) status).writeToParcel(_hidl_reply);
                ...
                case 95 /* setGroupCipher_1_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    int groupCipherMask = _hidl_request.readInt32();
                    android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = setGroupCipher_1_3(groupCipherMask);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 96 /* getPairwiseCipher_1_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    getPairwiseCipher_1_3(new getPairwiseCipher_1_3Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, int pairwiseCipherMask) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) status).writeToParcel(_hidl_reply);
                ...
                case 97 /* setPairwiseCipher_1_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    int pairwiseCipherMask = _hidl_request.readInt32();
                    android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = setPairwiseCipher_1_3(pairwiseCipherMask);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 98 /* getGroupCipher_1_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    getGroupCipher_1_3(new getGroupCipher_1_3Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, int groupCipherMask) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) status).writeToParcel(_hidl_reply);
                ...
                case 99 /* setWapiCertSuite */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    String suite = _hidl_request.readString();
                    android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = setWapiCertSuite(suite);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 100 /* getWapiCertSuite */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    getWapiCertSuite(new getWapiCertSuiteCallback() {
                        @Override
                        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, String suite) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) status).writeToParcel(_hidl_reply);
                            _hidl_reply.writeString(suite);
                            _hidl_reply.send();
                            }});
                    break;
                }

                case 101 /* setPmkCache */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    java.util.ArrayList<Byte> serializedEntry = _hidl_request.readInt8Vector();
                    android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = setPmkCache(serializedEntry);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 102 /* setAuthAlg_1_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    int authAlgMask = _hidl_request.readInt32();
                    android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = setAuthAlg_1_3(authAlgMask);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 103 /* getAuthAlg_1_3 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_3.ISupplicantStaNetwork.kInterfaceName);

                    getAuthAlg_1_3(new getAuthAlg_1_3Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.supplicant.V1_0.SupplicantStatus status, int authAlgMask) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) status).writeToParcel(_hidl_reply);
                ...
                case 104 /* setEapErp */:
                {
                    ...
                    boolean enable = _hidl_request.readBool();
                    android.hardware.wifi.supplicant.V1_0.SupplicantStatus _hidl_out_status = setEapErp(enable);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_0.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 105 /* setGroupCipher_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);

                    int groupCipherMask = _hidl_request.readInt32();
                    android.hardware.wifi.supplicant.V1_4.SupplicantStatus _hidl_out_status = setGroupCipher_1_4(groupCipherMask);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                ...
                case 106 /* getGroupCipher_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);

                    getGroupCipher_1_4(new getGroupCipher_1_4Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.supplicant.V1_4.SupplicantStatus status, int groupCipherMask) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                ...
                case 107 /* setPairwiseCipher_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);

                    int pairwiseCipherMask = _hidl_request.readInt32();
                    android.hardware.wifi.supplicant.V1_4.SupplicantStatus _hidl_out_status = setPairwiseCipher_1_4(pairwiseCipherMask);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_4.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 108 /* getPairwiseCipher_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);

                    getPairwiseCipher_1_4(new getPairwiseCipher_1_4Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.supplicant.V1_4.SupplicantStatus status, int pairwiseCipherMask) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.supplicant.V1_4.SupplicantStatus) status).writeToParcel(_hidl_reply);
                ...
                case 109 /* setEdmg */:
                {
                    ...
                    boolean enable = _hidl_request.readBool();
                    android.hardware.wifi.supplicant.V1_4.SupplicantStatus _hidl_out_status = setEdmg(enable);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_4.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 111 /* registerCallback_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);

                    android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetworkCallback callback = android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetworkCallback.asInterface(_hidl_request.readStrongBinder());
                ...
                case 112 /* setSaeH2eMode */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);

                    byte mode = _hidl_request.readInt8();
                    android.hardware.wifi.supplicant.V1_4.SupplicantStatus _hidl_out_status = setSaeH2eMode(mode);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_4.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 113 /* enableSaePkOnlyMode */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_4.ISupplicantStaNetwork.kInterfaceName);

                    boolean enable = _hidl_request.readBool();
                    android.hardware.wifi.supplicant.V1_4.SupplicantStatus _hidl_out_status = enableSaePkOnlyMode(enable);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_4.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
