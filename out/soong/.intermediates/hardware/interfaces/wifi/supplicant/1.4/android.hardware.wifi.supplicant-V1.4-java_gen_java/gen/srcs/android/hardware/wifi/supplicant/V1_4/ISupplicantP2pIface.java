...
public interface ISupplicantP2pIface extends android.hardware.wifi.supplicant.V1_2.ISupplicantP2pIface {
     ...
     */
    public static final String kInterfaceName = "android.hardware.wifi.supplicant@1.4::ISupplicantP2pIface";
    ...
    public static ISupplicantP2pIface getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISupplicantP2pIface.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.4::ISupplicantP2pIface", serviceName, retry));
    }
    ...
    public static ISupplicantP2pIface getService(String serviceName) throws android.os.RemoteException {
        return ISupplicantP2pIface.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.4::ISupplicantP2pIface", serviceName));
    }
     ...
     */
    android.hardware.wifi.supplicant.V1_4.SupplicantStatus registerCallback_1_4(android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIfaceCallback callback)
        throws android.os.RemoteException;
    /*
     ...
     *         |SupplicantStatusCode.FAILURE_IFACE_INVALID|
     */
    android.hardware.wifi.supplicant.V1_4.SupplicantStatus setWfdR2DeviceInfo(byte[/* 4 */] info)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements ISupplicantP2pIface {
        ...
        // Methods from ::android::hardware::wifi::supplicant::V1_4::ISupplicantP2pIface follow.
        @Override
        public android.hardware.wifi.supplicant.V1_4.SupplicantStatus setEdmg(boolean enable)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIface.kInterfaceName);
            _hidl_request.writeBool(enable);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(56 /* setEdmg */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public void getEdmg(getEdmgCallback _hidl_cb)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(57 /* getEdmg */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_4.SupplicantStatus registerCallback_1_4(android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIfaceCallback callback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIface.kInterfaceName);
            _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());
        ...
        @Override
        public android.hardware.wifi.supplicant.V1_4.SupplicantStatus setWfdR2DeviceInfo(byte[/* 4 */] info)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIface.kInterfaceName);
            {
                ...
                {
                    long _hidl_array_offset_0 = 0 /* offset */;
                    byte[] _hidl_array_item_0 = (byte[/* 4 */]) info;
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(59 /* setWfdR2DeviceInfo */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISupplicantP2pIface {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIface.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIface.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-46,-97,-26,41,115,-60,-101,111,-92,14,-75,108,40,86,126,55,-60,-69,-20,1,95,-11,-111,17,-19,-6,-28,70,48,29,-64,109} /* d29fe62973c49b6fa40eb56c28567e37c4bbec015ff59111edfae446301dc06d */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 56 /* setEdmg */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIface.kInterfaceName);
                ...
                case 58 /* registerCallback_1_4 */:
                {
                    ...
                    android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIfaceCallback callback = android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIfaceCallback.asInterface(_hidl_request.readStrongBinder());
                ...
                case 59 /* setWfdR2DeviceInfo */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIface.kInterfaceName);

                    byte[/* 4 */] info = new byte[4];
                    {
                        android.os.HwBlob _hidl_blob = _hidl_request.readBuffer(4 /* size */);
                        {
                            long _hidl_array_offset_0 = 0 /* offset */;
                            _hidl_blob.copyToInt8Array(_hidl_array_offset_0, (byte[/* 4 */]) info, 4 /* size */);
                            _hidl_array_offset_0 += 4 * 1;
                        }
                    }
                    android.hardware.wifi.supplicant.V1_4.SupplicantStatus _hidl_out_status = setWfdR2DeviceInfo(info);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.supplicant.V1_4.SupplicantStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
