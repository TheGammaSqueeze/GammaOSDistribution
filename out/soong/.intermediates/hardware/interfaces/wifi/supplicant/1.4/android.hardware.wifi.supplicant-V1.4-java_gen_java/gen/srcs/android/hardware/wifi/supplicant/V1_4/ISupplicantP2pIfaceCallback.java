...
public interface ISupplicantP2pIfaceCallback extends android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback {
     ...
     */
    public static final String kInterfaceName = "android.hardware.wifi.supplicant@1.4::ISupplicantP2pIfaceCallback";
    ...
    public static ISupplicantP2pIfaceCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISupplicantP2pIfaceCallback.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.4::ISupplicantP2pIfaceCallback", serviceName, retry));
    }
    ...
    public static ISupplicantP2pIfaceCallback getService(String serviceName) throws android.os.RemoteException {
        return ISupplicantP2pIfaceCallback.asInterface(android.os.HwBinder.getService("android.hardware.wifi.supplicant@1.4::ISupplicantP2pIfaceCallback", serviceName));
    }
     ...
     */
    void onR2DeviceFound(byte[/* 6 */] srcAddress, byte[/* 6 */] p2pDeviceAddress, byte[/* 8 */] primaryDeviceType, String deviceName, short configMethods, byte deviceCapabilities, int groupCapabilities, byte[/* 6 */] wfdDeviceInfo, byte[/* 2 */] wfdR2DeviceInfo)
    ...
    public static final class Proxy implements ISupplicantP2pIfaceCallback {
        ...
        // Methods from ::android::hardware::wifi::supplicant::V1_4::ISupplicantP2pIfaceCallback follow.
        @Override
        public void onR2DeviceFound(byte[/* 6 */] srcAddress, byte[/* 6 */] p2pDeviceAddress, byte[/* 8 */] primaryDeviceType, String deviceName, short configMethods, byte deviceCapabilities, int groupCapabilities, byte[/* 6 */] wfdDeviceInfo, byte[/* 2 */] wfdR2DeviceInfo)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIfaceCallback.kInterfaceName);
            {
                android.os.HwBlob _hidl_blob = new android.os.HwBlob(6 /* size */);
                {
                    long _hidl_array_offset_0 = 0 /* offset */;
            ...
            }
            {
                ...
                {
                    long _hidl_array_offset_0 = 0 /* offset */;
                    byte[] _hidl_array_item_0 = (byte[/* 2 */]) wfdR2DeviceInfo;
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(18 /* onR2DeviceFound */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISupplicantP2pIfaceCallback {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIfaceCallback.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIfaceCallback.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-22,70,89,112,-23,109,-106,5,-18,111,103,6,-77,-75,18,114,108,102,-46,100,71,56,-83,-34,-39,18,-116,115,-97,-113,-117,12} /* ea465970e96d9605ee6f6706b3b512726c66d2644738added9128c739f8f8b0c */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 18 /* onR2DeviceFound */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_4.ISupplicantP2pIfaceCallback.kInterfaceName);
                    ...
                    byte[/* 2 */] wfdR2DeviceInfo = new byte[2];
                    {
                        android.os.HwBlob _hidl_blob = _hidl_request.readBuffer(2 /* size */);
                        {
                            long _hidl_array_offset_0 = 0 /* offset */;
                            _hidl_blob.copyToInt8Array(_hidl_array_offset_0, (byte[/* 2 */]) wfdR2DeviceInfo, 2 /* size */);
                            _hidl_array_offset_0 += 2 * 1;
                        }
                    }
