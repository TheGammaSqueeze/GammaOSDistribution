...
public interface IWifi extends android.hardware.wifi.V1_0.IWifi {
    ...
    public static IWifi getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IWifi.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.1::IWifi", serviceName, retry));
    }
    ...
    public static abstract class Stub extends android.os.HwBinder implements IWifi {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.V1_1.IWifi.kInterfaceName;
