...
public final class WifiRateInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.wifi.V1_4.WifiRateInfo.class) {
            return false;
        }
        android.hardware.wifi.V1_4.WifiRateInfo other = (android.hardware.wifi.V1_4.WifiRateInfo)otherObject;
    ...
    public final String toString() {
        ...
        builder.append(android.hardware.wifi.V1_4.WifiRatePreamble.toString(this.preamble));
        builder.append(", .nss = ");
    ...
    public static final java.util.ArrayList<WifiRateInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.wifi.V1_4.WifiRateInfo _hidl_vec_element = new android.hardware.wifi.V1_4.WifiRateInfo();
                ((android.hardware.wifi.V1_4.WifiRateInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 20);
