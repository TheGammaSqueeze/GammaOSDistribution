 ...
 */
public interface IWifiChipEventCallback extends android.hardware.wifi.V1_2.IWifiChipEventCallback {
    /**
     * Fully-qualified interface name for this interface.
     */
    public static final String kInterfaceName = "android.hardware.wifi@1.4::IWifiChipEventCallback";
    ...
    public static IWifiChipEventCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IWifiChipEventCallback.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.4::IWifiChipEventCallback", serviceName, retry));
    }
    ...
    public static IWifiChipEventCallback getService(String serviceName) throws android.os.RemoteException {
        return IWifiChipEventCallback.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.4::IWifiChipEventCallback", serviceName));
    }
    ...
    public final static class RadioModeInfo {
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (otherObject.getClass() != android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo.class) {
                return false;
            }
            android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo other = (android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo)otherObject;
        ...
        public final String toString() {
            ...
            builder.append(android.hardware.wifi.V1_4.WifiBand.toString(this.bandInfo));
        ...
        public static final java.util.ArrayList<RadioModeInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

            {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo _hidl_vec_element = new android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo();
                    ((android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
     ...
     */
    void onRadioModeChange_1_4(java.util.ArrayList<android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo> radioModeInfos)
    ...
    public static final class Proxy implements IWifiChipEventCallback {
        ...
        @Override
        public void onRadioModeChange_1_4(java.util.ArrayList<android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo> radioModeInfos)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_4.IWifiChipEventCallback.kInterfaceName);
            android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo.writeVectorToParcel(_hidl_request, radioModeInfos);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(8 /* onRadioModeChange_1_4 */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
    ...
    public static abstract class Stub extends android.os.HwBinder implements IWifiChipEventCallback {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.wifi.V1_4.IWifiChipEventCallback.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.V1_4.IWifiChipEventCallback.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{8,-63,-111,43,-28,-128,-64,-118,-89,127,109,86,-69,8,61,102,-51,19,-20,-95,30,1,-62,-45,-25,39,-68,-77,-95,-28,-9,-101} /* 08c1912be480c08aa77f6d56bb083d66cd13eca11e01c2d3e727bcb3a1e4f79b */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 8 /* onRadioModeChange_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_4.IWifiChipEventCallback.kInterfaceName);

                    java.util.ArrayList<android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo> radioModeInfos = android.hardware.wifi.V1_4.IWifiChipEventCallback.RadioModeInfo.readVectorFromParcel(_hidl_request);
                    onRadioModeChange_1_4(radioModeInfos);
                    break;
                }
