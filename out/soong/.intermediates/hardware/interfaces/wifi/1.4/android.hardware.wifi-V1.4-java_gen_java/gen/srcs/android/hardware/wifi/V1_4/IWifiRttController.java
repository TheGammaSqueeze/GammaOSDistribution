 ...
 */
public interface IWifiRttController extends android.hardware.wifi.V1_0.IWifiRttController {
    /**
     * Fully-qualified interface name for this interface.
     */
    public static final String kInterfaceName = "android.hardware.wifi@1.4::IWifiRttController";
    ...
    public static IWifiRttController getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IWifiRttController.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.4::IWifiRttController", serviceName, retry));
    }
    ...
    public static IWifiRttController getService(String serviceName) throws android.os.RemoteException {
        return IWifiRttController.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.4::IWifiRttController", serviceName));
    }
     ...
     */
    android.hardware.wifi.V1_0.WifiStatus registerEventCallback_1_4(android.hardware.wifi.V1_4.IWifiRttControllerEventCallback callback)
     ...
     */
    android.hardware.wifi.V1_0.WifiStatus rangeRequest_1_4(int cmdId, java.util.ArrayList<android.hardware.wifi.V1_4.RttConfig> rttConfigs)
        throws android.os.RemoteException;

    @java.lang.FunctionalInterface
    public interface getCapabilities_1_4Callback {
        public void onValues(android.hardware.wifi.V1_0.WifiStatus status, android.hardware.wifi.V1_4.RttCapabilities capabilities);
    }
     ...
     */
    void getCapabilities_1_4(getCapabilities_1_4Callback _hidl_cb)
        throws android.os.RemoteException;

    @java.lang.FunctionalInterface
    public interface getResponderInfo_1_4Callback {
        public void onValues(android.hardware.wifi.V1_0.WifiStatus status, android.hardware.wifi.V1_4.RttResponder info);
    }
     ...
     */
    void getResponderInfo_1_4(getResponderInfo_1_4Callback _hidl_cb)
        throws android.os.RemoteException;
    /**
     ...
     *         |WifiStatusCode.ERROR_UNKNOWN|
     */
    android.hardware.wifi.V1_0.WifiStatus enableResponder_1_4(int cmdId, android.hardware.wifi.V1_0.WifiChannelInfo channelHint, int maxDurationInSeconds, android.hardware.wifi.V1_4.RttResponder info)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements IWifiRttController {
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus registerEventCallback_1_4(android.hardware.wifi.V1_4.IWifiRttControllerEventCallback callback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName);
            _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(11 /* registerEventCallback_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus rangeRequest_1_4(int cmdId, java.util.ArrayList<android.hardware.wifi.V1_4.RttConfig> rttConfigs)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName);
            _hidl_request.writeInt32(cmdId);
            android.hardware.wifi.V1_4.RttConfig.writeVectorToParcel(_hidl_request, rttConfigs);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(12 /* rangeRequest_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void getCapabilities_1_4(getCapabilities_1_4Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(13 /* getCapabilities_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = new android.hardware.wifi.V1_0.WifiStatus();
                ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).readFromParcel(_hidl_reply);
                android.hardware.wifi.V1_4.RttCapabilities _hidl_out_capabilities = new android.hardware.wifi.V1_4.RttCapabilities();
                ((android.hardware.wifi.V1_4.RttCapabilities) _hidl_out_capabilities).readFromParcel(_hidl_reply);
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_capabilities);
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override
        public void getResponderInfo_1_4(getResponderInfo_1_4Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(14 /* getResponderInfo_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = new android.hardware.wifi.V1_0.WifiStatus();
                ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).readFromParcel(_hidl_reply);
                android.hardware.wifi.V1_4.RttResponder _hidl_out_info = new android.hardware.wifi.V1_4.RttResponder();
                ((android.hardware.wifi.V1_4.RttResponder) _hidl_out_info).readFromParcel(_hidl_reply);
                _hidl_cb.onValues(_hidl_out_status, _hidl_out_info);
            } finally {
                _hidl_reply.release();
            }
        ...
        @Override
        public android.hardware.wifi.V1_0.WifiStatus enableResponder_1_4(int cmdId, android.hardware.wifi.V1_0.WifiChannelInfo channelHint, int maxDurationInSeconds, android.hardware.wifi.V1_4.RttResponder info)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName);
            _hidl_request.writeInt32(cmdId);
            ((android.hardware.wifi.V1_0.WifiChannelInfo) channelHint).writeToParcel(_hidl_request);
            _hidl_request.writeInt32(maxDurationInSeconds);
            ((android.hardware.wifi.V1_4.RttResponder) info).writeToParcel(_hidl_request);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(15 /* enableResponder_1_4 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IWifiRttController {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{16,-67,111,25,25,-116,40,30,-30,5,38,65,4,-114,-105,10,-42,107,115,46,79,111,-2,121,-96,-10,-105,-22,21,118,30,15} /* 10bd6f19198c281ee2052641048e970ad66b732e4f6ffe79a0f697ea15761e0f */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 11 /* registerEventCallback_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName);

                    android.hardware.wifi.V1_4.IWifiRttControllerEventCallback callback = android.hardware.wifi.V1_4.IWifiRttControllerEventCallback.asInterface(_hidl_request.readStrongBinder());
                ...
                case 12 /* rangeRequest_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName);

                    int cmdId = _hidl_request.readInt32();
                    java.util.ArrayList<android.hardware.wifi.V1_4.RttConfig> rttConfigs = android.hardware.wifi.V1_4.RttConfig.readVectorFromParcel(_hidl_request);
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = rangeRequest_1_4(cmdId, rttConfigs);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                ...
                case 13 /* getCapabilities_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName);

                    getCapabilities_1_4(new getCapabilities_1_4Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.V1_0.WifiStatus status, android.hardware.wifi.V1_4.RttCapabilities capabilities) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.V1_0.WifiStatus) status).writeToParcel(_hidl_reply);
                            ((android.hardware.wifi.V1_4.RttCapabilities) capabilities).writeToParcel(_hidl_reply);
                            _hidl_reply.send();
                            }});
                    break;
                }

                case 14 /* getResponderInfo_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName);

                    getResponderInfo_1_4(new getResponderInfo_1_4Callback() {
                        @Override
                        public void onValues(android.hardware.wifi.V1_0.WifiStatus status, android.hardware.wifi.V1_4.RttResponder info) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            ((android.hardware.wifi.V1_0.WifiStatus) status).writeToParcel(_hidl_reply);
                            ((android.hardware.wifi.V1_4.RttResponder) info).writeToParcel(_hidl_reply);
                            _hidl_reply.send();
                            }});
                    break;
                }

                case 15 /* enableResponder_1_4 */:
                {
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_4.IWifiRttController.kInterfaceName);
                    ...
                    android.hardware.wifi.V1_0.WifiChannelInfo channelHint = new android.hardware.wifi.V1_0.WifiChannelInfo();
                    ((android.hardware.wifi.V1_0.WifiChannelInfo) channelHint).readFromParcel(_hidl_request);
                    int maxDurationInSeconds = _hidl_request.readInt32();
                    android.hardware.wifi.V1_4.RttResponder info = new android.hardware.wifi.V1_4.RttResponder();
                    ((android.hardware.wifi.V1_4.RttResponder) info).readFromParcel(_hidl_request);
                    android.hardware.wifi.V1_0.WifiStatus _hidl_out_status = enableResponder_1_4(cmdId, channelHint, maxDurationInSeconds, info);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.wifi.V1_0.WifiStatus) _hidl_out_status).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
