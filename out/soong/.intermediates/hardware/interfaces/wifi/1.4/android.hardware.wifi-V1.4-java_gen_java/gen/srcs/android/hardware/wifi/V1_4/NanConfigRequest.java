...
public final class NanConfigRequest {
     ...
     */
    public android.hardware.wifi.V1_0.NanBandSpecificConfig[/* 3 */] bandSpecificConfig = new android.hardware.wifi.V1_0.NanBandSpecificConfig[3];
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.wifi.V1_4.NanConfigRequest.class) {
            return false;
        }
        android.hardware.wifi.V1_4.NanConfigRequest other = (android.hardware.wifi.V1_4.NanConfigRequest)otherObject;
    ...
    public static final java.util.ArrayList<NanConfigRequest> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.wifi.V1_4.NanConfigRequest _hidl_vec_element = new android.hardware.wifi.V1_4.NanConfigRequest();
                ((android.hardware.wifi.V1_4.NanConfigRequest) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 40);
    ...
    public final void readEmbeddedFromParcel(
        ...
        macAddressRandomizationIntervalSec = _hidl_blob.getInt32(_hidl_offset + 12);
        {
            ...
            for (int _hidl_index_0_0 = 0; _hidl_index_0_0 < 3; ++_hidl_index_0_0) {
                ((android.hardware.wifi.V1_0.NanBandSpecificConfig[/* 3 */]) bandSpecificConfig)[_hidl_index_0_0] = new android.hardware.wifi.V1_0.NanBandSpecificConfig();
                ((android.hardware.wifi.V1_0.NanBandSpecificConfig) ((android.hardware.wifi.V1_0.NanBandSpecificConfig[/* 3 */]) bandSpecificConfig)[_hidl_index_0_0]).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_array_offset_0);
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 12, macAddressRandomizationIntervalSec);
        {
            long _hidl_array_offset_0 = _hidl_offset + 16;
            for (int _hidl_index_0_0 = 0; _hidl_index_0_0 < 3; ++_hidl_index_0_0) {
                ((android.hardware.wifi.V1_0.NanBandSpecificConfig[/* 3 */]) bandSpecificConfig)[_hidl_index_0_0].writeEmbeddedToBlob(_hidl_blob, _hidl_array_offset_0);
                _hidl_array_offset_0 += 8;
            }
        }
    }
