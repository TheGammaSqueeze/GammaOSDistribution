...
public final class RttResult {
     ...
     */
    public android.hardware.wifi.V1_4.WifiRateInfo txRate = new android.hardware.wifi.V1_4.WifiRateInfo();
    /**
     * 1-sided RTT: TX rate of Ack from other side.
     * 2-sided RTT: TX rate of FTM frame coming from responder.
     */
    public android.hardware.wifi.V1_4.WifiRateInfo rxRate = new android.hardware.wifi.V1_4.WifiRateInfo();
    /**
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.wifi.V1_4.RttResult.class) {
            return false;
        }
        android.hardware.wifi.V1_4.RttResult other = (android.hardware.wifi.V1_4.RttResult)otherObject;
    ...
    public static final java.util.ArrayList<RttResult> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.wifi.V1_4.RttResult _hidl_vec_element = new android.hardware.wifi.V1_4.RttResult();
                ((android.hardware.wifi.V1_4.RttResult) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 192);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.wifi.V1_4.WifiRateInfo) txRate).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 44);
        ((android.hardware.wifi.V1_4.WifiRateInfo) rxRate).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 64);
