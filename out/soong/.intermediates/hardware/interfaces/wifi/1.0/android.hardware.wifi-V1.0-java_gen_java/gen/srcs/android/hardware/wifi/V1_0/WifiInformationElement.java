...
public final class WifiInformationElement {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.wifi.V1_0.WifiInformationElement.class) {
            return false;
        }
        android.hardware.wifi.V1_0.WifiInformationElement other = (android.hardware.wifi.V1_0.WifiInformationElement)otherObject;
        if (this.id != other.id) {
            return false;
        }
    ...
    public static final java.util.ArrayList<WifiInformationElement> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<WifiInformationElement> _hidl_vec = new java.util.ArrayList();
    ...
    public final void readEmbeddedFromParcel(
        ...
        id = _hidl_blob.getInt8(_hidl_offset + 0);
        {
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<WifiInformationElement> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt8(_hidl_offset + 0, id);
        {
