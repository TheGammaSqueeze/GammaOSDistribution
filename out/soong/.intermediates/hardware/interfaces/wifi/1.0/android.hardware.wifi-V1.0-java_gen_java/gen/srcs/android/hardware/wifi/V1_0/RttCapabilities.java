...
public final class RttCapabilities {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.wifi.V1_0.RttCapabilities.class) {
            return false;
        }
        android.hardware.wifi.V1_0.RttCapabilities other = (android.hardware.wifi.V1_0.RttCapabilities)otherObject;
    ...
    public final String toString() {
        ...
        builder.append(android.hardware.wifi.V1_0.RttPreamble.dumpBitfield(this.preambleSupport));
    ...
    public static final java.util.ArrayList<RttCapabilities> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.wifi.V1_0.RttCapabilities _hidl_vec_element = new android.hardware.wifi.V1_0.RttCapabilities();
                ((android.hardware.wifi.V1_0.RttCapabilities) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 20);
