...
public final class NanDebugConfig {
    ...
    public int[/* 2 */] discoveryChannelMhzVal = new int[2];
    /**
    ...
    public boolean[/* 2 */] useBeaconsInBandVal = new boolean[2];
    /**
    ...
    public boolean[/* 2 */] useSdfInBandVal = new boolean[2];
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.wifi.V1_0.NanDebugConfig.class) {
            return false;
        }
        android.hardware.wifi.V1_0.NanDebugConfig other = (android.hardware.wifi.V1_0.NanDebugConfig)otherObject;
    ...
    public final void readFromParcel(android.os.HwParcel parcel) {
        android.os.HwBlob blob = parcel.readBuffer(44 /* size */);
    ...
    public static final java.util.ArrayList<NanDebugConfig> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            android.os.HwBlob childBlob = parcel.readEmbeddedBuffer(
                    _hidl_vec_size * 44,_hidl_blob.handle(),
                    0 + 0 /* offsetof(hidl_vec<T>, mBuffer) */,true /* nullable */);

            _hidl_vec.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.wifi.V1_0.NanDebugConfig _hidl_vec_element = new android.hardware.wifi.V1_0.NanDebugConfig();
                ((android.hardware.wifi.V1_0.NanDebugConfig) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 44);
    ...
    public final void readEmbeddedFromParcel(
        ...
        validDiscoveryChannelVal = _hidl_blob.getBool(_hidl_offset + 24);
        {
            ...
            _hidl_blob.copyToInt32Array(_hidl_array_offset_0, (int[/* 2 */]) discoveryChannelMhzVal, 2 /* size */);
            _hidl_array_offset_0 += 2 * 4;
        }
        validUseBeaconsInBandVal = _hidl_blob.getBool(_hidl_offset + 36);
        {
            long _hidl_array_offset_0 = _hidl_offset + 37;
            _hidl_blob.copyToBoolArray(_hidl_array_offset_0, (boolean[/* 2 */]) useBeaconsInBandVal, 2 /* size */);
            _hidl_array_offset_0 += 2 * 1;
        }
        validUseSdfInBandVal = _hidl_blob.getBool(_hidl_offset + 39);
        {
            long _hidl_array_offset_0 = _hidl_offset + 40;
            _hidl_blob.copyToBoolArray(_hidl_array_offset_0, (boolean[/* 2 */]) useSdfInBandVal, 2 /* size */);
            _hidl_array_offset_0 += 2 * 1;
        }
    }

    public final void writeToParcel(android.os.HwParcel parcel) {
        android.os.HwBlob _hidl_blob = new android.os.HwBlob(44 /* size */);
    ...
    public static final void writeVectorToParcel(
        ...
        android.os.HwBlob _hidl_blob = new android.os.HwBlob(16 /* sizeof(hidl_vec<T>) */);
        {
            ...
            android.os.HwBlob childBlob = new android.os.HwBlob((int)(_hidl_vec_size * 44));
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 44);
            }
    ...
    public final void writeEmbeddedToBlob(
        ...
        {
            long _hidl_array_offset_0 = _hidl_offset + 28;
            int[] _hidl_array_item_0 = (int[/* 2 */]) discoveryChannelMhzVal;
        ...
        _hidl_blob.putBool(_hidl_offset + 36, validUseBeaconsInBandVal);
        {
            long _hidl_array_offset_0 = _hidl_offset + 37;
            boolean[] _hidl_array_item_0 = (boolean[/* 2 */]) useBeaconsInBandVal;
        ...
        _hidl_blob.putBool(_hidl_offset + 39, validUseSdfInBandVal);
        {
            long _hidl_array_offset_0 = _hidl_offset + 40;
            boolean[] _hidl_array_item_0 = (boolean[/* 2 */]) useSdfInBandVal;
