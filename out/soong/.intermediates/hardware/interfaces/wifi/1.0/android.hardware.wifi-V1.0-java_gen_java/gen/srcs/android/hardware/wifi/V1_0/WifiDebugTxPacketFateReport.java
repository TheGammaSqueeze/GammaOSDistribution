...
public final class WifiDebugTxPacketFateReport {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.wifi.V1_0.WifiDebugTxPacketFateReport.class) {
            return false;
        }
        android.hardware.wifi.V1_0.WifiDebugTxPacketFateReport other = (android.hardware.wifi.V1_0.WifiDebugTxPacketFateReport)otherObject;
    ...
    public final String toString() {
        ...
        builder.append("{");
        builder.append(".fate = ");
        builder.append(android.hardware.wifi.V1_0.WifiDebugTxPacketFate.toString(this.fate));
    ...
    public static final java.util.ArrayList<WifiDebugTxPacketFateReport> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<WifiDebugTxPacketFateReport> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.wifi.V1_0.WifiDebugTxPacketFateReport _hidl_vec_element = new android.hardware.wifi.V1_0.WifiDebugTxPacketFateReport();
                ((android.hardware.wifi.V1_0.WifiDebugTxPacketFateReport) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 56);
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<WifiDebugTxPacketFateReport> _hidl_vec) {
