...
public final class RttConfig {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.wifi.V1_0.RttConfig.class) {
            return false;
        }
        android.hardware.wifi.V1_0.RttConfig other = (android.hardware.wifi.V1_0.RttConfig)otherObject;
    ...
    public static final java.util.ArrayList<RttConfig> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.wifi.V1_0.RttConfig _hidl_vec_element = new android.hardware.wifi.V1_0.RttConfig();
                ((android.hardware.wifi.V1_0.RttConfig) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 68);
