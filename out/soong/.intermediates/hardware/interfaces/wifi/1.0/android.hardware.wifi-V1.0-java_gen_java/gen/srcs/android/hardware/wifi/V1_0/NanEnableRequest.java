...
public final class NanEnableRequest {
     ...
     */
    public boolean[/* 2 */] operateInBand = new boolean[2];
    /**
     ...
     */
    public android.hardware.wifi.V1_0.NanConfigRequest configParams = new android.hardware.wifi.V1_0.NanConfigRequest();
    /**
     * Non-standard configurations of NAN cluster operation - useful for debugging operations.
     */
    public android.hardware.wifi.V1_0.NanDebugConfig debugConfigs = new android.hardware.wifi.V1_0.NanDebugConfig();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.wifi.V1_0.NanEnableRequest.class) {
            return false;
        }
        android.hardware.wifi.V1_0.NanEnableRequest other = (android.hardware.wifi.V1_0.NanEnableRequest)otherObject;
    ...
    public static final java.util.ArrayList<NanEnableRequest> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.wifi.V1_0.NanEnableRequest _hidl_vec_element = new android.hardware.wifi.V1_0.NanEnableRequest();
                ((android.hardware.wifi.V1_0.NanEnableRequest) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 80);
    ...
    public final void readEmbeddedFromParcel(
            android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
        {
            ...
            _hidl_blob.copyToBoolArray(_hidl_array_offset_0, (boolean[/* 2 */]) operateInBand, 2 /* size */);
            _hidl_array_offset_0 += 2 * 1;
        }
        hopCountMax = _hidl_blob.getInt8(_hidl_offset + 2);
        ((android.hardware.wifi.V1_0.NanConfigRequest) configParams).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 4);
        ((android.hardware.wifi.V1_0.NanDebugConfig) debugConfigs).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 36);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        {
            long _hidl_array_offset_0 = _hidl_offset + 0;
            boolean[] _hidl_array_item_0 = (boolean[/* 2 */]) operateInBand;
        ...
        _hidl_blob.putInt8(_hidl_offset + 2, hopCountMax);
        configParams.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 4);
        debugConfigs.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 36);
    }
};
