 ...
 */
public interface IWifiIface extends android.hidl.base.V1_0.IBase {
    /**
     ...
     */
    /* package private */ static IWifiIface asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        IWifiIface proxy = new IWifiIface.Proxy(binder);
     ...
     */
    public static IWifiIface castFrom(android.os.IHwInterface iface) {
        return (iface == null) ? null : IWifiIface.asInterface(iface.asBinder());
    }
     ...
     */
    public static IWifiIface getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IWifiIface.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.0::IWifiIface", serviceName, retry));
    }

    /**
     * Calls getService("default",retry).
     */
    public static IWifiIface getService(boolean retry) throws android.os.RemoteException {
     ...
     */
    @Deprecated
    public static IWifiIface getService(String serviceName) throws android.os.RemoteException {
        return IWifiIface.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.0::IWifiIface", serviceName));
    }
     ...
     */
    @Deprecated
    public static IWifiIface getService() throws android.os.RemoteException {
    ...
    public static final class Proxy implements IWifiIface {
        ...
        public String toString() {
            ...
            return "[class or subclass of " + IWifiIface.kInterfaceName + "]@Proxy";
        }
    ...
    public static abstract class Stub extends android.os.HwBinder implements IWifiIface {
        @Override
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.V1_0.IWifiIface.kInterfaceName;
