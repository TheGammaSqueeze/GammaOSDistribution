...
public interface IWifiChipEventCallback extends android.hidl.base.V1_0.IBase {
    /**
    ...
    public static IWifiChipEventCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IWifiChipEventCallback.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.0::IWifiChipEventCallback", serviceName, retry));
    }
    ...
    public static IWifiChipEventCallback getService(String serviceName) throws android.os.RemoteException {
        return IWifiChipEventCallback.asInterface(android.os.HwBinder.getService("android.hardware.wifi@1.0::IWifiChipEventCallback", serviceName));
    }
     ...
     */
    void onChipReconfigureFailure(android.hardware.wifi.V1_0.WifiStatus status)
        throws android.os.RemoteException;
    /**
     ...
     */
    void onDebugRingBufferDataAvailable(android.hardware.wifi.V1_0.WifiDebugRingBufferStatus status, java.util.ArrayList<Byte> data)
        throws android.os.RemoteException;
    /**
     ...
     */
    void onDebugErrorAlert(int errorCode, java.util.ArrayList<Byte> debugData)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements IWifiChipEventCallback {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.wifi.V1_0.IWifiChipEventCallback.kInterfaceName;
