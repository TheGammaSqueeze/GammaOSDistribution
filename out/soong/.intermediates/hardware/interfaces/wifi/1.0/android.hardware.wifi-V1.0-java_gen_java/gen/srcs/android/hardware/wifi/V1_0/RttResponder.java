...
public final class RttResponder {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.wifi.V1_0.RttResponder.class) {
            return false;
        }
        android.hardware.wifi.V1_0.RttResponder other = (android.hardware.wifi.V1_0.RttResponder)otherObject;
    ...
    public final String toString() {
        ...
        builder.append(android.hardware.wifi.V1_0.RttPreamble.toString(this.preamble));
        builder.append("}");
    ...
    public static final java.util.ArrayList<RttResponder> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.wifi.V1_0.RttResponder _hidl_vec_element = new android.hardware.wifi.V1_0.RttResponder();
                ((android.hardware.wifi.V1_0.RttResponder) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 20);
