...
public final class ContextHubMsg {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.contexthub.V1_2.ContextHubMsg.class) {
            return false;
        }
        android.hardware.contexthub.V1_2.ContextHubMsg other = (android.hardware.contexthub.V1_2.ContextHubMsg)otherObject;
        if (!android.os.HidlSupport.deepEquals(this.msg_1_0, other.msg_1_0)) {
            return false;
        }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                android.os.HidlSupport.deepHashCode(this.msg_1_0), 
    ...
    public final String toString() {
        ...
        builder.append("{");
        builder.append(".msg_1_0 = ");
        builder.append(this.msg_1_0);
    ...
    public static final java.util.ArrayList<ContextHubMsg> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.contexthub.V1_2.ContextHubMsg _hidl_vec_element = new android.hardware.contexthub.V1_2.ContextHubMsg();
                ((android.hardware.contexthub.V1_2.ContextHubMsg) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 48);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.contexthub.V1_0.ContextHubMsg) msg_1_0).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        {
    ...
    public final void writeEmbeddedToBlob(
        ...
        msg_1_0.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 0);
        {
