...
public interface IContexthub extends android.hidl.base.V1_0.IBase {
    ...
    public static IContexthub getService(String serviceName) throws android.os.RemoteException {
        return IContexthub.asInterface(android.os.HwBinder.getService("android.hardware.contexthub@1.0::IContexthub", serviceName));
    }
     ...
     */
    java.util.ArrayList<android.hardware.contexthub.V1_0.ContextHub> getHubs()
     ...
     *
     */
    int registerCallback(int hubId, android.hardware.contexthub.V1_0.IContexthubCallback cb)
        throws android.os.RemoteException;
    /**
     ...
     */
    int sendMessageToHub(int hubId, android.hardware.contexthub.V1_0.ContextHubMsg msg)
        throws android.os.RemoteException;
    /**
     ...
     *
     */
    int loadNanoApp(int hubId, android.hardware.contexthub.V1_0.NanoAppBinary appBinary, int transactionId)
        throws android.os.RemoteException;
    /**
     ...
     *
     */
    int unloadNanoApp(int hubId, long appId, int transactionId)
        throws android.os.RemoteException;
    /**
     ...
     *
     */
    int enableNanoApp(int hubId, long appId, int transactionId)
        throws android.os.RemoteException;
    /**
     ...
     *
     */
    int disableNanoApp(int hubId, long appId, int transactionId)
        throws android.os.RemoteException;
    /**
