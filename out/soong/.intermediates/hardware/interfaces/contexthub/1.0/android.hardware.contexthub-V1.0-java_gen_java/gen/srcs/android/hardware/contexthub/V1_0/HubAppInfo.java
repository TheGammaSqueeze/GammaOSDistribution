...
public final class HubAppInfo {
    ...
    public java.util.ArrayList<android.hardware.contexthub.V1_0.MemRange> memUsage = new java.util.ArrayList<android.hardware.contexthub.V1_0.MemRange>();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.contexthub.V1_0.HubAppInfo.class) {
            return false;
        }
        android.hardware.contexthub.V1_0.HubAppInfo other = (android.hardware.contexthub.V1_0.HubAppInfo)otherObject;
        ...
        if (!android.os.HidlSupport.deepEquals(this.memUsage, other.memUsage)) {
            return false;
        }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.memUsage), 
    ...
    public static final java.util.ArrayList<HubAppInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.contexthub.V1_0.HubAppInfo _hidl_vec_element = new android.hardware.contexthub.V1_0.HubAppInfo();
                ((android.hardware.contexthub.V1_0.HubAppInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 40);
    ...
    public final void readEmbeddedFromParcel(
        ...
        version = _hidl_blob.getInt32(_hidl_offset + 8);
        {
            ...
            ((java.util.ArrayList<android.hardware.contexthub.V1_0.MemRange>) memUsage).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((java.util.ArrayList<android.hardware.contexthub.V1_0.MemRange>) memUsage).add(_hidl_vec_element);
            }
        }
        enabled = _hidl_blob.getBool(_hidl_offset + 32);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 8, version);
        {
            int _hidl_vec_size = memUsage.size();
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                memUsage.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 16);
            }
            _hidl_blob.putBlob(_hidl_offset + 16 + 0 /* offsetof(hidl_vec<T>, mBuffer) */, childBlob);
        }
        _hidl_blob.putBool(_hidl_offset + 32, enabled);
    }
};
