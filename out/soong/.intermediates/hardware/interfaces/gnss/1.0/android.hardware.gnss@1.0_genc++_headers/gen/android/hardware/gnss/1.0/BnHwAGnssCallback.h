#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_0_BNHWAGNSSCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_0_BNHWAGNSSCALLBACK_H
...
struct BnHwAGnssCallback : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_agnssStatusIpV4Cb(
    ...
    static ::android::status_t _hidl_agnssStatusIpV6Cb(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_0_BNHWAGNSSCALLBACK_H
