#define LOG_TAG "android.hardware.gnss@1.0::GnssDebug"
...
#include <android/hardware/gnss/1.0/BsGnssDebug.h>
...
::android::status_t readEmbeddedFromParcel(
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::gnss::V1_0::IGnssDebug::SatelliteData> &>(obj.satelliteDataArray),
            parcel,
            parentHandle,
            parentOffset + offsetof(::android::hardware::gnss::V1_0::IGnssDebug::DebugData, satelliteDataArray), &_hidl_satelliteDataArray_child);
...
const char* IGnssDebug::descriptor("android.hardware.gnss@1.0::IGnssDebug");
...
::android::hardware::Return<void> IGnssDebug::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::gnss::V1_0::IGnssDebug::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_0::IGnssDebug>> IGnssDebug::castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnssDebug>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_0::IGnssDebug>> IGnssDebug::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IGnssDebug, ::android::hidl::base::V1_0::IBase, BpHwGnssDebug>(
            parent, "android.hardware.gnss@1.0::IGnssDebug", emitError);
}

BpHwGnssDebug::BpHwGnssDebug(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IGnssDebug>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@1.0", "IGnssDebug") {
}
...
// Methods from ::android::hardware::gnss::V1_0::IGnssDebug follow.
::android::hardware::Return<void> BpHwGnssDebug::_hidl_getDebugData(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getDebugData_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IGnssDebug::getDebugData::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "1.0", "IGnssDebug", "getDebugData", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* getDebugData */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::gnss::V1_0::IGnssDebug::DebugData* _hidl_out_debugData;
        ...
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::gnss::V1_0::IGnssDebug::DebugData &>(*_hidl_out_debugData),
                _hidl_reply,
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "1.0", "IGnssDebug", "getDebugData", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwGnssDebug::BnHwGnssDebug(const ::android::sp<IGnssDebug> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.gnss@1.0", "IGnssDebug") { 
...
// Methods from ::android::hardware::gnss::V1_0::IGnssDebug follow.
::android::status_t BnHwGnssDebug::_hidl_getDebugData(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnssDebug::getDebugData::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "1.0", "IGnssDebug", "getDebugData", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IGnssDebug*>(_hidl_this->getImpl().get())->getDebugData([&](const auto &_hidl_out_debugData) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("getDebugData: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_debugData);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "1.0", "IGnssDebug", "getDebugData", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("getDebugData: _hidl_cb not called, but must be called once.");
    }
...
BsGnssDebug::BsGnssDebug(const ::android::sp<::android::hardware::gnss::V1_0::IGnssDebug> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@1.0", "IGnssDebug"), mImpl(impl) {
...
bool IGnssDebug::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.gnss@1.0::IGnssDebug",
