#define LOG_TAG "android.hardware.gnss@1.0::GnssMeasurement"
...
#include <android/hardware/gnss/1.0/BnHwGnssMeasurement.h>
#include <android/hardware/gnss/1.0/BsGnssMeasurement.h>
...
const char* IGnssMeasurement::descriptor("android.hardware.gnss@1.0::IGnssMeasurement");
...
::android::hardware::Return<void> IGnssMeasurement::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::gnss::V1_0::IGnssMeasurement::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_0::IGnssMeasurement>> IGnssMeasurement::castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnssMeasurement>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_0::IGnssMeasurement>> IGnssMeasurement::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IGnssMeasurement, ::android::hidl::base::V1_0::IBase, BpHwGnssMeasurement>(
            parent, "android.hardware.gnss@1.0::IGnssMeasurement", emitError);
}
...
BpHwGnssMeasurement::BpHwGnssMeasurement(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IGnssMeasurement>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@1.0", "IGnssMeasurement") {
}
...
// Methods from ::android::hardware::gnss::V1_0::IGnssMeasurement follow.
::android::hardware::Return<::android::hardware::gnss::V1_0::IGnssMeasurement::GnssMeasurementStatus> BpHwGnssMeasurement::_hidl_setCallback(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::gnss::V1_0::IGnssMeasurementCallback>& callback) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IGnssMeasurement::setCallback::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "1.0", "IGnssMeasurement", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "1.0", "IGnssMeasurement", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwGnssMeasurement::_hidl_close(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IGnssMeasurement::close::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "1.0", "IGnssMeasurement", "close", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "1.0", "IGnssMeasurement", "close", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwGnssMeasurement::BnHwGnssMeasurement(const ::android::sp<IGnssMeasurement> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.gnss@1.0", "IGnssMeasurement") { 
...
// Methods from ::android::hardware::gnss::V1_0::IGnssMeasurement follow.
::android::status_t BnHwGnssMeasurement::_hidl_setCallback(
    ...
    ::android::sp<::android::hardware::gnss::V1_0::IGnssMeasurementCallback> callback;

    {
        ...
        callback = ::android::hardware::fromBinder<::android::hardware::gnss::V1_0::IGnssMeasurementCallback,::android::hardware::gnss::V1_0::BpHwGnssMeasurementCallback,::android::hardware::gnss::V1_0::BnHwGnssMeasurementCallback>(_hidl_binder);
    }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnssMeasurement::setCallback::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "1.0", "IGnssMeasurement", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::gnss::V1_0::IGnssMeasurement::GnssMeasurementStatus _hidl_out_initRet = static_cast<IGnssMeasurement*>(_hidl_this->getImpl().get())->setCallback(callback);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_initRet);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "1.0", "IGnssMeasurement", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwGnssMeasurement::_hidl_close(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnssMeasurement::close::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "1.0", "IGnssMeasurement", "close", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IGnssMeasurement*>(_hidl_this->getImpl().get())->close();
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "1.0", "IGnssMeasurement", "close", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsGnssMeasurement::BsGnssMeasurement(const ::android::sp<::android::hardware::gnss::V1_0::IGnssMeasurement> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@1.0", "IGnssMeasurement"), mImpl(impl) {
...
bool IGnssMeasurement::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.gnss@1.0::IGnssMeasurement",
