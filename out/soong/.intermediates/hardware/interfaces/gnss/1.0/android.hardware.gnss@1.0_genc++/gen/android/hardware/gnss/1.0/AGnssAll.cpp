#define LOG_TAG "android.hardware.gnss@1.0::AGnss"
...
#include <android/hardware/gnss/1.0/BpHwAGnss.h>
#include <android/hardware/gnss/1.0/BnHwAGnss.h>
#include <android/hardware/gnss/1.0/BsAGnss.h>
...
const char* IAGnss::descriptor("android.hardware.gnss@1.0::IAGnss");
...
// no default implementation for: ::android::hardware::Return<void> IAGnss::setCallback(const ::android::sp<::android::hardware::gnss::V1_0::IAGnssCallback>& callback)
...
// no default implementation for: ::android::hardware::Return<bool> IAGnss::setServer(::android::hardware::gnss::V1_0::IAGnssCallback::AGnssType type, const ::android::hardware::hidl_string& hostname, int32_t port)
// no default implementation for: ::android::hardware::Return<bool> IAGnss::dataConnOpen(const ::android::hardware::hidl_string& apn, ::android::hardware::gnss::V1_0::IAGnss::ApnIpType apnIpType)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IAGnss::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::gnss::V1_0::IAGnss::descriptor,
...
::android::hardware::Return<void> IAGnss::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::gnss::V1_0::IAGnss::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IAGnss::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){55,199,218,79,130,62,201,88,223,169,201,96,226,211,65,196,143,135,126,11,250,117,143,63,169,226,217,193,225,189,102,217} /* 37c7da4f823ec958dfa9c960e2d341c48f877e0bfa758f3fa9e2d9c1e1bd66d9 */,
...
::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_0::IAGnss>> IAGnss::castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IAGnss>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_0::IAGnss>> IAGnss::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IAGnss, ::android::hidl::base::V1_0::IBase, BpHwAGnss>(
            parent, "android.hardware.gnss@1.0::IAGnss", emitError);
}

BpHwAGnss::BpHwAGnss(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IAGnss>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@1.0", "IAGnss") {
}
...
// Methods from ::android::hardware::gnss::V1_0::IAGnss follow.
::android::hardware::Return<void> BpHwAGnss::_hidl_setCallback(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::gnss::V1_0::IAGnssCallback>& callback) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "1.0", "IAGnss", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "1.0", "IAGnss", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<bool> BpHwAGnss::_hidl_dataConnClosed(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "1.0", "IAGnss", "dataConnClosed", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "1.0", "IAGnss", "dataConnClosed", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<bool> BpHwAGnss::_hidl_dataConnFailed(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "1.0", "IAGnss", "dataConnFailed", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_success);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "1.0", "IAGnss", "dataConnFailed", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<bool> BpHwAGnss::_hidl_setServer(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::gnss::V1_0::IAGnssCallback::AGnssType type, const ::android::hardware::hidl_string& hostname, int32_t port) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "1.0", "IAGnss", "setServer", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_success);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "1.0", "IAGnss", "setServer", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<bool> BpHwAGnss::_hidl_dataConnOpen(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& apn, ::android::hardware::gnss::V1_0::IAGnss::ApnIpType apnIpType) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "1.0", "IAGnss", "dataConnOpen", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_success);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "1.0", "IAGnss", "dataConnOpen", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::gnss::V1_0::IAGnss follow.
::android::hardware::Return<void> BpHwAGnss::setCallback(const ::android::sp<::android::hardware::gnss::V1_0::IAGnssCallback>& callback){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::gnss::V1_0::BpHwAGnss::_hidl_setCallback(this, this, callback);

    return _hidl_out;
}

::android::hardware::Return<bool> BpHwAGnss::dataConnClosed(){
    ::android::hardware::Return<bool>  _hidl_out = ::android::hardware::gnss::V1_0::BpHwAGnss::_hidl_dataConnClosed(this, this);

    return _hidl_out;
}

::android::hardware::Return<bool> BpHwAGnss::dataConnFailed(){
    ::android::hardware::Return<bool>  _hidl_out = ::android::hardware::gnss::V1_0::BpHwAGnss::_hidl_dataConnFailed(this, this);

    return _hidl_out;
}

::android::hardware::Return<bool> BpHwAGnss::setServer(::android::hardware::gnss::V1_0::IAGnssCallback::AGnssType type, const ::android::hardware::hidl_string& hostname, int32_t port){
    ::android::hardware::Return<bool>  _hidl_out = ::android::hardware::gnss::V1_0::BpHwAGnss::_hidl_setServer(this, this, type, hostname, port);

    return _hidl_out;
}

::android::hardware::Return<bool> BpHwAGnss::dataConnOpen(const ::android::hardware::hidl_string& apn, ::android::hardware::gnss::V1_0::IAGnss::ApnIpType apnIpType){
    ::android::hardware::Return<bool>  _hidl_out = ::android::hardware::gnss::V1_0::BpHwAGnss::_hidl_dataConnOpen(this, this, apn, apnIpType);
...
BnHwAGnss::BnHwAGnss(const ::android::sp<IAGnss> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.gnss@1.0", "IAGnss") { 
...
::android::status_t BnHwAGnss::_hidl_setCallback(
    ...
    ::android::sp<::android::hardware::gnss::V1_0::IAGnssCallback> callback;

    {
        ...
        callback = ::android::hardware::fromBinder<::android::hardware::gnss::V1_0::IAGnssCallback,::android::hardware::gnss::V1_0::BpHwAGnssCallback,::android::hardware::gnss::V1_0::BnHwAGnssCallback>(_hidl_binder);
    }
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "1.0", "IAGnss", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "1.0", "IAGnss", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwAGnss::_hidl_dataConnClosed(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "1.0", "IAGnss", "dataConnClosed", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_success);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "1.0", "IAGnss", "dataConnClosed", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwAGnss::_hidl_dataConnFailed(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "1.0", "IAGnss", "dataConnFailed", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_success);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "1.0", "IAGnss", "dataConnFailed", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwAGnss::_hidl_setServer(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&port);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "1.0", "IAGnss", "setServer", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_success);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "1.0", "IAGnss", "setServer", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwAGnss::_hidl_dataConnOpen(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&apnIpType);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "1.0", "IAGnss", "dataConnOpen", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    bool _hidl_out_success = static_cast<IAGnss*>(_hidl_this->getImpl().get())->dataConnOpen(*apn, apnIpType);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_success);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "1.0", "IAGnss", "dataConnOpen", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwAGnss::onTransact(
    ...
    switch (_hidl_code) {
        case 1 /* setCallback */:
        {
            _hidl_err = ::android::hardware::gnss::V1_0::BnHwAGnss::_hidl_setCallback(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 2 /* dataConnClosed */:
        {
            _hidl_err = ::android::hardware::gnss::V1_0::BnHwAGnss::_hidl_dataConnClosed(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 3 /* dataConnFailed */:
        {
            _hidl_err = ::android::hardware::gnss::V1_0::BnHwAGnss::_hidl_dataConnFailed(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 4 /* setServer */:
        {
            _hidl_err = ::android::hardware::gnss::V1_0::BnHwAGnss::_hidl_setServer(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 5 /* dataConnOpen */:
        {
            _hidl_err = ::android::hardware::gnss::V1_0::BnHwAGnss::_hidl_dataConnOpen(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsAGnss::BsAGnss(const ::android::sp<::android::hardware::gnss::V1_0::IAGnss> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@1.0", "IAGnss"), mImpl(impl) {
...
bool IAGnss::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.gnss@1.0::IAGnss",
