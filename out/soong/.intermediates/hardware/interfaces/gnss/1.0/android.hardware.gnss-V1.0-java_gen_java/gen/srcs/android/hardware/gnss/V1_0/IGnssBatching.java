 ...
 */
public interface IGnssBatching extends android.hidl.base.V1_0.IBase {
    /**
    ...
    public static IGnssBatching getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IGnssBatching.asInterface(android.os.HwBinder.getService("android.hardware.gnss@1.0::IGnssBatching", serviceName, retry));
    }
    ...
    public static IGnssBatching getService(String serviceName) throws android.os.RemoteException {
        return IGnssBatching.asInterface(android.os.HwBinder.getService("android.hardware.gnss@1.0::IGnssBatching", serviceName));
    }
    ...
    public static final class Flag {
         ...
         */
        public static final byte WAKEUP_ON_FIFO_FULL = 1 /* 0x01 */;
        public static final String toString(byte o) {
            if (o == WAKEUP_ON_FIFO_FULL) {
        ...
        public static final String dumpBitfield(byte o) {
            ...
            byte flipped = 0;
            if ((o & WAKEUP_ON_FIFO_FULL) == WAKEUP_ON_FIFO_FULL) {
                list.add("WAKEUP_ON_FIFO_FULL");
                flipped |= WAKEUP_ON_FIFO_FULL;
            }
            if (o != flipped) {
    ...
    public final static class Options {
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (otherObject.getClass() != android.hardware.gnss.V1_0.IGnssBatching.Options.class) {
                return false;
            }
            android.hardware.gnss.V1_0.IGnssBatching.Options other = (android.hardware.gnss.V1_0.IGnssBatching.Options)otherObject;
        ...
        public final int hashCode() {
            return java.util.Objects.hash(
                    android.os.HidlSupport.deepHashCode(this.periodNanos), 
        ...
        public final String toString() {
            ...
            builder.append("{");
            builder.append(".periodNanos = ");
            builder.append(this.periodNanos);
            builder.append(", .flags = ");
            builder.append(android.hardware.gnss.V1_0.IGnssBatching.Flag.dumpBitfield(this.flags));
            builder.append("}");
        ...
        public static final java.util.ArrayList<Options> readVectorFromParcel(android.os.HwParcel parcel) {
            java.util.ArrayList<Options> _hidl_vec = new java.util.ArrayList();
...

            {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    android.hardware.gnss.V1_0.IGnssBatching.Options _hidl_vec_element = new android.hardware.gnss.V1_0.IGnssBatching.Options();
                    ((android.hardware.gnss.V1_0.IGnssBatching.Options) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 16);
        ...
        public final void readEmbeddedFromParcel(
            ...
            periodNanos = _hidl_blob.getInt64(_hidl_offset + 0);
            flags = _hidl_blob.getInt8(_hidl_offset + 8);
        }
        ...
        public static final void writeVectorToParcel(
                android.os.HwParcel parcel, java.util.ArrayList<Options> _hidl_vec) {
        ...
        public final void writeEmbeddedToBlob(
            ...
            _hidl_blob.putInt64(_hidl_offset + 0, periodNanos);
            _hidl_blob.putInt8(_hidl_offset + 8, flags);
        }
    };
     ...
     */
    boolean init(android.hardware.gnss.V1_0.IGnssBatchingCallback callback)
     ...
     * @return success Returns true on success.
     */
    boolean start(android.hardware.gnss.V1_0.IGnssBatching.Options options)
        throws android.os.RemoteException;
    /**
