 ...
 */
public interface IGnssGeofencing extends android.hidl.base.V1_0.IBase {
    /**
     ...
     */
    /* package private */ static IGnssGeofencing asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        IGnssGeofencing proxy = new IGnssGeofencing.Proxy(binder);
     ...
     */
    public static IGnssGeofencing castFrom(android.os.IHwInterface iface) {
        return (iface == null) ? null : IGnssGeofencing.asInterface(iface.asBinder());
    }
     ...
     */
    public static IGnssGeofencing getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IGnssGeofencing.asInterface(android.os.HwBinder.getService("android.hardware.gnss@1.0::IGnssGeofencing", serviceName, retry));
    }

    /**
     * Calls getService("default",retry).
     */
    public static IGnssGeofencing getService(boolean retry) throws android.os.RemoteException {
     ...
     */
    @Deprecated
    public static IGnssGeofencing getService(String serviceName) throws android.os.RemoteException {
        return IGnssGeofencing.asInterface(android.os.HwBinder.getService("android.hardware.gnss@1.0::IGnssGeofencing", serviceName));
    }
     ...
     */
    @Deprecated
    public static IGnssGeofencing getService() throws android.os.RemoteException {
     ...
     */
    void setCallback(android.hardware.gnss.V1_0.IGnssGeofenceCallback callback)
     ...
     */
    void addGeofence(int geofenceId, double latitudeDegrees, double longitudeDegrees, double radiusMeters, int lastTransition, int monitorTransitions, int notificationResponsivenessMs, int unknownTimerMs)
        throws android.os.RemoteException;
    /**
    ...
    public static final class Proxy implements IGnssGeofencing {
        ...
        public String toString() {
            ...
            return "[class or subclass of " + IGnssGeofencing.kInterfaceName + "]@Proxy";
        }
        ...
        @Override
        public void setCallback(android.hardware.gnss.V1_0.IGnssGeofenceCallback callback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V1_0.IGnssGeofencing.kInterfaceName);
        ...
        @Override
        public void addGeofence(int geofenceId, double latitudeDegrees, double longitudeDegrees, double radiusMeters, int lastTransition, int monitorTransitions, int notificationResponsivenessMs, int unknownTimerMs)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V1_0.IGnssGeofencing.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(2 /* addGeofence */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
        ...
        public void pauseGeofence(int geofenceId)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(3 /* pauseGeofence */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
        ...
        public void resumeGeofence(int geofenceId, int monitorTransitions)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(4 /* resumeGeofence */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
        ...
        public void removeGeofence(int geofenceId)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(5 /* removeGeofence */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IGnssGeofencing {
        @Override
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.gnss.V1_0.IGnssGeofencing.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.gnss.V1_0.IGnssGeofencing.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-7,14,77,-36,101,39,6,41,-99,-114,61,-117,-95,-114,7,69,-61,-70,-23,-65,77,27,-26,-67,6,-39,-63,-11,14,-56,-46,-118} /* f90e4ddc652706299d8e3d8ba18e0745c3bae9bf4d1be6bd06d9c1f50ec8d28a */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                case 1 /* setCallback */:
                {
                    _hidl_request.enforceInterface(android.hardware.gnss.V1_0.IGnssGeofencing.kInterfaceName);

                    android.hardware.gnss.V1_0.IGnssGeofenceCallback callback = android.hardware.gnss.V1_0.IGnssGeofenceCallback.asInterface(_hidl_request.readStrongBinder());
                ...
                case 4 /* resumeGeofence */:
                {
                    ...
                    int geofenceId = _hidl_request.readInt32();
                    int monitorTransitions = _hidl_request.readInt32();
                    resumeGeofence(geofenceId, monitorTransitions);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.send();
                    break;
                }
