...
public interface IGnss extends android.hardware.gnss.V1_1.IGnss {
    ...
    public static IGnss getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IGnss.asInterface(android.os.HwBinder.getService("android.hardware.gnss@2.0::IGnss", serviceName, retry));
    }
    ...
    public static IGnss getService(String serviceName) throws android.os.RemoteException {
        return IGnss.asInterface(android.os.HwBinder.getService("android.hardware.gnss@2.0::IGnss", serviceName));
    }
     ...
     */
    boolean setCallback_2_0(android.hardware.gnss.V2_0.IGnssCallback callback)
     ...
     */
    android.hardware.gnss.V2_0.IGnssConfiguration getExtensionGnssConfiguration_2_0()
        throws android.os.RemoteException;
    /**
     ...
     */
    android.hardware.gnss.V2_0.IGnssDebug getExtensionGnssDebug_2_0()
        throws android.os.RemoteException;
    /**
     ...
     */
    android.hardware.gnss.V2_0.IAGnss getExtensionAGnss_2_0()
        throws android.os.RemoteException;
    /**
     ...
     */
    android.hardware.gnss.V2_0.IAGnssRil getExtensionAGnssRil_2_0()
        throws android.os.RemoteException;
    /**
     ...
     */
    android.hardware.gnss.V2_0.IGnssMeasurement getExtensionGnssMeasurement_2_0()
        throws android.os.RemoteException;
    /**
     ...
     */
    android.hardware.gnss.measurement_corrections.V1_0.IMeasurementCorrections getExtensionMeasurementCorrections()
        throws android.os.RemoteException;
    /**
     ...
     */
    android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControl getExtensionVisibilityControl()
        throws android.os.RemoteException;
    /**
     ...
     */
    android.hardware.gnss.V2_0.IGnssBatching getExtensionGnssBatching_2_0()
        throws android.os.RemoteException;
    /**
     ...
     */
    boolean injectBestLocation_2_0(android.hardware.gnss.V2_0.GnssLocation location)
        throws android.os.RemoteException;
    /*
