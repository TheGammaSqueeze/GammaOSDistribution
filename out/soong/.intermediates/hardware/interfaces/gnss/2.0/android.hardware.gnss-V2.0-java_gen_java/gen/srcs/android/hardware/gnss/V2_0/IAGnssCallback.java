...
public interface IAGnssCallback extends android.hidl.base.V1_0.IBase {
    ...
    public static IAGnssCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IAGnssCallback.asInterface(android.os.HwBinder.getService("android.hardware.gnss@2.0::IAGnssCallback", serviceName, retry));
    }
    ...
    public static IAGnssCallback getService(String serviceName) throws android.os.RemoteException {
        return IAGnssCallback.asInterface(android.os.HwBinder.getService("android.hardware.gnss@2.0::IAGnssCallback", serviceName));
    }
    ...
    public static final class AGnssType {
        ...
        public static final String dumpBitfield(byte o) {
            ...
            if ((o & SUPL_EIMS) == SUPL_EIMS) {
                list.add("SUPL_EIMS");
                flipped |= SUPL_EIMS;
            }
            if ((o & SUPL_IMS) == SUPL_IMS) {
                list.add("SUPL_IMS");
                flipped |= SUPL_IMS;
            }
            if (o != flipped) {
     ...
     */
    void agnssStatusCb(byte type, byte status)
    ...
    public static final class Proxy implements IAGnssCallback {
        ...
        @Override
        public void agnssStatusCb(byte type, byte status)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V2_0.IAGnssCallback.kInterfaceName);
            _hidl_request.writeInt8(type);
            _hidl_request.writeInt8(status);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(1 /* agnssStatusCb */, _hidl_request, _hidl_reply, 0 /* flags */);
    ...
    public static abstract class Stub extends android.os.HwBinder implements IAGnssCallback {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.gnss.V2_0.IAGnssCallback.kInterfaceName,
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{46,90,-39,-125,115,64,105,-24,74,118,0,4,-77,45,-96,-48,-98,65,112,-64,83,-128,-85,-30,126,110,-72,14,74,-89,13,90} /* 2e5ad983734069e84a760004b32da0d09e4170c05380abe27e6eb80e4aa70d5a */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                {
                    _hidl_request.enforceInterface(android.hardware.gnss.V2_0.IAGnssCallback.kInterfaceName);
