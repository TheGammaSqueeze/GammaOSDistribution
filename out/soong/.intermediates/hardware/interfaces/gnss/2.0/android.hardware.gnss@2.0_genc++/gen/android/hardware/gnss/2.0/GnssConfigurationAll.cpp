#define LOG_TAG "android.hardware.gnss@2.0::GnssConfiguration"
...
#include <android/hardware/gnss/2.0/BnHwGnssConfiguration.h>
#include <android/hardware/gnss/2.0/BsGnssConfiguration.h>
...
const char* IGnssConfiguration::descriptor("android.hardware.gnss@2.0::IGnssConfiguration");
...
::android::hardware::Return<void> IGnssConfiguration::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::gnss::V2_0::IGnssConfiguration::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssConfiguration>> IGnssConfiguration::castFrom(const ::android::sp<::android::hardware::gnss::V2_0::IGnssConfiguration>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssConfiguration>> IGnssConfiguration::castFrom(const ::android::sp<::android::hardware::gnss::V1_1::IGnssConfiguration>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IGnssConfiguration, ::android::hardware::gnss::V1_1::IGnssConfiguration, BpHwGnssConfiguration>(
            parent, "android.hardware.gnss@2.0::IGnssConfiguration", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssConfiguration>> IGnssConfiguration::castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnssConfiguration>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssConfiguration>> IGnssConfiguration::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwGnssConfiguration::BpHwGnssConfiguration(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IGnssConfiguration>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@2.0", "IGnssConfiguration") {
}
...
// Methods from ::android::hardware::gnss::V2_0::IGnssConfiguration follow.
::android::hardware::Return<bool> BpHwGnssConfiguration::_hidl_setEsExtensionSec(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t emergencyExtensionSeconds) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IGnssConfiguration::setEsExtensionSec::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&emergencyExtensionSeconds);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "2.0", "IGnssConfiguration", "setEsExtensionSec", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_err = _hidl_data.writeUint32(emergencyExtensionSeconds);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(9 /* setEsExtensionSec */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "2.0", "IGnssConfiguration", "setEsExtensionSec", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwGnssConfiguration::BnHwGnssConfiguration(const ::android::sp<IGnssConfiguration> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.gnss@2.0", "IGnssConfiguration") { 
...
// Methods from ::android::hardware::gnss::V2_0::IGnssConfiguration follow.
::android::status_t BnHwGnssConfiguration::_hidl_setEsExtensionSec(
    ...
    _hidl_err = _hidl_data.readUint32(&emergencyExtensionSeconds);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnssConfiguration::setEsExtensionSec::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&emergencyExtensionSeconds);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "2.0", "IGnssConfiguration", "setEsExtensionSec", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    bool _hidl_out_success = static_cast<IGnssConfiguration*>(_hidl_this->getImpl().get())->setEsExtensionSec(emergencyExtensionSeconds);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_success);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "2.0", "IGnssConfiguration", "setEsExtensionSec", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsGnssConfiguration::BsGnssConfiguration(const ::android::sp<::android::hardware::gnss::V2_0::IGnssConfiguration> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@2.0", "IGnssConfiguration"), mImpl(impl) {
...
bool IGnssConfiguration::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.gnss@2.0::IGnssConfiguration",
