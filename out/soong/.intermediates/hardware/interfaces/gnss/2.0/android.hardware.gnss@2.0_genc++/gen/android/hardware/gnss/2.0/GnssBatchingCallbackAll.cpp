#define LOG_TAG "android.hardware.gnss@2.0::GnssBatchingCallback"
...
#include <android/hardware/gnss/2.0/BpHwGnssBatchingCallback.h>
#include <android/hardware/gnss/2.0/BnHwGnssBatchingCallback.h>
#include <android/hardware/gnss/2.0/BsGnssBatchingCallback.h>
...
const char* IGnssBatchingCallback::descriptor("android.hardware.gnss@2.0::IGnssBatchingCallback");
...
// no default implementation for: ::android::hardware::Return<void> IGnssBatchingCallback::gnssLocationBatchCb(const ::android::hardware::hidl_vec<::android::hardware::gnss::V2_0::GnssLocation>& locations)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IGnssBatchingCallback::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::gnss::V2_0::IGnssBatchingCallback::descriptor,
...
::android::hardware::Return<void> IGnssBatchingCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::gnss::V2_0::IGnssBatchingCallback::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IGnssBatchingCallback::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){31,137,57,47,30,187,105,61,143,166,245,3,36,177,99,95,199,159,171,36,109,49,144,14,99,153,142,27,14,23,81,28} /* 1f89392f1ebb693d8fa6f50324b1635fc79fab246d31900e63998e1b0e17511c */,
...
::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssBatchingCallback>> IGnssBatchingCallback::castFrom(const ::android::sp<::android::hardware::gnss::V2_0::IGnssBatchingCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_0::IGnssBatchingCallback>> IGnssBatchingCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IGnssBatchingCallback, ::android::hidl::base::V1_0::IBase, BpHwGnssBatchingCallback>(
            parent, "android.hardware.gnss@2.0::IGnssBatchingCallback", emitError);
}
...
BpHwGnssBatchingCallback::BpHwGnssBatchingCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IGnssBatchingCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@2.0", "IGnssBatchingCallback") {
}
...
// Methods from ::android::hardware::gnss::V2_0::IGnssBatchingCallback follow.
::android::hardware::Return<void> BpHwGnssBatchingCallback::_hidl_gnssLocationBatchCb(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::gnss::V2_0::GnssLocation>& locations) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "2.0", "IGnssBatchingCallback", "gnssLocationBatchCb", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "2.0", "IGnssBatchingCallback", "gnssLocationBatchCb", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::gnss::V2_0::IGnssBatchingCallback follow.
::android::hardware::Return<void> BpHwGnssBatchingCallback::gnssLocationBatchCb(const ::android::hardware::hidl_vec<::android::hardware::gnss::V2_0::GnssLocation>& locations){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::gnss::V2_0::BpHwGnssBatchingCallback::_hidl_gnssLocationBatchCb(this, this, locations);
...
BnHwGnssBatchingCallback::BnHwGnssBatchingCallback(const ::android::sp<IGnssBatchingCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.gnss@2.0", "IGnssBatchingCallback") { 
...
::android::status_t BnHwGnssBatchingCallback::_hidl_gnssLocationBatchCb(
    ...
    const ::android::hardware::hidl_vec<::android::hardware::gnss::V2_0::GnssLocation>* locations;
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::gnss::V2_0::GnssLocation> &>(*locations),
            _hidl_data,
            _hidl_locations_parent,
            0 /* parentOffset */, &_hidl_locations_child);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)locations);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "2.0", "IGnssBatchingCallback", "gnssLocationBatchCb", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "2.0", "IGnssBatchingCallback", "gnssLocationBatchCb", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwGnssBatchingCallback::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::gnss::V2_0::BnHwGnssBatchingCallback::_hidl_gnssLocationBatchCb(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsGnssBatchingCallback::BsGnssBatchingCallback(const ::android::sp<::android::hardware::gnss::V2_0::IGnssBatchingCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@2.0", "IGnssBatchingCallback"), mImpl(impl) {
...
bool IGnssBatchingCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.gnss@2.0::IGnssBatchingCallback",
