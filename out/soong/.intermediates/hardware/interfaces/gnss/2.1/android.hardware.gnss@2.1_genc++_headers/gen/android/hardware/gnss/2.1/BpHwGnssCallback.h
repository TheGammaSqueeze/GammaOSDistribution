#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_1_BPHWGNSSCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_1_BPHWGNSSCALLBACK_H
...
struct BpHwGnssCallback : public ::android::hardware::BpInterface<IGnssCallback>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_gnssSetCapabilitiesCb_2_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::hidl_bitfield<::android::hardware::gnss::V2_1::IGnssCallback::Capabilities> capabilities);
    static ::android::hardware::Return<void>  _hidl_gnssSvStatusCb_2_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::gnss::V2_1::IGnssCallback::GnssSvInfo>& svInfoList);
    ...
    // Methods from ::android::hardware::gnss::V2_1::IGnssCallback follow.
    ::android::hardware::Return<void> gnssSetCapabilitiesCb_2_1(::android::hardware::hidl_bitfield<::android::hardware::gnss::V2_1::IGnssCallback::Capabilities> capabilities) override;
    ::android::hardware::Return<void> gnssSvStatusCb_2_1(const ::android::hardware::hidl_vec<::android::hardware::gnss::V2_1::IGnssCallback::GnssSvInfo>& svInfoList) override;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V2_1_BPHWGNSSCALLBACK_H
