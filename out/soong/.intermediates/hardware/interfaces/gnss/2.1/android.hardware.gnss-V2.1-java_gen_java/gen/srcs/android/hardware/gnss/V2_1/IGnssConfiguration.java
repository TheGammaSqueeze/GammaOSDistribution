...
public interface IGnssConfiguration extends android.hardware.gnss.V2_0.IGnssConfiguration {
    ...
    public static IGnssConfiguration getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IGnssConfiguration.asInterface(android.os.HwBinder.getService("android.hardware.gnss@2.1::IGnssConfiguration", serviceName, retry));
    }
    ...
    public static IGnssConfiguration getService(String serviceName) throws android.os.RemoteException {
        return IGnssConfiguration.asInterface(android.os.HwBinder.getService("android.hardware.gnss@2.1::IGnssConfiguration", serviceName));
    }
     ...
     * IRNSS.
     */
    public final static class BlacklistedSource {
        /**
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (otherObject.getClass() != android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource.class) {
                return false;
            }
            android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource other = (android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource)otherObject;
        ...
        public static final java.util.ArrayList<BlacklistedSource> readVectorFromParcel(android.os.HwParcel parcel) {
            java.util.ArrayList<BlacklistedSource> _hidl_vec = new java.util.ArrayList();
...

            {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource _hidl_vec_element = new android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource();
                    ((android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 4);
        ...
        public final void readEmbeddedFromParcel(
            ...
            svid = _hidl_blob.getInt16(_hidl_offset + 2);
        }
        ...
        public static final void writeVectorToParcel(
                android.os.HwParcel parcel, java.util.ArrayList<BlacklistedSource> _hidl_vec) {
        ...
        public final void writeEmbeddedToBlob(
            ...
            _hidl_blob.putInt16(_hidl_offset + 2, svid);
        }
    };
     ...
     */
    boolean setBlacklist_2_1(java.util.ArrayList<android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource> blacklist)
    ...
    public static final class Proxy implements IGnssConfiguration {
        ...
        @Override
        public boolean setBlacklist_2_1(java.util.ArrayList<android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource> blacklist)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V2_1.IGnssConfiguration.kInterfaceName);
            android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource.writeVectorToParcel(_hidl_request, blacklist);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(10 /* setBlacklist_2_1 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IGnssConfiguration {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.gnss.V2_1.IGnssConfiguration.kInterfaceName,
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{115,125,117,0,23,115,-113,7,83,-47,59,-96,26,51,16,-32,22,31,41,75,-118,-24,11,63,-42,62,-86,34,126,-99,-100,102} /* 737d750017738f0753d13ba01a3310e0161f294b8ae80b3fd63eaa227e9d9c66 */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                {
                    _hidl_request.enforceInterface(android.hardware.gnss.V2_1.IGnssConfiguration.kInterfaceName);

                    java.util.ArrayList<android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource> blacklist = android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource.readVectorFromParcel(_hidl_request);
                    boolean _hidl_out_success = setBlacklist_2_1(blacklist);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeBool(_hidl_out_success);
                    _hidl_reply.send();
                    break;
