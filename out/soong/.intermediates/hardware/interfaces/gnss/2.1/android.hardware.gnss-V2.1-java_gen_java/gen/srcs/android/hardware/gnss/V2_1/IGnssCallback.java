...
public interface IGnssCallback extends android.hardware.gnss.V2_0.IGnssCallback {
    ...
    public static IGnssCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IGnssCallback.asInterface(android.os.HwBinder.getService("android.hardware.gnss@2.1::IGnssCallback", serviceName, retry));
    }
    ...
    public static IGnssCallback getService(String serviceName) throws android.os.RemoteException {
        return IGnssCallback.asInterface(android.os.HwBinder.getService("android.hardware.gnss@2.1::IGnssCallback", serviceName));
    }
    ...
    public static final class Capabilities {
         ...
         * GNSS supports measurement corrections
         */
        public static final int ANTENNA_INFO = 2048 /* 1 << 11 */;
        ...
        public static final String dumpBitfield(int o) {
            ...
            if ((o & ANTENNA_INFO) == ANTENNA_INFO) {
                list.add("ANTENNA_INFO");
                flipped |= ANTENNA_INFO;
            }
            if (o != flipped) {
    ...
    public final static class GnssSvInfo {
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (otherObject.getClass() != android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo.class) {
                return false;
            }
            android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo other = (android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo)otherObject;
        ...
        public static final java.util.ArrayList<GnssSvInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

            {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo _hidl_vec_element = new android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo();
                    ((android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 40);
        ...
        public final void readEmbeddedFromParcel(
            ...
            ((android.hardware.gnss.V2_0.IGnssCallback.GnssSvInfo) v2_0).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
            basebandCN0DbHz = _hidl_blob.getDouble(_hidl_offset + 32);
        }
        ...
        public final void writeEmbeddedToBlob(
            ...
            _hidl_blob.putDouble(_hidl_offset + 32, basebandCN0DbHz);
        }
    };
     ...
     */
    void gnssSetCapabilitiesCb_2_1(int capabilities)
     ...
     */
    void gnssSvStatusCb_2_1(java.util.ArrayList<android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo> svInfoList)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements IGnssCallback {
        ...
        @Override
        public void gnssSetCapabilitiesCb_2_1(int capabilities)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V2_1.IGnssCallback.kInterfaceName);
            _hidl_request.writeInt32(capabilities);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(16 /* gnssSetCapabilitiesCb_2_1 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
        ...
        @Override
        public void gnssSvStatusCb_2_1(java.util.ArrayList<android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo> svInfoList)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V2_1.IGnssCallback.kInterfaceName);
            android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo.writeVectorToParcel(_hidl_request, svInfoList);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(17 /* gnssSvStatusCb_2_1 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IGnssCallback {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.gnss.V2_1.IGnssCallback.kInterfaceName,
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{53,65,-40,58,-33,-22,-63,110,-29,-28,93,24,58,88,-33,-2,6,1,44,-53,90,-91,-68,-46,-28,-10,-18,-82,38,-97,105,-51} /* 3541d83adfeac16ee3e45d183a58dffe06012ccb5aa5bcd2e4f6eeae269f69cd */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                {
                    _hidl_request.enforceInterface(android.hardware.gnss.V2_1.IGnssCallback.kInterfaceName);

                    int capabilities = _hidl_request.readInt32();
                    gnssSetCapabilitiesCb_2_1(capabilities);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.send();
                    break;
                }
                ...
                case 17 /* gnssSvStatusCb_2_1 */:
                {
                    ...
                    java.util.ArrayList<android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo> svInfoList = android.hardware.gnss.V2_1.IGnssCallback.GnssSvInfo.readVectorFromParcel(_hidl_request);
                    gnssSvStatusCb_2_1(svInfoList);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.send();
                    break;
                }
