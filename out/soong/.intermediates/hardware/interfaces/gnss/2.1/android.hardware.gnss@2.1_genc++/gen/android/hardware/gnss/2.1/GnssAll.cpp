#define LOG_TAG "android.hardware.gnss@2.1::Gnss"
...
#include <android/hardware/gnss/2.1/BpHwGnss.h>
#include <android/hardware/gnss/2.1/BnHwGnss.h>
#include <android/hardware/gnss/2.1/BsGnss.h>
...
const char* IGnss::descriptor("android.hardware.gnss@2.1::IGnss");
...
// no default implementation for: ::android::hardware::Return<bool> IGnss::setCallback_2_1(const ::android::sp<::android::hardware::gnss::V2_1::IGnssCallback>& callback)
// no default implementation for: ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>> IGnss::getExtensionGnssMeasurement_2_1()
// no default implementation for: ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration>> IGnss::getExtensionGnssConfiguration_2_1()
// no default implementation for: ::android::hardware::Return<::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections>> IGnss::getExtensionMeasurementCorrections_1_1()
// no default implementation for: ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo>> IGnss::getExtensionGnssAntennaInfo()
...
::android::hardware::Return<void> IGnss::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::gnss::V2_1::IGnss::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IGnss::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){195,25,230,139,3,130,153,88,64,68,2,194,217,198,130,1,150,120,8,125,96,73,88,7,192,167,68,78,10,106,249,129} /* c319e68b03829958404402c2d9c682019678087d60495807c0a7444e0a6af981 */,
...
::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnss>> IGnss::castFrom(const ::android::sp<::android::hardware::gnss::V2_1::IGnss>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnss>> IGnss::castFrom(const ::android::sp<::android::hardware::gnss::V2_0::IGnss>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IGnss, ::android::hardware::gnss::V2_0::IGnss, BpHwGnss>(
            parent, "android.hardware.gnss@2.1::IGnss", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnss>> IGnss::castFrom(const ::android::sp<::android::hardware::gnss::V1_1::IGnss>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IGnss, ::android::hardware::gnss::V1_1::IGnss, BpHwGnss>(
            parent, "android.hardware.gnss@2.1::IGnss", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnss>> IGnss::castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnss>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IGnss, ::android::hardware::gnss::V1_0::IGnss, BpHwGnss>(
            parent, "android.hardware.gnss@2.1::IGnss", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnss>> IGnss::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwGnss::BpHwGnss(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IGnss>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@2.1", "IGnss") {
}
...
// Methods from ::android::hardware::gnss::V2_1::IGnss follow.
::android::hardware::Return<bool> BpHwGnss::_hidl_setCallback_2_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::gnss::V2_1::IGnssCallback>& callback) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IGnss::setCallback_2_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "setCallback_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(34 /* setCallback_2_1 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "2.1", "IGnss", "setCallback_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>> BpHwGnss::_hidl_getExtensionGnssMeasurement_2_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssMeasurement_2_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssMeasurement_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement> _hidl_out_gnssMeasurementIface;

    _hidl_err = _hidl_data.writeInterfaceToken(BpHwGnss::descriptor);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(35 /* getExtensionGnssMeasurement_2_1 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
...

    {
        ...
        _hidl_out_gnssMeasurementIface = ::android::hardware::fromBinder<::android::hardware::gnss::V2_1::IGnssMeasurement,::android::hardware::gnss::V2_1::BpHwGnssMeasurement,::android::hardware::gnss::V2_1::BnHwGnssMeasurement>(_hidl_binder);
    }
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssMeasurement_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    return ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>>(_hidl_out_gnssMeasurementIface);

_hidl_error:
    _hidl_status.setFromStatusT(_hidl_err);
    return ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>>(_hidl_status);
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration>> BpHwGnss::_hidl_getExtensionGnssConfiguration_2_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssConfiguration_2_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssConfiguration_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration> _hidl_out_gnssConfigurationIface;

    _hidl_err = _hidl_data.writeInterfaceToken(BpHwGnss::descriptor);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(36 /* getExtensionGnssConfiguration_2_1 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
...

    {
        ...
        _hidl_out_gnssConfigurationIface = ::android::hardware::fromBinder<::android::hardware::gnss::V2_1::IGnssConfiguration,::android::hardware::gnss::V2_1::BpHwGnssConfiguration,::android::hardware::gnss::V2_1::BnHwGnssConfiguration>(_hidl_binder);
    }
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssConfiguration_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    return ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration>>(_hidl_out_gnssConfigurationIface);

_hidl_error:
    _hidl_status.setFromStatusT(_hidl_err);
    return ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration>>(_hidl_status);
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections>> BpHwGnss::_hidl_getExtensionMeasurementCorrections_1_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionMeasurementCorrections_1_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionMeasurementCorrections_1_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections> _hidl_out_measurementCorrectionsIface;

    _hidl_err = _hidl_data.writeInterfaceToken(BpHwGnss::descriptor);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(37 /* getExtensionMeasurementCorrections_1_1 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
...

    {
        ...
        _hidl_out_measurementCorrectionsIface = ::android::hardware::fromBinder<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections,::android::hardware::gnss::measurement_corrections::V1_1::BpHwMeasurementCorrections,::android::hardware::gnss::measurement_corrections::V1_1::BnHwMeasurementCorrections>(_hidl_binder);
    }
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionMeasurementCorrections_1_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    return ::android::hardware::Return<::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections>>(_hidl_out_measurementCorrectionsIface);

_hidl_error:
    _hidl_status.setFromStatusT(_hidl_err);
    return ::android::hardware::Return<::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections>>(_hidl_status);
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo>> BpHwGnss::_hidl_getExtensionGnssAntennaInfo(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssAntennaInfo::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssAntennaInfo", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo> _hidl_out_gnssAntennaInfoIface;

    _hidl_err = _hidl_data.writeInterfaceToken(BpHwGnss::descriptor);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(38 /* getExtensionGnssAntennaInfo */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
...

    {
        ...
        _hidl_out_gnssAntennaInfoIface = ::android::hardware::fromBinder<::android::hardware::gnss::V2_1::IGnssAntennaInfo,::android::hardware::gnss::V2_1::BpHwGnssAntennaInfo,::android::hardware::gnss::V2_1::BnHwGnssAntennaInfo>(_hidl_binder);
    }

    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&_hidl_out_gnssAntennaInfoIface);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssAntennaInfo", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    return ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo>>(_hidl_out_gnssAntennaInfoIface);

_hidl_error:
    _hidl_status.setFromStatusT(_hidl_err);
    return ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo>>(_hidl_status);
}
...
// Methods from ::android::hardware::gnss::V2_1::IGnss follow.
::android::hardware::Return<bool> BpHwGnss::setCallback_2_1(const ::android::sp<::android::hardware::gnss::V2_1::IGnssCallback>& callback){
    ::android::hardware::Return<bool>  _hidl_out = ::android::hardware::gnss::V2_1::BpHwGnss::_hidl_setCallback_2_1(this, this, callback);

    return _hidl_out;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>> BpHwGnss::getExtensionGnssMeasurement_2_1(){
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement>>  _hidl_out = ::android::hardware::gnss::V2_1::BpHwGnss::_hidl_getExtensionGnssMeasurement_2_1(this, this);

    return _hidl_out;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration>> BpHwGnss::getExtensionGnssConfiguration_2_1(){
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration>>  _hidl_out = ::android::hardware::gnss::V2_1::BpHwGnss::_hidl_getExtensionGnssConfiguration_2_1(this, this);

    return _hidl_out;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections>> BpHwGnss::getExtensionMeasurementCorrections_1_1(){
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections>>  _hidl_out = ::android::hardware::gnss::V2_1::BpHwGnss::_hidl_getExtensionMeasurementCorrections_1_1(this, this);

    return _hidl_out;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo>> BpHwGnss::getExtensionGnssAntennaInfo(){
    ::android::hardware::Return<::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo>>  _hidl_out = ::android::hardware::gnss::V2_1::BpHwGnss::_hidl_getExtensionGnssAntennaInfo(this, this);
...
BnHwGnss::BnHwGnss(const ::android::sp<IGnss> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.gnss@2.1", "IGnss") { 
...
// Methods from ::android::hardware::gnss::V2_1::IGnss follow.
::android::status_t BnHwGnss::_hidl_setCallback_2_1(
    ...
    ::android::sp<::android::hardware::gnss::V2_1::IGnssCallback> callback;

    {
        ...
        callback = ::android::hardware::fromBinder<::android::hardware::gnss::V2_1::IGnssCallback,::android::hardware::gnss::V2_1::BpHwGnssCallback,::android::hardware::gnss::V2_1::BnHwGnssCallback>(_hidl_binder);
    }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::setCallback_2_1::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "setCallback_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    bool _hidl_out_success = static_cast<IGnss*>(_hidl_this->getImpl().get())->setCallback_2_1(callback);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_success);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "2.1", "IGnss", "setCallback_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwGnss::_hidl_getExtensionGnssMeasurement_2_1(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssMeasurement_2_1::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssMeasurement_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::sp<::android::hardware::gnss::V2_1::IGnssMeasurement> _hidl_out_gnssMeasurementIface = static_cast<IGnss*>(_hidl_this->getImpl().get())->getExtensionGnssMeasurement_2_1();
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_gnssMeasurementIface);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssMeasurement_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwGnss::_hidl_getExtensionGnssConfiguration_2_1(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssConfiguration_2_1::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssConfiguration_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::sp<::android::hardware::gnss::V2_1::IGnssConfiguration> _hidl_out_gnssConfigurationIface = static_cast<IGnss*>(_hidl_this->getImpl().get())->getExtensionGnssConfiguration_2_1();
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_gnssConfigurationIface);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssConfiguration_2_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwGnss::_hidl_getExtensionMeasurementCorrections_1_1(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionMeasurementCorrections_1_1::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionMeasurementCorrections_1_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::sp<::android::hardware::gnss::measurement_corrections::V1_1::IMeasurementCorrections> _hidl_out_measurementCorrectionsIface = static_cast<IGnss*>(_hidl_this->getImpl().get())->getExtensionMeasurementCorrections_1_1();
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_measurementCorrectionsIface);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionMeasurementCorrections_1_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwGnss::_hidl_getExtensionGnssAntennaInfo(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnss::getExtensionGnssAntennaInfo::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssAntennaInfo", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::sp<::android::hardware::gnss::V2_1::IGnssAntennaInfo> _hidl_out_gnssAntennaInfoIface = static_cast<IGnss*>(_hidl_this->getImpl().get())->getExtensionGnssAntennaInfo();

    ::android::hardware::writeToParcel(::android::hardware::Status::ok(), _hidl_reply);

    if (_hidl_out_gnssAntennaInfoIface == nullptr) {
        _hidl_err = _hidl_reply->writeStrongBinder(nullptr);
    } else {
        ::android::sp<::android::hardware::IBinder> _hidl_binder = ::android::hardware::getOrCreateCachedBinder(_hidl_out_gnssAntennaInfoIface.get());
        if (_hidl_binder.get() != nullptr) {
            _hidl_err = _hidl_reply->writeStrongBinder(_hidl_binder);
        } else {
            _hidl_err = ::android::UNKNOWN_ERROR;
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_gnssAntennaInfoIface);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "2.1", "IGnss", "getExtensionGnssAntennaInfo", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwGnss::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::gnss::V2_1::BnHwGnss::_hidl_setCallback_2_1(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 35 /* getExtensionGnssMeasurement_2_1 */:
        {
            _hidl_err = ::android::hardware::gnss::V2_1::BnHwGnss::_hidl_getExtensionGnssMeasurement_2_1(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 36 /* getExtensionGnssConfiguration_2_1 */:
        {
            _hidl_err = ::android::hardware::gnss::V2_1::BnHwGnss::_hidl_getExtensionGnssConfiguration_2_1(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 37 /* getExtensionMeasurementCorrections_1_1 */:
        {
            _hidl_err = ::android::hardware::gnss::V2_1::BnHwGnss::_hidl_getExtensionMeasurementCorrections_1_1(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 38 /* getExtensionGnssAntennaInfo */:
        {
            _hidl_err = ::android::hardware::gnss::V2_1::BnHwGnss::_hidl_getExtensionGnssAntennaInfo(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsGnss::BsGnss(const ::android::sp<::android::hardware::gnss::V2_1::IGnss> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@2.1", "IGnss"), mImpl(impl) {
...
bool IGnss::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.gnss@2.1::IGnss",
