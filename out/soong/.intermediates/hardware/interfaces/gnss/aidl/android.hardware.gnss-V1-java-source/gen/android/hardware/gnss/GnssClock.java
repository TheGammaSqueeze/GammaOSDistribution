...
public class GnssClock implements android.os.Parcelable
{
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    if ((referenceSignalTypeForIsb!=null)) {
      _aidl_parcel.writeInt(1);
      referenceSignalTypeForIsb.writeToParcel(_aidl_parcel, 0);
    }
    else {
      _aidl_parcel.writeInt(0);
    }
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if ((0!=_aidl_parcel.readInt())) {
        referenceSignalTypeForIsb = android.hardware.gnss.GnssSignalType.CREATOR.createFromParcel(_aidl_parcel);
      }
      else {
        referenceSignalTypeForIsb = null;
      }
    } finally {
