...
public class GnssMeasurement implements android.os.Parcelable
{
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    if ((signalType!=null)) {
      ...
      signalType.writeToParcel(_aidl_parcel, 0);
    }
    else {
      _aidl_parcel.writeInt(0);
    }
    ...
    if ((satellitePvt!=null)) {
      _aidl_parcel.writeInt(1);
      satellitePvt.writeToParcel(_aidl_parcel, 0);
    }
    else {
      _aidl_parcel.writeInt(0);
    }
    _aidl_parcel.writeTypedArray(correlationVectors, 0);
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if ((0!=_aidl_parcel.readInt())) {
        signalType = android.hardware.gnss.GnssSignalType.CREATOR.createFromParcel(_aidl_parcel);
      }
      else {
        signalType = null;
      }
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      if ((0!=_aidl_parcel.readInt())) {
        satellitePvt = android.hardware.gnss.SatellitePvt.CREATOR.createFromParcel(_aidl_parcel);
      }
      else {
        satellitePvt = null;
      }
