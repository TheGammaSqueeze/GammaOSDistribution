...
public interface IGnssPowerIndication extends android.os.IInterface
{
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.gnss.IGnssPowerIndication
  {
    ...
    private static class Proxy implements android.hardware.gnss.IGnssPowerIndication
    {
      ...
      @Override public void requestGnssPowerStats() throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status) {
            if (getDefaultImpl() != null) {
              getDefaultImpl().requestGnssPowerStats();
              return;
            }
            else {
      ...
      public static android.hardware.gnss.IGnssPowerIndication sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(android.hardware.gnss.IGnssPowerIndication impl) {
    ...
    public static android.hardware.gnss.IGnssPowerIndication getDefaultImpl() {
