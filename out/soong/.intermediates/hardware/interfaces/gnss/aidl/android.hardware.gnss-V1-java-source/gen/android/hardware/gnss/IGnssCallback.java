...
public interface IGnssCallback extends android.os.IInterface
{
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.gnss.IGnssCallback
  {
    ...
    private static class Proxy implements android.hardware.gnss.IGnssCallback
    {
        ...
        try {
          ...
          if (!_status) {
            if (getDefaultImpl() != null) {
              getDefaultImpl().gnssSetCapabilitiesCb(capabilities);
              return;
            }
            else {
      ...
      public static android.hardware.gnss.IGnssCallback sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(android.hardware.gnss.IGnssCallback impl) {
    ...
    public static android.hardware.gnss.IGnssCallback getDefaultImpl() {
