...
public interface IGnssCallback extends android.hardware.gnss.V1_0.IGnssCallback {
    ...
    public static IGnssCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IGnssCallback.asInterface(android.os.HwBinder.getService("android.hardware.gnss@1.1::IGnssCallback", serviceName, retry));
    }
    ...
    public static IGnssCallback getService(String serviceName) throws android.os.RemoteException {
        return IGnssCallback.asInterface(android.os.HwBinder.getService("android.hardware.gnss@1.1::IGnssCallback", serviceName));
    }
     ...
     */
    void gnssRequestLocationCb(boolean independentFromGnss)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements IGnssCallback {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.gnss.V1_1.IGnssCallback.kInterfaceName;
