...
public interface IGnssConfiguration extends android.hardware.gnss.V1_0.IGnssConfiguration {
    ...
    public static IGnssConfiguration getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IGnssConfiguration.asInterface(android.os.HwBinder.getService("android.hardware.gnss@1.1::IGnssConfiguration", serviceName, retry));
    }
    ...
    public static IGnssConfiguration getService(String serviceName) throws android.os.RemoteException {
        return IGnssConfiguration.asInterface(android.os.HwBinder.getService("android.hardware.gnss@1.1::IGnssConfiguration", serviceName));
    }
    ...
    public final static class BlacklistedSource {
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (otherObject.getClass() != android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource.class) {
                return false;
            }
            android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource other = (android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource)otherObject;
        ...
        public static final java.util.ArrayList<BlacklistedSource> readVectorFromParcel(android.os.HwParcel parcel) {
...

            {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource _hidl_vec_element = new android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource();
                    ((android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 4);
     ...
     */
    boolean setBlacklist(java.util.ArrayList<android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource> blacklist)
    ...
    public static abstract class Stub extends android.os.HwBinder implements IGnssConfiguration {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.gnss.V1_1.IGnssConfiguration.kInterfaceName;
