...
public interface IGnssMeasurement extends android.hardware.gnss.V1_0.IGnssMeasurement {
    ...
    public static IGnssMeasurement getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IGnssMeasurement.asInterface(android.os.HwBinder.getService("android.hardware.gnss@1.1::IGnssMeasurement", serviceName, retry));
    }
    ...
    public static IGnssMeasurement getService(String serviceName) throws android.os.RemoteException {
        return IGnssMeasurement.asInterface(android.os.HwBinder.getService("android.hardware.gnss@1.1::IGnssMeasurement", serviceName));
    }
     ...
     *     error code.
     */
    int setCallback_1_1(android.hardware.gnss.V1_1.IGnssMeasurementCallback callback, boolean enableFullTracking)
