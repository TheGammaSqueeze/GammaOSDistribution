#define LOG_TAG "android.hardware.gnss@1.1::GnssMeasurementCallback"
...
#include <android/hardware/gnss/1.1/BsGnssMeasurementCallback.h>
...
::android::status_t readEmbeddedFromParcel(
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::gnss::V1_1::IGnssMeasurementCallback::GnssMeasurement> &>(obj.measurements),
            parcel,
            parentHandle,
            parentOffset + offsetof(::android::hardware::gnss::V1_1::IGnssMeasurementCallback::GnssData, measurements), &_hidl_measurements_child);
...
const char* IGnssMeasurementCallback::descriptor("android.hardware.gnss@1.1::IGnssMeasurementCallback");
...
::android::hardware::Return<void> IGnssMeasurementCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::gnss::V1_1::IGnssMeasurementCallback::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurementCallback>> IGnssMeasurementCallback::castFrom(const ::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurementCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurementCallback>> IGnssMeasurementCallback::castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnssMeasurementCallback>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IGnssMeasurementCallback, ::android::hardware::gnss::V1_0::IGnssMeasurementCallback, BpHwGnssMeasurementCallback>(
            parent, "android.hardware.gnss@1.1::IGnssMeasurementCallback", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurementCallback>> IGnssMeasurementCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwGnssMeasurementCallback::BpHwGnssMeasurementCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IGnssMeasurementCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@1.1", "IGnssMeasurementCallback") {
}
...
// Methods from ::android::hardware::gnss::V1_1::IGnssMeasurementCallback follow.
::android::hardware::Return<void> BpHwGnssMeasurementCallback::_hidl_gnssMeasurementCb(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::gnss::V1_1::IGnssMeasurementCallback::GnssData& data) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "1.1", "IGnssMeasurementCallback", "gnssMeasurementCb", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* gnssMeasurementCb */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "1.1", "IGnssMeasurementCallback", "gnssMeasurementCb", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwGnssMeasurementCallback::BnHwGnssMeasurementCallback(const ::android::sp<IGnssMeasurementCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.gnss@1.1", "IGnssMeasurementCallback") { 
...
::android::status_t BnHwGnssMeasurementCallback::_hidl_gnssMeasurementCb(
    ...
    ::android::hardware::gnss::V1_1::IGnssMeasurementCallback::GnssData* data;
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::gnss::V1_1::IGnssMeasurementCallback::GnssData &>(*data),
            _hidl_data,
            _hidl_data_parent,
            0 /* parentOffset */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)data);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "1.1", "IGnssMeasurementCallback", "gnssMeasurementCb", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "1.1", "IGnssMeasurementCallback", "gnssMeasurementCb", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsGnssMeasurementCallback::BsGnssMeasurementCallback(const ::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurementCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@1.1", "IGnssMeasurementCallback"), mImpl(impl) {
...
bool IGnssMeasurementCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.gnss@1.1::IGnssMeasurementCallback",
