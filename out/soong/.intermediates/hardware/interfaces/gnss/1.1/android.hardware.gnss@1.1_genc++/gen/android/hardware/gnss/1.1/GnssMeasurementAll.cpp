#define LOG_TAG "android.hardware.gnss@1.1::GnssMeasurement"
...
#include <android/hardware/gnss/1.1/BnHwGnssMeasurement.h>
#include <android/hardware/gnss/1.1/BsGnssMeasurement.h>
...
const char* IGnssMeasurement::descriptor("android.hardware.gnss@1.1::IGnssMeasurement");
...
::android::hardware::Return<void> IGnssMeasurement::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::gnss::V1_1::IGnssMeasurement::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurement>> IGnssMeasurement::castFrom(const ::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurement>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurement>> IGnssMeasurement::castFrom(const ::android::sp<::android::hardware::gnss::V1_0::IGnssMeasurement>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IGnssMeasurement, ::android::hardware::gnss::V1_0::IGnssMeasurement, BpHwGnssMeasurement>(
            parent, "android.hardware.gnss@1.1::IGnssMeasurement", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurement>> IGnssMeasurement::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwGnssMeasurement::BpHwGnssMeasurement(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IGnssMeasurement>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@1.1", "IGnssMeasurement") {
}
...
// Methods from ::android::hardware::gnss::V1_1::IGnssMeasurement follow.
::android::hardware::Return<::android::hardware::gnss::V1_0::IGnssMeasurement::GnssMeasurementStatus> BpHwGnssMeasurement::_hidl_setCallback_1_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurementCallback>& callback, bool enableFullTracking) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IGnssMeasurement::setCallback_1_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.gnss", "1.1", "IGnssMeasurement", "setCallback_1_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(3 /* setCallback_1_1 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.gnss", "1.1", "IGnssMeasurement", "setCallback_1_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwGnssMeasurement::BnHwGnssMeasurement(const ::android::sp<IGnssMeasurement> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.gnss@1.1", "IGnssMeasurement") { 
...
// Methods from ::android::hardware::gnss::V1_1::IGnssMeasurement follow.
::android::status_t BnHwGnssMeasurement::_hidl_setCallback_1_1(
    ...
    ::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurementCallback> callback;
...

    {
        ...
        callback = ::android::hardware::fromBinder<::android::hardware::gnss::V1_1::IGnssMeasurementCallback,::android::hardware::gnss::V1_1::BpHwGnssMeasurementCallback,::android::hardware::gnss::V1_1::BnHwGnssMeasurementCallback>(_hidl_binder);
    }

    _hidl_err = _hidl_data.readBool(&enableFullTracking);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IGnssMeasurement::setCallback_1_1::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&callback);
        _hidl_args.push_back((void *)&enableFullTracking);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.gnss", "1.1", "IGnssMeasurement", "setCallback_1_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::gnss::V1_0::IGnssMeasurement::GnssMeasurementStatus _hidl_out_initRet = static_cast<IGnssMeasurement*>(_hidl_this->getImpl().get())->setCallback_1_1(callback, enableFullTracking);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_initRet);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.gnss", "1.1", "IGnssMeasurement", "setCallback_1_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsGnssMeasurement::BsGnssMeasurement(const ::android::sp<::android::hardware::gnss::V1_1::IGnssMeasurement> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.gnss@1.1", "IGnssMeasurement"), mImpl(impl) {
...
bool IGnssMeasurement::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.gnss@1.1::IGnssMeasurement",
