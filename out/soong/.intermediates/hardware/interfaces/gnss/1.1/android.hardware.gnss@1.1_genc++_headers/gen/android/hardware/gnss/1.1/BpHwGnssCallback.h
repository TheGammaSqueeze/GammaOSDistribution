#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BPHWGNSSCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BPHWGNSSCALLBACK_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/gnss/1.1/IHwGnssCallback.h>
...
struct BpHwGnssCallback : public ::android::hardware::BpInterface<IGnssCallback>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_gnssNameCb(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& name);
    static ::android::hardware::Return<void>  _hidl_gnssRequestLocationCb(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, bool independentFromGnss);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GNSS_V1_1_BPHWGNSSCALLBACK_H
