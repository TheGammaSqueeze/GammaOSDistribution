#ifndef HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_ICOMPONENTSTORE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_ICOMPONENTSTORE_H
 ...
 */
struct IComponentStore : public ::android::hardware::media::c2::V1_1::IComponentStore {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.media.c2@1.2::IComponentStore"
     */
    ...
    /**
     * Return callback for createComponent_1_2
     */
    using createComponent_1_2_cb = std::function<void(::android::hardware::media::c2::V1_0::Status status, const ::android::sp<::android::hardware::media::c2::V1_2::IComponent>& comp)>;
    /**
     * Creates a component by name.
     *
     * @param name Name of the component to create. This must match one of the
     ...
     * @sa IComponentListener.
     */
    virtual ::android::hardware::Return<void> createComponent_1_2(const ::android::hardware::hidl_string& name, const ::android::sp<::android::hardware::media::c2::V1_0::IComponentListener>& listener, const ::android::sp<::android::hardware::media::bufferpool::V2_0::IClientManager>& pool, createComponent_1_2_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_2::IComponentStore>> castFrom(const ::android::sp<::android::hardware::media::c2::V1_2::IComponentStore>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_2::IComponentStore>> castFrom(const ::android::sp<::android::hardware::media::c2::V1_1::IComponentStore>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_2::IComponentStore>> castFrom(const ::android::sp<::android::hardware::media::c2::V1_0::IComponentStore>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_2::IComponentStore>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::media::c2::V1_2::IComponentStore>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::media::c2::V1_2::IComponentStore>& o) {
    ...
    os += ::android::hardware::media::c2::V1_2::IComponentStore::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_ICOMPONENTSTORE_H
