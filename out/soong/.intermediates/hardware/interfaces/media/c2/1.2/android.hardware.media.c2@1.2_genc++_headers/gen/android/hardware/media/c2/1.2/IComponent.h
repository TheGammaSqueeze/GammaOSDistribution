#ifndef HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_ICOMPONENT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_ICOMPONENT_H
 ...
 */
struct IComponent : public ::android::hardware::media::c2::V1_1::IComponent {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.media.c2@1.2::IComponent"
     */
    ...
    /**
     * Return callback for configureVideoTunnel
     */
    using configureVideoTunnel_cb = std::function<void(::android::hardware::media::c2::V1_0::Status status, const ::android::hardware::hidl_handle& sidebandHandle)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> configureVideoTunnel(uint32_t avSyncHwId, configureVideoTunnel_cb _hidl_cb) = 0;
     ...
     *   - `CORRUPTED` - Some unknown error occurred.
     */
    virtual ::android::hardware::Return<::android::hardware::media::c2::V1_0::Status> setOutputSurfaceWithSyncObj(uint64_t blockPoolId, const ::android::sp<::android::hardware::graphics::bufferqueue::V2_0::IGraphicBufferProducer>& surface, const ::android::hardware::media::c2::V1_2::SurfaceSyncObj& syncObject) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_2::IComponent>> castFrom(const ::android::sp<::android::hardware::media::c2::V1_2::IComponent>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_2::IComponent>> castFrom(const ::android::sp<::android::hardware::media::c2::V1_1::IComponent>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_2::IComponent>> castFrom(const ::android::sp<::android::hardware::media::c2::V1_0::IComponent>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_2::IComponent>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::media::c2::V1_2::IComponent>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::media::c2::V1_2::IComponent>& o) {
    ...
    os += ::android::hardware::media::c2::V1_2::IComponent::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_ICOMPONENT_H
