#ifndef HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_BSCOMPONENTSTORE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_BSCOMPONENTSTORE_H
...
struct BsComponentStore : IComponentStore, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> createComponent_1_2(const ::android::hardware::hidl_string& name, const ::android::sp<::android::hardware::media::c2::V1_0::IComponentListener>& listener, const ::android::sp<::android::hardware::media::bufferpool::V2_0::IClientManager>& pool, createComponent_1_2_cb _hidl_cb) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IComponentStore::createComponent_1_2::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&name);
            ...
            _hidl_args.push_back((void *)&pool);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.media.c2", "1.2", "IComponentStore", "createComponent_1_2", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->createComponent_1_2(name, _hidl_wrapped_listener, _hidl_wrapped_pool, [&](const auto &_hidl_out_status, const auto &_hidl_out_comp) {
            atrace_end(ATRACE_TAG_HAL);
            #ifdef __ANDROID_DEBUGGABLE__
            if (UNLIKELY(mEnableInstrumentation)) {
                std::vector<void *> _hidl_args;
                ...
                _hidl_args.push_back((void *)&_hidl_out_comp);
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.media.c2", "1.2", "IComponentStore", "createComponent_1_2", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__

            ::android::sp<::android::hardware::media::c2::V1_2::IComponent> _hidl_wrapped__hidl_out_comp;
            if (_hidl_out_comp != nullptr && !_hidl_out_comp->isRemote()) {
                _hidl_wrapped__hidl_out_comp = ::android::hardware::details::wrapPassthrough(_hidl_out_comp);
                if (_hidl_wrapped__hidl_out_comp == nullptr) {
                    _hidl_error = ::android::hardware::Status::fromExceptionCode(
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_BSCOMPONENTSTORE_H
