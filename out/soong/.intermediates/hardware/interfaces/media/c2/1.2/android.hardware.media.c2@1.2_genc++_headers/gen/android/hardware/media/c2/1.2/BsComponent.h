#ifndef HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_BSCOMPONENT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_BSCOMPONENT_H
...
struct BsComponent : IComponent, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<::android::hardware::media::c2::V1_0::Status> setOutputSurfaceWithSyncObj(uint64_t blockPoolId, const ::android::sp<::android::hardware::graphics::bufferqueue::V2_0::IGraphicBufferProducer>& surface, const ::android::hardware::media::c2::V1_2::SurfaceSyncObj& syncObject) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IComponent::setOutputSurfaceWithSyncObj::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)&blockPoolId);
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.media.c2", "1.2", "IComponent", "setOutputSurfaceWithSyncObj", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        ::android::hardware::Status _hidl_error = ::android::hardware::Status::ok();
        auto _hidl_return = mImpl->setOutputSurfaceWithSyncObj(blockPoolId, _hidl_wrapped_surface, syncObject);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_status);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.media.c2", "1.2", "IComponent", "setOutputSurfaceWithSyncObj", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_MEDIA_C2_V1_2_BSCOMPONENT_H
