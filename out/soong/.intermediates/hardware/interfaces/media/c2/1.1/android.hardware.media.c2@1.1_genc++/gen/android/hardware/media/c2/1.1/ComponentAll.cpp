#define LOG_TAG "android.hardware.media.c2@1.1::Component"
...
#include <android/hardware/media/c2/1.1/BnHwComponent.h>
#include <android/hardware/media/c2/1.1/BsComponent.h>
...
const char* IComponent::descriptor("android.hardware.media.c2@1.1::IComponent");
...
::android::hardware::Return<void> IComponent::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::media::c2::V1_1::IComponent::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_1::IComponent>> IComponent::castFrom(const ::android::sp<::android::hardware::media::c2::V1_1::IComponent>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_1::IComponent>> IComponent::castFrom(const ::android::sp<::android::hardware::media::c2::V1_0::IComponent>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IComponent, ::android::hardware::media::c2::V1_0::IComponent, BpHwComponent>(
            parent, "android.hardware.media.c2@1.1::IComponent", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_1::IComponent>> IComponent::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwComponent::BpHwComponent(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IComponent>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.media.c2@1.1", "IComponent") {
}
...
// Methods from ::android::hardware::media::c2::V1_1::IComponent follow.
::android::hardware::Return<void> BpHwComponent::_hidl_configureVideoTunnel(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t avSyncHwId, configureVideoTunnel_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IComponent::configureVideoTunnel::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&avSyncHwId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.media.c2", "1.1", "IComponent", "configureVideoTunnel", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_err = _hidl_data.writeUint32(avSyncHwId);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(16 /* configureVideoTunnel */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.media.c2", "1.1", "IComponent", "configureVideoTunnel", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwComponent::BnHwComponent(const ::android::sp<IComponent> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.media.c2@1.1", "IComponent") { 
...
// Methods from ::android::hardware::media::c2::V1_1::IComponent follow.
::android::status_t BnHwComponent::_hidl_configureVideoTunnel(
    ...
    _hidl_err = _hidl_data.readUint32(&avSyncHwId);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IComponent::configureVideoTunnel::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&avSyncHwId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.media.c2", "1.1", "IComponent", "configureVideoTunnel", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IComponent*>(_hidl_this->getImpl().get())->configureVideoTunnel(avSyncHwId, [&](const auto &_hidl_out_status, const auto &_hidl_out_sidebandHandle) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("configureVideoTunnel: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_sidebandHandle);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.media.c2", "1.1", "IComponent", "configureVideoTunnel", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("configureVideoTunnel: _hidl_cb not called, but must be called once.");
    }
...
BsComponent::BsComponent(const ::android::sp<::android::hardware::media::c2::V1_1::IComponent> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.media.c2@1.1", "IComponent"), mImpl(impl) {
...
bool IComponent::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.media.c2@1.1::IComponent",
