#define LOG_TAG "android.hardware.media.c2@1.1::ComponentStore"
...
#include <android/hardware/media/c2/1.1/BnHwComponentStore.h>
#include <android/hardware/media/c2/1.1/BsComponentStore.h>
...
const char* IComponentStore::descriptor("android.hardware.media.c2@1.1::IComponentStore");
...
::android::hardware::Return<void> IComponentStore::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::media::c2::V1_1::IComponentStore::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_1::IComponentStore>> IComponentStore::castFrom(const ::android::sp<::android::hardware::media::c2::V1_1::IComponentStore>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_1::IComponentStore>> IComponentStore::castFrom(const ::android::sp<::android::hardware::media::c2::V1_0::IComponentStore>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IComponentStore, ::android::hardware::media::c2::V1_0::IComponentStore, BpHwComponentStore>(
            parent, "android.hardware.media.c2@1.1::IComponentStore", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::media::c2::V1_1::IComponentStore>> IComponentStore::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwComponentStore::BpHwComponentStore(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IComponentStore>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.media.c2@1.1", "IComponentStore") {
}
...
// Methods from ::android::hardware::media::c2::V1_1::IComponentStore follow.
::android::hardware::Return<void> BpHwComponentStore::_hidl_createComponent_1_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& name, const ::android::sp<::android::hardware::media::c2::V1_0::IComponentListener>& listener, const ::android::sp<::android::hardware::media::bufferpool::V2_0::IClientManager>& pool, createComponent_1_1_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IComponentStore::createComponent_1_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.media.c2", "1.1", "IComponentStore", "createComponent_1_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(9 /* createComponent_1_1 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::media::c2::V1_0::Status _hidl_out_status;
        ::android::sp<::android::hardware::media::c2::V1_1::IComponent> _hidl_out_comp;
...

        {
            ...
            _hidl_out_comp = ::android::hardware::fromBinder<::android::hardware::media::c2::V1_1::IComponent,::android::hardware::media::c2::V1_1::BpHwComponent,::android::hardware::media::c2::V1_1::BnHwComponent>(_hidl_binder);
        }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.media.c2", "1.1", "IComponentStore", "createComponent_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwComponentStore::BnHwComponentStore(const ::android::sp<IComponentStore> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.media.c2@1.1", "IComponentStore") { 
...
// Methods from ::android::hardware::media::c2::V1_1::IComponentStore follow.
::android::status_t BnHwComponentStore::_hidl_createComponent_1_1(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IComponentStore::createComponent_1_1::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)name);
        ...
        _hidl_args.push_back((void *)&pool);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.media.c2", "1.1", "IComponentStore", "createComponent_1_1", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IComponentStore*>(_hidl_this->getImpl().get())->createComponent_1_1(*name, listener, pool, [&](const auto &_hidl_out_status, const auto &_hidl_out_comp) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("createComponent_1_1: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_comp);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.media.c2", "1.1", "IComponentStore", "createComponent_1_1", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("createComponent_1_1: _hidl_cb not called, but must be called once.");
    }
...
BsComponentStore::BsComponentStore(const ::android::sp<::android::hardware::media::c2::V1_1::IComponentStore> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.media.c2@1.1", "IComponentStore"), mImpl(impl) {
...
bool IComponentStore::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.media.c2@1.1::IComponentStore",
