#ifndef HIDL_GENERATED_ANDROID_HARDWARE_NFC_V1_1_BPHWNFC_H
#define HIDL_GENERATED_ANDROID_HARDWARE_NFC_V1_1_BPHWNFC_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/nfc/1.1/IHwNfc.h>
...
struct BpHwNfc : public ::android::hardware::BpInterface<INfc>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_factoryReset(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::hardware::nfc::V1_0::NfcStatus>  _hidl_closeForPowerOffCase(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::hardware::nfc::V1_0::NfcStatus>  _hidl_open_1_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::nfc::V1_1::INfcClientCallback>& clientCallback);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_NFC_V1_1_BPHWNFC_H
