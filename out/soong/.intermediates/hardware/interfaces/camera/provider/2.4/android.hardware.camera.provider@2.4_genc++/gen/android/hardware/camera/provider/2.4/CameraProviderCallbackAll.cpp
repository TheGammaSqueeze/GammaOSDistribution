#define LOG_TAG "android.hardware.camera.provider@2.4::CameraProviderCallback"
...
#include <android/hardware/camera/provider/2.4/BnHwCameraProviderCallback.h>
#include <android/hardware/camera/provider/2.4/BsCameraProviderCallback.h>
...
const char* ICameraProviderCallback::descriptor("android.hardware.camera.provider@2.4::ICameraProviderCallback");
...
::android::hardware::Return<void> ICameraProviderCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::camera::provider::V2_4::ICameraProviderCallback::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_4::ICameraProviderCallback>> ICameraProviderCallback::castFrom(const ::android::sp<::android::hardware::camera::provider::V2_4::ICameraProviderCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_4::ICameraProviderCallback>> ICameraProviderCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraProviderCallback, ::android::hidl::base::V1_0::IBase, BpHwCameraProviderCallback>(
            parent, "android.hardware.camera.provider@2.4::ICameraProviderCallback", emitError);
}
...
BpHwCameraProviderCallback::BpHwCameraProviderCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICameraProviderCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.camera.provider@2.4", "ICameraProviderCallback") {
}
...
// Methods from ::android::hardware::camera::provider::V2_4::ICameraProviderCallback follow.
::android::hardware::Return<void> BpHwCameraProviderCallback::_hidl_cameraDeviceStatusChange(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& cameraDeviceName, ::android::hardware::camera::common::V1_0::CameraDeviceStatus newStatus) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraProviderCallback::cameraDeviceStatusChange::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.provider", "2.4", "ICameraProviderCallback", "cameraDeviceStatusChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* cameraDeviceStatusChange */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.provider", "2.4", "ICameraProviderCallback", "cameraDeviceStatusChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwCameraProviderCallback::_hidl_torchModeStatusChange(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& cameraDeviceName, ::android::hardware::camera::common::V1_0::TorchModeStatus newStatus) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraProviderCallback::torchModeStatusChange::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&cameraDeviceName);
        _hidl_args.push_back((void *)&newStatus);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.provider", "2.4", "ICameraProviderCallback", "torchModeStatusChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* torchModeStatusChange */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.provider", "2.4", "ICameraProviderCallback", "torchModeStatusChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwCameraProviderCallback::BnHwCameraProviderCallback(const ::android::sp<ICameraProviderCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.camera.provider@2.4", "ICameraProviderCallback") { 
...
// Methods from ::android::hardware::camera::provider::V2_4::ICameraProviderCallback follow.
::android::status_t BnHwCameraProviderCallback::_hidl_cameraDeviceStatusChange(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraProviderCallback::cameraDeviceStatusChange::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)cameraDeviceName);
        _hidl_args.push_back((void *)&newStatus);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.provider", "2.4", "ICameraProviderCallback", "cameraDeviceStatusChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraProviderCallback*>(_hidl_this->getImpl().get())->cameraDeviceStatusChange(*cameraDeviceName, newStatus);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.provider", "2.4", "ICameraProviderCallback", "cameraDeviceStatusChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwCameraProviderCallback::_hidl_torchModeStatusChange(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraProviderCallback::torchModeStatusChange::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)cameraDeviceName);
        _hidl_args.push_back((void *)&newStatus);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.provider", "2.4", "ICameraProviderCallback", "torchModeStatusChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraProviderCallback*>(_hidl_this->getImpl().get())->torchModeStatusChange(*cameraDeviceName, newStatus);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.provider", "2.4", "ICameraProviderCallback", "torchModeStatusChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsCameraProviderCallback::BsCameraProviderCallback(const ::android::sp<::android::hardware::camera::provider::V2_4::ICameraProviderCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.camera.provider@2.4", "ICameraProviderCallback"), mImpl(impl) {
...
bool ICameraProviderCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.camera.provider@2.4::ICameraProviderCallback",
