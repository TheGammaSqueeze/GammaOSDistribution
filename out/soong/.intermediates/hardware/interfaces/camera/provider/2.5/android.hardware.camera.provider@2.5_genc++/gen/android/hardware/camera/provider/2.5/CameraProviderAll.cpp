#define LOG_TAG "android.hardware.camera.provider@2.5::CameraProvider"
...
#include <android/hardware/camera/provider/2.5/BnHwCameraProvider.h>
#include <android/hardware/camera/provider/2.5/BsCameraProvider.h>
...
const char* ICameraProvider::descriptor("android.hardware.camera.provider@2.5::ICameraProvider");
...
::android::hardware::Return<void> ICameraProvider::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::camera::provider::V2_5::ICameraProvider::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_5::ICameraProvider>> ICameraProvider::castFrom(const ::android::sp<::android::hardware::camera::provider::V2_5::ICameraProvider>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_5::ICameraProvider>> ICameraProvider::castFrom(const ::android::sp<::android::hardware::camera::provider::V2_4::ICameraProvider>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraProvider, ::android::hardware::camera::provider::V2_4::ICameraProvider, BpHwCameraProvider>(
            parent, "android.hardware.camera.provider@2.5::ICameraProvider", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_5::ICameraProvider>> ICameraProvider::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCameraProvider::BpHwCameraProvider(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICameraProvider>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.camera.provider@2.5", "ICameraProvider") {
}
...
// Methods from ::android::hardware::camera::provider::V2_5::ICameraProvider follow.
::android::hardware::Return<void> BpHwCameraProvider::_hidl_notifyDeviceStateChange(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::hidl_bitfield<::android::hardware::camera::provider::V2_5::DeviceState> newState) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraProvider::notifyDeviceStateChange::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&newState);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.provider", "2.5", "ICameraProvider", "notifyDeviceStateChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_err = _hidl_data.writeUint64((uint64_t)newState);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(7 /* notifyDeviceStateChange */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.provider", "2.5", "ICameraProvider", "notifyDeviceStateChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwCameraProvider::BnHwCameraProvider(const ::android::sp<ICameraProvider> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.camera.provider@2.5", "ICameraProvider") { 
...
// Methods from ::android::hardware::camera::provider::V2_5::ICameraProvider follow.
::android::status_t BnHwCameraProvider::_hidl_notifyDeviceStateChange(
    ...
    ::android::hardware::hidl_bitfield<::android::hardware::camera::provider::V2_5::DeviceState> newState;

    _hidl_err = _hidl_data.readUint64((uint64_t *)&newState);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraProvider::notifyDeviceStateChange::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&newState);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.provider", "2.5", "ICameraProvider", "notifyDeviceStateChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraProvider*>(_hidl_this->getImpl().get())->notifyDeviceStateChange(newState);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.provider", "2.5", "ICameraProvider", "notifyDeviceStateChange", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsCameraProvider::BsCameraProvider(const ::android::sp<::android::hardware::camera::provider::V2_5::ICameraProvider> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.camera.provider@2.5", "ICameraProvider"), mImpl(impl) {
...
bool ICameraProvider::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.camera.provider@2.5::ICameraProvider",
