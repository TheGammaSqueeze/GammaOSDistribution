#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_PROVIDER_V2_5_BPHWCAMERAPROVIDER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_PROVIDER_V2_5_BPHWCAMERAPROVIDER_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/camera/provider/2.5/IHwCameraProvider.h>
...
struct BpHwCameraProvider : public ::android::hardware::BpInterface<ICameraProvider>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_notifyDeviceStateChange(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::hidl_bitfield<::android::hardware::camera::provider::V2_5::DeviceState> newState);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_PROVIDER_V2_5_BPHWCAMERAPROVIDER_H
