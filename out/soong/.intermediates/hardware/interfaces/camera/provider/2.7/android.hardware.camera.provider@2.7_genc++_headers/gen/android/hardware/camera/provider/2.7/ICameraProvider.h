#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_PROVIDER_V2_7_ICAMERAPROVIDER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_PROVIDER_V2_7_ICAMERAPROVIDER_H
 ...
 */
struct ICameraProvider : public ::android::hardware::camera::provider::V2_6::ICameraProvider {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.camera.provider@2.7::ICameraProvider"
     */
    ...
    /**
     * Return callback for isConcurrentStreamCombinationSupported_2_7
     */
    using isConcurrentStreamCombinationSupported_2_7_cb = std::function<void(::android::hardware::camera::common::V1_0::Status status, bool queryStatus)>;
    /**
     ...
     *
     */
    virtual ::android::hardware::Return<void> isConcurrentStreamCombinationSupported_2_7(const ::android::hardware::hidl_vec<::android::hardware::camera::provider::V2_7::CameraIdAndStreamCombination>& configs, isConcurrentStreamCombinationSupported_2_7_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_7::ICameraProvider>> castFrom(const ::android::sp<::android::hardware::camera::provider::V2_7::ICameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_7::ICameraProvider>> castFrom(const ::android::sp<::android::hardware::camera::provider::V2_6::ICameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_7::ICameraProvider>> castFrom(const ::android::sp<::android::hardware::camera::provider::V2_5::ICameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_7::ICameraProvider>> castFrom(const ::android::sp<::android::hardware::camera::provider::V2_4::ICameraProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_7::ICameraProvider>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::camera::provider::V2_7::ICameraProvider>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::camera::provider::V2_7::ICameraProvider>& o) {
    ...
    os += ::android::hardware::camera::provider::V2_7::ICameraProvider::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_PROVIDER_V2_7_ICAMERAPROVIDER_H
