#define LOG_TAG "android.hardware.camera.provider@2.6::CameraProvider"
...
#include <android/hardware/camera/provider/2.6/BnHwCameraProvider.h>
#include <android/hardware/camera/provider/2.6/BsCameraProvider.h>
...
const char* ICameraProvider::descriptor("android.hardware.camera.provider@2.6::ICameraProvider");
...
::android::hardware::Return<void> ICameraProvider::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::camera::provider::V2_6::ICameraProvider::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_6::ICameraProvider>> ICameraProvider::castFrom(const ::android::sp<::android::hardware::camera::provider::V2_6::ICameraProvider>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_6::ICameraProvider>> ICameraProvider::castFrom(const ::android::sp<::android::hardware::camera::provider::V2_5::ICameraProvider>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraProvider, ::android::hardware::camera::provider::V2_5::ICameraProvider, BpHwCameraProvider>(
            parent, "android.hardware.camera.provider@2.6::ICameraProvider", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_6::ICameraProvider>> ICameraProvider::castFrom(const ::android::sp<::android::hardware::camera::provider::V2_4::ICameraProvider>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::camera::provider::V2_6::ICameraProvider>> ICameraProvider::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCameraProvider::BpHwCameraProvider(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICameraProvider>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.camera.provider@2.6", "ICameraProvider") {
}
...
// Methods from ::android::hardware::camera::provider::V2_6::ICameraProvider follow.
::android::hardware::Return<void> BpHwCameraProvider::_hidl_getConcurrentStreamingCameraIds(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getConcurrentStreamingCameraIds_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraProvider::getConcurrentStreamingCameraIds::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.provider", "2.6", "ICameraProvider", "getConcurrentStreamingCameraIds", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(8 /* getConcurrentStreamingCameraIds */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::camera::common::V1_0::Status _hidl_out_status;
        const ::android::hardware::hidl_vec<::android::hardware::hidl_vec<::android::hardware::hidl_string>>* _hidl_out_cameraIds;
        ...
        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::hidl_vec<::android::hardware::hidl_vec<::android::hardware::hidl_string>> &>(*_hidl_out_cameraIds),
                _hidl_reply,
        ...
        for (size_t _hidl_index_0 = 0; _hidl_index_0 < _hidl_out_cameraIds->size(); ++_hidl_index_0) {
            size_t _hidl__hidl_out_cameraIds_deref_indexed_child;

            _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                    const_cast<::android::hardware::hidl_vec<::android::hardware::hidl_string> &>((*_hidl_out_cameraIds)[_hidl_index_0]),
                    _hidl_reply,
                    _hidl__hidl_out_cameraIds_child,
                    _hidl_index_0 * sizeof(::android::hardware::hidl_vec<::android::hardware::hidl_string>), &_hidl__hidl_out_cameraIds_deref_indexed_child);

            if (_hidl_err != ::android::OK) { return; }

            for (size_t _hidl_index_1 = 0; _hidl_index_1 < (*_hidl_out_cameraIds)[_hidl_index_0].size(); ++_hidl_index_1) {
                _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                        const_cast<::android::hardware::hidl_string &>((*_hidl_out_cameraIds)[_hidl_index_0][_hidl_index_1]),
                        _hidl_reply,
                        _hidl__hidl_out_cameraIds_deref_indexed_child,
                        _hidl_index_1 * sizeof(::android::hardware::hidl_string));
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.provider", "2.6", "ICameraProvider", "getConcurrentStreamingCameraIds", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwCameraProvider::_hidl_isConcurrentStreamCombinationSupported(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::camera::provider::V2_6::CameraIdAndStreamCombination>& configs, isConcurrentStreamCombinationSupported_cb _hidl_cb) {
    ...
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraProvider::isConcurrentStreamCombinationSupported::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&configs);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.provider", "2.6", "ICameraProvider", "isConcurrentStreamCombinationSupported", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < configs.size(); ++_hidl_index_0) {
        _hidl_err = writeEmbeddedToParcel(
                ...
                &_hidl_data,
                _hidl_configs_child,
                _hidl_index_0 * sizeof(::android::hardware::camera::provider::V2_6::CameraIdAndStreamCombination));

        if (_hidl_err != ::android::OK) { goto _hidl_error; }

    }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(9 /* isConcurrentStreamCombinationSupported */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::camera::common::V1_0::Status _hidl_out_status;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.provider", "2.6", "ICameraProvider", "isConcurrentStreamCombinationSupported", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwCameraProvider::BnHwCameraProvider(const ::android::sp<ICameraProvider> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.camera.provider@2.6", "ICameraProvider") { 
...
// Methods from ::android::hardware::camera::provider::V2_6::ICameraProvider follow.
::android::status_t BnHwCameraProvider::_hidl_getConcurrentStreamingCameraIds(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraProvider::getConcurrentStreamingCameraIds::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.provider", "2.6", "ICameraProvider", "getConcurrentStreamingCameraIds", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraProvider*>(_hidl_this->getImpl().get())->getConcurrentStreamingCameraIds([&](const auto &_hidl_out_status, const auto &_hidl_out_cameraIds) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("getConcurrentStreamingCameraIds: _hidl_cb called a second time, but must be called once.");
        }
        ...
        for (size_t _hidl_index_0 = 0; _hidl_index_0 < _hidl_out_cameraIds.size(); ++_hidl_index_0) {
            size_t _hidl__hidl_out_cameraIds_indexed_child;

            _hidl_err = ::android::hardware::writeEmbeddedToParcel(
                    _hidl_out_cameraIds[_hidl_index_0],
                    _hidl_reply,
                    _hidl__hidl_out_cameraIds_child,
                    _hidl_index_0 * sizeof(::android::hardware::hidl_vec<::android::hardware::hidl_string>), &_hidl__hidl_out_cameraIds_indexed_child);

            if (_hidl_err != ::android::OK) { goto _hidl_error; }

            for (size_t _hidl_index_1 = 0; _hidl_index_1 < _hidl_out_cameraIds[_hidl_index_0].size(); ++_hidl_index_1) {
                _hidl_err = ::android::hardware::writeEmbeddedToParcel(
                        _hidl_out_cameraIds[_hidl_index_0][_hidl_index_1],
                        _hidl_reply,
                        _hidl__hidl_out_cameraIds_indexed_child,
                        _hidl_index_1 * sizeof(::android::hardware::hidl_string));
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_cameraIds);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.provider", "2.6", "ICameraProvider", "getConcurrentStreamingCameraIds", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("getConcurrentStreamingCameraIds: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwCameraProvider::_hidl_isConcurrentStreamCombinationSupported(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    const ::android::hardware::hidl_vec<::android::hardware::camera::provider::V2_6::CameraIdAndStreamCombination>* configs;
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::camera::provider::V2_6::CameraIdAndStreamCombination> &>(*configs),
            _hidl_data,
            _hidl_configs_parent,
            0 /* parentOffset */, &_hidl_configs_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < configs->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::camera::provider::V2_6::CameraIdAndStreamCombination &>((*configs)[_hidl_index_0]),
                _hidl_data,
                _hidl_configs_child,
                _hidl_index_0 * sizeof(::android::hardware::camera::provider::V2_6::CameraIdAndStreamCombination));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraProvider::isConcurrentStreamCombinationSupported::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)configs);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.provider", "2.6", "ICameraProvider", "isConcurrentStreamCombinationSupported", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraProvider*>(_hidl_this->getImpl().get())->isConcurrentStreamCombinationSupported(*configs, [&](const auto &_hidl_out_status, const auto &_hidl_out_queryStatus) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("isConcurrentStreamCombinationSupported: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_queryStatus);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.provider", "2.6", "ICameraProvider", "isConcurrentStreamCombinationSupported", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("isConcurrentStreamCombinationSupported: _hidl_cb not called, but must be called once.");
    }
...
BsCameraProvider::BsCameraProvider(const ::android::sp<::android::hardware::camera::provider::V2_6::ICameraProvider> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.camera.provider@2.6", "ICameraProvider"), mImpl(impl) {
...
bool ICameraProvider::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.camera.provider@2.6::ICameraProvider",
