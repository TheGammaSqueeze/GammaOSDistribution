#define LOG_TAG "android.hardware.camera.device@3.6::CameraDeviceSession"
...
#include <android/hardware/camera/device/3.6/BnHwCameraDeviceSession.h>
#include <android/hardware/camera/device/3.6/BsCameraDeviceSession.h>
...
const char* ICameraDeviceSession::descriptor("android.hardware.camera.device@3.6::ICameraDeviceSession");
...
::android::hardware::Return<void> ICameraDeviceSession::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::camera::device::V3_6::ICameraDeviceSession::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_6::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_6::ICameraDeviceSession>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_6::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDeviceSession>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraDeviceSession, ::android::hardware::camera::device::V3_5::ICameraDeviceSession, BpHwCameraDeviceSession>(
            parent, "android.hardware.camera.device@3.6::ICameraDeviceSession", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_6::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_6::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_3::ICameraDeviceSession>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_6::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDeviceSession>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_6::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCameraDeviceSession::BpHwCameraDeviceSession(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICameraDeviceSession>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.camera.device@3.6", "ICameraDeviceSession") {
}
...
// Methods from ::android::hardware::camera::device::V3_6::ICameraDeviceSession follow.
::android::hardware::Return<void> BpHwCameraDeviceSession::_hidl_configureStreams_3_6(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::camera::device::V3_5::StreamConfiguration& requestedConfiguration, configureStreams_3_6_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::configureStreams_3_6::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&requestedConfiguration);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.device", "3.6", "ICameraDeviceSession", "configureStreams_3_6", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(14 /* configureStreams_3_6 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.device", "3.6", "ICameraDeviceSession", "configureStreams_3_6", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwCameraDeviceSession::_hidl_switchToOffline(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<int32_t>& streamsToKeep, switchToOffline_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::switchToOffline::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&streamsToKeep);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.device", "3.6", "ICameraDeviceSession", "switchToOffline", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    size_t _hidl_streamsToKeep_parent;

    _hidl_err = _hidl_data.writeBuffer(&streamsToKeep, sizeof(streamsToKeep), &_hidl_streamsToKeep_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_streamsToKeep_child;

    _hidl_err = ::android::hardware::writeEmbeddedToParcel(
            streamsToKeep,
            &_hidl_data,
            _hidl_streamsToKeep_parent,
            0 /* parentOffset */, &_hidl_streamsToKeep_child);

    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(15 /* switchToOffline */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::camera::common::V1_0::Status _hidl_out_status;
        ::android::hardware::camera::device::V3_6::CameraOfflineSessionInfo* _hidl_out_offlineSessionInfo;
        ::android::sp<::android::hardware::camera::device::V3_6::ICameraOfflineSession> _hidl_out_offlineSession;
        ...
        size_t _hidl__hidl_out_offlineSessionInfo_parent;

        _hidl_err = _hidl_reply.readBuffer(sizeof(*_hidl_out_offlineSessionInfo), &_hidl__hidl_out_offlineSessionInfo_parent,  const_cast<const void**>(reinterpret_cast<void **>(&_hidl_out_offlineSessionInfo)));
        if (_hidl_err != ::android::OK) { return; }

        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::camera::device::V3_6::CameraOfflineSessionInfo &>(*_hidl_out_offlineSessionInfo),
                _hidl_reply,
                _hidl__hidl_out_offlineSessionInfo_parent,
                0 /* parentOffset */);
...

        {
            ...
            _hidl_out_offlineSession = ::android::hardware::fromBinder<::android::hardware::camera::device::V3_6::ICameraOfflineSession,::android::hardware::camera::device::V3_6::BpHwCameraOfflineSession,::android::hardware::camera::device::V3_6::BnHwCameraOfflineSession>(_hidl_binder);
        }

        _hidl_cb(_hidl_out_status, *_hidl_out_offlineSessionInfo, _hidl_out_offlineSession);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.device", "3.6", "ICameraDeviceSession", "switchToOffline", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwCameraDeviceSession::BnHwCameraDeviceSession(const ::android::sp<ICameraDeviceSession> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.camera.device@3.6", "ICameraDeviceSession") { 
...
// Methods from ::android::hardware::camera::device::V3_6::ICameraDeviceSession follow.
::android::status_t BnHwCameraDeviceSession::_hidl_configureStreams_3_6(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::configureStreams_3_6::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)requestedConfiguration);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.device", "3.6", "ICameraDeviceSession", "configureStreams_3_6", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraDeviceSession*>(_hidl_this->getImpl().get())->configureStreams_3_6(*requestedConfiguration, [&](const auto &_hidl_out_status, const auto &_hidl_out_halConfiguration) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("configureStreams_3_6: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_halConfiguration);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.device", "3.6", "ICameraDeviceSession", "configureStreams_3_6", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("configureStreams_3_6: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwCameraDeviceSession::_hidl_switchToOffline(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    const ::android::hardware::hidl_vec<int32_t>* streamsToKeep;

    size_t _hidl_streamsToKeep_parent;

    _hidl_err = _hidl_data.readBuffer(sizeof(*streamsToKeep), &_hidl_streamsToKeep_parent,  reinterpret_cast<const void **>(&streamsToKeep));
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<int32_t> &>(*streamsToKeep),
            _hidl_data,
            _hidl_streamsToKeep_parent,
            0 /* parentOffset */, &_hidl_streamsToKeep_child);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::switchToOffline::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)streamsToKeep);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.device", "3.6", "ICameraDeviceSession", "switchToOffline", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraDeviceSession*>(_hidl_this->getImpl().get())->switchToOffline(*streamsToKeep, [&](const auto &_hidl_out_status, const auto &_hidl_out_offlineSessionInfo, const auto &_hidl_out_offlineSession) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("switchToOffline: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;
        ...
        _hidl_err = _hidl_reply->writeBuffer(&_hidl_out_offlineSessionInfo, sizeof(_hidl_out_offlineSessionInfo), &_hidl__hidl_out_offlineSessionInfo_parent);
        if (_hidl_err != ::android::OK) { goto _hidl_error; }

        _hidl_err = writeEmbeddedToParcel(
                _hidl_out_offlineSessionInfo,
                _hidl_reply,
                _hidl__hidl_out_offlineSessionInfo_parent,
                0 /* parentOffset */);
        ...
        if (_hidl_out_offlineSession == nullptr) {
            _hidl_err = _hidl_reply->writeStrongBinder(nullptr);
        } else {
            ::android::sp<::android::hardware::IBinder> _hidl_binder = ::android::hardware::getOrCreateCachedBinder(_hidl_out_offlineSession.get());
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_offlineSession);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.device", "3.6", "ICameraDeviceSession", "switchToOffline", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("switchToOffline: _hidl_cb not called, but must be called once.");
    }
...
BsCameraDeviceSession::BsCameraDeviceSession(const ::android::sp<::android::hardware::camera::device::V3_6::ICameraDeviceSession> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.camera.device@3.6", "ICameraDeviceSession"), mImpl(impl) {
...
bool ICameraDeviceSession::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.camera.device@3.6::ICameraDeviceSession",
