#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_BNHWCAMERADEVICECALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_BNHWCAMERADEVICECALLBACK_H
...
struct BnHwCameraDeviceCallback : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_requestStreamBuffers(
    ...
    static ::android::status_t _hidl_returnStreamBuffers(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_BNHWCAMERADEVICECALLBACK_H
