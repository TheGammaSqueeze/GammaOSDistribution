#define LOG_TAG "android.hardware.camera.device@3.5::CameraDeviceSession"
...
#include <android/hardware/camera/device/3.5/BnHwCameraDeviceSession.h>
#include <android/hardware/camera/device/3.5/BsCameraDeviceSession.h>
...
const char* ICameraDeviceSession::descriptor("android.hardware.camera.device@3.5::ICameraDeviceSession");
...
::android::hardware::Return<void> ICameraDeviceSession::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::camera::device::V3_5::ICameraDeviceSession::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_5::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDeviceSession>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_5::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraDeviceSession, ::android::hardware::camera::device::V3_4::ICameraDeviceSession, BpHwCameraDeviceSession>(
            parent, "android.hardware.camera.device@3.5::ICameraDeviceSession", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_5::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_3::ICameraDeviceSession>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_5::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDeviceSession>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_5::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCameraDeviceSession::BpHwCameraDeviceSession(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICameraDeviceSession>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.camera.device@3.5", "ICameraDeviceSession") {
}
...
// Methods from ::android::hardware::camera::device::V3_5::ICameraDeviceSession follow.
::android::hardware::Return<void> BpHwCameraDeviceSession::_hidl_configureStreams_3_5(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::camera::device::V3_5::StreamConfiguration& requestedConfiguration, configureStreams_3_5_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::configureStreams_3_5::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&requestedConfiguration);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "configureStreams_3_5", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(11 /* configureStreams_3_5 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::camera::common::V1_0::Status _hidl_out_status;
        ::android::hardware::camera::device::V3_4::HalStreamConfiguration* _hidl_out_halConfiguration;
        ...
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::camera::device::V3_4::HalStreamConfiguration &>(*_hidl_out_halConfiguration),
                _hidl_reply,
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "configureStreams_3_5", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwCameraDeviceSession::_hidl_signalStreamFlush(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<int32_t>& streamIds, uint32_t streamConfigCounter) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::signalStreamFlush::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "signalStreamFlush", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    size_t _hidl_streamIds_parent;

    _hidl_err = _hidl_data.writeBuffer(&streamIds, sizeof(streamIds), &_hidl_streamIds_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_streamIds_child;

    _hidl_err = ::android::hardware::writeEmbeddedToParcel(
            streamIds,
            &_hidl_data,
            _hidl_streamIds_parent,
            0 /* parentOffset */, &_hidl_streamIds_child);

    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_err = _hidl_data.writeUint32(streamConfigCounter);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(12 /* signalStreamFlush */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "signalStreamFlush", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwCameraDeviceSession::_hidl_isReconfigurationRequired(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& oldSessionParams, const ::android::hardware::hidl_vec<uint8_t>& newSessionParams, isReconfigurationRequired_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::isReconfigurationRequired::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "isReconfigurationRequired", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    size_t _hidl_oldSessionParams_parent;

    _hidl_err = _hidl_data.writeBuffer(&oldSessionParams, sizeof(oldSessionParams), &_hidl_oldSessionParams_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_oldSessionParams_child;

    _hidl_err = ::android::hardware::writeEmbeddedToParcel(
            oldSessionParams,
            &_hidl_data,
            _hidl_oldSessionParams_parent,
            0 /* parentOffset */, &_hidl_oldSessionParams_child);

    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_newSessionParams_parent;

    _hidl_err = _hidl_data.writeBuffer(&newSessionParams, sizeof(newSessionParams), &_hidl_newSessionParams_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_newSessionParams_child;

    _hidl_err = ::android::hardware::writeEmbeddedToParcel(
            newSessionParams,
            &_hidl_data,
            _hidl_newSessionParams_parent,
            0 /* parentOffset */, &_hidl_newSessionParams_child);

    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(13 /* isReconfigurationRequired */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::camera::common::V1_0::Status _hidl_out_status;
        bool _hidl_out_reconfigurationNeeded;
        ...
        _hidl_err = _hidl_reply.readBool(&_hidl_out_reconfigurationNeeded);
        if (_hidl_err != ::android::OK) { return; }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "isReconfigurationRequired", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwCameraDeviceSession::BnHwCameraDeviceSession(const ::android::sp<ICameraDeviceSession> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.camera.device@3.5", "ICameraDeviceSession") { 
...
// Methods from ::android::hardware::camera::device::V3_5::ICameraDeviceSession follow.
::android::status_t BnHwCameraDeviceSession::_hidl_configureStreams_3_5(
    ...
    ::android::hardware::camera::device::V3_5::StreamConfiguration* requestedConfiguration;
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::camera::device::V3_5::StreamConfiguration &>(*requestedConfiguration),
            _hidl_data,
            _hidl_requestedConfiguration_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::configureStreams_3_5::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)requestedConfiguration);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "configureStreams_3_5", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraDeviceSession*>(_hidl_this->getImpl().get())->configureStreams_3_5(*requestedConfiguration, [&](const auto &_hidl_out_status, const auto &_hidl_out_halConfiguration) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("configureStreams_3_5: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_halConfiguration);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "configureStreams_3_5", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("configureStreams_3_5: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwCameraDeviceSession::_hidl_signalStreamFlush(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    const ::android::hardware::hidl_vec<int32_t>* streamIds;
    uint32_t streamConfigCounter;

    size_t _hidl_streamIds_parent;

    _hidl_err = _hidl_data.readBuffer(sizeof(*streamIds), &_hidl_streamIds_parent,  reinterpret_cast<const void **>(&streamIds));
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<int32_t> &>(*streamIds),
            _hidl_data,
            _hidl_streamIds_parent,
            0 /* parentOffset */, &_hidl_streamIds_child);
    ...
    _hidl_err = _hidl_data.readUint32(&streamConfigCounter);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::signalStreamFlush::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)streamIds);
        _hidl_args.push_back((void *)&streamConfigCounter);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "signalStreamFlush", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraDeviceSession*>(_hidl_this->getImpl().get())->signalStreamFlush(*streamIds, streamConfigCounter);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "signalStreamFlush", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwCameraDeviceSession::_hidl_isReconfigurationRequired(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    const ::android::hardware::hidl_vec<uint8_t>* oldSessionParams;
    const ::android::hardware::hidl_vec<uint8_t>* newSessionParams;

    size_t _hidl_oldSessionParams_parent;

    _hidl_err = _hidl_data.readBuffer(sizeof(*oldSessionParams), &_hidl_oldSessionParams_parent,  reinterpret_cast<const void **>(&oldSessionParams));
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<uint8_t> &>(*oldSessionParams),
            _hidl_data,
            _hidl_oldSessionParams_parent,
            0 /* parentOffset */, &_hidl_oldSessionParams_child);
    ...
    _hidl_err = _hidl_data.readBuffer(sizeof(*newSessionParams), &_hidl_newSessionParams_parent,  reinterpret_cast<const void **>(&newSessionParams));
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<uint8_t> &>(*newSessionParams),
            _hidl_data,
            _hidl_newSessionParams_parent,
            0 /* parentOffset */, &_hidl_newSessionParams_child);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::isReconfigurationRequired::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)oldSessionParams);
        _hidl_args.push_back((void *)newSessionParams);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "isReconfigurationRequired", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraDeviceSession*>(_hidl_this->getImpl().get())->isReconfigurationRequired(*oldSessionParams, *newSessionParams, [&](const auto &_hidl_out_status, const auto &_hidl_out_reconfigurationNeeded) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("isReconfigurationRequired: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;
        ...
        _hidl_err = _hidl_reply->writeBool(_hidl_out_reconfigurationNeeded);
        if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_reconfigurationNeeded);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.device", "3.5", "ICameraDeviceSession", "isReconfigurationRequired", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("isReconfigurationRequired: _hidl_cb not called, but must be called once.");
    }
...
BsCameraDeviceSession::BsCameraDeviceSession(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDeviceSession> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.camera.device@3.5", "ICameraDeviceSession"), mImpl(impl) {
...
bool ICameraDeviceSession::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.camera.device@3.5::ICameraDeviceSession",
