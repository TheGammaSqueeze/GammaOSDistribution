#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_BPHWCAMERADEVICESESSION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_BPHWCAMERADEVICESESSION_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/camera/device/3.5/IHwCameraDeviceSession.h>
...
struct BpHwCameraDeviceSession : public ::android::hardware::BpInterface<ICameraDeviceSession>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_configureStreams_3_5(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::camera::device::V3_5::StreamConfiguration& requestedConfiguration, configureStreams_3_5_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_signalStreamFlush(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<int32_t>& streamIds, uint32_t streamConfigCounter);
    static ::android::hardware::Return<void>  _hidl_isReconfigurationRequired(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& oldSessionParams, const ::android::hardware::hidl_vec<uint8_t>& newSessionParams, isReconfigurationRequired_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_5_BPHWCAMERADEVICESESSION_H
