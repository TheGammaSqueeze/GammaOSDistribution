#define LOG_TAG "android.hardware.camera.device@3.7::CameraDeviceSession"
...
#include <android/hardware/camera/device/3.7/BnHwCameraDeviceSession.h>
#include <android/hardware/camera/device/3.7/BsCameraDeviceSession.h>
...
const char* ICameraDeviceSession::descriptor("android.hardware.camera.device@3.7::ICameraDeviceSession");
...
// no default implementation for: ::android::hardware::Return<void> ICameraDeviceSession::configureStreams_3_4(const ::android::hardware::camera::device::V3_4::StreamConfiguration& requestedConfiguration, configureStreams_3_4_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<void> ICameraDeviceSession::processCaptureRequest_3_4(const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_4::CaptureRequest>& requests, const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_2::BufferCache>& cachesToRemove, processCaptureRequest_3_4_cb _hidl_cb)

// Methods from ::android::hardware::camera::device::V3_5::ICameraDeviceSession follow.
// no default implementation for: ::android::hardware::Return<void> ICameraDeviceSession::configureStreams_3_5(const ::android::hardware::camera::device::V3_5::StreamConfiguration& requestedConfiguration, configureStreams_3_5_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<void> ICameraDeviceSession::signalStreamFlush(const ::android::hardware::hidl_vec<int32_t>& streamIds, uint32_t streamConfigCounter)
// no default implementation for: ::android::hardware::Return<void> ICameraDeviceSession::isReconfigurationRequired(const ::android::hardware::hidl_vec<uint8_t>& oldSessionParams, const ::android::hardware::hidl_vec<uint8_t>& newSessionParams, isReconfigurationRequired_cb _hidl_cb)

// Methods from ::android::hardware::camera::device::V3_6::ICameraDeviceSession follow.
// no default implementation for: ::android::hardware::Return<void> ICameraDeviceSession::configureStreams_3_6(const ::android::hardware::camera::device::V3_5::StreamConfiguration& requestedConfiguration, configureStreams_3_6_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<void> ICameraDeviceSession::switchToOffline(const ::android::hardware::hidl_vec<int32_t>& streamsToKeep, switchToOffline_cb _hidl_cb)

// Methods from ::android::hardware::camera::device::V3_7::ICameraDeviceSession follow.
// no default implementation for: ::android::hardware::Return<void> ICameraDeviceSession::configureStreams_3_7(const ::android::hardware::camera::device::V3_7::StreamConfiguration& requestedConfiguration, configureStreams_3_7_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<void> ICameraDeviceSession::processCaptureRequest_3_7(const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_7::CaptureRequest>& requests, const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_2::BufferCache>& cachesToRemove, processCaptureRequest_3_7_cb _hidl_cb)
...
::android::hardware::Return<void> ICameraDeviceSession::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::camera::device::V3_7::ICameraDeviceSession::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraDeviceSession>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_6::ICameraDeviceSession>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraDeviceSession, ::android::hardware::camera::device::V3_6::ICameraDeviceSession, BpHwCameraDeviceSession>(
            parent, "android.hardware.camera.device@3.7::ICameraDeviceSession", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDeviceSession>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraDeviceSession, ::android::hardware::camera::device::V3_5::ICameraDeviceSession, BpHwCameraDeviceSession>(
            parent, "android.hardware.camera.device@3.7::ICameraDeviceSession", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraDeviceSession, ::android::hardware::camera::device::V3_4::ICameraDeviceSession, BpHwCameraDeviceSession>(
            parent, "android.hardware.camera.device@3.7::ICameraDeviceSession", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_3::ICameraDeviceSession>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraDeviceSession, ::android::hardware::camera::device::V3_3::ICameraDeviceSession, BpHwCameraDeviceSession>(
            parent, "android.hardware.camera.device@3.7::ICameraDeviceSession", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDeviceSession>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDeviceSession>> ICameraDeviceSession::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCameraDeviceSession::BpHwCameraDeviceSession(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICameraDeviceSession>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.camera.device@3.7", "ICameraDeviceSession") {
}
...
// Methods from ::android::hardware::camera::device::V3_7::ICameraDeviceSession follow.
::android::hardware::Return<void> BpHwCameraDeviceSession::_hidl_configureStreams_3_7(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::camera::device::V3_7::StreamConfiguration& requestedConfiguration, configureStreams_3_7_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::configureStreams_3_7::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&requestedConfiguration);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.device", "3.7", "ICameraDeviceSession", "configureStreams_3_7", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(16 /* configureStreams_3_7 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::camera::common::V1_0::Status _hidl_out_status;
        ::android::hardware::camera::device::V3_6::HalStreamConfiguration* _hidl_out_halConfiguration;
        ...
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::camera::device::V3_6::HalStreamConfiguration &>(*_hidl_out_halConfiguration),
                _hidl_reply,
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.device", "3.7", "ICameraDeviceSession", "configureStreams_3_7", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwCameraDeviceSession::_hidl_processCaptureRequest_3_7(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_7::CaptureRequest>& requests, const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_2::BufferCache>& cachesToRemove, processCaptureRequest_3_7_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::processCaptureRequest_3_7::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.device", "3.7", "ICameraDeviceSession", "processCaptureRequest_3_7", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < requests.size(); ++_hidl_index_0) {
        _hidl_err = writeEmbeddedToParcel(
                ...
                _hidl_index_0 * sizeof(::android::hardware::camera::device::V3_7::CaptureRequest));
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(17 /* processCaptureRequest_3_7 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::camera::common::V1_0::Status _hidl_out_status;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.device", "3.7", "ICameraDeviceSession", "processCaptureRequest_3_7", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::camera::device::V3_4::ICameraDeviceSession follow.
::android::hardware::Return<void> BpHwCameraDeviceSession::configureStreams_3_4(const ::android::hardware::camera::device::V3_4::StreamConfiguration& requestedConfiguration, configureStreams_3_4_cb _hidl_cb){
...
::android::hardware::Return<void> BpHwCameraDeviceSession::processCaptureRequest_3_4(const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_4::CaptureRequest>& requests, const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_2::BufferCache>& cachesToRemove, processCaptureRequest_3_4_cb _hidl_cb){
...
// Methods from ::android::hardware::camera::device::V3_5::ICameraDeviceSession follow.
::android::hardware::Return<void> BpHwCameraDeviceSession::configureStreams_3_5(const ::android::hardware::camera::device::V3_5::StreamConfiguration& requestedConfiguration, configureStreams_3_5_cb _hidl_cb){
...
::android::hardware::Return<void> BpHwCameraDeviceSession::signalStreamFlush(const ::android::hardware::hidl_vec<int32_t>& streamIds, uint32_t streamConfigCounter){
...
::android::hardware::Return<void> BpHwCameraDeviceSession::isReconfigurationRequired(const ::android::hardware::hidl_vec<uint8_t>& oldSessionParams, const ::android::hardware::hidl_vec<uint8_t>& newSessionParams, isReconfigurationRequired_cb _hidl_cb){
...
// Methods from ::android::hardware::camera::device::V3_6::ICameraDeviceSession follow.
::android::hardware::Return<void> BpHwCameraDeviceSession::configureStreams_3_6(const ::android::hardware::camera::device::V3_5::StreamConfiguration& requestedConfiguration, configureStreams_3_6_cb _hidl_cb){
...
::android::hardware::Return<void> BpHwCameraDeviceSession::switchToOffline(const ::android::hardware::hidl_vec<int32_t>& streamsToKeep, switchToOffline_cb _hidl_cb){
...
// Methods from ::android::hardware::camera::device::V3_7::ICameraDeviceSession follow.
::android::hardware::Return<void> BpHwCameraDeviceSession::configureStreams_3_7(const ::android::hardware::camera::device::V3_7::StreamConfiguration& requestedConfiguration, configureStreams_3_7_cb _hidl_cb){
...
::android::hardware::Return<void> BpHwCameraDeviceSession::processCaptureRequest_3_7(const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_7::CaptureRequest>& requests, const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_2::BufferCache>& cachesToRemove, processCaptureRequest_3_7_cb _hidl_cb){
...
BnHwCameraDeviceSession::BnHwCameraDeviceSession(const ::android::sp<ICameraDeviceSession> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.camera.device@3.7", "ICameraDeviceSession") { 
...
// Methods from ::android::hardware::camera::device::V3_7::ICameraDeviceSession follow.
::android::status_t BnHwCameraDeviceSession::_hidl_configureStreams_3_7(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::configureStreams_3_7::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)requestedConfiguration);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.device", "3.7", "ICameraDeviceSession", "configureStreams_3_7", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraDeviceSession*>(_hidl_this->getImpl().get())->configureStreams_3_7(*requestedConfiguration, [&](const auto &_hidl_out_status, const auto &_hidl_out_halConfiguration) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("configureStreams_3_7: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_halConfiguration);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.device", "3.7", "ICameraDeviceSession", "configureStreams_3_7", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("configureStreams_3_7: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwCameraDeviceSession::_hidl_processCaptureRequest_3_7(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_7::CaptureRequest>* requests;
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::camera::device::V3_7::CaptureRequest> &>(*requests),
            _hidl_data,
            _hidl_requests_parent,
            0 /* parentOffset */, &_hidl_requests_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < requests->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::camera::device::V3_7::CaptureRequest &>((*requests)[_hidl_index_0]),
                _hidl_data,
                _hidl_requests_child,
                _hidl_index_0 * sizeof(::android::hardware::camera::device::V3_7::CaptureRequest));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraDeviceSession::processCaptureRequest_3_7::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)requests);
        _hidl_args.push_back((void *)cachesToRemove);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.device", "3.7", "ICameraDeviceSession", "processCaptureRequest_3_7", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraDeviceSession*>(_hidl_this->getImpl().get())->processCaptureRequest_3_7(*requests, *cachesToRemove, [&](const auto &_hidl_out_status, const auto &_hidl_out_numRequestProcessed) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("processCaptureRequest_3_7: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_numRequestProcessed);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.device", "3.7", "ICameraDeviceSession", "processCaptureRequest_3_7", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("processCaptureRequest_3_7: _hidl_cb not called, but must be called once.");
    }
...
BsCameraDeviceSession::BsCameraDeviceSession(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraDeviceSession> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.camera.device@3.7", "ICameraDeviceSession"), mImpl(impl) {
...
bool ICameraDeviceSession::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.camera.device@3.7::ICameraDeviceSession",
