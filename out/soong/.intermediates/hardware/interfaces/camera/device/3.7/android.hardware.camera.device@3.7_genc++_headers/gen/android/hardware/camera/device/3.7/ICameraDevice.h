#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_7_ICAMERADEVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_7_ICAMERADEVICE_H
 ...
 */
struct ICameraDevice : public ::android::hardware::camera::device::V3_6::ICameraDevice {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.camera.device@3.7::ICameraDevice"
     */
    ...
    /**
     * Return callback for isStreamCombinationSupported_3_7
     */
    using isStreamCombinationSupported_3_7_cb = std::function<void(::android::hardware::camera::common::V1_0::Status status, bool queryStatus)>;
    /**
     ...
     *
     */
    virtual ::android::hardware::Return<void> isStreamCombinationSupported_3_7(const ::android::hardware::camera::device::V3_7::StreamConfiguration& streams, isStreamCombinationSupported_3_7_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_6::ICameraDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>& o) {
    ...
    os += ::android::hardware::camera::device::V3_7::ICameraDevice::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_7_ICAMERADEVICE_H
