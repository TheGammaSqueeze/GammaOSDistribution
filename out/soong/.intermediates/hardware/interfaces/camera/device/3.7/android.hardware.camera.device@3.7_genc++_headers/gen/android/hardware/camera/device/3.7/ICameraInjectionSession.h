#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_7_ICAMERAINJECTIONSESSION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_7_ICAMERAINJECTIONSESSION_H
 ...
 * be returned.
 */
struct ICameraInjectionSession : public ::android::hardware::camera::device::V3_7::ICameraDeviceSession {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.camera.device@3.7::ICameraInjectionSession"
     */
    ...
    /**
     * Return callback for configureStreams_3_6
     */
    using configureStreams_3_6_cb = std::function<void(::android::hardware::camera::common::V1_0::Status status, const ::android::hardware::camera::device::V3_6::HalStreamConfiguration& halConfiguration)>;
    /**
     ...
     *     override format.
     */
    virtual ::android::hardware::Return<void> configureStreams_3_6(const ::android::hardware::camera::device::V3_5::StreamConfiguration& requestedConfiguration, configureStreams_3_6_cb _hidl_cb) = 0;

    /**
     * Return callback for switchToOffline
     */
    using switchToOffline_cb = std::function<void(::android::hardware::camera::common::V1_0::Status status, const ::android::hardware::camera::device::V3_6::CameraOfflineSessionInfo& offlineSessionInfo, const ::android::sp<::android::hardware::camera::device::V3_6::ICameraOfflineSession>& offlineSession)>;
    /**
     * switchToOffline:
     *
     ...
     *     to interact with.
     */
    virtual ::android::hardware::Return<void> switchToOffline(const ::android::hardware::hidl_vec<int32_t>& streamsToKeep, switchToOffline_cb _hidl_cb) = 0;

    /**
     * Return callback for configureStreams_3_7
     */
    using configureStreams_3_7_cb = std::function<void(::android::hardware::camera::common::V1_0::Status status, const ::android::hardware::camera::device::V3_6::HalStreamConfiguration& halConfiguration)>;
    /**
     ...
     *     override format.
     */
    virtual ::android::hardware::Return<void> configureStreams_3_7(const ::android::hardware::camera::device::V3_7::StreamConfiguration& requestedConfiguration, configureStreams_3_7_cb _hidl_cb) = 0;

    /**
     * Return callback for processCaptureRequest_3_7
     */
    using processCaptureRequest_3_7_cb = std::function<void(::android::hardware::camera::common::V1_0::Status status, uint32_t numRequestProcessed)>;
    /**
     ...
     *
     */
    virtual ::android::hardware::Return<void> processCaptureRequest_3_7(const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_7::CaptureRequest>& requests, const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_2::BufferCache>& cachesToRemove, processCaptureRequest_3_7_cb _hidl_cb) = 0;
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::camera::common::V1_0::Status> configureInjectionStreams(const ::android::hardware::camera::device::V3_7::StreamConfiguration& requestedConfiguration, const ::android::hardware::hidl_vec<uint8_t>& characteristics) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraDeviceSession>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_6::ICameraDeviceSession>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDeviceSession>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_3::ICameraDeviceSession>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDeviceSession>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
     ...
     */
    static ::android::sp<ICameraInjectionSession> tryGetService(const std::string &serviceName="default", bool getStub=false);
    /**
     * Deprecated. See tryGetService(std::string, bool)
     */
    static ::android::sp<ICameraInjectionSession> tryGetService(const char serviceName[], bool getStub=false)  { std::string str(serviceName ? serviceName : "");      return tryGetService(str, getStub); }
    /**
     * Deprecated. See tryGetService(std::string, bool)
     */
    static ::android::sp<ICameraInjectionSession> tryGetService(const ::android::hardware::hidl_string& serviceName, bool getStub=false)  { std::string str(serviceName.c_str());      return tryGetService(str, getStub); }
    /**
     * Calls tryGetService("default", bool). This is the recommended instance name for singleton services.
     */
    static ::android::sp<ICameraInjectionSession> tryGetService(bool getStub) { return tryGetService("default", getStub); }
    /**
     * This gets the service of this type with the specified instance name. If the
     ...
     */
    static ::android::sp<ICameraInjectionSession> getService(const std::string &serviceName="default", bool getStub=false);
    /**
     * Deprecated. See getService(std::string, bool)
     */
    static ::android::sp<ICameraInjectionSession> getService(const char serviceName[], bool getStub=false)  { std::string str(serviceName ? serviceName : "");      return getService(str, getStub); }
    /**
     * Deprecated. See getService(std::string, bool)
     */
    static ::android::sp<ICameraInjectionSession> getService(const ::android::hardware::hidl_string& serviceName, bool getStub=false)  { std::string str(serviceName.c_str());      return getService(str, getStub); }
    /**
     * Calls getService("default", bool). This is the recommended instance name for singleton services.
     */
    static ::android::sp<ICameraInjectionSession> getService(bool getStub) { return getService("default", getStub); }
    /**
...
static inline std::string toString(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraInjectionSession>& o) {
    ...
    os += ::android::hardware::camera::device::V3_7::ICameraInjectionSession::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_7_ICAMERAINJECTIONSESSION_H
