#define LOG_TAG "android.hardware.camera.device@3.7::CameraDevice"
...
#include <android/hardware/camera/device/3.7/BpHwCameraDevice.h>
#include <android/hardware/camera/device/3.7/BnHwCameraDevice.h>
#include <android/hardware/camera/device/3.7/BsCameraDevice.h>
...
const char* ICameraDevice::descriptor("android.hardware.camera.device@3.7::ICameraDevice");
...
// no default implementation for: ::android::hardware::Return<void> ICameraDevice::isStreamCombinationSupported_3_7(const ::android::hardware::camera::device::V3_7::StreamConfiguration& streams, isStreamCombinationSupported_3_7_cb _hidl_cb)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> ICameraDevice::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::camera::device::V3_7::ICameraDevice::descriptor,
...
::android::hardware::Return<void> ICameraDevice::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::camera::device::V3_7::ICameraDevice::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> ICameraDevice::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){26,29,255,110,141,37,219,192,42,105,254,211,192,119,221,7,130,179,3,49,202,63,52,88,72,236,82,252,103,116,66,36} /* 1a1dff6e8d25dbc02a69fed3c077dd0782b30331ca3f345848ec52fc67744224 */,
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>> ICameraDevice::castFrom(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>> ICameraDevice::castFrom(const ::android::sp<::android::hardware::camera::device::V3_6::ICameraDevice>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraDevice, ::android::hardware::camera::device::V3_6::ICameraDevice, BpHwCameraDevice>(
            parent, "android.hardware.camera.device@3.7::ICameraDevice", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>> ICameraDevice::castFrom(const ::android::sp<::android::hardware::camera::device::V3_5::ICameraDevice>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraDevice, ::android::hardware::camera::device::V3_5::ICameraDevice, BpHwCameraDevice>(
            parent, "android.hardware.camera.device@3.7::ICameraDevice", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>> ICameraDevice::castFrom(const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDevice>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice>> ICameraDevice::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCameraDevice::BpHwCameraDevice(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICameraDevice>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.camera.device@3.7", "ICameraDevice") {
}
...
// Methods from ::android::hardware::camera::device::V3_7::ICameraDevice follow.
::android::hardware::Return<void> BpHwCameraDevice::_hidl_isStreamCombinationSupported_3_7(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::camera::device::V3_7::StreamConfiguration& streams, isStreamCombinationSupported_3_7_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraDevice::isStreamCombinationSupported_3_7::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&streams);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.device", "3.7", "ICameraDevice", "isStreamCombinationSupported_3_7", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(8 /* isStreamCombinationSupported_3_7 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.device", "3.7", "ICameraDevice", "isStreamCombinationSupported_3_7", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::camera::device::V3_7::ICameraDevice follow.
::android::hardware::Return<void> BpHwCameraDevice::isStreamCombinationSupported_3_7(const ::android::hardware::camera::device::V3_7::StreamConfiguration& streams, isStreamCombinationSupported_3_7_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::camera::device::V3_7::BpHwCameraDevice::_hidl_isStreamCombinationSupported_3_7(this, this, streams, _hidl_cb);
...
BnHwCameraDevice::BnHwCameraDevice(const ::android::sp<ICameraDevice> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.camera.device@3.7", "ICameraDevice") { 
...
// Methods from ::android::hardware::camera::device::V3_7::ICameraDevice follow.
::android::status_t BnHwCameraDevice::_hidl_isStreamCombinationSupported_3_7(
    ...
    ::android::hardware::camera::device::V3_7::StreamConfiguration* streams;
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::camera::device::V3_7::StreamConfiguration &>(*streams),
            _hidl_data,
            _hidl_streams_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraDevice::isStreamCombinationSupported_3_7::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)streams);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.device", "3.7", "ICameraDevice", "isStreamCombinationSupported_3_7", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraDevice*>(_hidl_this->getImpl().get())->isStreamCombinationSupported_3_7(*streams, [&](const auto &_hidl_out_status, const auto &_hidl_out_queryStatus) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("isStreamCombinationSupported_3_7: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_queryStatus);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.device", "3.7", "ICameraDevice", "isStreamCombinationSupported_3_7", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("isStreamCombinationSupported_3_7: _hidl_cb not called, but must be called once.");
    }
...
::android::status_t BnHwCameraDevice::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 8 /* isStreamCombinationSupported_3_7 */:
        {
            _hidl_err = ::android::hardware::camera::device::V3_7::BnHwCameraDevice::_hidl_isStreamCombinationSupported_3_7(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsCameraDevice::BsCameraDevice(const ::android::sp<::android::hardware::camera::device::V3_7::ICameraDevice> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.camera.device@3.7", "ICameraDevice"), mImpl(impl) {
...
bool ICameraDevice::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.camera.device@3.7::ICameraDevice",
