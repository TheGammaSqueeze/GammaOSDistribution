#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_2_BPHWCAMERADEVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_2_BPHWCAMERADEVICE_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/camera/device/3.2/IHwCameraDevice.h>
...
struct BpHwCameraDevice : public ::android::hardware::BpInterface<ICameraDevice>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_getCameraCharacteristics(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getCameraCharacteristics_cb _hidl_cb);
    ...
    static ::android::hardware::Return<void>  _hidl_open(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDeviceCallback>& callback, open_cb _hidl_cb);
    static ::android::hardware::Return<void>  _hidl_dumpState(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_handle& fd);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_2_BPHWCAMERADEVICE_H
