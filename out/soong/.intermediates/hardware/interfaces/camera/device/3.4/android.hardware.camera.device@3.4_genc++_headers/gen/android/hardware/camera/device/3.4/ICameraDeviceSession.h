#ifndef HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_ICAMERADEVICESESSION_H
#define HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_ICAMERADEVICESESSION_H
 ...
 */
struct ICameraDeviceSession : public ::android::hardware::camera::device::V3_3::ICameraDeviceSession {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.camera.device@3.4::ICameraDeviceSession"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_3::ICameraDeviceSession>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>> castFrom(const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDeviceSession>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceSession>& o) {
    ...
    os += ::android::hardware::camera::device::V3_4::ICameraDeviceSession::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_CAMERA_DEVICE_V3_4_ICAMERADEVICESESSION_H
