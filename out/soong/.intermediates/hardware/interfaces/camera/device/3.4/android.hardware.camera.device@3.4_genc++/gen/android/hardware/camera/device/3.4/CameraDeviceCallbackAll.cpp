#define LOG_TAG "android.hardware.camera.device@3.4::CameraDeviceCallback"
...
#include <android/hardware/camera/device/3.4/BnHwCameraDeviceCallback.h>
#include <android/hardware/camera/device/3.4/BsCameraDeviceCallback.h>
...
const char* ICameraDeviceCallback::descriptor("android.hardware.camera.device@3.4::ICameraDeviceCallback");
...
::android::hardware::Return<void> ICameraDeviceCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::camera::device::V3_4::ICameraDeviceCallback::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceCallback>> ICameraDeviceCallback::castFrom(const ::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceCallback>> ICameraDeviceCallback::castFrom(const ::android::sp<::android::hardware::camera::device::V3_2::ICameraDeviceCallback>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ICameraDeviceCallback, ::android::hardware::camera::device::V3_2::ICameraDeviceCallback, BpHwCameraDeviceCallback>(
            parent, "android.hardware.camera.device@3.4::ICameraDeviceCallback", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceCallback>> ICameraDeviceCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwCameraDeviceCallback::BpHwCameraDeviceCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ICameraDeviceCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.camera.device@3.4", "ICameraDeviceCallback") {
}
...
// Methods from ::android::hardware::camera::device::V3_4::ICameraDeviceCallback follow.
::android::hardware::Return<void> BpHwCameraDeviceCallback::_hidl_processCaptureResult_3_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_4::CaptureResult>& results) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ICameraDeviceCallback::processCaptureResult_3_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&results);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.camera.device", "3.4", "ICameraDeviceCallback", "processCaptureResult_3_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < results.size(); ++_hidl_index_0) {
        _hidl_err = writeEmbeddedToParcel(
                ...
                &_hidl_data,
                _hidl_results_child,
                _hidl_index_0 * sizeof(::android::hardware::camera::device::V3_4::CaptureResult));

        if (_hidl_err != ::android::OK) { goto _hidl_error; }

    }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(3 /* processCaptureResult_3_4 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.camera.device", "3.4", "ICameraDeviceCallback", "processCaptureResult_3_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwCameraDeviceCallback::BnHwCameraDeviceCallback(const ::android::sp<ICameraDeviceCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.camera.device@3.4", "ICameraDeviceCallback") { 
...
// Methods from ::android::hardware::camera::device::V3_4::ICameraDeviceCallback follow.
::android::status_t BnHwCameraDeviceCallback::_hidl_processCaptureResult_3_4(
    ...
    const ::android::hardware::hidl_vec<::android::hardware::camera::device::V3_4::CaptureResult>* results;
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::camera::device::V3_4::CaptureResult> &>(*results),
            _hidl_data,
            _hidl_results_parent,
            0 /* parentOffset */, &_hidl_results_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < results->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::camera::device::V3_4::CaptureResult &>((*results)[_hidl_index_0]),
                _hidl_data,
                _hidl_results_child,
                _hidl_index_0 * sizeof(::android::hardware::camera::device::V3_4::CaptureResult));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ICameraDeviceCallback::processCaptureResult_3_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)results);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.camera.device", "3.4", "ICameraDeviceCallback", "processCaptureResult_3_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<ICameraDeviceCallback*>(_hidl_this->getImpl().get())->processCaptureResult_3_4(*results);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.camera.device", "3.4", "ICameraDeviceCallback", "processCaptureResult_3_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsCameraDeviceCallback::BsCameraDeviceCallback(const ::android::sp<::android::hardware::camera::device::V3_4::ICameraDeviceCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.camera.device@3.4", "ICameraDeviceCallback"), mImpl(impl) {
...
bool ICameraDeviceCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.camera.device@3.4::ICameraDeviceCallback",
