...
#include <android/hardware/neuralnetworks/1.0/BnHwPreparedModel.h>
#include <android/hardware/neuralnetworks/1.0/BsPreparedModel.h>
...
const char* IPreparedModel::descriptor("android.hardware.neuralnetworks@1.0::IPreparedModel");
...
::android::hardware::Return<void> IPreparedModel::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::neuralnetworks::V1_0::IPreparedModel::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModel>> IPreparedModel::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModel>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModel>> IPreparedModel::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwPreparedModel::BpHwPreparedModel(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IPreparedModel>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.0", "IPreparedModel") {
}
...
// Methods from ::android::hardware::neuralnetworks::V1_0::IPreparedModel follow.
::android::hardware::Return<::android::hardware::neuralnetworks::V1_0::ErrorStatus> BpHwPreparedModel::_hidl_execute(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::neuralnetworks::V1_0::Request& request, const ::android::sp<::android::hardware::neuralnetworks::V1_0::IExecutionCallback>& callback) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IPreparedModel::execute::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.0", "IPreparedModel", "execute", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* execute */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.0", "IPreparedModel", "execute", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwPreparedModel::BnHwPreparedModel(const ::android::sp<IPreparedModel> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.neuralnetworks@1.0", "IPreparedModel") { 
...
// Methods from ::android::hardware::neuralnetworks::V1_0::IPreparedModel follow.
::android::status_t BnHwPreparedModel::_hidl_execute(
    ...
    ::android::sp<::android::hardware::neuralnetworks::V1_0::IExecutionCallback> callback;
...

    {
        ...
        callback = ::android::hardware::fromBinder<::android::hardware::neuralnetworks::V1_0::IExecutionCallback,::android::hardware::neuralnetworks::V1_0::BpHwExecutionCallback,::android::hardware::neuralnetworks::V1_0::BnHwExecutionCallback>(_hidl_binder);
    }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IPreparedModel::execute::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)request);
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.0", "IPreparedModel", "execute", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::neuralnetworks::V1_0::ErrorStatus _hidl_out_status = static_cast<IPreparedModel*>(_hidl_this->getImpl().get())->execute(*request, callback);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.0", "IPreparedModel", "execute", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsPreparedModel::BsPreparedModel(const ::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModel> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.0", "IPreparedModel"), mImpl(impl) {
...
bool IPreparedModel::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.neuralnetworks@1.0::IPreparedModel",
