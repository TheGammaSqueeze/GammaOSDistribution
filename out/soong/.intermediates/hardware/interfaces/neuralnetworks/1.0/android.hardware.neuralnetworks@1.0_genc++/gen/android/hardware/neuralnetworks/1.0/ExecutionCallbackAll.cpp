...
#include <android/hardware/neuralnetworks/1.0/BnHwExecutionCallback.h>
#include <android/hardware/neuralnetworks/1.0/BsExecutionCallback.h>
...
const char* IExecutionCallback::descriptor("android.hardware.neuralnetworks@1.0::IExecutionCallback");
...
::android::hardware::Return<void> IExecutionCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::neuralnetworks::V1_0::IExecutionCallback::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_0::IExecutionCallback>> IExecutionCallback::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_0::IExecutionCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_0::IExecutionCallback>> IExecutionCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IExecutionCallback, ::android::hidl::base::V1_0::IBase, BpHwExecutionCallback>(
            parent, "android.hardware.neuralnetworks@1.0::IExecutionCallback", emitError);
}
...
BpHwExecutionCallback::BpHwExecutionCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IExecutionCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.0", "IExecutionCallback") {
}
...
// Methods from ::android::hardware::neuralnetworks::V1_0::IExecutionCallback follow.
::android::hardware::Return<void> BpHwExecutionCallback::_hidl_notify(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::neuralnetworks::V1_0::ErrorStatus status) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IExecutionCallback::notify::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.0", "IExecutionCallback", "notify", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.0", "IExecutionCallback", "notify", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwExecutionCallback::BnHwExecutionCallback(const ::android::sp<IExecutionCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.neuralnetworks@1.0", "IExecutionCallback") { 
...
// Methods from ::android::hardware::neuralnetworks::V1_0::IExecutionCallback follow.
::android::status_t BnHwExecutionCallback::_hidl_notify(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IExecutionCallback::notify::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.0", "IExecutionCallback", "notify", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IExecutionCallback*>(_hidl_this->getImpl().get())->notify(status);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.0", "IExecutionCallback", "notify", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsExecutionCallback::BsExecutionCallback(const ::android::sp<::android::hardware::neuralnetworks::V1_0::IExecutionCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.0", "IExecutionCallback"), mImpl(impl) {
...
bool IExecutionCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.neuralnetworks@1.0::IExecutionCallback",
