...
#include <android/hardware/neuralnetworks/1.0/BsPreparedModelCallback.h>
...
const char* IPreparedModelCallback::descriptor("android.hardware.neuralnetworks@1.0::IPreparedModelCallback");
...
::android::hardware::Return<void> IPreparedModelCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::neuralnetworks::V1_0::IPreparedModelCallback::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModelCallback>> IPreparedModelCallback::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModelCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModelCallback>> IPreparedModelCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IPreparedModelCallback, ::android::hidl::base::V1_0::IBase, BpHwPreparedModelCallback>(
            parent, "android.hardware.neuralnetworks@1.0::IPreparedModelCallback", emitError);
}
...
BpHwPreparedModelCallback::BpHwPreparedModelCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IPreparedModelCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.0", "IPreparedModelCallback") {
}
...
// Methods from ::android::hardware::neuralnetworks::V1_0::IPreparedModelCallback follow.
::android::hardware::Return<void> BpHwPreparedModelCallback::_hidl_notify(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::neuralnetworks::V1_0::ErrorStatus status, const ::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModel>& preparedModel) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IPreparedModelCallback::notify::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.0", "IPreparedModelCallback", "notify", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* notify */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.0", "IPreparedModelCallback", "notify", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwPreparedModelCallback::BnHwPreparedModelCallback(const ::android::sp<IPreparedModelCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.neuralnetworks@1.0", "IPreparedModelCallback") { 
...
// Methods from ::android::hardware::neuralnetworks::V1_0::IPreparedModelCallback follow.
::android::status_t BnHwPreparedModelCallback::_hidl_notify(
    ...
    ::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModel> preparedModel;
...

    {
        ...
        preparedModel = ::android::hardware::fromBinder<::android::hardware::neuralnetworks::V1_0::IPreparedModel,::android::hardware::neuralnetworks::V1_0::BpHwPreparedModel,::android::hardware::neuralnetworks::V1_0::BnHwPreparedModel>(_hidl_binder);
    }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IPreparedModelCallback::notify::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&status);
        _hidl_args.push_back((void *)&preparedModel);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.0", "IPreparedModelCallback", "notify", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IPreparedModelCallback*>(_hidl_this->getImpl().get())->notify(status, preparedModel);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.0", "IPreparedModelCallback", "notify", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsPreparedModelCallback::BsPreparedModelCallback(const ::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModelCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.0", "IPreparedModelCallback"), mImpl(impl) {
...
bool IPreparedModelCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.neuralnetworks@1.0::IPreparedModelCallback",
