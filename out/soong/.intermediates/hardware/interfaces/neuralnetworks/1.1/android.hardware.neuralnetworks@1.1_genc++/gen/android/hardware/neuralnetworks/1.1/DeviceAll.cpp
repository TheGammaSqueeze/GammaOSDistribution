...
::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_1::IDevice>> IDevice::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_1::IDevice>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_1::IDevice>> IDevice::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_0::IDevice>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_1::IDevice>> IDevice::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
::android::hardware::Return<void> BpHwDevice::_hidl_getCapabilities_1_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getCapabilities_1_1_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDevice::getCapabilities_1_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(5 /* getCapabilities_1_1 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::neuralnetworks::V1_0::ErrorStatus _hidl_out_status;
        ::android::hardware::neuralnetworks::V1_1::Capabilities* _hidl_out_capabilities;
...
::android::hardware::Return<void> BpHwDevice::_hidl_getSupportedOperations_1_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::neuralnetworks::V1_1::Model& model, getSupportedOperations_1_1_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDevice::getSupportedOperations_1_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(6 /* getSupportedOperations_1_1 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::neuralnetworks::V1_0::ErrorStatus _hidl_out_status;
...
::android::hardware::Return<::android::hardware::neuralnetworks::V1_0::ErrorStatus> BpHwDevice::_hidl_prepareModel_1_1(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::neuralnetworks::V1_1::Model& model, ::android::hardware::neuralnetworks::V1_1::ExecutionPreference preference, const ::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModelCallback>& callback) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDevice::prepareModel_1_1::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&model);
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(7 /* prepareModel_1_1 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
...
::android::status_t BnHwDevice::_hidl_getCapabilities_1_1(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDevice*>(_hidl_this->getImpl().get())->getCapabilities_1_1([&](const auto &_hidl_out_status, const auto &_hidl_out_capabilities) {
...
::android::status_t BnHwDevice::_hidl_getSupportedOperations_1_1(
    ...
    ::android::hardware::neuralnetworks::V1_1::Model* model;
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::neuralnetworks::V1_1::Model &>(*model),
            _hidl_data,
            _hidl_model_parent,
            0 /* parentOffset */);
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDevice*>(_hidl_this->getImpl().get())->getSupportedOperations_1_1(*model, [&](const auto &_hidl_out_status, const auto &_hidl_out_supportedOperations) {
        if (_hidl_callbackCalled) {
...
::android::status_t BnHwDevice::_hidl_prepareModel_1_1(
    ...
    ::android::hardware::neuralnetworks::V1_0::ErrorStatus _hidl_out_status = static_cast<IDevice*>(_hidl_this->getImpl().get())->prepareModel_1_1(*model, preference, callback);
...
BsDevice::BsDevice(const ::android::sp<::android::hardware::neuralnetworks::V1_1::IDevice> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.1", "IDevice"), mImpl(impl) {
