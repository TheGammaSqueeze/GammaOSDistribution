...
const char* ExtensionNameAndPrefix::descriptor = "android.hardware.neuralnetworks.ExtensionNameAndPrefix";

binder_status_t ExtensionNameAndPrefix::readFromParcel(const AParcel* parcel) {
  ...
  _aidl_ret_status = AParcel_readChar(parcel, &prefix);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t ExtensionNameAndPrefix::writeToParcel(AParcel* parcel) const {
  ...
  _aidl_ret_status = AParcel_writeChar(parcel, prefix);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
