...
const char* FencedExecutionResult::descriptor = "android.hardware.neuralnetworks.FencedExecutionResult";

binder_status_t FencedExecutionResult::readFromParcel(const AParcel* parcel) {
  ...
  _aidl_ret_status = ::aidl::android::hardware::neuralnetworks::IFencedExecutionCallback::readFromParcel(parcel, &callback);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = ::ndk::AParcel_readNullableParcelFileDescriptor(parcel, &syncFence);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t FencedExecutionResult::writeToParcel(AParcel* parcel) const {
  binder_status_t _aidl_ret_status;
  size_t _aidl_start_pos = AParcel_getDataPosition(parcel);
  _aidl_ret_status = AParcel_writeInt32(parcel, 0);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::aidl::android::hardware::neuralnetworks::IFencedExecutionCallback::writeToParcel(parcel, callback);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeNullableParcelFileDescriptor(parcel, syncFence);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
