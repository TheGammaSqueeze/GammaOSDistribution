...
static binder_status_t _aidl_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  ...
  switch (_aidl_code) {
    case (FIRST_CALL_TRANSACTION + 0 /*copyFrom*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readParcelable(_aidl_in, &in_src);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readVector(_aidl_in, &in_dimensions);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 1 /*copyTo*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readParcelable(_aidl_in, &in_dst);
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_clazz = ::ndk::ICInterface::defineClass(IBuffer::descriptor, _aidl_onTransact);
...
::ndk::ScopedAStatus BpBuffer::copyFrom(const ::aidl::android::hardware::neuralnetworks::Memory& in_src, const std::vector<int32_t>& in_dimensions) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeParcelable(_aidl_in.get(), in_src);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeVector(_aidl_in.get(), in_dimensions);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpBuffer::copyTo(const ::aidl::android::hardware::neuralnetworks::Memory& in_dst) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeParcelable(_aidl_in.get(), in_dst);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
