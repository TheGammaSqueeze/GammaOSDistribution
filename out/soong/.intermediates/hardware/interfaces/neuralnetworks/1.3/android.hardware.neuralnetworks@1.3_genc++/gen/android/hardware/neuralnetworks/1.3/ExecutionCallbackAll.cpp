...
#include <android/hardware/neuralnetworks/1.3/BpHwExecutionCallback.h>
#include <android/hardware/neuralnetworks/1.3/BnHwExecutionCallback.h>
#include <android/hardware/neuralnetworks/1.3/BsExecutionCallback.h>
...
const char* IExecutionCallback::descriptor("android.hardware.neuralnetworks@1.3::IExecutionCallback");
...
// Methods from ::android::hardware::neuralnetworks::V1_3::IExecutionCallback follow.
// no default implementation for: ::android::hardware::Return<void> IExecutionCallback::notify_1_3(::android::hardware::neuralnetworks::V1_3::ErrorStatus status, const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_2::OutputShape>& outputShapes, const ::android::hardware::neuralnetworks::V1_2::Timing& timing)
...
::android::hardware::Return<void> IExecutionCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::neuralnetworks::V1_3::IExecutionCallback::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IExecutionCallback::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){18,123,161,30,251,130,32,220,58,236,154,143,68,27,89,234,241,198,141,127,3,245,119,131,62,24,36,222,117,163,107,23} /* 127ba11efb8220dc3aec9a8f441b59eaf1c68d7f03f577833e1824de75a36b17 */,
...
::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_3::IExecutionCallback>> IExecutionCallback::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_3::IExecutionCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_3::IExecutionCallback>> IExecutionCallback::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_2::IExecutionCallback>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IExecutionCallback, ::android::hardware::neuralnetworks::V1_2::IExecutionCallback, BpHwExecutionCallback>(
            parent, "android.hardware.neuralnetworks@1.3::IExecutionCallback", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_3::IExecutionCallback>> IExecutionCallback::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_0::IExecutionCallback>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_3::IExecutionCallback>> IExecutionCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwExecutionCallback::BpHwExecutionCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IExecutionCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.3", "IExecutionCallback") {
}
...
// Methods from ::android::hardware::neuralnetworks::V1_3::IExecutionCallback follow.
::android::hardware::Return<void> BpHwExecutionCallback::_hidl_notify_1_3(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::neuralnetworks::V1_3::ErrorStatus status, const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_2::OutputShape>& outputShapes, const ::android::hardware::neuralnetworks::V1_2::Timing& timing) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IExecutionCallback::notify_1_3::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IExecutionCallback", "notify_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IExecutionCallback", "notify_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::neuralnetworks::V1_3::IExecutionCallback follow.
::android::hardware::Return<void> BpHwExecutionCallback::notify_1_3(::android::hardware::neuralnetworks::V1_3::ErrorStatus status, const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_2::OutputShape>& outputShapes, const ::android::hardware::neuralnetworks::V1_2::Timing& timing){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::neuralnetworks::V1_3::BpHwExecutionCallback::_hidl_notify_1_3(this, this, status, outputShapes, timing);
...
BnHwExecutionCallback::BnHwExecutionCallback(const ::android::sp<IExecutionCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.neuralnetworks@1.3", "IExecutionCallback") { 
...
// Methods from ::android::hardware::neuralnetworks::V1_3::IExecutionCallback follow.
::android::status_t BnHwExecutionCallback::_hidl_notify_1_3(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IExecutionCallback::notify_1_3::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&status);
        ...
        _hidl_args.push_back((void *)timing);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IExecutionCallback", "notify_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IExecutionCallback*>(_hidl_this->getImpl().get())->notify_1_3(status, *outputShapes, *timing);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IExecutionCallback", "notify_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwExecutionCallback::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 3 /* notify_1_3 */:
        {
            _hidl_err = ::android::hardware::neuralnetworks::V1_3::BnHwExecutionCallback::_hidl_notify_1_3(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsExecutionCallback::BsExecutionCallback(const ::android::sp<::android::hardware::neuralnetworks::V1_3::IExecutionCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.3", "IExecutionCallback"), mImpl(impl) {
...
bool IExecutionCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.neuralnetworks@1.3::IExecutionCallback",
