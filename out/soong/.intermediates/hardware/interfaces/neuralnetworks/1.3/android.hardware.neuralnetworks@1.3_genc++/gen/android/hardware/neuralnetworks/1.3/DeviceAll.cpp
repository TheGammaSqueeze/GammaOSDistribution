...
#include <android/hardware/neuralnetworks/1.3/BpHwDevice.h>
#include <android/hardware/neuralnetworks/1.3/BnHwDevice.h>
#include <android/hardware/neuralnetworks/1.3/BsDevice.h>
...
::android::hardware::Return<void> IDevice::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){195,254,197,189,71,9,132,64,41,151,247,138,116,182,81,30,252,64,99,178,112,242,189,158,231,183,143,72,182,131,161,187} /* c3fec5bd470984402997f78a74b6511efc4063b270f2bd9ee7b78f48b683a1bb */,
...
::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_3::IDevice>> IDevice::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_3::IDevice>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_3::IDevice>> IDevice::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_2::IDevice>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDevice, ::android::hardware::neuralnetworks::V1_2::IDevice, BpHwDevice>(
            parent, "android.hardware.neuralnetworks@1.3::IDevice", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_3::IDevice>> IDevice::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_1::IDevice>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDevice, ::android::hardware::neuralnetworks::V1_1::IDevice, BpHwDevice>(
            parent, "android.hardware.neuralnetworks@1.3::IDevice", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_3::IDevice>> IDevice::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_0::IDevice>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDevice, ::android::hardware::neuralnetworks::V1_0::IDevice, BpHwDevice>(
            parent, "android.hardware.neuralnetworks@1.3::IDevice", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_3::IDevice>> IDevice::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwDevice::BpHwDevice(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IDevice>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.3", "IDevice") {
}
...
// Methods from ::android::hardware::neuralnetworks::V1_3::IDevice follow.
::android::hardware::Return<void> BpHwDevice::_hidl_getCapabilities_1_3(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getCapabilities_1_3_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDevice::getCapabilities_1_3::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IDevice", "getCapabilities_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(16 /* getCapabilities_1_3 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::neuralnetworks::V1_3::ErrorStatus _hidl_out_status;
        ::android::hardware::neuralnetworks::V1_3::Capabilities* _hidl_out_capabilities;
        ...
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::neuralnetworks::V1_3::Capabilities &>(*_hidl_out_capabilities),
                _hidl_reply,
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IDevice", "getCapabilities_1_3", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDevice::_hidl_getSupportedOperations_1_3(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::neuralnetworks::V1_3::Model& model, getSupportedOperations_1_3_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDevice::getSupportedOperations_1_3::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&model);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IDevice", "getSupportedOperations_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(17 /* getSupportedOperations_1_3 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::neuralnetworks::V1_3::ErrorStatus _hidl_out_status;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IDevice", "getSupportedOperations_1_3", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::neuralnetworks::V1_3::ErrorStatus> BpHwDevice::_hidl_prepareModel_1_3(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::neuralnetworks::V1_3::Model& model, ::android::hardware::neuralnetworks::V1_1::ExecutionPreference preference, ::android::hardware::neuralnetworks::V1_3::Priority priority, const ::android::hardware::neuralnetworks::V1_3::OptionalTimePoint& deadline, const ::android::hardware::hidl_vec<::android::hardware::hidl_handle>& modelCache, const ::android::hardware::hidl_vec<::android::hardware::hidl_handle>& dataCache, const ::android::hardware::hidl_array<uint8_t, 32 /* Constant:BYTE_SIZE_OF_CACHE_TOKEN */>& token, const ::android::sp<::android::hardware::neuralnetworks::V1_3::IPreparedModelCallback>& callback) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDevice::prepareModel_1_3::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&model);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IDevice", "prepareModel_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(18 /* prepareModel_1_3 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IDevice", "prepareModel_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::neuralnetworks::V1_3::ErrorStatus> BpHwDevice::_hidl_prepareModelFromCache_1_3(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::neuralnetworks::V1_3::OptionalTimePoint& deadline, const ::android::hardware::hidl_vec<::android::hardware::hidl_handle>& modelCache, const ::android::hardware::hidl_vec<::android::hardware::hidl_handle>& dataCache, const ::android::hardware::hidl_array<uint8_t, 32 /* Constant:BYTE_SIZE_OF_CACHE_TOKEN */>& token, const ::android::sp<::android::hardware::neuralnetworks::V1_3::IPreparedModelCallback>& callback) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDevice::prepareModelFromCache_1_3::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&deadline);
        ...
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IDevice", "prepareModelFromCache_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::ProcessState::self()->startThreadPool();
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(19 /* prepareModelFromCache_1_3 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IDevice", "prepareModelFromCache_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDevice::_hidl_allocate(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::neuralnetworks::V1_3::BufferDesc& desc, const ::android::hardware::hidl_vec<::android::sp<::android::hardware::neuralnetworks::V1_3::IPreparedModel>>& preparedModels, const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_3::BufferRole>& inputRoles, const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_3::BufferRole>& outputRoles, allocate_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDevice::allocate::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IDevice", "allocate", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    size_t _hidl_desc_parent;

    _hidl_err = _hidl_data.writeBuffer(&desc, sizeof(desc), &_hidl_desc_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_err = _hidl_data.writeUint64(preparedModels.size());
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    for (size_t _hidl_index = 0; _hidl_index < preparedModels.size(); ++_hidl_index) {
        if (preparedModels[_hidl_index] == nullptr) {
            _hidl_err = _hidl_data.writeStrongBinder(nullptr);
        } else {
            ::android::sp<::android::hardware::IBinder> _hidl_binder = ::android::hardware::getOrCreateCachedBinder(preparedModels[_hidl_index].get());
            if (_hidl_binder.get() != nullptr) {
                _hidl_err = _hidl_data.writeStrongBinder(_hidl_binder);
            } else {
                _hidl_err = ::android::UNKNOWN_ERROR;
    ...
    size_t _hidl_inputRoles_parent;

    _hidl_err = _hidl_data.writeBuffer(&inputRoles, sizeof(inputRoles), &_hidl_inputRoles_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_inputRoles_child;

    _hidl_err = ::android::hardware::writeEmbeddedToParcel(
            inputRoles,
            &_hidl_data,
            _hidl_inputRoles_parent,
            0 /* parentOffset */, &_hidl_inputRoles_child);

    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_outputRoles_parent;

    _hidl_err = _hidl_data.writeBuffer(&outputRoles, sizeof(outputRoles), &_hidl_outputRoles_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_outputRoles_child;

    _hidl_err = ::android::hardware::writeEmbeddedToParcel(
            outputRoles,
            &_hidl_data,
            _hidl_outputRoles_parent,
            0 /* parentOffset */, &_hidl_outputRoles_child);

    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(20 /* allocate */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::neuralnetworks::V1_3::ErrorStatus _hidl_out_status;
        ::android::sp<::android::hardware::neuralnetworks::V1_3::IBuffer> _hidl_out_buffer;
        uint32_t _hidl_out_token;
...

        {
            ...
            _hidl_out_buffer = ::android::hardware::fromBinder<::android::hardware::neuralnetworks::V1_3::IBuffer,::android::hardware::neuralnetworks::V1_3::BpHwBuffer,::android::hardware::neuralnetworks::V1_3::BnHwBuffer>(_hidl_binder);
        }

        _hidl_err = _hidl_reply.readUint32(&_hidl_out_token);
        if (_hidl_err != ::android::OK) { return; }

        _hidl_cb(_hidl_out_status, _hidl_out_buffer, _hidl_out_token);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IDevice", "allocate", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::neuralnetworks::V1_3::IDevice follow.
::android::hardware::Return<void> BpHwDevice::getCapabilities_1_3(getCapabilities_1_3_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::neuralnetworks::V1_3::BpHwDevice::_hidl_getCapabilities_1_3(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwDevice::getSupportedOperations_1_3(const ::android::hardware::neuralnetworks::V1_3::Model& model, getSupportedOperations_1_3_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::neuralnetworks::V1_3::BpHwDevice::_hidl_getSupportedOperations_1_3(this, this, model, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::neuralnetworks::V1_3::ErrorStatus> BpHwDevice::prepareModel_1_3(const ::android::hardware::neuralnetworks::V1_3::Model& model, ::android::hardware::neuralnetworks::V1_1::ExecutionPreference preference, ::android::hardware::neuralnetworks::V1_3::Priority priority, const ::android::hardware::neuralnetworks::V1_3::OptionalTimePoint& deadline, const ::android::hardware::hidl_vec<::android::hardware::hidl_handle>& modelCache, const ::android::hardware::hidl_vec<::android::hardware::hidl_handle>& dataCache, const ::android::hardware::hidl_array<uint8_t, 32 /* Constant:BYTE_SIZE_OF_CACHE_TOKEN */>& token, const ::android::sp<::android::hardware::neuralnetworks::V1_3::IPreparedModelCallback>& callback){
    ::android::hardware::Return<::android::hardware::neuralnetworks::V1_3::ErrorStatus>  _hidl_out = ::android::hardware::neuralnetworks::V1_3::BpHwDevice::_hidl_prepareModel_1_3(this, this, model, preference, priority, deadline, modelCache, dataCache, token, callback);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::neuralnetworks::V1_3::ErrorStatus> BpHwDevice::prepareModelFromCache_1_3(const ::android::hardware::neuralnetworks::V1_3::OptionalTimePoint& deadline, const ::android::hardware::hidl_vec<::android::hardware::hidl_handle>& modelCache, const ::android::hardware::hidl_vec<::android::hardware::hidl_handle>& dataCache, const ::android::hardware::hidl_array<uint8_t, 32 /* Constant:BYTE_SIZE_OF_CACHE_TOKEN */>& token, const ::android::sp<::android::hardware::neuralnetworks::V1_3::IPreparedModelCallback>& callback){
    ::android::hardware::Return<::android::hardware::neuralnetworks::V1_3::ErrorStatus>  _hidl_out = ::android::hardware::neuralnetworks::V1_3::BpHwDevice::_hidl_prepareModelFromCache_1_3(this, this, deadline, modelCache, dataCache, token, callback);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwDevice::allocate(const ::android::hardware::neuralnetworks::V1_3::BufferDesc& desc, const ::android::hardware::hidl_vec<::android::sp<::android::hardware::neuralnetworks::V1_3::IPreparedModel>>& preparedModels, const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_3::BufferRole>& inputRoles, const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_3::BufferRole>& outputRoles, allocate_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::neuralnetworks::V1_3::BpHwDevice::_hidl_allocate(this, this, desc, preparedModels, inputRoles, outputRoles, _hidl_cb);
...
BnHwDevice::BnHwDevice(const ::android::sp<IDevice> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.neuralnetworks@1.3", "IDevice") { 
...
// Methods from ::android::hardware::neuralnetworks::V1_3::IDevice follow.
::android::status_t BnHwDevice::_hidl_getCapabilities_1_3(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDevice::getCapabilities_1_3::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IDevice", "getCapabilities_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDevice*>(_hidl_this->getImpl().get())->getCapabilities_1_3([&](const auto &_hidl_out_status, const auto &_hidl_out_capabilities) {
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_capabilities);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IDevice", "getCapabilities_1_3", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwDevice::_hidl_getSupportedOperations_1_3(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::android::hardware::neuralnetworks::V1_3::Model* model;
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::neuralnetworks::V1_3::Model &>(*model),
            _hidl_data,
            _hidl_model_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDevice::getSupportedOperations_1_3::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)model);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IDevice", "getSupportedOperations_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDevice*>(_hidl_this->getImpl().get())->getSupportedOperations_1_3(*model, [&](const auto &_hidl_out_status, const auto &_hidl_out_supportedOperations) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("getSupportedOperations_1_3: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_supportedOperations);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IDevice", "getSupportedOperations_1_3", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("getSupportedOperations_1_3: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwDevice::_hidl_prepareModel_1_3(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::android::sp<::android::hardware::neuralnetworks::V1_3::IPreparedModelCallback> callback;
...

    {
        ...
        callback = ::android::hardware::fromBinder<::android::hardware::neuralnetworks::V1_3::IPreparedModelCallback,::android::hardware::neuralnetworks::V1_3::BpHwPreparedModelCallback,::android::hardware::neuralnetworks::V1_3::BnHwPreparedModelCallback>(_hidl_binder);
    }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDevice::prepareModel_1_3::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)model);
        ...
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IDevice", "prepareModel_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::neuralnetworks::V1_3::ErrorStatus _hidl_out_status = static_cast<IDevice*>(_hidl_this->getImpl().get())->prepareModel_1_3(*model, preference, priority, *deadline, *modelCache, *dataCache, *token, callback);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IDevice", "prepareModel_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwDevice::_hidl_prepareModelFromCache_1_3(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDevice::prepareModelFromCache_1_3::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)deadline);
        ...
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IDevice", "prepareModelFromCache_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::neuralnetworks::V1_3::ErrorStatus _hidl_out_status = static_cast<IDevice*>(_hidl_this->getImpl().get())->prepareModelFromCache_1_3(*deadline, *modelCache, *dataCache, *token, callback);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IDevice", "prepareModelFromCache_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwDevice::_hidl_allocate(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::android::hardware::neuralnetworks::V1_3::BufferDesc* desc;
    ::android::hardware::hidl_vec<::android::sp<::android::hardware::neuralnetworks::V1_3::IPreparedModel>> preparedModels;
    const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_3::BufferRole>* inputRoles;
    const ::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_3::BufferRole>* outputRoles;

    size_t _hidl_desc_parent;

    _hidl_err = _hidl_data.readBuffer(sizeof(*desc), &_hidl_desc_parent,  const_cast<const void**>(reinterpret_cast<void **>(&desc)));
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::neuralnetworks::V1_3::BufferDesc &>(*desc),
            _hidl_data,
            _hidl_desc_parent,
            0 /* parentOffset */);
    ...
    {
        uint64_t _hidl_preparedModels_size;
        _hidl_err = _hidl_data.readUint64(&_hidl_preparedModels_size);
        if (_hidl_err != ::android::OK) { return _hidl_err; }

        preparedModels.resize(_hidl_preparedModels_size);

        for (size_t _hidl_index = 0; _hidl_index < _hidl_preparedModels_size; ++_hidl_index) {
            ::android::sp<::android::hardware::neuralnetworks::V1_3::IPreparedModel> _hidl_base;
            {
                ::android::sp<::android::hardware::IBinder> _hidl_binder;
                _hidl_err = _hidl_data.readNullableStrongBinder(&_hidl_binder);
                if (_hidl_err != ::android::OK) { return _hidl_err; }

                _hidl_base = ::android::hardware::fromBinder<::android::hardware::neuralnetworks::V1_3::IPreparedModel,::android::hardware::neuralnetworks::V1_3::BpHwPreparedModel,::android::hardware::neuralnetworks::V1_3::BnHwPreparedModel>(_hidl_binder);
            }

            preparedModels[_hidl_index] = _hidl_base;
        }
    }
    size_t _hidl_inputRoles_parent;

    _hidl_err = _hidl_data.readBuffer(sizeof(*inputRoles), &_hidl_inputRoles_parent,  reinterpret_cast<const void **>(&inputRoles));
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_3::BufferRole> &>(*inputRoles),
            _hidl_data,
            _hidl_inputRoles_parent,
            0 /* parentOffset */, &_hidl_inputRoles_child);
    ...
    _hidl_err = _hidl_data.readBuffer(sizeof(*outputRoles), &_hidl_outputRoles_parent,  reinterpret_cast<const void **>(&outputRoles));
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::neuralnetworks::V1_3::BufferRole> &>(*outputRoles),
            _hidl_data,
            _hidl_outputRoles_parent,
            0 /* parentOffset */, &_hidl_outputRoles_child);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IDevice::allocate::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)desc);
        ...
        _hidl_args.push_back((void *)outputRoles);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.3", "IDevice", "allocate", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDevice*>(_hidl_this->getImpl().get())->allocate(*desc, preparedModels, *inputRoles, *outputRoles, [&](const auto &_hidl_out_status, const auto &_hidl_out_buffer, const auto &_hidl_out_token) {
        if (_hidl_callbackCalled) {
        ...
        if (_hidl_out_buffer == nullptr) {
            _hidl_err = _hidl_reply->writeStrongBinder(nullptr);
        } else {
            ::android::sp<::android::hardware::IBinder> _hidl_binder = ::android::hardware::getOrCreateCachedBinder(_hidl_out_buffer.get());
            if (_hidl_binder.get() != nullptr) {
        ...
        _hidl_err = _hidl_reply->writeUint32(_hidl_out_token);
        if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_token);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.3", "IDevice", "allocate", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwDevice::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 16 /* getCapabilities_1_3 */:
        {
            _hidl_err = ::android::hardware::neuralnetworks::V1_3::BnHwDevice::_hidl_getCapabilities_1_3(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 17 /* getSupportedOperations_1_3 */:
        {
            _hidl_err = ::android::hardware::neuralnetworks::V1_3::BnHwDevice::_hidl_getSupportedOperations_1_3(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 18 /* prepareModel_1_3 */:
        {
            _hidl_err = ::android::hardware::neuralnetworks::V1_3::BnHwDevice::_hidl_prepareModel_1_3(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 19 /* prepareModelFromCache_1_3 */:
        {
            _hidl_err = ::android::hardware::neuralnetworks::V1_3::BnHwDevice::_hidl_prepareModelFromCache_1_3(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 20 /* allocate */:
        {
            _hidl_err = ::android::hardware::neuralnetworks::V1_3::BnHwDevice::_hidl_allocate(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsDevice::BsDevice(const ::android::sp<::android::hardware::neuralnetworks::V1_3::IDevice> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.3", "IDevice"), mImpl(impl) {
...
bool IDevice::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.neuralnetworks@1.3::IDevice",
