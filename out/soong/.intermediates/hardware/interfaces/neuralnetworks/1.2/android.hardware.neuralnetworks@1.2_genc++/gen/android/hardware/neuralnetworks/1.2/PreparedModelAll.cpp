...
#include <android/hardware/neuralnetworks/1.2/BnHwPreparedModel.h>
#include <android/hardware/neuralnetworks/1.2/BsPreparedModel.h>
...
const char* IPreparedModel::descriptor("android.hardware.neuralnetworks@1.2::IPreparedModel");
...
::android::hardware::Return<void> IPreparedModel::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::neuralnetworks::V1_2::IPreparedModel::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_2::IPreparedModel>> IPreparedModel::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_2::IPreparedModel>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_2::IPreparedModel>> IPreparedModel::castFrom(const ::android::sp<::android::hardware::neuralnetworks::V1_0::IPreparedModel>& parent, bool emitError) {
...
::android::hardware::Return<::android::sp<::android::hardware::neuralnetworks::V1_2::IPreparedModel>> IPreparedModel::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwPreparedModel::BpHwPreparedModel(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IPreparedModel>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.2", "IPreparedModel") {
}
...
// Methods from ::android::hardware::neuralnetworks::V1_2::IPreparedModel follow.
::android::hardware::Return<::android::hardware::neuralnetworks::V1_0::ErrorStatus> BpHwPreparedModel::_hidl_execute_1_2(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::neuralnetworks::V1_0::Request& request, ::android::hardware::neuralnetworks::V1_2::MeasureTiming measure, const ::android::sp<::android::hardware::neuralnetworks::V1_2::IExecutionCallback>& callback) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IPreparedModel::execute_1_2::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "execute_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* execute_1_2 */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "execute_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwPreparedModel::_hidl_executeSynchronously(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::neuralnetworks::V1_0::Request& request, ::android::hardware::neuralnetworks::V1_2::MeasureTiming measure, executeSynchronously_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IPreparedModel::executeSynchronously::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&request);
        _hidl_args.push_back((void *)&measure);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "executeSynchronously", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(3 /* executeSynchronously */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::neuralnetworks::V1_0::ErrorStatus _hidl_out_status;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "executeSynchronously", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwPreparedModel::_hidl_configureExecutionBurst(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::neuralnetworks::V1_2::IBurstCallback>& callback, const ::android::hardware::MQDescriptorSync<::android::hardware::neuralnetworks::V1_2::FmqRequestDatum>& requestChannel, const ::android::hardware::MQDescriptorSync<::android::hardware::neuralnetworks::V1_2::FmqResultDatum>& resultChannel, configureExecutionBurst_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IPreparedModel::configureExecutionBurst::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&callback);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "configureExecutionBurst", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    size_t _hidl_requestChannel_parent;

    _hidl_err = _hidl_data.writeBuffer(&requestChannel, sizeof(requestChannel), &_hidl_requestChannel_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_err = ::android::hardware::writeEmbeddedToParcel(
            requestChannel,
            &_hidl_data,
            _hidl_requestChannel_parent,
            0 /* parentOffset */);

    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_resultChannel_parent;

    _hidl_err = _hidl_data.writeBuffer(&resultChannel, sizeof(resultChannel), &_hidl_resultChannel_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_err = ::android::hardware::writeEmbeddedToParcel(
            resultChannel,
            &_hidl_data,
            _hidl_resultChannel_parent,
            0 /* parentOffset */);

    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    ::android::hardware::ProcessState::self()->startThreadPool();
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(4 /* configureExecutionBurst */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::neuralnetworks::V1_0::ErrorStatus _hidl_out_status;
        ::android::sp<::android::hardware::neuralnetworks::V1_2::IBurstContext> _hidl_out_context;
...

        {
            ...
            _hidl_out_context = ::android::hardware::fromBinder<::android::hardware::neuralnetworks::V1_2::IBurstContext,::android::hardware::neuralnetworks::V1_2::BpHwBurstContext,::android::hardware::neuralnetworks::V1_2::BnHwBurstContext>(_hidl_binder);
        }

        _hidl_cb(_hidl_out_status, _hidl_out_context);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "configureExecutionBurst", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwPreparedModel::BnHwPreparedModel(const ::android::sp<IPreparedModel> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.neuralnetworks@1.2", "IPreparedModel") { 
...
// Methods from ::android::hardware::neuralnetworks::V1_2::IPreparedModel follow.
::android::status_t BnHwPreparedModel::_hidl_execute_1_2(
    ...
    ::android::sp<::android::hardware::neuralnetworks::V1_2::IExecutionCallback> callback;
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::neuralnetworks::V1_0::Request &>(*request),
            _hidl_data,
            _hidl_request_parent,
            0 /* parentOffset */);
...

    {
        ...
        callback = ::android::hardware::fromBinder<::android::hardware::neuralnetworks::V1_2::IExecutionCallback,::android::hardware::neuralnetworks::V1_2::BpHwExecutionCallback,::android::hardware::neuralnetworks::V1_2::BnHwExecutionCallback>(_hidl_binder);
    }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IPreparedModel::execute_1_2::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)request);
        ...
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "execute_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::neuralnetworks::V1_0::ErrorStatus _hidl_out_status = static_cast<IPreparedModel*>(_hidl_this->getImpl().get())->execute_1_2(*request, measure, callback);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_status);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "execute_1_2", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwPreparedModel::_hidl_executeSynchronously(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IPreparedModel::executeSynchronously::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)request);
        _hidl_args.push_back((void *)&measure);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "executeSynchronously", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IPreparedModel*>(_hidl_this->getImpl().get())->executeSynchronously(*request, measure, [&](const auto &_hidl_out_status, const auto &_hidl_out_outputShapes, const auto &_hidl_out_timing) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("executeSynchronously: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_timing);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "executeSynchronously", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("executeSynchronously: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwPreparedModel::_hidl_configureExecutionBurst(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::android::sp<::android::hardware::neuralnetworks::V1_2::IBurstCallback> callback;
    const ::android::hardware::MQDescriptorSync<::android::hardware::neuralnetworks::V1_2::FmqRequestDatum>* requestChannel;
    const ::android::hardware::MQDescriptorSync<::android::hardware::neuralnetworks::V1_2::FmqResultDatum>* resultChannel;

    {
        ...
        callback = ::android::hardware::fromBinder<::android::hardware::neuralnetworks::V1_2::IBurstCallback,::android::hardware::neuralnetworks::V1_2::BpHwBurstCallback,::android::hardware::neuralnetworks::V1_2::BnHwBurstCallback>(_hidl_binder);
    }

    size_t _hidl_requestChannel_parent;

    _hidl_err = _hidl_data.readBuffer(sizeof(*requestChannel), &_hidl_requestChannel_parent,  reinterpret_cast<const void **>(&requestChannel));

    if (_hidl_err != ::android::OK) { return _hidl_err; }

    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::MQDescriptorSync<::android::hardware::neuralnetworks::V1_2::FmqRequestDatum> &>(*requestChannel),
            _hidl_data,
            _hidl_requestChannel_parent,
            0 /* parentOffset */);
    ...
    _hidl_err = _hidl_data.readBuffer(sizeof(*resultChannel), &_hidl_resultChannel_parent,  reinterpret_cast<const void **>(&resultChannel));

    if (_hidl_err != ::android::OK) { return _hidl_err; }

    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::MQDescriptorSync<::android::hardware::neuralnetworks::V1_2::FmqResultDatum> &>(*resultChannel),
            _hidl_data,
            _hidl_resultChannel_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IPreparedModel::configureExecutionBurst::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&callback);
        ...
        _hidl_args.push_back((void *)resultChannel);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "configureExecutionBurst", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IPreparedModel*>(_hidl_this->getImpl().get())->configureExecutionBurst(callback, *requestChannel, *resultChannel, [&](const auto &_hidl_out_status, const auto &_hidl_out_context) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("configureExecutionBurst: _hidl_cb called a second time, but must be called once.");
        }
        _hidl_callbackCalled = true;
        ...
        if (_hidl_out_context == nullptr) {
            _hidl_err = _hidl_reply->writeStrongBinder(nullptr);
        } else {
            ::android::sp<::android::hardware::IBinder> _hidl_binder = ::android::hardware::getOrCreateCachedBinder(_hidl_out_context.get());
            if (_hidl_binder.get() != nullptr) {
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_context);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.neuralnetworks", "1.2", "IPreparedModel", "configureExecutionBurst", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("configureExecutionBurst: _hidl_cb not called, but must be called once.");
    }
...
BsPreparedModel::BsPreparedModel(const ::android::sp<::android::hardware::neuralnetworks::V1_2::IPreparedModel> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.neuralnetworks@1.2", "IPreparedModel"), mImpl(impl) {
...
bool IPreparedModel::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.neuralnetworks@1.2::IPreparedModel",
