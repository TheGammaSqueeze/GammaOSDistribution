#define LOG_TAG "android.hardware.power@1.3::Power"
...
#include <android/hardware/power/1.3/BpHwPower.h>
#include <android/hardware/power/1.3/BnHwPower.h>
#include <android/hardware/power/1.3/BsPower.h>
...
const char* IPower::descriptor("android.hardware.power@1.3::IPower");
...
// no default implementation for: ::android::hardware::Return<void> IPower::powerHintAsync_1_3(::android::hardware::power::V1_3::PowerHint hint, int32_t data)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IPower::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::power::V1_3::IPower::descriptor,
...
::android::hardware::Return<void> IPower::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::power::V1_3::IPower::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IPower::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){90,70,78,109,181,63,173,34,57,134,214,85,2,138,24,24,91,115,219,142,43,250,150,99,249,4,44,150,35,235,10,160} /* 5a464e6db53fad223986d655028a18185b73db8e2bfa9663f9042c9623eb0aa0 */,
...
::android::hardware::Return<::android::sp<::android::hardware::power::V1_3::IPower>> IPower::castFrom(const ::android::sp<::android::hardware::power::V1_3::IPower>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::power::V1_3::IPower>> IPower::castFrom(const ::android::sp<::android::hardware::power::V1_2::IPower>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IPower, ::android::hardware::power::V1_2::IPower, BpHwPower>(
            parent, "android.hardware.power@1.3::IPower", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::power::V1_3::IPower>> IPower::castFrom(const ::android::sp<::android::hardware::power::V1_1::IPower>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IPower, ::android::hardware::power::V1_1::IPower, BpHwPower>(
            parent, "android.hardware.power@1.3::IPower", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::power::V1_3::IPower>> IPower::castFrom(const ::android::sp<::android::hardware::power::V1_0::IPower>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IPower, ::android::hardware::power::V1_0::IPower, BpHwPower>(
            parent, "android.hardware.power@1.3::IPower", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::power::V1_3::IPower>> IPower::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwPower::BpHwPower(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IPower>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.power@1.3", "IPower") {
}
...
// Methods from ::android::hardware::power::V1_3::IPower follow.
::android::hardware::Return<void> BpHwPower::_hidl_powerHintAsync_1_3(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::power::V1_3::PowerHint hint, int32_t data) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IPower::powerHintAsync_1_3::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.power", "1.3", "IPower", "powerHintAsync_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(8 /* powerHintAsync_1_3 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.power", "1.3", "IPower", "powerHintAsync_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::power::V1_3::IPower follow.
::android::hardware::Return<void> BpHwPower::powerHintAsync_1_3(::android::hardware::power::V1_3::PowerHint hint, int32_t data){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::power::V1_3::BpHwPower::_hidl_powerHintAsync_1_3(this, this, hint, data);
...
BnHwPower::BnHwPower(const ::android::sp<IPower> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.power@1.3", "IPower") { 
...
// Methods from ::android::hardware::power::V1_3::IPower follow.
::android::status_t BnHwPower::_hidl_powerHintAsync_1_3(
    ...
    ::android::hardware::power::V1_3::PowerHint hint;
    int32_t data;
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IPower::powerHintAsync_1_3::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&hint);
        _hidl_args.push_back((void *)&data);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.power", "1.3", "IPower", "powerHintAsync_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IPower*>(_hidl_this->getImpl().get())->powerHintAsync_1_3(hint, data);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.power", "1.3", "IPower", "powerHintAsync_1_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwPower::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 8 /* powerHintAsync_1_3 */:
        {
            _hidl_err = ::android::hardware::power::V1_3::BnHwPower::_hidl_powerHintAsync_1_3(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsPower::BsPower(const ::android::sp<::android::hardware::power::V1_3::IPower> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.power@1.3", "IPower"), mImpl(impl) {
...
bool IPower::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.power@1.3::IPower",
