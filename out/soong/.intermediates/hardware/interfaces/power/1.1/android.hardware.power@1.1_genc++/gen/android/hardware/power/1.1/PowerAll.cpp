#define LOG_TAG "android.hardware.power@1.1::Power"
...
#include <android/hardware/power/1.1/BnHwPower.h>
#include <android/hardware/power/1.1/BsPower.h>
...
const char* IPower::descriptor("android.hardware.power@1.1::IPower");
...
::android::hardware::Return<void> IPower::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::power::V1_1::IPower::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::power::V1_1::IPower>> IPower::castFrom(const ::android::sp<::android::hardware::power::V1_1::IPower>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::power::V1_1::IPower>> IPower::castFrom(const ::android::sp<::android::hardware::power::V1_0::IPower>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IPower, ::android::hardware::power::V1_0::IPower, BpHwPower>(
            parent, "android.hardware.power@1.1::IPower", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::power::V1_1::IPower>> IPower::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwPower::BpHwPower(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IPower>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.power@1.1", "IPower") {
}
...
// Methods from ::android::hardware::power::V1_1::IPower follow.
::android::hardware::Return<void> BpHwPower::_hidl_getSubsystemLowPowerStats(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getSubsystemLowPowerStats_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IPower::getSubsystemLowPowerStats::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.power", "1.1", "IPower", "getSubsystemLowPowerStats", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(5 /* getSubsystemLowPowerStats */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        const ::android::hardware::hidl_vec<::android::hardware::power::V1_1::PowerStateSubsystem>* _hidl_out_subsystems;
        ...
        size_t _hidl__hidl_out_subsystems_parent;

        _hidl_err = _hidl_reply.readBuffer(sizeof(*_hidl_out_subsystems), &_hidl__hidl_out_subsystems_parent,  reinterpret_cast<const void **>(&_hidl_out_subsystems));

        if (_hidl_err != ::android::OK) { return; }

        size_t _hidl__hidl_out_subsystems_child;

        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::hidl_vec<::android::hardware::power::V1_1::PowerStateSubsystem> &>(*_hidl_out_subsystems),
                _hidl_reply,
                _hidl__hidl_out_subsystems_parent,
                0 /* parentOffset */, &_hidl__hidl_out_subsystems_child);

        if (_hidl_err != ::android::OK) { return; }

        for (size_t _hidl_index_0 = 0; _hidl_index_0 < _hidl_out_subsystems->size(); ++_hidl_index_0) {
            _hidl_err = readEmbeddedFromParcel(
                    const_cast<::android::hardware::power::V1_1::PowerStateSubsystem &>((*_hidl_out_subsystems)[_hidl_index_0]),
                    _hidl_reply,
                    _hidl__hidl_out_subsystems_child,
                    _hidl_index_0 * sizeof(::android::hardware::power::V1_1::PowerStateSubsystem));
        ...
        _hidl_cb(*_hidl_out_subsystems, _hidl_out_retval);

        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            _hidl_args.push_back((void *)_hidl_out_subsystems);
            _hidl_args.push_back((void *)&_hidl_out_retval);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.power", "1.1", "IPower", "getSubsystemLowPowerStats", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwPower::_hidl_powerHintAsync(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::power::V1_0::PowerHint hint, int32_t data) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IPower::powerHintAsync::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.power", "1.1", "IPower", "powerHintAsync", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(6 /* powerHintAsync */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.power", "1.1", "IPower", "powerHintAsync", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BnHwPower::BnHwPower(const ::android::sp<IPower> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.power@1.1", "IPower") { 
...
// Methods from ::android::hardware::power::V1_1::IPower follow.
::android::status_t BnHwPower::_hidl_getSubsystemLowPowerStats(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IPower::getSubsystemLowPowerStats::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.power", "1.1", "IPower", "getSubsystemLowPowerStats", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IPower*>(_hidl_this->getImpl().get())->getSubsystemLowPowerStats([&](const auto &_hidl_out_subsystems, const auto &_hidl_out_retval) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("getSubsystemLowPowerStats: _hidl_cb called a second time, but must be called once.");
        }
        ...
        _hidl_err = _hidl_reply->writeBuffer(&_hidl_out_subsystems, sizeof(_hidl_out_subsystems), &_hidl__hidl_out_subsystems_parent);
        if (_hidl_err != ::android::OK) { goto _hidl_error; }

        size_t _hidl__hidl_out_subsystems_child;

        _hidl_err = ::android::hardware::writeEmbeddedToParcel(
                _hidl_out_subsystems,
                _hidl_reply,
                _hidl__hidl_out_subsystems_parent,
                0 /* parentOffset */, &_hidl__hidl_out_subsystems_child);
        ...
        for (size_t _hidl_index_0 = 0; _hidl_index_0 < _hidl_out_subsystems.size(); ++_hidl_index_0) {
            _hidl_err = writeEmbeddedToParcel(
                    _hidl_out_subsystems[_hidl_index_0],
                    _hidl_reply,
                    _hidl__hidl_out_subsystems_child,
                    _hidl_index_0 * sizeof(::android::hardware::power::V1_1::PowerStateSubsystem));
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_retval);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.power", "1.1", "IPower", "getSubsystemLowPowerStats", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("getSubsystemLowPowerStats: _hidl_cb not called, but must be called once.");
    }

    return _hidl_err;
}

::android::status_t BnHwPower::_hidl_powerHintAsync(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IPower::powerHintAsync::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&hint);
        _hidl_args.push_back((void *)&data);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.power", "1.1", "IPower", "powerHintAsync", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IPower*>(_hidl_this->getImpl().get())->powerHintAsync(hint, data);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.power", "1.1", "IPower", "powerHintAsync", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
BsPower::BsPower(const ::android::sp<::android::hardware::power::V1_1::IPower> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.power@1.1", "IPower"), mImpl(impl) {
...
bool IPower::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.power@1.1::IPower",
