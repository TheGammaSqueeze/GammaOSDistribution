package android.hardware.secure_element.V1_2;

public interface ISecureElement extends android.hardware.secure_element.V1_1.ISecureElement {
    /**
     * Fully-qualified interface name for this interface.
     */
    public static final String kInterfaceName = "android.hardware.secure_element@1.2::ISecureElement";
    ...
    public static ISecureElement getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISecureElement.asInterface(android.os.HwBinder.getService("android.hardware.secure_element@1.2::ISecureElement", serviceName, retry));
    }
    ...
    public static ISecureElement getService(String serviceName) throws android.os.RemoteException {
        return ISecureElement.asInterface(android.os.HwBinder.getService("android.hardware.secure_element@1.2::ISecureElement", serviceName));
    }
    ...
    public static final class Proxy implements ISecureElement {
        ...
        @Override
        public void init_1_1(android.hardware.secure_element.V1_1.ISecureElementHalCallback clientCallback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.secure_element.V1_1.ISecureElement.kInterfaceName);
            _hidl_request.writeStrongBinder(clientCallback == null ? null : clientCallback.asBinder());

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(8 /* init_1_1 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
        ...
        public byte reset()
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.secure_element.V1_2.ISecureElement.kInterfaceName);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(9 /* reset */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISecureElement {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.secure_element.V1_2.ISecureElement.kInterfaceName,
                    android.hardware.secure_element.V1_1.ISecureElement.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.secure_element.V1_2.ISecureElement.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-62,-52,25,46,-36,-62,34,-95,43,82,79,-80,-32,-25,-15,126,-14,-76,-115,107,28,11,-25,-74,11,-63,20,96,23,-109,-41,-87} /* c2cc192edcc222a12b524fb0e0e7f17ef2b48d6b1c0be7b60bc114601793d7a9 */,
                    new byte[/* 32 */]{8,-44,57,-60,99,-28,4,79,-89,-120,116,3,125,-114,-125,121,-86,60,-85,-20,-34,50,-16,-118,119,88,-105,-18,-91,-91,56,-81} /* 08d439c463e4044fa78874037d8e8379aa3cabecde32f08a775897eea5a538af */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 8 /* init_1_1 */:
                {
                    _hidl_request.enforceInterface(android.hardware.secure_element.V1_1.ISecureElement.kInterfaceName);

                    android.hardware.secure_element.V1_1.ISecureElementHalCallback clientCallback = android.hardware.secure_element.V1_1.ISecureElementHalCallback.asInterface(_hidl_request.readStrongBinder());
                    init_1_1(clientCallback);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.send();
                    break;
                }
                ...
                case 9 /* reset */:
                {
                    _hidl_request.enforceInterface(android.hardware.secure_element.V1_2.ISecureElement.kInterfaceName);

                    byte _hidl_out_status = reset();
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt8(_hidl_out_status);
                    _hidl_reply.send();
                    break;
