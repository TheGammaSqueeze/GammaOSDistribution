...
public final class CoolingDevice {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.thermal.V1_0.CoolingDevice.class) {
            return false;
        }
        android.hardware.thermal.V1_0.CoolingDevice other = (android.hardware.thermal.V1_0.CoolingDevice)otherObject;
    ...
    public final String toString() {
        ...
        builder.append("{");
        builder.append(".type = ");
        builder.append(android.hardware.thermal.V1_0.CoolingType.toString(this.type));
        builder.append(", .name = ");
    ...
    public static final java.util.ArrayList<CoolingDevice> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.thermal.V1_0.CoolingDevice _hidl_vec_element = new android.hardware.thermal.V1_0.CoolingDevice();
                ((android.hardware.thermal.V1_0.CoolingDevice) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 32);
