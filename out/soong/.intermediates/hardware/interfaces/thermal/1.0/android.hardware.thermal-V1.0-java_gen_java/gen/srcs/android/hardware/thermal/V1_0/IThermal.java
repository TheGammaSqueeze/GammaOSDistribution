...
public interface IThermal extends android.hidl.base.V1_0.IBase {
    /**
    ...
    public static IThermal getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IThermal.asInterface(android.os.HwBinder.getService("android.hardware.thermal@1.0::IThermal", serviceName, retry));
    }
    ...
    public static IThermal getService(String serviceName) throws android.os.RemoteException {
        return IThermal.asInterface(android.os.HwBinder.getService("android.hardware.thermal@1.0::IThermal", serviceName));
    }
     ...
     *
     */
    void getTemperatures(getTemperaturesCallback _hidl_cb)
     ...
     *
     */
    void getCpuUsages(getCpuUsagesCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     *
     */
    void getCoolingDevices(getCoolingDevicesCallback _hidl_cb)
        throws android.os.RemoteException;
    /*
