...
public interface IThermal extends android.hardware.thermal.V1_0.IThermal {
    ...
    public static IThermal getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IThermal.asInterface(android.os.HwBinder.getService("android.hardware.thermal@1.1::IThermal", serviceName, retry));
    }
    ...
    public static IThermal getService(String serviceName) throws android.os.RemoteException {
        return IThermal.asInterface(android.os.HwBinder.getService("android.hardware.thermal@1.1::IThermal", serviceName));
    }
     ...
     */
    void registerThermalCallback(android.hardware.thermal.V1_1.IThermalCallback callback)
    ...
    public static final class Proxy implements IThermal {
        ...
        @Override
        public void registerThermalCallback(android.hardware.thermal.V1_1.IThermalCallback callback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.thermal.V1_1.IThermal.kInterfaceName);
            _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(4 /* registerThermalCallback */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IThermal {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.thermal.V1_1.IThermal.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.thermal.V1_1.IThermal.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-12,-108,94,57,123,93,-22,65,-69,100,81,-115,-3,-27,-101,-25,18,69,-40,-95,37,-3,30,10,-49,-2,-75,122,-57,-80,-113,-19} /* f4945e397b5dea41bb64518dfde59be71245d8a125fd1e0acffeb57ac7b08fed */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 4 /* registerThermalCallback */:
                {
                    _hidl_request.enforceInterface(android.hardware.thermal.V1_1.IThermal.kInterfaceName);

                    android.hardware.thermal.V1_1.IThermalCallback callback = android.hardware.thermal.V1_1.IThermalCallback.asInterface(_hidl_request.readStrongBinder());
