...
::android::hardware::Return<void> IAllocator::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::graphics::allocator::V2_0::IAllocator::descriptor,
...
::android::hardware::Return<void> IAllocator::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::graphics::allocator::V2_0::IAllocator::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::graphics::allocator::V2_0::IAllocator>> IAllocator::castFrom(const ::android::sp<::android::hardware::graphics::allocator::V2_0::IAllocator>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::graphics::allocator::V2_0::IAllocator>> IAllocator::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BsAllocator::BsAllocator(const ::android::sp<::android::hardware::graphics::allocator::V2_0::IAllocator> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.graphics.allocator@2.0", "IAllocator"), mImpl(impl) {
