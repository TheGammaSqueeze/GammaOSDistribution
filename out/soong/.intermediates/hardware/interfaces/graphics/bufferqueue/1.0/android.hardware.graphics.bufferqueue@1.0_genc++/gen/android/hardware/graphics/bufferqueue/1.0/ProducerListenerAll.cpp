...
::android::hardware::Return<void> BpHwProducerListener::_hidl_onBufferReleased(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IProducerListener::onBufferReleased::client");
    #ifdef __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* onBufferReleased */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
...
::android::hardware::Return<bool> BpHwProducerListener::_hidl_needsReleaseNotify(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IProducerListener::needsReleaseNotify::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* needsReleaseNotify */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
...
::android::status_t BnHwProducerListener::_hidl_onBufferReleased(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IProducerListener*>(_hidl_this->getImpl().get())->onBufferReleased();
