#define LOG_TAG "android.hardware.graphics.composer@2.3::Composer"
...
#include <android/hardware/graphics/composer/2.3/BnHwComposer.h>
#include <android/hardware/graphics/composer/2.3/BsComposer.h>
...
const char* IComposer::descriptor("android.hardware.graphics.composer@2.3::IComposer");
...
::android::hardware::Return<void> IComposer::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::graphics::composer::V2_3::IComposer::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>> IComposer::castFrom(const ::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>> IComposer::castFrom(const ::android::sp<::android::hardware::graphics::composer::V2_2::IComposer>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IComposer, ::android::hardware::graphics::composer::V2_2::IComposer, BpHwComposer>(
            parent, "android.hardware.graphics.composer@2.3::IComposer", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>> IComposer::castFrom(const ::android::sp<::android::hardware::graphics::composer::V2_1::IComposer>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IComposer, ::android::hardware::graphics::composer::V2_1::IComposer, BpHwComposer>(
            parent, "android.hardware.graphics.composer@2.3::IComposer", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>> IComposer::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwComposer::BpHwComposer(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IComposer>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.graphics.composer@2.3", "IComposer") {
}
...
// Methods from ::android::hardware::graphics::composer::V2_3::IComposer follow.
::android::hardware::Return<void> BpHwComposer::_hidl_createClient_2_3(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, createClient_2_3_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IComposer::createClient_2_3::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.graphics.composer", "2.3", "IComposer", "createClient_2_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(4 /* createClient_2_3 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::graphics::composer::V2_1::Error _hidl_out_error;
        ::android::sp<::android::hardware::graphics::composer::V2_3::IComposerClient> _hidl_out_client;
...

        {
            ...
            _hidl_out_client = ::android::hardware::fromBinder<::android::hardware::graphics::composer::V2_3::IComposerClient,::android::hardware::graphics::composer::V2_3::BpHwComposerClient,::android::hardware::graphics::composer::V2_3::BnHwComposerClient>(_hidl_binder);
        }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.graphics.composer", "2.3", "IComposer", "createClient_2_3", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
BnHwComposer::BnHwComposer(const ::android::sp<IComposer> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.graphics.composer@2.3", "IComposer") { 
...
// Methods from ::android::hardware::graphics::composer::V2_3::IComposer follow.
::android::status_t BnHwComposer::_hidl_createClient_2_3(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IComposer::createClient_2_3::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.graphics.composer", "2.3", "IComposer", "createClient_2_3", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IComposer*>(_hidl_this->getImpl().get())->createClient_2_3([&](const auto &_hidl_out_error, const auto &_hidl_out_client) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("createClient_2_3: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_client);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.graphics.composer", "2.3", "IComposer", "createClient_2_3", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("createClient_2_3: _hidl_cb not called, but must be called once.");
    }
...
BsComposer::BsComposer(const ::android::sp<::android::hardware::graphics::composer::V2_3::IComposer> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.graphics.composer@2.3", "IComposer"), mImpl(impl) {
...
bool IComposer::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.graphics.composer@2.3::IComposer",
