#define LOG_TAG "android.hardware.graphics.composer@2.4::Composer"
...
#include <android/hardware/graphics/composer/2.4/BpHwComposer.h>
#include <android/hardware/graphics/composer/2.4/BnHwComposer.h>
#include <android/hardware/graphics/composer/2.4/BsComposer.h>
#include <android/hardware/graphics/composer/2.3/BpHwComposer.h>
...
const char* IComposer::descriptor("android.hardware.graphics.composer@2.4::IComposer");
...
// no default implementation for: ::android::hardware::Return<void> IComposer::createClient_2_3(createClient_2_3_cb _hidl_cb)

// Methods from ::android::hardware::graphics::composer::V2_4::IComposer follow.
// no default implementation for: ::android::hardware::Return<void> IComposer::createClient_2_4(createClient_2_4_cb _hidl_cb)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IComposer::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::graphics::composer::V2_4::IComposer::descriptor,
        ::android::hardware::graphics::composer::V2_3::IComposer::descriptor,
...
::android::hardware::Return<void> IComposer::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::graphics::composer::V2_4::IComposer::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IComposer::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){10,144,198,101,96,93,243,215,215,176,252,175,204,65,120,195,52,90,110,75,167,227,20,143,239,228,151,54,41,130,116,99} /* 0a90c665605df3d7d7b0fcafcc4178c3345a6e4ba7e3148fefe4973629827463 */,
        (uint8_t[32]){61,255,4,163,107,134,102,11,88,7,65,69,135,229,48,187,12,41,78,213,111,223,240,111,137,21,186,10,155,115,249,116} /* 3dff04a36b86660b5807414587e530bb0c294ed56fdff06f8915ba0a9b73f974 */,
...
::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_4::IComposer>> IComposer::castFrom(const ::android::sp<::android::hardware::graphics::composer::V2_4::IComposer>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_4::IComposer>> IComposer::castFrom(const ::android::sp<::android::hardware::graphics::composer::V2_3::IComposer>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IComposer, ::android::hardware::graphics::composer::V2_3::IComposer, BpHwComposer>(
            parent, "android.hardware.graphics.composer@2.4::IComposer", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_4::IComposer>> IComposer::castFrom(const ::android::sp<::android::hardware::graphics::composer::V2_2::IComposer>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IComposer, ::android::hardware::graphics::composer::V2_2::IComposer, BpHwComposer>(
            parent, "android.hardware.graphics.composer@2.4::IComposer", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_4::IComposer>> IComposer::castFrom(const ::android::sp<::android::hardware::graphics::composer::V2_1::IComposer>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IComposer, ::android::hardware::graphics::composer::V2_1::IComposer, BpHwComposer>(
            parent, "android.hardware.graphics.composer@2.4::IComposer", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::graphics::composer::V2_4::IComposer>> IComposer::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwComposer::BpHwComposer(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IComposer>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.graphics.composer@2.4", "IComposer") {
}
...
// Methods from ::android::hardware::graphics::composer::V2_4::IComposer follow.
::android::hardware::Return<void> BpHwComposer::_hidl_createClient_2_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, createClient_2_4_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IComposer::createClient_2_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.graphics.composer", "2.4", "IComposer", "createClient_2_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(5 /* createClient_2_4 */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::graphics::composer::V2_4::Error _hidl_out_error;
        ::android::sp<::android::hardware::graphics::composer::V2_4::IComposerClient> _hidl_out_client;
...

        {
            ...
            _hidl_out_client = ::android::hardware::fromBinder<::android::hardware::graphics::composer::V2_4::IComposerClient,::android::hardware::graphics::composer::V2_4::BpHwComposerClient,::android::hardware::graphics::composer::V2_4::BnHwComposerClient>(_hidl_binder);
        }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.graphics.composer", "2.4", "IComposer", "createClient_2_4", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::graphics::composer::V2_3::IComposer follow.
::android::hardware::Return<void> BpHwComposer::createClient_2_3(createClient_2_3_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::graphics::composer::V2_3::BpHwComposer::_hidl_createClient_2_3(this, this, _hidl_cb);
...
// Methods from ::android::hardware::graphics::composer::V2_4::IComposer follow.
::android::hardware::Return<void> BpHwComposer::createClient_2_4(createClient_2_4_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::graphics::composer::V2_4::BpHwComposer::_hidl_createClient_2_4(this, this, _hidl_cb);
...
BnHwComposer::BnHwComposer(const ::android::sp<IComposer> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.graphics.composer@2.4", "IComposer") { 
...
// Methods from ::android::hardware::graphics::composer::V2_4::IComposer follow.
::android::status_t BnHwComposer::_hidl_createClient_2_4(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IComposer::createClient_2_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.graphics.composer", "2.4", "IComposer", "createClient_2_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IComposer*>(_hidl_this->getImpl().get())->createClient_2_4([&](const auto &_hidl_out_error, const auto &_hidl_out_client) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("createClient_2_4: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_client);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.graphics.composer", "2.4", "IComposer", "createClient_2_4", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("createClient_2_4: _hidl_cb not called, but must be called once.");
    }
...
::android::status_t BnHwComposer::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 4 /* createClient_2_3 */:
        {
            _hidl_err = ::android::hardware::graphics::composer::V2_3::BnHwComposer::_hidl_createClient_2_3(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 5 /* createClient_2_4 */:
        {
            _hidl_err = ::android::hardware::graphics::composer::V2_4::BnHwComposer::_hidl_createClient_2_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsComposer::BsComposer(const ::android::sp<::android::hardware::graphics::composer::V2_4::IComposer> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.graphics.composer@2.4", "IComposer"), mImpl(impl) {
...
bool IComposer::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.graphics.composer@2.4::IComposer",
