...
struct IComposer : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.graphics.composer@2.1::IComposer"
     */
...
static inline void PrintTo(::android::hardware::graphics::composer::V2_1::IComposer::Capability o, ::std::ostream* os);
...
template<> inline constexpr std::array<::android::hardware::graphics::composer::V2_1::IComposer::Capability, 4> hidl_enum_values<::android::hardware::graphics::composer::V2_1::IComposer::Capability> = {
