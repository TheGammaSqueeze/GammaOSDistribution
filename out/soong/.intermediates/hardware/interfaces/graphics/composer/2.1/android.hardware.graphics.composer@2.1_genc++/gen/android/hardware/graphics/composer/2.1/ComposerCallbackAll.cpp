...
::android::hardware::Return<void> BpHwComposerCallback::_hidl_onHotplug(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display, ::android::hardware::graphics::composer::V2_1::IComposerCallback::Connection connected) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IComposerCallback::onHotplug::client");
    #ifdef __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* onHotplug */, _hidl_data, &_hidl_reply, 0 /* flags */);
...
::android::hardware::Return<void> BpHwComposerCallback::_hidl_onRefresh(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display) {
    ...
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IComposerCallback::onRefresh::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&display);
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* onRefresh */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
...
::android::hardware::Return<void> BpHwComposerCallback::_hidl_onVsync(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint64_t display, int64_t timestamp) {
    ...
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IComposerCallback::onVsync::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&display);
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(3 /* onVsync */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
...
::android::status_t BnHwComposerCallback::_hidl_onHotplug(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IComposerCallback*>(_hidl_this->getImpl().get())->onHotplug(display, connected);
...
::android::status_t BnHwComposerCallback::_hidl_onRefresh(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IComposerCallback*>(_hidl_this->getImpl().get())->onRefresh(display);
...
::android::status_t BnHwComposerCallback::_hidl_onVsync(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IComposerCallback*>(_hidl_this->getImpl().get())->onVsync(display, timestamp);
