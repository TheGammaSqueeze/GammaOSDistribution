...
::android::hardware::Return<void> IMapper::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::graphics::mapper::V2_0::IMapper::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::graphics::mapper::V2_0::IMapper>> IMapper::castFrom(const ::android::sp<::android::hardware::graphics::mapper::V2_0::IMapper>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::graphics::mapper::V2_0::IMapper>> IMapper::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
// Methods from ::android::hardware::graphics::mapper::V2_0::IMapper follow.
::android::hardware::Return<void> BpHwMapper::_hidl_createDescriptor(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::graphics::mapper::V2_0::IMapper::BufferDescriptorInfo& descriptorInfo, createDescriptor_cb _hidl_cb) {
...
::android::hardware::Return<::android::hardware::graphics::mapper::V2_0::Error> BpHwMapper::_hidl_freeBuffer(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, void* buffer) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
...
::android::hardware::Return<void> BpHwMapper::_hidl_lock(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, void* buffer, ::android::hardware::hidl_bitfield<::android::hardware::graphics::common::V1_0::BufferUsage> cpuUsage, const ::android::hardware::graphics::mapper::V2_0::IMapper::Rect& accessRegion, const ::android::hardware::hidl_handle& acquireFence, lock_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(4 /* lock */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::graphics::mapper::V2_0::Error _hidl_out_error;
        void* _hidl_out_data;
...
::android::hardware::Return<void> BpHwMapper::_hidl_lockYCbCr(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, void* buffer, ::android::hardware::hidl_bitfield<::android::hardware::graphics::common::V1_0::BufferUsage> cpuUsage, const ::android::hardware::graphics::mapper::V2_0::IMapper::Rect& accessRegion, const ::android::hardware::hidl_handle& acquireFence, lockYCbCr_cb _hidl_cb) {
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(5 /* lockYCbCr */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::graphics::mapper::V2_0::Error _hidl_out_error;
        ::android::hardware::graphics::mapper::V2_0::YCbCrLayout* _hidl_out_layout;
        ...
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::graphics::mapper::V2_0::YCbCrLayout &>(*_hidl_out_layout),
                _hidl_reply,
...
::android::hardware::Return<void> BpHwMapper::_hidl_unlock(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, void* buffer, unlock_cb _hidl_cb) {
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(6 /* unlock */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::graphics::mapper::V2_0::Error _hidl_out_error;
...
::android::status_t BnHwMapper::_hidl_createDescriptor(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IMapper*>(_hidl_this->getImpl().get())->createDescriptor(*descriptorInfo, [&](const auto &_hidl_out_error, const auto &_hidl_out_descriptor) {
...
::android::status_t BnHwMapper::_hidl_freeBuffer(
    ...
    ::android::hardware::graphics::mapper::V2_0::Error _hidl_out_error = static_cast<IMapper*>(_hidl_this->getImpl().get())->freeBuffer(buffer);
...
::android::status_t BnHwMapper::_hidl_lock(
    ...
    void* buffer;
    ::android::hardware::hidl_bitfield<::android::hardware::graphics::common::V1_0::BufferUsage> cpuUsage;
    ::android::hardware::graphics::mapper::V2_0::IMapper::Rect* accessRegion;
...
BsMapper::BsMapper(const ::android::sp<::android::hardware::graphics::mapper::V2_0::IMapper> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.graphics.mapper@2.0", "IMapper"), mImpl(impl) {
