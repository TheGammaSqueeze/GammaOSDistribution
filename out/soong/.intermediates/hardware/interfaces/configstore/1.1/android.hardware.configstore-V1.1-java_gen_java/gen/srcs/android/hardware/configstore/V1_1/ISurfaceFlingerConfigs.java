...
public interface ISurfaceFlingerConfigs extends android.hardware.configstore.V1_0.ISurfaceFlingerConfigs {
    ...
    public static ISurfaceFlingerConfigs getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISurfaceFlingerConfigs.asInterface(android.os.HwBinder.getService("android.hardware.configstore@1.1::ISurfaceFlingerConfigs", serviceName, retry));
    }
    ...
    public static ISurfaceFlingerConfigs getService(String serviceName) throws android.os.RemoteException {
        return ISurfaceFlingerConfigs.asInterface(android.os.HwBinder.getService("android.hardware.configstore@1.1::ISurfaceFlingerConfigs", serviceName));
    }
     ...
     */
    android.hardware.configstore.V1_1.OptionalDisplayOrientation primaryDisplayOrientation()
    ...
    public static final class Proxy implements ISurfaceFlingerConfigs {
        ...
        @Override
        public android.hardware.configstore.V1_1.OptionalDisplayOrientation primaryDisplayOrientation()
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.kInterfaceName);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(13 /* primaryDisplayOrientation */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();

                android.hardware.configstore.V1_1.OptionalDisplayOrientation _hidl_out_value = new android.hardware.configstore.V1_1.OptionalDisplayOrientation();
                ((android.hardware.configstore.V1_1.OptionalDisplayOrientation) _hidl_out_value).readFromParcel(_hidl_reply);
                return _hidl_out_value;
            } finally {
                _hidl_reply.release();
            }
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISurfaceFlingerConfigs {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-8,88,9,27,16,-9,-43,-110,123,-26,5,115,-64,109,-12,-128,82,117,-45,114,38,-69,-76,26,115,33,-112,-65,-72,20,87,-20} /* f858091b10f7d5927be60573c06df4805275d37226bbb41a732190bfb81457ec */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                {
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.kInterfaceName);

                    android.hardware.configstore.V1_1.OptionalDisplayOrientation _hidl_out_value = primaryDisplayOrientation();
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    ((android.hardware.configstore.V1_1.OptionalDisplayOrientation) _hidl_out_value).writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    break;
                }
