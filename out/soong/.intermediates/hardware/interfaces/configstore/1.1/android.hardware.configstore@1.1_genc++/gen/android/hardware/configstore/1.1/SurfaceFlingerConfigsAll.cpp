#define LOG_TAG "android.hardware.configstore@1.1::SurfaceFlingerConfigs"
...
#include <android/hardware/configstore/1.1/BpHwSurfaceFlingerConfigs.h>
#include <android/hardware/configstore/1.1/BnHwSurfaceFlingerConfigs.h>
#include <android/hardware/configstore/1.1/BsSurfaceFlingerConfigs.h>
...
const char* ISurfaceFlingerConfigs::descriptor("android.hardware.configstore@1.1::ISurfaceFlingerConfigs");
...
// no default implementation for: ::android::hardware::Return<void> ISurfaceFlingerConfigs::primaryDisplayOrientation(primaryDisplayOrientation_cb _hidl_cb)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> ISurfaceFlingerConfigs::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::configstore::V1_1::ISurfaceFlingerConfigs::descriptor,
...
::android::hardware::Return<void> ISurfaceFlingerConfigs::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::configstore::V1_1::ISurfaceFlingerConfigs::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> ISurfaceFlingerConfigs::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){248,88,9,27,16,247,213,146,123,230,5,115,192,109,244,128,82,117,211,114,38,187,180,26,115,33,144,191,184,20,87,236} /* f858091b10f7d5927be60573c06df4805275d37226bbb41a732190bfb81457ec */,
...
::android::hardware::Return<::android::sp<::android::hardware::configstore::V1_1::ISurfaceFlingerConfigs>> ISurfaceFlingerConfigs::castFrom(const ::android::sp<::android::hardware::configstore::V1_1::ISurfaceFlingerConfigs>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::configstore::V1_1::ISurfaceFlingerConfigs>> ISurfaceFlingerConfigs::castFrom(const ::android::sp<::android::hardware::configstore::V1_0::ISurfaceFlingerConfigs>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ISurfaceFlingerConfigs, ::android::hardware::configstore::V1_0::ISurfaceFlingerConfigs, BpHwSurfaceFlingerConfigs>(
            parent, "android.hardware.configstore@1.1::ISurfaceFlingerConfigs", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::configstore::V1_1::ISurfaceFlingerConfigs>> ISurfaceFlingerConfigs::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwSurfaceFlingerConfigs::BpHwSurfaceFlingerConfigs(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ISurfaceFlingerConfigs>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.configstore@1.1", "ISurfaceFlingerConfigs") {
}
...
// Methods from ::android::hardware::configstore::V1_1::ISurfaceFlingerConfigs follow.
::android::hardware::Return<void> BpHwSurfaceFlingerConfigs::_hidl_primaryDisplayOrientation(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, primaryDisplayOrientation_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ISurfaceFlingerConfigs::primaryDisplayOrientation::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.configstore", "1.1", "ISurfaceFlingerConfigs", "primaryDisplayOrientation", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(13 /* primaryDisplayOrientation */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::configstore::V1_1::OptionalDisplayOrientation* _hidl_out_value;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.configstore", "1.1", "ISurfaceFlingerConfigs", "primaryDisplayOrientation", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::configstore::V1_1::ISurfaceFlingerConfigs follow.
::android::hardware::Return<void> BpHwSurfaceFlingerConfigs::primaryDisplayOrientation(primaryDisplayOrientation_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::configstore::V1_1::BpHwSurfaceFlingerConfigs::_hidl_primaryDisplayOrientation(this, this, _hidl_cb);
...
BnHwSurfaceFlingerConfigs::BnHwSurfaceFlingerConfigs(const ::android::sp<ISurfaceFlingerConfigs> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.configstore@1.1", "ISurfaceFlingerConfigs") { 
...
// Methods from ::android::hardware::configstore::V1_1::ISurfaceFlingerConfigs follow.
::android::status_t BnHwSurfaceFlingerConfigs::_hidl_primaryDisplayOrientation(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::ISurfaceFlingerConfigs::primaryDisplayOrientation::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.configstore", "1.1", "ISurfaceFlingerConfigs", "primaryDisplayOrientation", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ISurfaceFlingerConfigs*>(_hidl_this->getImpl().get())->primaryDisplayOrientation([&](const auto &_hidl_out_value) {
        if (_hidl_callbackCalled) {
            LOG_ALWAYS_FATAL("primaryDisplayOrientation: _hidl_cb called a second time, but must be called once.");
        }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_value);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.configstore", "1.1", "ISurfaceFlingerConfigs", "primaryDisplayOrientation", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_ret.assertOk();
    if (!_hidl_callbackCalled) {
        LOG_ALWAYS_FATAL("primaryDisplayOrientation: _hidl_cb not called, but must be called once.");
    }
...
::android::status_t BnHwSurfaceFlingerConfigs::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 13 /* primaryDisplayOrientation */:
        {
            _hidl_err = ::android::hardware::configstore::V1_1::BnHwSurfaceFlingerConfigs::_hidl_primaryDisplayOrientation(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsSurfaceFlingerConfigs::BsSurfaceFlingerConfigs(const ::android::sp<::android::hardware::configstore::V1_1::ISurfaceFlingerConfigs> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.configstore@1.1", "ISurfaceFlingerConfigs"), mImpl(impl) {
...
bool ISurfaceFlingerConfigs::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.configstore@1.1::ISurfaceFlingerConfigs",
