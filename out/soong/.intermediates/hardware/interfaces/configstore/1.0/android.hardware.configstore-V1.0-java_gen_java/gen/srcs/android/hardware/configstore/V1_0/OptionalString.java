...
public final class OptionalString {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.configstore.V1_0.OptionalString.class) {
            return false;
        }
    ...
    public static final java.util.ArrayList<OptionalString> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<OptionalString> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((android.hardware.configstore.V1_0.OptionalString) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<OptionalString> _hidl_vec) {
