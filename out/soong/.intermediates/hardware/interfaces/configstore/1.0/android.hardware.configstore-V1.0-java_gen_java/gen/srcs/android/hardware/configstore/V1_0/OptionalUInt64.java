...
public final class OptionalUInt64 {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.configstore.V1_0.OptionalUInt64.class) {
            return false;
        }
        android.hardware.configstore.V1_0.OptionalUInt64 other = (android.hardware.configstore.V1_0.OptionalUInt64)otherObject;
    ...
    public static final java.util.ArrayList<OptionalUInt64> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.configstore.V1_0.OptionalUInt64 _hidl_vec_element = new android.hardware.configstore.V1_0.OptionalUInt64();
                ((android.hardware.configstore.V1_0.OptionalUInt64) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 16);
