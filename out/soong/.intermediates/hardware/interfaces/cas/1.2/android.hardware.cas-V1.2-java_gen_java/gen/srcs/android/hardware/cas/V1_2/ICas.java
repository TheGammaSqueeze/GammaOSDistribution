...
public interface ICas extends android.hardware.cas.V1_1.ICas {
    ...
    public static ICas getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ICas.asInterface(android.os.HwBinder.getService("android.hardware.cas@1.2::ICas", serviceName, retry));
    }
    ...
    public static ICas getService(String serviceName) throws android.os.RemoteException {
        return ICas.asInterface(android.os.HwBinder.getService("android.hardware.cas@1.2::ICas", serviceName));
    }
     ...
     */
    void openSession_1_2(int intent, int mode, openSession_1_2Callback _hidl_cb)
    ...
    public static final class Proxy implements ICas {
        ...
        @Override
        public int sendSessionEvent(java.util.ArrayList<Byte> sessionId, int event, int arg, java.util.ArrayList<Byte> eventData)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(11 /* sendSessionEvent */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public void openSession_1_2(int intent, int mode, openSession_1_2Callback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.cas.V1_2.ICas.kInterfaceName);
            _hidl_request.writeInt32(intent);
            _hidl_request.writeInt32(mode);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(12 /* openSession_1_2 */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements ICas {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.cas.V1_2.ICas.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.cas.V1_2.ICas.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-63,-86,80,-115,0,-74,110,-43,-2,-17,-22,57,-113,-43,-19,-14,-113,-90,81,-84,-119,119,58,-38,-41,-33,-38,78,10,115,-87,82} /* c1aa508d00b66ed5feefea398fd5edf28fa651ac89773adad7dfda4e0a73a952 */,
                    new byte[/* 32 */]{68,-56,-119,84,-77,-62,1,-78,111,100,-4,-37,111,39,-128,36,-85,58,-82,-122,74,-98,30,-57,14,-118,116,39,74,-23,-42,-86} /* 44c88954b3c201b26f64fcdb6f278024ab3aae864a9e1ec70e8a74274ae9d6aa */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 11 /* sendSessionEvent */:
                {
                    ...
                    int arg = _hidl_request.readInt32();
                    java.util.ArrayList<Byte> eventData = _hidl_request.readInt8Vector();
                    int _hidl_out_status = sendSessionEvent(sessionId, event, arg, eventData);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_status);
                    _hidl_reply.send();
                    break;
                ...
                case 12 /* openSession_1_2 */:
                {
                    _hidl_request.enforceInterface(android.hardware.cas.V1_2.ICas.kInterfaceName);

                    int intent = _hidl_request.readInt32();
                    int mode = _hidl_request.readInt32();
                    openSession_1_2(intent, mode, new openSession_1_2Callback() {
                        @Override
                        public void onValues(int status, java.util.ArrayList<Byte> sessionId) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            _hidl_reply.writeInt32(status);
