...
public interface ICas extends android.hardware.cas.V1_0.ICas {
    ...
    public static ICas getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ICas.asInterface(android.os.HwBinder.getService("android.hardware.cas@1.1::ICas", serviceName, retry));
    }
    ...
    public static ICas getService(String serviceName) throws android.os.RemoteException {
        return ICas.asInterface(android.os.HwBinder.getService("android.hardware.cas@1.1::ICas", serviceName));
    }
     ...
     */
    int sendSessionEvent(java.util.ArrayList<Byte> sessionId, int event, int arg, java.util.ArrayList<Byte> eventData)
