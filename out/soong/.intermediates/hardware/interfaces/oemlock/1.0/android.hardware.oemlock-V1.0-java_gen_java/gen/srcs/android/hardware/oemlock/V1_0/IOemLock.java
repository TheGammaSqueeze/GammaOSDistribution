...
public interface IOemLock extends android.hidl.base.V1_0.IBase {
     ...
     */
    /* package private */ static IOemLock asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        IOemLock proxy = new IOemLock.Proxy(binder);
     ...
     */
    public static IOemLock castFrom(android.os.IHwInterface iface) {
        return (iface == null) ? null : IOemLock.asInterface(iface.asBinder());
    }
     ...
     */
    public static IOemLock getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IOemLock.asInterface(android.os.HwBinder.getService("android.hardware.oemlock@1.0::IOemLock", serviceName, retry));
    }

    /**
     * Calls getService("default",retry).
     */
    public static IOemLock getService(boolean retry) throws android.os.RemoteException {
     ...
     */
    @Deprecated
    public static IOemLock getService(String serviceName) throws android.os.RemoteException {
        return IOemLock.asInterface(android.os.HwBinder.getService("android.hardware.oemlock@1.0::IOemLock", serviceName));
    }
     ...
     */
    @Deprecated
    public static IOemLock getService() throws android.os.RemoteException {
     ...
     */
    void getName(getNameCallback _hidl_cb)
     ...
     */
    int setOemUnlockAllowedByCarrier(boolean allowed, java.util.ArrayList<Byte> signature)
        throws android.os.RemoteException;
     ...
     */
    void isOemUnlockAllowedByCarrier(isOemUnlockAllowedByCarrierCallback _hidl_cb)
        throws android.os.RemoteException;
    /**
     ...
     * @return status is OK if the flag was successfully updated.
     */
    int setOemUnlockAllowedByDevice(boolean allowed)
        throws android.os.RemoteException;
     ...
     * @return allowed is the current state of the flag.
     */
    void isOemUnlockAllowedByDevice(isOemUnlockAllowedByDeviceCallback _hidl_cb)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements IOemLock {
        ...
        public String toString() {
            ...
            return "[class or subclass of " + IOemLock.kInterfaceName + "]@Proxy";
        }
        ...
        @Override
        public int setOemUnlockAllowedByCarrier(boolean allowed, java.util.ArrayList<Byte> signature)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.oemlock.V1_0.IOemLock.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(2 /* setOemUnlockAllowedByCarrier */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void isOemUnlockAllowedByCarrier(isOemUnlockAllowedByCarrierCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.oemlock.V1_0.IOemLock.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(3 /* isOemUnlockAllowedByCarrier */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public int setOemUnlockAllowedByDevice(boolean allowed)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.oemlock.V1_0.IOemLock.kInterfaceName);
            _hidl_request.writeBool(allowed);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(4 /* setOemUnlockAllowedByDevice */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public void isOemUnlockAllowedByDevice(isOemUnlockAllowedByDeviceCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.oemlock.V1_0.IOemLock.kInterfaceName);
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(5 /* isOemUnlockAllowedByDevice */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IOemLock {
        @Override
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.oemlock.V1_0.IOemLock.kInterfaceName,
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{75,101,118,54,99,-87,74,57,32,19,64,17,105,31,-113,-69,66,-52,-73,-73,121,85,-119,-17,-35,-64,73,-87,16,96,71,-42} /* 4b65763663a94a3920134011691f8fbb42ccb7b7795589efddc049a9106047d6 */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 2 /* setOemUnlockAllowedByCarrier */:
                {
                    _hidl_request.enforceInterface(android.hardware.oemlock.V1_0.IOemLock.kInterfaceName);

                    boolean allowed = _hidl_request.readBool();
                    java.util.ArrayList<Byte> signature = _hidl_request.readInt8Vector();
                ...
                case 3 /* isOemUnlockAllowedByCarrier */:
                {
                    _hidl_request.enforceInterface(android.hardware.oemlock.V1_0.IOemLock.kInterfaceName);
                ...
                case 4 /* setOemUnlockAllowedByDevice */:
                {
                    _hidl_request.enforceInterface(android.hardware.oemlock.V1_0.IOemLock.kInterfaceName);

                    boolean allowed = _hidl_request.readBool();
                    int _hidl_out_status = setOemUnlockAllowedByDevice(allowed);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                    _hidl_reply.writeInt32(_hidl_out_status);
                    _hidl_reply.send();
                    break;
                ...
                case 5 /* isOemUnlockAllowedByDevice */:
                {
                    _hidl_request.enforceInterface(android.hardware.oemlock.V1_0.IOemLock.kInterfaceName);
