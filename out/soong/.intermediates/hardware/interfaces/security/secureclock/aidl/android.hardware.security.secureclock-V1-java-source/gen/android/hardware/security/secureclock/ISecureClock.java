...
public interface ISecureClock extends android.os.IInterface
{
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.security.secureclock.ISecureClock
  {
    ...
    private static class Proxy implements android.hardware.security.secureclock.ISecureClock
    {
        ...
        try {
          ...
          if (!_status) {
            if (getDefaultImpl() != null) {
              return getDefaultImpl().generateTimeStamp(challenge);
            }
            else {
          ...
          if ((0!=_reply.readInt())) {
            _result = android.hardware.security.secureclock.TimeStampToken.CREATOR.createFromParcel(_reply);
          }
          else {
            _result = null;
          }
      ...
      public static android.hardware.security.secureclock.ISecureClock sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(android.hardware.security.secureclock.ISecureClock impl) {
    ...
    public static android.hardware.security.secureclock.ISecureClock getDefaultImpl() {
