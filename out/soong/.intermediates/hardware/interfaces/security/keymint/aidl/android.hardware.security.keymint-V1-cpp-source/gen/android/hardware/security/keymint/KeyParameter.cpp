...
::android::status_t KeyParameter::readFromParcel(const ::android::Parcel* _aidl_parcel) {
  ...
  _aidl_ret_status = _aidl_parcel->readInt32(reinterpret_cast<int32_t *>(&tag));
...
::android::status_t KeyParameter::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  auto _aidl_start_pos = _aidl_parcel->dataPosition();
  _aidl_parcel->writeInt32(0);
  _aidl_ret_status = _aidl_parcel->writeInt32(static_cast<int32_t>(tag));
  if (((_aidl_ret_status) != (::android::OK))) {
    return _aidl_ret_status;
  }
