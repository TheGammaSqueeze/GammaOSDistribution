...
public interface IBiometricsFingerprint extends android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint {
    ...
    public static IBiometricsFingerprint getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IBiometricsFingerprint.asInterface(android.os.HwBinder.getService("android.hardware.biometrics.fingerprint@2.3::IBiometricsFingerprint", serviceName, retry));
    }
    ...
    public static IBiometricsFingerprint getService(String serviceName) throws android.os.RemoteException {
        return IBiometricsFingerprint.asInterface(android.os.HwBinder.getService("android.hardware.biometrics.fingerprint@2.3::IBiometricsFingerprint", serviceName));
    }
    ...
    public static final class Proxy implements IBiometricsFingerprint {
        ...
        public boolean isUdfps(int sensorId)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(11 /* isUdfps */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
        ...
        public void onFingerDown(int x, int y, float minor, float major)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(12 /* onFingerDown */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
        ...
        public void onFingerUp()
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(13 /* onFingerUp */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IBiometricsFingerprint {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.biometrics.fingerprint.V2_3.IBiometricsFingerprint.kInterfaceName,
                    android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint.kInterfaceName,
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{122,120,-23,-106,59,-20,11,7,30,125,70,-110,-116,97,0,-30,23,66,112,-119,45,63,21,-95,-22,-83,7,73,-105,-83,-14,121} /* 7a78e9963bec0b071e7d46928c6100e2174270892d3f15a1eaad074997adf279 */,
                    new byte[/* 32 */]{20,15,-113,98,16,12,-49,-100,-46,-126,-82,54,-123,-96,-12,-17,10,-97,-105,29,119,-33,-68,115,80,-52,-76,-32,76,-14,-107,-20} /* 140f8f62100ccf9cd282ae3685a0f4ef0a9f971d77dfbc7350ccb4e04cf295ec */,
