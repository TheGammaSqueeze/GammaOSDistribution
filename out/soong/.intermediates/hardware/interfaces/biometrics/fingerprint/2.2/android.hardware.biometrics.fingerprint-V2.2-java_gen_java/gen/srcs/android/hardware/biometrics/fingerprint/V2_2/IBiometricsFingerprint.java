...
public interface IBiometricsFingerprint extends android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint {
    ...
    public static IBiometricsFingerprint getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IBiometricsFingerprint.asInterface(android.os.HwBinder.getService("android.hardware.biometrics.fingerprint@2.2::IBiometricsFingerprint", serviceName, retry));
    }
    ...
    public static IBiometricsFingerprint getService(String serviceName) throws android.os.RemoteException {
        return IBiometricsFingerprint.asInterface(android.os.HwBinder.getService("android.hardware.biometrics.fingerprint@2.2::IBiometricsFingerprint", serviceName));
    }
    ...
    public static abstract class Stub extends android.os.HwBinder implements IBiometricsFingerprint {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint.kInterfaceName;
