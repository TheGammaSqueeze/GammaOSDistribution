...
public interface IBiometricsFingerprintClientCallback extends android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback {
    ...
    public static IBiometricsFingerprintClientCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IBiometricsFingerprintClientCallback.asInterface(android.os.HwBinder.getService("android.hardware.biometrics.fingerprint@2.2::IBiometricsFingerprintClientCallback", serviceName, retry));
    }
    ...
    public static IBiometricsFingerprintClientCallback getService(String serviceName) throws android.os.RemoteException {
        return IBiometricsFingerprintClientCallback.asInterface(android.os.HwBinder.getService("android.hardware.biometrics.fingerprint@2.2::IBiometricsFingerprintClientCallback", serviceName));
    }
     ...
     */
    void onAcquired_2_2(long deviceId, int acquiredInfo, int vendorCode)
    ...
    public static final class Proxy implements IBiometricsFingerprintClientCallback {
        ...
        public void onAcquired_2_2(long deviceId, int acquiredInfo, int vendorCode)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(7 /* onAcquired_2_2 */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
    ...
    public static abstract class Stub extends android.os.HwBinder implements IBiometricsFingerprintClientCallback {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback.kInterfaceName,
                    android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.kInterfaceName,
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-126,-54,-39,-97,95,-21,46,-87,-68,-44,87,-112,85,-19,-12,-81,-113,-21,-97,-58,2,-90,-28,-126,125,-35,114,125,37,77,73,-111} /* 82cad99f5feb2ea9bcd4579055edf4af8feb9fc602a6e4827ddd727d254d4991 */,
