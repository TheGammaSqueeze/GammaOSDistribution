...
public final class FingerprintAuthenticated {
    ...
    public static final java.util.ArrayList<FingerprintAuthenticated> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((android.hardware.biometrics.fingerprint.V2_1.FingerprintAuthenticated) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 80);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId) finger).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        {
