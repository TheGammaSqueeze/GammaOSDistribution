...
public interface IBiometricsFingerprintClientCallback extends android.hidl.base.V1_0.IBase {
    ...
    public static IBiometricsFingerprintClientCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IBiometricsFingerprintClientCallback.asInterface(android.os.HwBinder.getService("android.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback", serviceName, retry));
    }
    ...
    public static abstract class Stub extends android.os.HwBinder implements IBiometricsFingerprintClientCallback {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.kInterfaceName;
