    ...
    public static final java.util.ArrayList<FingerprintFingerId> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId _hidl_vec_element = new android.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId();
                ((android.hardware.biometrics.fingerprint.V2_1.FingerprintFingerId) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 8);
