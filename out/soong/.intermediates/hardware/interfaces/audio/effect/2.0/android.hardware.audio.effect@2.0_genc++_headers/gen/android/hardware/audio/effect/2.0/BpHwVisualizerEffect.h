#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWVISUALIZEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWVISUALIZEREFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/2.0/IHwVisualizerEffect.h>
...
struct BpHwVisualizerEffect : public ::android::hardware::BpInterface<IVisualizerEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result>  _hidl_setCaptureSize(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint16_t captureSize);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result>  _hidl_setScalingMode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::effect::V2_0::IVisualizerEffect::ScalingMode scalingMode);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result>  _hidl_setLatency(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t latencyMs);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V2_0::Result>  _hidl_setMeasurementMode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::effect::V2_0::IVisualizerEffect::MeasurementMode measurementMode);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V2_0_BPHWVISUALIZEREFFECT_H
