#define LOG_TAG "android.hardware.audio.effect@4.0::LoudnessEnhancerEffect"
...
#include <android/hardware/audio/effect/4.0/BpHwLoudnessEnhancerEffect.h>
#include <android/hardware/audio/effect/4.0/BnHwLoudnessEnhancerEffect.h>
#include <android/hardware/audio/effect/4.0/BsLoudnessEnhancerEffect.h>
...
const char* ILoudnessEnhancerEffect::descriptor("android.hardware.audio.effect@4.0::ILoudnessEnhancerEffect");
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::init()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setConfig(const ::android::hardware::audio::effect::V4_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& outputBufferProvider)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::reset()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::enable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::disable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V4_0::AudioDevice> device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setAudioMode(::android::hardware::audio::common::V4_0::AudioMode mode)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setConfigReverse(const ::android::hardware::audio::effect::V4_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& outputBufferProvider)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setInputDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V4_0::AudioDevice> device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V4_0::EffectAuxChannelsConfig& config)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setAudioSource(::android::hardware::audio::common::V4_0::AudioSource source)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::offload(const ::android::hardware::audio::effect::V4_0::EffectOffloadParameter& param)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setProcessBuffers(const ::android::hardware::audio::effect::V4_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V4_0::AudioBuffer& outBuffer)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::close()

// Methods from ::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect follow.
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> ILoudnessEnhancerEffect::setTargetGain(int32_t targetGainMb)
...
::android::hardware::Return<void> ILoudnessEnhancerEffect::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect::descriptor,
...
::android::hardware::Return<void> ILoudnessEnhancerEffect::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> ILoudnessEnhancerEffect::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){169,27,84,127,89,34,243,159,228,35,29,151,250,193,195,130,92,28,27,12,142,247,165,19,102,137,206,237,55,232,191,233} /* a91b547f5922f39fe4231d97fac1c3825c1c1b0c8ef7a5136689ceed37e8bfe9 */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect>> ILoudnessEnhancerEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect>> ILoudnessEnhancerEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::IEffect>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<ILoudnessEnhancerEffect, ::android::hardware::audio::effect::V4_0::IEffect, BpHwLoudnessEnhancerEffect>(
            parent, "android.hardware.audio.effect@4.0::ILoudnessEnhancerEffect", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect>> ILoudnessEnhancerEffect::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwLoudnessEnhancerEffect::BpHwLoudnessEnhancerEffect(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<ILoudnessEnhancerEffect>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@4.0", "ILoudnessEnhancerEffect") {
}
...
// Methods from ::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::_hidl_setTargetGain(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t targetGainMb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "ILoudnessEnhancerEffect", "setTargetGain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "ILoudnessEnhancerEffect", "setTargetGain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwLoudnessEnhancerEffect::_hidl_getTargetGain(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getTargetGain_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "ILoudnessEnhancerEffect", "getTargetGain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(30 /* getTargetGain */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "ILoudnessEnhancerEffect", "getTargetGain", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::audio::effect::V4_0::IEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::init(){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setConfig(const ::android::hardware::audio::effect::V4_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& outputBufferProvider){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::reset(){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::enable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::disable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V4_0::AudioDevice> device){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setAudioMode(::android::hardware::audio::common::V4_0::AudioMode mode){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setConfigReverse(const ::android::hardware::audio::effect::V4_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& outputBufferProvider){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setInputDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V4_0::AudioDevice> device){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V4_0::EffectAuxChannelsConfig& config){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setAudioSource(::android::hardware::audio::common::V4_0::AudioSource source){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::offload(const ::android::hardware::audio::effect::V4_0::EffectOffloadParameter& param){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setProcessBuffers(const ::android::hardware::audio::effect::V4_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V4_0::AudioBuffer& outBuffer){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::close(){
...
// Methods from ::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwLoudnessEnhancerEffect::setTargetGain(int32_t targetGainMb){
    ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwLoudnessEnhancerEffect::_hidl_setTargetGain(this, this, targetGainMb);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwLoudnessEnhancerEffect::getTargetGain(getTargetGain_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwLoudnessEnhancerEffect::_hidl_getTargetGain(this, this, _hidl_cb);
...
BnHwLoudnessEnhancerEffect::BnHwLoudnessEnhancerEffect(const ::android::sp<ILoudnessEnhancerEffect> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio.effect@4.0", "ILoudnessEnhancerEffect") { 
...
::android::status_t BnHwLoudnessEnhancerEffect::_hidl_setTargetGain(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&targetGainMb);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "ILoudnessEnhancerEffect", "setTargetGain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::effect::V4_0::Result _hidl_out_retval = static_cast<ILoudnessEnhancerEffect*>(_hidl_this->getImpl().get())->setTargetGain(targetGainMb);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "ILoudnessEnhancerEffect", "setTargetGain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwLoudnessEnhancerEffect::_hidl_getTargetGain(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "ILoudnessEnhancerEffect", "getTargetGain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_targetGainMb);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "ILoudnessEnhancerEffect", "getTargetGain", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwLoudnessEnhancerEffect::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwLoudnessEnhancerEffect::_hidl_setTargetGain(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 30 /* getTargetGain */:
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwLoudnessEnhancerEffect::_hidl_getTargetGain(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsLoudnessEnhancerEffect::BsLoudnessEnhancerEffect(const ::android::sp<::android::hardware::audio::effect::V4_0::ILoudnessEnhancerEffect> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@4.0", "ILoudnessEnhancerEffect"), mImpl(impl) {
...
bool ILoudnessEnhancerEffect::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio.effect@4.0::ILoudnessEnhancerEffect",
