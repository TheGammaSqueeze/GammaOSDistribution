#define LOG_TAG "android.hardware.audio.effect@4.0::EffectsFactory"
...
#include <android/hardware/audio/effect/4.0/BpHwEffectsFactory.h>
#include <android/hardware/audio/effect/4.0/BnHwEffectsFactory.h>
#include <android/hardware/audio/effect/4.0/BsEffectsFactory.h>
...
const char* IEffectsFactory::descriptor("android.hardware.audio.effect@4.0::IEffectsFactory");
...
// Methods from ::android::hardware::audio::effect::V4_0::IEffectsFactory follow.
...
// no default implementation for: ::android::hardware::Return<void> IEffectsFactory::getDescriptor(const ::android::hardware::audio::common::V4_0::Uuid& uid, getDescriptor_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<void> IEffectsFactory::createEffect(const ::android::hardware::audio::common::V4_0::Uuid& uid, int32_t session, int32_t ioHandle, createEffect_cb _hidl_cb)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IEffectsFactory::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::effect::V4_0::IEffectsFactory::descriptor,
...
::android::hardware::Return<void> IEffectsFactory::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::effect::V4_0::IEffectsFactory::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IEffectsFactory::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){90,116,110,129,23,84,137,235,35,113,184,136,100,195,108,155,182,59,198,78,247,153,250,231,76,217,96,3,176,19,192,209} /* 5a746e81175489eb2371b88864c36c9bb63bc64ef799fae74cd96003b013c0d1 */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::IEffectsFactory>> IEffectsFactory::castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectsFactory>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::IEffectsFactory>> IEffectsFactory::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IEffectsFactory, ::android::hidl::base::V1_0::IBase, BpHwEffectsFactory>(
            parent, "android.hardware.audio.effect@4.0::IEffectsFactory", emitError);
}
...
BpHwEffectsFactory::BpHwEffectsFactory(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IEffectsFactory>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@4.0", "IEffectsFactory") {
}
...
::android::hardware::Return<void> BpHwEffectsFactory::_hidl_getAllDescriptors(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getAllDescriptors_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "getAllDescriptors", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* getAllDescriptors */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        const ::android::hardware::hidl_vec<::android::hardware::audio::effect::V4_0::EffectDescriptor>* _hidl_out_result;
        ...
        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::hidl_vec<::android::hardware::audio::effect::V4_0::EffectDescriptor> &>(*_hidl_out_result),
                _hidl_reply,
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "getAllDescriptors", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwEffectsFactory::_hidl_getDescriptor(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V4_0::Uuid& uid, getDescriptor_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "getDescriptor", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* getDescriptor */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::effect::V4_0::Result _hidl_out_retval;
        ::android::hardware::audio::effect::V4_0::EffectDescriptor* _hidl_out_result;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)_hidl_out_result);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "getDescriptor", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwEffectsFactory::_hidl_createEffect(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V4_0::Uuid& uid, int32_t session, int32_t ioHandle, createEffect_cb _hidl_cb) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "createEffect", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(3 /* createEffect */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::effect::V4_0::Result _hidl_out_retval;
        ::android::sp<::android::hardware::audio::effect::V4_0::IEffect> _hidl_out_result;
...

        {
            ...
            _hidl_out_result = ::android::hardware::fromBinder<::android::hardware::audio::effect::V4_0::IEffect,::android::hardware::audio::effect::V4_0::BpHwEffect,::android::hardware::audio::effect::V4_0::BnHwEffect>(_hidl_binder);
        }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "createEffect", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwEffectsFactory::getAllDescriptors(getAllDescriptors_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwEffectsFactory::_hidl_getAllDescriptors(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwEffectsFactory::getDescriptor(const ::android::hardware::audio::common::V4_0::Uuid& uid, getDescriptor_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwEffectsFactory::_hidl_getDescriptor(this, this, uid, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwEffectsFactory::createEffect(const ::android::hardware::audio::common::V4_0::Uuid& uid, int32_t session, int32_t ioHandle, createEffect_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwEffectsFactory::_hidl_createEffect(this, this, uid, session, ioHandle, _hidl_cb);
...
BnHwEffectsFactory::BnHwEffectsFactory(const ::android::sp<IEffectsFactory> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio.effect@4.0", "IEffectsFactory") { 
...
::android::status_t BnHwEffectsFactory::_hidl_getAllDescriptors(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "getAllDescriptors", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_result);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "getAllDescriptors", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwEffectsFactory::_hidl_getDescriptor(
    ...
    ::android::hardware::audio::common::V4_0::Uuid* uid;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)uid);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "getDescriptor", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_result);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "getDescriptor", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwEffectsFactory::_hidl_createEffect(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&ioHandle);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "createEffect", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IEffectsFactory*>(_hidl_this->getImpl().get())->createEffect(*uid, session, ioHandle, [&](const auto &_hidl_out_retval, const auto &_hidl_out_result, const auto &_hidl_out_effectId) {
        if (_hidl_callbackCalled) {
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_effectId);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "IEffectsFactory", "createEffect", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwEffectsFactory::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwEffectsFactory::_hidl_getAllDescriptors(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 2 /* getDescriptor */:
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwEffectsFactory::_hidl_getDescriptor(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 3 /* createEffect */:
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwEffectsFactory::_hidl_createEffect(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsEffectsFactory::BsEffectsFactory(const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectsFactory> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@4.0", "IEffectsFactory"), mImpl(impl) {
...
bool IEffectsFactory::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio.effect@4.0::IEffectsFactory",
