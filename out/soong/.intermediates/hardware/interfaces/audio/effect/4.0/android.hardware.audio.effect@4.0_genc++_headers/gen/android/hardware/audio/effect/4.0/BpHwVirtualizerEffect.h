#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWVIRTUALIZEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWVIRTUALIZEREFFECT_H
...
struct BpHwVirtualizerEffect : public ::android::hardware::BpInterface<IVirtualizerEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_getVirtualSpeakerAngles(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::hidl_bitfield<::android::hardware::audio::common::V4_0::AudioChannelMask> mask, ::android::hardware::audio::common::V4_0::AudioDevice device, getVirtualSpeakerAngles_cb _hidl_cb);
    static ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_forceVirtualizationMode(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::common::V4_0::AudioDevice device);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V4_0_BPHWVIRTUALIZEREFFECT_H
