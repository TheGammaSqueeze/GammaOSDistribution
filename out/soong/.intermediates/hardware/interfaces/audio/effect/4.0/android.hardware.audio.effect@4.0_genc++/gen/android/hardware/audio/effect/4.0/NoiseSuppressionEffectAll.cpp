#define LOG_TAG "android.hardware.audio.effect@4.0::NoiseSuppressionEffect"
...
#include <android/hardware/audio/effect/4.0/BpHwNoiseSuppressionEffect.h>
#include <android/hardware/audio/effect/4.0/BnHwNoiseSuppressionEffect.h>
#include <android/hardware/audio/effect/4.0/BsNoiseSuppressionEffect.h>
...
const char* INoiseSuppressionEffect::descriptor("android.hardware.audio.effect@4.0::INoiseSuppressionEffect");
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::init()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setConfig(const ::android::hardware::audio::effect::V4_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& outputBufferProvider)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::reset()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::enable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::disable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V4_0::AudioDevice> device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setAudioMode(::android::hardware::audio::common::V4_0::AudioMode mode)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setConfigReverse(const ::android::hardware::audio::effect::V4_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& outputBufferProvider)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setInputDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V4_0::AudioDevice> device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V4_0::EffectAuxChannelsConfig& config)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setAudioSource(::android::hardware::audio::common::V4_0::AudioSource source)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::offload(const ::android::hardware::audio::effect::V4_0::EffectOffloadParameter& param)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setProcessBuffers(const ::android::hardware::audio::effect::V4_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V4_0::AudioBuffer& outBuffer)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::close()

// Methods from ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect follow.
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setSuppressionLevel(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level level)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setSuppressionType(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type type)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> INoiseSuppressionEffect::setAllProperties(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& properties)
...
::android::hardware::Return<void> INoiseSuppressionEffect::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::descriptor,
...
::android::hardware::Return<void> INoiseSuppressionEffect::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> INoiseSuppressionEffect::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){17,69,245,185,33,221,236,24,79,218,91,220,135,72,123,70,242,168,156,217,244,44,200,130,187,179,165,79,74,200,4,102} /* 1145f5b921ddec184fda5bdc87487b46f2a89cd9f42cc882bbb3a54f4ac80466 */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect>> INoiseSuppressionEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect>> INoiseSuppressionEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V4_0::IEffect>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<INoiseSuppressionEffect, ::android::hardware::audio::effect::V4_0::IEffect, BpHwNoiseSuppressionEffect>(
            parent, "android.hardware.audio.effect@4.0::INoiseSuppressionEffect", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect>> INoiseSuppressionEffect::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwNoiseSuppressionEffect::BpHwNoiseSuppressionEffect(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<INoiseSuppressionEffect>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@4.0", "INoiseSuppressionEffect") {
}
...
// Methods from ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::_hidl_setSuppressionLevel(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level level) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setSuppressionLevel", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setSuppressionLevel", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwNoiseSuppressionEffect::_hidl_getSuppressionLevel(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getSuppressionLevel_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getSuppressionLevel", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(30 /* getSuppressionLevel */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::effect::V4_0::Result _hidl_out_retval;
        ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level _hidl_out_level;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getSuppressionLevel", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::_hidl_setSuppressionType(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type type) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setSuppressionType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setSuppressionType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwNoiseSuppressionEffect::_hidl_getSuppressionType(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getSuppressionType_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getSuppressionType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(32 /* getSuppressionType */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::effect::V4_0::Result _hidl_out_retval;
        ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type _hidl_out_type;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getSuppressionType", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::_hidl_setAllProperties(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& properties) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setAllProperties", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setAllProperties", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwNoiseSuppressionEffect::_hidl_getAllProperties(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getAllProperties_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getAllProperties", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(34 /* getAllProperties */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::effect::V4_0::Result _hidl_out_retval;
        ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties* _hidl_out_properties;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getAllProperties", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::audio::effect::V4_0::IEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::init(){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setConfig(const ::android::hardware::audio::effect::V4_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& outputBufferProvider){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::reset(){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::enable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::disable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V4_0::AudioDevice> device){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setAudioMode(::android::hardware::audio::common::V4_0::AudioMode mode){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setConfigReverse(const ::android::hardware::audio::effect::V4_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V4_0::IEffectBufferProviderCallback>& outputBufferProvider){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setInputDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V4_0::AudioDevice> device){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V4_0::EffectAuxChannelsConfig& config){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setAudioSource(::android::hardware::audio::common::V4_0::AudioSource source){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::offload(const ::android::hardware::audio::effect::V4_0::EffectOffloadParameter& param){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setProcessBuffers(const ::android::hardware::audio::effect::V4_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V4_0::AudioBuffer& outBuffer){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData){
...
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::close(){
...
// Methods from ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setSuppressionLevel(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level level){
    ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwNoiseSuppressionEffect::_hidl_setSuppressionLevel(this, this, level);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwNoiseSuppressionEffect::getSuppressionLevel(getSuppressionLevel_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwNoiseSuppressionEffect::_hidl_getSuppressionLevel(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setSuppressionType(::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type type){
    ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwNoiseSuppressionEffect::_hidl_setSuppressionType(this, this, type);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwNoiseSuppressionEffect::getSuppressionType(getSuppressionType_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwNoiseSuppressionEffect::_hidl_getSuppressionType(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result> BpHwNoiseSuppressionEffect::setAllProperties(const ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties& properties){
    ::android::hardware::Return<::android::hardware::audio::effect::V4_0::Result>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwNoiseSuppressionEffect::_hidl_setAllProperties(this, this, properties);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwNoiseSuppressionEffect::getAllProperties(getAllProperties_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V4_0::BpHwNoiseSuppressionEffect::_hidl_getAllProperties(this, this, _hidl_cb);
...
BnHwNoiseSuppressionEffect::BnHwNoiseSuppressionEffect(const ::android::sp<INoiseSuppressionEffect> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio.effect@4.0", "INoiseSuppressionEffect") { 
...
::android::status_t BnHwNoiseSuppressionEffect::_hidl_setSuppressionLevel(
    ...
    ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Level level;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&level);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setSuppressionLevel", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::effect::V4_0::Result _hidl_out_retval = static_cast<INoiseSuppressionEffect*>(_hidl_this->getImpl().get())->setSuppressionLevel(level);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setSuppressionLevel", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwNoiseSuppressionEffect::_hidl_getSuppressionLevel(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getSuppressionLevel", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_level);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getSuppressionLevel", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwNoiseSuppressionEffect::_hidl_setSuppressionType(
    ...
    ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::Type type;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&type);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setSuppressionType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::effect::V4_0::Result _hidl_out_retval = static_cast<INoiseSuppressionEffect*>(_hidl_this->getImpl().get())->setSuppressionType(type);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setSuppressionType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwNoiseSuppressionEffect::_hidl_getSuppressionType(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getSuppressionType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_type);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getSuppressionType", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwNoiseSuppressionEffect::_hidl_setAllProperties(
    ...
    ::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect::AllProperties* properties;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)properties);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setAllProperties", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::effect::V4_0::Result _hidl_out_retval = static_cast<INoiseSuppressionEffect*>(_hidl_this->getImpl().get())->setAllProperties(*properties);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "setAllProperties", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwNoiseSuppressionEffect::_hidl_getAllProperties(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getAllProperties", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_properties);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "4.0", "INoiseSuppressionEffect", "getAllProperties", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwNoiseSuppressionEffect::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwNoiseSuppressionEffect::_hidl_setSuppressionLevel(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 30 /* getSuppressionLevel */:
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwNoiseSuppressionEffect::_hidl_getSuppressionLevel(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 31 /* setSuppressionType */:
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwNoiseSuppressionEffect::_hidl_setSuppressionType(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 32 /* getSuppressionType */:
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwNoiseSuppressionEffect::_hidl_getSuppressionType(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 33 /* setAllProperties */:
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwNoiseSuppressionEffect::_hidl_setAllProperties(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 34 /* getAllProperties */:
        {
            _hidl_err = ::android::hardware::audio::effect::V4_0::BnHwNoiseSuppressionEffect::_hidl_getAllProperties(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsNoiseSuppressionEffect::BsNoiseSuppressionEffect(const ::android::sp<::android::hardware::audio::effect::V4_0::INoiseSuppressionEffect> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@4.0", "INoiseSuppressionEffect"), mImpl(impl) {
...
bool INoiseSuppressionEffect::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio.effect@4.0::INoiseSuppressionEffect",
