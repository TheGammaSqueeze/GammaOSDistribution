#define LOG_TAG "android.hardware.audio.effect@6.0::DownmixEffect"
...
#include <android/hardware/audio/effect/6.0/BpHwDownmixEffect.h>
#include <android/hardware/audio/effect/6.0/BnHwDownmixEffect.h>
#include <android/hardware/audio/effect/6.0/BsDownmixEffect.h>
...
const char* IDownmixEffect::descriptor("android.hardware.audio.effect@6.0::IDownmixEffect");
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::init()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setConfig(const ::android::hardware::audio::effect::V6_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& outputBufferProvider)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::reset()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::enable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::disable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setAudioMode(::android::hardware::audio::common::V6_0::AudioMode mode)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setConfigReverse(const ::android::hardware::audio::effect::V6_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& outputBufferProvider)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setInputDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V6_0::EffectAuxChannelsConfig& config)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setAudioSource(::android::hardware::audio::common::V6_0::AudioSource source)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::offload(const ::android::hardware::audio::effect::V6_0::EffectOffloadParameter& param)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setProcessBuffers(const ::android::hardware::audio::effect::V6_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V6_0::AudioBuffer& outBuffer)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::close()

// Methods from ::android::hardware::audio::effect::V6_0::IDownmixEffect follow.
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IDownmixEffect::setType(::android::hardware::audio::effect::V6_0::IDownmixEffect::Type preset)
...
::android::hardware::Return<void> IDownmixEffect::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::effect::V6_0::IDownmixEffect::descriptor,
...
::android::hardware::Return<void> IDownmixEffect::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::effect::V6_0::IDownmixEffect::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IDownmixEffect::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){139,197,151,209,102,224,126,158,186,99,50,103,252,40,114,196,197,61,19,211,240,2,91,119,140,152,225,51,36,161,101,222} /* 8bc597d166e07e9eba633267fc2872c4c53d13d3f0025b778c98e13324a165de */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IDownmixEffect>> IDownmixEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IDownmixEffect>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IDownmixEffect>> IDownmixEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffect>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDownmixEffect, ::android::hardware::audio::effect::V6_0::IEffect, BpHwDownmixEffect>(
            parent, "android.hardware.audio.effect@6.0::IDownmixEffect", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IDownmixEffect>> IDownmixEffect::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwDownmixEffect::BpHwDownmixEffect(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IDownmixEffect>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@6.0", "IDownmixEffect") {
}
...
// Methods from ::android::hardware::audio::effect::V6_0::IDownmixEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::_hidl_setType(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::effect::V6_0::IDownmixEffect::Type preset) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "6.0", "IDownmixEffect", "setType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "6.0", "IDownmixEffect", "setType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDownmixEffect::_hidl_getType(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getType_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "6.0", "IDownmixEffect", "getType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(30 /* getType */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::effect::V6_0::Result _hidl_out_retval;
        ::android::hardware::audio::effect::V6_0::IDownmixEffect::Type _hidl_out_preset;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "6.0", "IDownmixEffect", "getType", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::audio::effect::V6_0::IEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::init(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setConfig(const ::android::hardware::audio::effect::V6_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& outputBufferProvider){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::reset(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::enable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::disable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setAudioMode(::android::hardware::audio::common::V6_0::AudioMode mode){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setConfigReverse(const ::android::hardware::audio::effect::V6_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& outputBufferProvider){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setInputDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V6_0::EffectAuxChannelsConfig& config){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setAudioSource(::android::hardware::audio::common::V6_0::AudioSource source){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::offload(const ::android::hardware::audio::effect::V6_0::EffectOffloadParameter& param){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setProcessBuffers(const ::android::hardware::audio::effect::V6_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V6_0::AudioBuffer& outBuffer){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::close(){
...
// Methods from ::android::hardware::audio::effect::V6_0::IDownmixEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwDownmixEffect::setType(::android::hardware::audio::effect::V6_0::IDownmixEffect::Type preset){
    ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result>  _hidl_out = ::android::hardware::audio::effect::V6_0::BpHwDownmixEffect::_hidl_setType(this, this, preset);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwDownmixEffect::getType(getType_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V6_0::BpHwDownmixEffect::_hidl_getType(this, this, _hidl_cb);
...
BnHwDownmixEffect::BnHwDownmixEffect(const ::android::sp<IDownmixEffect> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio.effect@6.0", "IDownmixEffect") { 
...
::android::status_t BnHwDownmixEffect::_hidl_setType(
    ...
    ::android::hardware::audio::effect::V6_0::IDownmixEffect::Type preset;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&preset);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "6.0", "IDownmixEffect", "setType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::effect::V6_0::Result _hidl_out_retval = static_cast<IDownmixEffect*>(_hidl_this->getImpl().get())->setType(preset);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "6.0", "IDownmixEffect", "setType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwDownmixEffect::_hidl_getType(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "6.0", "IDownmixEffect", "getType", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_preset);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "6.0", "IDownmixEffect", "getType", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwDownmixEffect::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 29 /* setType */:
        {
            _hidl_err = ::android::hardware::audio::effect::V6_0::BnHwDownmixEffect::_hidl_setType(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 30 /* getType */:
        {
            _hidl_err = ::android::hardware::audio::effect::V6_0::BnHwDownmixEffect::_hidl_getType(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsDownmixEffect::BsDownmixEffect(const ::android::sp<::android::hardware::audio::effect::V6_0::IDownmixEffect> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@6.0", "IDownmixEffect"), mImpl(impl) {
...
bool IDownmixEffect::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio.effect@6.0::IDownmixEffect",
