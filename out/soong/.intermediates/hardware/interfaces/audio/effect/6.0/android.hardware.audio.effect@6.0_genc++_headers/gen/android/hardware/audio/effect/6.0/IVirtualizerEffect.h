#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IVIRTUALIZEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IVIRTUALIZEREFFECT_H
...
struct IVirtualizerEffect : public ::android::hardware::audio::effect::V6_0::IEffect {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@6.0::IVirtualizerEffect"
     */
    ...
    struct SpeakerAngle final {
         ...
         */
        ::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioChannelMask> mask __attribute__ ((aligned(4)));
        int16_t azimuth __attribute__ ((aligned(2)));
        int16_t elevation __attribute__ ((aligned(2)));
    };

    static_assert(offsetof(::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle, mask) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle, azimuth) == 4, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle, elevation) == 6, "wrong offset");
    static_assert(sizeof(::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle) == 8, "wrong size");
    static_assert(__alignof(::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle) == 4, "wrong alignment");
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> setStrength(uint16_t strength) = 0;

    /**
     * Return callback for getStrength
     */
    using getStrength_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, uint16_t strength)>;
    /**
     ...
     */
    using getVirtualSpeakerAngles_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, const ::android::hardware::hidl_vec<::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle>& speakerAngles)>;
    /**
     * Retrieves virtual speaker angles for the given channel mask on the
     * specified device.
     */
    virtual ::android::hardware::Return<void> getVirtualSpeakerAngles(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioChannelMask> mask, ::android::hardware::audio::common::V6_0::AudioDevice device, getVirtualSpeakerAngles_cb _hidl_cb) = 0;

    /**
     * Forces the virtualizer effect for the given output device.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> forceVirtualizationMode(::android::hardware::audio::common::V6_0::AudioDevice device) = 0;

    /**
     * Return callback for getVirtualizationMode
     */
    using getVirtualizationMode_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, ::android::hardware::audio::common::V6_0::AudioDevice device)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IVirtualizerEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IVirtualizerEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IVirtualizerEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IVirtualizerEffect>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange o);
static inline void PrintTo(::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange o, ::std::ostream* os);
constexpr uint16_t operator|(const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange lhs, const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange rhs) {
    return static_cast<uint16_t>(static_cast<uint16_t>(lhs) | static_cast<uint16_t>(rhs));
}
constexpr uint16_t operator|(const uint16_t lhs, const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange rhs) {
    return static_cast<uint16_t>(lhs | static_cast<uint16_t>(rhs));
}
constexpr uint16_t operator|(const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange lhs, const uint16_t rhs) {
...
constexpr uint16_t &operator|=(uint16_t& v, const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange e) {
...
static inline std::string toString(const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle& o);
static inline void PrintTo(const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle& lhs, const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle& rhs);
static inline bool operator!=(const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle& lhs, const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle& rhs);

static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V6_0::IVirtualizerEffect>& o);
...
template<>
inline std::string toString<::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange>(uint16_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange::MIN) == static_cast<uint16_t>(::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange::MIN)) {
        os += (first ? "" : " | ");
        os += "MIN";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange::MIN;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange::MAX) == static_cast<uint16_t>(::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange::MAX)) {
        os += (first ? "" : " | ");
        os += "MAX";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange::MAX;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
...
static inline std::string toString(::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange::MIN) {
        return "MIN";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange::MAX) {
        return "MAX";
    }
    std::string os;
...
static inline std::string toString(const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle& o) {
    ...
    os += "{";
    os += ".mask = ";
    os += ::android::hardware::audio::common::V6_0::toString<::android::hardware::audio::common::V6_0::AudioChannelMask>(o.mask);
    os += ", .azimuth = ";
...
static inline void PrintTo(const ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::SpeakerAngle& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V6_0::IVirtualizerEffect>& o) {
    ...
    os += ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::descriptor;
    os += "]";
...
template<> inline constexpr std::array<::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange, 2> hidl_enum_values<::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange> = {
    ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange::MIN,
    ::android::hardware::audio::effect::V6_0::IVirtualizerEffect::StrengthRange::MAX,
};
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IVIRTUALIZEREFFECT_H
