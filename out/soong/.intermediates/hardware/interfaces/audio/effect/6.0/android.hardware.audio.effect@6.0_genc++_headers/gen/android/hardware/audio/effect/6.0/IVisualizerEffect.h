#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IVISUALIZEREFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IVISUALIZEREFFECT_H
...
struct IVisualizerEffect : public ::android::hardware::audio::effect::V6_0::IEffect {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio.effect@6.0::IVisualizerEffect"
     */
    ...
    struct Measurement final {
        ...
        union Values final {
            ...
            static_assert(offsetof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms, peakMb) == 0, "wrong offset");
            static_assert(offsetof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms, rmsMb) == 4, "wrong offset");
            static_assert(sizeof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms) == 8, "wrong size");
            static_assert(__alignof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms) == 4, "wrong alignment");

            ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms peakAndRms __attribute__ ((aligned(4)));
        };

        static_assert(offsetof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values, peakAndRms) == 0, "wrong offset");
        static_assert(sizeof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values) == 8, "wrong size");
        static_assert(__alignof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values) == 4, "wrong alignment");

        ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode mode __attribute__ ((aligned(4)));
        ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values value __attribute__ ((aligned(4)));
    };

    static_assert(offsetof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement, mode) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement, value) == 4, "wrong offset");
    static_assert(sizeof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement) == 12, "wrong size");
    static_assert(__alignof(::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement) == 4, "wrong alignment");
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> setCaptureSize(uint16_t captureSize) = 0;

    /**
     * Return callback for getCaptureSize
     */
    using getCaptureSize_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, uint16_t captureSize)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> setScalingMode(::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode scalingMode) = 0;

    /**
     * Return callback for getScalingMode
     */
    using getScalingMode_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode scalingMode)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> setLatency(uint32_t latencyMs) = 0;

    /**
     * Return callback for getLatency
     */
    using getLatency_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, uint32_t latencyMs)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> setMeasurementMode(::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode measurementMode) = 0;

    /**
     * Return callback for getMeasurementMode
     */
    using getMeasurementMode_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode measurementMode)>;
    /**
     ...
     */
    using capture_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, const ::android::hardware::hidl_vec<uint8_t>& samples)>;
    /**
     ...
     */
    using measure_cb = std::function<void(::android::hardware::audio::effect::V6_0::Result retval, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement& result)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IVisualizerEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IVisualizerEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IVisualizerEffect>> castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffect>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IVisualizerEffect>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange o);
static inline void PrintTo(::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange o, ::std::ostream* os);
constexpr int32_t operator|(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange lhs, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const int32_t lhs, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange rhs) {
    return static_cast<int32_t>(lhs | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange lhs, const int32_t rhs) {
...
constexpr int32_t &operator|=(int32_t& v, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange e) {
...
template<typename>
static inline std::string toString(int32_t o);
static inline std::string toString(::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode o);
static inline void PrintTo(::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode o, ::std::ostream* os);
constexpr int32_t operator|(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode lhs, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const int32_t lhs, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode rhs) {
    return static_cast<int32_t>(lhs | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode lhs, const int32_t rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | rhs);
}
constexpr int32_t operator&(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode lhs, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) & static_cast<int32_t>(rhs));
...
constexpr int32_t &operator|=(int32_t& v, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode e) {
    v |= static_cast<int32_t>(e);
    return v;
}
constexpr int32_t &operator&=(int32_t& v, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode e) {
...
template<typename>
static inline std::string toString(int32_t o);
static inline std::string toString(::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode o);
static inline void PrintTo(::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode o, ::std::ostream* os);
constexpr int32_t operator|(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode lhs, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const int32_t lhs, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode rhs) {
    return static_cast<int32_t>(lhs | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode lhs, const int32_t rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | rhs);
}
constexpr int32_t operator&(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode lhs, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) & static_cast<int32_t>(rhs));
...
constexpr int32_t &operator|=(int32_t& v, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode e) {
    v |= static_cast<int32_t>(e);
    return v;
}
constexpr int32_t &operator&=(int32_t& v, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode e) {
...
static inline std::string toString(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms& o);
static inline void PrintTo(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms& lhs, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms& rhs);
static inline bool operator!=(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms& lhs, const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms& rhs);

static inline std::string toString(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values& o);
static inline void PrintTo(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values& o, ::std::ostream*);
// operator== and operator!= are not generated for Values

static inline std::string toString(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement& o);
static inline void PrintTo(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement& o, ::std::ostream*);
// operator== and operator!= are not generated for Measurement

static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V6_0::IVisualizerEffect>& o);
...
template<>
inline std::string toString<::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange>(int32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange::MAX) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange::MAX)) {
        os += (first ? "" : " | ");
        os += "MAX";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange::MAX;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange::MIN) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange::MIN)) {
        os += (first ? "" : " | ");
        os += "MIN";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange::MIN;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
...
static inline std::string toString(::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange::MAX) {
        return "MAX";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange::MIN) {
        return "MIN";
    }
    std::string os;
...
template<>
inline std::string toString<::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode>(int32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode::NORMALIZED) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode::NORMALIZED)) {
        os += (first ? "" : " | ");
        os += "NORMALIZED";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode::NORMALIZED;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode::AS_PLAYED) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode::AS_PLAYED)) {
        os += (first ? "" : " | ");
        os += "AS_PLAYED";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode::AS_PLAYED;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
        os += toHexString(o & (~flipped));
...
static inline std::string toString(::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode::NORMALIZED) {
        return "NORMALIZED";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode::AS_PLAYED) {
        return "AS_PLAYED";
    }
    std::string os;
    os += toHexString(static_cast<int32_t>(o));
...
template<>
inline std::string toString<::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode>(int32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode::NONE) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode::NONE)) {
        os += (first ? "" : " | ");
        os += "NONE";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode::NONE;
    }
    if ((o & ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode::PEAK_RMS) == static_cast<int32_t>(::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode::PEAK_RMS)) {
        os += (first ? "" : " | ");
        os += "PEAK_RMS";
        first = false;
        flipped |= ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode::PEAK_RMS;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
        os += toHexString(o & (~flipped));
...
static inline std::string toString(::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode::NONE) {
        return "NONE";
    }
    if (o == ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode::PEAK_RMS) {
        return "PEAK_RMS";
    }
    std::string os;
    os += toHexString(static_cast<int32_t>(o));
...
static inline void PrintTo(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values::PeakAndRms& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values& o) {
    ...
    os += "{";
    os += ".peakAndRms = ";
    os += ::android::hardware::audio::effect::V6_0::toString(o.peakAndRms);
    os += "}"; return os;
}

static inline void PrintTo(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement::Values& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement& o) {
    ...
    os += "{";
    os += ".mode = ";
    os += ::android::hardware::audio::effect::V6_0::toString(o.mode);
    os += ", .value = ";
    os += ::android::hardware::audio::effect::V6_0::toString(o.value);
    os += "}"; return os;
}

static inline void PrintTo(const ::android::hardware::audio::effect::V6_0::IVisualizerEffect::Measurement& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::effect::V6_0::IVisualizerEffect>& o) {
    ...
    os += ::android::hardware::audio::effect::V6_0::IVisualizerEffect::descriptor;
    os += "]";
...
template<> inline constexpr std::array<::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange, 2> hidl_enum_values<::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange> = {
    ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange::MAX,
    ::android::hardware::audio::effect::V6_0::IVisualizerEffect::CaptureSizeRange::MIN,
};
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<> inline constexpr std::array<::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode, 2> hidl_enum_values<::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode> = {
    ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode::NORMALIZED,
    ::android::hardware::audio::effect::V6_0::IVisualizerEffect::ScalingMode::AS_PLAYED,
};
#pragma clang diagnostic pop
}  // namespace details
}  // namespace hardware
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<> inline constexpr std::array<::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode, 2> hidl_enum_values<::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode> = {
    ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode::NONE,
    ::android::hardware::audio::effect::V6_0::IVisualizerEffect::MeasurementMode::PEAK_RMS,
};
#pragma clang diagnostic pop
}  // namespace details
}  // namespace hardware
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V6_0_IVISUALIZEREFFECT_H
