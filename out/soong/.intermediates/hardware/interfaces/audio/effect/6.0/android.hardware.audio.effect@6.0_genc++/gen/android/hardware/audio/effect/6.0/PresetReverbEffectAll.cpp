#define LOG_TAG "android.hardware.audio.effect@6.0::PresetReverbEffect"
...
#include <android/hardware/audio/effect/6.0/BpHwPresetReverbEffect.h>
#include <android/hardware/audio/effect/6.0/BnHwPresetReverbEffect.h>
#include <android/hardware/audio/effect/6.0/BsPresetReverbEffect.h>
...
const char* IPresetReverbEffect::descriptor("android.hardware.audio.effect@6.0::IPresetReverbEffect");
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::init()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setConfig(const ::android::hardware::audio::effect::V6_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& outputBufferProvider)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::reset()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::enable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::disable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setAudioMode(::android::hardware::audio::common::V6_0::AudioMode mode)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setConfigReverse(const ::android::hardware::audio::effect::V6_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& outputBufferProvider)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setInputDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V6_0::EffectAuxChannelsConfig& config)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setAudioSource(::android::hardware::audio::common::V6_0::AudioSource source)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::offload(const ::android::hardware::audio::effect::V6_0::EffectOffloadParameter& param)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setProcessBuffers(const ::android::hardware::audio::effect::V6_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V6_0::AudioBuffer& outBuffer)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::close()

// Methods from ::android::hardware::audio::effect::V6_0::IPresetReverbEffect follow.
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IPresetReverbEffect::setPreset(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset preset)
...
::android::hardware::Return<void> IPresetReverbEffect::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::descriptor,
...
::android::hardware::Return<void> IPresetReverbEffect::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IPresetReverbEffect::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){82,55,196,45,57,19,239,86,159,7,190,200,2,86,128,132,182,21,21,93,5,167,149,30,117,8,93,165,72,86,80,140} /* 5237c42d3913ef569f07bec802568084b615155d05a7951e75085da54856508c */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect>> IPresetReverbEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect>> IPresetReverbEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffect>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IPresetReverbEffect, ::android::hardware::audio::effect::V6_0::IEffect, BpHwPresetReverbEffect>(
            parent, "android.hardware.audio.effect@6.0::IPresetReverbEffect", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect>> IPresetReverbEffect::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwPresetReverbEffect::BpHwPresetReverbEffect(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IPresetReverbEffect>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@6.0", "IPresetReverbEffect") {
}
...
// Methods from ::android::hardware::audio::effect::V6_0::IPresetReverbEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::_hidl_setPreset(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset preset) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "6.0", "IPresetReverbEffect", "setPreset", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "6.0", "IPresetReverbEffect", "setPreset", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwPresetReverbEffect::_hidl_getPreset(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getPreset_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "6.0", "IPresetReverbEffect", "getPreset", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(30 /* getPreset */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::effect::V6_0::Result _hidl_out_retval;
        ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset _hidl_out_preset;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "6.0", "IPresetReverbEffect", "getPreset", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::audio::effect::V6_0::IEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::init(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setConfig(const ::android::hardware::audio::effect::V6_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& outputBufferProvider){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::reset(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::enable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::disable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setAudioMode(::android::hardware::audio::common::V6_0::AudioMode mode){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setConfigReverse(const ::android::hardware::audio::effect::V6_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& outputBufferProvider){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setInputDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V6_0::EffectAuxChannelsConfig& config){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setAudioSource(::android::hardware::audio::common::V6_0::AudioSource source){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::offload(const ::android::hardware::audio::effect::V6_0::EffectOffloadParameter& param){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setProcessBuffers(const ::android::hardware::audio::effect::V6_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V6_0::AudioBuffer& outBuffer){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::close(){
...
// Methods from ::android::hardware::audio::effect::V6_0::IPresetReverbEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwPresetReverbEffect::setPreset(::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset preset){
    ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result>  _hidl_out = ::android::hardware::audio::effect::V6_0::BpHwPresetReverbEffect::_hidl_setPreset(this, this, preset);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwPresetReverbEffect::getPreset(getPreset_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V6_0::BpHwPresetReverbEffect::_hidl_getPreset(this, this, _hidl_cb);
...
BnHwPresetReverbEffect::BnHwPresetReverbEffect(const ::android::sp<IPresetReverbEffect> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio.effect@6.0", "IPresetReverbEffect") { 
...
::android::status_t BnHwPresetReverbEffect::_hidl_setPreset(
    ...
    ::android::hardware::audio::effect::V6_0::IPresetReverbEffect::Preset preset;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&preset);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "6.0", "IPresetReverbEffect", "setPreset", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::effect::V6_0::Result _hidl_out_retval = static_cast<IPresetReverbEffect*>(_hidl_this->getImpl().get())->setPreset(preset);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "6.0", "IPresetReverbEffect", "setPreset", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwPresetReverbEffect::_hidl_getPreset(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "6.0", "IPresetReverbEffect", "getPreset", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_preset);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "6.0", "IPresetReverbEffect", "getPreset", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwPresetReverbEffect::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 29 /* setPreset */:
        {
            _hidl_err = ::android::hardware::audio::effect::V6_0::BnHwPresetReverbEffect::_hidl_setPreset(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 30 /* getPreset */:
        {
            _hidl_err = ::android::hardware::audio::effect::V6_0::BnHwPresetReverbEffect::_hidl_getPreset(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsPresetReverbEffect::BsPresetReverbEffect(const ::android::sp<::android::hardware::audio::effect::V6_0::IPresetReverbEffect> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@6.0", "IPresetReverbEffect"), mImpl(impl) {
...
bool IPresetReverbEffect::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio.effect@6.0::IPresetReverbEffect",
