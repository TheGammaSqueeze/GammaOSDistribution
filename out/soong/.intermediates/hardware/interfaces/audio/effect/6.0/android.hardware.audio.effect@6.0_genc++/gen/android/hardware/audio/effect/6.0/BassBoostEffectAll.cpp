#define LOG_TAG "android.hardware.audio.effect@6.0::BassBoostEffect"
...
#include <android/hardware/audio/effect/6.0/BpHwBassBoostEffect.h>
#include <android/hardware/audio/effect/6.0/BnHwBassBoostEffect.h>
#include <android/hardware/audio/effect/6.0/BsBassBoostEffect.h>
...
const char* IBassBoostEffect::descriptor("android.hardware.audio.effect@6.0::IBassBoostEffect");
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::init()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::setConfig(const ::android::hardware::audio::effect::V6_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& outputBufferProvider)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::reset()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::enable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::disable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::setDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::setAudioMode(::android::hardware::audio::common::V6_0::AudioMode mode)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::setInputDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V6_0::EffectAuxChannelsConfig& config)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::setAudioSource(::android::hardware::audio::common::V6_0::AudioSource source)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::offload(const ::android::hardware::audio::effect::V6_0::EffectOffloadParameter& param)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::setProcessBuffers(const ::android::hardware::audio::effect::V6_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V6_0::AudioBuffer& outBuffer)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::close()

// Methods from ::android::hardware::audio::effect::V6_0::IBassBoostEffect follow.
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> IBassBoostEffect::setStrength(uint16_t strength)
...
::android::hardware::Return<void> IBassBoostEffect::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::effect::V6_0::IBassBoostEffect::descriptor,
...
::android::hardware::Return<void> IBassBoostEffect::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::effect::V6_0::IBassBoostEffect::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IBassBoostEffect::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){70,27,17,20,203,53,216,159,135,229,105,78,7,146,186,83,193,18,167,250,154,20,217,185,81,136,207,156,71,100,190,35} /* 461b1114cb35d89f87e5694e0792ba53c112a7fa9a14d9b95188cf9c4764be23 */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IBassBoostEffect>> IBassBoostEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IBassBoostEffect>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IBassBoostEffect>> IBassBoostEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V6_0::IEffect>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IBassBoostEffect, ::android::hardware::audio::effect::V6_0::IEffect, BpHwBassBoostEffect>(
            parent, "android.hardware.audio.effect@6.0::IBassBoostEffect", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V6_0::IBassBoostEffect>> IBassBoostEffect::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwBassBoostEffect::BpHwBassBoostEffect(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IBassBoostEffect>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@6.0", "IBassBoostEffect") {
}
...
::android::hardware::Return<void> BpHwBassBoostEffect::_hidl_isStrengthSupported(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, isStrengthSupported_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "isStrengthSupported", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(29 /* isStrengthSupported */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "isStrengthSupported", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::_hidl_setStrength(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint16_t strength) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "setStrength", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "setStrength", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwBassBoostEffect::_hidl_getStrength(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getStrength_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "getStrength", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(31 /* getStrength */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "getStrength", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::audio::effect::V6_0::IEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::init(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::setConfig(const ::android::hardware::audio::effect::V6_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V6_0::IEffectBufferProviderCallback>& outputBufferProvider){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::reset(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::enable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::disable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::setDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::setAudioMode(::android::hardware::audio::common::V6_0::AudioMode mode){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::setInputDevice(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V6_0::AudioDevice> device){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V6_0::EffectAuxChannelsConfig& config){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::setAudioSource(::android::hardware::audio::common::V6_0::AudioSource source){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::offload(const ::android::hardware::audio::effect::V6_0::EffectOffloadParameter& param){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::setProcessBuffers(const ::android::hardware::audio::effect::V6_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V6_0::AudioBuffer& outBuffer){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData){
...
::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::close(){
...
::android::hardware::Return<void> BpHwBassBoostEffect::isStrengthSupported(isStrengthSupported_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V6_0::BpHwBassBoostEffect::_hidl_isStrengthSupported(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result> BpHwBassBoostEffect::setStrength(uint16_t strength){
    ::android::hardware::Return<::android::hardware::audio::effect::V6_0::Result>  _hidl_out = ::android::hardware::audio::effect::V6_0::BpHwBassBoostEffect::_hidl_setStrength(this, this, strength);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwBassBoostEffect::getStrength(getStrength_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V6_0::BpHwBassBoostEffect::_hidl_getStrength(this, this, _hidl_cb);
...
BnHwBassBoostEffect::BnHwBassBoostEffect(const ::android::sp<IBassBoostEffect> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio.effect@6.0", "IBassBoostEffect") { 
...
::android::status_t BnHwBassBoostEffect::_hidl_isStrengthSupported(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "isStrengthSupported", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_strengthSupported);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "isStrengthSupported", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBassBoostEffect::_hidl_setStrength(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&strength);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "setStrength", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::effect::V6_0::Result _hidl_out_retval = static_cast<IBassBoostEffect*>(_hidl_this->getImpl().get())->setStrength(strength);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "setStrength", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBassBoostEffect::_hidl_getStrength(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "getStrength", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_strength);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "6.0", "IBassBoostEffect", "getStrength", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBassBoostEffect::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::audio::effect::V6_0::BnHwBassBoostEffect::_hidl_isStrengthSupported(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 30 /* setStrength */:
        {
            _hidl_err = ::android::hardware::audio::effect::V6_0::BnHwBassBoostEffect::_hidl_setStrength(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 31 /* getStrength */:
        {
            _hidl_err = ::android::hardware::audio::effect::V6_0::BnHwBassBoostEffect::_hidl_getStrength(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsBassBoostEffect::BsBassBoostEffect(const ::android::sp<::android::hardware::audio::effect::V6_0::IBassBoostEffect> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@6.0", "IBassBoostEffect"), mImpl(impl) {
...
bool IBassBoostEffect::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio.effect@6.0::IBassBoostEffect",
