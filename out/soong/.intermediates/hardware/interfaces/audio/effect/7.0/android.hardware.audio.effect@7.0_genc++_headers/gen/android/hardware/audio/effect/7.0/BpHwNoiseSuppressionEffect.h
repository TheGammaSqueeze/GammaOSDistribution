#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V7_0_BPHWNOISESUPPRESSIONEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V7_0_BPHWNOISESUPPRESSIONEFFECT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/effect/7.0/IHwNoiseSuppressionEffect.h>
...
struct BpHwNoiseSuppressionEffect : public ::android::hardware::BpInterface<INoiseSuppressionEffect>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result>  _hidl_setSuppressionLevel(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::effect::V7_0::INoiseSuppressionEffect::Level level);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result>  _hidl_setSuppressionType(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::effect::V7_0::INoiseSuppressionEffect::Type type);
    ...
    static ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result>  _hidl_setAllProperties(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::effect::V7_0::INoiseSuppressionEffect::AllProperties& properties);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V7_0_BPHWNOISESUPPRESSIONEFFECT_H
