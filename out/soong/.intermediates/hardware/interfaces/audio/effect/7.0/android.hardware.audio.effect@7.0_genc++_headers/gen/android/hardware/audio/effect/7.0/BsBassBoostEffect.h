#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V7_0_BSBASSBOOSTEFFECT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V7_0_BSBASSBOOSTEFFECT_H

#include <android-base/macros.h>
#include <cutils/trace.h>
#include <future>
#include <android/hardware/audio/effect/7.0/IBassBoostEffect.h>
...
struct BsBassBoostEffect : IBassBoostEffect, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> isStrengthSupported(isStrengthSupported_cb _hidl_cb) override {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.audio.effect", "7.0", "IBassBoostEffect", "isStrengthSupported", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->isStrengthSupported([&](const auto &_hidl_out_retval, const auto &_hidl_out_strengthSupported) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.audio.effect", "7.0", "IBassBoostEffect", "isStrengthSupported", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> setStrength(uint16_t strength) override {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.audio.effect", "7.0", "IBassBoostEffect", "setStrength", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_retval);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.audio.effect", "7.0", "IBassBoostEffect", "setStrength", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> getStrength(getStrength_cb _hidl_cb) override {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::PASSTHROUGH_ENTRY, "android.hardware.audio.effect", "7.0", "IBassBoostEffect", "getStrength", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
        ...
        auto _hidl_return = mImpl->getStrength([&](const auto &_hidl_out_retval, const auto &_hidl_out_strength) {
            ...
            if (UNLIKELY(mEnableInstrumentation)) {
                ...
                for (const auto &callback: mInstrumentationCallbacks) {
                    callback(InstrumentationEvent::PASSTHROUGH_EXIT, "android.hardware.audio.effect", "7.0", "IBassBoostEffect", "getStrength", &_hidl_args);
                }
            }
            #endif // __ANDROID_DEBUGGABLE__
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_EFFECT_V7_0_BSBASSBOOSTEFFECT_H
