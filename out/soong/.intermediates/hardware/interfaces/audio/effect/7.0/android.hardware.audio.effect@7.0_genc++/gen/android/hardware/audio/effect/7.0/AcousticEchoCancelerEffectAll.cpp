#define LOG_TAG "android.hardware.audio.effect@7.0::AcousticEchoCancelerEffect"
...
#include <android/hardware/audio/effect/7.0/BpHwAcousticEchoCancelerEffect.h>
#include <android/hardware/audio/effect/7.0/BnHwAcousticEchoCancelerEffect.h>
#include <android/hardware/audio/effect/7.0/BsAcousticEchoCancelerEffect.h>
...
const char* IAcousticEchoCancelerEffect::descriptor("android.hardware.audio.effect@7.0::IAcousticEchoCancelerEffect");
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::init()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::setConfig(const ::android::hardware::audio::effect::V7_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V7_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V7_0::IEffectBufferProviderCallback>& outputBufferProvider)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::reset()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::enable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::disable()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::setDevice(const ::android::hardware::audio::common::V7_0::DeviceAddress& device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::setAudioMode(::android::hardware::audio::common::V7_0::AudioMode mode)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::setInputDevice(const ::android::hardware::audio::common::V7_0::DeviceAddress& device)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V7_0::EffectAuxChannelsConfig& config)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::setAudioSource(const ::android::hardware::hidl_string& source)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::offload(const ::android::hardware::audio::effect::V7_0::EffectOffloadParameter& param)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::setProcessBuffers(const ::android::hardware::audio::effect::V7_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V7_0::AudioBuffer& outBuffer)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::close()

// Methods from ::android::hardware::audio::effect::V7_0::IAcousticEchoCancelerEffect follow.
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> IAcousticEchoCancelerEffect::setEchoDelay(uint32_t echoDelayMs)
...
::android::hardware::Return<void> IAcousticEchoCancelerEffect::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::effect::V7_0::IAcousticEchoCancelerEffect::descriptor,
...
::android::hardware::Return<void> IAcousticEchoCancelerEffect::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::effect::V7_0::IAcousticEchoCancelerEffect::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IAcousticEchoCancelerEffect::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){132,43,68,133,160,0,5,251,147,143,103,75,18,68,92,181,146,205,22,54,245,108,124,196,71,150,97,25,7,8,17,189} /* 842b4485a00005fb938f674b12445cb592cd1636f56c7cc447966119070811bd */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V7_0::IAcousticEchoCancelerEffect>> IAcousticEchoCancelerEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V7_0::IAcousticEchoCancelerEffect>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V7_0::IAcousticEchoCancelerEffect>> IAcousticEchoCancelerEffect::castFrom(const ::android::sp<::android::hardware::audio::effect::V7_0::IEffect>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IAcousticEchoCancelerEffect, ::android::hardware::audio::effect::V7_0::IEffect, BpHwAcousticEchoCancelerEffect>(
            parent, "android.hardware.audio.effect@7.0::IAcousticEchoCancelerEffect", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V7_0::IAcousticEchoCancelerEffect>> IAcousticEchoCancelerEffect::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwAcousticEchoCancelerEffect::BpHwAcousticEchoCancelerEffect(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IAcousticEchoCancelerEffect>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@7.0", "IAcousticEchoCancelerEffect") {
}
...
// Methods from ::android::hardware::audio::effect::V7_0::IAcousticEchoCancelerEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::_hidl_setEchoDelay(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t echoDelayMs) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "7.0", "IAcousticEchoCancelerEffect", "setEchoDelay", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "7.0", "IAcousticEchoCancelerEffect", "setEchoDelay", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwAcousticEchoCancelerEffect::_hidl_getEchoDelay(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getEchoDelay_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "7.0", "IAcousticEchoCancelerEffect", "getEchoDelay", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(30 /* getEchoDelay */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "7.0", "IAcousticEchoCancelerEffect", "getEchoDelay", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::audio::effect::V7_0::IEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::init(){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::setConfig(const ::android::hardware::audio::effect::V7_0::EffectConfig& config, const ::android::sp<::android::hardware::audio::effect::V7_0::IEffectBufferProviderCallback>& inputBufferProvider, const ::android::sp<::android::hardware::audio::effect::V7_0::IEffectBufferProviderCallback>& outputBufferProvider){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::reset(){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::enable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::disable(){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::setDevice(const ::android::hardware::audio::common::V7_0::DeviceAddress& device){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::volumeChangeNotification(const ::android::hardware::hidl_vec<uint32_t>& volumes){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::setAudioMode(::android::hardware::audio::common::V7_0::AudioMode mode){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::setInputDevice(const ::android::hardware::audio::common::V7_0::DeviceAddress& device){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::setAuxChannelsConfig(const ::android::hardware::audio::effect::V7_0::EffectAuxChannelsConfig& config){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::setAudioSource(const ::android::hardware::hidl_string& source){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::offload(const ::android::hardware::audio::effect::V7_0::EffectOffloadParameter& param){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::setProcessBuffers(const ::android::hardware::audio::effect::V7_0::AudioBuffer& inBuffer, const ::android::hardware::audio::effect::V7_0::AudioBuffer& outBuffer){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::setParameter(const ::android::hardware::hidl_vec<uint8_t>& parameter, const ::android::hardware::hidl_vec<uint8_t>& value){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::setCurrentConfigForFeature(uint32_t featureId, const ::android::hardware::hidl_vec<uint8_t>& configData){
...
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::close(){
...
// Methods from ::android::hardware::audio::effect::V7_0::IAcousticEchoCancelerEffect follow.
::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result> BpHwAcousticEchoCancelerEffect::setEchoDelay(uint32_t echoDelayMs){
    ::android::hardware::Return<::android::hardware::audio::effect::V7_0::Result>  _hidl_out = ::android::hardware::audio::effect::V7_0::BpHwAcousticEchoCancelerEffect::_hidl_setEchoDelay(this, this, echoDelayMs);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwAcousticEchoCancelerEffect::getEchoDelay(getEchoDelay_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V7_0::BpHwAcousticEchoCancelerEffect::_hidl_getEchoDelay(this, this, _hidl_cb);
...
BnHwAcousticEchoCancelerEffect::BnHwAcousticEchoCancelerEffect(const ::android::sp<IAcousticEchoCancelerEffect> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio.effect@7.0", "IAcousticEchoCancelerEffect") { 
...
::android::status_t BnHwAcousticEchoCancelerEffect::_hidl_setEchoDelay(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&echoDelayMs);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "7.0", "IAcousticEchoCancelerEffect", "setEchoDelay", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::effect::V7_0::Result _hidl_out_retval = static_cast<IAcousticEchoCancelerEffect*>(_hidl_this->getImpl().get())->setEchoDelay(echoDelayMs);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "7.0", "IAcousticEchoCancelerEffect", "setEchoDelay", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwAcousticEchoCancelerEffect::_hidl_getEchoDelay(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "7.0", "IAcousticEchoCancelerEffect", "getEchoDelay", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_echoDelayMs);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "7.0", "IAcousticEchoCancelerEffect", "getEchoDelay", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwAcousticEchoCancelerEffect::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::audio::effect::V7_0::BnHwAcousticEchoCancelerEffect::_hidl_setEchoDelay(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 30 /* getEchoDelay */:
        {
            _hidl_err = ::android::hardware::audio::effect::V7_0::BnHwAcousticEchoCancelerEffect::_hidl_getEchoDelay(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsAcousticEchoCancelerEffect::BsAcousticEchoCancelerEffect(const ::android::sp<::android::hardware::audio::effect::V7_0::IAcousticEchoCancelerEffect> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@7.0", "IAcousticEchoCancelerEffect"), mImpl(impl) {
...
bool IAcousticEchoCancelerEffect::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio.effect@7.0::IAcousticEchoCancelerEffect",
