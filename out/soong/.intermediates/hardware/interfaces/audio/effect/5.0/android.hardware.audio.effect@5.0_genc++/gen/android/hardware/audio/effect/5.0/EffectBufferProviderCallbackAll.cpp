#define LOG_TAG "android.hardware.audio.effect@5.0::EffectBufferProviderCallback"
...
#include <android/hardware/audio/effect/5.0/BpHwEffectBufferProviderCallback.h>
#include <android/hardware/audio/effect/5.0/BnHwEffectBufferProviderCallback.h>
#include <android/hardware/audio/effect/5.0/BsEffectBufferProviderCallback.h>
...
const char* IEffectBufferProviderCallback::descriptor("android.hardware.audio.effect@5.0::IEffectBufferProviderCallback");
...
// Methods from ::android::hardware::audio::effect::V5_0::IEffectBufferProviderCallback follow.
// no default implementation for: ::android::hardware::Return<void> IEffectBufferProviderCallback::getBuffer(getBuffer_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<void> IEffectBufferProviderCallback::putBuffer(const ::android::hardware::audio::effect::V5_0::AudioBuffer& buffer)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IEffectBufferProviderCallback::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::effect::V5_0::IEffectBufferProviderCallback::descriptor,
...
::android::hardware::Return<void> IEffectBufferProviderCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::effect::V5_0::IEffectBufferProviderCallback::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IEffectBufferProviderCallback::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){10,194,233,81,243,89,232,118,68,220,246,66,244,136,25,79,107,2,86,63,137,207,232,221,102,138,183,196,34,190,137,177} /* 0ac2e951f359e87644dcf642f488194f6b02563f89cfe8dd668ab7c422be89b1 */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V5_0::IEffectBufferProviderCallback>> IEffectBufferProviderCallback::castFrom(const ::android::sp<::android::hardware::audio::effect::V5_0::IEffectBufferProviderCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::effect::V5_0::IEffectBufferProviderCallback>> IEffectBufferProviderCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IEffectBufferProviderCallback, ::android::hidl::base::V1_0::IBase, BpHwEffectBufferProviderCallback>(
            parent, "android.hardware.audio.effect@5.0::IEffectBufferProviderCallback", emitError);
}
...
BpHwEffectBufferProviderCallback::BpHwEffectBufferProviderCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IEffectBufferProviderCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@5.0", "IEffectBufferProviderCallback") {
}

void BpHwEffectBufferProviderCallback::onLastStrongRef(const void* id) {
    {
        std::unique_lock<std::mutex> lock(_hidl_mMutex);
        _hidl_mDeathRecipients.clear();
    }

    BpInterface<IEffectBufferProviderCallback>::onLastStrongRef(id);
}
// Methods from ::android::hardware::audio::effect::V5_0::IEffectBufferProviderCallback follow.
::android::hardware::Return<void> BpHwEffectBufferProviderCallback::_hidl_getBuffer(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getBuffer_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IEffectBufferProviderCallback::getBuffer::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "5.0", "IEffectBufferProviderCallback", "getBuffer", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* getBuffer */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::effect::V5_0::AudioBuffer* _hidl_out_buffer;
        ...
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::audio::effect::V5_0::AudioBuffer &>(*_hidl_out_buffer),
                _hidl_reply,
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "5.0", "IEffectBufferProviderCallback", "getBuffer", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwEffectBufferProviderCallback::_hidl_putBuffer(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::effect::V5_0::AudioBuffer& buffer) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IEffectBufferProviderCallback::putBuffer::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&buffer);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio.effect", "5.0", "IEffectBufferProviderCallback", "putBuffer", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* putBuffer */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio.effect", "5.0", "IEffectBufferProviderCallback", "putBuffer", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwEffectBufferProviderCallback::getBuffer(getBuffer_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V5_0::BpHwEffectBufferProviderCallback::_hidl_getBuffer(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwEffectBufferProviderCallback::putBuffer(const ::android::hardware::audio::effect::V5_0::AudioBuffer& buffer){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::effect::V5_0::BpHwEffectBufferProviderCallback::_hidl_putBuffer(this, this, buffer);
...
BnHwEffectBufferProviderCallback::BnHwEffectBufferProviderCallback(const ::android::sp<IEffectBufferProviderCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio.effect@5.0", "IEffectBufferProviderCallback") { 
...
::android::status_t BnHwEffectBufferProviderCallback::_hidl_getBuffer(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "5.0", "IEffectBufferProviderCallback", "getBuffer", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IEffectBufferProviderCallback*>(_hidl_this->getImpl().get())->getBuffer([&](const auto &_hidl_out_buffer) {
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_buffer);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "5.0", "IEffectBufferProviderCallback", "getBuffer", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwEffectBufferProviderCallback::_hidl_putBuffer(
    ...
    ::android::hardware::audio::effect::V5_0::AudioBuffer* buffer;
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::audio::effect::V5_0::AudioBuffer &>(*buffer),
            _hidl_data,
            _hidl_buffer_parent,
            0 /* parentOffset */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)buffer);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio.effect", "5.0", "IEffectBufferProviderCallback", "putBuffer", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IEffectBufferProviderCallback*>(_hidl_this->getImpl().get())->putBuffer(*buffer);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio.effect", "5.0", "IEffectBufferProviderCallback", "putBuffer", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwEffectBufferProviderCallback::onTransact(
    ...
    switch (_hidl_code) {
        case 1 /* getBuffer */:
        {
            _hidl_err = ::android::hardware::audio::effect::V5_0::BnHwEffectBufferProviderCallback::_hidl_getBuffer(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 2 /* putBuffer */:
        {
            _hidl_err = ::android::hardware::audio::effect::V5_0::BnHwEffectBufferProviderCallback::_hidl_putBuffer(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsEffectBufferProviderCallback::BsEffectBufferProviderCallback(const ::android::sp<::android::hardware::audio::effect::V5_0::IEffectBufferProviderCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio.effect@5.0", "IEffectBufferProviderCallback"), mImpl(impl) {
...
bool IEffectBufferProviderCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio.effect@5.0::IEffectBufferProviderCallback",
