#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWSTREAMOUT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWSTREAMOUT_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/audio/5.0/IHwStreamOut.h>
...
struct BpHwStreamOut : public ::android::hardware::BpInterface<IStreamOut>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setVolume(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float left, float right);
    static ::android::hardware::Return<void>  _hidl_updateSourceMetadata(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V5_0::SourceMetadata& sourceMetadata);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_setCallback(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::audio::V5_0::IStreamOutCallback>& callback);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_clearCallback(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_pause(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_resume(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_drain(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::V5_0::AudioDrain type);
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_flush(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor);
    ...
    static ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_selectPresentation(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t presentationId, int32_t programId);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_BPHWSTREAMOUT_H
