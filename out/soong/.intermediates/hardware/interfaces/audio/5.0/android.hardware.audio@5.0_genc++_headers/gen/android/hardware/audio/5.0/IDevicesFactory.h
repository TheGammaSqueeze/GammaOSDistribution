#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_IDEVICESFACTORY_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_IDEVICESFACTORY_H
...
struct IDevicesFactory : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio@5.0::IDevicesFactory"
     */
    ...
    /**
     * Return callback for openDevice
     */
    using openDevice_cb = std::function<void(::android::hardware::audio::V5_0::Result retval, const ::android::sp<::android::hardware::audio::V5_0::IDevice>& result)>;
    /**
    ...
    /**
     * Return callback for openPrimaryDevice
     */
    using openPrimaryDevice_cb = std::function<void(::android::hardware::audio::V5_0::Result retval, const ::android::sp<::android::hardware::audio::V5_0::IPrimaryDevice>& result)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V5_0::IDevicesFactory>> castFrom(const ::android::sp<::android::hardware::audio::V5_0::IDevicesFactory>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V5_0::IDevicesFactory>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::V5_0::IDevicesFactory>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::V5_0::IDevicesFactory>& o) {
    ...
    os += ::android::hardware::audio::V5_0::IDevicesFactory::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V5_0_IDEVICESFACTORY_H
