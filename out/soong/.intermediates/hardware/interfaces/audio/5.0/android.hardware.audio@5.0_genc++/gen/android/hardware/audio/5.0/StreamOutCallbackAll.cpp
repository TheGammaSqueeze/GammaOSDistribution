#define LOG_TAG "android.hardware.audio@5.0::StreamOutCallback"
...
#include <android/hardware/audio/5.0/BpHwStreamOutCallback.h>
#include <android/hardware/audio/5.0/BnHwStreamOutCallback.h>
#include <android/hardware/audio/5.0/BsStreamOutCallback.h>
...
const char* IStreamOutCallback::descriptor("android.hardware.audio@5.0::IStreamOutCallback");
...
// Methods from ::android::hardware::audio::V5_0::IStreamOutCallback follow.
...
::android::hardware::Return<void> IStreamOutCallback::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::V5_0::IStreamOutCallback::descriptor,
...
::android::hardware::Return<void> IStreamOutCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::V5_0::IStreamOutCallback::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IStreamOutCallback::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){27,5,0,54,126,210,179,42,132,22,103,172,50,0,237,243,211,161,100,232,0,74,202,68,95,241,176,133,172,131,30,147} /* 1b0500367ed2b32a841667ac3200edf3d3a164e8004aca445ff1b085ac831e93 */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::V5_0::IStreamOutCallback>> IStreamOutCallback::castFrom(const ::android::sp<::android::hardware::audio::V5_0::IStreamOutCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::V5_0::IStreamOutCallback>> IStreamOutCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IStreamOutCallback, ::android::hidl::base::V1_0::IBase, BpHwStreamOutCallback>(
            parent, "android.hardware.audio@5.0::IStreamOutCallback", emitError);
}
...
BpHwStreamOutCallback::BpHwStreamOutCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IStreamOutCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio@5.0", "IStreamOutCallback") {
}
...
::android::hardware::Return<void> BpHwStreamOutCallback::_hidl_onWriteReady(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOutCallback", "onWriteReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOutCallback", "onWriteReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOutCallback::_hidl_onDrainReady(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOutCallback", "onDrainReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOutCallback", "onDrainReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOutCallback::_hidl_onError(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOutCallback", "onError", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOutCallback", "onError", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOutCallback::onWriteReady(){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOutCallback::_hidl_onWriteReady(this, this);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwStreamOutCallback::onDrainReady(){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOutCallback::_hidl_onDrainReady(this, this);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwStreamOutCallback::onError(){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOutCallback::_hidl_onError(this, this);
...
BnHwStreamOutCallback::BnHwStreamOutCallback(const ::android::sp<IStreamOutCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio@5.0", "IStreamOutCallback") { 
...
::android::status_t BnHwStreamOutCallback::_hidl_onWriteReady(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOutCallback", "onWriteReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOutCallback", "onWriteReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOutCallback::_hidl_onDrainReady(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOutCallback", "onDrainReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOutCallback", "onDrainReady", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOutCallback::_hidl_onError(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOutCallback", "onError", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOutCallback", "onError", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOutCallback::onTransact(
    ...
    switch (_hidl_code) {
        case 1 /* onWriteReady */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOutCallback::_hidl_onWriteReady(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 2 /* onDrainReady */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOutCallback::_hidl_onDrainReady(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 3 /* onError */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOutCallback::_hidl_onError(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsStreamOutCallback::BsStreamOutCallback(const ::android::sp<::android::hardware::audio::V5_0::IStreamOutCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio@5.0", "IStreamOutCallback"), mImpl(impl) {
...
bool IStreamOutCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio@5.0::IStreamOutCallback",
