#define LOG_TAG "android.hardware.audio@5.0::StreamOut"
...
#include <android/hardware/audio/5.0/BpHwStreamOut.h>
#include <android/hardware/audio/5.0/BnHwStreamOut.h>
#include <android/hardware/audio/5.0/BsStreamOut.h>
...
const char* IStreamOut::descriptor("android.hardware.audio@5.0::IStreamOut");
...
// no default implementation for: ::android::hardware::Return<void> IStreamOut::getSupportedSampleRates(::android::hardware::audio::common::V5_0::AudioFormat format, getSupportedSampleRates_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::setSampleRate(uint32_t sampleRateHz)
// no default implementation for: ::android::hardware::Return<::android::hardware::hidl_bitfield<::android::hardware::audio::common::V5_0::AudioChannelMask>> IStreamOut::getChannelMask()
// no default implementation for: ::android::hardware::Return<void> IStreamOut::getSupportedChannelMasks(::android::hardware::audio::common::V5_0::AudioFormat format, getSupportedChannelMasks_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::setChannelMask(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V5_0::AudioChannelMask> mask)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::common::V5_0::AudioFormat> IStreamOut::getFormat()
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::setFormat(::android::hardware::audio::common::V5_0::AudioFormat format)
// no default implementation for: ::android::hardware::Return<void> IStreamOut::getAudioProperties(getAudioProperties_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::addEffect(uint64_t effectId)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::removeEffect(uint64_t effectId)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::standby()
// no default implementation for: ::android::hardware::Return<void> IStreamOut::getDevices(getDevices_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::setDevices(const ::android::hardware::hidl_vec<::android::hardware::audio::common::V5_0::DeviceAddress>& devices)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::setHwAvSync(uint32_t hwAvSync)
// no default implementation for: ::android::hardware::Return<void> IStreamOut::getParameters(const ::android::hardware::hidl_vec<::android::hardware::audio::V5_0::ParameterValue>& context, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& keys, getParameters_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::setParameters(const ::android::hardware::hidl_vec<::android::hardware::audio::V5_0::ParameterValue>& context, const ::android::hardware::hidl_vec<::android::hardware::audio::V5_0::ParameterValue>& parameters)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::start()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::stop()
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::close()

// Methods from ::android::hardware::audio::V5_0::IStreamOut follow.
// no default implementation for: ::android::hardware::Return<uint32_t> IStreamOut::getLatency()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::setVolume(float left, float right)
// no default implementation for: ::android::hardware::Return<void> IStreamOut::updateSourceMetadata(const ::android::hardware::audio::common::V5_0::SourceMetadata& sourceMetadata)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::setCallback(const ::android::sp<::android::hardware::audio::V5_0::IStreamOutCallback>& callback)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::clearCallback()
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::pause()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::resume()
// no default implementation for: ::android::hardware::Return<bool> IStreamOut::supportsDrain()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::drain(::android::hardware::audio::V5_0::AudioDrain type)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::flush()
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V5_0::Result> IStreamOut::selectPresentation(int32_t presentationId, int32_t programId)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IStreamOut::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::V5_0::IStreamOut::descriptor,
...
::android::hardware::Return<void> IStreamOut::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::V5_0::IStreamOut::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IStreamOut::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){148,113,177,43,28,37,91,181,48,105,87,32,188,65,116,189,116,152,123,117,177,248,32,133,74,248,148,75,200,194,21,201} /* 9471b12b1c255bb530695720bc4174bd74987b75b1f820854af8944bc8c215c9 */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::V5_0::IStreamOut>> IStreamOut::castFrom(const ::android::sp<::android::hardware::audio::V5_0::IStreamOut>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::V5_0::IStreamOut>> IStreamOut::castFrom(const ::android::sp<::android::hardware::audio::V5_0::IStream>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IStreamOut, ::android::hardware::audio::V5_0::IStream, BpHwStreamOut>(
            parent, "android.hardware.audio@5.0::IStreamOut", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::audio::V5_0::IStreamOut>> IStreamOut::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwStreamOut::BpHwStreamOut(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IStreamOut>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio@5.0", "IStreamOut") {
}
...
::android::hardware::Return<uint32_t> BpHwStreamOut::_hidl_getLatency(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "getLatency", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "getLatency", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::_hidl_setVolume(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float left, float right) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "setVolume", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "setVolume", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOut::_hidl_updateSourceMetadata(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V5_0::SourceMetadata& sourceMetadata) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "updateSourceMetadata", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "updateSourceMetadata", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOut::_hidl_prepareForWriting(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t frameSize, uint32_t framesCount, prepareForWriting_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "prepareForWriting", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(30 /* prepareForWriting */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::V5_0::Result _hidl_out_retval;
        const ::android::hardware::MQDescriptorSync<::android::hardware::audio::V5_0::IStreamOut::WriteCommand>* _hidl_out_commandMQ;
        const ::android::hardware::MQDescriptorSync<uint8_t>* _hidl_out_dataMQ;
        const ::android::hardware::MQDescriptorSync<::android::hardware::audio::V5_0::IStreamOut::WriteStatus>* _hidl_out_statusMQ;
        ...
        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::MQDescriptorSync<::android::hardware::audio::V5_0::IStreamOut::WriteCommand> &>(*_hidl_out_commandMQ),
                _hidl_reply,
        ...
        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::MQDescriptorSync<::android::hardware::audio::V5_0::IStreamOut::WriteStatus> &>(*_hidl_out_statusMQ),
                _hidl_reply,
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "prepareForWriting", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOut::_hidl_getRenderPosition(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getRenderPosition_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "getRenderPosition", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(31 /* getRenderPosition */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "getRenderPosition", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOut::_hidl_getNextWriteTimestamp(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getNextWriteTimestamp_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "getNextWriteTimestamp", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(32 /* getNextWriteTimestamp */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "getNextWriteTimestamp", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::_hidl_setCallback(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::audio::V5_0::IStreamOutCallback>& callback) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::_hidl_clearCallback(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "clearCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "clearCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOut::_hidl_supportsPauseAndResume(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, supportsPauseAndResume_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "supportsPauseAndResume", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(35 /* supportsPauseAndResume */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "supportsPauseAndResume", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::_hidl_pause(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "pause", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(36 /* pause */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "pause", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::_hidl_resume(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "resume", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(37 /* resume */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "resume", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<bool> BpHwStreamOut::_hidl_supportsDrain(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "supportsDrain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(38 /* supportsDrain */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "supportsDrain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::_hidl_drain(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::V5_0::AudioDrain type) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "drain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(39 /* drain */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "drain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::_hidl_flush(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "flush", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(40 /* flush */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "flush", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOut::_hidl_getPresentationPosition(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getPresentationPosition_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "getPresentationPosition", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(41 /* getPresentationPosition */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::V5_0::Result _hidl_out_retval;
        uint64_t _hidl_out_frames;
        ::android::hardware::audio::V5_0::TimeSpec* _hidl_out_timeStamp;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "getPresentationPosition", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::_hidl_selectPresentation(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t presentationId, int32_t programId) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "selectPresentation", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(42 /* selectPresentation */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "selectPresentation", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOut::getSupportedSampleRates(::android::hardware::audio::common::V5_0::AudioFormat format, getSupportedSampleRates_cb _hidl_cb){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::setSampleRate(uint32_t sampleRateHz){
...
::android::hardware::Return<::android::hardware::hidl_bitfield<::android::hardware::audio::common::V5_0::AudioChannelMask>> BpHwStreamOut::getChannelMask(){
...
::android::hardware::Return<void> BpHwStreamOut::getSupportedChannelMasks(::android::hardware::audio::common::V5_0::AudioFormat format, getSupportedChannelMasks_cb _hidl_cb){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::setChannelMask(::android::hardware::hidl_bitfield<::android::hardware::audio::common::V5_0::AudioChannelMask> mask){
...
::android::hardware::Return<::android::hardware::audio::common::V5_0::AudioFormat> BpHwStreamOut::getFormat(){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::setFormat(::android::hardware::audio::common::V5_0::AudioFormat format){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::addEffect(uint64_t effectId){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::removeEffect(uint64_t effectId){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::standby(){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::setDevices(const ::android::hardware::hidl_vec<::android::hardware::audio::common::V5_0::DeviceAddress>& devices){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::setHwAvSync(uint32_t hwAvSync){
...
::android::hardware::Return<void> BpHwStreamOut::getParameters(const ::android::hardware::hidl_vec<::android::hardware::audio::V5_0::ParameterValue>& context, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& keys, getParameters_cb _hidl_cb){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::setParameters(const ::android::hardware::hidl_vec<::android::hardware::audio::V5_0::ParameterValue>& context, const ::android::hardware::hidl_vec<::android::hardware::audio::V5_0::ParameterValue>& parameters){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::start(){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::stop(){
...
::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::close(){
...
::android::hardware::Return<uint32_t> BpHwStreamOut::getLatency(){
    ::android::hardware::Return<uint32_t>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_getLatency(this, this);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::setVolume(float left, float right){
    ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_setVolume(this, this, left, right);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwStreamOut::updateSourceMetadata(const ::android::hardware::audio::common::V5_0::SourceMetadata& sourceMetadata){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_updateSourceMetadata(this, this, sourceMetadata);
...
::android::hardware::Return<void> BpHwStreamOut::prepareForWriting(uint32_t frameSize, uint32_t framesCount, prepareForWriting_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_prepareForWriting(this, this, frameSize, framesCount, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwStreamOut::getRenderPosition(getRenderPosition_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_getRenderPosition(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwStreamOut::getNextWriteTimestamp(getNextWriteTimestamp_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_getNextWriteTimestamp(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::setCallback(const ::android::sp<::android::hardware::audio::V5_0::IStreamOutCallback>& callback){
    ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_setCallback(this, this, callback);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::clearCallback(){
    ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_clearCallback(this, this);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwStreamOut::supportsPauseAndResume(supportsPauseAndResume_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_supportsPauseAndResume(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::pause(){
    ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_pause(this, this);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::resume(){
    ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_resume(this, this);

    return _hidl_out;
}

::android::hardware::Return<bool> BpHwStreamOut::supportsDrain(){
    ::android::hardware::Return<bool>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_supportsDrain(this, this);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::drain(::android::hardware::audio::V5_0::AudioDrain type){
    ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_drain(this, this, type);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::flush(){
    ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_flush(this, this);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwStreamOut::getPresentationPosition(getPresentationPosition_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_getPresentationPosition(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V5_0::Result> BpHwStreamOut::selectPresentation(int32_t presentationId, int32_t programId){
    ::android::hardware::Return<::android::hardware::audio::V5_0::Result>  _hidl_out = ::android::hardware::audio::V5_0::BpHwStreamOut::_hidl_selectPresentation(this, this, presentationId, programId);
...
BnHwStreamOut::BnHwStreamOut(const ::android::sp<IStreamOut> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio@5.0", "IStreamOut") { 
...
::android::status_t BnHwStreamOut::_hidl_getLatency(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "getLatency", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_latencyMs);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "getLatency", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_setVolume(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&right);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "setVolume", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V5_0::Result _hidl_out_retval = static_cast<IStreamOut*>(_hidl_this->getImpl().get())->setVolume(left, right);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "setVolume", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_updateSourceMetadata(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)sourceMetadata);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "updateSourceMetadata", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "updateSourceMetadata", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_prepareForWriting(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&framesCount);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "prepareForWriting", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_threadInfo);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "prepareForWriting", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_getRenderPosition(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "getRenderPosition", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_dspFrames);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "getRenderPosition", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_getNextWriteTimestamp(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "getNextWriteTimestamp", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_timestampUs);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "getNextWriteTimestamp", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_setCallback(
    ...
    ::android::sp<::android::hardware::audio::V5_0::IStreamOutCallback> callback;

    {
        ...
        callback = ::android::hardware::fromBinder<::android::hardware::audio::V5_0::IStreamOutCallback,::android::hardware::audio::V5_0::BpHwStreamOutCallback,::android::hardware::audio::V5_0::BnHwStreamOutCallback>(_hidl_binder);
    }
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&callback);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V5_0::Result _hidl_out_retval = static_cast<IStreamOut*>(_hidl_this->getImpl().get())->setCallback(callback);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "setCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_clearCallback(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "clearCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V5_0::Result _hidl_out_retval = static_cast<IStreamOut*>(_hidl_this->getImpl().get())->clearCallback();
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "clearCallback", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_supportsPauseAndResume(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "supportsPauseAndResume", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_supportsResume);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "supportsPauseAndResume", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_pause(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "pause", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V5_0::Result _hidl_out_retval = static_cast<IStreamOut*>(_hidl_this->getImpl().get())->pause();
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "pause", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_resume(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "resume", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V5_0::Result _hidl_out_retval = static_cast<IStreamOut*>(_hidl_this->getImpl().get())->resume();
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "resume", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_supportsDrain(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "supportsDrain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_supports);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "supportsDrain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_drain(
    ...
    ::android::hardware::audio::V5_0::AudioDrain type;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&type);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "drain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V5_0::Result _hidl_out_retval = static_cast<IStreamOut*>(_hidl_this->getImpl().get())->drain(type);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "drain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_flush(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "flush", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V5_0::Result _hidl_out_retval = static_cast<IStreamOut*>(_hidl_this->getImpl().get())->flush();
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "flush", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_getPresentationPosition(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "getPresentationPosition", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_timeStamp);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "getPresentationPosition", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::_hidl_selectPresentation(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&programId);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "5.0", "IStreamOut", "selectPresentation", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V5_0::Result _hidl_out_retval = static_cast<IStreamOut*>(_hidl_this->getImpl().get())->selectPresentation(presentationId, programId);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "5.0", "IStreamOut", "selectPresentation", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOut::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 27 /* getLatency */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_getLatency(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 28 /* setVolume */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_setVolume(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 29 /* updateSourceMetadata */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_updateSourceMetadata(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 30 /* prepareForWriting */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_prepareForWriting(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 31 /* getRenderPosition */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_getRenderPosition(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 32 /* getNextWriteTimestamp */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_getNextWriteTimestamp(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 33 /* setCallback */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_setCallback(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 34 /* clearCallback */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_clearCallback(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 35 /* supportsPauseAndResume */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_supportsPauseAndResume(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 36 /* pause */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_pause(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 37 /* resume */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_resume(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 38 /* supportsDrain */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_supportsDrain(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 39 /* drain */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_drain(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 40 /* flush */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_flush(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 41 /* getPresentationPosition */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_getPresentationPosition(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 42 /* selectPresentation */:
        {
            _hidl_err = ::android::hardware::audio::V5_0::BnHwStreamOut::_hidl_selectPresentation(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsStreamOut::BsStreamOut(const ::android::sp<::android::hardware::audio::V5_0::IStreamOut> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio@5.0", "IStreamOut"), mImpl(impl) {
...
bool IStreamOut::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio@5.0::IStreamOut",
