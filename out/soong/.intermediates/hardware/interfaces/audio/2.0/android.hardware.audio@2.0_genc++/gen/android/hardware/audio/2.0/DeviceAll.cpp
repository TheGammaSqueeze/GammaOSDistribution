...
::android::hardware::Return<uint32_t> BpHwDevice::_hidl_getHwAvSync(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(16 /* getHwAvSync */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
...
::android::hardware::Return<void> BpHwDevice::_hidl_debugDump(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_handle& fd) {
    ...
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDevice::debugDump::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(20 /* debugDump */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
...
::android::status_t BnHwDevice::_hidl_openOutputStream(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDevice*>(_hidl_this->getImpl().get())->openOutputStream(ioHandle, *device, *config, flags, [&](const auto &_hidl_out_retval, const auto &_hidl_out_outStream, const auto &_hidl_out_suggestedConfig) {
        if (_hidl_callbackCalled) {
...
::android::status_t BnHwDevice::_hidl_openInputStream(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDevice*>(_hidl_this->getImpl().get())->openInputStream(ioHandle, *device, *config, flags, source, [&](const auto &_hidl_out_retval, const auto &_hidl_out_inStream, const auto &_hidl_out_suggestedConfig) {
        if (_hidl_callbackCalled) {
...
::android::status_t BnHwDevice::_hidl_getParameters(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDevice*>(_hidl_this->getImpl().get())->getParameters(*keys, [&](const auto &_hidl_out_retval, const auto &_hidl_out_parameters) {
        if (_hidl_callbackCalled) {
...
::android::status_t BnHwDevice::_hidl_debugDump(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDevice*>(_hidl_this->getImpl().get())->debugDump(fd);
