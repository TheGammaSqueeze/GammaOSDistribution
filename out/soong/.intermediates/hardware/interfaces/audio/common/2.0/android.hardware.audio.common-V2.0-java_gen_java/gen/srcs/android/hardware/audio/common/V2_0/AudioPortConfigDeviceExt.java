...
public final class AudioPortConfigDeviceExt {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.audio.common.V2_0.AudioPortConfigDeviceExt.class) {
            return false;
        }
    ...
    public static final java.util.ArrayList<AudioPortConfigDeviceExt> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<AudioPortConfigDeviceExt> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((android.hardware.audio.common.V2_0.AudioPortConfigDeviceExt) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 40);
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<AudioPortConfigDeviceExt> _hidl_vec) {
