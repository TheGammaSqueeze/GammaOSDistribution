#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_IDEVICESFACTORY_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_IDEVICESFACTORY_H
...
struct IDevicesFactory : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio@7.0::IDevicesFactory"
     */
     ...
     */
    using openDevice_cb = std::function<void(::android::hardware::audio::V7_0::Result retval, const ::android::sp<::android::hardware::audio::V7_0::IDevice>& result)>;
    /**
     ...
     */
    using openPrimaryDevice_cb = std::function<void(::android::hardware::audio::V7_0::Result retval, const ::android::sp<::android::hardware::audio::V7_0::IPrimaryDevice>& result)>;
    /**
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IDevicesFactory>> castFrom(const ::android::sp<::android::hardware::audio::V7_0::IDevicesFactory>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IDevicesFactory>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::V7_0::IDevicesFactory>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::V7_0::IDevicesFactory>& o) {
    ...
    os += ::android::hardware::audio::V7_0::IDevicesFactory::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_IDEVICESFACTORY_H
