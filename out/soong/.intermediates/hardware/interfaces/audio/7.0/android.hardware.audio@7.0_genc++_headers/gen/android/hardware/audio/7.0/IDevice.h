#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_IDEVICE_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_IDEVICE_H
...
struct IDevice : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio@7.0::IDevice"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IDevice>> castFrom(const ::android::sp<::android::hardware::audio::V7_0::IDevice>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IDevice>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::V7_0::IDevice>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::V7_0::IDevice>& o) {
    ...
    os += ::android::hardware::audio::V7_0::IDevice::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_IDEVICE_H
