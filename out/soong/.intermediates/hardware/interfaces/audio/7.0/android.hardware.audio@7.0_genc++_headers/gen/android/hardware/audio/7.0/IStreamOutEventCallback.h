#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_ISTREAMOUTEVENTCALLBACK_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_ISTREAMOUTEVENTCALLBACK_H
...
struct IStreamOutEventCallback : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio@7.0::IStreamOutEventCallback"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IStreamOutEventCallback>> castFrom(const ::android::sp<::android::hardware::audio::V7_0::IStreamOutEventCallback>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IStreamOutEventCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::V7_0::IStreamOutEventCallback>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::V7_0::IStreamOutEventCallback>& o) {
    ...
    os += ::android::hardware::audio::V7_0::IStreamOutEventCallback::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_ISTREAMOUTEVENTCALLBACK_H
