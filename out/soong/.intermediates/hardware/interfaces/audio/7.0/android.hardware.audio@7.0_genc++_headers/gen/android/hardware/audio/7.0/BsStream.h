#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_BSSTREAM_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_BSSTREAM_H
...
struct BsStream : IStream, ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> getSupportedProfiles(getSupportedProfiles_cb _hidl_cb) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IStream::getSupportedProfiles::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
            for (const auto &callback: mInstrumentationCallbacks) {
    ...
    ::android::hardware::Return<::android::hardware::audio::V7_0::Result> setAudioProperties(const ::android::hardware::audio::common::V7_0::AudioConfigBaseOptional& config) override {
        atrace_begin(ATRACE_TAG_HAL, "HIDL::IStream::setAudioProperties::passthrough");
        #ifdef __ANDROID_DEBUGGABLE__
        if (UNLIKELY(mEnableInstrumentation)) {
            std::vector<void *> _hidl_args;
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_BSSTREAM_H
