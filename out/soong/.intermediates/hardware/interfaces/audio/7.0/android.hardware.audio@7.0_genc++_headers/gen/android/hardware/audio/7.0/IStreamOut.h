#ifndef HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_ISTREAMOUT_H
#define HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_ISTREAMOUT_H

#include <android/hardware/audio/common/7.0/types.h>
#include <android/hardware/audio/7.0/IStream.h>
#include <android/hardware/audio/7.0/IStreamOutCallback.h>
#include <android/hardware/audio/7.0/IStreamOutEventCallback.h>
...
struct IStreamOut : public ::android::hardware::audio::V7_0::IStream {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.audio@7.0::IStreamOut"
     */
    ...
    enum class WriteCommand : int32_t {
        WRITE = 0,
        GET_PRESENTATION_POSITION = 1 /* ::android::hardware::audio::V7_0::IStreamOut::WriteCommand.WRITE implicitly + 1 */,
        GET_LATENCY = 2 /* ::android::hardware::audio::V7_0::IStreamOut::WriteCommand.GET_PRESENTATION_POSITION implicitly + 1 */,
    };
    ...
    struct WriteStatus final {
        ...
        union Reply final {
            ...
            struct PresentationPosition final {
                ...
                ::android::hardware::audio::V7_0::TimeSpec timeStamp __attribute__ ((aligned(8)));
            };

            static_assert(offsetof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition, frames) == 0, "wrong offset");
            static_assert(offsetof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition, timeStamp) == 8, "wrong offset");
            static_assert(sizeof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition) == 24, "wrong size");
            static_assert(__alignof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition) == 8, "wrong alignment");

            uint64_t written __attribute__ ((aligned(8)));
            ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition presentationPosition __attribute__ ((aligned(8)));
            uint32_t latencyMs __attribute__ ((aligned(4)));
        };

        static_assert(offsetof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply, written) == 0, "wrong offset");
        static_assert(offsetof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply, presentationPosition) == 0, "wrong offset");
        static_assert(offsetof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply, latencyMs) == 0, "wrong offset");
        static_assert(sizeof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply) == 24, "wrong size");
        static_assert(__alignof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply) == 8, "wrong alignment");

        ::android::hardware::audio::V7_0::Result retval __attribute__ ((aligned(4)));
        ::android::hardware::audio::V7_0::IStreamOut::WriteCommand replyTo __attribute__ ((aligned(4)));
        ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply reply __attribute__ ((aligned(8)));
    };

    static_assert(offsetof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus, retval) == 0, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus, replyTo) == 4, "wrong offset");
    static_assert(offsetof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus, reply) == 8, "wrong offset");
    static_assert(sizeof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus) == 32, "wrong size");
    static_assert(__alignof(::android::hardware::audio::V7_0::IStreamOut::WriteStatus) == 8, "wrong alignment");
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> setVolume(float left, float right) = 0;
     ...
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> updateSourceMetadata(const ::android::hardware::audio::common::V7_0::SourceMetadata& sourceMetadata) = 0;

    /**
     * Return callback for prepareForWriting
     */
    using prepareForWriting_cb = std::function<void(::android::hardware::audio::V7_0::Result retval, const ::android::hardware::MQDescriptorSync<::android::hardware::audio::V7_0::IStreamOut::WriteCommand>& commandMQ, const ::android::hardware::MQDescriptorSync<uint8_t>& dataMQ, const ::android::hardware::MQDescriptorSync<::android::hardware::audio::V7_0::IStreamOut::WriteStatus>& statusMQ, int32_t threadId)>;
    /**
     ...
     */
    using getRenderPosition_cb = std::function<void(::android::hardware::audio::V7_0::Result retval, uint32_t dspFrames)>;
    /**
     ...
     */
    using getNextWriteTimestamp_cb = std::function<void(::android::hardware::audio::V7_0::Result retval, int64_t timestampUs)>;
    /**
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> setCallback(const ::android::sp<::android::hardware::audio::V7_0::IStreamOutCallback>& callback) = 0;
     ...
     * @return retval operation completion status: OK or NOT_SUPPORTED.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> clearCallback() = 0;
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> setEventCallback(const ::android::sp<::android::hardware::audio::V7_0::IStreamOutEventCallback>& callback) = 0;
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> pause() = 0;
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> resume() = 0;
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> drain(::android::hardware::audio::V7_0::AudioDrain type) = 0;
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> flush() = 0;

    /**
     * Return callback for getPresentationPosition
     */
    using getPresentationPosition_cb = std::function<void(::android::hardware::audio::V7_0::Result retval, uint64_t frames, const ::android::hardware::audio::V7_0::TimeSpec& timeStamp)>;
    /**
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> selectPresentation(int32_t presentationId, int32_t programId) = 0;

    /**
     * Return callback for getDualMonoMode
     */
    using getDualMonoMode_cb = std::function<void(::android::hardware::audio::V7_0::Result retval, ::android::hardware::audio::V7_0::DualMonoMode mode)>;
    /**
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> setDualMonoMode(::android::hardware::audio::V7_0::DualMonoMode mode) = 0;

    /**
     * Return callback for getAudioDescriptionMixLevel
     */
    using getAudioDescriptionMixLevel_cb = std::function<void(::android::hardware::audio::V7_0::Result retval, float leveldB)>;
    /**
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> setAudioDescriptionMixLevel(float leveldB) = 0;

    /**
     * Return callback for getPlaybackRateParameters
     */
    using getPlaybackRateParameters_cb = std::function<void(::android::hardware::audio::V7_0::Result retval, const ::android::hardware::audio::V7_0::PlaybackRate& playbackRate)>;
    /**
     ...
     * @return retval operation completion status.
     */
    virtual ::android::hardware::Return<::android::hardware::audio::V7_0::Result> setPlaybackRateParameters(const ::android::hardware::audio::V7_0::PlaybackRate& playbackRate) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IStreamOut>> castFrom(const ::android::sp<::android::hardware::audio::V7_0::IStreamOut>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IStreamOut>> castFrom(const ::android::sp<::android::hardware::audio::V7_0::IStream>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IStreamOut>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(::android::hardware::audio::V7_0::IStreamOut::WriteCommand o);
static inline void PrintTo(::android::hardware::audio::V7_0::IStreamOut::WriteCommand o, ::std::ostream* os);
constexpr int32_t operator|(const ::android::hardware::audio::V7_0::IStreamOut::WriteCommand lhs, const ::android::hardware::audio::V7_0::IStreamOut::WriteCommand rhs) {
    return static_cast<int32_t>(static_cast<int32_t>(lhs) | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const int32_t lhs, const ::android::hardware::audio::V7_0::IStreamOut::WriteCommand rhs) {
    return static_cast<int32_t>(lhs | static_cast<int32_t>(rhs));
}
constexpr int32_t operator|(const ::android::hardware::audio::V7_0::IStreamOut::WriteCommand lhs, const int32_t rhs) {
...
constexpr int32_t &operator|=(int32_t& v, const ::android::hardware::audio::V7_0::IStreamOut::WriteCommand e) {
...
static inline std::string toString(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition& o);
static inline void PrintTo(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition& o, ::std::ostream*);
static inline bool operator==(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition& lhs, const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition& rhs);
static inline bool operator!=(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition& lhs, const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition& rhs);

static inline std::string toString(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply& o);
static inline void PrintTo(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply& o, ::std::ostream*);
// operator== and operator!= are not generated for Reply

static inline std::string toString(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus& o);
static inline void PrintTo(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus& o, ::std::ostream*);
// operator== and operator!= are not generated for WriteStatus

static inline std::string toString(const ::android::sp<::android::hardware::audio::V7_0::IStreamOut>& o);
...
template<>
inline std::string toString<::android::hardware::audio::V7_0::IStreamOut::WriteCommand>(int32_t o) {
    using ::android::hardware::details::toHexString;
    std::string os;
    ::android::hardware::hidl_bitfield<::android::hardware::audio::V7_0::IStreamOut::WriteCommand> flipped = 0;
    bool first = true;
    if ((o & ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::WRITE) == static_cast<int32_t>(::android::hardware::audio::V7_0::IStreamOut::WriteCommand::WRITE)) {
        os += (first ? "" : " | ");
        os += "WRITE";
        first = false;
        flipped |= ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::WRITE;
    }
    if ((o & ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::GET_PRESENTATION_POSITION) == static_cast<int32_t>(::android::hardware::audio::V7_0::IStreamOut::WriteCommand::GET_PRESENTATION_POSITION)) {
        os += (first ? "" : " | ");
        os += "GET_PRESENTATION_POSITION";
        first = false;
        flipped |= ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::GET_PRESENTATION_POSITION;
    }
    if ((o & ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::GET_LATENCY) == static_cast<int32_t>(::android::hardware::audio::V7_0::IStreamOut::WriteCommand::GET_LATENCY)) {
        os += (first ? "" : " | ");
        os += "GET_LATENCY";
        first = false;
        flipped |= ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::GET_LATENCY;
    }
    if (o != flipped) {
        os += (first ? "" : " | ");
...
static inline std::string toString(::android::hardware::audio::V7_0::IStreamOut::WriteCommand o) {
    using ::android::hardware::details::toHexString;
    if (o == ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::WRITE) {
        return "WRITE";
    }
    if (o == ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::GET_PRESENTATION_POSITION) {
        return "GET_PRESENTATION_POSITION";
    }
    if (o == ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::GET_LATENCY) {
        return "GET_LATENCY";
    }
    std::string os;
...
static inline std::string toString(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition& o) {
    ...
    os += ", .timeStamp = ";
    os += ::android::hardware::audio::V7_0::toString(o.timeStamp);
    os += "}"; return os;
}

static inline void PrintTo(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply::PresentationPosition& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply& o) {
    ...
    os += ::android::hardware::audio::V7_0::toString(o.presentationPosition);
    os += ", .latencyMs = ";
    os += ::android::hardware::toString(o.latencyMs);
    os += "}"; return os;
}

static inline void PrintTo(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus::Reply& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline void PrintTo(const ::android::hardware::audio::V7_0::IStreamOut::WriteStatus& o, ::std::ostream* os) {
    *os << toString(o);
}
...
static inline std::string toString(const ::android::sp<::android::hardware::audio::V7_0::IStreamOut>& o) {
    ...
    os += ::android::hardware::audio::V7_0::IStreamOut::descriptor;
    os += "]";
...
template<> inline constexpr std::array<::android::hardware::audio::V7_0::IStreamOut::WriteCommand, 3> hidl_enum_values<::android::hardware::audio::V7_0::IStreamOut::WriteCommand> = {
    ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::WRITE,
    ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::GET_PRESENTATION_POSITION,
    ::android::hardware::audio::V7_0::IStreamOut::WriteCommand::GET_LATENCY,
};
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_AUDIO_V7_0_ISTREAMOUT_H
