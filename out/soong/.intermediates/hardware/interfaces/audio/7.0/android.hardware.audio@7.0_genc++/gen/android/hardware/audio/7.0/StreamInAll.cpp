#define LOG_TAG "android.hardware.audio@7.0::StreamIn"
...
#include <android/hardware/audio/7.0/BpHwStreamIn.h>
#include <android/hardware/audio/7.0/BnHwStreamIn.h>
#include <android/hardware/audio/7.0/BsStreamIn.h>
...
const char* IStreamIn::descriptor("android.hardware.audio@7.0::IStreamIn");
...
// no default implementation for: ::android::hardware::Return<void> IStreamIn::getSupportedProfiles(getSupportedProfiles_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<void> IStreamIn::getAudioProperties(getAudioProperties_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::setAudioProperties(const ::android::hardware::audio::common::V7_0::AudioConfigBaseOptional& config)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::addEffect(uint64_t effectId)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::removeEffect(uint64_t effectId)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::standby()
// no default implementation for: ::android::hardware::Return<void> IStreamIn::getDevices(getDevices_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::setDevices(const ::android::hardware::hidl_vec<::android::hardware::audio::common::V7_0::DeviceAddress>& devices)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::setHwAvSync(uint32_t hwAvSync)
// no default implementation for: ::android::hardware::Return<void> IStreamIn::getParameters(const ::android::hardware::hidl_vec<::android::hardware::audio::V7_0::ParameterValue>& context, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& keys, getParameters_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::setParameters(const ::android::hardware::hidl_vec<::android::hardware::audio::V7_0::ParameterValue>& context, const ::android::hardware::hidl_vec<::android::hardware::audio::V7_0::ParameterValue>& parameters)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::start()
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::stop()
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::close()

// Methods from ::android::hardware::audio::V7_0::IStreamIn follow.
// no default implementation for: ::android::hardware::Return<void> IStreamIn::getAudioSource(getAudioSource_cb _hidl_cb)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::setGain(float gain)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::updateSinkMetadata(const ::android::hardware::audio::common::V7_0::SinkMetadata& sinkMetadata)
...
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::setMicrophoneDirection(::android::hardware::audio::V7_0::MicrophoneDirection direction)
// no default implementation for: ::android::hardware::Return<::android::hardware::audio::V7_0::Result> IStreamIn::setMicrophoneFieldDimension(float zoom)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IStreamIn::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::V7_0::IStreamIn::descriptor,
...
::android::hardware::Return<void> IStreamIn::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::V7_0::IStreamIn::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IStreamIn::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){119,216,67,48,65,138,187,165,169,43,12,220,78,39,250,124,133,194,115,68,234,247,238,239,68,27,142,136,130,158,228,117} /* 77d84330418abba5a92b0cdc4e27fa7c85c27344eaf7eeef441b8e88829ee475 */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IStreamIn>> IStreamIn::castFrom(const ::android::sp<::android::hardware::audio::V7_0::IStreamIn>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IStreamIn>> IStreamIn::castFrom(const ::android::sp<::android::hardware::audio::V7_0::IStream>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IStreamIn, ::android::hardware::audio::V7_0::IStream, BpHwStreamIn>(
            parent, "android.hardware.audio@7.0::IStreamIn", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::audio::V7_0::IStreamIn>> IStreamIn::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwStreamIn::BpHwStreamIn(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IStreamIn>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio@7.0", "IStreamIn") {
}
...
::android::hardware::Return<void> BpHwStreamIn::_hidl_getAudioSource(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getAudioSource_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "getAudioSource", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(20 /* getAudioSource */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::V7_0::Result _hidl_out_retval;
        const ::android::hardware::hidl_string* _hidl_out_source;
        ...
        size_t _hidl__hidl_out_source_parent;

        _hidl_err = _hidl_reply.readBuffer(sizeof(*_hidl_out_source), &_hidl__hidl_out_source_parent,  reinterpret_cast<const void **>(&_hidl_out_source));

        if (_hidl_err != ::android::OK) { return; }

        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::hidl_string &>(*_hidl_out_source),
                _hidl_reply,
                _hidl__hidl_out_source_parent,
                0 /* parentOffset */);
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "getAudioSource", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::_hidl_setGain(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float gain) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "setGain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(21 /* setGain */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "setGain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::_hidl_updateSinkMetadata(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::audio::common::V7_0::SinkMetadata& sinkMetadata) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "updateSinkMetadata", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(22 /* updateSinkMetadata */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "updateSinkMetadata", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamIn::_hidl_prepareForReading(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, uint32_t frameSize, uint32_t framesCount, prepareForReading_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "prepareForReading", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(23 /* prepareForReading */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::V7_0::Result _hidl_out_retval;
        const ::android::hardware::MQDescriptorSync<::android::hardware::audio::V7_0::IStreamIn::ReadParameters>* _hidl_out_commandMQ;
        const ::android::hardware::MQDescriptorSync<uint8_t>* _hidl_out_dataMQ;
        const ::android::hardware::MQDescriptorSync<::android::hardware::audio::V7_0::IStreamIn::ReadStatus>* _hidl_out_statusMQ;
        ...
        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::MQDescriptorSync<::android::hardware::audio::V7_0::IStreamIn::ReadParameters> &>(*_hidl_out_commandMQ),
                _hidl_reply,
        ...
        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::MQDescriptorSync<::android::hardware::audio::V7_0::IStreamIn::ReadStatus> &>(*_hidl_out_statusMQ),
                _hidl_reply,
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "prepareForReading", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<uint32_t> BpHwStreamIn::_hidl_getInputFramesLost(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "getInputFramesLost", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(24 /* getInputFramesLost */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "getInputFramesLost", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamIn::_hidl_getCapturePosition(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getCapturePosition_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "getCapturePosition", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(25 /* getCapturePosition */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::V7_0::Result _hidl_out_retval;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "getCapturePosition", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamIn::_hidl_getActiveMicrophones(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, getActiveMicrophones_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "getActiveMicrophones", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(26 /* getActiveMicrophones */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::V7_0::Result _hidl_out_retval;
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "getActiveMicrophones", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::_hidl_setMicrophoneDirection(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::audio::V7_0::MicrophoneDirection direction) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "setMicrophoneDirection", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(27 /* setMicrophoneDirection */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "setMicrophoneDirection", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::_hidl_setMicrophoneFieldDimension(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, float zoom) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "setMicrophoneFieldDimension", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(28 /* setMicrophoneFieldDimension */, _hidl_data, &_hidl_reply, 0 /* flags */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "setMicrophoneFieldDimension", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamIn::getSupportedProfiles(getSupportedProfiles_cb _hidl_cb){
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::setAudioProperties(const ::android::hardware::audio::common::V7_0::AudioConfigBaseOptional& config){
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::addEffect(uint64_t effectId){
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::removeEffect(uint64_t effectId){
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::standby(){
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::setDevices(const ::android::hardware::hidl_vec<::android::hardware::audio::common::V7_0::DeviceAddress>& devices){
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::setHwAvSync(uint32_t hwAvSync){
...
::android::hardware::Return<void> BpHwStreamIn::getParameters(const ::android::hardware::hidl_vec<::android::hardware::audio::V7_0::ParameterValue>& context, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& keys, getParameters_cb _hidl_cb){
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::setParameters(const ::android::hardware::hidl_vec<::android::hardware::audio::V7_0::ParameterValue>& context, const ::android::hardware::hidl_vec<::android::hardware::audio::V7_0::ParameterValue>& parameters){
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::start(){
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::stop(){
...
::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::close(){
...
::android::hardware::Return<void> BpHwStreamIn::getAudioSource(getAudioSource_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V7_0::BpHwStreamIn::_hidl_getAudioSource(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::setGain(float gain){
    ::android::hardware::Return<::android::hardware::audio::V7_0::Result>  _hidl_out = ::android::hardware::audio::V7_0::BpHwStreamIn::_hidl_setGain(this, this, gain);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::updateSinkMetadata(const ::android::hardware::audio::common::V7_0::SinkMetadata& sinkMetadata){
    ::android::hardware::Return<::android::hardware::audio::V7_0::Result>  _hidl_out = ::android::hardware::audio::V7_0::BpHwStreamIn::_hidl_updateSinkMetadata(this, this, sinkMetadata);
...
::android::hardware::Return<void> BpHwStreamIn::prepareForReading(uint32_t frameSize, uint32_t framesCount, prepareForReading_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V7_0::BpHwStreamIn::_hidl_prepareForReading(this, this, frameSize, framesCount, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<uint32_t> BpHwStreamIn::getInputFramesLost(){
    ::android::hardware::Return<uint32_t>  _hidl_out = ::android::hardware::audio::V7_0::BpHwStreamIn::_hidl_getInputFramesLost(this, this);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwStreamIn::getCapturePosition(getCapturePosition_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V7_0::BpHwStreamIn::_hidl_getCapturePosition(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwStreamIn::getActiveMicrophones(getActiveMicrophones_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V7_0::BpHwStreamIn::_hidl_getActiveMicrophones(this, this, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::setMicrophoneDirection(::android::hardware::audio::V7_0::MicrophoneDirection direction){
    ::android::hardware::Return<::android::hardware::audio::V7_0::Result>  _hidl_out = ::android::hardware::audio::V7_0::BpHwStreamIn::_hidl_setMicrophoneDirection(this, this, direction);

    return _hidl_out;
}

::android::hardware::Return<::android::hardware::audio::V7_0::Result> BpHwStreamIn::setMicrophoneFieldDimension(float zoom){
    ::android::hardware::Return<::android::hardware::audio::V7_0::Result>  _hidl_out = ::android::hardware::audio::V7_0::BpHwStreamIn::_hidl_setMicrophoneFieldDimension(this, this, zoom);
...
BnHwStreamIn::BnHwStreamIn(const ::android::sp<IStreamIn> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio@7.0", "IStreamIn") { 
...
::android::status_t BnHwStreamIn::_hidl_getAudioSource(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "getAudioSource", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IStreamIn*>(_hidl_this->getImpl().get())->getAudioSource([&](const auto &_hidl_out_retval, const auto &_hidl_out_source) {
        ...
        _hidl_err = _hidl_reply->writeBuffer(&_hidl_out_source, sizeof(_hidl_out_source), &_hidl__hidl_out_source_parent);
        if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_source);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "getAudioSource", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamIn::_hidl_setGain(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&gain);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "setGain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V7_0::Result _hidl_out_retval = static_cast<IStreamIn*>(_hidl_this->getImpl().get())->setGain(gain);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "setGain", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamIn::_hidl_updateSinkMetadata(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)sinkMetadata);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "updateSinkMetadata", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V7_0::Result _hidl_out_retval = static_cast<IStreamIn*>(_hidl_this->getImpl().get())->updateSinkMetadata(*sinkMetadata);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "updateSinkMetadata", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamIn::_hidl_prepareForReading(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&framesCount);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "prepareForReading", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IStreamIn*>(_hidl_this->getImpl().get())->prepareForReading(frameSize, framesCount, [&](const auto &_hidl_out_retval, const auto &_hidl_out_commandMQ, const auto &_hidl_out_dataMQ, const auto &_hidl_out_statusMQ, const auto &_hidl_out_threadId) {
        if (_hidl_callbackCalled) {
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_threadId);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "prepareForReading", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamIn::_hidl_getInputFramesLost(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "getInputFramesLost", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_framesLost);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "getInputFramesLost", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamIn::_hidl_getCapturePosition(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "getCapturePosition", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_time);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "getCapturePosition", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamIn::_hidl_getActiveMicrophones(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "getActiveMicrophones", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_microphones);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "getActiveMicrophones", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamIn::_hidl_setMicrophoneDirection(
    ...
    ::android::hardware::audio::V7_0::MicrophoneDirection direction;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&direction);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "setMicrophoneDirection", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V7_0::Result _hidl_out_retval = static_cast<IStreamIn*>(_hidl_this->getImpl().get())->setMicrophoneDirection(direction);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "setMicrophoneDirection", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamIn::_hidl_setMicrophoneFieldDimension(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&zoom);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "7.0", "IStreamIn", "setMicrophoneFieldDimension", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::audio::V7_0::Result _hidl_out_retval = static_cast<IStreamIn*>(_hidl_this->getImpl().get())->setMicrophoneFieldDimension(zoom);
...
_hidl_error:
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&_hidl_out_retval);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "7.0", "IStreamIn", "setMicrophoneFieldDimension", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamIn::onTransact(
    ...
    switch (_hidl_code) {
        ...
        case 20 /* getAudioSource */:
        {
            _hidl_err = ::android::hardware::audio::V7_0::BnHwStreamIn::_hidl_getAudioSource(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 21 /* setGain */:
        {
            _hidl_err = ::android::hardware::audio::V7_0::BnHwStreamIn::_hidl_setGain(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 22 /* updateSinkMetadata */:
        {
            _hidl_err = ::android::hardware::audio::V7_0::BnHwStreamIn::_hidl_updateSinkMetadata(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 23 /* prepareForReading */:
        {
            _hidl_err = ::android::hardware::audio::V7_0::BnHwStreamIn::_hidl_prepareForReading(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 24 /* getInputFramesLost */:
        {
            _hidl_err = ::android::hardware::audio::V7_0::BnHwStreamIn::_hidl_getInputFramesLost(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 25 /* getCapturePosition */:
        {
            _hidl_err = ::android::hardware::audio::V7_0::BnHwStreamIn::_hidl_getCapturePosition(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 26 /* getActiveMicrophones */:
        {
            _hidl_err = ::android::hardware::audio::V7_0::BnHwStreamIn::_hidl_getActiveMicrophones(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 27 /* setMicrophoneDirection */:
        {
            _hidl_err = ::android::hardware::audio::V7_0::BnHwStreamIn::_hidl_setMicrophoneDirection(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 28 /* setMicrophoneFieldDimension */:
        {
            _hidl_err = ::android::hardware::audio::V7_0::BnHwStreamIn::_hidl_setMicrophoneFieldDimension(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsStreamIn::BsStreamIn(const ::android::sp<::android::hardware::audio::V7_0::IStreamIn> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio@7.0", "IStreamIn"), mImpl(impl) {
...
bool IStreamIn::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio@7.0::IStreamIn",
