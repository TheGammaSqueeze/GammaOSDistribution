#define LOG_TAG "android.hardware.audio@6.0::StreamOutEventCallback"
...
#include <android/hardware/audio/6.0/BpHwStreamOutEventCallback.h>
#include <android/hardware/audio/6.0/BnHwStreamOutEventCallback.h>
#include <android/hardware/audio/6.0/BsStreamOutEventCallback.h>
...
const char* IStreamOutEventCallback::descriptor("android.hardware.audio@6.0::IStreamOutEventCallback");
...
::android::hardware::Return<void> IStreamOutEventCallback::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::V6_0::IStreamOutEventCallback::descriptor,
...
::android::hardware::Return<void> IStreamOutEventCallback::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::V6_0::IStreamOutEventCallback::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IStreamOutEventCallback::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){170,34,17,171,216,3,224,61,5,234,17,193,135,73,219,6,143,120,95,224,38,248,217,155,206,100,189,118,79,99,209,148} /* aa2211abd803e03d05ea11c18749db068f785fe026f8d99bce64bd764f63d194 */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::V6_0::IStreamOutEventCallback>> IStreamOutEventCallback::castFrom(const ::android::sp<::android::hardware::audio::V6_0::IStreamOutEventCallback>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::V6_0::IStreamOutEventCallback>> IStreamOutEventCallback::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IStreamOutEventCallback, ::android::hidl::base::V1_0::IBase, BpHwStreamOutEventCallback>(
            parent, "android.hardware.audio@6.0::IStreamOutEventCallback", emitError);
}
...
BpHwStreamOutEventCallback::BpHwStreamOutEventCallback(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IStreamOutEventCallback>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio@6.0", "IStreamOutEventCallback") {
}
...
::android::hardware::Return<void> BpHwStreamOutEventCallback::_hidl_onCodecFormatChanged(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& audioMetadata) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "6.0", "IStreamOutEventCallback", "onCodecFormatChanged", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "6.0", "IStreamOutEventCallback", "onCodecFormatChanged", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwStreamOutEventCallback::onCodecFormatChanged(const ::android::hardware::hidl_vec<uint8_t>& audioMetadata){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V6_0::BpHwStreamOutEventCallback::_hidl_onCodecFormatChanged(this, this, audioMetadata);
...
BnHwStreamOutEventCallback::BnHwStreamOutEventCallback(const ::android::sp<IStreamOutEventCallback> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio@6.0", "IStreamOutEventCallback") { 
...
::android::status_t BnHwStreamOutEventCallback::_hidl_onCodecFormatChanged(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)audioMetadata);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "6.0", "IStreamOutEventCallback", "onCodecFormatChanged", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "6.0", "IStreamOutEventCallback", "onCodecFormatChanged", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwStreamOutEventCallback::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::audio::V6_0::BnHwStreamOutEventCallback::_hidl_onCodecFormatChanged(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsStreamOutEventCallback::BsStreamOutEventCallback(const ::android::sp<::android::hardware::audio::V6_0::IStreamOutEventCallback> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio@6.0", "IStreamOutEventCallback"), mImpl(impl) {
...
bool IStreamOutEventCallback::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio@6.0::IStreamOutEventCallback",
