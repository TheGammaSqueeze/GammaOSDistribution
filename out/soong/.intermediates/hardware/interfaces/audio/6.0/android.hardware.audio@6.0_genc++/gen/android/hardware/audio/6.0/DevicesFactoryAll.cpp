#define LOG_TAG "android.hardware.audio@6.0::DevicesFactory"
...
#include <android/hardware/audio/6.0/BpHwDevicesFactory.h>
#include <android/hardware/audio/6.0/BnHwDevicesFactory.h>
#include <android/hardware/audio/6.0/BsDevicesFactory.h>
...
const char* IDevicesFactory::descriptor("android.hardware.audio@6.0::IDevicesFactory");
...
// Methods from ::android::hardware::audio::V6_0::IDevicesFactory follow.
...
::android::hardware::Return<void> IDevicesFactory::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::audio::V6_0::IDevicesFactory::descriptor,
...
::android::hardware::Return<void> IDevicesFactory::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::audio::V6_0::IDevicesFactory::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IDevicesFactory::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){36,2,135,108,188,35,192,222,54,144,166,101,236,168,79,211,133,125,24,8,219,165,202,210,92,226,114,248,30,206,248,201} /* 2402876cbc23c0de3690a665eca84fd3857d1808dba5cad25ce272f81ecef8c9 */,
...
::android::hardware::Return<::android::sp<::android::hardware::audio::V6_0::IDevicesFactory>> IDevicesFactory::castFrom(const ::android::sp<::android::hardware::audio::V6_0::IDevicesFactory>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::audio::V6_0::IDevicesFactory>> IDevicesFactory::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IDevicesFactory, ::android::hidl::base::V1_0::IBase, BpHwDevicesFactory>(
            parent, "android.hardware.audio@6.0::IDevicesFactory", emitError);
}
...
BpHwDevicesFactory::BpHwDevicesFactory(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IDevicesFactory>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.audio@6.0", "IDevicesFactory") {
}
...
::android::hardware::Return<void> BpHwDevicesFactory::_hidl_openDevice(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& device, openDevice_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "6.0", "IDevicesFactory", "openDevice", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* openDevice */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ...
        ::android::sp<::android::hardware::audio::V6_0::IDevice> _hidl_out_result;
...

        {
            ...
            _hidl_out_result = ::android::hardware::fromBinder<::android::hardware::audio::V6_0::IDevice,::android::hardware::audio::V6_0::BpHwDevice,::android::hardware::audio::V6_0::BnHwDevice>(_hidl_binder);
        }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "6.0", "IDevicesFactory", "openDevice", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDevicesFactory::_hidl_openPrimaryDevice(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, openPrimaryDevice_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.audio", "6.0", "IDevicesFactory", "openPrimaryDevice", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* openPrimaryDevice */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::audio::V6_0::Result _hidl_out_retval;
        ::android::sp<::android::hardware::audio::V6_0::IPrimaryDevice> _hidl_out_result;
...

        {
            ...
            _hidl_out_result = ::android::hardware::fromBinder<::android::hardware::audio::V6_0::IPrimaryDevice,::android::hardware::audio::V6_0::BpHwPrimaryDevice,::android::hardware::audio::V6_0::BnHwPrimaryDevice>(_hidl_binder);
        }
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_result);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.audio", "6.0", "IDevicesFactory", "openPrimaryDevice", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwDevicesFactory::openDevice(const ::android::hardware::hidl_string& device, openDevice_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V6_0::BpHwDevicesFactory::_hidl_openDevice(this, this, device, _hidl_cb);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwDevicesFactory::openPrimaryDevice(openPrimaryDevice_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::audio::V6_0::BpHwDevicesFactory::_hidl_openPrimaryDevice(this, this, _hidl_cb);
...
BnHwDevicesFactory::BnHwDevicesFactory(const ::android::sp<IDevicesFactory> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.audio@6.0", "IDevicesFactory") { 
...
::android::status_t BnHwDevicesFactory::_hidl_openDevice(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)device);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "6.0", "IDevicesFactory", "openDevice", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_result);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "6.0", "IDevicesFactory", "openDevice", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwDevicesFactory::_hidl_openPrimaryDevice(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.audio", "6.0", "IDevicesFactory", "openPrimaryDevice", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_error:
        ...
        if (UNLIKELY(mEnableInstrumentation)) {
            ...
            _hidl_args.push_back((void *)&_hidl_out_result);
            for (const auto &callback: mInstrumentationCallbacks) {
                callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.audio", "6.0", "IDevicesFactory", "openPrimaryDevice", &_hidl_args);
            }
        }
        #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwDevicesFactory::onTransact(
    ...
    switch (_hidl_code) {
        case 1 /* openDevice */:
        {
            _hidl_err = ::android::hardware::audio::V6_0::BnHwDevicesFactory::_hidl_openDevice(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 2 /* openPrimaryDevice */:
        {
            _hidl_err = ::android::hardware::audio::V6_0::BnHwDevicesFactory::_hidl_openPrimaryDevice(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsDevicesFactory::BsDevicesFactory(const ::android::sp<::android::hardware::audio::V6_0::IDevicesFactory> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.audio@6.0", "IDevicesFactory"), mImpl(impl) {
...
bool IDevicesFactory::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.audio@6.0::IDevicesFactory",
