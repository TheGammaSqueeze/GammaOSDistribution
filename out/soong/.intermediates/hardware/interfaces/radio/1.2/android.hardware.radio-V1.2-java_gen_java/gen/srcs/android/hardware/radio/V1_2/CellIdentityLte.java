...
public final class CellIdentityLte {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.CellIdentityLte.class) {
            return false;
        }
        android.hardware.radio.V1_2.CellIdentityLte other = (android.hardware.radio.V1_2.CellIdentityLte)otherObject;
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.bandwidth));
    }
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_0.CellIdentityLte) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_2.CellIdentityOperatorNames) operatorNames).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 48);
        bandwidth = _hidl_blob.getInt32(_hidl_offset + 80);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        operatorNames.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 48);
        _hidl_blob.putInt32(_hidl_offset + 80, bandwidth);
    }
};
