...
public final class SignalStrength {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.SignalStrength.class) {
            return false;
        }
        android.hardware.radio.V1_2.SignalStrength other = (android.hardware.radio.V1_2.SignalStrength)otherObject;
    ...
    public final void readFromParcel(android.os.HwParcel parcel) {
        android.os.HwBlob blob = parcel.readBuffer(76 /* size */);
    ...
    public static final java.util.ArrayList<SignalStrength> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            android.os.HwBlob childBlob = parcel.readEmbeddedBuffer(
                    _hidl_vec_size * 76,_hidl_blob.handle(),
                    0 + 0 /* offsetof(hidl_vec<T>, mBuffer) */,true /* nullable */);

            _hidl_vec.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_2.SignalStrength _hidl_vec_element = new android.hardware.radio.V1_2.SignalStrength();
                ((android.hardware.radio.V1_2.SignalStrength) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 76);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_2.WcdmaSignalStrength) wcdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 60);
    }

    public final void writeToParcel(android.os.HwParcel parcel) {
        android.os.HwBlob _hidl_blob = new android.os.HwBlob(76 /* size */);
    ...
    public static final void writeVectorToParcel(
        ...
        android.os.HwBlob _hidl_blob = new android.os.HwBlob(16 /* sizeof(hidl_vec<T>) */);
        {
            ...
            android.os.HwBlob childBlob = new android.os.HwBlob((int)(_hidl_vec_size * 76));
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        wcdma.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 60);
    }
};
