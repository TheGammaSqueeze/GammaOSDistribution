...
public final class CellIdentityWcdma {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.CellIdentityWcdma.class) {
            return false;
        }
        android.hardware.radio.V1_2.CellIdentityWcdma other = (android.hardware.radio.V1_2.CellIdentityWcdma)otherObject;
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_0.CellIdentityWcdma) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
