...
public final class CellIdentityCdma {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.CellIdentityCdma.class) {
            return false;
        }
        android.hardware.radio.V1_2.CellIdentityCdma other = (android.hardware.radio.V1_2.CellIdentityCdma)otherObject;
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_0.CellIdentityCdma) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_2.CellIdentityOperatorNames) operatorNames).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 24);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        operatorNames.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 24);
    }
};
