...
public final class CellInfoWcdma {
    public android.hardware.radio.V1_2.CellIdentityWcdma cellIdentityWcdma = new android.hardware.radio.V1_2.CellIdentityWcdma();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.CellInfoWcdma.class) {
            return false;
        }
        android.hardware.radio.V1_2.CellInfoWcdma other = (android.hardware.radio.V1_2.CellInfoWcdma)otherObject;
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_2.CellIdentityWcdma) cellIdentityWcdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_2.WcdmaSignalStrength) signalStrengthWcdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 80);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        signalStrengthWcdma.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 80);
    }
};
