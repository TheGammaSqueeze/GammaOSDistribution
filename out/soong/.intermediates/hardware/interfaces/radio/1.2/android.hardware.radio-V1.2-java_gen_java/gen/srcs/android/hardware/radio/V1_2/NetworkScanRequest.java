...
public final class NetworkScanRequest {
     ...
     */
    public java.util.ArrayList<android.hardware.radio.V1_1.RadioAccessSpecifier> specifiers = new java.util.ArrayList<android.hardware.radio.V1_1.RadioAccessSpecifier>();
    /**
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.NetworkScanRequest.class) {
            return false;
        }
        android.hardware.radio.V1_2.NetworkScanRequest other = (android.hardware.radio.V1_2.NetworkScanRequest)otherObject;
    ...
    public static final java.util.ArrayList<NetworkScanRequest> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_2.NetworkScanRequest _hidl_vec_element = new android.hardware.radio.V1_2.NetworkScanRequest();
                ((android.hardware.radio.V1_2.NetworkScanRequest) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 56);
    ...
    public final void readEmbeddedFromParcel(
        ...
        interval = _hidl_blob.getInt32(_hidl_offset + 4);
        {
            ...
            ((java.util.ArrayList<android.hardware.radio.V1_1.RadioAccessSpecifier>) specifiers).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_1.RadioAccessSpecifier _hidl_vec_element = new android.hardware.radio.V1_1.RadioAccessSpecifier();
                ((android.hardware.radio.V1_1.RadioAccessSpecifier) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 72);
                ((java.util.ArrayList<android.hardware.radio.V1_1.RadioAccessSpecifier>) specifiers).add(_hidl_vec_element);
            }
        }
