...
public final class CellIdentityOperatorNames {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.CellIdentityOperatorNames.class) {
            return false;
        }
        android.hardware.radio.V1_2.CellIdentityOperatorNames other = (android.hardware.radio.V1_2.CellIdentityOperatorNames)otherObject;
    ...
    public static final java.util.ArrayList<CellIdentityOperatorNames> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<CellIdentityOperatorNames> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_2.CellIdentityOperatorNames _hidl_vec_element = new android.hardware.radio.V1_2.CellIdentityOperatorNames();
                ((android.hardware.radio.V1_2.CellIdentityOperatorNames) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 32);
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<CellIdentityOperatorNames> _hidl_vec) {
