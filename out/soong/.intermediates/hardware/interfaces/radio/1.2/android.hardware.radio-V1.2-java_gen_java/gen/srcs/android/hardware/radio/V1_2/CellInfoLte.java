...
public final class CellInfoLte {
    public android.hardware.radio.V1_2.CellIdentityLte cellIdentityLte = new android.hardware.radio.V1_2.CellIdentityLte();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.CellInfoLte.class) {
            return false;
        }
        android.hardware.radio.V1_2.CellInfoLte other = (android.hardware.radio.V1_2.CellInfoLte)otherObject;
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_2.CellIdentityLte) cellIdentityLte).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_0.LteSignalStrength) signalStrengthLte).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 88);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        signalStrengthLte.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 88);
    }
};
