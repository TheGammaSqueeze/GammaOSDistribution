...
public interface IRadio extends android.hardware.radio.V1_1.IRadio {
    ...
    public static IRadio getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IRadio.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.2::IRadio", serviceName, retry));
    }
    ...
    public static IRadio getService(String serviceName) throws android.os.RemoteException {
        return IRadio.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.2::IRadio", serviceName));
    }
     ...
     */
    void startNetworkScan_1_2(int serial, android.hardware.radio.V1_2.NetworkScanRequest request)
     ...
     */
    void setIndicationFilter_1_2(int serial, int indicationFilter)
        throws android.os.RemoteException;
    /**
     ...
     */
    void setSignalStrengthReportingCriteria(int serial, int hysteresisMs, int hysteresisDb, java.util.ArrayList<Integer> thresholdsDbm, int accessNetwork)
        throws android.os.RemoteException;
    /**
     ...
     * @param accessNetwork The type of network for which to apply these thresholds.
     */
    void setLinkCapacityReportingCriteria(int serial, int hysteresisMs, int hysteresisDlKbps, int hysteresisUlKbps, java.util.ArrayList<Integer> thresholdsDownlinkKbps, java.util.ArrayList<Integer> thresholdsUplinkKbps, int accessNetwork)
        throws android.os.RemoteException;
    /**
     ...
     */
    void setupDataCall_1_2(int serial, int accessNetwork, android.hardware.radio.V1_0.DataProfileInfo dataProfileInfo, boolean modemCognitive, boolean roamingAllowed, boolean isRoaming, int reason, java.util.ArrayList<String> addresses, java.util.ArrayList<String> dnses)
        throws android.os.RemoteException;
    /**
     ...
     */
    void deactivateDataCall_1_2(int serial, int cid, int reason)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements IRadio {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.radio.V1_2.IRadio.kInterfaceName;
