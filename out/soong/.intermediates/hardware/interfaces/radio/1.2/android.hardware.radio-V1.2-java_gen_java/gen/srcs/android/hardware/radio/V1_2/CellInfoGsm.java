...
public final class CellInfoGsm {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.CellInfoGsm.class) {
            return false;
        }
        android.hardware.radio.V1_2.CellInfoGsm other = (android.hardware.radio.V1_2.CellInfoGsm)otherObject;
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_2.CellIdentityGsm) cellIdentityGsm).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_0.GsmSignalStrength) signalStrengthGsm).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 80);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        signalStrengthGsm.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 80);
    }
};
