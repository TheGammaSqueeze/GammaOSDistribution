...
public final class CellIdentityGsm {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.CellIdentityGsm.class) {
            return false;
        }
        android.hardware.radio.V1_2.CellIdentityGsm other = (android.hardware.radio.V1_2.CellIdentityGsm)otherObject;
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_0.CellIdentityGsm) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
