...
public final class PhysicalChannelConfig {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_2.PhysicalChannelConfig.class) {
            return false;
        }
        android.hardware.radio.V1_2.PhysicalChannelConfig other = (android.hardware.radio.V1_2.PhysicalChannelConfig)otherObject;
        if (this.status != other.status) {
            return false;
        }
        if (this.cellBandwidthDownlink != other.cellBandwidthDownlink) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.cellBandwidthDownlink));
    }
    ...
    public static final java.util.ArrayList<PhysicalChannelConfig> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_2.PhysicalChannelConfig _hidl_vec_element = new android.hardware.radio.V1_2.PhysicalChannelConfig();
                ((android.hardware.radio.V1_2.PhysicalChannelConfig) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 8);
    ...
    public final void readEmbeddedFromParcel(
        ...
        cellBandwidthDownlink = _hidl_blob.getInt32(_hidl_offset + 4);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 4, cellBandwidthDownlink);
    }
};
