...
public interface IRadioResponse extends android.hardware.radio.V1_0.IRadioResponse {
    ...
    public static IRadioResponse getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IRadioResponse.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.1::IRadioResponse", serviceName, retry));
    }
     ...
     *   RadioError:INVALID_ARGUMENTS
     */
    void startKeepaliveResponse(android.hardware.radio.V1_0.RadioResponseInfo info, android.hardware.radio.V1_1.KeepaliveStatus status)
        throws android.os.RemoteException;
    /**
     * @param info Response info struct containing response type, serial no. and error
     *
    ...
    public static abstract class Stub extends android.os.HwBinder implements IRadioResponse {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.radio.V1_1.IRadioResponse.kInterfaceName;
