...
public final class NetworkScanResult {
    public int status = 0;
    public int error = 0;
    public java.util.ArrayList<android.hardware.radio.V1_0.CellInfo> networkInfos = new java.util.ArrayList<android.hardware.radio.V1_0.CellInfo>();
    ...
    public static final java.util.ArrayList<NetworkScanResult> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_1.NetworkScanResult _hidl_vec_element = new android.hardware.radio.V1_1.NetworkScanResult();
                ((android.hardware.radio.V1_1.NetworkScanResult) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
    ...
    public final void readEmbeddedFromParcel(
        ...
        error = _hidl_blob.getInt32(_hidl_offset + 4);
        {
            ...
            ((java.util.ArrayList<android.hardware.radio.V1_0.CellInfo>) networkInfos).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((java.util.ArrayList<android.hardware.radio.V1_0.CellInfo>) networkInfos).add(_hidl_vec_element);
            }
        }
    }
