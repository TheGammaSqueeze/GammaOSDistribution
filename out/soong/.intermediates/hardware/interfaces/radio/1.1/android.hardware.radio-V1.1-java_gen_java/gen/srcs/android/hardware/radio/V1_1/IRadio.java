...
public interface IRadio extends android.hardware.radio.V1_0.IRadio {
    ...
    public static IRadio getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IRadio.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.1::IRadio", serviceName, retry));
    }
     ...
     */
    void setCarrierInfoForImsiEncryption(int serial, android.hardware.radio.V1_1.ImsiEncryptionInfo imsiEncryptionInfo)
     ...
     */
    void startNetworkScan(int serial, android.hardware.radio.V1_1.NetworkScanRequest request)
        throws android.os.RemoteException;
    /**
     ...
     */
    void startKeepalive(int serial, android.hardware.radio.V1_1.KeepaliveRequest keepalive)
        throws android.os.RemoteException;
    /**
    ...
    public static abstract class Stub extends android.os.HwBinder implements IRadio {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.radio.V1_1.IRadio.kInterfaceName;
