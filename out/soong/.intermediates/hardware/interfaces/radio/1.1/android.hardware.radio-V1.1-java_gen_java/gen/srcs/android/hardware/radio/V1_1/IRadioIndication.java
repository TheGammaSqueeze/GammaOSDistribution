...
public interface IRadioIndication extends android.hardware.radio.V1_0.IRadioIndication {
    ...
    public static IRadioIndication getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IRadioIndication.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.1::IRadioIndication", serviceName, retry));
    }
     ...
     */
    void networkScanResult(int type, android.hardware.radio.V1_1.NetworkScanResult result)
        throws android.os.RemoteException;
    /**
     ...
     */
    void keepaliveStatus(int type, android.hardware.radio.V1_1.KeepaliveStatus status)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements IRadioIndication {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.radio.V1_1.IRadioIndication.kInterfaceName;
