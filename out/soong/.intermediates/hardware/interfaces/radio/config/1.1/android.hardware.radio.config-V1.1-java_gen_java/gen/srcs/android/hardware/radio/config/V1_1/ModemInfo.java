...
public final class ModemInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.config.V1_1.ModemInfo.class) {
            return false;
        }
        android.hardware.radio.config.V1_1.ModemInfo other = (android.hardware.radio.config.V1_1.ModemInfo)otherObject;
        if (this.modemId != other.modemId) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                android.os.HidlSupport.deepHashCode(this.modemId));
    }
    ...
    public static final java.util.ArrayList<ModemInfo> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<ModemInfo> _hidl_vec = new java.util.ArrayList();
    ...
    public final void readEmbeddedFromParcel(
        ...
        modemId = _hidl_blob.getInt8(_hidl_offset + 0);
    }
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<ModemInfo> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt8(_hidl_offset + 0, modemId);
    }
};
