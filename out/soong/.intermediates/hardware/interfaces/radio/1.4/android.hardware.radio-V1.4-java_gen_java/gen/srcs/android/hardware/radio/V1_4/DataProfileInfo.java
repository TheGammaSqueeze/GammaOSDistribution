...
public final class DataProfileInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_4.DataProfileInfo.class) {
            return false;
        }
        android.hardware.radio.V1_4.DataProfileInfo other = (android.hardware.radio.V1_4.DataProfileInfo)otherObject;
    ...
    public final String toString() {
        ...
        builder.append(android.hardware.radio.V1_4.ApnTypes.dumpBitfield(this.supportedApnTypesBitmap));
    ...
    public static final java.util.ArrayList<DataProfileInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_4.DataProfileInfo _hidl_vec_element = new android.hardware.radio.V1_4.DataProfileInfo();
                ((android.hardware.radio.V1_4.DataProfileInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 112);
    ...
    public final void readEmbeddedFromParcel(
        ...
        mtu = _hidl_blob.getInt32(_hidl_offset + 100);
        preferred = _hidl_blob.getBool(_hidl_offset + 104);
        persistent = _hidl_blob.getBool(_hidl_offset + 105);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 100, mtu);
        _hidl_blob.putBool(_hidl_offset + 104, preferred);
        _hidl_blob.putBool(_hidl_offset + 105, persistent);
    }
};
