...
public interface IRadioResponse extends android.hardware.radio.V1_3.IRadioResponse {
    ...
    public static IRadioResponse getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IRadioResponse.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.4::IRadioResponse", serviceName, retry));
    }
    ...
    public static IRadioResponse getService(String serviceName) throws android.os.RemoteException {
        return IRadioResponse.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.4::IRadioResponse", serviceName));
    }
     ...
     */
    void emergencyDialResponse(android.hardware.radio.V1_0.RadioResponseInfo info)
     ...
     *   RadioError:INVALID_ARGUMENTS
     */
    void startNetworkScanResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo info)
        throws android.os.RemoteException;
    /**
     * @param info Response info struct containing response type, serial no. and error
     ...
     *   RadioError:INTERNAL_ERR
     */
    void getCellInfoListResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo info, java.util.ArrayList<android.hardware.radio.V1_4.CellInfo> cellInfo)
        throws android.os.RemoteException;
    /**
     * @param info Response info struct containing response type, serial no. and error
     ...
     */
    void getDataRegistrationStateResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo info, android.hardware.radio.V1_4.DataRegStateResult dataRegResponse)
        throws android.os.RemoteException;
    /**
     * @param info Response info struct containing response type, serial no. and error
     ...
     */
    void getIccCardStatusResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo info, android.hardware.radio.V1_4.CardStatus cardStatus)
        throws android.os.RemoteException;
    /**
     * @param info Response info struct containing response type, serial no. and error
     ...
     *   RadioError:NO_RESOURCES
     */
    void getPreferredNetworkTypeBitmapResponse(android.hardware.radio.V1_0.RadioResponseInfo info, int networkTypeBitmap)
        throws android.os.RemoteException;
    /**
     ...
     *   RadioError:NO_RESOURCES
     */
    void setPreferredNetworkTypeBitmapResponse(android.hardware.radio.V1_0.RadioResponseInfo info)
        throws android.os.RemoteException;
    /**
     * @param info Response info struct containing response type, serial no. and error
     ...
     */
    void getDataCallListResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo info, java.util.ArrayList<android.hardware.radio.V1_4.SetupDataCallResult> dcResponse)
        throws android.os.RemoteException;
    /**
     * @param info Response info struct containing response type, serial no. and error
     ...
     *   RadioError:SIM_ABSENT
     */
    void setupDataCallResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo info, android.hardware.radio.V1_4.SetupDataCallResult dcResponse)
        throws android.os.RemoteException;
    /**
     * @param info Response info struct containing response type, serial no. and error
     *
     ...
     *   RadioError:REQUEST_NOT_SUPPORTED
     */
    void setAllowedCarriersResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo info)
        throws android.os.RemoteException;
    /**
     ...
     *   RadioError:REQUEST_NOT_SUPPORTED
     */
    void getAllowedCarriersResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo info, android.hardware.radio.V1_4.CarrierRestrictionsWithPriority carriers, int multiSimPolicy)
        throws android.os.RemoteException;
    /**
     ...
     *   RadioError:INTERNAL_ERR
     */
    void getSignalStrengthResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo info, android.hardware.radio.V1_4.SignalStrength signalStrength)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements IRadioResponse {
        ...
        public final String interfaceDescriptor() {
            return android.hardware.radio.V1_4.IRadioResponse.kInterfaceName;
