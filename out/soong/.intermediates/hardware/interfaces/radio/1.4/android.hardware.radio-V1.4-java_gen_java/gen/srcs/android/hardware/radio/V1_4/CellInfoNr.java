...
public final class CellInfoNr {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_4.CellInfoNr.class) {
            return false;
        }
        android.hardware.radio.V1_4.CellInfoNr other = (android.hardware.radio.V1_4.CellInfoNr)otherObject;
        if (!android.os.HidlSupport.deepEquals(this.signalStrength, other.signalStrength)) {
            return false;
        }
    ...
    public static final java.util.ArrayList<CellInfoNr> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_4.CellInfoNr _hidl_vec_element = new android.hardware.radio.V1_4.CellInfoNr();
                ((android.hardware.radio.V1_4.CellInfoNr) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 112);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_4.NrSignalStrength) signalStrength).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_4.CellIdentityNr) cellidentity).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 24);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        signalStrength.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 0);
        cellidentity.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 24);
    }
};
