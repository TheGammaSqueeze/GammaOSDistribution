...
public final class CellInfoLte {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_4.CellInfoLte.class) {
            return false;
        }
        android.hardware.radio.V1_4.CellInfoLte other = (android.hardware.radio.V1_4.CellInfoLte)otherObject;
        if (!android.os.HidlSupport.deepEquals(this.base, other.base)) {
            return false;
        }
        if (!android.os.HidlSupport.deepEquals(this.cellConfig, other.cellConfig)) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.cellConfig));
    }
    ...
    public static final java.util.ArrayList<CellInfoLte> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_4.CellInfoLte _hidl_vec_element = new android.hardware.radio.V1_4.CellInfoLte();
                ((android.hardware.radio.V1_4.CellInfoLte) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 120);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_2.CellInfoLte) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_4.CellConfigLte) cellConfig).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 112);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        cellConfig.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 112);
    }
};
