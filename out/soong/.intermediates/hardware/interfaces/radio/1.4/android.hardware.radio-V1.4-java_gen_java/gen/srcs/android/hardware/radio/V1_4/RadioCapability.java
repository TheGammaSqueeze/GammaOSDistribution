...
public final class RadioCapability {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_4.RadioCapability.class) {
            return false;
        }
        android.hardware.radio.V1_4.RadioCapability other = (android.hardware.radio.V1_4.RadioCapability)otherObject;
    ...
    public final String toString() {
        ...
        builder.append(", .raf = ");
        builder.append(android.hardware.radio.V1_4.RadioAccessFamily.dumpBitfield(this.raf));
    ...
    public static final java.util.ArrayList<RadioCapability> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_4.RadioCapability _hidl_vec_element = new android.hardware.radio.V1_4.RadioCapability();
                ((android.hardware.radio.V1_4.RadioCapability) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 40);
