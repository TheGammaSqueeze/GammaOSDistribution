...
public final class CardStatus {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_4.CardStatus.class) {
            return false;
        }
        android.hardware.radio.V1_4.CardStatus other = (android.hardware.radio.V1_4.CardStatus)otherObject;
    ...
    public static final java.util.ArrayList<CardStatus> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_4.CardStatus _hidl_vec_element = new android.hardware.radio.V1_4.CardStatus();
                ((android.hardware.radio.V1_4.CardStatus) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 96);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_2.CardStatus) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        eid = _hidl_blob.getString(_hidl_offset + 80);
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putString(_hidl_offset + 80, eid);
    }
};
