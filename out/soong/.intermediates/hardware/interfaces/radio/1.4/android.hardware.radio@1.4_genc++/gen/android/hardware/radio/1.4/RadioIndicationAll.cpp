...
#include <android/hardware/radio/1.4/BpHwRadioIndication.h>
#include <android/hardware/radio/1.4/BnHwRadioIndication.h>
#include <android/hardware/radio/1.4/BsRadioIndication.h>
...
::android::hardware::Return<void> IRadioIndication::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::radio::V1_4::IRadioIndication::descriptor,
...
::android::hardware::Return<void> IRadioIndication::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::radio::V1_4::IRadioIndication::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadioIndication>> IRadioIndication::castFrom(const ::android::sp<::android::hardware::radio::V1_3::IRadioIndication>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadioIndication, ::android::hardware::radio::V1_3::IRadioIndication, BpHwRadioIndication>(
            parent, "android.hardware.radio@1.4::IRadioIndication", emitError);
}
...
BpHwRadioIndication::BpHwRadioIndication(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IRadioIndication>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.radio@1.4", "IRadioIndication") {
}
...
// Methods from ::android::hardware::radio::V1_4::IRadioIndication follow.
::android::hardware::Return<void> BpHwRadioIndication::_hidl_currentEmergencyNumberList(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::EmergencyNumber>& emergencyNumberList) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioIndication::currentEmergencyNumberList::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "currentEmergencyNumberList", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    size_t _hidl_emergencyNumberList_parent;

    _hidl_err = _hidl_data.writeBuffer(&emergencyNumberList, sizeof(emergencyNumberList), &_hidl_emergencyNumberList_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_emergencyNumberList_child;

    _hidl_err = ::android::hardware::writeEmbeddedToParcel(
            emergencyNumberList,
            &_hidl_data,
            _hidl_emergencyNumberList_parent,
            0 /* parentOffset */, &_hidl_emergencyNumberList_child);

    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    for (size_t _hidl_index_0 = 0; _hidl_index_0 < emergencyNumberList.size(); ++_hidl_index_0) {
        _hidl_err = writeEmbeddedToParcel(
                emergencyNumberList[_hidl_index_0],
                &_hidl_data,
                _hidl_emergencyNumberList_child,
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::EmergencyNumber));

        if (_hidl_err != ::android::OK) { goto _hidl_error; }

    }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(54 /* currentEmergencyNumberList */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "currentEmergencyNumberList", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioIndication::_hidl_cellInfoList_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::CellInfo>& records) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioIndication::cellInfoList_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "cellInfoList_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(55 /* cellInfoList_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "cellInfoList_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioIndication::_hidl_networkScanResult_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_4::NetworkScanResult& result) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioIndication::networkScanResult_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "networkScanResult_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(56 /* networkScanResult_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "networkScanResult_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioIndication::_hidl_currentPhysicalChannelConfigs_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::PhysicalChannelConfig>& configs) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioIndication::currentPhysicalChannelConfigs_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "currentPhysicalChannelConfigs_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < configs.size(); ++_hidl_index_0) {
        _hidl_err = writeEmbeddedToParcel(
                ...
                &_hidl_data,
                _hidl_configs_child,
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::PhysicalChannelConfig));

        if (_hidl_err != ::android::OK) { goto _hidl_error; }

    }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(57 /* currentPhysicalChannelConfigs_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "currentPhysicalChannelConfigs_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioIndication::_hidl_dataCallListChanged_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::SetupDataCallResult>& dcList) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioIndication::dataCallListChanged_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "dataCallListChanged_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(58 /* dataCallListChanged_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "dataCallListChanged_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioIndication::_hidl_currentSignalStrength_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, ::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_4::SignalStrength& signalStrength) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioIndication::currentSignalStrength_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "currentSignalStrength_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(59 /* currentSignalStrength_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "currentSignalStrength_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::radio::V1_4::IRadioIndication follow.
::android::hardware::Return<void> BpHwRadioIndication::currentEmergencyNumberList(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::EmergencyNumber>& emergencyNumberList){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioIndication::_hidl_currentEmergencyNumberList(this, this, type, emergencyNumberList);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioIndication::cellInfoList_1_4(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::CellInfo>& records){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioIndication::_hidl_cellInfoList_1_4(this, this, type, records);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioIndication::networkScanResult_1_4(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_4::NetworkScanResult& result){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioIndication::_hidl_networkScanResult_1_4(this, this, type, result);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioIndication::currentPhysicalChannelConfigs_1_4(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::PhysicalChannelConfig>& configs){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioIndication::_hidl_currentPhysicalChannelConfigs_1_4(this, this, type, configs);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioIndication::dataCallListChanged_1_4(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::SetupDataCallResult>& dcList){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioIndication::_hidl_dataCallListChanged_1_4(this, this, type, dcList);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioIndication::currentSignalStrength_1_4(::android::hardware::radio::V1_0::RadioIndicationType type, const ::android::hardware::radio::V1_4::SignalStrength& signalStrength){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioIndication::_hidl_currentSignalStrength_1_4(this, this, type, signalStrength);
...
BnHwRadioIndication::BnHwRadioIndication(const ::android::sp<IRadioIndication> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.radio@1.4", "IRadioIndication") { 
...
// Methods from ::android::hardware::radio::V1_4::IRadioIndication follow.
::android::status_t BnHwRadioIndication::_hidl_currentEmergencyNumberList(
    ...
    _hidl_err = _hidl_data.readBuffer(sizeof(*emergencyNumberList), &_hidl_emergencyNumberList_parent,  reinterpret_cast<const void **>(&emergencyNumberList));
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::radio::V1_4::EmergencyNumber> &>(*emergencyNumberList),
            _hidl_data,
            _hidl_emergencyNumberList_parent,
            0 /* parentOffset */, &_hidl_emergencyNumberList_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < emergencyNumberList->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::radio::V1_4::EmergencyNumber &>((*emergencyNumberList)[_hidl_index_0]),
                _hidl_data,
                _hidl_emergencyNumberList_child,
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::EmergencyNumber));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioIndication::currentEmergencyNumberList::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        _hidl_args.push_back((void *)emergencyNumberList);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "currentEmergencyNumberList", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioIndication*>(_hidl_this->getImpl().get())->currentEmergencyNumberList(type, *emergencyNumberList);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "currentEmergencyNumberList", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioIndication::_hidl_cellInfoList_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::android::hardware::radio::V1_0::RadioIndicationType type;
    const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::CellInfo>* records;
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::radio::V1_4::CellInfo> &>(*records),
            _hidl_data,
            _hidl_records_parent,
            0 /* parentOffset */, &_hidl_records_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < records->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::radio::V1_4::CellInfo &>((*records)[_hidl_index_0]),
                _hidl_data,
                _hidl_records_child,
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::CellInfo));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioIndication::cellInfoList_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        _hidl_args.push_back((void *)records);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "cellInfoList_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioIndication*>(_hidl_this->getImpl().get())->cellInfoList_1_4(type, *records);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "cellInfoList_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioIndication::_hidl_networkScanResult_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::radio::V1_4::NetworkScanResult &>(*result),
            _hidl_data,
            _hidl_result_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioIndication::networkScanResult_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        _hidl_args.push_back((void *)result);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "networkScanResult_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioIndication*>(_hidl_this->getImpl().get())->networkScanResult_1_4(type, *result);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "networkScanResult_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioIndication::_hidl_currentPhysicalChannelConfigs_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::android::hardware::radio::V1_0::RadioIndicationType type;
    const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::PhysicalChannelConfig>* configs;
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::radio::V1_4::PhysicalChannelConfig> &>(*configs),
            _hidl_data,
            _hidl_configs_parent,
            0 /* parentOffset */, &_hidl_configs_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < configs->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::radio::V1_4::PhysicalChannelConfig &>((*configs)[_hidl_index_0]),
                _hidl_data,
                _hidl_configs_child,
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::PhysicalChannelConfig));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioIndication::currentPhysicalChannelConfigs_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        _hidl_args.push_back((void *)configs);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "currentPhysicalChannelConfigs_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioIndication*>(_hidl_this->getImpl().get())->currentPhysicalChannelConfigs_1_4(type, *configs);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "currentPhysicalChannelConfigs_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioIndication::_hidl_dataCallListChanged_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::android::hardware::radio::V1_0::RadioIndicationType type;
    const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::SetupDataCallResult>* dcList;
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::radio::V1_4::SetupDataCallResult> &>(*dcList),
            _hidl_data,
            _hidl_dcList_parent,
            0 /* parentOffset */, &_hidl_dcList_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < dcList->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::radio::V1_4::SetupDataCallResult &>((*dcList)[_hidl_index_0]),
                _hidl_data,
                _hidl_dcList_child,
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::SetupDataCallResult));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioIndication::dataCallListChanged_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        _hidl_args.push_back((void *)dcList);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "dataCallListChanged_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioIndication*>(_hidl_this->getImpl().get())->dataCallListChanged_1_4(type, *dcList);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "dataCallListChanged_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioIndication::_hidl_currentSignalStrength_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioIndication::currentSignalStrength_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&type);
        _hidl_args.push_back((void *)signalStrength);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioIndication", "currentSignalStrength_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioIndication*>(_hidl_this->getImpl().get())->currentSignalStrength_1_4(type, *signalStrength);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioIndication", "currentSignalStrength_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioIndication::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioIndication::_hidl_currentEmergencyNumberList(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 55 /* cellInfoList_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioIndication::_hidl_cellInfoList_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 56 /* networkScanResult_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioIndication::_hidl_networkScanResult_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 57 /* currentPhysicalChannelConfigs_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioIndication::_hidl_currentPhysicalChannelConfigs_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 58 /* dataCallListChanged_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioIndication::_hidl_dataCallListChanged_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 59 /* currentSignalStrength_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioIndication::_hidl_currentSignalStrength_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsRadioIndication::BsRadioIndication(const ::android::sp<::android::hardware::radio::V1_4::IRadioIndication> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.radio@1.4", "IRadioIndication"), mImpl(impl) {
...
bool IRadioIndication::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.radio@1.4::IRadioIndication",
