...
#include <android/hardware/radio/1.4/BpHwRadio.h>
#include <android/hardware/radio/1.4/BnHwRadio.h>
#include <android/hardware/radio/1.4/BsRadio.h>
#include <android/hardware/radio/1.3/BpHwRadio.h>
...
::android::hardware::Return<void> IRadio::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::radio::V1_4::IRadio::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadio>> IRadio::castFrom(const ::android::sp<::android::hardware::radio::V1_3::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::android::hardware::radio::V1_3::IRadio, BpHwRadio>(
            parent, "android.hardware.radio@1.4::IRadio", emitError);
}
...
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadio>> IRadio::castFrom(const ::android::sp<::android::hardware::radio::V1_2::IRadio>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadio, ::android::hardware::radio::V1_2::IRadio, BpHwRadio>(
            parent, "android.hardware.radio@1.4::IRadio", emitError);
}
...
BpHwRadio::BpHwRadio(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IRadio>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.radio@1.4", "IRadio") {
}
...
// Methods from ::android::hardware::radio::V1_4::IRadio follow.
::android::hardware::Return<void> BpHwRadio::_hidl_setupDataCall_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, ::android::hardware::radio::V1_4::AccessNetwork accessNetwork, const ::android::hardware::radio::V1_4::DataProfileInfo& dataProfileInfo, bool roamingAllowed, ::android::hardware::radio::V1_2::DataRequestReason reason, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& addresses, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& dnses) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::setupDataCall_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "setupDataCall_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(146 /* setupDataCall_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "setupDataCall_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadio::_hidl_setInitialAttachApn_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, const ::android::hardware::radio::V1_4::DataProfileInfo& dataProfileInfo) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::setInitialAttachApn_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        _hidl_args.push_back((void *)&dataProfileInfo);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "setInitialAttachApn_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(147 /* setInitialAttachApn_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "setInitialAttachApn_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadio::_hidl_setDataProfile_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::DataProfileInfo>& profiles) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::setDataProfile_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "setDataProfile_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < profiles.size(); ++_hidl_index_0) {
        _hidl_err = writeEmbeddedToParcel(
                ...
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::DataProfileInfo));

        if (_hidl_err != ::android::OK) { goto _hidl_error; }

    }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(148 /* setDataProfile_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "setDataProfile_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadio::_hidl_emergencyDial(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, const ::android::hardware::radio::V1_0::Dial& dialInfo, ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_4::EmergencyServiceCategory> categories, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& urns, ::android::hardware::radio::V1_4::EmergencyCallRouting routing, bool hasKnownUserIntentEmergency, bool isTesting) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&urns);
        _hidl_args.push_back((void *)&routing);
        _hidl_args.push_back((void *)&hasKnownUserIntentEmergency);
        _hidl_args.push_back((void *)&isTesting);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "emergencyDial", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_err = _hidl_data.writeInt32((int32_t)categories);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    size_t _hidl_urns_parent;

    _hidl_err = _hidl_data.writeBuffer(&urns, sizeof(urns), &_hidl_urns_parent);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    _hidl_err = ::android::hardware::writeEmbeddedToParcel(
            ...
            &_hidl_data,
            _hidl_urns_parent,
            0 /* parentOffset */, &_hidl_urns_child);

    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    for (size_t _hidl_index_0 = 0; _hidl_index_0 < urns.size(); ++_hidl_index_0) {
        _hidl_err = ::android::hardware::writeEmbeddedToParcel(
                urns[_hidl_index_0],
                &_hidl_data,
                _hidl_urns_child,
    ...
    _hidl_err = _hidl_data.writeInt32((int32_t)routing);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_err = _hidl_data.writeBool(hasKnownUserIntentEmergency);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_err = _hidl_data.writeBool(isTesting);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(149 /* emergencyDial */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "emergencyDial", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadio::_hidl_startNetworkScan_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, const ::android::hardware::radio::V1_2::NetworkScanRequest& request) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::startNetworkScan_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "startNetworkScan_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(150 /* startNetworkScan_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "startNetworkScan_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadio::_hidl_getPreferredNetworkTypeBitmap(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::getPreferredNetworkTypeBitmap::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "getPreferredNetworkTypeBitmap", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(151 /* getPreferredNetworkTypeBitmap */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "getPreferredNetworkTypeBitmap", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadio::_hidl_setPreferredNetworkTypeBitmap(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_4::RadioAccessFamily> networkTypeBitmap) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::setPreferredNetworkTypeBitmap::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "setPreferredNetworkTypeBitmap", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(152 /* setPreferredNetworkTypeBitmap */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "setPreferredNetworkTypeBitmap", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadio::_hidl_setAllowedCarriers_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial, const ::android::hardware::radio::V1_4::CarrierRestrictionsWithPriority& carriers, ::android::hardware::radio::V1_4::SimLockMultiSimPolicy multiSimPolicy) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::setAllowedCarriers_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "setAllowedCarriers_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(153 /* setAllowedCarriers_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "setAllowedCarriers_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadio::_hidl_getAllowedCarriers_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::getAllowedCarriers_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "getAllowedCarriers_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(154 /* getAllowedCarriers_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "getAllowedCarriers_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadio::_hidl_getSignalStrength_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t serial) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadio::getSignalStrength_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "getSignalStrength_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(155 /* getSignalStrength_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "getSignalStrength_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::radio::V1_3::IRadio follow.
::android::hardware::Return<void> BpHwRadio::setSystemSelectionChannels(int32_t serial, bool specifyChannels, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_1::RadioAccessSpecifier>& specifiers){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_3::BpHwRadio::_hidl_setSystemSelectionChannels(this, this, serial, specifyChannels, specifiers);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::enableModem(int32_t serial, bool on){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_3::BpHwRadio::_hidl_enableModem(this, this, serial, on);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::getModemStackStatus(int32_t serial){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_3::BpHwRadio::_hidl_getModemStackStatus(this, this, serial);
...
// Methods from ::android::hardware::radio::V1_4::IRadio follow.
::android::hardware::Return<void> BpHwRadio::setupDataCall_1_4(int32_t serial, ::android::hardware::radio::V1_4::AccessNetwork accessNetwork, const ::android::hardware::radio::V1_4::DataProfileInfo& dataProfileInfo, bool roamingAllowed, ::android::hardware::radio::V1_2::DataRequestReason reason, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& addresses, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& dnses){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadio::_hidl_setupDataCall_1_4(this, this, serial, accessNetwork, dataProfileInfo, roamingAllowed, reason, addresses, dnses);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::setInitialAttachApn_1_4(int32_t serial, const ::android::hardware::radio::V1_4::DataProfileInfo& dataProfileInfo){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadio::_hidl_setInitialAttachApn_1_4(this, this, serial, dataProfileInfo);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::setDataProfile_1_4(int32_t serial, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::DataProfileInfo>& profiles){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadio::_hidl_setDataProfile_1_4(this, this, serial, profiles);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::emergencyDial(int32_t serial, const ::android::hardware::radio::V1_0::Dial& dialInfo, ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_4::EmergencyServiceCategory> categories, const ::android::hardware::hidl_vec<::android::hardware::hidl_string>& urns, ::android::hardware::radio::V1_4::EmergencyCallRouting routing, bool hasKnownUserIntentEmergency, bool isTesting){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadio::_hidl_emergencyDial(this, this, serial, dialInfo, categories, urns, routing, hasKnownUserIntentEmergency, isTesting);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::startNetworkScan_1_4(int32_t serial, const ::android::hardware::radio::V1_2::NetworkScanRequest& request){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadio::_hidl_startNetworkScan_1_4(this, this, serial, request);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::getPreferredNetworkTypeBitmap(int32_t serial){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadio::_hidl_getPreferredNetworkTypeBitmap(this, this, serial);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::setPreferredNetworkTypeBitmap(int32_t serial, ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_4::RadioAccessFamily> networkTypeBitmap){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadio::_hidl_setPreferredNetworkTypeBitmap(this, this, serial, networkTypeBitmap);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::setAllowedCarriers_1_4(int32_t serial, const ::android::hardware::radio::V1_4::CarrierRestrictionsWithPriority& carriers, ::android::hardware::radio::V1_4::SimLockMultiSimPolicy multiSimPolicy){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadio::_hidl_setAllowedCarriers_1_4(this, this, serial, carriers, multiSimPolicy);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::getAllowedCarriers_1_4(int32_t serial){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadio::_hidl_getAllowedCarriers_1_4(this, this, serial);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadio::getSignalStrength_1_4(int32_t serial){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadio::_hidl_getSignalStrength_1_4(this, this, serial);
...
BnHwRadio::BnHwRadio(const ::android::sp<IRadio> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.radio@1.4", "IRadio") { 
...
// Methods from ::android::hardware::radio::V1_4::IRadio follow.
::android::status_t BnHwRadio::_hidl_setupDataCall_1_4(
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::radio::V1_4::DataProfileInfo &>(*dataProfileInfo),
            _hidl_data,
            _hidl_dataProfileInfo_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::setupDataCall_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        ...
        _hidl_args.push_back((void *)dnses);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "setupDataCall_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->setupDataCall_1_4(serial, accessNetwork, *dataProfileInfo, roamingAllowed, reason, *addresses, *dnses);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "setupDataCall_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::_hidl_setInitialAttachApn_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::setInitialAttachApn_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        _hidl_args.push_back((void *)dataProfileInfo);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "setInitialAttachApn_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->setInitialAttachApn_1_4(serial, *dataProfileInfo);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "setInitialAttachApn_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::_hidl_setDataProfile_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    int32_t serial;
    const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::DataProfileInfo>* profiles;
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::radio::V1_4::DataProfileInfo> &>(*profiles),
            _hidl_data,
            _hidl_profiles_parent,
            0 /* parentOffset */, &_hidl_profiles_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < profiles->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::radio::V1_4::DataProfileInfo &>((*profiles)[_hidl_index_0]),
                _hidl_data,
                _hidl_profiles_child,
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::DataProfileInfo));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::setDataProfile_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        _hidl_args.push_back((void *)profiles);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "setDataProfile_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->setDataProfile_1_4(serial, *profiles);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "setDataProfile_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::_hidl_emergencyDial(
    ...
    _hidl_err = _hidl_data.readInt32((int32_t *)&categories);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    size_t _hidl_urns_parent;

    _hidl_err = _hidl_data.readBuffer(sizeof(*urns), &_hidl_urns_parent,  reinterpret_cast<const void **>(&urns));
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::hidl_string> &>(*urns),
            _hidl_data,
            _hidl_urns_parent,
            0 /* parentOffset */, &_hidl_urns_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < urns->size(); ++_hidl_index_0) {
        _hidl_err = ::android::hardware::readEmbeddedFromParcel(
                const_cast<::android::hardware::hidl_string &>((*urns)[_hidl_index_0]),
                _hidl_data,
                _hidl_urns_child,
                _hidl_index_0 * sizeof(::android::hardware::hidl_string));
    ...
    _hidl_err = _hidl_data.readInt32((int32_t *)&routing);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    _hidl_err = _hidl_data.readBool(&hasKnownUserIntentEmergency);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    _hidl_err = _hidl_data.readBool(&isTesting);
    if (_hidl_err != ::android::OK) { return _hidl_err; }
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&isTesting);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "emergencyDial", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->emergencyDial(serial, *dialInfo, categories, *urns, routing, hasKnownUserIntentEmergency, isTesting);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "emergencyDial", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::_hidl_startNetworkScan_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::startNetworkScan_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        _hidl_args.push_back((void *)request);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "startNetworkScan_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->startNetworkScan_1_4(serial, *request);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "startNetworkScan_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::_hidl_getPreferredNetworkTypeBitmap(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::getPreferredNetworkTypeBitmap::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "getPreferredNetworkTypeBitmap", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->getPreferredNetworkTypeBitmap(serial);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "getPreferredNetworkTypeBitmap", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::_hidl_setPreferredNetworkTypeBitmap(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::setPreferredNetworkTypeBitmap::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        _hidl_args.push_back((void *)&networkTypeBitmap);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "setPreferredNetworkTypeBitmap", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->setPreferredNetworkTypeBitmap(serial, networkTypeBitmap);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "setPreferredNetworkTypeBitmap", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::_hidl_setAllowedCarriers_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::setAllowedCarriers_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        ...
        _hidl_args.push_back((void *)&multiSimPolicy);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "setAllowedCarriers_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->setAllowedCarriers_1_4(serial, *carriers, multiSimPolicy);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "setAllowedCarriers_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::_hidl_getAllowedCarriers_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::getAllowedCarriers_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "getAllowedCarriers_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->getAllowedCarriers_1_4(serial);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "getAllowedCarriers_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::_hidl_getSignalStrength_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadio::getSignalStrength_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&serial);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadio", "getSignalStrength_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadio*>(_hidl_this->getImpl().get())->getSignalStrength_1_4(serial);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadio", "getSignalStrength_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadio::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::radio::V1_3::BnHwRadio::_hidl_setSystemSelectionChannels(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 144 /* enableModem */:
        {
            _hidl_err = ::android::hardware::radio::V1_3::BnHwRadio::_hidl_enableModem(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 145 /* getModemStackStatus */:
        {
            _hidl_err = ::android::hardware::radio::V1_3::BnHwRadio::_hidl_getModemStackStatus(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 146 /* setupDataCall_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadio::_hidl_setupDataCall_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 147 /* setInitialAttachApn_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadio::_hidl_setInitialAttachApn_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 148 /* setDataProfile_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadio::_hidl_setDataProfile_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 149 /* emergencyDial */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadio::_hidl_emergencyDial(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 150 /* startNetworkScan_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadio::_hidl_startNetworkScan_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 151 /* getPreferredNetworkTypeBitmap */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadio::_hidl_getPreferredNetworkTypeBitmap(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 152 /* setPreferredNetworkTypeBitmap */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadio::_hidl_setPreferredNetworkTypeBitmap(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 153 /* setAllowedCarriers_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadio::_hidl_setAllowedCarriers_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 154 /* getAllowedCarriers_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadio::_hidl_getAllowedCarriers_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 155 /* getSignalStrength_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadio::_hidl_getSignalStrength_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsRadio::BsRadio(const ::android::sp<::android::hardware::radio::V1_4::IRadio> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.radio@1.4", "IRadio"), mImpl(impl) {
...
bool IRadio::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.radio@1.4::IRadio",
