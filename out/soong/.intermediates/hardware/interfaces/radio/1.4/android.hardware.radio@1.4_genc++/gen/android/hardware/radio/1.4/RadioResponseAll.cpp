...
#include <android/hardware/radio/1.4/BpHwRadioResponse.h>
#include <android/hardware/radio/1.4/BnHwRadioResponse.h>
#include <android/hardware/radio/1.4/BsRadioResponse.h>
#include <android/hardware/radio/1.3/BpHwRadioResponse.h>
...
::android::hardware::Return<void> IRadioResponse::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::radio::V1_4::IRadioResponse::descriptor,
        ::android::hardware::radio::V1_3::IRadioResponse::descriptor,
...
::android::hardware::Return<void> IRadioResponse::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::radio::V1_4::IRadioResponse::descriptor);
    return ::android::hardware::Void();
}
...
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadioResponse>> IRadioResponse::castFrom(const ::android::sp<::android::hardware::radio::V1_3::IRadioResponse>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadioResponse, ::android::hardware::radio::V1_3::IRadioResponse, BpHwRadioResponse>(
            parent, "android.hardware.radio@1.4::IRadioResponse", emitError);
}
...
::android::hardware::Return<::android::sp<::android::hardware::radio::V1_4::IRadioResponse>> IRadioResponse::castFrom(const ::android::sp<::android::hardware::radio::V1_2::IRadioResponse>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IRadioResponse, ::android::hardware::radio::V1_2::IRadioResponse, BpHwRadioResponse>(
            parent, "android.hardware.radio@1.4::IRadioResponse", emitError);
}
...
BpHwRadioResponse::BpHwRadioResponse(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IRadioResponse>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.radio@1.4", "IRadioResponse") {
}
...
// Methods from ::android::hardware::radio::V1_4::IRadioResponse follow.
::android::hardware::Return<void> BpHwRadioResponse::_hidl_emergencyDialResponse(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "emergencyDialResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(147 /* emergencyDialResponse */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "emergencyDialResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_startNetworkScanResponse_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::startNetworkScanResponse_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "startNetworkScanResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(148 /* startNetworkScanResponse_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "startNetworkScanResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_getCellInfoListResponse_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::CellInfo>& cellInfo) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::getCellInfoListResponse_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getCellInfoListResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(149 /* getCellInfoListResponse_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getCellInfoListResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_getDataRegistrationStateResponse_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_4::DataRegStateResult& dataRegResponse) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::getDataRegistrationStateResponse_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getDataRegistrationStateResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(150 /* getDataRegistrationStateResponse_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getDataRegistrationStateResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_getIccCardStatusResponse_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_4::CardStatus& cardStatus) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::getIccCardStatusResponse_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getIccCardStatusResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(151 /* getIccCardStatusResponse_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getIccCardStatusResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_getPreferredNetworkTypeBitmapResponse(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info, ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_4::RadioAccessFamily> networkTypeBitmap) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::getPreferredNetworkTypeBitmapResponse::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getPreferredNetworkTypeBitmapResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_err = _hidl_data.writeInt32((int32_t)networkTypeBitmap);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(152 /* getPreferredNetworkTypeBitmapResponse */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getPreferredNetworkTypeBitmapResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_setPreferredNetworkTypeBitmapResponse(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::setPreferredNetworkTypeBitmapResponse::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "setPreferredNetworkTypeBitmapResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(153 /* setPreferredNetworkTypeBitmapResponse */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "setPreferredNetworkTypeBitmapResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_getDataCallListResponse_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::SetupDataCallResult>& dcResponse) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::getDataCallListResponse_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getDataCallListResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < dcResponse.size(); ++_hidl_index_0) {
        _hidl_err = writeEmbeddedToParcel(
                ...
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::SetupDataCallResult));

        if (_hidl_err != ::android::OK) { goto _hidl_error; }

    }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(154 /* getDataCallListResponse_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getDataCallListResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_setupDataCallResponse_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_4::SetupDataCallResult& dcResponse) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::setupDataCallResponse_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        _hidl_args.push_back((void *)&dcResponse);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "setupDataCallResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(155 /* setupDataCallResponse_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "setupDataCallResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_setAllowedCarriersResponse_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::setAllowedCarriersResponse_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "setAllowedCarriersResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(156 /* setAllowedCarriersResponse_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "setAllowedCarriersResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_getAllowedCarriersResponse_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_4::CarrierRestrictionsWithPriority& carriers, ::android::hardware::radio::V1_4::SimLockMultiSimPolicy multiSimPolicy) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::getAllowedCarriersResponse_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getAllowedCarriersResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_err = _hidl_data.writeInt32((int32_t)multiSimPolicy);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }

    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(157 /* getAllowedCarriersResponse_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getAllowedCarriersResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::hardware::Return<void> BpHwRadioResponse::_hidl_getSignalStrengthResponse_1_4(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_4::SignalStrength& signalStrength) {
    #ifdef __ANDROID_DEBUGGABLE__
    bool mEnableInstrumentation = _hidl_this_instrumentor->isInstrumentationEnabled();
    const auto &mInstrumentationCallbacks = _hidl_this_instrumentor->getInstrumentationCallbacks();
    #else
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IRadioResponse::getSignalStrengthResponse_1_4::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&info);
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getSignalStrengthResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(158 /* getSignalStrengthResponse_1_4 */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
    if (_hidl_transact_err != ::android::OK) 
    {
        _hidl_err = _hidl_transact_err;
        goto _hidl_error;
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getSignalStrengthResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::radio::V1_3::IRadioResponse follow.
::android::hardware::Return<void> BpHwRadioResponse::setSystemSelectionChannelsResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_3::BpHwRadioResponse::_hidl_setSystemSelectionChannelsResponse(this, this, info);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::enableModemResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_3::BpHwRadioResponse::_hidl_enableModemResponse(this, this, info);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::getModemStackStatusResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, bool isEnabled){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_3::BpHwRadioResponse::_hidl_getModemStackStatusResponse(this, this, info, isEnabled);
...
// Methods from ::android::hardware::radio::V1_4::IRadioResponse follow.
::android::hardware::Return<void> BpHwRadioResponse::emergencyDialResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_emergencyDialResponse(this, this, info);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::startNetworkScanResponse_1_4(const ::android::hardware::radio::V1_0::RadioResponseInfo& info){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_startNetworkScanResponse_1_4(this, this, info);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::getCellInfoListResponse_1_4(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::CellInfo>& cellInfo){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_getCellInfoListResponse_1_4(this, this, info, cellInfo);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::getDataRegistrationStateResponse_1_4(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_4::DataRegStateResult& dataRegResponse){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_getDataRegistrationStateResponse_1_4(this, this, info, dataRegResponse);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::getIccCardStatusResponse_1_4(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_4::CardStatus& cardStatus){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_getIccCardStatusResponse_1_4(this, this, info, cardStatus);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::getPreferredNetworkTypeBitmapResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_4::RadioAccessFamily> networkTypeBitmap){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_getPreferredNetworkTypeBitmapResponse(this, this, info, networkTypeBitmap);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::setPreferredNetworkTypeBitmapResponse(const ::android::hardware::radio::V1_0::RadioResponseInfo& info){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_setPreferredNetworkTypeBitmapResponse(this, this, info);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::getDataCallListResponse_1_4(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::SetupDataCallResult>& dcResponse){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_getDataCallListResponse_1_4(this, this, info, dcResponse);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::setupDataCallResponse_1_4(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_4::SetupDataCallResult& dcResponse){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_setupDataCallResponse_1_4(this, this, info, dcResponse);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::setAllowedCarriersResponse_1_4(const ::android::hardware::radio::V1_0::RadioResponseInfo& info){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_setAllowedCarriersResponse_1_4(this, this, info);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::getAllowedCarriersResponse_1_4(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_4::CarrierRestrictionsWithPriority& carriers, ::android::hardware::radio::V1_4::SimLockMultiSimPolicy multiSimPolicy){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_getAllowedCarriersResponse_1_4(this, this, info, carriers, multiSimPolicy);

    return _hidl_out;
}

::android::hardware::Return<void> BpHwRadioResponse::getSignalStrengthResponse_1_4(const ::android::hardware::radio::V1_0::RadioResponseInfo& info, const ::android::hardware::radio::V1_4::SignalStrength& signalStrength){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::radio::V1_4::BpHwRadioResponse::_hidl_getSignalStrengthResponse_1_4(this, this, info, signalStrength);
...
BnHwRadioResponse::BnHwRadioResponse(const ::android::sp<IRadioResponse> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.radio@1.4", "IRadioResponse") { 
...
::android::status_t BnHwRadioResponse::_hidl_emergencyDialResponse(
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)info);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "emergencyDialResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->emergencyDialResponse(*info);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "emergencyDialResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_startNetworkScanResponse_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::startNetworkScanResponse_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "startNetworkScanResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->startNetworkScanResponse_1_4(*info);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "startNetworkScanResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_getCellInfoListResponse_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::radio::V1_4::CellInfo> &>(*cellInfo),
            _hidl_data,
            _hidl_cellInfo_parent,
            0 /* parentOffset */, &_hidl_cellInfo_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < cellInfo->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::radio::V1_4::CellInfo &>((*cellInfo)[_hidl_index_0]),
                _hidl_data,
                _hidl_cellInfo_child,
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::CellInfo));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::getCellInfoListResponse_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        _hidl_args.push_back((void *)cellInfo);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getCellInfoListResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->getCellInfoListResponse_1_4(*info, *cellInfo);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getCellInfoListResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_getDataRegistrationStateResponse_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::radio::V1_4::DataRegStateResult &>(*dataRegResponse),
            _hidl_data,
            _hidl_dataRegResponse_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::getDataRegistrationStateResponse_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        _hidl_args.push_back((void *)dataRegResponse);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getDataRegistrationStateResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->getDataRegistrationStateResponse_1_4(*info, *dataRegResponse);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getDataRegistrationStateResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_getIccCardStatusResponse_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::radio::V1_4::CardStatus &>(*cardStatus),
            _hidl_data,
            _hidl_cardStatus_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::getIccCardStatusResponse_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        _hidl_args.push_back((void *)cardStatus);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getIccCardStatusResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->getIccCardStatusResponse_1_4(*info, *cardStatus);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getIccCardStatusResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_getPreferredNetworkTypeBitmapResponse(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::android::hardware::radio::V1_0::RadioResponseInfo* info;
    ::android::hardware::hidl_bitfield<::android::hardware::radio::V1_4::RadioAccessFamily> networkTypeBitmap;
    ...
    _hidl_err = _hidl_data.readInt32((int32_t *)&networkTypeBitmap);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::getPreferredNetworkTypeBitmapResponse::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        _hidl_args.push_back((void *)&networkTypeBitmap);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getPreferredNetworkTypeBitmapResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->getPreferredNetworkTypeBitmapResponse(*info, networkTypeBitmap);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getPreferredNetworkTypeBitmapResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_setPreferredNetworkTypeBitmapResponse(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::setPreferredNetworkTypeBitmapResponse::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "setPreferredNetworkTypeBitmapResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->setPreferredNetworkTypeBitmapResponse(*info);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "setPreferredNetworkTypeBitmapResponse", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_getDataCallListResponse_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::android::hardware::radio::V1_0::RadioResponseInfo* info;
    const ::android::hardware::hidl_vec<::android::hardware::radio::V1_4::SetupDataCallResult>* dcResponse;
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<::android::hardware::radio::V1_4::SetupDataCallResult> &>(*dcResponse),
            _hidl_data,
            _hidl_dcResponse_parent,
            0 /* parentOffset */, &_hidl_dcResponse_child);
    ...
    for (size_t _hidl_index_0 = 0; _hidl_index_0 < dcResponse->size(); ++_hidl_index_0) {
        _hidl_err = readEmbeddedFromParcel(
                const_cast<::android::hardware::radio::V1_4::SetupDataCallResult &>((*dcResponse)[_hidl_index_0]),
                _hidl_data,
                _hidl_dcResponse_child,
                _hidl_index_0 * sizeof(::android::hardware::radio::V1_4::SetupDataCallResult));
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::getDataCallListResponse_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        _hidl_args.push_back((void *)dcResponse);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getDataCallListResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->getDataCallListResponse_1_4(*info, *dcResponse);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getDataCallListResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_setupDataCallResponse_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::radio::V1_4::SetupDataCallResult &>(*dcResponse),
            _hidl_data,
            _hidl_dcResponse_parent,
            0 /* parentOffset */);
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::setupDataCallResponse_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        _hidl_args.push_back((void *)dcResponse);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "setupDataCallResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->setupDataCallResponse_1_4(*info, *dcResponse);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "setupDataCallResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_setAllowedCarriersResponse_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::setAllowedCarriersResponse_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "setAllowedCarriersResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->setAllowedCarriersResponse_1_4(*info);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "setAllowedCarriersResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_getAllowedCarriersResponse_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    ::android::hardware::radio::V1_0::RadioResponseInfo* info;
    ::android::hardware::radio::V1_4::CarrierRestrictionsWithPriority* carriers;
    ...
    _hidl_err = readEmbeddedFromParcel(
            const_cast<::android::hardware::radio::V1_4::CarrierRestrictionsWithPriority &>(*carriers),
            _hidl_data,
            _hidl_carriers_parent,
            0 /* parentOffset */);
    ...
    _hidl_err = _hidl_data.readInt32((int32_t *)&multiSimPolicy);
    if (_hidl_err != ::android::OK) { return _hidl_err; }

    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::getAllowedCarriersResponse_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        ...
        _hidl_args.push_back((void *)&multiSimPolicy);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getAllowedCarriersResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->getAllowedCarriersResponse_1_4(*info, *carriers, multiSimPolicy);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getAllowedCarriersResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::_hidl_getSignalStrengthResponse_1_4(
        ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
        const ::android::hardware::Parcel &_hidl_data,
        ::android::hardware::Parcel *_hidl_reply,
        TransactCallback _hidl_cb) {
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IRadioResponse::getSignalStrengthResponse_1_4::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)info);
        _hidl_args.push_back((void *)signalStrength);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.radio", "1.4", "IRadioResponse", "getSignalStrengthResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IRadioResponse*>(_hidl_this->getImpl().get())->getSignalStrengthResponse_1_4(*info, *signalStrength);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.radio", "1.4", "IRadioResponse", "getSignalStrengthResponse_1_4", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwRadioResponse::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::radio::V1_3::BnHwRadioResponse::_hidl_setSystemSelectionChannelsResponse(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 145 /* enableModemResponse */:
        {
            _hidl_err = ::android::hardware::radio::V1_3::BnHwRadioResponse::_hidl_enableModemResponse(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 146 /* getModemStackStatusResponse */:
        {
            _hidl_err = ::android::hardware::radio::V1_3::BnHwRadioResponse::_hidl_getModemStackStatusResponse(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 147 /* emergencyDialResponse */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_emergencyDialResponse(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 148 /* startNetworkScanResponse_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_startNetworkScanResponse_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 149 /* getCellInfoListResponse_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_getCellInfoListResponse_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 150 /* getDataRegistrationStateResponse_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_getDataRegistrationStateResponse_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 151 /* getIccCardStatusResponse_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_getIccCardStatusResponse_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 152 /* getPreferredNetworkTypeBitmapResponse */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_getPreferredNetworkTypeBitmapResponse(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 153 /* setPreferredNetworkTypeBitmapResponse */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_setPreferredNetworkTypeBitmapResponse(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 154 /* getDataCallListResponse_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_getDataCallListResponse_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 155 /* setupDataCallResponse_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_setupDataCallResponse_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 156 /* setAllowedCarriersResponse_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_setAllowedCarriersResponse_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 157 /* getAllowedCarriersResponse_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_getAllowedCarriersResponse_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }

        case 158 /* getSignalStrengthResponse_1_4 */:
        {
            _hidl_err = ::android::hardware::radio::V1_4::BnHwRadioResponse::_hidl_getSignalStrengthResponse_1_4(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsRadioResponse::BsRadioResponse(const ::android::sp<::android::hardware::radio::V1_4::IRadioResponse> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.radio@1.4", "IRadioResponse"), mImpl(impl) {
...
bool IRadioResponse::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.radio@1.4::IRadioResponse",
