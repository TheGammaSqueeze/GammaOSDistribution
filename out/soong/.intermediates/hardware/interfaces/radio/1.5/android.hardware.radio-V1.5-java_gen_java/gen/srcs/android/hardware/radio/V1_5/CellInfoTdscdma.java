...
public final class CellInfoTdscdma {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_5.CellInfoTdscdma.class) {
            return false;
        }
        android.hardware.radio.V1_5.CellInfoTdscdma other = (android.hardware.radio.V1_5.CellInfoTdscdma)otherObject;
    ...
    public static final java.util.ArrayList<CellInfoTdscdma> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_5.CellInfoTdscdma _hidl_vec_element = new android.hardware.radio.V1_5.CellInfoTdscdma();
                ((android.hardware.radio.V1_5.CellInfoTdscdma) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 160);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_5.CellIdentityTdscdma) cellIdentityTdscdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_2.TdscdmaSignalStrength) signalStrengthTdscdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 144);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        signalStrengthTdscdma.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 144);
    }
};
