...
public final class CellInfoWcdma {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_5.CellInfoWcdma.class) {
            return false;
        }
        android.hardware.radio.V1_5.CellInfoWcdma other = (android.hardware.radio.V1_5.CellInfoWcdma)otherObject;
    ...
    public static final java.util.ArrayList<CellInfoWcdma> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_5.CellInfoWcdma _hidl_vec_element = new android.hardware.radio.V1_5.CellInfoWcdma();
                ((android.hardware.radio.V1_5.CellInfoWcdma) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 152);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_5.CellIdentityWcdma) cellIdentityWcdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_2.WcdmaSignalStrength) signalStrengthWcdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 136);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        signalStrengthWcdma.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 136);
    }
};
