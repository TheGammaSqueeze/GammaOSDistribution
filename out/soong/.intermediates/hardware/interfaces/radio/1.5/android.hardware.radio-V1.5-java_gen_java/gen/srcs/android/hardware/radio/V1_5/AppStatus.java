...
public final class AppStatus {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_5.AppStatus.class) {
            return false;
        }
        android.hardware.radio.V1_5.AppStatus other = (android.hardware.radio.V1_5.AppStatus)otherObject;
    ...
    public final String toString() {
        ...
        builder.append(android.hardware.radio.V1_5.PersoSubstate.toString(this.persoSubstate));
        builder.append("}");
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_0.AppStatus) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        persoSubstate = _hidl_blob.getInt32(_hidl_offset + 64);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 64, persoSubstate);
    }
};
