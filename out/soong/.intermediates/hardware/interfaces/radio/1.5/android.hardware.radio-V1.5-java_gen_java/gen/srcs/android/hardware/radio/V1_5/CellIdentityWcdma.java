...
public final class CellIdentityWcdma {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_5.CellIdentityWcdma.class) {
            return false;
        }
        android.hardware.radio.V1_5.CellIdentityWcdma other = (android.hardware.radio.V1_5.CellIdentityWcdma)otherObject;
    ...
    public static final java.util.ArrayList<CellIdentityWcdma> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_5.CellIdentityWcdma _hidl_vec_element = new android.hardware.radio.V1_5.CellIdentityWcdma();
                ((android.hardware.radio.V1_5.CellIdentityWcdma) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 136);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_2.CellIdentityWcdma) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        {
        ...
        ((android.hardware.radio.V1_5.OptionalCsgInfo) optionalCsgInfo).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 96);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        optionalCsgInfo.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 96);
    }
};
