...
public final class RegStateResult {
    public final static class AccessTechnologySpecificInfo {
        public final static class Cdma2000RegistrationInfo {
            /**
            ...
            public final boolean equals(Object otherObject) {
                ...
                if (otherObject.getClass() != android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.Cdma2000RegistrationInfo.class) {
                    return false;
                }
                android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.Cdma2000RegistrationInfo other = (android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.Cdma2000RegistrationInfo)otherObject;
            ...
            public final String toString() {
                ...
                builder.append(android.hardware.radio.V1_5.PrlIndicator.toString(this.systemIsInPrl));
            ...
            public static final java.util.ArrayList<Cdma2000RegistrationInfo> readVectorFromParcel(android.os.HwParcel parcel) {
                java.util.ArrayList<Cdma2000RegistrationInfo> _hidl_vec = new java.util.ArrayList();
...

                {
                    ...
                    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                        android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.Cdma2000RegistrationInfo _hidl_vec_element = new android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.Cdma2000RegistrationInfo();
                        ((android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.Cdma2000RegistrationInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 16);
            ...
            public final void readEmbeddedFromParcel(
                ...
                cssSupported = _hidl_blob.getBool(_hidl_offset + 0);
                roamingIndicator = _hidl_blob.getInt32(_hidl_offset + 4);
                systemIsInPrl = _hidl_blob.getInt32(_hidl_offset + 8);
                defaultRoamingIndicator = _hidl_blob.getInt32(_hidl_offset + 12);
            }
            ...
            public static final void writeVectorToParcel(
                    android.os.HwParcel parcel, java.util.ArrayList<Cdma2000RegistrationInfo> _hidl_vec) {
            ...
            public final void writeEmbeddedToBlob(
                ...
                _hidl_blob.putBool(_hidl_offset + 0, cssSupported);
                _hidl_blob.putInt32(_hidl_offset + 4, roamingIndicator);
                _hidl_blob.putInt32(_hidl_offset + 8, systemIsInPrl);
                _hidl_blob.putInt32(_hidl_offset + 12, defaultRoamingIndicator);
            }
        };

        public final static class EutranRegistrationInfo {
            /**
            ...
            public final boolean equals(Object otherObject) {
                ...
                if (otherObject.getClass() != android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.EutranRegistrationInfo.class) {
                    return false;
                }
                android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.EutranRegistrationInfo other = (android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.EutranRegistrationInfo)otherObject;
                if (!android.os.HidlSupport.deepEquals(this.lteVopsInfo, other.lteVopsInfo)) {
                    return false;
                }
            ...
            public final int hashCode() {
                return java.util.Objects.hash(
                        android.os.HidlSupport.deepHashCode(this.lteVopsInfo), 
            ...
            public final void readFromParcel(android.os.HwParcel parcel) {
                android.os.HwBlob blob = parcel.readBuffer(5 /* size */);
                readEmbeddedFromParcel(parcel, blob, 0 /* parentOffset */);
            }

            public static final java.util.ArrayList<EutranRegistrationInfo> readVectorFromParcel(android.os.HwParcel parcel) {
                java.util.ArrayList<EutranRegistrationInfo> _hidl_vec = new java.util.ArrayList();
                android.os.HwBlob _hidl_blob = parcel.readBuffer(16 /* sizeof hidl_vec<T> */);

                {
                    int _hidl_vec_size = _hidl_blob.getInt32(0 + 8 /* offsetof(hidl_vec<T>, mSize) */);
                    android.os.HwBlob childBlob = parcel.readEmbeddedBuffer(
                            _hidl_vec_size * 5,_hidl_blob.handle(),
                            0 + 0 /* offsetof(hidl_vec<T>, mBuffer) */,true /* nullable */);

                    _hidl_vec.clear();
                    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                        android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.EutranRegistrationInfo _hidl_vec_element = new android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.EutranRegistrationInfo();
                        ((android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.EutranRegistrationInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 5);
                        _hidl_vec.add(_hidl_vec_element);
                    }
                }
            ...
            public final void readEmbeddedFromParcel(
                    android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
                ((android.hardware.radio.V1_4.LteVopsInfo) lteVopsInfo).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
                ((android.hardware.radio.V1_4.NrIndicators) nrIndicators).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 2);
            }

            public final void writeToParcel(android.os.HwParcel parcel) {
                android.os.HwBlob _hidl_blob = new android.os.HwBlob(5 /* size */);
                writeEmbeddedToBlob(_hidl_blob, 0 /* parentOffset */);
                parcel.writeBuffer(_hidl_blob);
            }

            public static final void writeVectorToParcel(
                    android.os.HwParcel parcel, java.util.ArrayList<EutranRegistrationInfo> _hidl_vec) {
                android.os.HwBlob _hidl_blob = new android.os.HwBlob(16 /* sizeof(hidl_vec<T>) */);
                {
                    int _hidl_vec_size = _hidl_vec.size();
                    _hidl_blob.putInt32(0 + 8 /* offsetof(hidl_vec<T>, mSize) */, _hidl_vec_size);
                    _hidl_blob.putBool(0 + 12 /* offsetof(hidl_vec<T>, mOwnsBuffer) */, false);
                    android.os.HwBlob childBlob = new android.os.HwBlob((int)(_hidl_vec_size * 5));
                    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
            ...
            public final void writeEmbeddedToBlob(
                    android.os.HwBlob _hidl_blob, long _hidl_offset) {
                lteVopsInfo.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 0);
                nrIndicators.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 2);
            }
        };
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (otherObject.getClass() != android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo.class) {
                return false;
            }
            android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo other = (android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo)otherObject;
        ...
        public static final java.util.ArrayList<AccessTechnologySpecificInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

            {
                ...
                _hidl_vec.clear();
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo _hidl_vec_element = new android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo();
                    ((android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 20);
                    _hidl_vec.add(_hidl_vec_element);
                }
            }
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_5.RegStateResult.class) {
            return false;
        }
        android.hardware.radio.V1_5.RegStateResult other = (android.hardware.radio.V1_5.RegStateResult)otherObject;
    ...
    public static final java.util.ArrayList<RegStateResult> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            _hidl_vec.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_5.RegStateResult _hidl_vec_element = new android.hardware.radio.V1_5.RegStateResult();
                ((android.hardware.radio.V1_5.RegStateResult) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 224);
                _hidl_vec.add(_hidl_vec_element);
            }
        }
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_5.RegStateResult.AccessTechnologySpecificInfo) accessTechnologySpecificInfo).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 200);
    }
