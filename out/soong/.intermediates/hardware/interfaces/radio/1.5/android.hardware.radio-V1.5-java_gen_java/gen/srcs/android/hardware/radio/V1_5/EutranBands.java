...
public final class EutranBands {
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & BAND_52) == BAND_52) {
            list.add("BAND_52");
            flipped |= BAND_52;
        }
        if ((o & BAND_53) == BAND_53) {
            list.add("BAND_53");
            flipped |= BAND_53;
        }
        ...
        if ((o & BAND_72) == BAND_72) {
            list.add("BAND_72");
            flipped |= BAND_72;
        }
        if ((o & BAND_73) == BAND_73) {
            list.add("BAND_73");
            flipped |= BAND_73;
        }
        ...
        if ((o & BAND_85) == BAND_85) {
            list.add("BAND_85");
            flipped |= BAND_85;
        }
        if ((o & BAND_87) == BAND_87) {
            list.add("BAND_87");
            flipped |= BAND_87;
        }
        if ((o & BAND_88) == BAND_88) {
            list.add("BAND_88");
            flipped |= BAND_88;
        }
        if (o != flipped) {
