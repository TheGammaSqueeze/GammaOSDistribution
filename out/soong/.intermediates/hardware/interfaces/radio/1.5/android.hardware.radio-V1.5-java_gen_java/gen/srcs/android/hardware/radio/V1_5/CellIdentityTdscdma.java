...
public final class CellIdentityTdscdma {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_5.CellIdentityTdscdma.class) {
            return false;
        }
        android.hardware.radio.V1_5.CellIdentityTdscdma other = (android.hardware.radio.V1_5.CellIdentityTdscdma)otherObject;
    ...
    public static final java.util.ArrayList<CellIdentityTdscdma> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_5.CellIdentityTdscdma _hidl_vec_element = new android.hardware.radio.V1_5.CellIdentityTdscdma();
                ((android.hardware.radio.V1_5.CellIdentityTdscdma) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 144);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_2.CellIdentityTdscdma) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        {
