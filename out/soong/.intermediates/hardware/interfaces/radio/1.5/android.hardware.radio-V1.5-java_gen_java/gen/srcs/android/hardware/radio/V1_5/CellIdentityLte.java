...
public final class CellIdentityLte {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_5.CellIdentityLte.class) {
            return false;
        }
        android.hardware.radio.V1_5.CellIdentityLte other = (android.hardware.radio.V1_5.CellIdentityLte)otherObject;
        ...
        if (!android.os.HidlSupport.deepEquals(this.optionalCsgInfo, other.optionalCsgInfo)) {
            return false;
        }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.optionalCsgInfo), 
    ...
    public final String toString() {
        ...
        builder.append(", .optionalCsgInfo = ");
        builder.append(this.optionalCsgInfo);
    ...
    public static final java.util.ArrayList<CellIdentityLte> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_5.CellIdentityLte _hidl_vec_element = new android.hardware.radio.V1_5.CellIdentityLte();
                ((android.hardware.radio.V1_5.CellIdentityLte) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 160);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_2.CellIdentityLte) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        {
        ...
        ((android.hardware.radio.V1_5.OptionalCsgInfo) optionalCsgInfo).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 104);
        {
            int _hidl_vec_size = _hidl_blob.getInt32(_hidl_offset + 144 + 8 /* offsetof(hidl_vec<T>, mSize) */);
            android.os.HwBlob childBlob = parcel.readEmbeddedBuffer(
                    _hidl_vec_size * 4,_hidl_blob.handle(),
                    _hidl_offset + 144 + 0 /* offsetof(hidl_vec<T>, mBuffer) */,true /* nullable */);
    ...
    public final void writeEmbeddedToBlob(
        ...
        optionalCsgInfo.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 104);
        {
            int _hidl_vec_size = bands.size();
            _hidl_blob.putInt32(_hidl_offset + 144 + 8 /* offsetof(hidl_vec<T>, mSize) */, _hidl_vec_size);
            _hidl_blob.putBool(_hidl_offset + 144 + 12 /* offsetof(hidl_vec<T>, mOwnsBuffer) */, false);
            ...
            _hidl_blob.putBlob(_hidl_offset + 144 + 0 /* offsetof(hidl_vec<T>, mBuffer) */, childBlob);
        }
    }
};
