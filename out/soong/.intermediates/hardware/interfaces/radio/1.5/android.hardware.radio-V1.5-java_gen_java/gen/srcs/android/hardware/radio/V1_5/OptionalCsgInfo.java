...
public final class OptionalCsgInfo {
    ...
    public static final class hidl_discriminator {
         ...
         */
        public static final byte csgInfo = 1;  // android.hardware.radio.V1_5.ClosedSubscriberGroupInfo

        public static final String getName(byte value) {
            switch (value) {
                case 0: { return "noinit"; }
                case 1: { return "csgInfo"; }
    ...
    public void csgInfo(android.hardware.radio.V1_5.ClosedSubscriberGroupInfo csgInfo) {
        hidl_d = hidl_discriminator.csgInfo;
        hidl_o = csgInfo;
    }

    public android.hardware.radio.V1_5.ClosedSubscriberGroupInfo csgInfo() {
        ...
        if (hidl_o != null && !android.hardware.radio.V1_5.ClosedSubscriberGroupInfo.class.isInstance(hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
        return ((android.hardware.radio.V1_5.ClosedSubscriberGroupInfo) hidl_o);
    }
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_5.OptionalCsgInfo.class) {
            return false;
        }
        android.hardware.radio.V1_5.OptionalCsgInfo other = (android.hardware.radio.V1_5.OptionalCsgInfo)otherObject;
    ...
    public static final java.util.ArrayList<OptionalCsgInfo> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<OptionalCsgInfo> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_5.OptionalCsgInfo _hidl_vec_element = new android.hardware.radio.V1_5.OptionalCsgInfo();
                ((android.hardware.radio.V1_5.OptionalCsgInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 40);
    ...
    public final void readEmbeddedFromParcel(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.csgInfo: {
                hidl_o = new android.hardware.radio.V1_5.ClosedSubscriberGroupInfo();
                ((android.hardware.radio.V1_5.ClosedSubscriberGroupInfo) hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 8);
                break;
            }
            default: {
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<OptionalCsgInfo> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.csgInfo: {
                csgInfo().writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 8);
                break;
            }
            default: {
                throw new Error("Unknown union discriminator (value: " + hidl_d + ").");
