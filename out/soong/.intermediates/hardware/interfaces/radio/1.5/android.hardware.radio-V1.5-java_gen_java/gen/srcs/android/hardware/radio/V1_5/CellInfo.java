...
public final class CellInfo {
    public final static class CellInfoRatSpecificInfo {
        ...
        public static final class hidl_discriminator {
            ...
            public static final byte lte = 3;  // android.hardware.radio.V1_5.CellInfoLte
            public static final byte nr = 4;  // android.hardware.radio.V1_5.CellInfoNr
            /**
        ...
        public void lte(android.hardware.radio.V1_5.CellInfoLte lte) {
        ...
        public android.hardware.radio.V1_5.CellInfoLte lte() {
            ...
            if (hidl_o != null && !android.hardware.radio.V1_5.CellInfoLte.class.isInstance(hidl_o)) {
                throw new Error("Union is in a corrupted state.");
            }
            return ((android.hardware.radio.V1_5.CellInfoLte) hidl_o);
        }

        public void nr(android.hardware.radio.V1_5.CellInfoNr nr) {
        ...
        public android.hardware.radio.V1_5.CellInfoNr nr() {
            ...
            if (hidl_o != null && !android.hardware.radio.V1_5.CellInfoNr.class.isInstance(hidl_o)) {
                throw new Error("Union is in a corrupted state.");
            }
            return ((android.hardware.radio.V1_5.CellInfoNr) hidl_o);
        }
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (otherObject.getClass() != android.hardware.radio.V1_5.CellInfo.CellInfoRatSpecificInfo.class) {
                return false;
            }
            android.hardware.radio.V1_5.CellInfo.CellInfoRatSpecificInfo other = (android.hardware.radio.V1_5.CellInfo.CellInfoRatSpecificInfo)otherObject;
        ...
        public static final java.util.ArrayList<CellInfoRatSpecificInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

            {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                    android.hardware.radio.V1_5.CellInfo.CellInfoRatSpecificInfo _hidl_vec_element = new android.hardware.radio.V1_5.CellInfo.CellInfoRatSpecificInfo();
                    ((android.hardware.radio.V1_5.CellInfo.CellInfoRatSpecificInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 192);
        ...
        public final void readEmbeddedFromParcel(
            ...
            switch (this.hidl_d) {
                ...
                case hidl_discriminator.lte: {
                    hidl_o = new android.hardware.radio.V1_5.CellInfoLte();
                    ((android.hardware.radio.V1_5.CellInfoLte) hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 8);
                    break;
                }
                case hidl_discriminator.nr: {
                    hidl_o = new android.hardware.radio.V1_5.CellInfoNr();
                    ((android.hardware.radio.V1_5.CellInfoNr) hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 8);
                    break;
                }
                case hidl_discriminator.cdma: {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_5.CellInfo.class) {
            return false;
        }
        android.hardware.radio.V1_5.CellInfo other = (android.hardware.radio.V1_5.CellInfo)otherObject;
    ...
    public static final java.util.ArrayList<CellInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            _hidl_vec.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_5.CellInfo _hidl_vec_element = new android.hardware.radio.V1_5.CellInfo();
                ((android.hardware.radio.V1_5.CellInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 216);
                _hidl_vec.add(_hidl_vec_element);
            }
        }
    ...
    public final void readEmbeddedFromParcel(
        ...
        timeStampType = _hidl_blob.getInt32(_hidl_offset + 4);
        timeStamp = _hidl_blob.getInt64(_hidl_offset + 8);
        connectionStatus = _hidl_blob.getInt32(_hidl_offset + 16);
        ((android.hardware.radio.V1_5.CellInfo.CellInfoRatSpecificInfo) ratSpecificInfo).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 24);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 4, timeStampType);
        _hidl_blob.putInt64(_hidl_offset + 8, timeStamp);
        _hidl_blob.putInt32(_hidl_offset + 16, connectionStatus);
        ratSpecificInfo.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 24);
    }
};
