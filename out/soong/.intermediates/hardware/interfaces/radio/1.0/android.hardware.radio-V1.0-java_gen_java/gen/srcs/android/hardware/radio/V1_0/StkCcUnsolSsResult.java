...
public final class StkCcUnsolSsResult {
    ...
    public int result = 0;
    public java.util.ArrayList<android.hardware.radio.V1_0.SsInfoData> ssInfo = new java.util.ArrayList<android.hardware.radio.V1_0.SsInfoData>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CfData> cfData = new java.util.ArrayList<android.hardware.radio.V1_0.CfData>();
    ...
    public static final java.util.ArrayList<StkCcUnsolSsResult> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_0.StkCcUnsolSsResult _hidl_vec_element = new android.hardware.radio.V1_0.StkCcUnsolSsResult();
                ((android.hardware.radio.V1_0.StkCcUnsolSsResult) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 56);
    ...
    public final void readEmbeddedFromParcel(
        ...
        result = _hidl_blob.getInt32(_hidl_offset + 16);
        {
            ...
            ((java.util.ArrayList<android.hardware.radio.V1_0.SsInfoData>) ssInfo).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_0.SsInfoData _hidl_vec_element = new android.hardware.radio.V1_0.SsInfoData();
                ((android.hardware.radio.V1_0.SsInfoData) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 16);
                ((java.util.ArrayList<android.hardware.radio.V1_0.SsInfoData>) ssInfo).add(_hidl_vec_element);
            }
        }
        {
            ...
            ((java.util.ArrayList<android.hardware.radio.V1_0.CfData>) cfData).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_0.CfData _hidl_vec_element = new android.hardware.radio.V1_0.CfData();
                ((android.hardware.radio.V1_0.CfData) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 16);
                ((java.util.ArrayList<android.hardware.radio.V1_0.CfData>) cfData).add(_hidl_vec_element);
            }
        }
    }
