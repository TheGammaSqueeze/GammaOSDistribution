...
public interface ISapCallback extends android.hidl.base.V1_0.IBase {
     ...
     */
    public static ISapCallback getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISapCallback.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.0::ISapCallback", serviceName, retry));
    }

    /**
     * Calls getService("default",retry).
     */
    public static ISapCallback getService(boolean retry) throws android.os.RemoteException {
    ...
    public static final class Proxy implements ISapCallback {
        ...
        public void connectResponse(int token, int sapConnectRsp, int maxMsgSize)
            ...
            _hidl_request.writeInterfaceToken(android.hardware.radio.V1_0.ISapCallback.kInterfaceName);
            ...
            try {
                mRemote.transact(1 /* connectResponse */, _hidl_request, _hidl_reply, 1 /* oneway */);
        ...
        public void disconnectResponse(int token)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(2 /* disconnectResponse */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void disconnectIndication(int token, int disconnectType)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(3 /* disconnectIndication */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void apduResponse(int token, int resultCode, java.util.ArrayList<Byte> apduRsp)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(4 /* apduResponse */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void transferAtrResponse(int token, int resultCode, java.util.ArrayList<Byte> atr)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(5 /* transferAtrResponse */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void powerResponse(int token, int resultCode)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(6 /* powerResponse */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void resetSimResponse(int token, int resultCode)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(7 /* resetSimResponse */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void statusIndication(int token, int status)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(8 /* statusIndication */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void transferCardReaderStatusResponse(int token, int resultCode, int cardReaderStatus)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(9 /* transferCardReaderStatusResponse */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void errorResponse(int token)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(10 /* errorResponse */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void transferProtocolResponse(int token, int resultCode)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(11 /* transferProtocolResponse */, _hidl_request, _hidl_reply, 1 /* oneway */);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISapCallback {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.radio.V1_0.ISapCallback.kInterfaceName,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                {
                    _hidl_request.enforceInterface(android.hardware.radio.V1_0.ISapCallback.kInterfaceName);
