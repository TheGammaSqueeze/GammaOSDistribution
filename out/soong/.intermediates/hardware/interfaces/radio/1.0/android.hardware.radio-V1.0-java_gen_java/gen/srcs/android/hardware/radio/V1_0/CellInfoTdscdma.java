...
public final class CellInfoTdscdma {
    public android.hardware.radio.V1_0.CellIdentityTdscdma cellIdentityTdscdma = new android.hardware.radio.V1_0.CellIdentityTdscdma();
    public android.hardware.radio.V1_0.TdScdmaSignalStrength signalStrengthTdscdma = new android.hardware.radio.V1_0.TdScdmaSignalStrength();
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_0.CellIdentityTdscdma) cellIdentityTdscdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_0.TdScdmaSignalStrength) signalStrengthTdscdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 48);
    }
