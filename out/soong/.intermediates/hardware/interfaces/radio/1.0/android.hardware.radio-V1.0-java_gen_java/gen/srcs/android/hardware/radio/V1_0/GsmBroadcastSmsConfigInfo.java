    ...
    public static final java.util.ArrayList<GsmBroadcastSmsConfigInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_0.GsmBroadcastSmsConfigInfo _hidl_vec_element = new android.hardware.radio.V1_0.GsmBroadcastSmsConfigInfo();
                ((android.hardware.radio.V1_0.GsmBroadcastSmsConfigInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 20);
