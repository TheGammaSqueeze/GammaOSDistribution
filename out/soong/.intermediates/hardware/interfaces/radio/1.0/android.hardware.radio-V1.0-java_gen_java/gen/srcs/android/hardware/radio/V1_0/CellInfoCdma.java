...
public final class CellInfoCdma {
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_0.CellIdentityCdma) cellIdentityCdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_0.CdmaSignalStrength) signalStrengthCdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 20);
        ((android.hardware.radio.V1_0.EvdoSignalStrength) signalStrengthEvdo).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 28);
    }
