...
public final class DataRegStateResult {
    ...
    public static final java.util.ArrayList<DataRegStateResult> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_0.DataRegStateResult _hidl_vec_element = new android.hardware.radio.V1_0.DataRegStateResult();
                ((android.hardware.radio.V1_0.DataRegStateResult) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 104);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_0.CellIdentity) cellIdentity).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 16);
    }
