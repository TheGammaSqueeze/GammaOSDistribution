    ...
    public static final java.util.ArrayList<WcdmaSignalStrength> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_0.WcdmaSignalStrength _hidl_vec_element = new android.hardware.radio.V1_0.WcdmaSignalStrength();
                ((android.hardware.radio.V1_0.WcdmaSignalStrength) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 8);
