...
public final class CellInfoLte {
    public android.hardware.radio.V1_0.CellIdentityLte cellIdentityLte = new android.hardware.radio.V1_0.CellIdentityLte();
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_0.CellIdentityLte) cellIdentityLte).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_0.LteSignalStrength) signalStrengthLte).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 48);
    }
