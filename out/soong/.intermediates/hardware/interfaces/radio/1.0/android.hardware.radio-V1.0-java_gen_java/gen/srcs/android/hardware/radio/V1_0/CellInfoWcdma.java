...
public final class CellInfoWcdma {
    public android.hardware.radio.V1_0.CellIdentityWcdma cellIdentityWcdma = new android.hardware.radio.V1_0.CellIdentityWcdma();
    public android.hardware.radio.V1_0.WcdmaSignalStrength signalStrengthWcdma = new android.hardware.radio.V1_0.WcdmaSignalStrength();
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_0.CellIdentityWcdma) cellIdentityWcdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        ((android.hardware.radio.V1_0.WcdmaSignalStrength) signalStrengthWcdma).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 48);
    }
