...
public final class CellIdentity {
    ...
    public java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityGsm> cellIdentityGsm = new java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityGsm>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityWcdma> cellIdentityWcdma = new java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityWcdma>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityCdma> cellIdentityCdma = new java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityCdma>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityLte> cellIdentityLte = new java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityLte>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityTdscdma> cellIdentityTdscdma = new java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityTdscdma>();
    ...
    public static final java.util.ArrayList<CellIdentity> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_0.CellIdentity _hidl_vec_element = new android.hardware.radio.V1_0.CellIdentity();
                ((android.hardware.radio.V1_0.CellIdentity) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 88);
    ...
    public final void readEmbeddedFromParcel(
        ...
        cellInfoType = _hidl_blob.getInt32(_hidl_offset + 0);
        {
            ...
            ((java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityGsm>) cellIdentityGsm).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityGsm>) cellIdentityGsm).add(_hidl_vec_element);
            }
        }
        {
            ...
            ((java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityWcdma>) cellIdentityWcdma).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_0.CellIdentityWcdma _hidl_vec_element = new android.hardware.radio.V1_0.CellIdentityWcdma();
                ((android.hardware.radio.V1_0.CellIdentityWcdma) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 48);
                ((java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityWcdma>) cellIdentityWcdma).add(_hidl_vec_element);
            }
        }
        {
            ...
            ((java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityCdma>) cellIdentityCdma).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityCdma>) cellIdentityCdma).add(_hidl_vec_element);
            }
        }
        {
            ...
            ((java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityLte>) cellIdentityLte).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityLte>) cellIdentityLte).add(_hidl_vec_element);
            }
        }
        {
            ...
            ((java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityTdscdma>) cellIdentityTdscdma).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_0.CellIdentityTdscdma _hidl_vec_element = new android.hardware.radio.V1_0.CellIdentityTdscdma();
                ((android.hardware.radio.V1_0.CellIdentityTdscdma) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 48);
                ((java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityTdscdma>) cellIdentityTdscdma).add(_hidl_vec_element);
            }
        }
    }
