...
public final class SsInfoData {
    public java.util.ArrayList<Integer> ssInfo = new java.util.ArrayList<Integer>();
    ...
    public final void readEmbeddedFromParcel(
            android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
        {
            ...
            ((java.util.ArrayList<Integer>) ssInfo).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                int _hidl_vec_element = 0;
                _hidl_vec_element = childBlob.getInt32(_hidl_index_0 * 4);
                ((java.util.ArrayList<Integer>) ssInfo).add(_hidl_vec_element);
            }
        }
    }
