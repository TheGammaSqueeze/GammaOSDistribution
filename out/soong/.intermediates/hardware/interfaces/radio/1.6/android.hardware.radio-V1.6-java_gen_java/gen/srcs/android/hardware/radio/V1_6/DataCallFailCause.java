...
public final class DataCallFailCause {
     ...
     */
    public static final int SLICE_REJECTED = 2252 /* 0x8CC */;
    /**
     * No matching rule available for the request, and match-all rule is not allowed for it.
     */
    public static final int MATCH_ALL_RULE_NOT_ALLOWED = 2253 /* 0x8CD */;
    /**
     * If connection failed for all matching URSP rules.
     */
    public static final int ALL_MATCHING_RULES_FAILED = 2254 /* 0x8CE */;
    public static final String toString(int o) {
        ...
        if (o == MATCH_ALL_RULE_NOT_ALLOWED) {
            return "MATCH_ALL_RULE_NOT_ALLOWED";
        }
        if (o == ALL_MATCHING_RULES_FAILED) {
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & SLICE_REJECTED) == SLICE_REJECTED) {
            list.add("SLICE_REJECTED");
            flipped |= SLICE_REJECTED;
        }
        if ((o & MATCH_ALL_RULE_NOT_ALLOWED) == MATCH_ALL_RULE_NOT_ALLOWED) {
            list.add("MATCH_ALL_RULE_NOT_ALLOWED");
            flipped |= MATCH_ALL_RULE_NOT_ALLOWED;
        }
        if ((o & ALL_MATCHING_RULES_FAILED) == ALL_MATCHING_RULES_FAILED) {
            list.add("ALL_MATCHING_RULES_FAILED");
            flipped |= ALL_MATCHING_RULES_FAILED;
        }
        if (o != flipped) {
