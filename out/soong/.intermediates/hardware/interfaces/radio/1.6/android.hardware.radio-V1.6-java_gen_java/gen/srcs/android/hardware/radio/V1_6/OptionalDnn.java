...
public final class OptionalDnn {
    ...
    public static final class hidl_discriminator {
        ...
        public static final byte value = 1;  // String
    ...
    public String value() {
        ...
        if (hidl_o != null && !String.class.isInstance(hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
        return ((String) hidl_o);
    }
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.OptionalDnn.class) {
            return false;
        }
        android.hardware.radio.V1_6.OptionalDnn other = (android.hardware.radio.V1_6.OptionalDnn)otherObject;
    ...
    public static final java.util.ArrayList<OptionalDnn> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<OptionalDnn> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.OptionalDnn _hidl_vec_element = new android.hardware.radio.V1_6.OptionalDnn();
                ((android.hardware.radio.V1_6.OptionalDnn) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
    ...
    public final void readEmbeddedFromParcel(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.value: {
                hidl_o = new String();
                hidl_o = _hidl_blob.getString(_hidl_offset + 8);

                parcel.readEmbeddedBuffer(
                        ((String) hidl_o).getBytes().length + 1,
                        _hidl_blob.handle(),
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<OptionalDnn> _hidl_vec) {
