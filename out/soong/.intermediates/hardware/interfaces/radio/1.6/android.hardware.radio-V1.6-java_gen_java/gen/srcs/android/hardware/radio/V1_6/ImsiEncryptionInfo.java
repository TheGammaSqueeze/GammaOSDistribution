...
public final class ImsiEncryptionInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.ImsiEncryptionInfo.class) {
            return false;
        }
        android.hardware.radio.V1_6.ImsiEncryptionInfo other = (android.hardware.radio.V1_6.ImsiEncryptionInfo)otherObject;
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.keyType));
    }
    ...
    public final String toString() {
        ...
        builder.append(android.hardware.radio.V1_6.PublicKeyType.toString(this.keyType));
        builder.append("}");
    ...
    public static final java.util.ArrayList<ImsiEncryptionInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.ImsiEncryptionInfo _hidl_vec_element = new android.hardware.radio.V1_6.ImsiEncryptionInfo();
                ((android.hardware.radio.V1_6.ImsiEncryptionInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 80);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_1.ImsiEncryptionInfo) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        keyType = _hidl_blob.getInt8(_hidl_offset + 72);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt8(_hidl_offset + 72, keyType);
    }
};
