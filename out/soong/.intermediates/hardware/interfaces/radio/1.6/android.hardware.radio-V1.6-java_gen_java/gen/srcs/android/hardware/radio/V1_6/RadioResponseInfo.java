...
public final class RadioResponseInfo {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.RadioResponseInfo.class) {
            return false;
        }
        android.hardware.radio.V1_6.RadioResponseInfo other = (android.hardware.radio.V1_6.RadioResponseInfo)otherObject;
    ...
    public static final java.util.ArrayList<RadioResponseInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.RadioResponseInfo _hidl_vec_element = new android.hardware.radio.V1_6.RadioResponseInfo();
                ((android.hardware.radio.V1_6.RadioResponseInfo) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 12);
