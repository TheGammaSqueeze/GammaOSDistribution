...
public final class MaybePort {
    ...
    public static final class hidl_discriminator {
        ...
        public static final byte range = 1;  // android.hardware.radio.V1_6.PortRange
    ...
    public void range(android.hardware.radio.V1_6.PortRange range) {
        hidl_d = hidl_discriminator.range;
        hidl_o = range;
    }

    public android.hardware.radio.V1_6.PortRange range() {
        ...
        if (hidl_o != null && !android.hardware.radio.V1_6.PortRange.class.isInstance(hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
        return ((android.hardware.radio.V1_6.PortRange) hidl_o);
    }
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.MaybePort.class) {
            return false;
        }
        android.hardware.radio.V1_6.MaybePort other = (android.hardware.radio.V1_6.MaybePort)otherObject;
    ...
    public static final java.util.ArrayList<MaybePort> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<MaybePort> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.MaybePort _hidl_vec_element = new android.hardware.radio.V1_6.MaybePort();
                ((android.hardware.radio.V1_6.MaybePort) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 12);
    ...
    public final void readEmbeddedFromParcel(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.range: {
                hidl_o = new android.hardware.radio.V1_6.PortRange();
                ((android.hardware.radio.V1_6.PortRange) hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 4);
                break;
            }
            default: {
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<MaybePort> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.range: {
                range().writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 4);
                break;
            }
            default: {
                throw new Error("Unknown union discriminator (value: " + hidl_d + ").");
