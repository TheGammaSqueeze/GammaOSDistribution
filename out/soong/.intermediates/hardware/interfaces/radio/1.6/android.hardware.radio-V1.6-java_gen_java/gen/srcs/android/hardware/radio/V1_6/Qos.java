...
public final class Qos {
    ...
    public static final class hidl_discriminator {
        ...
        public static final byte eps = 1;  // android.hardware.radio.V1_6.EpsQos
        public static final byte nr = 2;  // android.hardware.radio.V1_6.NrQos
    ...
    public void eps(android.hardware.radio.V1_6.EpsQos eps) {
    ...
    public android.hardware.radio.V1_6.EpsQos eps() {
        ...
        if (hidl_o != null && !android.hardware.radio.V1_6.EpsQos.class.isInstance(hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
        return ((android.hardware.radio.V1_6.EpsQos) hidl_o);
    }

    public void nr(android.hardware.radio.V1_6.NrQos nr) {
    ...
    public android.hardware.radio.V1_6.NrQos nr() {
        ...
        if (hidl_o != null && !android.hardware.radio.V1_6.NrQos.class.isInstance(hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
        return ((android.hardware.radio.V1_6.NrQos) hidl_o);
    }
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.Qos.class) {
            return false;
        }
        android.hardware.radio.V1_6.Qos other = (android.hardware.radio.V1_6.Qos)otherObject;
    ...
    public static final java.util.ArrayList<Qos> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<Qos> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.Qos _hidl_vec_element = new android.hardware.radio.V1_6.Qos();
                ((android.hardware.radio.V1_6.Qos) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 28);
    ...
    public final void readEmbeddedFromParcel(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.eps: {
                hidl_o = new android.hardware.radio.V1_6.EpsQos();
                ((android.hardware.radio.V1_6.EpsQos) hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 4);
                break;
            }
            case hidl_discriminator.nr: {
                hidl_o = new android.hardware.radio.V1_6.NrQos();
                ((android.hardware.radio.V1_6.NrQos) hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 4);
                break;
            }
            default: {
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<Qos> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.eps: {
                eps().writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 4);
                break;
            }
            case hidl_discriminator.nr: {
                nr().writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 4);
                break;
            }
            default: {
                throw new Error("Unknown union discriminator (value: " + hidl_d + ").");
