...
public final class OptionalOsAppId {
    ...
    public static final class hidl_discriminator {
        ...
        public static final byte value = 1;  // android.hardware.radio.V1_6.OsAppId
    ...
    public void value(android.hardware.radio.V1_6.OsAppId value) {
    ...
    public android.hardware.radio.V1_6.OsAppId value() {
        ...
        if (hidl_o != null && !android.hardware.radio.V1_6.OsAppId.class.isInstance(hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
        return ((android.hardware.radio.V1_6.OsAppId) hidl_o);
    }
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.OptionalOsAppId.class) {
            return false;
        }
        android.hardware.radio.V1_6.OptionalOsAppId other = (android.hardware.radio.V1_6.OptionalOsAppId)otherObject;
    ...
    public static final java.util.ArrayList<OptionalOsAppId> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<OptionalOsAppId> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.OptionalOsAppId _hidl_vec_element = new android.hardware.radio.V1_6.OptionalOsAppId();
                ((android.hardware.radio.V1_6.OptionalOsAppId) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
    ...
    public final void readEmbeddedFromParcel(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.value: {
                hidl_o = new android.hardware.radio.V1_6.OsAppId();
                ((android.hardware.radio.V1_6.OsAppId) hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 8);
                break;
            }
            default: {
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<OptionalOsAppId> _hidl_vec) {
