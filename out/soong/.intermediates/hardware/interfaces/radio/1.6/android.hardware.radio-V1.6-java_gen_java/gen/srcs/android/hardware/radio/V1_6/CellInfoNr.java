...
public final class CellInfoNr {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.CellInfoNr.class) {
            return false;
        }
        android.hardware.radio.V1_6.CellInfoNr other = (android.hardware.radio.V1_6.CellInfoNr)otherObject;
    ...
    public static final java.util.ArrayList<CellInfoNr> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.CellInfoNr _hidl_vec_element = new android.hardware.radio.V1_6.CellInfoNr();
                ((android.hardware.radio.V1_6.CellInfoNr) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 168);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_6.NrSignalStrength) signalStrengthNr).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 120);
    }
