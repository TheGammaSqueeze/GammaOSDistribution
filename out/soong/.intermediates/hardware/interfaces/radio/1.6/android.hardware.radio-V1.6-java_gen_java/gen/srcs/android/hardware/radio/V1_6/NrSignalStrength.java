...
public final class NrSignalStrength {
     ...
     */
    public java.util.ArrayList<Byte> csiCqiReport = new java.util.ArrayList<Byte>();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.NrSignalStrength.class) {
            return false;
        }
        android.hardware.radio.V1_6.NrSignalStrength other = (android.hardware.radio.V1_6.NrSignalStrength)otherObject;
        if (!android.os.HidlSupport.deepEquals(this.base, other.base)) {
            return false;
        }
        if (this.csiCqiTableIndex != other.csiCqiTableIndex) {
            return false;
        }
        if (!android.os.HidlSupport.deepEquals(this.csiCqiReport, other.csiCqiReport)) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.csiCqiTableIndex), 
                android.os.HidlSupport.deepHashCode(this.csiCqiReport));
    }
    ...
    public final String toString() {
        ...
        builder.append(", .csiCqiTableIndex = ");
        builder.append(this.csiCqiTableIndex);
        builder.append(", .csiCqiReport = ");
        builder.append(this.csiCqiReport);
        builder.append("}");
    ...
    public static final java.util.ArrayList<NrSignalStrength> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.NrSignalStrength _hidl_vec_element = new android.hardware.radio.V1_6.NrSignalStrength();
                ((android.hardware.radio.V1_6.NrSignalStrength) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 48);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_4.NrSignalStrength) base).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        csiCqiTableIndex = _hidl_blob.getInt32(_hidl_offset + 24);
        {
            ...
            ((java.util.ArrayList<Byte>) csiCqiReport).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                byte _hidl_vec_element = 0;
                _hidl_vec_element = childBlob.getInt8(_hidl_index_0 * 1);
                ((java.util.ArrayList<Byte>) csiCqiReport).add(_hidl_vec_element);
            }
        }
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 24, csiCqiTableIndex);
        {
            int _hidl_vec_size = csiCqiReport.size();
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                childBlob.putInt8(_hidl_index_0 * 1, csiCqiReport.get(_hidl_index_0));
            }
