...
public final class RadioError {
    ...
    public static final String toString(int o) {
        ...
        if (o == SIMULTANEOUS_SMS_AND_CALL_NOT_ALLOWED) {
            return "SIMULTANEOUS_SMS_AND_CALL_NOT_ALLOWED";
        }
        if (o == ACCESS_BARRED) {
            return "ACCESS_BARRED";
        }
        if (o == BLOCKED_DUE_TO_CALL) {
            return "BLOCKED_DUE_TO_CALL";
        }
        if (o == RF_HARDWARE_ISSUE) {
            return "RF_HARDWARE_ISSUE";
        }
        if (o == NO_RF_CALIBRATION_INFO) {
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & SIMULTANEOUS_SMS_AND_CALL_NOT_ALLOWED) == SIMULTANEOUS_SMS_AND_CALL_NOT_ALLOWED) {
            list.add("SIMULTANEOUS_SMS_AND_CALL_NOT_ALLOWED");
            flipped |= SIMULTANEOUS_SMS_AND_CALL_NOT_ALLOWED;
        }
        if ((o & ACCESS_BARRED) == ACCESS_BARRED) {
            list.add("ACCESS_BARRED");
            flipped |= ACCESS_BARRED;
        }
        if ((o & BLOCKED_DUE_TO_CALL) == BLOCKED_DUE_TO_CALL) {
            list.add("BLOCKED_DUE_TO_CALL");
            flipped |= BLOCKED_DUE_TO_CALL;
        }
        if ((o & RF_HARDWARE_ISSUE) == RF_HARDWARE_ISSUE) {
            list.add("RF_HARDWARE_ISSUE");
            flipped |= RF_HARDWARE_ISSUE;
        }
        if ((o & NO_RF_CALIBRATION_INFO) == NO_RF_CALIBRATION_INFO) {
            list.add("NO_RF_CALIBRATION_INFO");
            flipped |= NO_RF_CALIBRATION_INFO;
        }
        if (o != flipped) {
