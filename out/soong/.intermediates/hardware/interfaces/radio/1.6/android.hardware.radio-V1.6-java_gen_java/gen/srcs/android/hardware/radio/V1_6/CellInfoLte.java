...
public final class CellInfoLte {
    ...
    public android.hardware.radio.V1_6.LteSignalStrength signalStrengthLte = new android.hardware.radio.V1_6.LteSignalStrength();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.CellInfoLte.class) {
            return false;
        }
        android.hardware.radio.V1_6.CellInfoLte other = (android.hardware.radio.V1_6.CellInfoLte)otherObject;
    ...
    public static final java.util.ArrayList<CellInfoLte> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.CellInfoLte _hidl_vec_element = new android.hardware.radio.V1_6.CellInfoLte();
                ((android.hardware.radio.V1_6.CellInfoLte) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 192);
    ...
    public final void readEmbeddedFromParcel(
        ...
        ((android.hardware.radio.V1_6.LteSignalStrength) signalStrengthLte).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 160);
    }
