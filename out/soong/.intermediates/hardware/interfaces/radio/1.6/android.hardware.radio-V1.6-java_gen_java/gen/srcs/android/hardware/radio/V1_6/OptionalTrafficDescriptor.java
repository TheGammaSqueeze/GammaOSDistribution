...
public final class OptionalTrafficDescriptor {
    ...
    public static final class hidl_discriminator {
        ...
        public static final byte value = 1;  // android.hardware.radio.V1_6.TrafficDescriptor
    ...
    public void value(android.hardware.radio.V1_6.TrafficDescriptor value) {
        hidl_d = hidl_discriminator.value;
        hidl_o = value;
    }

    public android.hardware.radio.V1_6.TrafficDescriptor value() {
        ...
        if (hidl_o != null && !android.hardware.radio.V1_6.TrafficDescriptor.class.isInstance(hidl_o)) {
            throw new Error("Union is in a corrupted state.");
        }
        return ((android.hardware.radio.V1_6.TrafficDescriptor) hidl_o);
    }
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.OptionalTrafficDescriptor.class) {
            return false;
        }
        android.hardware.radio.V1_6.OptionalTrafficDescriptor other = (android.hardware.radio.V1_6.OptionalTrafficDescriptor)otherObject;
    ...
    public static final java.util.ArrayList<OptionalTrafficDescriptor> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<OptionalTrafficDescriptor> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.OptionalTrafficDescriptor _hidl_vec_element = new android.hardware.radio.V1_6.OptionalTrafficDescriptor();
                ((android.hardware.radio.V1_6.OptionalTrafficDescriptor) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 56);
    ...
    public final void readEmbeddedFromParcel(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.value: {
                hidl_o = new android.hardware.radio.V1_6.TrafficDescriptor();
                ((android.hardware.radio.V1_6.TrafficDescriptor) hidl_o).readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 8);
                break;
            }
            default: {
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<OptionalTrafficDescriptor> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.value: {
                value().writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 8);
                break;
            }
            default: {
                throw new Error("Unknown union discriminator (value: " + hidl_d + ").");
