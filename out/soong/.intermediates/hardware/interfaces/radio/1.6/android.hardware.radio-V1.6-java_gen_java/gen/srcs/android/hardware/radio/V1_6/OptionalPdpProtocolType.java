...
public final class OptionalPdpProtocolType {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.OptionalPdpProtocolType.class) {
            return false;
        }
        android.hardware.radio.V1_6.OptionalPdpProtocolType other = (android.hardware.radio.V1_6.OptionalPdpProtocolType)otherObject;
    ...
    public final String toString() {
        ...
        switch (this.hidl_d) {
            ...
            case hidl_discriminator.value: {
                ...
                builder.append(android.hardware.radio.V1_4.PdpProtocolType.toString(this.value()));
                break;
            }
            default: {
    ...
    public static final java.util.ArrayList<OptionalPdpProtocolType> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<OptionalPdpProtocolType> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.OptionalPdpProtocolType _hidl_vec_element = new android.hardware.radio.V1_6.OptionalPdpProtocolType();
                ((android.hardware.radio.V1_6.OptionalPdpProtocolType) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 8);
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<OptionalPdpProtocolType> _hidl_vec) {
