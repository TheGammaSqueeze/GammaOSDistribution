...
public final class NetworkScanResult {
     ...
     */
    public java.util.ArrayList<android.hardware.radio.V1_6.CellInfo> networkInfos = new java.util.ArrayList<android.hardware.radio.V1_6.CellInfo>();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.NetworkScanResult.class) {
            return false;
        }
        android.hardware.radio.V1_6.NetworkScanResult other = (android.hardware.radio.V1_6.NetworkScanResult)otherObject;
    ...
    public final String toString() {
        ...
        builder.append(android.hardware.radio.V1_6.RadioError.toString(this.error));
    ...
    public static final java.util.ArrayList<NetworkScanResult> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.NetworkScanResult _hidl_vec_element = new android.hardware.radio.V1_6.NetworkScanResult();
                ((android.hardware.radio.V1_6.NetworkScanResult) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
    ...
    public final void readEmbeddedFromParcel(
        ...
        error = _hidl_blob.getInt32(_hidl_offset + 4);
        {
            ...
            ((java.util.ArrayList<android.hardware.radio.V1_6.CellInfo>) networkInfos).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((java.util.ArrayList<android.hardware.radio.V1_6.CellInfo>) networkInfos).add(_hidl_vec_element);
            }
        }
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 4, error);
        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                networkInfos.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 208);
            }
