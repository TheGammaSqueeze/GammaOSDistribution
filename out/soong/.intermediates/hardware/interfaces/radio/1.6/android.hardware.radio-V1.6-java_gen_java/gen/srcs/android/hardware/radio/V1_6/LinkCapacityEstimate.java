...
public final class LinkCapacityEstimate {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_6.LinkCapacityEstimate.class) {
            return false;
        }
        android.hardware.radio.V1_6.LinkCapacityEstimate other = (android.hardware.radio.V1_6.LinkCapacityEstimate)otherObject;
        ...
        if (this.secondaryDownlinkCapacityKbps != other.secondaryDownlinkCapacityKbps) {
            return false;
        }
        if (this.secondaryUplinkCapacityKbps != other.secondaryUplinkCapacityKbps) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.secondaryDownlinkCapacityKbps), 
                android.os.HidlSupport.deepHashCode(this.secondaryUplinkCapacityKbps));
    }
    ...
    public final String toString() {
        ...
        builder.append(", .secondaryDownlinkCapacityKbps = ");
        builder.append(this.secondaryDownlinkCapacityKbps);
        builder.append(", .secondaryUplinkCapacityKbps = ");
        builder.append(this.secondaryUplinkCapacityKbps);
        builder.append("}");
    ...
    public static final java.util.ArrayList<LinkCapacityEstimate> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                android.hardware.radio.V1_6.LinkCapacityEstimate _hidl_vec_element = new android.hardware.radio.V1_6.LinkCapacityEstimate();
                ((android.hardware.radio.V1_6.LinkCapacityEstimate) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 16);
    ...
    public final void readEmbeddedFromParcel(
        ...
        secondaryDownlinkCapacityKbps = _hidl_blob.getInt32(_hidl_offset + 8);
        secondaryUplinkCapacityKbps = _hidl_blob.getInt32(_hidl_offset + 12);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 8, secondaryDownlinkCapacityKbps);
        _hidl_blob.putInt32(_hidl_offset + 12, secondaryUplinkCapacityKbps);
    }
};
