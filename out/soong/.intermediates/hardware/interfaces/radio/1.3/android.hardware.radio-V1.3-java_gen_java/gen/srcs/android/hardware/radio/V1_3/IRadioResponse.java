...
public interface IRadioResponse extends android.hardware.radio.V1_2.IRadioResponse {
    ...
    public static IRadioResponse getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IRadioResponse.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.3::IRadioResponse", serviceName, retry));
    }
    ...
    public static IRadioResponse getService(String serviceName) throws android.os.RemoteException {
        return IRadioResponse.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.3::IRadioResponse", serviceName));
    }
     ...
     */
    void setSystemSelectionChannelsResponse(android.hardware.radio.V1_0.RadioResponseInfo info)
     ...
     */
    void enableModemResponse(android.hardware.radio.V1_0.RadioResponseInfo info)
        throws android.os.RemoteException;
    /**
     * @param info Response info struct containing response type, serial no. and error
     *
     ...
     *   RadioError:MODEM_ERR
     */
    void getModemStackStatusResponse(android.hardware.radio.V1_0.RadioResponseInfo info, boolean isEnabled)
        throws android.os.RemoteException;
    /*
