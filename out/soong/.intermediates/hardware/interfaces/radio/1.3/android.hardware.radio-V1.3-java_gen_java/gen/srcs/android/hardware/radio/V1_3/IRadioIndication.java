...
public interface IRadioIndication extends android.hardware.radio.V1_2.IRadioIndication {
    ...
    public static IRadioIndication getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IRadioIndication.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.3::IRadioIndication", serviceName, retry));
    }
    ...
    public static IRadioIndication getService(String serviceName) throws android.os.RemoteException {
        return IRadioIndication.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.3::IRadioIndication", serviceName));
    }
