...
::android::hardware::Return<void> BpHwDumpstateDevice::_hidl_dumpstateBoard(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_handle& h) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IDumpstateDevice::dumpstateBoard::client");
    #ifdef __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* dumpstateBoard */, _hidl_data, &_hidl_reply, 0 /* flags */);
...
::android::status_t BnHwDumpstateDevice::_hidl_dumpstateBoard(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<IDumpstateDevice*>(_hidl_this->getImpl().get())->dumpstateBoard(h);
