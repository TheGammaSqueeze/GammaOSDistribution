#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_AUDIO_V2_1_BPHWBLUETOOTHAUDIOPROVIDER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_AUDIO_V2_1_BPHWBLUETOOTHAUDIOPROVIDER_H

#include <hidl/HidlTransportSupport.h>

#include <android/hardware/bluetooth/audio/2.1/IHwBluetoothAudioProvider.h>
...
struct BpHwBluetoothAudioProvider : public ::android::hardware::BpInterface<IBluetoothAudioProvider>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_startSession_2_1(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioPort>& hostIf, const ::android::hardware::bluetooth::audio::V2_1::AudioConfiguration& audioConfig, startSession_2_1_cb _hidl_cb);
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_AUDIO_V2_1_BPHWBLUETOOTHAUDIOPROVIDER_H
