#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDERSFACTORY_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDERSFACTORY_H
 ...
 */
struct IBluetoothAudioProvidersFactory : public ::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvidersFactory {
    /**
    ...
    /**
     * Return callback for openProvider_2_1
     */
    using openProvider_2_1_cb = std::function<void(::android::hardware::bluetooth::audio::V2_0::Status status, const ::android::sp<::android::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvider>& provider)>;
    /**
     * Opens an audio provider for a session type. To close the provider, it is
     * necessary to release references to the returned provider object.
     *
     ...
     * @return provider The provider of the specified session type
     */
    virtual ::android::hardware::Return<void> openProvider_2_1(::android::hardware::bluetooth::audio::V2_1::SessionType sessionType, openProvider_2_1_cb _hidl_cb) = 0;

    /**
     * Return callback for getProviderCapabilities_2_1
     */
    using getProviderCapabilities_2_1_cb = std::function<void(const ::android::hardware::hidl_vec<::android::hardware::bluetooth::audio::V2_1::AudioCapabilities>& audioCapabilities)>;
    /**
     * Gets a list of audio capabilities for a session type.
     *
     * For software encoding, the PCM capabilities are returned.
     ...
     *    encoding.
     */
    virtual ::android::hardware::Return<void> getProviderCapabilities_2_1(::android::hardware::bluetooth::audio::V2_1::SessionType sessionType, getProviderCapabilities_2_1_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>> castFrom(const ::android::sp<::android::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>> castFrom(const ::android::sp<::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvidersFactory>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory>& o) {
    ...
    os += ::android::hardware::bluetooth::audio::V2_1::IBluetoothAudioProvidersFactory::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_AUDIO_V2_1_IBLUETOOTHAUDIOPROVIDERSFACTORY_H
