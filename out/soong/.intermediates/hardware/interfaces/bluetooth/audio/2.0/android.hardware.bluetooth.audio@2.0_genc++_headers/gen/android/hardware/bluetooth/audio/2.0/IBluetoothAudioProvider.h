#ifndef HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPROVIDER_H
#define HIDL_GENERATED_ANDROID_HARDWARE_BLUETOOTH_AUDIO_V2_0_IBLUETOOTHAUDIOPROVIDER_H
 ...
 */
struct IBluetoothAudioProvider : public ::android::hidl::base::V1_0::IBase {
    /**
    ...
    /**
     * Fully qualified interface name: "android.hardware.bluetooth.audio@2.0::IBluetoothAudioProvider"
     */
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvider>> castFrom(const ::android::sp<::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvider>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvider>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvider>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvider>& o) {
    ...
    os += ::android::hardware::bluetooth::audio::V2_0::IBluetoothAudioProvider::descriptor;
    os += "]";
