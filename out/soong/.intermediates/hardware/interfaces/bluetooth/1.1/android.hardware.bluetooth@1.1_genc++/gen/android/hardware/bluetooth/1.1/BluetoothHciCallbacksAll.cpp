#define LOG_TAG "android.hardware.bluetooth@1.1::BluetoothHciCallbacks"
...
#include <android/hardware/bluetooth/1.1/BpHwBluetoothHciCallbacks.h>
#include <android/hardware/bluetooth/1.1/BnHwBluetoothHciCallbacks.h>
#include <android/hardware/bluetooth/1.1/BsBluetoothHciCallbacks.h>
...
// no default implementation for: ::android::hardware::Return<void> IBluetoothHciCallbacks::isoDataReceived(const ::android::hardware::hidl_vec<uint8_t>& data)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IBluetoothHciCallbacks::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks::descriptor,
...
::android::hardware::Return<void> IBluetoothHciCallbacks::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IBluetoothHciCallbacks::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){64,171,44,104,102,193,141,50,186,246,228,158,48,83,148,158,121,96,31,86,150,58,121,30,147,230,139,158,225,143,113,141} /* 40ab2c6866c18d32baf6e49e3053949e79601f56963a791e93e68b9ee18f718d */,
...
::android::hardware::Return<::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks>> IBluetoothHciCallbacks::castFrom(const ::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks>> IBluetoothHciCallbacks::castFrom(const ::android::sp<::android::hardware::bluetooth::V1_0::IBluetoothHciCallbacks>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IBluetoothHciCallbacks, ::android::hardware::bluetooth::V1_0::IBluetoothHciCallbacks, BpHwBluetoothHciCallbacks>(
            parent, "android.hardware.bluetooth@1.1::IBluetoothHciCallbacks", emitError);
}

::android::hardware::Return<::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks>> IBluetoothHciCallbacks::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
...
BpHwBluetoothHciCallbacks::BpHwBluetoothHciCallbacks(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IBluetoothHciCallbacks>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.bluetooth@1.1", "IBluetoothHciCallbacks") {
}
...
// Methods from ::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks follow.
::android::hardware::Return<void> BpHwBluetoothHciCallbacks::_hidl_isoDataReceived(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& data) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::IBluetoothHciCallbacks::isoDataReceived::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)&data);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.bluetooth", "1.1", "IBluetoothHciCallbacks", "isoDataReceived", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(5 /* isoDataReceived */, _hidl_data, &_hidl_reply, 0 /* flags */);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.bluetooth", "1.1", "IBluetoothHciCallbacks", "isoDataReceived", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks follow.
::android::hardware::Return<void> BpHwBluetoothHciCallbacks::isoDataReceived(const ::android::hardware::hidl_vec<uint8_t>& data){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::bluetooth::V1_1::BpHwBluetoothHciCallbacks::_hidl_isoDataReceived(this, this, data);
...
BnHwBluetoothHciCallbacks::BnHwBluetoothHciCallbacks(const ::android::sp<IBluetoothHciCallbacks> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.bluetooth@1.1", "IBluetoothHciCallbacks") { 
...
// Methods from ::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks follow.
::android::status_t BnHwBluetoothHciCallbacks::_hidl_isoDataReceived(
    ...
    atrace_begin(ATRACE_TAG_HAL, "HIDL::IBluetoothHciCallbacks::isoDataReceived::server");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        _hidl_args.push_back((void *)data);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.bluetooth", "1.1", "IBluetoothHciCallbacks", "isoDataReceived", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__

    ::android::hardware::Return<void> _hidl_ret = static_cast<IBluetoothHciCallbacks*>(_hidl_this->getImpl().get())->isoDataReceived(*data);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_EXIT, "android.hardware.bluetooth", "1.1", "IBluetoothHciCallbacks", "isoDataReceived", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwBluetoothHciCallbacks::onTransact(
    ...
    switch (_hidl_code) {
        ...
        {
            _hidl_err = ::android::hardware::bluetooth::V1_1::BnHwBluetoothHciCallbacks::_hidl_isoDataReceived(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsBluetoothHciCallbacks::BsBluetoothHciCallbacks(const ::android::sp<::android::hardware::bluetooth::V1_1::IBluetoothHciCallbacks> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.bluetooth@1.1", "IBluetoothHciCallbacks"), mImpl(impl) {
...
bool IBluetoothHciCallbacks::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.bluetooth@1.1::IBluetoothHciCallbacks",
