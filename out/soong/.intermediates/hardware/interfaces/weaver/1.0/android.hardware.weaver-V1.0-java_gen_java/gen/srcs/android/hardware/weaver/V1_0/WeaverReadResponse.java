...
public final class WeaverReadResponse {
     ...
     */
    public java.util.ArrayList<Byte> value = new java.util.ArrayList<Byte>();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.weaver.V1_0.WeaverReadResponse.class) {
            return false;
        }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                android.os.HidlSupport.deepHashCode(this.timeout), 
    ...
    public static final java.util.ArrayList<WeaverReadResponse> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<WeaverReadResponse> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((android.hardware.weaver.V1_0.WeaverReadResponse) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
    ...
    public final void readEmbeddedFromParcel(
        ...
        timeout = _hidl_blob.getInt32(_hidl_offset + 0);
        {
            ...
            ((java.util.ArrayList<Byte>) value).clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                byte _hidl_vec_element = 0;
                _hidl_vec_element = childBlob.getInt8(_hidl_index_0 * 1);
                ((java.util.ArrayList<Byte>) value).add(_hidl_vec_element);
            }
        }
    }
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<WeaverReadResponse> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 0, timeout);
        {
            int _hidl_vec_size = value.size();
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                childBlob.putInt8(_hidl_index_0 * 1, value.get(_hidl_index_0));
            }
