 ...
 */
public interface IOffloadControl extends android.hardware.tetheroffload.control.V1_0.IOffloadControl {
    /**
     * Fully-qualified interface name for this interface.
     */
    public static final String kInterfaceName = "android.hardware.tetheroffload.control@1.1::IOffloadControl";
    ...
    public static IOffloadControl getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IOffloadControl.asInterface(android.os.HwBinder.getService("android.hardware.tetheroffload.control@1.1::IOffloadControl", serviceName, retry));
    }
    ...
    public static IOffloadControl getService(String serviceName) throws android.os.RemoteException {
        return IOffloadControl.asInterface(android.os.HwBinder.getService("android.hardware.tetheroffload.control@1.1::IOffloadControl", serviceName));
    }
    ...
    public interface setDataWarningAndLimitCallback {
     ...
     */
    void setDataWarningAndLimit(String upstream, long warningBytes, long limitBytes, setDataWarningAndLimitCallback _hidl_cb)
    ...
    public static final class Proxy implements IOffloadControl {
        ...
        // Methods from ::android::hardware::tetheroffload::control::V1_1::IOffloadControl follow.
        @Override
        public void setDataWarningAndLimit(String upstream, long warningBytes, long limitBytes, setDataWarningAndLimitCallback _hidl_cb)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.tetheroffload.control.V1_1.IOffloadControl.kInterfaceName);
            _hidl_request.writeString(upstream);
            _hidl_request.writeInt64(warningBytes);
            _hidl_request.writeInt64(limitBytes);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(9 /* setDataWarningAndLimit */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IOffloadControl {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    android.hardware.tetheroffload.control.V1_1.IOffloadControl.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return android.hardware.tetheroffload.control.V1_1.IOffloadControl.kInterfaceName;
        ...
        public final java.util.ArrayList<byte[/* 32 */]> getHashChain() {
            return new java.util.ArrayList<byte[/* 32 */]>(java.util.Arrays.asList(
                    new byte[/* 32 */]{-3,67,41,-116,67,-9,1,48,-57,71,-90,66,-18,67,-80,-62,66,-84,12,-21,-1,-77,119,-6,-94,79,39,37,-16,-86,108,-81} /* fd43298c43f70130c747a642ee43b0c242ac0cebffb377faa24f2725f0aa6caf */,
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                ...
                case 9 /* setDataWarningAndLimit */:
                {
                    _hidl_request.enforceInterface(android.hardware.tetheroffload.control.V1_1.IOffloadControl.kInterfaceName);

                    String upstream = _hidl_request.readString();
                    long warningBytes = _hidl_request.readInt64();
                    long limitBytes = _hidl_request.readInt64();
                    setDataWarningAndLimit(upstream, warningBytes, limitBytes, new setDataWarningAndLimitCallback() {
                        @Override
                        public void onValues(boolean success, String errMsg) {
                            _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
                            _hidl_reply.writeBool(success);
