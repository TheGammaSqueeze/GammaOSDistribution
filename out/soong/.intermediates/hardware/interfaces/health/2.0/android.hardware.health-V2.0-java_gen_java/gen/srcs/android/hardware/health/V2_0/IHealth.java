...
public interface IHealth extends android.hidl.base.V1_0.IBase {
    ...
    public static IHealth getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IHealth.asInterface(android.os.HwBinder.getService("android.hardware.health@2.0::IHealth", serviceName, retry));
    }
    ...
    public static IHealth getService(String serviceName) throws android.os.RemoteException {
        return IHealth.asInterface(android.os.HwBinder.getService("android.hardware.health@2.0::IHealth", serviceName));
    }
     ...
     */
    int registerCallback(android.hardware.health.V2_0.IHealthInfoCallback callback)
     ...
     *                UNKNOWN for other errors.
     */
    int unregisterCallback(android.hardware.health.V2_0.IHealthInfoCallback callback)
        throws android.os.RemoteException;
    /**
     * Schedule update.
     *
     ...
     */
    void getChargeCounter(getChargeCounterCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     *               successful.
     */
    void getCurrentNow(getCurrentNowCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getCurrentAverage(getCurrentAverageCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getCapacity(getCapacityCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getEnergyCounter(getEnergyCounterCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getChargeStatus(getChargeStatusCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     *               SUCCESS.
     */
    void getStorageInfo(getStorageInfoCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     */
    void getDiskStats(getDiskStatsCallback _hidl_cb)
        throws android.os.RemoteException;
     ...
     *                SUCCESS.
     */
    void getHealthInfo(getHealthInfoCallback _hidl_cb)
        throws android.os.RemoteException;
    /*
