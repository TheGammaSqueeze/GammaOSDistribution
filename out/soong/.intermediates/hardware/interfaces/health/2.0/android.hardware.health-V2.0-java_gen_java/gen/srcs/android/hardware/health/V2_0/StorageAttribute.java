...
public final class StorageAttribute {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.health.V2_0.StorageAttribute.class) {
            return false;
        }
        ...
        if (this.isBootDevice != other.isBootDevice) {
            return false;
        }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                android.os.HidlSupport.deepHashCode(this.isInternal), 
                android.os.HidlSupport.deepHashCode(this.isBootDevice), 
    ...
    public static final java.util.ArrayList<StorageAttribute> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<StorageAttribute> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                ((android.hardware.health.V2_0.StorageAttribute) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
    ...
    public final void readEmbeddedFromParcel(
        ...
        isInternal = _hidl_blob.getBool(_hidl_offset + 0);
        isBootDevice = _hidl_blob.getBool(_hidl_offset + 1);
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<StorageAttribute> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putBool(_hidl_offset + 0, isInternal);
        _hidl_blob.putBool(_hidl_offset + 1, isBootDevice);
