...
public final class DisplayMode {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != vendor.lineage.livedisplay.V2_0.DisplayMode.class) {
            return false;
        }
        vendor.lineage.livedisplay.V2_0.DisplayMode other = (vendor.lineage.livedisplay.V2_0.DisplayMode)otherObject;
        if (this.id != other.id) {
            return false;
        }
    ...
    public static final java.util.ArrayList<DisplayMode> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<DisplayMode> _hidl_vec = new java.util.ArrayList();
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                vendor.lineage.livedisplay.V2_0.DisplayMode _hidl_vec_element = new vendor.lineage.livedisplay.V2_0.DisplayMode();
                ((vendor.lineage.livedisplay.V2_0.DisplayMode) _hidl_vec_element).readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<DisplayMode> _hidl_vec) {
