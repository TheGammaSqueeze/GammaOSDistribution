...
var t = []testing.InternalTest{
	...
	{"TestGenruleAllowMissingDependencies", pkg.TestGenruleAllowMissingDependencies},

	{"TestGenruleCmd", pkg.TestGenruleCmd},

	{"TestGenruleDefaults", pkg.TestGenruleDefaults},

	{"TestGenruleHashInputs", pkg.TestGenruleHashInputs},

	{"TestGenruleWithBazel", pkg.TestGenruleWithBazel},
