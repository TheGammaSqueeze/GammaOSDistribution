...
import (
	...
	pkg "android/soong/android/soongconfig"
)

var t = []testing.InternalTest{

	{"Test_CanonicalizeToProperty", pkg.Test_CanonicalizeToProperty},

	{"Test_PropertiesToApply", pkg.Test_PropertiesToApply},

	{"Test_createAffectablePropertiesType", pkg.Test_createAffectablePropertiesType},

	{"Test_typeForPropertyFromPropertyStruct", pkg.Test_typeForPropertyFromPropertyStruct},
...
func (matchString) ImportPath() string {
	return "android/soong/android/soongconfig"
}
