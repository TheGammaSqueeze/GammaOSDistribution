...
import (
	...
	pkg "android/soong/sh"
)

var t = []testing.InternalTest{

	{"TestShTest", pkg.TestShTest},

	{"TestShTestHost", pkg.TestShTestHost},

	{"TestShTestHost_dataDeviceModules", pkg.TestShTestHost_dataDeviceModules},

	{"TestShTestSubDir", pkg.TestShTestSubDir},

	{"TestShTest_dataModules", pkg.TestShTest_dataModules},
