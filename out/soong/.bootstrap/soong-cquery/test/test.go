...
import (
	...
	pkg "android/soong/bazel/cquery"
)

var t = []testing.InternalTest{

	{"TestGetCcInfoParseResults", pkg.TestGetCcInfoParseResults},

	{"TestGetOutputFilesParseResults", pkg.TestGetOutputFilesParseResults},
...
func (matchString) ImportPath() string {
	return "android/soong/bazel/cquery"
}
