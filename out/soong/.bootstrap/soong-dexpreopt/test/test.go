...
var t = []testing.InternalTest{
	...
	{"TestCLCJson", pkg.TestCLCJson},

	{"TestCLCNestedConditional", pkg.TestCLCNestedConditional},

	{"TestCLCSdkVersionOrder", pkg.TestCLCSdkVersionOrder},

	{"TestCLCUnknownBuildPath", pkg.TestCLCUnknownBuildPath},

	{"TestCLCUnknownInstallPath", pkg.TestCLCUnknownInstallPath},

	{"TestDexPreopt", pkg.TestDexPreopt},

	{"TestDexPreoptConfigToJson", pkg.TestDexPreoptConfigToJson},
