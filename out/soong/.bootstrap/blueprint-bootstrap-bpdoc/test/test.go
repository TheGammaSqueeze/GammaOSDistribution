...
var t = []testing.InternalTest{
	...
	{"TestAllPackages", pkg.TestAllPackages},

	{"TestExcludeByTag", pkg.TestExcludeByTag},

	{"TestFuncToPkgPath", pkg.TestFuncToPkgPath},

	{"TestIncludeByTag", pkg.TestIncludeByTag},

	{"TestModuleTypeDocs", pkg.TestModuleTypeDocs},

	{"TestNestedPropertyStructs", pkg.TestNestedPropertyStructs},
