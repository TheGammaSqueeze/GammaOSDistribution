...
import (
	...
	pkg "android/soong/linkerconfig"
)

var t = []testing.InternalTest{

	{"TestBaseLinkerConfig", pkg.TestBaseLinkerConfig},

	{"TestUninstallableLinkerConfig", pkg.TestUninstallableLinkerConfig},
...
func (matchString) ImportPath() string {
	return "android/soong/linkerconfig"
}
