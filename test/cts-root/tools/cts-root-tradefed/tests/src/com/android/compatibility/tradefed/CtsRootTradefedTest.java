...
/**
 * Tests for cts-root-tradefed.
 */
@RunWith(JUnit4.class)
public class CtsRootTradefedTest {

    private static final String PROPERTY_NAME = "CTS_ROOT_ROOT";
    private static final String SUITE_FULL_NAME = "Compatibility Test Suite (Root)";
    private static final String SUITE_NAME = "CTS_ROOT";
    ...
    public void testSuiteInfoLoad() throws Exception {
        ...
        File base = new File(root, "android-cts-root");
        base.mkdirs();
